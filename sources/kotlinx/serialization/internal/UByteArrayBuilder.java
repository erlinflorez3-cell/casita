...
public final class UByteArrayBuilder extends PrimitiveArrayBuilder<UByteArray> {
    ...
    private UByteArrayBuilder(byte[] bArr) {
        this.buffer = bArr;
        this.position = UByteArray.m9057getSizeimpl(bArr);
    ...
    public final void m10584append7apg3OU$kotlinx_serialization_core(byte b2) {
        PrimitiveArrayBuilder.ensureCapacity$kotlinx_serialization_core$default(this, 0, 1, null);
        byte[] bArr = this.buffer;
        int position$kotlinx_serialization_core = getPosition$kotlinx_serialization_core();
        this.position = position$kotlinx_serialization_core + 1;
        UByteArray.m9061setVurrAj0(bArr, position$kotlinx_serialization_core, b2);
    }

    @Override // kotlinx.serialization.internal.PrimitiveArrayBuilder
    public /* bridge */ /* synthetic */ UByteArray build$kotlinx_serialization_core() {
        return UByteArray.m9049boximpl(m10585buildTcUX1vc$kotlinx_serialization_core());
    }

    /* JADX INFO: renamed from: build-TcUX1vc$kotlinx_serialization_core, reason: not valid java name */
    public byte[] m10585buildTcUX1vc$kotlinx_serialization_core() {
    ...
    public void ensureCapacity$kotlinx_serialization_core(int i2) {
        if (UByteArray.m9057getSizeimpl(this.buffer) < i2) {
            byte[] bArr = this.buffer;
            byte[] bArrCopyOf = Arrays.copyOf(bArr, RangesKt.coerceAtLeast(i2, UByteArray.m9057getSizeimpl(bArr) * 2));
            Intrinsics.checkNotNullExpressionValue(bArrCopyOf, "copyOf(this, newSize)");
            this.buffer = UByteArray.m9051constructorimpl(bArrCopyOf);
        }
    }
