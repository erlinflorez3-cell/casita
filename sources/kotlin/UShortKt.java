...
@InterfaceC1492Gx
@Metadata(bv = {}, d1 = {"Я\"\u001d̉=!4i\bDRf|İI\u0006>\u00116Ȑ\u0007\":\u0019\u007fјnjG8LeN.jc8ş\u0004{b#\u0004$ C\u0002٭ ԥ&\t]O\u007fw|Ϻr\u000bq\u000e.\u0016'lrշ[ޯa\u0012\u001d5Z\u007fM\u074ceok8\ttd\tfݍ(أ}\u0005\u000f\u001fBX\u001e͌\u0013Cy\u000b:0nv\u0001ĭ\u0013̂\t\u001a \r̭$\t"}, d2 = {"BnD [6Kb", "\u001aj^A_0G\u001d\tl}h9\f^", "", "uA\u0018 ", "", "uH\u0018 ", "", "uI\u0018 ", "", "uR\u0018 ", "9nc9\\5\u0006a(}\u0002b)"}, k = 2, mv = {1, 9, 0}, pn = "", xi = 48, xs = "")
public final class UShortKt {
    private static final short toUShort(byte b2) {
        return UShort.m9261constructorimpl(b2);
    }
    ...
    private static final short toUShort(short s2) {
        return UShort.m9261constructorimpl(s2);
    }
}
