...
public class ReflectionFactory {
    ...
    public KType mutableCollectionType(KType kType) {
        ...
        return new TypeReference(kType.getClassifier(), kType.getArguments(), typeReference.getPlatformTypeUpperBound$kotlin_stdlib(), (-1) - (((-1) - typeReference.getFlags$kotlin_stdlib()) & ((-1) - 2)));
    }
    ...
    public KType nothingType(KType kType) {
        TypeReference typeReference = (TypeReference) kType;
        return new TypeReference(kType.getClassifier(), kType.getArguments(), typeReference.getPlatformTypeUpperBound$kotlin_stdlib(), (-1) - (((-1) - typeReference.getFlags$kotlin_stdlib()) & ((-1) - 4)));
    }
