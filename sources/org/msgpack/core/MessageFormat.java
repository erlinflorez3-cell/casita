...
public enum MessageFormat {
    ...
    static MessageFormat toMessageFormat(byte b2) {
        if (MessagePack.Code.isPosFixInt(b2)) {
            return POSFIXINT;
        }
        if (MessagePack.Code.isNegFixInt(b2)) {
            return NEGFIXINT;
        }
        if (MessagePack.Code.isFixStr(b2)) {
            return FIXSTR;
        }
    ...
    public static MessageFormat valueOf(byte b2) {
