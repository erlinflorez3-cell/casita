...
public class ImmutableMapValueImpl extends AbstractImmutableValue implements ImmutableMapValue {
    ...
    private static class EntryIterator implements Iterator<Value> {
        ...
        public EntryIterator(Value[] valueArr, int i2) {
            this.kvs = valueArr;
            this.index = i2;
        }
    ...
    private static class EntrySetIterator implements Iterator<Map.Entry<Value, Value>> {
        ...
        public Map.Entry<Value, Value> next() {
            ...
            AbstractMap.SimpleImmutableEntry simpleImmutableEntry = new AbstractMap.SimpleImmutableEntry(valueArr[i2], valueArr[i2 + 1]);
            this.index += 2;
    ...
    public int hashCode() {
        ...
        while (true) {
            ...
            iHashCode += valueArr[i2].hashCode() ^ this.kvs[i2 + 1].hashCode();
            i2 += 2;
        }
    }
    ...
    public String toJson() {
        ...
        for (int i2 = 2; i2 < this.kvs.length; i2 += 2) {
            sb.append(",");
