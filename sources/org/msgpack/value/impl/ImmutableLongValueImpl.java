...
public class ImmutableLongValueImpl extends AbstractImmutableValue implements ImmutableIntegerValue {
    ...
    public ImmutableLongValueImpl(long j2) {
        this.value = j2;
    }
    ...
    public int hashCode() {
        long j2 = this.value;
        return (INT_MIN > j2 || j2 > INT_MAX) ? (int) (j2 ^ (j2 >>> 32)) : (int) j2;
    }
    ...
    public boolean isInByteRange() {
        long j2 = this.value;
        return BYTE_MIN <= j2 && j2 <= BYTE_MAX;
    }

    @Override // org.msgpack.value.IntegerValue
    public boolean isInIntRange() {
        long j2 = this.value;
        return INT_MIN <= j2 && j2 <= INT_MAX;
    }
    ...
    public boolean isInShortRange() {
        long j2 = this.value;
        return SHORT_MIN <= j2 && j2 <= SHORT_MAX;
    }
