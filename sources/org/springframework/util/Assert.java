...
public abstract class Assert {
    ...
    public static void isInstanceOf(Class<?> cls, Object obj, String str) {
        ...
        if (cls.isInstance(obj)) {
            ...
            throw new IllegalArgumentException((StringUtils.hasLength(str) ? str + Global.BLANK : "") + "Object of class [" + (obj != null ? obj.getClass().getName() : "null") + "] must be an instance of " + cls);
        }
    }
    ...
    public static void isTrue(boolean z2) {
        isTrue(z2, "[Assertion failed] - this expression must be true");
    }
    ...
    public static void state(boolean z2) {
        state(z2, "[Assertion failed] - this state invariant must be true");
    }

    public static void state(boolean z2, String str) {
        if (!z2) {
