...
public abstract class GenericCollectionTypeResolver {
    ...
    public static Class<?> getCollectionFieldType(Field field, int i2) {
        return getGenericFieldType(field, Collection.class, 0, null, i2);
    }
    ...
    public static Class<?> getCollectionReturnType(Method method, int i2) {
        return getGenericReturnType(method, Collection.class, 0, i2);
    }
    ...
    private static Class<?> getGenericReturnType(Method method, Class<?> cls, int i2, int i3) {
        return extractType(method.getGenericReturnType(), cls, i2, null, null, i3, 1);
    }
    ...
    public static Class<?> getMapKeyFieldType(Field field, int i2) {
        return getGenericFieldType(field, Map.class, 0, null, i2);
    }
    ...
    public static Class<?> getMapKeyReturnType(Method method, int i2) {
        return getGenericReturnType(method, Map.class, 0, i2);
    }
    ...
    public static Class<?> getMapValueFieldType(Field field, int i2) {
        return getGenericFieldType(field, Map.class, 1, null, i2);
    }
    ...
    public static Class<?> getMapValueReturnType(Method method, int i2) {
        return getGenericReturnType(method, Map.class, 1, i2);
    }
