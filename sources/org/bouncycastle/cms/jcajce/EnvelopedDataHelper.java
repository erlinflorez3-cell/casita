...
public class EnvelopedDataHelper {
    ...
    /* JADX INFO: renamed from: org.bouncycastle.cms.jcajce.EnvelopedDataHelper$1 */
    ...
    /* JADX INFO: renamed from: org.bouncycastle.cms.jcajce.EnvelopedDataHelper$2 */
    ...
    AlgorithmParameters generateParameters(ASN1ObjectIdentifier aSN1ObjectIdentifier, SecretKey secretKey, SecureRandom secureRandom) throws Throwable {
        String strZd = Wg.Zd("lE l@\u001e\u0003c*\u0011\u0005N\u0016\u000772vm,\u0010ZU\u0015mG\nt\u001ai", (short) (C1499aX.Xd() ^ (-8679)), (short) (C1499aX.Xd() ^ (-2849)));
        try {
            ...
            if (aSN1ObjectIdentifier.equals(CMSAlgorithm.RC2_CBC)) {
                ...
                Object[] objArr = {bArr};
                Method method = Class.forName(C1561oA.Xd(".&<(u</.A?7CI~%87JH<*:H?KJ", (short) (C1580rY.Xd() ^ (-3860)))).getMethod(Wg.vd("3)?:\u000397'0", (short) (C1633zX.Xd() ^ (-10263))), byte[].class);
                try {
                    ...
                    try {
                        ...
                        throw new CMSException(strZd + e2, e2);
                    }
            ...
            throw new CMSException(Qg.kd("\u001f1\u001b\u001c&)\u001d\" P\u0013!\u0013\u000e \u0014\u0018\u0010G\b\u0012\f\u0013\u0015\u000b\u0015\b\f=\r|\rz\u0006|\u000bz\u00073yv~t\u0001n\u0001z|C(", (short) (FB.Xd() ^ 7453), (short) (FB.Xd() ^ 24020)) + e4, e4);
        }
    }
