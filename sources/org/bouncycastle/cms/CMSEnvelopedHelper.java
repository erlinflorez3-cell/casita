        ...
        public InputStream getInputStream() throws CMSException, IOException {
            return new FilterInputStream(this.readable.getInputStream()) { // from class: org.bouncycastle.cms.CMSEnvelopedHelper.CMSDigestAuthenticatedSecureReadable.1
                ...
                public int read() throws IOException {
                    int i2 = this.in.read();
                    if (i2 >= 0) {
                        CMSDigestAuthenticatedSecureReadable.this.digestCalculator.getOutputStream().write(i2);
                    }
                    return i2;
                }
                ...
                public int read(byte[] bArr, int i2, int i3) throws IOException {
                    ...
                    if (i4 >= 0) {
                        CMSDigestAuthenticatedSecureReadable.this.digestCalculator.getOutputStream().write(bArr, i2, i4);
                    }
                    return i4;
                }
            };
