...
public class CMSSignedDataParser extends CMSContentInfoParser {
        ...
        try {
            ...
            if (content instanceof ASN1OctetStringParser) {
                ...
                if (aSN1OctetStringParser != null) {
                    pKCS7TypedStream = new CMSTypedStream(encapContentInfo.getContentType(), aSN1OctetStringParser.getOctetStream());
    ...
    private static void writeSetToGeneratorTagged(ASN1Generator aSN1Generator, ASN1SetParser aSN1SetParser, int i2) throws IOException {
        ASN1Set aSN1Set = getASN1Set(aSN1SetParser);
        if (aSN1Set != null) {
            boolean z2 = aSN1SetParser instanceof BERSetParser;
            OutputStream rawOutputStream = aSN1Generator.getRawOutputStream();
            if (z2) {
                rawOutputStream.write(new BERTaggedObject(false, i2, aSN1Set).getEncoded());
            } else {
                rawOutputStream.write(new DERTaggedObject(false, i2, aSN1Set).getEncoded());
            }
        }
    }
