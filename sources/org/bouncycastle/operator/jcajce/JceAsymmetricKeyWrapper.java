...
public class JceAsymmetricKeyWrapper extends AsymmetricKeyWrapper {
    ...
    static {
        ...
        map.put(McElieceCCA2ParameterSpec.DEFAULT_MD, new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha256, DERNull.INSTANCE));
        ...
        map.put(MessageDigestAlgorithms.SHA_512_224, new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha512_224, DERNull.INSTANCE));
        ...
        map.put(MessageDigestAlgorithms.SHA_512_256, new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha512_256, DERNull.INSTANCE));
