...
public class JceAsymmetricKeyUnwrapper extends AsymmetricKeyUnwrapper {
    ...
    */
    public org.bouncycastle.operator.GenericKey generateUnwrappedKey(org.bouncycastle.asn1.x509.AlgorithmIdentifier r6, byte[] r7) throws org.bouncycastle.operator.OperatorException {
        /*
            r5 = this;
            org.bouncycastle.operator.jcajce.OperatorHelper r2 = r5.helper     // Catch: javax.crypto.BadPaddingException -> L68 javax.crypto.IllegalBlockSizeException -> L82 java.security.InvalidKeyException -> L9c
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r0 = r5.getAlgorithmIdentifier()     // Catch: javax.crypto.BadPaddingException -> L68 javax.crypto.IllegalBlockSizeException -> L82 java.security.InvalidKeyException -> L9c
            org.bouncycastle.asn1.ASN1ObjectIdentifier r1 = r0.getAlgorithm()     // Catch: javax.crypto.BadPaddingException -> L68 javax.crypto.IllegalBlockSizeException -> L82 java.security.InvalidKeyException -> L9c
            ...
            org.bouncycastle.operator.jcajce.OperatorHelper r1 = r5.helper     // Catch: javax.crypto.BadPaddingException -> L68 javax.crypto.IllegalBlockSizeException -> L82 java.security.InvalidKeyException -> L9c
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r0 = r5.getAlgorithmIdentifier()     // Catch: javax.crypto.BadPaddingException -> L68 javax.crypto.IllegalBlockSizeException -> L82 java.security.InvalidKeyException -> L9c
        ...
        L2a:
            org.bouncycastle.operator.jcajce.OperatorHelper r1 = r5.helper     // Catch: java.lang.Throwable -> L46 javax.crypto.BadPaddingException -> L68 javax.crypto.IllegalBlockSizeException -> L82 java.security.InvalidKeyException -> L9c
            org.bouncycastle.asn1.ASN1ObjectIdentifier r0 = r6.getAlgorithm()     // Catch: java.lang.Throwable -> L46 javax.crypto.BadPaddingException -> L68 javax.crypto.IllegalBlockSizeException -> L82 java.security.InvalidKeyException -> L9c
        ...
        L4b:
            ...
            org.bouncycastle.asn1.ASN1ObjectIdentifier r0 = r6.getAlgorithm()     // Catch: javax.crypto.BadPaddingException -> L68 javax.crypto.IllegalBlockSizeException -> L82 java.security.InvalidKeyException -> L9c
        ...
        L62:
            org.bouncycastle.operator.jcajce.JceGenericKey r0 = new org.bouncycastle.operator.jcajce.JceGenericKey     // Catch: javax.crypto.BadPaddingException -> L68 javax.crypto.IllegalBlockSizeException -> L82 java.security.InvalidKeyException -> L9c
