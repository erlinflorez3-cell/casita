...
public class PolynomialRingGF2m {
    ...
    private PolynomialGF2mSmallM f27795p;
    ...
    public PolynomialRingGF2m(GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM) {
        ...
        this.f27795p = polynomialGF2mSmallM;
    ...
    private void computeSquareRootMatrix() {
        int coefficient;
        int degree = this.f27795p.getDegree();
    ...
    private void computeSquaringMatrix() {
        ...
        while (i2 < degree) {
            ...
            iArr2[i5] = 1;
            this.sqMatrix[i2] = new PolynomialGF2mSmallM(this.field, iArr2).mod(this.f27795p);
            i2++;
        }
    }
