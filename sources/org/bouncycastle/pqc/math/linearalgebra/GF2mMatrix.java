...
public class GF2mMatrix extends Matrix {
    ...
    public GF2mMatrix(GF2mField gF2mField, byte[] bArr) {
        ...
        byte b2 = bArr[3];
        this.numRows = (((((b2 + 255) - (b2 | 255)) << 24) ^ ((bArr[2] & 255) << 16)) ^ (((-1) - (((-1) - bArr[1]) | ((-1) - 255))) << 8)) ^ ((-1) - (((-1) - bArr[0]) | ((-1) - 255)));
        int i4 = i3 * this.numRows;
        if (this.numRows > 0) {
            int i5 = 4;
    ...
    public byte[] getEncoded() {
        ...
        int i6 = this.numRows >>> 24;
        bArr[3] = (byte) ((i6 + 255) - (i6 | 255));
        for (int i7 = 0; i7 < this.numRows; i7++) {
