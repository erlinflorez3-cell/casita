...
public final class ByteUtils {
    ...
    public static String toHexString(byte[] bArr) {
        ...
        for (int i2 = 0; i2 < bArr.length; i2++) {
            ...
            char[] cArr = HEX_CHARS;
            str = sbAppend.append(cArr[(bArr[i2] >>> 4) & 15]).toString() + cArr[bArr[i2] & Ascii.SI];
        }
        return str;
    }
    ...
    public static String toHexString(byte[] bArr, String str, String str2) {
        ...
        for (int i2 = 0; i2 < bArr.length; i2++) {
            ...
            char[] cArr = HEX_CHARS;
            str3 = sbAppend.append(cArr[(-1) - (((-1) - (bArr[i2] >>> 4)) | ((-1) - 15))]).toString() + cArr[(-1) - (((-1) - bArr[i2]) | ((-1) - 15))];
            if (i2 < bArr.length - 1) {
                str3 = str3 + str2;
            }
        }
