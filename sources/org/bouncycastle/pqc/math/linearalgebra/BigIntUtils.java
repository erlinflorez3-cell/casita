...
public final class BigIntUtils {
    ...
    public static boolean equals(BigInteger[] bigIntegerArr, BigInteger[] bigIntegerArr2) {
        ...
        for (int i3 = 0; i3 < bigIntegerArr.length; i3++) {
            int iCompareTo = bigIntegerArr[i3].compareTo(bigIntegerArr2[i3]);
            i2 = (i2 + iCompareTo) - (i2 & iCompareTo);
        }
        return i2 == 0;
    }
    ...
    public static byte[] toMinimalByteArray(BigInteger bigInteger) {
        ...
        if (byteArray.length != 1) {
            ...
            if ((iBitLength + 7) - (iBitLength | 7) == 0) {
                int iBitLength2 = bigInteger.bitLength() >> 3;
                byte[] bArr = new byte[iBitLength2];
                System.arraycopy(byteArray, 1, bArr, 0, iBitLength2);
                return bArr;
            }
        }
        return byteArray;
