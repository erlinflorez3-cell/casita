...
final class Conversions {
    ...
    public static byte[] signConversion(int i2, int i3, byte[] bArr) {
        ...
        if (bArr.length < i9) {
            ...
            int i10 = (1 << i6) - 1;
            int i11 = bArr[i7];
            bArr2[i7] = (byte) ((i11 + i10) - (i11 | i10));
        }
        BigInteger bigIntegerAdd = ZERO;
        int i12 = i2;
        for (int i13 = 0; i13 < i2; i13++) {
            bigIntegerBinomial = bigIntegerBinomial.multiply(new BigInteger(Integer.toString(i12 - i3))).divide(new BigInteger(Integer.toString(i12)));
            i12--;
            if (((byte) ((-1) - (((-1) - bArr2[i13 >>> 3]) | ((-1) - (1 << ((-1) - (((-1) - i13) | ((-1) - 7)))))))) != 0) {
                bigIntegerAdd = bigIntegerAdd.add(bigIntegerBinomial);
                int i14 = i3 - 1;
                bigIntegerBinomial = i12 == i14 ? ONE : bigIntegerBinomial.multiply(new BigInteger(Integer.toString(i3))).divide(new BigInteger(Integer.toString(i12 - i14)));
                i3 = i14;
            }
        }
        int i15 = i4 + 1;
        ...
        if (byteArray.length < i15) {
            ...
            for (int length2 = byteArray.length; length2 < i15; length2++) {
                bArr3[length2] = 0;
            }
        } else {
            System.arraycopy(byteArray, 0, bArr3, 0, i4);
            bArr3[i4] = (byte) ((-1) - (((-1) - ((1 << i5) - 1)) | ((-1) - byteArray[i4])));
        }
        return bArr3;
    }
}
