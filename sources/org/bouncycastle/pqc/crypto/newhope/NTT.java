    ...
    static void core(short[] sArr, short[] sArr2) {
        for (int i2 = 0; i2 < 10; i2 += 2) {
            ...
            for (int i4 = 0; i4 < i3; i4++) {
                ...
                int i6 = i4;
                while (i6 < 1023) {
                    int i7 = (-1) - (((-1) - sArr[i6]) | ((-1) - 65535));
                    int i8 = i6 + i3;
                    int i9 = sArr[i8] & 65535;
                    short s2 = sArr2[i5];
                    sArr[i6] = (short) (i7 + i9);
                    sArr[i8] = Reduce.montgomery(s2 * ((i7 + ExifDirectoryBase.TAG_DATETIME_ORIGINAL) - i9));
                    i6 += i3 * 2;
                    i5++;
                }
            }
            ...
            for (int i11 = 0; i11 < i10; i11++) {
                ...
                while (i13 < 1023) {
                    short s3 = sArr[i13];
                    int i14 = (s3 + 65535) - (s3 | 65535);
                    int i15 = i13 + i10;
                    int i16 = (-1) - (((-1) - sArr[i15]) | ((-1) - 65535));
                    short s4 = sArr2[i12];
                    sArr[i13] = Reduce.barrett((short) (i14 + i16));
                    sArr[i15] = Reduce.montgomery(s4 * ((i14 + ExifDirectoryBase.TAG_DATETIME_ORIGINAL) - i16));
                    i13 += i10 * 2;
                    i12++;
                }
            }
