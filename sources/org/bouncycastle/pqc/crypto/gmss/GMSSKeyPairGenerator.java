...
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private void initializeDefault() throws Throwable {
        ...
        int[] iArr2 = {3, 3, 3, 3};
        int[] iArr3 = {2, 2, 2, 2};
        short sXd = (short) (C1607wl.Xd() ^ 29177);
        int[] iArr4 = new int["0&:$o4%\"3/%/3f\u000b\u001c\u0019*&\u0018\u0004\u0012\u001e\u0013\u001d\u001a".length()];
        QB qb = new QB("0&:$o4%\"3/%/3f\u000b\u001c\u0019*&\u0018\u0004\u0012\u001e\u0013\u001d\u001a");
        int i2 = 0;
        while (qb.YK()) {
            int iKK = qb.KK();
            Xu xuXd = Xu.Xd(iKK);
            iArr4[i2] = xuXd.fK(sXd + sXd + sXd + i2 + xuXd.CK(iKK));
            i2++;
        }
        Object[] objArr = new Object[0];
        Constructor<?> constructor = Class.forName(new String(iArr4, 0, i2)).getConstructor(new Class[0]);
        try {
    ...
    public void initialize(KeyGenerationParameters keyGenerationParameters) throws Throwable {
        ...
        Object[] objArr = new Object[0];
        Constructor<?> constructor = Class.forName(C1593ug.zd(")!7#p7*)<:2>Dy 32EC7%5C:FE", (short) (C1580rY.Xd() ^ (-31402)), (short) (C1580rY.Xd() ^ (-3952)))).getConstructor(new Class[0]);
        try {
            constructor.setAccessible(true);
            SecureRandom secureRandom = (SecureRandom) constructor.newInstance(objArr);
            for (int i2 = 0; i2 < this.numLayer; i2++) {
                byte[] bArr = this.currentSeeds[i2];
                short sXd = (short) (Od.Xd() ^ (-12439));
                int[] iArr = new int["\u0003x\rvB\u0007wt\u0006\u0002w\u0002\u00069]nk|xjVdpeol".length()];
                QB qb = new QB("\u0003x\rvB\u0007wt\u0006\u0002w\u0002\u00069]nk|xjVdpeol");
                int i3 = 0;
                while (qb.YK()) {
                    int iKK = qb.KK();
                    Xu xuXd = Xu.Xd(iKK);
                ...
                Object[] objArr2 = {bArr};
                Method method = Class.forName(new String(iArr, 0, i3)).getMethod(C1561oA.Kd("\u0018\u0010$!o($\u0016%", (short) (C1499aX.Xd() ^ (-32306))), byte[].class);
                try {
