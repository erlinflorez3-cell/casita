...
public class Treehash {
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < this.tailLength + 6; i2++) {
            string = string + getStatInt()[i2] + Global.BLANK;
        }
        for (int i3 = 0; i3 < this.tailLength + 3; i3++) {
            string = (getStatByte()[i3] != null ? new StringBuilder().append(string).append(new String(Hex.encode(getStatByte()[i3]))).append(Global.BLANK) : new StringBuilder().append(string).append("null ")).toString();
        }
