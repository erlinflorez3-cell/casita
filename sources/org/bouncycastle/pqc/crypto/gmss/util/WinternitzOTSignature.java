        ...
        if (8 % i5 == 0) {
            ...
            for (int i11 = 0; i11 < digestSize; i11++) {
                for (int i12 = 0; i12 < i7; i12++) {
                    ...
                    bArr4[i11] = (byte) (bArr4[i11] >>> this.f27744w);
                    i10++;
                }
            }
            int i15 = (this.messagesize << this.f27744w) - i9;
            int i16 = 0;
            ...
            while (i23 < i21) {
                long j2 = 0;
                for (int i27 = 0; i27 < this.f27744w; i27++) {
                    byte b2 = bArr4[i24];
            ...
            int i31 = this.mdsize % this.f27744w;
            long j3 = 0;
            ...
            while (i34 < i33) {
                ...
                int i37 = this.f27744w;
                j3 >>>= i37;
                i25++;
                i34 += i37;
            }
            int i38 = (this.messagesize << this.f27744w) - i26;
            int i39 = 0;
            ...
            while (i47 <= i44) {
                ...
                for (int i52 = i47 >>> 3; i52 < i50; i52++) {
                    byte b3 = bArr4[i52];
                    j4 ^= (long) (((b3 + 255) - (b3 | 255)) << (i51 << 3));
                    i51++;
                }
                long j5 = (-1) - (((-1) - (j4 >>> i49)) | ((-1) - ((long) i45)));
                i46 = (int) (((long) i46) + j5);
            ...
            if (i54 < this.mdsize) {
                ...
                while (true) {
                    ...
                    j6 ^= (long) ((bArr4[i54] & 255) << (i56 << 3));
                    i56++;
                    i54++;
                }
                long j7 = (-1) - (((-1) - (j6 >>> i55)) | ((-1) - ((long) i45)));
                i46 = (int) (((long) i46) + j7);
            ...
            int i58 = (this.messagesize << this.f27744w) - i46;
            int i59 = 0;
            while (i59 < this.checksumsize) {
                System.arraycopy(this.privateKeyOTS[i48], 0, bArr7, 0, this.mdsize);
                for (long j8 = (i58 + i45) - (i58 | i45); j8 > 0; j8--) {
                    this.messDigestOTS.update(bArr7, 0, bArr7.length);
                    bArr7 = new byte[this.messDigestOTS.getDigestSize()];
                    this.messDigestOTS.doFinal(bArr7, 0);
                }
