...
public class GMSSPrivateKeyParameters extends GMSSKeyParameters {
    ...
    private void computeAuthPaths(int i2) {
        ...
        int i8 = i4 >>> (iHeightOfPhi + 1);
        int i9 = (i8 + 1) - (i8 | 1);
        int i10 = this.mdLength;
        byte[] bArr2 = new byte[i10];
        int i11 = i5 - 1;
        if (iHeightOfPhi < i11 && i9 == 0) {
            System.arraycopy(this.currentAuthPaths[i2][iHeightOfPhi], 0, bArr2, 0, i10);
        }
        ...
        if (iHeightOfPhi == 0) {
            if (i2 == this.numLayer - 1) {
                ...
                System.arraycopy(this.currentSeeds[i2], 0, bArr4, 0, i12);
            ...
            System.arraycopy(this.currentAuthPaths[i2][iHeightOfPhi - 1], 0, bArr5, 0, i12);
            byte[] bArr6 = this.keep[i2][(int) Math.floor(r1 / 2)];
            int i14 = this.mdLength;
            System.arraycopy(bArr6, 0, bArr5, i14, i14);
            this.messDigestTrees.update(bArr5, 0, i13);
            ...
            for (int i15 = 0; i15 < iHeightOfPhi; i15++) {
                if (i15 < i3) {
                ...
                if (i15 < i11 && i15 >= i3) {
                    ...
                    if (this.currentRetain[i2][i16].size() > 0) {
                        ...
                        Vector vector = this.currentRetain[i2][i16];
                        vector.removeElementAt(vector.size() - 1);
                    }
                }
                if (i15 < i3 && ((1 << i15) * 3) + i4 < this.numLeafs[i2]) {
