...
public class McEliecePrivateKey extends ASN1Object {
    ...
    private McEliecePrivateKey(ASN1Sequence aSN1Sequence) {
        this.f27728n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).getValue().intValue();
        this.f27727k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f27728n));
        aSN1EncodableVector.add(new ASN1Integer(this.f27727k));
