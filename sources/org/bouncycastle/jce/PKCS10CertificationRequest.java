    ...
    */
    public PKCS10CertificationRequest(java.lang.String r5, org.bouncycastle.asn1.x509.X509Name r6, java.security.PublicKey r7, org.bouncycastle.asn1.ASN1Set r8, java.security.PrivateKey r9, java.lang.String r10) throws java.security.NoSuchAlgorithmException, java.security.SignatureException, java.security.InvalidKeyException, java.security.NoSuchProviderException {
        /*
            r4 = this;
            r4.<init>()
            java.lang.String r3 = org.bouncycastle.util.Strings.toUpperCase(r5)
            ...
            if (r2 != 0) goto L1f
            org.bouncycastle.asn1.ASN1ObjectIdentifier r2 = new org.bouncycastle.asn1.ASN1ObjectIdentifier     // Catch: java.lang.Exception -> L17
        ...
        L30:
            ...
            goto L53
        L33:
            java.util.Hashtable r0 = org.bouncycastle.jce.PKCS10CertificationRequest.params
        ...
        L4b:
            ...
            goto L30
        L53:
            byte[] r0 = r7.getEncoded()     // Catch: java.io.IOException -> La4
            org.bouncycastle.asn1.ASN1Primitive r0 = org.bouncycastle.asn1.ASN1Primitive.fromByteArray(r0)     // Catch: java.io.IOException -> La4
            org.bouncycastle.asn1.ASN1Sequence r0 = (org.bouncycastle.asn1.ASN1Sequence) r0     // Catch: java.io.IOException -> La4
            org.bouncycastle.asn1.pkcs.CertificationRequestInfo r1 = new org.bouncycastle.asn1.pkcs.CertificationRequestInfo     // Catch: java.io.IOException -> La4
            org.bouncycastle.asn1.x509.SubjectPublicKeyInfo r0 = org.bouncycastle.asn1.x509.SubjectPublicKeyInfo.getInstance(r0)     // Catch: java.io.IOException -> La4
            r1.<init>(r6, r0, r8)     // Catch: java.io.IOException -> La4
            r4.reqInfo = r1     // Catch: java.io.IOException -> La4
            if (r10 != 0) goto L72
            java.security.Signature r2 = java.security.Signature.getInstance(r5)
        L6e:
            r2.initSign(r9)
            goto L77
        L72:
            java.security.Signature r2 = java.security.Signature.getInstance(r5, r10)
            goto L6e
        L77:
            org.bouncycastle.asn1.pkcs.CertificationRequestInfo r1 = r4.reqInfo     // Catch: java.lang.Exception -> L8e
            java.lang.String r0 = "DER"
            byte[] r0 = r1.getEncoded(r0)     // Catch: java.lang.Exception -> L8e
            r2.update(r0)     // Catch: java.lang.Exception -> L8e
        ...
        L8e:
            ...
            java.lang.String r0 = "exception encoding TBS cert request - "
            r1.<init>(r0)
        ...
        La4:
            java.lang.IllegalArgumentException r1 = new java.lang.IllegalArgumentException
            java.lang.String r0 = "can't encode public key"
            r1.<init>(r0)
            throw r1
        Lac:
            java.lang.IllegalArgumentException r1 = new java.lang.IllegalArgumentException
            java.lang.String r0 = "public key must not be null"
            r1.<init>(r0)
            throw r1
        Lb4:
            java.lang.IllegalArgumentException r1 = new java.lang.IllegalArgumentException
            java.lang.String r0 = "subject must not be null"
            r1.<init>(r0)
            throw r1
        */
