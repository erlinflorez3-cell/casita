...
class RFC3280CertPathUtilities {
    ...
    private static void checkCRL(DistributionPoint distributionPoint, PKIXExtendedParameters pKIXExtendedParameters, X509Certificate x509Certificate, Date date, X509Certificate x509Certificate2, PublicKey publicKey, CertStatus certStatus, ReasonsMask reasonsMask, List list, JcaJceHelper jcaJceHelper) throws Throwable {
        ...
        if (date.getTime() > date2.getTime()) {
            throw new AnnotatedException(ZO.xd("0\u0015Rg\t\u0019a\u0003\u0012xz#?\u000ff\u0002kV5i/]S\u0012Bq]/g", (short) (C1580rY.Xd() ^ (-22480)), (short) (C1580rY.Xd() ^ (-9940))));
        }
                ...
                if (reasonsMaskProcessCRLD.hasNewReasons(reasonsMask)) {
                    try {
                        ...
                        if (pKIXExtendedParameters.getValidityModel() != 1) {
                            ...
                            Method method = Class.forName(C1561oA.ud("\u000e\u0004\u0018\u0002M\u0012\u0003\u007f\u0011\r\u0003\r\u0011Dxy\u0006\u0007?hD>FOp|}qmohewg", (short) (ZN.Xd() ^ 12464))).getMethod(C1561oA.yd("QN`9]a1UfVf", (short) (FB.Xd() ^ 5186)), new Class[0]);
                            try {
                                method.setAccessible(true);
                                if (((Date) method.invoke(x509Certificate, objArr)).getTime() < x509crl.getThisUpdate().getTime()) {
                                    throw new AnnotatedException(C1561oA.Yd("\u00168iA-973o\u0014$\u001fs;EIw<OMNBLS\u007fUKPI\u0005LV]WN\u0019", (short) (FB.Xd() ^ 31791)));
                                }
                        ...
                        if (criticalExtensionOIDs2 != null) {
                            ...
                            if (!hashSet.isEmpty()) {
                                throw new AnnotatedException(Xg.qd("Td_4x\u0006\u0006\rz\u0004\n\u0010=\u0014\u000e\u0014\u0017\u0013\u0014\u0014\u0018\u001b\r\rI\u000e\u001e\u0016\"\u0018\u0013\u0012\u001eR\u0019-*\u001c&,#**0k", (short) (C1633zX.Xd() ^ (-31356)), (short) (C1633zX.Xd() ^ (-8794))));
                            }
                        }
                        if (x509crlProcessCRLH != null && (criticalExtensionOIDs = x509crlProcessCRLH.getCriticalExtensionOIDs()) != null) {
                            ...
                            if (!hashSet2.isEmpty()) {
                                throw new AnnotatedException(Jg.Wd("@I/%p\r~k@\u0002$>\u001c\u007f[AA\u0014\u001fb:\u001d-\u0006`M/~N+Uv@F/\u0013jG .QS-*\u0015t\\Y:D", (short) (FB.Xd() ^ 1946), (short) (FB.Xd() ^ 78)));
                            }
                        }
                        z2 = true;
  ...
  0x00cc: PHI (r2v10 'e' org.bouncycastle.jce.provider.AnnotatedException) = 
  (r2v9 'e' org.bouncycastle.jce.provider.AnnotatedException)
  (r2v14 'e' org.bouncycastle.jce.provider.AnnotatedException)
  (r2v9 'e' org.bouncycastle.jce.provider.AnnotatedException)
 binds: [B:120:0x0086, B:128:0x00cb, B:122:0x008c] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    protected static void checkCRLs(org.bouncycastle.jcajce.PKIXExtendedParameters r19, java.security.cert.X509Certificate r20, java.util.Date r21, java.security.cert.X509Certificate r22, java.security.PublicKey r23, java.util.List r24, org.bouncycastle.jcajce.util.JcaJceHelper r25) throws java.lang.Throwable {
        /*
    ...
    /* JADX WARN: Code restructure failed: missing block: B:139:0x00d0, code lost:
        ...
        r12 = ((org.bouncycastle.asn1.ASN1Sequence) org.bouncycastle.jce.provider.CertPathValidatorUtilities.getExtensionValue(r7, org.bouncycastle.jce.provider.RFC3280CertPathUtilities.CERTIFICATE_POLICIES)).getObjects();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:142:0x00da, code lost:
        ...
        r1 = org.bouncycastle.asn1.x509.PolicyInformation.getInstance(r12.nextElement());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:145:0x00f0, code lost:
        ...
        r19 = org.bouncycastle.jce.provider.CertPathValidatorUtilities.getQualifierSet(r1.getPolicyQualifiers());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:149:0x0101, code lost:
        ...
        r10 = r7.getCriticalExtensionOIDs().contains(org.bouncycastle.jce.provider.RFC3280CertPathUtilities.CERTIFICATE_POLICIES);
     */
    /* JADX WARN: Code restructure failed: missing block: B:150:0x010b, code lost:
    
        r2 = (org.bouncycastle.jce.provider.PKIXPolicyNode) r2.getParent();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:152:0x011b, code lost:
        ...
        r14 = new org.bouncycastle.jce.provider.PKIXPolicyNode(new java.util.ArrayList(), r16, (java.util.Set) r4.get(r3), r2, r19, r3, r10);
        r2.addChild(r14);
        r22[r16].add(r14);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:173:0x0196, code lost:
        ...
        throw new org.bouncycastle.jce.exception.ExtCertPathValidatorException("Policy qualifier info set could not be decoded.", r2, r20, r21);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:179:0x01a8, code lost:
        ...
        throw new org.bouncycastle.jce.exception.ExtCertPathValidatorException("Certificate policies extension could not be decoded.", r2, r20, r21);
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    protected static org.bouncycastle.jce.provider.PKIXPolicyNode prepareCertB(java.security.cert.CertPath r20, int r21, java.util.List[] r22, org.bouncycastle.jce.provider.PKIXPolicyNode r23, int r24) throws java.security.cert.CertPathValidatorException {
        /*
    ...
    /* JADX WARN: Code restructure failed: missing block: B:37:0x002e, code lost:
        ...
        r0 = org.bouncycastle.asn1.ASN1Integer.getInstance(r1, false).getValue().intValue();
     */
    ...
    */
    protected static int prepareNextCertI1(java.security.cert.CertPath r3, int r4, int r5) throws java.security.cert.CertPathValidatorException {
        /*
            ...
            java.lang.String r0 = org.bouncycastle.jce.provider.RFC3280CertPathUtilities.POLICY_CONSTRAINTS     // Catch: java.lang.Exception -> L48
            org.bouncycastle.asn1.ASN1Primitive r0 = org.bouncycastle.jce.provider.CertPathValidatorUtilities.getExtensionValue(r1, r0)     // Catch: java.lang.Exception -> L48
        ...
        L1a:
            ...
            org.bouncycastle.asn1.ASN1TaggedObject r1 = org.bouncycastle.asn1.ASN1TaggedObject.getInstance(r0)     // Catch: java.lang.IllegalArgumentException -> L3e
    ...
    /* JADX WARN: Code restructure failed: missing block: B:37:0x002f, code lost:
        ...
        r0 = org.bouncycastle.asn1.ASN1Integer.getInstance(r2, false).getValue().intValue();
     */
    ...
    */
    protected static int prepareNextCertI2(java.security.cert.CertPath r4, int r5, int r6) throws java.security.cert.CertPathValidatorException {
        /*
            ...
            java.security.cert.X509Certificate r1 = (java.security.cert.X509Certificate) r1
            java.lang.String r0 = org.bouncycastle.jce.provider.RFC3280CertPathUtilities.POLICY_CONSTRAINTS     // Catch: java.lang.Exception -> L49
            org.bouncycastle.asn1.ASN1Primitive r0 = org.bouncycastle.jce.provider.CertPathValidatorUtilities.getExtensionValue(r1, r0)     // Catch: java.lang.Exception -> L49
            org.bouncycastle.asn1.ASN1Sequence r0 = org.bouncycastle.asn1.DERSequence.getInstance(r0)     // Catch: java.lang.Exception -> L49
            if (r0 == 0) goto L48
        ...
        L1a:
            ...
            org.bouncycastle.asn1.ASN1TaggedObject r2 = org.bouncycastle.asn1.ASN1TaggedObject.getInstance(r0)     // Catch: java.lang.IllegalArgumentException -> L3f
            int r1 = r2.getTagNo()     // Catch: java.lang.IllegalArgumentException -> L3f
            r0 = 1
            if (r1 != r0) goto L1a
            r0 = 0
            org.bouncycastle.asn1.ASN1Integer r0 = org.bouncycastle.asn1.ASN1Integer.getInstance(r2, r0)     // Catch: java.lang.IllegalArgumentException -> L3f
    ...
    protected static void prepareNextCertN(CertPath certPath, int i2) throws Throwable {
        ...
        Object[] objArr = new Object[0];
        Method method = Class.forName(C1626yg.Ud("{_L\u001ah?\u0003r\u0019\u001bg\u0011\u001dwo(|RVK81\u0019H\u001f8_pQ%2?\u007ft", (short) (OY.Xd() ^ 7270), (short) (OY.Xd() ^ 25858))).getMethod(Ig.wd("\u0015h\nwz2yw\u0017X\\", (short) (FB.Xd() ^ 6899)), new Class[0]);
        try {
            method.setAccessible(true);
            boolean[] zArr = (boolean[]) method.invoke(x509Certificate, objArr);
            if (zArr != null && !zArr[5]) {
                throw new ExtCertPathValidatorException(EO.Od("J#\u0013v(zV#|GM\u001efamG\bxlBs-\r\u0011fJ(\u0018E\b2>a\u0006G\u00197\u0007MGqN1 \u000b\u00166z\u001anJ\u0015h\u000e\u000e6,Z6\u0011'\r|1\u0001w-s^\u0010&une|g3\u0019mWr\n", (short) (C1499aX.Xd() ^ (-14610))), null, certPath, i2);
            }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:67:0x0032, code lost:
        ...
        if (r2.equals(r0) != false) goto L97;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    protected static void processCRLC(java.security.cert.X509CRL r4, java.security.cert.X509CRL r5, org.bouncycastle.jcajce.PKIXExtendedParameters r6) throws org.bouncycastle.jce.provider.AnnotatedException {
        /*
            if (r4 != 0) goto L3
            return
        L3:
            java.lang.String r3 = org.bouncycastle.jce.provider.RFC3280CertPathUtilities.ISSUING_DISTRIBUTION_POINT     // Catch: java.lang.Exception -> L8d
            org.bouncycastle.asn1.ASN1Primitive r0 = org.bouncycastle.jce.provider.CertPathValidatorUtilities.getExtensionValue(r5, r3)     // Catch: java.lang.Exception -> L8d
            org.bouncycastle.asn1.x509.IssuingDistributionPoint r2 = org.bouncycastle.asn1.x509.IssuingDistributionPoint.getInstance(r0)     // Catch: java.lang.Exception -> L8d
            boolean r0 = r6.isUseDeltasEnabled()
            if (r0 == 0) goto L74
            org.bouncycastle.asn1.x500.X500Name r1 = org.bouncycastle.jce.provider.PrincipalUtils.getIssuerPrincipal(r4)
            org.bouncycastle.asn1.x500.X500Name r0 = org.bouncycastle.jce.provider.PrincipalUtils.getIssuerPrincipal(r5)
            boolean r0 = r1.equals(r0)
            if (r0 == 0) goto L62
            org.bouncycastle.asn1.ASN1Primitive r0 = org.bouncycastle.jce.provider.CertPathValidatorUtilities.getExtensionValue(r4, r3)     // Catch: java.lang.Exception -> L59
            org.bouncycastle.asn1.x509.IssuingDistributionPoint r0 = org.bouncycastle.asn1.x509.IssuingDistributionPoint.getInstance(r0)     // Catch: java.lang.Exception -> L59
            if (r2 != 0) goto L2e
            if (r0 != 0) goto L51
            goto L34
        L2e:
            ...
            if (r0 == 0) goto L51
        L34:
            java.lang.String r0 = org.bouncycastle.jce.provider.RFC3280CertPathUtilities.AUTHORITY_KEY_IDENTIFIER     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> L48
            org.bouncycastle.asn1.ASN1Primitive r1 = org.bouncycastle.jce.provider.CertPathValidatorUtilities.getExtensionValue(r5, r0)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> L48
            org.bouncycastle.asn1.ASN1Primitive r0 = org.bouncycastle.jce.provider.CertPathValidatorUtilities.getExtensionValue(r4, r0)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> L3f
            goto L6a
        L3f:
            r2 = move-exception
        ...
        L8d:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.jce.provider.RFC3280CertPathUtilities.processCRLC(java.security.cert.X509CRL, java.security.cert.X509CRL, org.bouncycastle.jcajce.PKIXExtendedParameters):void");
    }
        ...
        try {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (x509Certificate2.equals(x509Certificate)) {
                        ...
                        try {
                            ...
                            throw new AnnotatedException(C1593ug.zd("`\u0004\u0012\u0015q\u0004\u0018\rE\r\u0017\u001bIm}xM\"\u0019\u0018 \u0018&T\u001c\u0018!%\u001f\u001f[1-^6\".,(&:,u", (short) (C1607wl.Xd() ^ 27601), (short) (C1607wl.Xd() ^ 15769)), e2);
                        } catch (CertPathValidatorException e3) {
                            throw new AnnotatedException(C1561oA.Qd("\u00148$-)\"](!4Y(\u001eV\u001f('(\u0017#O\u0012\u0013\u001f \u0014\u0010\u0012\u000b\b\u001a\nC\u0012\b@bpi<~\n\u000f\u0005{6\u0004\u0004\b2su/\u0001r\u0001}sn~lj3", (short) (C1499aX.Xd() ^ (-31436))), e3);
                        } catch (Exception e4) {
                ...
                for (i2 = 0; i2 < arrayList.size(); i2++) {
                    ...
                    Class<?> cls = Class.forName(C1561oA.od("+!5\u001fj/ \u001d.* *.a\u0016\u0017#$\\\u0006a[cl\u000e\u001a\u001b\u000f\u000b\r\u0006\u0003\u0015\u0005", (short) (Od.Xd() ^ (-17064))));
                    Class<?>[] clsArr = new Class[0];
                    Object[] objArr = new Object[0];
                    short sXd = (short) (C1633zX.Xd() ^ (-7520));
                    ...
                    try {
                        ...
                        if (zArr == null || (zArr.length >= 7 && zArr[6])) {
                            ...
                            short sXd2 = (short) (C1580rY.Xd() ^ (-25925));
                            short sXd3 = (short) (C1580rY.Xd() ^ (-492));
                            int[] iArr2 = new int["\u000by\r\u000f\n&R%2?T\tN`\u001ek\n:CNS7!\u0006Hu\u000f\rR'9D@IaTes)|\u0013\u0004%\u0011+;\u0004\u007f[\u0010pj2\bv)\u0004=$4u\u0003\u000e\u0018(\u001cu".length()];
                            QB qb2 = new QB("\u000by\r\u000f\n&R%2?T\tN`\u001ek\n:CNS7!\u0006Hu\u000f\rR'9D@IaTes)|\u0013\u0004%\u0011+;\u0004\u007f[\u0010pj2\bv)\u0004=$4u\u0003\u000e\u0018(\u001cu");
                            int i4 = 0;
                            while (qb2.YK()) {
                                int iKK2 = qb2.KK();
                                Xu xuXd2 = Xu.Xd(iKK2);
                            ...
                            annotatedException = new AnnotatedException(new String(iArr2, 0, i4));
                        }
                ...
                if (hashSet.isEmpty() && annotatedException == null) {
                    throw new AnnotatedException(C1561oA.Xd("p\u0010\u001e\u001f!'S\u001b\u001f%\u001cX\u001bZ2\u001e*($`+67:+9g,/=@64832F8\u0002", (short) (Od.Xd() ^ (-25137))));
                }
                if (!hashSet.isEmpty() || annotatedException == null) {
                    return hashSet;
                }
                ...
                short sXd4 = (short) (Od.Xd() ^ (-1376));
                int[] iArr3 = new int["t \u001d \u0015#M\u0012\t\u0017\u0016\f\u000e\u0012\t\b0\"Y!/3]\u0002\u0006\u0001Q\u0016\u0019'$&@l,0oD306(*(,v".length()];
                QB qb3 = new QB("t \u001d \u0015#M\u0012\t\u0017\u0016\f\u000e\u0012\t\b0\"Y!/3]\u0002\u0006\u0001Q\u0016\u0019'$&@l,0oD306(*(,v");
                int i5 = 0;
                while (qb3.YK()) {
                    int iKK3 = qb3.KK();
                    Xu xuXd3 = Xu.Xd(iKK3);
                ...
                throw new AnnotatedException(new String(iArr3, 0, i5), e6);
            }
        } catch (IOException e7) {
            throw new AnnotatedException(Qg.kd("\u0001\"\u000e\u0015\u000f\f\u001cF\t\u0017\r\u0017\u0007\u0013\t\u007f=\u0003\u000b\r9{|\t\n}y{tq\u0004s-\u007fpvnk{uw$wq!fhla\u001cdmlm\\h\u0015WXdeYUWPM_O\tNVX\u0005'5.\u0001CNSI@zHHLv8:sF7E}", (short) (OY.Xd() ^ 9999), (short) (OY.Xd() ^ 10109)), e7);
        }
    }
    ...
    protected static void processCertA(CertPath certPath, PKIXExtendedParameters pKIXExtendedParameters, int i2, PublicKey publicKey, boolean z2, X500Name x500Name, X509Certificate x509Certificate, JcaJceHelper jcaJceHelper) throws Throwable {
        String strVd = hg.Vd("\u0018CH>5o==AkA+51+'9)b%&23'#%\u001e\u001b-\u001dpU", (short) (C1607wl.Xd() ^ 8537), (short) (C1607wl.Xd() ^ 4709));
        ...
        if (!z2) {
            try {
                ...
                throw new ExtCertPathValidatorException(C1561oA.ud("[\u0007\f\u0002x3\u0001\u0001\u0005/\u0005nxtnj|l&hiuvjfha^p`\u001ala^dVhhdV\u001e", (short) (C1499aX.Xd() ^ (-6523))), e2, certPath, i2);
            }
        }
        try {
            ...
            Class<?> cls = Class.forName(C1561oA.yd("\u001b\u0011%\u000fb'\u0018\u0015\u001e\u001a\u0010\u001a&Y\u000e\u000f\u0013\u0014LuYS[d}\n\u000b~\u0003\u0005}z\u0005t", (short) (C1580rY.Xd() ^ (-28070))));
            Class<?>[] clsArr = new Class[1];
            clsArr[0] = Class.forName(C1561oA.Yd(":2H4\u0002JJ@D\u0007\u001e<PB", (short) (C1607wl.Xd() ^ 12656)));
            Object[] objArr = {validCertDateFromValidityModel};
            Method method = cls.getMethod(Xg.qd("msqpyeq}{w}\n\u0010", (short) (C1580rY.Xd() ^ (-24705)), (short) (C1580rY.Xd() ^ (-13734))), clsArr);
            try {
                method.setAccessible(true);
                ...
                if (!PrincipalUtils.getEncodedIssuerPrincipal(x509Certificate2).equals(x500Name)) {
                    throw new ExtCertPathValidatorException(Jg.Wd("_@\u0015M&G\u001aE6d\u007f", (short) (FB.Xd() ^ 8261), (short) (FB.Xd() ^ 18233)) + PrincipalUtils.getEncodedIssuerPrincipal(x509Certificate2) + ZO.xd("h|$\u0018C-\u001ali\u000f+EUh\u0015P\u001dSQ\u001f]W]{Vw\\V\u0004", (short) (C1633zX.Xd() ^ (-582)), (short) (C1633zX.Xd() ^ (-2374))) + x500Name + C1626yg.Ud("\u000f73ur%|\u0005Z5Xw\"`\u000by\u0019\u001985M\bI0\b", (short) (FB.Xd() ^ 26052), (short) (FB.Xd() ^ 10174)), null, certPath, i2);
                }
            ...
            throw new ExtCertPathValidatorException(Ig.wd("vMA,j\u0002`\u0001O^/c\u001f(-J\u0014\u0019yx&`x1=J$6L\n\"7^\u0006U\u0014;R2", (short) (FB.Xd() ^ 29126)), e7, certPath, i2);
        }
    }
