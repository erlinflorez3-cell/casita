...
public class X9ECParameters extends ASN1Object implements X9ObjectIdentifiers {
    ...
    private X9ECPoint f27489g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private BigInteger f27490h;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    private BigInteger f27491n;
    private byte[] seed;
    ...
    private X9ECParameters(ASN1Sequence aSN1Sequence) {
        ...
        if (objectAt instanceof X9ECPoint) {
            this.f27489g = (X9ECPoint) objectAt;
        } else {
            this.f27489g = new X9ECPoint(this.curve, (ASN1OctetString) objectAt);
        }
        this.f27491n = ((ASN1Integer) aSN1Sequence.getObjectAt(4)).getValue();
        this.seed = x9Curve.getSeed();
        if (aSN1Sequence.size() == 6) {
            this.f27490h = ((ASN1Integer) aSN1Sequence.getObjectAt(5)).getValue();
        }
    }
    ...
    public X9ECParameters(ECCurve eCCurve, X9ECPoint x9ECPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        X9FieldID x9FieldID;
        this.curve = eCCurve;
        this.f27489g = x9ECPoint;
        this.f27491n = bigInteger;
        this.f27490h = bigInteger2;
        this.seed = bArr;
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f27489g);
        aSN1EncodableVector.add(new ASN1Integer(this.f27491n));
        if (this.f27490h != null) {
            aSN1EncodableVector.add(new ASN1Integer(this.f27490h));
        }
