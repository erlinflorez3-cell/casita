...
public class ASN1StreamParser {
    ...
    public ASN1Encodable readObject() throws IOException {
        ...
        if (length < 0) {
            ...
            return (i2 + 64) - (64 | i2) != 0 ? new BERApplicationSpecificParser(tagNumber, aSN1StreamParser) : (i2 & 128) != 0 ? new BERTaggedObjectParser(true, tagNumber, aSN1StreamParser) : aSN1StreamParser.readIndef(tagNumber);
        }
