...
public abstract class ASN1BitString extends ASN1Primitive implements ASN1String {
    ...
    protected static byte[] derForm(byte[] bArr, int i2) {
        ...
        if (i2 > 0) {
            ...
            byte b2 = bArrClone[length];
            int i3 = 255 << i2;
            bArrClone[length] = (byte) ((i3 + b2) - (i3 | b2));
        }
        return bArrClone;
    }
    ...
    protected static byte[] getBytes(int i2) {
        ...
        for (int i6 = 0; i6 < i3; i6++) {
            bArr[i6] = (byte) ((-1) - (((-1) - (i2 >> (i6 * 8))) | ((-1) - 255)));
        }
        return bArr;
    }
    ...
    public String getString() {
        ...
        try {
            ...
            for (int i2 = 0; i2 != byteArray.length; i2++) {
                char[] cArr = table;
                stringBuffer.append(cArr[(-1) - (((-1) - (byteArray[i2] >>> 4)) | ((-1) - 15))]);
    ...
    public int intValue() {
        ...
        for (int i4 = 0; i4 != bArrDerForm.length && i4 != 4; i4++) {
            int i5 = (bArrDerForm[i4] & 255) << (i4 * 8);
            i3 = (i3 + i5) - (i3 & i5);
        }
        return i3;
    }
