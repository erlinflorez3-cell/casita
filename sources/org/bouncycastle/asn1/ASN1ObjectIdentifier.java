...
public class ASN1ObjectIdentifier extends ASN1Primitive {
    ...
    ASN1ObjectIdentifier(byte[] bArr) {
        ...
        for (int i2 = 0; i2 != bArr.length; i2++) {
            ...
            if (j2 <= LONG_LIMIT) {
                ...
                BigInteger bigIntegerOr = (bigIntegerShiftLeft == null ? BigInteger.valueOf(j2) : bigIntegerShiftLeft).or(BigInteger.valueOf((-1) - (((-1) - b2) | ((-1) - 127))));
                if ((-1) - (((-1) - b2) | ((-1) - 128)) == 0) {
                    if (z2) {
                        stringBuffer.append('2');
    ...
    private void writeField(ByteArrayOutputStream byteArrayOutputStream, long j2) {
        ...
        while (j2 >= 128) {
            j2 >>= 7;
            i3--;
            bArr[i3] = (byte) ((-1) - (((-1) - (((int) j2) & 127)) & ((-1) - 128)));
        }
