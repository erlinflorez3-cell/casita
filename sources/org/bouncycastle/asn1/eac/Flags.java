...
public class Flags {
    ...
    private class StringJoiner {
        ...
        StringBuffer f27460b = new StringBuffer();
        String mSeparator;
        ...
        public void add(String str) {
            if (this.First) {
                ...
                this.f27460b.append(this.mSeparator);
            }
            this.f27460b.append(str);
        }

        public String toString() {
            return this.f27460b.toString();
        }
    }
    ...
    public void set(int i2) {
        this.value = (-1) - (((-1) - i2) & ((-1) - this.value));
    }
}
