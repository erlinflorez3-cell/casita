...
public class BasicConstraints extends ASN1Object {
    ...
    public String toString() {
        ...
        if (this.pathLenConstraint != null) {
            sbAppend = new StringBuilder("BasicConstraints: isCa(").append(isCA()).append("), pathLenConstraint = ").append(this.pathLenConstraint.getValue());
        } else {
            if (this.cA == null) {
                return "BasicConstraints: isCa(false)";
            }
            sbAppend = new StringBuilder("BasicConstraints: isCa(").append(isCA()).append(")");
        }
