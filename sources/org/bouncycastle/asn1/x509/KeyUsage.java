...
public class KeyUsage extends ASN1Object {
    ...
    public boolean hasUsages(int i2) {
        int iIntValue = this.bitString.intValue();
        return (iIntValue + i2) - (iIntValue | i2) == i2;
    }
    ...
    public String toString() {
        ...
        if (bytes.length == 1) {
            ...
            i2 = (-1) - (((-1) - bytes[0]) | ((-1) - 255));
        } else {
            sb = new StringBuilder("KeyUsage: 0x");
            i2 = (-1) - (((-1) - ((-1) - (((-1) - bytes[0]) | ((-1) - 255)))) & ((-1) - (((-1) - (((-1) - bytes[1]) | ((-1) - 255))) << 8)));
        }
        return sb.append(Integer.toHexString(i2)).toString();
    }
}
