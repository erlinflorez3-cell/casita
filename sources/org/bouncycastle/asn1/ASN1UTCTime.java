...
public class ASN1UTCTime extends ASN1Primitive {
    ...
    public String getTime() {
        ...
        if (strFromByteArray.indexOf(45) >= 0 || strFromByteArray.indexOf(43) >= 0) {
            ...
            if (iIndexOf == 10) {
                sbAppend = new StringBuilder().append(strFromByteArray.substring(0, 10)).append("00GMT").append(strFromByteArray.substring(10, 13)).append(Global.COLON);
                strSubstring = strFromByteArray.substring(13, 15);
            } else {
                sbAppend = new StringBuilder().append(strFromByteArray.substring(0, 12)).append("GMT").append(strFromByteArray.substring(12, 15)).append(Global.COLON);
