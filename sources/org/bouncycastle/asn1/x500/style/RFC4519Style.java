...
public class RFC4519Style extends AbstractX500NameStyle {
    ...
    public static final ASN1ObjectIdentifier f27474c;
    ...
    public static final ASN1ObjectIdentifier f27475l;
    public static final ASN1ObjectIdentifier member;
    public static final ASN1ObjectIdentifier name;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public static final ASN1ObjectIdentifier f27476o;
    ...
    static {
        ...
        f27474c = aSN1ObjectIdentifierIntern2;
        ...
        f27475l = aSN1ObjectIdentifierIntern16;
        ...
        f27476o = aSN1ObjectIdentifierIntern19;
    ...
    protected ASN1Encodable encodeStringValue(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        return aSN1ObjectIdentifier.equals(dc) ? new DERIA5String(str) : (aSN1ObjectIdentifier.equals(f27474c) || aSN1ObjectIdentifier.equals(serialNumber) || aSN1ObjectIdentifier.equals(dnQualifier) || aSN1ObjectIdentifier.equals(telephoneNumber)) ? new DERPrintableString(str) : super.encodeStringValue(aSN1ObjectIdentifier, str);
    }
    ...
    public RDN[] fromString(String str) {
        ...
        for (int i2 = 0; i2 != rdnArrRDNsFromString.length; i2++) {
            rdnArr[(r4 - i2) - 1] = rdnArrRDNsFromString[i2];
        }
        return rdnArr;
    }
