...
public class IETFUtils {
    ...
    public static String canonicalize(String str) {
        ...
        if (lowerCase.length() > 0 && lowerCase.charAt(0) == '#') {
            ...
            if (aSN1EncodableDecodeObject instanceof ASN1String) {
                lowerCase = Strings.toLowerCase(((ASN1String) aSN1EncodableDecodeObject).getString());
            }
        }
    ...
    public static ASN1Encodable valueFromHexString(String str, int i2) throws IOException {
        ...
        for (int i3 = 0; i3 != length; i3++) {
            ...
            int iConvertHex = convertHex(cCharAt) << 4;
            int iConvertHex2 = convertHex(cCharAt2);
            bArr[i3] = (byte) ((iConvertHex2 + iConvertHex) - (iConvertHex2 & iConvertHex));
        }
