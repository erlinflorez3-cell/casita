...
public class ASN1Dump {
    ...
    static void _dumpAsString(String str, boolean z2, ASN1Primitive aSN1Primitive, StringBuffer stringBuffer) {
                ...
                while (true) {
                    ...
                    while (objects.hasMoreElements()) {
                        ...
                        if (objNextElement == null) {
                            ...
                            _dumpAsString(str4, z2, objNextElement instanceof ASN1Primitive ? (ASN1Primitive) objNextElement : ((ASN1Encodable) objNextElement).toASN1Primitive(), stringBuffer);
                        }
                    }
                    return;
                        ...
                        if (!(aSN1Primitive instanceof ASN1Integer)) {
                            if (aSN1Primitive instanceof DERBitString) {
                                ...
                                if (aSN1Primitive instanceof DERIA5String) {
                                    ...
                                    if (aSN1Primitive instanceof BERApplicationSpecific) {
                                        ...
                                        if (aSN1Primitive instanceof DERExternal) {
                                            ...
                                            if (dERExternal.getDataValueDescriptor() != null) {
                                                _dumpAsString(str5, z2, dERExternal.getDataValueDescriptor(), stringBuffer);
                                            }
                                            stringBuffer.append(str5 + "Encoding: " + dERExternal.getEncoding() + strLineSeparator);
                                            _dumpAsString(str5, z2, dERExternal.getExternalContent(), stringBuffer);
                                            return;
                                        }
                                    ...
                                    strOutputApplicationSpecific = outputApplicationSpecific(str2, str, z2, aSN1Primitive, strLineSeparator);
                                }
        ...
        while (true) {
            ...
            while (objects2.hasMoreElements()) {
                ...
                if (objNextElement2 == null || objNextElement2.equals(DERNull.INSTANCE)) {
                    ...
                    _dumpAsString(str6, z2, objNextElement2 instanceof ASN1Primitive ? (ASN1Primitive) objNextElement2 : ((ASN1Encodable) objNextElement2).toASN1Primitive(), stringBuffer);
                }
            }
            return;
