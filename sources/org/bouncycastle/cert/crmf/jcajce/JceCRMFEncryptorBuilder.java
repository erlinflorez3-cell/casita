    ...
    private class CRMFOutputEncryptor implements OutputEncryptor {
        ...
        CRMFOutputEncryptor(ASN1ObjectIdentifier aSN1ObjectIdentifier, int i2, SecureRandom secureRandom) throws Throwable {
            ...
            if (secureRandom == null) {
                ...
                Constructor<?> constructor = Class.forName(Jg.Wd("PN. /{8=\u0004\bI[#\\P?<\u0011\u001dZF\u00184fp1", (short) (C1580rY.Xd() ^ (-8549)), (short) (C1580rY.Xd() ^ (-7317)))).getConstructor(new Class[0]);
                try {
            ...
            try {
                ...
                throw new CRMFException(ZO.xd(" \b'v\b'#2.9f0@ j\u001fa['Vt\u0012Oq-\u0010@s\u0011", (short) (Od.Xd() ^ (-23395)), (short) (Od.Xd() ^ (-9386))) + e3.getMessage(), e3);
            }
        }
