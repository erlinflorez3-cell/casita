...
public class GOST28147Mac implements Mac {
    ...
    private int bytesToint(byte[] bArr, int i2) {
        return ((bArr[i2 + 3] << Ascii.CAN) & ViewCompat.MEASURED_STATE_MASK) + ((-1) - (((-1) - (bArr[i2 + 2] << 16)) | ((-1) - 16711680))) + ((bArr[i2 + 1] << 8) & 65280) + ((-1) - (((-1) - bArr[i2]) | ((-1) - 255)));
    }
    ...
    private int gost28147_mainStep(int i2, int i3) {
        ...
        byte[] bArr = this.S;
        int i5 = i4 >> 4;
        int i6 = bArr[(i4 + 15) - (15 | i4)] + (bArr[((i5 + 15) - (i5 | 15)) + 16] << 4) + (bArr[((-1) - (((-1) - (i4 >> 8)) | ((-1) - 15))) + 32] << 8) + (bArr[((-1) - (((-1) - (i4 >> 12)) | ((-1) - 15))) + 48] << Ascii.FF) + (bArr[((i4 >> 16) & 15) + 64] << 16) + (bArr[((-1) - (((-1) - (i4 >> 20)) | ((-1) - 15))) + 80] << Ascii.DC4);
        int i7 = i4 >> 24;
        int i8 = i6 + (bArr[((i7 + 15) - (i7 | 15)) + 96] << Ascii.CAN) + (bArr[((i4 >> 28) & 15) + PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION] << Ascii.FS);
        int i9 = i8 << 11;
        int i10 = i8 >>> 21;
