...
public class PSSSigner implements Signer {
    ...
    public byte[] generateSignature() throws Throwable {
        ...
        if (this.sLen != 0) {
            if (!this.sSet) {
                ...
                Method method = Class.forName(C1561oA.ud("\r\u0003\u0017\u0001L\u0011\u0002~\u0010\f\u0002\f\u0010Cgxu\u0007\u0003t`nzoyv", (short) (ZN.Xd() ^ 32299))).getMethod(C1561oA.yd("\u0011\t\u0019\u0016`\u0019\u0011\u0003\u001e", (short) (Od.Xd() ^ (-3837))), byte[].class);
                try {
        ...
        byte b2 = bArr8[0];
        int length3 = 255 >> ((bArr8.length * 8) - this.emBits);
        bArr8[0] = (byte) ((b2 + length3) - (b2 | length3));
        int length4 = bArr8.length;
        int i7 = this.hLen;
        System.arraycopy(bArr4, 0, bArr8, (length4 - i7) - 1, i7);
    ...
    public void init(boolean z2, CipherParameters cipherParameters) throws Throwable {
        ...
        if (cipherParameters instanceof ParametersWithRandom) {
            ...
            if (z2) {
                ...
                Constructor<?> constructor = Class.forName(C1561oA.Yd("\u0003z\u0011|J\u0011\u0004\u0003\u0016\u0014\f\u0018\u001eSy\r\f\u001f\u001d\u0011~\u000f\u001d\u0014 \u001f", (short) (C1607wl.Xd() ^ 6440))).getConstructor(new Class[0]);
                try {
        ...
        if (i2 < (this.hLen * 8) + (this.sLen * 8) + 9) {
            throw new IllegalArgumentException(Xg.qd("#\u001e3Z0,-^3.#/0d,6:h=;1075966r<6I?w:H?{P?KT\u0001NHRLZO[", (short) (C1633zX.Xd() ^ (-24336)), (short) (C1633zX.Xd() ^ (-3991))));
        }
    ...
    public boolean verifySignature(byte[] bArr) {
        ...
        try {
            ...
            byte[] bArr6 = this.block;
            byte b2 = bArr6[0];
            int length2 = 255 >> ((bArr6.length * 8) - this.emBits);
            bArr6[0] = (byte) ((b2 + length2) - (b2 | length2));
            int i4 = 0;
            while (true) {
                byte[] bArr7 = this.block;
                ...
                if (i4 != ((length3 - i5) - i6) - 2) {
                    ...
                    if (this.sSet) {
                        ...
                        int length4 = ((bArr7.length - i6) - i5) - 1;
                        byte[] bArr10 = this.mDash;
                        System.arraycopy(bArr7, length4, bArr10, bArr10.length - i6, i6);
                    }
                    Digest digest2 = this.contentDigest;
                    ...
                    while (true) {
                        ...
                        if (length6 == bArr13.length) {
                            clearBlock(bArr13);
                            clearBlock(this.block);
                            return true;
                        }
                        if ((this.block[i8] ^ bArr13[length6]) != 0) {
                            clearBlock(bArr13);
                            clearBlock(this.block);
                            return false;
                        }
