...
public class RijndaelEngine implements BlockCipher {
    ...
    private void InvMixColumn() {
        ...
        for (int i3 = 0; i3 < this.BC; i3 += 8) {
            int i4 = (int) ((this.A0 >> i3) & 255);
            int i5 = (int) ((this.A1 >> i3) & 255);
            int i6 = (int) ((-1) - (((-1) - (this.A2 >> i3)) | ((-1) - 255)));
            int i7 = (int) ((-1) - (((-1) - (this.A3 >> i3)) | ((-1) - 255)));
            int i8 = -1;
            if (i4 != 0) {
                byte b2 = logtable[i4 & 255];
                i2 = (b2 + 255) - (b2 | 255);
            } else {
                i2 = -1;
            }
            int i9 = i5 != 0 ? logtable[(-1) - (((-1) - i5) | ((-1) - 255))] & 255 : -1;
            int i10 = i6 != 0 ? logtable[i6 & 255] & 255 : -1;
            if (i7 != 0) {
                i8 = logtable[i7 & 255] & 255;
            }
            jMul0xe |= ((long) ((-1) - (((-1) - (((mul0xe(i2) ^ mul0xb(i9)) ^ mul0xd(i10)) ^ mul0x9(i8))) | ((-1) - 255)))) << i3;
            long jMul0xe4 = ((long) ((((mul0xe(i9) ^ mul0xb(i10)) ^ mul0xd(i8)) ^ mul0x9(i2)) & 255)) << i3;
            j2 = (j2 + jMul0xe4) - (j2 & jMul0xe4);
            jMul0xe2 = (-1) - (((-1) - jMul0xe2) & ((-1) - (((long) ((((mul0xe(i10) ^ mul0xb(i8)) ^ mul0xd(i2)) ^ mul0x9(i9)) & 255)) << i3)));
            jMul0xe3 = (-1) - (((-1) - (((long) ((-1) - (((-1) - (((mul0xe(i8) ^ mul0xb(i2)) ^ mul0xd(i9)) ^ mul0x9(i10))) | ((-1) - 255)))) << i3)) & ((-1) - jMul0xe3));
        }
        this.A0 = jMul0xe;
        this.A1 = j2;
        this.A2 = jMul0xe2;
    ...
    private void MixColumn() {
        ...
        for (int i2 = 0; i2 < this.BC; i2 += 8) {
            ...
            int iMul0x2 = ((mul0x2(i3) ^ mul0x3(i4)) ^ i5) ^ i6;
            j2 = (-1) - (((-1) - j2) & ((-1) - (((long) ((iMul0x2 + 255) - (iMul0x2 | 255))) << i2)));
            jMul0x22 |= ((long) ((-1) - (((-1) - (((mul0x2(i4) ^ mul0x3(i5)) ^ i6) ^ i3)) | ((-1) - 255)))) << i2;
            int iMul0x22 = ((mul0x2(i5) ^ mul0x3(i6)) ^ i3) ^ i4;
            long j5 = ((long) ((iMul0x22 + 255) - (iMul0x22 | 255))) << i2;
            j3 = (j3 + j5) - (j3 & j5);
            jMul0x2 = (-1) - (((-1) - (((long) ((-1) - (((-1) - (((mul0x2(i6) ^ mul0x3(i3)) ^ i4) ^ i5)) | ((-1) - 255)))) << i2)) & ((-1) - jMul0x2));
        }
        this.A0 = j2;
        this.A1 = jMul0x22;
        this.A2 = j3;
    ...
    private long applyS(long j2, byte[] bArr) {
        ...
        for (int i2 = 0; i2 < this.BC; i2 += 8) {
            long j4 = j2 >> i2;
            j3 = (-1) - (((-1) - j3) & ((-1) - (((long) ((-1) - (((-1) - bArr[(int) ((j4 + 255) - (j4 | 255))]) | ((-1) - 255)))) << i2)));
        }
        return j3;
    }
    ...
    private long[][] generateWorkingKey(byte[] bArr) {
        ...
        while (i10 < i2 && i11 < (this.ROUNDS + 1) * (this.BC / 8)) {
            while (i6 < i7) {
                ...
                long j2 = jArr2[i6];
                byte b2 = bArr2[i6][i10];
                long j3 = ((long) ((b2 + 255) - (b2 | 255))) << ((i11 * 8) % i12);
                jArr2[i6] = (j3 + j2) - (j3 & j2);
                i6++;
                i7 = 4;
            }
            i10++;
        ...
        while (i11 < (this.ROUNDS + i5) * (this.BC / i4)) {
            ...
            int i22 = 0;
            while (i22 < i2 && i11 < (this.ROUNDS + i5) * (this.BC / i4)) {
                for (int i23 = 0; i23 < 4; i23++) {
                    int i24 = this.BC;
                    long[] jArr3 = jArr[i11 / (i24 / 8)];
                    long j4 = jArr3[i23];
                    long j5 = ((long) ((-1) - (((-1) - bArr2[i23][i22]) | ((-1) - 255)))) << ((i11 * 8) % i24);
                    jArr3[i23] = (j5 + j4) - (j5 & j4);
                }
                i22++;
                i11++;
                i4 = 8;
    ...
    private void unpackBlock(byte[] bArr, int i2) {
        ...
        int i3 = i2 + 4;
        this.A3 = (-1) - (((-1) - bArr[i2 + 3]) | ((-1) - 255));
        for (int i4 = 8; i4 != this.BC; i4 += 8) {
            long j2 = this.A0;
            long j3 = ((long) (bArr[i3] & 255)) << i4;
            this.A0 = (j2 + j3) - (j2 & j3);
            long j4 = this.A1;
            byte b2 = bArr[i3 + 1];
            this.A1 = j4 | (((long) ((b2 + 255) - (b2 | 255))) << i4);
            long j5 = this.A2;
            int i5 = i3 + 3;
            long j6 = ((long) ((-1) - (((-1) - bArr[i3 + 2]) | ((-1) - 255)))) << i4;
            this.A2 = (j5 + j6) - (j5 & j6);
            long j7 = this.A3;
            i3 += 4;
            byte b3 = bArr[i5];
            long j8 = ((long) ((b3 + 255) - (b3 | 255))) << i4;
            this.A3 = (j7 + j8) - (j7 & j8);
        }
    }
