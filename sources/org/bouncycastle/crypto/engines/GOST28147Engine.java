...
public class GOST28147Engine implements BlockCipher {
    ...
    private int GOST28147_mainStep(int i2, int i3) {
        ...
        byte[] bArr = this.S;
        int i5 = i4 >> 16;
        int i6 = bArr[15 & i4] + (bArr[((i4 >> 4) & 15) + 16] << 4) + (bArr[((i4 >> 8) & 15) + 32] << 8) + (bArr[((i4 >> 12) & 15) + 48] << Ascii.FF) + (bArr[((i5 + 15) - (i5 | 15)) + 64] << 16);
        int i7 = i4 >> 20;
        int i8 = i6 + (bArr[((i7 + 15) - (i7 | 15)) + 80] << Ascii.DC4);
        int i9 = i4 >> 24;
        int i10 = i8 + (bArr[((i9 + 15) - (i9 | 15)) + 96] << Ascii.CAN) + (bArr[((i4 >> 28) & 15) + PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION] << Ascii.FS);
    ...
    private int bytesToint(byte[] bArr, int i2) {
        int i3 = bArr[i2 + 3] << Ascii.CAN;
        int i4 = (i3 + ViewCompat.MEASURED_STATE_MASK) - (i3 | ViewCompat.MEASURED_STATE_MASK);
        int i5 = bArr[i2 + 2] << 16;
        int i6 = i4 + ((i5 + 16711680) - (i5 | 16711680)) + ((-1) - (((-1) - (bArr[i2 + 1] << 8)) | ((-1) - 65280)));
        byte b2 = bArr[i2];
        return i6 + ((b2 + 255) - (b2 | 255));
    }
