...
public class CamelliaEngine implements BlockCipher {
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i2) {
        ...
        int i7 = i6 ^ iArr5[(i3 >>> 16) & 255];
        int[] iArr6 = SBOX1_1110;
        int i8 = iArr6[(i3 >>> 24) & 255] ^ i7;
        int i9 = iArr[1] ^ iArr2[i2 + 1];
        int i10 = (iArr5[(-1) - (((-1) - (i9 >>> 24)) | ((-1) - 255))] ^ ((iArr6[255 & i9] ^ iArr3[(-1) - (((-1) - (i9 >>> 8)) | ((-1) - 255))]) ^ iArr4[(i9 >>> 16) & 255])) ^ i8;
        iArr[2] = iArr[2] ^ i10;
        int iRightRotate = (rightRotate(i8, 8) ^ i10) ^ iArr[3];
        iArr[3] = iRightRotate;
        int i11 = iArr[2] ^ iArr2[i2 + 2];
        int i12 = i11 >>> 8;
        int i13 = (iArr3[255 & i11] ^ iArr4[(i12 + 255) - (i12 | 255)]) ^ iArr5[(i11 >>> 16) & 255];
        int i14 = i11 >>> 24;
        int i15 = iArr6[(i14 + 255) - (i14 | 255)] ^ i13;
        int i16 = iArr2[i2 + 3] ^ iRightRotate;
        int i17 = i16 >>> 8;
        int i18 = (iArr6[(i16 + 255) - (255 | i16)] ^ iArr3[(i17 + 255) - (i17 | 255)]) ^ iArr4[(i16 >>> 16) & 255];
        int i19 = i16 >>> 24;
        int i20 = (iArr5[(i19 + 255) - (i19 | 255)] ^ i18) ^ i15;
        iArr[0] = iArr[0] ^ i20;
    ...
    private static void decroldq(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i8 = i4 + 3;
        int i9 = i3 + 2;
        iArr2[i8] = (-1) - (((-1) - (iArr[i6] << i2)) & ((-1) - (iArr[i9] >>> i7)));
        int i10 = iArr[i9] << i2;
        int i11 = i3 + 3;
        int i12 = iArr[i11] >>> i7;
    ...
    private static void decroldqo32(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i10 = i4 + 3;
        int i11 = i3 + 3;
        iArr2[i10] = (-1) - (((-1) - (iArr[i8] << i7)) & ((-1) - (iArr[i11] >>> i9)));
        iArr2[i4] = (-1) - (((-1) - (iArr[i11] << i7)) & ((-1) - (iArr[i3] >>> i9)));
        int i12 = i4 + 1;
        iArr2[i12] = (-1) - (((-1) - (iArr[i6] >>> i9)) & ((-1) - (iArr[i3] << i7)));
        iArr[i3] = iArr2[i5];
        iArr[i6] = iArr2[i10];
        iArr[i8] = iArr2[i4];
        iArr[i11] = iArr2[i12];
    ...
    private static void roldq(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i11 = i4 + 3;
        iArr2[i11] = (-1) - (((-1) - (iArr[i10] << i2)) & ((-1) - (iArr[i3] >>> i6)));
        iArr[i3] = iArr2[i4];
        iArr[i5] = iArr2[i7];
        iArr[i8] = iArr2[i9];
        iArr[i10] = iArr2[i11];
