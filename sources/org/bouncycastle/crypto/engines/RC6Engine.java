...
public class RC6Engine implements BlockCipher {
    ...
    private int decryptBlock(byte[] bArr, int i2, byte[] bArr2, int i3) {
        ...
        wordToBytes(i8, bArr2, i3 + 4);
        wordToBytes(i4, bArr2, i3 + 8);
        wordToBytes(i7, bArr2, i3 + 12);
        return 16;
    }
    ...
    private int encryptBlock(byte[] bArr, int i2, byte[] bArr2, int i3) {
        ...
        while (i6 <= 20) {
            ...
            int i7 = i6 * 2;
            int i8 = iRotateLeft3 + this._S[i7];
        ...
        int[] iArr2 = this._S;
        int i9 = iBytesToWord + iArr2[42];
        int i10 = iBytesToWord3 + iArr2[43];
        wordToBytes(i9, bArr2, i3);
        wordToBytes(i4, bArr2, i3 + 4);
        wordToBytes(i10, bArr2, i3 + 8);
    ...
    private void setKey(byte[] bArr) {
        ...
        for (int length3 = bArr.length - 1; length3 >= 0; length3--) {
            int i2 = length3 / 4;
            iArr2[i2] = (iArr2[i2] << 8) + ((-1) - (((-1) - bArr[length3]) | ((-1) - 255)));
        }
