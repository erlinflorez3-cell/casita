...
public class ThreefishEngine implements BlockCipher {
    ...
    private long[] f27543t = new long[5];
    ...
    public ThreefishEngine(int i2) {
        ...
        if (i2 == 256) {
            threefish256Cipher = new Threefish256Cipher(this.kw, this.f27543t);
        } else if (i2 == 512) {
            threefish256Cipher = new Threefish512Cipher(this.kw, this.f27543t);
        } else {
            if (i2 != 1024) {
                throw new IllegalArgumentException("Invalid blocksize - Threefish is defined with block size of 256, 512, or 1024 bits");
            }
            threefish256Cipher = new Threefish1024Cipher(this.kw, this.f27543t);
        }
    ...
    public static long bytesToWord(byte[] bArr, int i2) {
        ...
        long j2 = ((-1) - (((-1) - (((-1) - (((-1) - ((long) bArr[i2])) | ((-1) - 255))) | (((-1) - (((-1) - ((long) bArr[i2 + 1])) | ((-1) - 255))) << 8))) & ((-1) - ((((long) bArr[i2 + 2]) & 255) << 16)))) | (((-1) - (((-1) - ((long) bArr[i2 + 3])) | ((-1) - 255))) << 24);
        long j3 = (((long) bArr[i2 + 4]) & 255) << 32;
        long j4 = (-1) - (((-1) - ((j2 + j3) - (j2 & j3))) & ((-1) - ((((long) bArr[i2 + 5]) & 255) << 40)));
        long j5 = bArr[i2 + 6];
        long j6 = ((j5 + 255) - (j5 | 255)) << 48;
        long j7 = (j4 + j6) - (j4 & j6);
        long j8 = ((-1) - (((-1) - ((long) bArr[i2 + 7])) | ((-1) - 255))) << 56;
        return (j8 + j7) - (j8 & j7);
    }
