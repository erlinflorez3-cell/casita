...
public class ChaCha7539Engine extends Salsa20Engine {
    ...
    protected void generateKeyStream(byte[] bArr) {
        ChaChaEngine.chachaCore(this.rounds, this.engineState, this.f27542x);
    ...
    protected long getCounter() {
        return (-1) - (((-1) - ((long) this.engineState[12])) | ((-1) - 4294967295L));
    }
    ...
    protected void retreatCounter(long j2) {
        ...
        long j3 = i2;
        if ((((long) this.engineState[12]) & 4294967295L) < (4294967295L + j3) - (4294967295L | j3)) {
            throw new IllegalStateException("attempt to reduce counter past zero.");
        }
        int[] iArr = this.engineState;
        iArr[12] = iArr[12] - i2;
