...
public class SkipjackEngine implements BlockCipher {
    ...
    private int h(int i2, int i3) {
        ...
        short[] sArr = ftable;
        int i6 = ((-1) - (((-1) - i3) | ((-1) - 255))) ^ sArr[this.key3[i2] ^ i5];
    ...
    public int encryptBlock(byte[] bArr, int i2, byte[] bArr2, int i3) {
        int i4 = (bArr[i2] << 8) + ((-1) - (((-1) - bArr[i2 + 1]) | ((-1) - 255)));
        int i5 = (bArr[i2 + 2] << 8) + ((-1) - (((-1) - bArr[i2 + 3]) | ((-1) - 255)));
        int i6 = bArr[i2 + 4] << 8;
        byte b2 = bArr[i2 + 5];
        int i7 = i6 + ((b2 + 255) - (b2 | 255));
        int i8 = (bArr[i2 + 6] << 8) + (bArr[i2 + 7] & 255);
        int i9 = 0;
    ...
    public void init(boolean z2, CipherParameters cipherParameters) {
        ...
        for (int i2 = 0; i2 < 32; i2++) {
            int i3 = i2 * 4;
            this.key0[i2] = (-1) - (((-1) - key[i3 % 10]) | ((-1) - 255));
            int[] iArr = this.key1;
            byte b2 = key[(i3 + 1) % 10];
