...
public class ChaChaEngine extends Salsa20Engine {
    ...
    protected void generateKeyStream(byte[] bArr) {
        chachaCore(this.rounds, this.engineState, this.f27542x);
    ...
    protected void retreatCounter(long j2) {
        ...
        int i3 = (int) j2;
        if (i2 != 0) {
            if ((-1) - (((-1) - ((long) this.engineState[13])) | ((-1) - 4294967295L)) < (-1) - (((-1) - ((long) i2)) | ((-1) - 4294967295L))) {
                throw new IllegalStateException("attempt to reduce counter past zero.");
            }
            int[] iArr = this.engineState;
            iArr[13] = iArr[13] - i2;
        }
        if ((((long) this.engineState[12]) & 4294967295L) >= (4294967295L & ((long) i3))) {
            int[] iArr2 = this.engineState;
            iArr2[12] = iArr2[12] - i3;
        } else {
