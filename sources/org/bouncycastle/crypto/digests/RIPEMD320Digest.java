...
public class RIPEMD320Digest extends GeneralDigest {
    ...
    private int f2(int i2, int i3, int i4) {
        int i5 = ~i2;
        return (-1) - (((-1) - ((i5 + i4) - (i5 | i4))) & ((-1) - ((i3 + i2) - (i3 | i2))));
    }
    ...
    protected void processBlock() {
        ...
        int i10 = this.H8;
        int i11 = this.H9;
        int iRL = RL(i2 + f1(i3, i4, i5) + this.X[0], 11) + i6;
        int iRL2 = RL(i4, 10);
        int iRL3 = RL(i6 + f1(iRL, i3, iRL2) + this.X[1], 14) + i5;
        int iRL4 = RL(i3, 10);
        int iRL5 = RL(i5 + f1(iRL3, iRL, iRL4) + this.X[2], 15) + iRL2;
        int iRL6 = RL(iRL, 10);
        ...
        int iRL33 = RL(i7 + f5(i8, i9, i10) + this.X[5] + 1352829926, 8) + i11;
        int iRL34 = RL(i9, 10);
        int iRL35 = RL(i11 + f5(iRL33, i8, iRL34) + this.X[14] + 1352829926, 9) + i10;
        int iRL36 = RL(i8, 10);
        int iRL37 = RL(i10 + f5(iRL35, iRL33, iRL36) + this.X[7] + 1352829926, 9) + iRL34;
    ...
    protected void processWord(byte[] bArr, int i2) {
        ...
        byte b2 = bArr[i2];
        byte b3 = bArr[i2 + 1];
        iArr[i3] = (-1) - (((-1) - ((bArr[i2 + 3] & 255) << 24)) & ((-1) - (((-1) - (((-1) - ((b2 + 255) - (b2 | 255))) & ((-1) - (((b3 + 255) - (b3 | 255)) << 8)))) | ((bArr[i2 + 2] & 255) << 16))));
        if (i4 == 16) {
            processBlock();
        }
    }
