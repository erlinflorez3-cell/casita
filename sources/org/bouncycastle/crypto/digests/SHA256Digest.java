...
public class SHA256Digest extends GeneralDigest implements EncodableDigest {
    ...
    private int Maj(int i2, int i3, int i4) {
        return (((-1) - (((-1) - i2) | ((-1) - i4))) ^ (i2 & i3)) ^ ((-1) - (((-1) - i3) | ((-1) - i4)));
    }

    private int Sum0(int i2) {
        return ((-1) - (((-1) - (i2 << 10)) & ((-1) - (i2 >>> 22)))) ^ (((-1) - (((-1) - (i2 >>> 2)) & ((-1) - (i2 << 30)))) ^ ((i2 >>> 13) | (i2 << 19)));
    }

    private int Sum1(int i2) {
        return ((-1) - (((-1) - (i2 << 7)) & ((-1) - (i2 >>> 25)))) ^ (((-1) - (((-1) - (i2 >>> 6)) & ((-1) - (i2 << 26)))) ^ ((-1) - (((-1) - (i2 >>> 11)) & ((-1) - (i2 << 21)))));
    }

    private int Theta0(int i2) {
        return (i2 >>> 3) ^ (((i2 >>> 7) | (i2 << 25)) ^ ((-1) - (((-1) - (i2 >>> 18)) & ((-1) - (i2 << 14)))));
    }

    private int Theta1(int i2) {
        int i3 = i2 >>> 19;
        int i4 = i2 << 13;
        return (i2 >>> 10) ^ (((-1) - (((-1) - (i2 >>> 17)) & ((-1) - (i2 << 15)))) ^ ((i3 + i4) - (i3 & i4)));
    }
    ...
    protected void processWord(byte[] bArr, int i2) {
        ...
        int i5 = ((-1) - (((-1) - bArr[i2 + 2]) | ((-1) - 255))) << 8;
        byte b3 = bArr[i2 + 3];
        int i6 = ((b3 + 255) - (b3 | 255)) | ((i4 + i5) - (i4 & i5));
        int[] iArr = this.X;
        int i7 = this.xOff;
        iArr[i7] = i6;
        int i8 = i7 + 1;
