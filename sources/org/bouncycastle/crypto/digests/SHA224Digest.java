...
public class SHA224Digest extends GeneralDigest implements EncodableDigest {
    ...
    private int Maj(int i2, int i3, int i4) {
        return (((-1) - (((-1) - i2) | ((-1) - i4))) ^ ((i2 + i3) - (i2 | i3))) ^ ((-1) - (((-1) - i3) | ((-1) - i4)));
    }

    private int Sum0(int i2) {
        int i3 = i2 >>> 2;
        int i4 = i2 << 30;
        return ((i2 << 10) | (i2 >>> 22)) ^ (((i3 + i4) - (i3 & i4)) ^ ((i2 >>> 13) | (i2 << 19)));
    }

    private int Sum1(int i2) {
        int i3 = i2 >>> 6;
        int i4 = i2 << 26;
        return ((-1) - (((-1) - (i2 << 7)) & ((-1) - (i2 >>> 25)))) ^ (((i3 + i4) - (i3 & i4)) ^ ((i2 >>> 11) | (i2 << 21)));
    }
    ...
    private int Theta1(int i2) {
        return (i2 >>> 10) ^ (((i2 >>> 17) | (i2 << 15)) ^ ((-1) - (((-1) - (i2 >>> 19)) & ((-1) - (i2 << 13)))));
    }
    ...
    protected void processWord(byte[] bArr, int i2) {
        ...
        int i5 = (i3 + i4) - (i3 & i4);
        byte b2 = bArr[i2 + 2];
        int i6 = (-1) - (((-1) - ((-1) - (((-1) - bArr[i2 + 3]) | ((-1) - 255)))) & ((-1) - ((-1) - (((-1) - i5) & ((-1) - (((b2 + 255) - (b2 | 255)) << 8))))));
        int[] iArr = this.X;
        int i7 = this.xOff;
        iArr[i7] = i6;
        int i8 = i7 + 1;
