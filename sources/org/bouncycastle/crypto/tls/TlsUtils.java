...
public class TlsUtils {
    ...
    /* JADX WARN: Removed duplicated region for block: B:104:0x0044 A[RETURN] */
    /*
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:105:0x0033 A[RETURN] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    */
    ...
    public static boolean isValidUint24(int i2) {
        return (ViewCompat.MEASURED_SIZE_MASK + i2) - (16777215 | i2) == i2;
    }

    public static boolean isValidUint24(long j2) {
        return (-1) - (((-1) - 16777215) | ((-1) - j2)) == j2;
    }
    ...
    public static int readUint16(byte[] bArr, int i2) {
        byte b2 = bArr[i2];
        return ((-1) - (((-1) - bArr[i2 + 1]) | ((-1) - 255))) | (((b2 + 255) - (b2 | 255)) << 8);
    }
    ...
    public static int readUint24(InputStream inputStream) throws IOException {
        ...
        int i5 = i2 << 16;
        int i6 = i3 << 8;
        return (-1) - (((-1) - i4) & ((-1) - ((i5 + i6) - (i5 & i6))));
    }

    public static int readUint24(byte[] bArr, int i2) {
        byte b2 = bArr[i2];
        int i3 = (((b2 + 255) - (b2 | 255)) << 16) | (((-1) - (((-1) - bArr[i2 + 1]) | ((-1) - 255))) << 8);
        byte b3 = bArr[i2 + 2];
    ...
    public static long readUint32(InputStream inputStream) throws IOException {
        ...
        return (-1) - (((-1) - ((long) ((-1) - (((-1) - i5) & ((-1) - ((-1) - (((-1) - ((-1) - (((-1) - (i2 << 24)) & ((-1) - (i3 << 16))))) & ((-1) - (i4 << 8))))))))) | ((-1) - 4294967295L));
    }
    ...
    public static long readUint32(byte[] bArr, int i2) {
        ...
        byte b3 = bArr[i2 + 2];
        int i5 = (-1) - (((-1) - i4) & ((-1) - (((b3 + 255) - (b3 | 255)) << 8)));
        byte b4 = bArr[i2 + 3];
        int i6 = (b4 + 255) - (b4 | 255);
        return (-1) - (((-1) - ((long) ((i6 + i5) - (i6 & i5)))) | ((-1) - 4294967295L));
    }

    public static long readUint48(InputStream inputStream) throws IOException {
        long uint24 = (((long) readUint24(inputStream)) & 4294967295L) << 24;
        long uint242 = 4294967295L & ((long) readUint24(inputStream));
        return (uint24 + uint242) - (uint24 & uint242);
    }

    public static long readUint48(byte[] bArr, int i2) {
        int uint24 = readUint24(bArr, i2);
        int uint242 = readUint24(bArr, i2 + 3);
        long j2 = (((long) uint24) & 4294967295L) << 24;
        long j3 = uint242;
        return (-1) - (((-1) - ((j3 + 4294967295L) - (j3 | 4294967295L))) & ((-1) - j2));
    }
    ...
    public static short readUint8(byte[] bArr, int i2) {
        return (short) ((-1) - (((-1) - bArr[i2]) | ((-1) - 255)));
    }
    ...
    public static ProtocolVersion readVersion(byte[] bArr, int i2) throws IOException {
        return ProtocolVersion.get(bArr[i2] & 255, (-1) - (((-1) - bArr[i2 + 1]) | ((-1) - 255)));
    }
    ...
    static void validateKeyUsage(org.bouncycastle.asn1.x509.Certificate certificate, int i2) throws IOException {
        KeyUsage keyUsageFromExtensions;
        Extensions extensions = certificate.getTBSCertificate().getExtensions();
        if (extensions != null && (keyUsageFromExtensions = KeyUsage.fromExtensions(extensions)) != null && (((-1) - (((-1) - keyUsageFromExtensions.getBytes()[0]) | ((-1) - 255))) & i2) != i2) {
