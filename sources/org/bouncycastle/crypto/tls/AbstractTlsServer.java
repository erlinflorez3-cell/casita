...
public abstract class AbstractTlsServer extends AbstractTlsPeer implements TlsServer {
    ...
    public int getSelectedCipherSuite() throws IOException {
        ...
        for (int i2 : getCipherSuites()) {
            if (Arrays.contains(this.offeredCipherSuites, i2) && ((zSupportsClientECCCapabilities || !TlsECCUtils.isECCCipherSuite(i2)) && TlsUtils.isValidCipherSuiteForVersion(i2, this.serverVersion))) {
