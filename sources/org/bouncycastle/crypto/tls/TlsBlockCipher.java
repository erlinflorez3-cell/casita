...
public class TlsBlockCipher implements TlsCipher {
    ...
    public byte[] decodeCiphertext(long j2, short s2, byte[] bArr, int i2, int i3) throws IOException {
        ...
        int i10 = iCheckPaddingConstantTime == 0 ? 1 : 0;
        int i11 = i6 - iCheckPaddingConstantTime;
        if (this.encryptThenMAC) {
            ...
            int i12 = i5 + i11;
            i4 = i5;
            int i13 = (-1) - (((-1) - i10) & ((-1) - (1 ^ (Arrays.constantTimeAreEqual(this.readMac.calculateMacConstantTime(j2, s2, bArr, i5, i11, i6 - size, this.randomData), Arrays.copyOfRange(bArr, i12, i12 + size)) ? 1 : 0))));
            i10 = 1;
            if (i13 != 1) {
                i10 = 0;
            }
        ...
        if (i10 == 0) {
            return Arrays.copyOfRange(bArr, i4, i4 + i11);
        }
        throw new TlsFatalAlert((short) 20);
    }
