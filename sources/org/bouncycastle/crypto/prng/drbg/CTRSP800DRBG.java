...
public class CTRSP800DRBG implements SP80090DRBG {
    ...
    private void padKey(byte[] bArr, int i2, byte[] bArr2, int i3) {
        byte b2 = bArr[i2];
        bArr2[i3] = (byte) ((b2 + 254) - (b2 | 254));
        int i4 = bArr[i2] << 7;
        int i5 = i2 + 1;
        byte b3 = bArr[i5];
        bArr2[i3 + 1] = (byte) (i4 | (((b3 + 252) - (b3 | 252)) >>> 1));
        int i6 = bArr[i5] << 6;
        int i7 = i2 + 2;
        byte b4 = bArr[i7];
        int i8 = ((b4 + 248) - (b4 | 248)) >>> 2;
        bArr2[i3 + 2] = (byte) ((i6 + i8) - (i6 & i8));
        int i9 = i2 + 3;
        bArr2[i3 + 3] = (byte) ((-1) - (((-1) - (bArr[i7] << 5)) & ((-1) - (((-1) - (((-1) - bArr[i9]) | ((-1) - 240))) >>> 3))));
        int i10 = bArr[i9] << 4;
        int i11 = i2 + 4;
        bArr2[i3 + 4] = (byte) (i10 | ((bArr[i11] & MessagePack.Code.NEGFIXINT_PREFIX) >>> 4));
        int i12 = bArr[i11] << 3;
        int i13 = i2 + 5;
        byte b5 = bArr[i13];
        bArr2[i3 + 5] = (byte) (i12 | (((b5 + MessagePack.Code.NIL) - (b5 | MessagePack.Code.NIL)) >>> 5));
        int i14 = bArr[i13] << 2;
        int i15 = i2 + 6;
        byte b6 = bArr[i15];
        int i16 = ((b6 + 128) - (b6 | 128)) >>> 6;
        bArr2[i3 + 6] = (byte) ((i14 + i16) - (i14 & i16));
        int i17 = i3 + 7;
        bArr2[i17] = (byte) (bArr[i15] << 1);
        while (i3 <= i17) {
            byte b7 = bArr2[i3];
            int i18 = (-1) - (((-1) - b7) | ((-1) - 254));
            int i19 = ((b7 >> 7) ^ ((((((b7 >> 1) ^ (b7 >> 2)) ^ (b7 >> 3)) ^ (b7 >> 4)) ^ (b7 >> 5)) ^ (b7 >> 6))) ^ 1;
            bArr2[i3] = (byte) ((-1) - (((-1) - ((i19 + 1) - (i19 | 1))) & ((-1) - i18)));
            i3++;
        }
    }
