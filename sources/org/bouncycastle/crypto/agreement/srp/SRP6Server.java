...
public class SRP6Server {
    ...
    protected BigInteger f27513b;
    protected Digest digest;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    protected BigInteger f27514g;
    protected SecureRandom random;

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    protected BigInteger f27515u;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    protected BigInteger f27516v;

    private BigInteger calculateS() {
        return this.f27516v.modPow(this.f27515u, this.N).multiply(this.A).mod(this.N).modPow(this.f27513b, this.N);
    }
    ...
    public BigInteger calculateSecret(BigInteger bigInteger) throws CryptoException {
        ...
        this.f27515u = SRP6Util.calculateU(this.digest, this.N, bigIntegerValidatePublicValue, this.B);
    ...
    public BigInteger generateServerCredentials() {
        BigInteger bigIntegerCalculateK = SRP6Util.calculateK(this.digest, this.N, this.f27514g);
        this.f27513b = selectPrivateValue();
        BigInteger bigIntegerMod = bigIntegerCalculateK.multiply(this.f27516v).mod(this.N).add(this.f27514g.modPow(this.f27513b, this.N)).mod(this.N);
    ...
    public void init(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, Digest digest, SecureRandom secureRandom) {
        this.N = bigInteger;
        this.f27514g = bigInteger2;
        this.f27516v = bigInteger3;
    ...
    protected BigInteger selectPrivateValue() {
        return SRP6Util.generatePrivateValue(this.digest, this.N, this.f27514g, this.random);
    }
