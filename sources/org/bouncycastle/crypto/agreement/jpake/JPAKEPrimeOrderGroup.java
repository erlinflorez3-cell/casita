...
public class JPAKEPrimeOrderGroup {
    ...
    private final BigInteger f27502g;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    private final BigInteger f27503p;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    private final BigInteger f27504q;
    ...
    JPAKEPrimeOrderGroup(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, boolean z2) {
        ...
        this.f27503p = bigInteger;
        this.f27504q = bigInteger2;
        this.f27502g = bigInteger3;
    }
