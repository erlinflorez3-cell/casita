...
public abstract class Pack {
    public static int bigEndianToInt(byte[] bArr, int i2) {
        ...
        return (-1) - (((-1) - ((-1) - (((-1) - bArr[i2 + 3]) | ((-1) - 255)))) & ((-1) - ((-1) - (((-1) - ((i3 + i4) - (i3 & i4))) & ((-1) - ((bArr[i2 + 2] & 255) << 8))))));
    }
    ...
    public static long bigEndianToLong(byte[] bArr, int i2) {
        ...
        return ((-1) - (((-1) - ((long) bigEndianToInt(bArr, i2 + 4))) | ((-1) - 4294967295L))) | (((-1) - (((-1) - ((long) iBigEndianToInt)) | ((-1) - 4294967295L))) << 32);
    }
    ...
    public static long littleEndianToLong(byte[] bArr, int i2) {
        ...
        return (((jLittleEndianToInt + 4294967295L) - (jLittleEndianToInt | 4294967295L)) << 32) | (((long) iLittleEndianToInt) & 4294967295L);
    }
    ...
    public static void longToLittleEndian(long j2, byte[] bArr, int i2) {
        intToLittleEndian((int) ((-1) - (((-1) - 4294967295L) | ((-1) - j2))), bArr, i2);
