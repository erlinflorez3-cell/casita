...
public class OCBBlockCipher implements AEADBlockCipher {
    ...
    public void init(boolean z2, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (i2 == 0) {
            ...
            for (int i4 = 0; i4 < 16; i4++) {
                ...
                byte b2 = bArr2[i3];
                i3++;
                int i5 = ((b2 + 255) - (b2 | 255)) << i2;
                int i6 = ((-1) - (((-1) - bArr2[i3]) | ((-1) - 255))) >>> (8 - i2);
                this.OffsetMAIN_0[i4] = (byte) ((i6 + i5) - (i6 & i5));
            }
        }
        this.hashBlockPos = 0;
        this.mainBlockPos = 0;
    ...
    protected int processNonce(byte[] bArr) {
        ...
        bArr2[length] = (byte) ((-1) - (((-1) - bArr2[length]) & ((-1) - 1)));
        byte b2 = bArr2[15];
        int i3 = (-1) - (((-1) - b2) | ((-1) - 63));
        bArr2[15] = (byte) ((-1) - (((-1) - b2) | ((-1) - 192)));
