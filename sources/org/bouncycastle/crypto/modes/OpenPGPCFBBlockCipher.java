...
public class OpenPGPCFBBlockCipher implements BlockCipher {
    ...
    private int encryptBlock(byte[] bArr, int i2, byte[] bArr2, int i3) throws IllegalStateException, DataLengthException {
        ...
        if (i6 > i5) {
            ...
            this.FR[i5 - 2] = bEncryptByte;
            byte[] bArr3 = this.FR;
            int i9 = this.blockSize;
            byte bEncryptByte2 = encryptByte(bArr[i2 + 1], i9 - 1);
            bArr2[i3 + 1] = bEncryptByte2;
            bArr3[i9 - 1] = bEncryptByte2;
            this.cipher.processBlock(this.FR, 0, this.FRE, 0);
            while (i7 < this.blockSize) {
                byte[] bArr4 = this.FR;
                int i10 = i7 - 2;
                byte bEncryptByte3 = encryptByte(bArr[i2 + i7], i10);
                bArr2[i3 + i7] = bEncryptByte3;
                bArr4[i10] = bEncryptByte3;
                i7++;
            }
        } else {
            if (i6 != 0) {
                if (i6 == i5) {
                    ...
                    while (true) {
                        ...
                        byte[] bArr6 = this.FR;
                        int i11 = i7 - 2;
                        byte bEncryptByte4 = encryptByte(bArr[i2 + i7], i11);
                        bArr2[i3 + i7] = bEncryptByte4;
                        bArr6[i11] = bEncryptByte4;
                        i7++;
                    }
                }
            } else {
