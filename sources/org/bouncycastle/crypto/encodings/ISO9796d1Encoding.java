...
public class ISO9796d1Encoding implements AsymmetricBlockCipher {
    ...
    private byte[] decodeBlock(byte[] bArr, int i2, int i3) throws InvalidCipherTextException {
        ...
        if ((-1) - (((-1) - bArrConvertOutputDecryptOnly[bArrConvertOutputDecryptOnly.length - 1]) | ((-1) - 15)) != 6) {
            throw new InvalidCipherTextException("invalid forcing byte in block");
        }
        int length = bArrConvertOutputDecryptOnly.length - 1;
        int i5 = (bArrConvertOutputDecryptOnly[bArrConvertOutputDecryptOnly.length - 1] & 255) >>> 4;
        byte[] bArr2 = inverse;
        byte b2 = bArrConvertOutputDecryptOnly[bArrConvertOutputDecryptOnly.length - 2];
        int i6 = bArr2[((b2 + 255) - (b2 | 255)) >> 4] << 4;
        bArrConvertOutputDecryptOnly[length] = (byte) ((i5 + i6) - (i5 & i6));
        byte[] bArr3 = shadows;
        byte b3 = bArrConvertOutputDecryptOnly[1];
        byte b4 = (byte) ((-1) - (((-1) - bArr3[b3 & Ascii.SI]) & ((-1) - (bArr3[((-1) - (((-1) - b3) | ((-1) - 255))) >>> 4] << 4))));
        ...
        for (int length2 = bArrConvertOutputDecryptOnly.length - 1; length2 >= bArrConvertOutputDecryptOnly.length - (i4 * 2); length2 -= 2) {
            byte[] bArr4 = shadows;
            byte b5 = bArrConvertOutputDecryptOnly[length2];
            int i9 = bArr4[((-1) - (((-1) - b5) | ((-1) - 255))) >>> 4] << 4;
            byte b6 = bArr4[b5 & Ascii.SI];
            int i10 = (b6 + i9) - (b6 & i9);
            int i11 = length2 - 1;
            byte b7 = bArrConvertOutputDecryptOnly[i11];
            if ((-1) - (((-1) - (b7 ^ i10)) | ((-1) - 255)) != 0) {
                if (z2) {
        ...
        bArrConvertOutputDecryptOnly[i8] = 0;
        int length3 = (bArrConvertOutputDecryptOnly.length - i8) / 2;
        byte[] bArr5 = new byte[length3];
        for (int i12 = 0; i12 < length3; i12++) {
            bArr5[i12] = bArrConvertOutputDecryptOnly[(i12 * 2) + i8 + 1];
        }
        this.padBits = i7 - 1;
        return bArr5;
    }
    ...
    private byte[] encodeBlock(byte[] bArr, int i2, int i3) throws InvalidCipherTextException {
        ...
        for (int i11 = i5 - (i8 * 2); i11 != i5; i11 += 2) {
            ...
            byte[] bArr3 = shadows;
            bArr2[i11] = (byte) (bArr3[15 & b2] | (bArr3[((-1) - (((-1) - b2) | ((-1) - 255))) >>> 4] << 4));
            bArr2[i11 + 1] = b2;
        }
        int i12 = i5 - (i3 * 2);
