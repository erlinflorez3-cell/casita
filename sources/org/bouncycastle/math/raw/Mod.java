...
public abstract class Mod {
    ...
    public static void invert(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        iArrCreate[0] = 1;
        int iInversionStep2 = (-1) - (((-1) - 1) | ((-1) - iArrCopy[0])) == 0 ? inversionStep(iArr, iArrCopy, length, iArrCreate, 0) : 0;
    ...
    public static int[] random(int[] iArr) {
        ...
        do {
            for (int i10 = 0; i10 != length; i10++) {
                iArrCreate[i10] = random.nextInt();
            }
            int i11 = iArrCreate[i2];
            iArrCreate[i2] = (i11 + i9) - (i11 | i9);
