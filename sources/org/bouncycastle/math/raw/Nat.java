...
public abstract class Nat {
    ...
    public static int add33At(int i2, int i3, int[] iArr, int i4, int i5) {
        int i6 = i4 + i5;
        long j2 = (((long) iArr[i6]) & M) + (((long) i3) & M);
        iArr[i6] = (int) j2;
        int i7 = i6 + 1;
        long j3 = iArr[i7];
    ...
    public static int add33To(int i2, int i3, int[] iArr) {
        long j2 = ((-1) - (((-1) - ((long) iArr[0])) | ((-1) - M))) + (((long) i3) & M);
        iArr[0] = (int) j2;
        long j3 = iArr[1];
        long j4 = (j2 >>> 32) + ((M + j3) - (M | j3)) + 1;
        iArr[1] = (int) j4;
    ...
    public static int addBothTo(int i2, int[] iArr, int i3, int[] iArr2, int i4, int[] iArr3, int i5) {
        ...
        for (int i6 = 0; i6 < i2; i6++) {
            long j3 = ((-1) - (((-1) - ((long) iArr[i3 + i6])) | ((-1) - M))) + ((-1) - (((-1) - ((long) iArr2[i4 + i6])) | ((-1) - M)));
            int i7 = i5 + i6;
            long j4 = iArr3[i7];
    ...
    public static int addBothTo(int i2, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            long j4 = iArr2[i3];
            long j5 = j2 + j3 + ((j4 + M) - (j4 | M)) + ((-1) - (((-1) - M) | ((-1) - ((long) iArr3[i3]))));
            iArr3[i3] = (int) j5;
            j2 = j5 >>> 32;
        }
        return (int) j2;
    ...
    public static int addDWordAt(int i2, long j2, int[] iArr, int i3) {
        long j3 = iArr[i3];
        long j4 = ((j3 + M) - (j3 | M)) + (j2 & M);
        iArr[i3] = (int) j4;
        int i4 = i3 + 1;
        long j5 = iArr[i4];
        long j6 = (j4 >>> 32) + ((M + j5) - (M | j5)) + (j2 >>> 32);
        iArr[i4] = (int) j6;
        if ((j6 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addDWordAt(int i2, long j2, int[] iArr, int i3, int i4) {
        int i5 = i3 + i4;
        long j3 = ((-1) - (((-1) - ((long) iArr[i5])) | ((-1) - M))) + (j2 & M);
        iArr[i5] = (int) j3;
        int i6 = i5 + 1;
        long j4 = (j3 >>> 32) + (M & ((long) iArr[i6])) + (j2 >>> 32);
        iArr[i6] = (int) j4;
        if ((j4 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addDWordTo(int i2, long j2, int[] iArr, int i3) {
        long j3 = ((-1) - (((-1) - ((long) iArr[i3])) | ((-1) - M))) + ((j2 + M) - (j2 | M));
        iArr[i3] = (int) j3;
        int i4 = i3 + 1;
        long j4 = iArr[i4];
    ...
    public static int addTo(int i2, int[] iArr, int[] iArr2) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            long j3 = iArr[i3];
            long j4 = j2 + ((j3 + M) - (j3 | M)) + (M & ((long) iArr2[i3]));
            iArr2[i3] = (int) j4;
            j2 = j4 >>> 32;
        }
        return (int) j2;
    ...
    public static int addWordAt(int i2, int i3, int[] iArr, int i4) {
        long j2 = ((-1) - (((-1) - ((long) i3)) | ((-1) - M))) + ((-1) - (((-1) - M) | ((-1) - ((long) iArr[i4]))));
        iArr[i4] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addWordAt(int i2, int i3, int[] iArr, int i4, int i5) {
        long j2 = i3;
        int i6 = i4 + i5;
        long j3 = ((j2 + M) - (j2 | M)) + ((-1) - (((-1) - M) | ((-1) - ((long) iArr[i6]))));
        iArr[i6] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addWordTo(int i2, int i3, int[] iArr) {
        long j2 = (((long) i3) & M) + ((-1) - (((-1) - M) | ((-1) - ((long) iArr[0]))));
        iArr[0] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int mul31BothAdd(int i2, int i3, int[] iArr, int i4, int[] iArr2, int[] iArr3, int i5) {
        ...
        long j3 = (-1) - (((-1) - ((long) i4)) | ((-1) - M));
        long j4 = 0;
        int i6 = 0;
        do {
            long j5 = iArr[i6];
            int i7 = i5 + i6;
            long j6 = j4 + (((j5 + M) - (j5 | M)) * j2) + ((((long) iArr2[i6]) & M) * j3) + ((-1) - (((-1) - ((long) iArr3[i7])) | ((-1) - M)));
            iArr3[i7] = (int) j6;
            j4 = j6 >>> 32;
            i6++;
        } while (i6 < i2);
    ...
    public static int mulAddTo(int i2, int[] iArr, int i3, int[] iArr2, int i4, int[] iArr3, int i5) {
        ...
        for (int i7 = 0; i7 < i2; i7++) {
            int i8 = i6 + i2;
            long jMulWordAddTo = ((-1) - (((-1) - ((long) mulWordAddTo(i2, iArr[i3 + i7], iArr2, i4, iArr3, i6))) | ((-1) - M))) + j2 + ((-1) - (((-1) - M) | ((-1) - ((long) iArr3[i8]))));
    ...
    public static int mulAddTo(int i2, int[] iArr, int[] iArr2, int[] iArr3) {
        long j2 = 0;
        for (int i3 = 0; i3 < i2; i3++) {
            long jMulWordAddTo = mulWordAddTo(i2, iArr[i3], iArr2, 0, iArr3, i3);
            int i4 = i2 + i3;
            long j3 = ((jMulWordAddTo + M) - (jMulWordAddTo | M)) + j2 + (M & ((long) iArr3[i4]));
            iArr3[i4] = (int) j3;
            j2 = j3 >>> 32;
        }
        return (int) j2;
    ...
    public static int mulWord(int i2, int i3, int[] iArr, int i4, int[] iArr2, int i5) {
        ...
        int i6 = 0;
        do {
            long j5 = j4 + ((((long) iArr[i4 + i6]) & M) * j3);
            iArr2[i5 + i6] = (int) j5;
            j4 = j5 >>> 32;
            i6++;
        } while (i6 < i2);
    ...
    public static int mulWordAddTo(int i2, int i3, int[] iArr, int i4, int[] iArr2, int i5) {
        ...
        do {
            int i7 = i5 + i6;
            long j4 = j3 + (((-1) - (((-1) - ((long) iArr[i4 + i6])) | ((-1) - M))) * j2) + ((-1) - (((-1) - ((long) iArr2[i7])) | ((-1) - M)));
            iArr2[i7] = (int) j4;
            j3 = j4 >>> 32;
            i6++;
        } while (i6 < i2);
    ...
    public static int mulWordDwordAddAt(int i2, int i3, long j2, int[] iArr, int i4) {
        long j3 = i3;
        long j4 = (j3 + M) - (j3 | M);
        long j5 = (((-1) - (((-1) - j2) | ((-1) - M))) * j4) + (((long) iArr[i4]) & M);
        iArr[i4] = (int) j5;
        int i5 = i4 + 1;
        long j6 = (j5 >>> 32) + (j4 * (j2 >>> 32)) + ((-1) - (((-1) - ((long) iArr[i5])) | ((-1) - M)));
        iArr[i5] = (int) j6;
        int i6 = i4 + 2;
        long j7 = (j6 >>> 32) + ((-1) - (((-1) - ((long) iArr[i6])) | ((-1) - M)));
        iArr[i6] = (int) j7;
        if ((j7 >>> 32) == 0) {
            return 0;
        }
    ...
    public static void square(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        do {
            ...
            long j3 = (j2 + M) - (j2 | M);
            long j4 = j3 * j3;
            iArr2[(i9 - 1) + i4] = (-1) - (((-1) - (i7 << 31)) & ((-1) - ((int) (j4 >>> 33))));
            i9 -= 2;
            iArr2[i4 + i9] = (int) (j4 >>> 1);
            i7 = (int) j4;
        } while (i8 > 0);
        for (i5 = 1; i5 < i2; i5++) {
    ...
    public static int squareWordAdd(int[] iArr, int i2, int i3, int[] iArr2, int i4) {
        long j2 = (-1) - (((-1) - ((long) iArr[i2 + i3])) | ((-1) - M));
        long j3 = 0;
        int i5 = 0;
        do {
            int i6 = i3 + i4;
            long j4 = j3 + (((-1) - (((-1) - ((long) iArr[i2 + i5])) | ((-1) - M))) * j2) + ((-1) - (((-1) - ((long) iArr2[i6])) | ((-1) - M)));
            iArr2[i6] = (int) j4;
            j3 = j4 >>> 32;
            i4++;
            i5++;
    ...
    public static int squareWordAdd(int[] iArr, int i2, int[] iArr2) {
        ...
        do {
            int i4 = i2 + i3;
            long j4 = j3 + ((((long) iArr[i3]) & M) * j2) + (((long) iArr2[i4]) & M);
            iArr2[i4] = (int) j4;
            j3 = j4 >>> 32;
            i3++;
        } while (i3 < i2);
    ...
    public static int sub(int i2, int[] iArr, int i3, int[] iArr2, int i4, int[] iArr3, int i5) {
        ...
        for (int i6 = 0; i6 < i2; i6++) {
            long j3 = iArr[i3 + i6];
            long j4 = j2 + (((j3 + M) - (j3 | M)) - (M & ((long) iArr2[i4 + i6])));
            iArr3[i5 + i6] = (int) j4;
            j2 = j4 >> 32;
        }
        return (int) j2;
    ...
    public static int sub(int i2, int[] iArr, int[] iArr2, int[] iArr3) {
        long j2 = 0;
        for (int i3 = 0; i3 < i2; i3++) {
            long j3 = j2 + ((((long) iArr[i3]) & M) - ((-1) - (((-1) - M) | ((-1) - ((long) iArr2[i3])))));
            iArr3[i3] = (int) j3;
            j2 = j3 >> 32;
        }
        return (int) j2;
    ...
    public static int sub33From(int i2, int i3, int[] iArr) {
        long j2 = iArr[0];
        long j3 = ((j2 + M) - (j2 | M)) - ((-1) - (((-1) - ((long) i3)) | ((-1) - M)));
        iArr[0] = (int) j3;
        long j4 = iArr[1];
        long j5 = (j3 >> 32) + (((M + j4) - (M | j4)) - 1);
        iArr[1] = (int) j5;
    ...
    public static int sub33From(int i2, int i3, int[] iArr, int i4) {
        ...
        iArr[i4] = (int) j3;
        int i5 = i4 + 1;
        long j4 = (j3 >> 32) + ((M & ((long) iArr[i5])) - 1);
        iArr[i5] = (int) j4;
        if ((j4 >> 32) == 0) {
            return 0;
        }
    ...
    public static int subBothFrom(int i2, int[] iArr, int i3, int[] iArr2, int i4, int[] iArr3, int i5) {
        ...
        for (int i6 = 0; i6 < i2; i6++) {
            int i7 = i5 + i6;
            long j3 = iArr3[i7];
            long j4 = j2 + ((((j3 + M) - (j3 | M)) - (((long) iArr[i3 + i6]) & M)) - (M & ((long) iArr2[i4 + i6])));
            iArr3[i7] = (int) j4;
            j2 = j4 >> 32;
        }
        return (int) j2;
    ...
    public static int subBothFrom(int i2, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            long j3 = iArr3[i3];
            long j4 = ((j3 + M) - (j3 | M)) - ((-1) - (((-1) - ((long) iArr[i3])) | ((-1) - M)));
            long j5 = iArr2[i3];
            long j6 = j2 + (j4 - ((M + j5) - (M | j5)));
            iArr3[i3] = (int) j6;
            j2 = j6 >> 32;
    ...
    public static int subDWordAt(int i2, long j2, int[] iArr, int i3) {
        long j3 = (((long) iArr[i3]) & M) - ((j2 + M) - (j2 | M));
        iArr[i3] = (int) j3;
        int i4 = i3 + 1;
    ...
    public static int subDWordFrom(int i2, long j2, int[] iArr) {
        long j3 = (((long) iArr[0]) & M) - ((j2 + M) - (j2 | M));
        iArr[0] = (int) j3;
        long j4 = (j3 >> 32) + (((-1) - (((-1) - M) | ((-1) - ((long) iArr[1])))) - (j2 >>> 32));
        iArr[1] = (int) j4;
        if ((j4 >> 32) == 0) {
            return 0;
        }
    ...
    public static int subFrom(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        for (int i5 = 0; i5 < i2; i5++) {
            int i6 = i4 + i5;
            long j3 = iArr2[i6];
            long j4 = j2 + (((j3 + M) - (j3 | M)) - ((-1) - (((-1) - M) | ((-1) - ((long) iArr[i3 + i5])))));
            iArr2[i6] = (int) j4;
            j2 = j4 >> 32;
        }
        return (int) j2;
    ...
    public static int subWordAt(int i2, int i3, int[] iArr, int i4) {
        long j2 = (((long) iArr[i4]) & M) - (M & ((long) i3));
        iArr[i4] = (int) j2;
        if ((j2 >> 32) == 0) {
            return 0;
        }
    ...
    public static int subWordAt(int i2, int i3, int[] iArr, int i4, int i5) {
        int i6 = i4 + i5;
        long j2 = (((long) iArr[i6]) & M) - (M & ((long) i3));
        iArr[i6] = (int) j2;
        if ((j2 >> 32) == 0) {
            return 0;
        }
    ...
    public static int subWordFrom(int i2, int i3, int[] iArr, int i4) {
        long j2 = iArr[i4];
        long j3 = ((j2 + M) - (j2 | M)) - ((-1) - (((-1) - M) | ((-1) - ((long) i3))));
        iArr[i4] = (int) j3;
        if ((j3 >> 32) == 0) {
            return 0;
        }
