...
public class DiscoverEndomorphisms {
    ...
    private static BigInteger[] extEuclidBezout(BigInteger[] bigIntegerArr) {
        ...
        while (bigInteger2.compareTo(ECConstants.ONE) > 0) {
            ...
            BigInteger bigIntegerSubtract = bigInteger3.subtract(bigInteger7.multiply(bigInteger4));
            BigInteger bigIntegerSubtract2 = bigInteger5.subtract(bigInteger7.multiply(bigInteger6));
            bigInteger = bigInteger2;
            bigInteger2 = bigInteger8;
            bigInteger3 = bigInteger4;
            bigInteger4 = bigIntegerSubtract;
            bigInteger5 = bigInteger6;
            bigInteger6 = bigIntegerSubtract2;
        }
    ...
    private static ECFieldElement[] findBetaValues(ECCurve eCCurve) throws Throwable {
        ...
        Constructor<?> constructor = Class.forName(Wg.Zd("1*\u0002\u0014$\u0011Ej^F<37VzvW\u0011Qk\u001bQ A+\u0015", (short) (Od.Xd() ^ (-15783)), (short) (Od.Xd() ^ (-23891)))).getConstructor(new Class[0]);
        try {
    ...
    private static void printGLVTypeBParameters(X9ECParameters x9ECParameters, BigInteger bigInteger, ECFieldElement[] eCFieldElementArr) {
        ...
        int iBitLength = n2.bitLength() + 16;
        int iBitLength2 = n2.bitLength();
        int i2 = iBitLength - ((iBitLength2 + 7) - (iBitLength2 | 7));
        BigInteger bigIntegerRoundQuotient = roundQuotient(bigIntegerArrChooseShortest[1].shiftLeft(i2), bigIntegerSubtract2);
        BigInteger bigIntegerNegate5 = roundQuotient(bigIntegerArr[1].shiftLeft(i2), bigIntegerSubtract2).negate();
        ...
        printProperty("(OPT) bits", Integer.toString(i2));
    }
