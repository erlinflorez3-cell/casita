...
public class SecP160R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP160R1FieldElement secP160R1FieldElement = (SecP160R1FieldElement) this.f27683x;
        SecP160R1FieldElement secP160R1FieldElement2 = (SecP160R1FieldElement) this.f27684y;
        ...
        if (zIsOne) {
            iArr = secP160R1FieldElement3.f27693x;
            iArr2 = secP160R1FieldElement4.f27693x;
        } else {
            SecP160R1Field.square(secP160R1FieldElement5.f27693x, iArrCreate2);
            SecP160R1Field.multiply(iArrCreate2, secP160R1FieldElement3.f27693x, iArrCreate);
            SecP160R1Field.multiply(iArrCreate2, secP160R1FieldElement5.f27693x, iArrCreate2);
            SecP160R1Field.multiply(iArrCreate2, secP160R1FieldElement4.f27693x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP160R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP160R1FieldElement.f27693x;
            iArr4 = secP160R1FieldElement2.f27693x;
        } else {
            SecP160R1Field.square(secP160R1FieldElement6.f27693x, iArrCreate3);
            SecP160R1Field.multiply(iArrCreate3, secP160R1FieldElement.f27693x, iArrCreateExt);
            SecP160R1Field.multiply(iArrCreate3, secP160R1FieldElement6.f27693x, iArrCreate3);
            SecP160R1Field.multiply(iArrCreate3, secP160R1FieldElement2.f27693x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP160R1Field.square(iArrCreate, secP160R1FieldElement7.f27693x);
        SecP160R1Field.subtract(secP160R1FieldElement7.f27693x, iArrCreate5, secP160R1FieldElement7.f27693x);
        SecP160R1FieldElement secP160R1FieldElement8 = new SecP160R1FieldElement(iArrCreate5);
        SecP160R1Field.subtract(iArrCreate2, secP160R1FieldElement7.f27693x, secP160R1FieldElement8.f27693x);
        SecP160R1Field.multiplyAddToExt(secP160R1FieldElement8.f27693x, iArrCreate, iArrCreateExt);
        SecP160R1Field.reduce(iArrCreateExt, secP160R1FieldElement8.f27693x);
        SecP160R1FieldElement secP160R1FieldElement9 = new SecP160R1FieldElement(iArrCreate4);
        if (!zIsOne) {
            SecP160R1Field.multiply(secP160R1FieldElement9.f27693x, secP160R1FieldElement5.f27693x, secP160R1FieldElement9.f27693x);
        }
        if (!zIsOne2) {
            SecP160R1Field.multiply(secP160R1FieldElement9.f27693x, secP160R1FieldElement6.f27693x, secP160R1FieldElement9.f27693x);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160R1Point(this.curve, this.f27683x, this.f27684y.negate(), this.zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP160R1FieldElement secP160R1FieldElement = (SecP160R1FieldElement) this.f27684y;
        if (secP160R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP160R1FieldElement secP160R1FieldElement2 = (SecP160R1FieldElement) this.f27683x;
        SecP160R1FieldElement secP160R1FieldElement3 = (SecP160R1FieldElement) this.zs[0];
        int[] iArrCreate = Nat160.create();
        int[] iArrCreate2 = Nat160.create();
        int[] iArrCreate3 = Nat160.create();
        SecP160R1Field.square(secP160R1FieldElement.f27693x, iArrCreate3);
        int[] iArrCreate4 = Nat160.create();
        SecP160R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP160R1FieldElement3.isOne();
        int[] iArr = secP160R1FieldElement3.f27693x;
        if (!zIsOne) {
            SecP160R1Field.square(secP160R1FieldElement3.f27693x, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP160R1Field.subtract(secP160R1FieldElement2.f27693x, iArr, iArrCreate);
        SecP160R1Field.add(secP160R1FieldElement2.f27693x, iArr, iArrCreate2);
        ...
        SecP160R1Field.square(iArrCreate2, secP160R1FieldElement4.f27693x);
        SecP160R1Field.subtract(secP160R1FieldElement4.f27693x, iArrCreate3, secP160R1FieldElement4.f27693x);
        SecP160R1Field.subtract(secP160R1FieldElement4.f27693x, iArrCreate3, secP160R1FieldElement4.f27693x);
        SecP160R1FieldElement secP160R1FieldElement5 = new SecP160R1FieldElement(iArrCreate3);
        SecP160R1Field.subtract(iArrCreate3, secP160R1FieldElement4.f27693x, secP160R1FieldElement5.f27693x);
        SecP160R1Field.multiply(secP160R1FieldElement5.f27693x, iArrCreate2, secP160R1FieldElement5.f27693x);
        SecP160R1Field.subtract(secP160R1FieldElement5.f27693x, iArrCreate, secP160R1FieldElement5.f27693x);
        SecP160R1FieldElement secP160R1FieldElement6 = new SecP160R1FieldElement(iArrCreate2);
        SecP160R1Field.twice(secP160R1FieldElement.f27693x, secP160R1FieldElement6.f27693x);
        if (!zIsOne) {
            SecP160R1Field.multiply(secP160R1FieldElement6.f27693x, secP160R1FieldElement3.f27693x, secP160R1FieldElement6.f27693x);
        }
