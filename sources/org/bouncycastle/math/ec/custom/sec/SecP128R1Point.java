...
public class SecP128R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP128R1FieldElement secP128R1FieldElement = (SecP128R1FieldElement) this.f27683x;
        SecP128R1FieldElement secP128R1FieldElement2 = (SecP128R1FieldElement) this.f27684y;
        ...
        if (zIsOne) {
            iArr = secP128R1FieldElement3.f27690x;
            iArr2 = secP128R1FieldElement4.f27690x;
        } else {
            SecP128R1Field.square(secP128R1FieldElement5.f27690x, iArrCreate2);
            SecP128R1Field.multiply(iArrCreate2, secP128R1FieldElement3.f27690x, iArrCreate);
            SecP128R1Field.multiply(iArrCreate2, secP128R1FieldElement5.f27690x, iArrCreate2);
            SecP128R1Field.multiply(iArrCreate2, secP128R1FieldElement4.f27690x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP128R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP128R1FieldElement.f27690x;
            iArr4 = secP128R1FieldElement2.f27690x;
        } else {
            SecP128R1Field.square(secP128R1FieldElement6.f27690x, iArrCreate3);
            SecP128R1Field.multiply(iArrCreate3, secP128R1FieldElement.f27690x, iArrCreateExt);
            SecP128R1Field.multiply(iArrCreate3, secP128R1FieldElement6.f27690x, iArrCreate3);
            SecP128R1Field.multiply(iArrCreate3, secP128R1FieldElement2.f27690x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP128R1Field.square(iArrCreate, secP128R1FieldElement7.f27690x);
        SecP128R1Field.subtract(secP128R1FieldElement7.f27690x, iArrCreate5, secP128R1FieldElement7.f27690x);
        SecP128R1FieldElement secP128R1FieldElement8 = new SecP128R1FieldElement(iArrCreate5);
        SecP128R1Field.subtract(iArrCreate2, secP128R1FieldElement7.f27690x, secP128R1FieldElement8.f27690x);
        SecP128R1Field.multiplyAddToExt(secP128R1FieldElement8.f27690x, iArrCreate, iArrCreateExt);
        SecP128R1Field.reduce(iArrCreateExt, secP128R1FieldElement8.f27690x);
        SecP128R1FieldElement secP128R1FieldElement9 = new SecP128R1FieldElement(iArrCreate4);
        if (!zIsOne) {
            SecP128R1Field.multiply(secP128R1FieldElement9.f27690x, secP128R1FieldElement5.f27690x, secP128R1FieldElement9.f27690x);
        }
        if (!zIsOne2) {
            SecP128R1Field.multiply(secP128R1FieldElement9.f27690x, secP128R1FieldElement6.f27690x, secP128R1FieldElement9.f27690x);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP128R1Point(this.curve, this.f27683x, this.f27684y.negate(), this.zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP128R1FieldElement secP128R1FieldElement = (SecP128R1FieldElement) this.f27684y;
        if (secP128R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP128R1FieldElement secP128R1FieldElement2 = (SecP128R1FieldElement) this.f27683x;
        SecP128R1FieldElement secP128R1FieldElement3 = (SecP128R1FieldElement) this.zs[0];
        int[] iArrCreate = Nat128.create();
        int[] iArrCreate2 = Nat128.create();
        int[] iArrCreate3 = Nat128.create();
        SecP128R1Field.square(secP128R1FieldElement.f27690x, iArrCreate3);
        int[] iArrCreate4 = Nat128.create();
        SecP128R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP128R1FieldElement3.isOne();
        int[] iArr = secP128R1FieldElement3.f27690x;
        if (!zIsOne) {
            SecP128R1Field.square(secP128R1FieldElement3.f27690x, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP128R1Field.subtract(secP128R1FieldElement2.f27690x, iArr, iArrCreate);
        SecP128R1Field.add(secP128R1FieldElement2.f27690x, iArr, iArrCreate2);
        ...
        SecP128R1Field.square(iArrCreate2, secP128R1FieldElement4.f27690x);
        SecP128R1Field.subtract(secP128R1FieldElement4.f27690x, iArrCreate3, secP128R1FieldElement4.f27690x);
        SecP128R1Field.subtract(secP128R1FieldElement4.f27690x, iArrCreate3, secP128R1FieldElement4.f27690x);
        SecP128R1FieldElement secP128R1FieldElement5 = new SecP128R1FieldElement(iArrCreate3);
        SecP128R1Field.subtract(iArrCreate3, secP128R1FieldElement4.f27690x, secP128R1FieldElement5.f27690x);
        SecP128R1Field.multiply(secP128R1FieldElement5.f27690x, iArrCreate2, secP128R1FieldElement5.f27690x);
        SecP128R1Field.subtract(secP128R1FieldElement5.f27690x, iArrCreate, secP128R1FieldElement5.f27690x);
        SecP128R1FieldElement secP128R1FieldElement6 = new SecP128R1FieldElement(iArrCreate2);
        SecP128R1Field.twice(secP128R1FieldElement.f27690x, secP128R1FieldElement6.f27690x);
        if (!zIsOne) {
            SecP128R1Field.multiply(secP128R1FieldElement6.f27690x, secP128R1FieldElement3.f27690x, secP128R1FieldElement6.f27690x);
        }
