...
public class SecP521R1Field {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        ...
        if (iInc > 511 || (iInc == 511 && Nat.eq(16, iArr2, P))) {
            iInc = (-1) - (((-1) - (iInc + Nat.inc(16, iArr2))) | ((-1) - 511));
        }
        iArr2[16] = iInc;
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        if (iShiftDownBits > 511 || (iShiftDownBits == 511 && Nat.eq(16, iArr2, P))) {
            int iInc = iShiftDownBits + Nat.inc(16, iArr2);
            iShiftDownBits = (iInc + 511) - (iInc | 511);
        }
    ...
    public static void subtract(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        if (iSub < 0) {
            int iDec = iSub + Nat.dec(16, iArr3);
            iSub = (iDec + 511) - (iDec | 511);
        }
        iArr3[16] = iSub;
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        int i2 = iArr[16];
        int iShiftUpBit = Nat.shiftUpBit(16, iArr, i2 << 23, iArr2) | (i2 << 1);
        iArr2[16] = (iShiftUpBit + 511) - (iShiftUpBit | 511);
    }
}
