...
public class SecP256K1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f27704q = new BigInteger(1, Hex.decode("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFC2F"));
    ...
    public SecP256K1Curve() {
        ...
        this.f27674b = fromBigInteger(BigInteger.valueOf(7L));
