...
public class SecT233Field {
    ...
    protected static void implMulwAcc(long j2, long j3, long[] jArr, int i2) {
        ...
        int i3 = (int) j2;
        long j8 = jArr2[(-1) - (((-1) - i3) | ((-1) - 7))];
        int i4 = i3 >>> 3;
        long j9 = (jArr2[(i4 + 7) - (i4 | 7)] << 3) ^ j8;
        long j10 = 0;
        int i5 = 54;
        do {
            int i6 = (int) (j2 >>> i5);
            long j11 = jArr2[(-1) - (((-1) - i6) | ((-1) - 7))] ^ (jArr2[(-1) - (((-1) - (i6 >>> 3)) | ((-1) - 7))] << 3);
            j9 ^= j11 << i5;
            j10 ^= j11 >>> (-i5);
            i5 -= 6;
        } while (i5 > 0);
        jArr[i2] = jArr[i2] ^ ((M59 + j9) - (M59 | j9));
        int i7 = i2 + 1;
        jArr[i7] = jArr[i7] ^ ((j9 >>> 59) ^ (j10 << 5));
    }
    ...
    protected static void implSquare(long[] jArr, long[] jArr2) {
        ...
        jArr2[7] = ((long) Interleave.expand16to32((int) (j2 >>> 32))) & 4294967295L;
    }
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j4 = (jUnshuffle2 - 4294967296L) - (jUnshuffle2 | (-4294967296L));
        long j5 = (j3 + j4) - (j3 & j4);
        long jUnshuffle3 = Interleave.unshuffle(jArr[2]);
        long jUnshuffle4 = Interleave.unshuffle(jArr[3]);
        long j6 = (4294967295L & jUnshuffle3) | (jUnshuffle4 << 32);
        long j7 = jUnshuffle3 >>> 32;
        long j8 = ((-4294967296L) + jUnshuffle4) - ((-4294967296L) | jUnshuffle4);
        long j9 = (j7 + j8) - (j7 & j8);
        long j10 = j9 >>> 27;
        long j11 = j9 ^ ((-1) - (((-1) - (j5 >>> 27)) & ((-1) - (j9 << 37))));
        long j12 = j5 ^ (j5 << 37);
        long[] jArrCreateExt64 = Nat256.createExt64();
        int[] iArr = {32, 117, 191};
        for (int i2 = 0; i2 < 3; i2++) {
            ...
            int i4 = i3 >>> 6;
            int i5 = (-1) - (((-1) - i3) | ((-1) - 63));
            jArrCreateExt64[i4] = jArrCreateExt64[i4] ^ (j12 << i5);
            int i6 = i4 + 1;
            int i7 = -i5;
            jArrCreateExt64[i6] = jArrCreateExt64[i6] ^ ((j11 << i5) | (j12 >>> i7));
            int i8 = i4 + 2;
            jArrCreateExt64[i8] = jArrCreateExt64[i8] ^ ((-1) - (((-1) - (j10 << i5)) & ((-1) - (j11 >>> i7))));
            int i9 = i4 + 3;
