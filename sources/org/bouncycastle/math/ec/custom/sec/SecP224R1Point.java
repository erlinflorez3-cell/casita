...
public class SecP224R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP224R1FieldElement secP224R1FieldElement = (SecP224R1FieldElement) this.f27683x;
        SecP224R1FieldElement secP224R1FieldElement2 = (SecP224R1FieldElement) this.f27684y;
        ...
        if (zIsOne) {
            iArr = secP224R1FieldElement3.f27703x;
            iArr2 = secP224R1FieldElement4.f27703x;
        } else {
            SecP224R1Field.square(secP224R1FieldElement5.f27703x, iArrCreate2);
            SecP224R1Field.multiply(iArrCreate2, secP224R1FieldElement3.f27703x, iArrCreate);
            SecP224R1Field.multiply(iArrCreate2, secP224R1FieldElement5.f27703x, iArrCreate2);
            SecP224R1Field.multiply(iArrCreate2, secP224R1FieldElement4.f27703x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP224R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP224R1FieldElement.f27703x;
            iArr4 = secP224R1FieldElement2.f27703x;
        } else {
            SecP224R1Field.square(secP224R1FieldElement6.f27703x, iArrCreate3);
            SecP224R1Field.multiply(iArrCreate3, secP224R1FieldElement.f27703x, iArrCreateExt);
            SecP224R1Field.multiply(iArrCreate3, secP224R1FieldElement6.f27703x, iArrCreate3);
            SecP224R1Field.multiply(iArrCreate3, secP224R1FieldElement2.f27703x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP224R1Field.square(iArrCreate, secP224R1FieldElement7.f27703x);
        SecP224R1Field.subtract(secP224R1FieldElement7.f27703x, iArrCreate5, secP224R1FieldElement7.f27703x);
        SecP224R1FieldElement secP224R1FieldElement8 = new SecP224R1FieldElement(iArrCreate5);
        SecP224R1Field.subtract(iArrCreate2, secP224R1FieldElement7.f27703x, secP224R1FieldElement8.f27703x);
        SecP224R1Field.multiplyAddToExt(secP224R1FieldElement8.f27703x, iArrCreate, iArrCreateExt);
        SecP224R1Field.reduce(iArrCreateExt, secP224R1FieldElement8.f27703x);
        SecP224R1FieldElement secP224R1FieldElement9 = new SecP224R1FieldElement(iArrCreate4);
        if (!zIsOne) {
            SecP224R1Field.multiply(secP224R1FieldElement9.f27703x, secP224R1FieldElement5.f27703x, secP224R1FieldElement9.f27703x);
        }
        if (!zIsOne2) {
            SecP224R1Field.multiply(secP224R1FieldElement9.f27703x, secP224R1FieldElement6.f27703x, secP224R1FieldElement9.f27703x);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP224R1Point(this.curve, this.f27683x, this.f27684y.negate(), this.zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP224R1FieldElement secP224R1FieldElement = (SecP224R1FieldElement) this.f27684y;
        if (secP224R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP224R1FieldElement secP224R1FieldElement2 = (SecP224R1FieldElement) this.f27683x;
        SecP224R1FieldElement secP224R1FieldElement3 = (SecP224R1FieldElement) this.zs[0];
        int[] iArrCreate = Nat224.create();
        int[] iArrCreate2 = Nat224.create();
        int[] iArrCreate3 = Nat224.create();
        SecP224R1Field.square(secP224R1FieldElement.f27703x, iArrCreate3);
        int[] iArrCreate4 = Nat224.create();
        SecP224R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP224R1FieldElement3.isOne();
        int[] iArr = secP224R1FieldElement3.f27703x;
        if (!zIsOne) {
            SecP224R1Field.square(secP224R1FieldElement3.f27703x, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP224R1Field.subtract(secP224R1FieldElement2.f27703x, iArr, iArrCreate);
        SecP224R1Field.add(secP224R1FieldElement2.f27703x, iArr, iArrCreate2);
        ...
        SecP224R1Field.square(iArrCreate2, secP224R1FieldElement4.f27703x);
        SecP224R1Field.subtract(secP224R1FieldElement4.f27703x, iArrCreate3, secP224R1FieldElement4.f27703x);
        SecP224R1Field.subtract(secP224R1FieldElement4.f27703x, iArrCreate3, secP224R1FieldElement4.f27703x);
        SecP224R1FieldElement secP224R1FieldElement5 = new SecP224R1FieldElement(iArrCreate3);
        SecP224R1Field.subtract(iArrCreate3, secP224R1FieldElement4.f27703x, secP224R1FieldElement5.f27703x);
        SecP224R1Field.multiply(secP224R1FieldElement5.f27703x, iArrCreate2, secP224R1FieldElement5.f27703x);
        SecP224R1Field.subtract(secP224R1FieldElement5.f27703x, iArrCreate, secP224R1FieldElement5.f27703x);
        SecP224R1FieldElement secP224R1FieldElement6 = new SecP224R1FieldElement(iArrCreate2);
        SecP224R1Field.twice(secP224R1FieldElement.f27703x, secP224R1FieldElement6.f27703x);
        if (!zIsOne) {
            SecP224R1Field.multiply(secP224R1FieldElement6.f27703x, secP224R1FieldElement3.f27703x, secP224R1FieldElement6.f27703x);
        }
