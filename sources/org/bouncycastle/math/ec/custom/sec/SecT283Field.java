...
public class SecT283Field {
    ...
    protected static void implExpand(long[] jArr, long[] jArr2) {
        ...
        long j7 = (j3 >>> 50) ^ (j4 << 14);
        jArr2[2] = (j7 + M57) - (j7 | M57);
        jArr2[3] = (-1) - (((-1) - ((j4 >>> 43) ^ (j5 << 21))) | ((-1) - M57));
        jArr2[4] = (j5 >>> 36) ^ (j6 << 28);
    }
    ...
    protected static void implMulw(long j2, long j3, long[] jArr, int i2) {
        ...
        long j8 = jArr2[(-1) - (((-1) - ((int) j2)) | ((-1) - 7))];
        long j9 = 0;
        int i3 = 48;
        do {
            int i4 = (int) (j2 >>> i3);
            int i5 = i4 >>> 3;
            long j10 = (jArr2[(i4 + 7) - (7 | i4)] ^ (jArr2[(i5 + 7) - (i5 | 7)] << 3)) ^ (jArr2[(-1) - (((-1) - (i4 >>> 6)) | ((-1) - 7))] << 6);
            j8 ^= j10 << i3;
            j9 ^= j10 >>> (-i3);
            i3 -= 9;
        } while (i3 > 0);
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j2 = (jUnshuffle + 4294967295L) - (jUnshuffle | 4294967295L);
        ...
        jArr2[0] = jArr2[0] ^ j4;
        jArr2[1] = jArr2[1] ^ ((jUnshuffle3 & 4294967295L) | (jUnshuffle4 << 32));
