...
public class SecP224K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP224K1FieldElement secP224K1FieldElement = (SecP224K1FieldElement) this.f27683x;
        SecP224K1FieldElement secP224K1FieldElement2 = (SecP224K1FieldElement) this.f27684y;
        ...
        if (zIsOne) {
            iArr = secP224K1FieldElement3.f27701x;
            iArr2 = secP224K1FieldElement4.f27701x;
        } else {
            SecP224K1Field.square(secP224K1FieldElement5.f27701x, iArrCreate2);
            SecP224K1Field.multiply(iArrCreate2, secP224K1FieldElement3.f27701x, iArrCreate);
            SecP224K1Field.multiply(iArrCreate2, secP224K1FieldElement5.f27701x, iArrCreate2);
            SecP224K1Field.multiply(iArrCreate2, secP224K1FieldElement4.f27701x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP224K1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP224K1FieldElement.f27701x;
            iArr4 = secP224K1FieldElement2.f27701x;
        } else {
            SecP224K1Field.square(secP224K1FieldElement6.f27701x, iArrCreate3);
            SecP224K1Field.multiply(iArrCreate3, secP224K1FieldElement.f27701x, iArrCreateExt);
            SecP224K1Field.multiply(iArrCreate3, secP224K1FieldElement6.f27701x, iArrCreate3);
            SecP224K1Field.multiply(iArrCreate3, secP224K1FieldElement2.f27701x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP224K1Field.square(iArrCreate, secP224K1FieldElement7.f27701x);
        SecP224K1Field.subtract(secP224K1FieldElement7.f27701x, iArrCreate5, secP224K1FieldElement7.f27701x);
        SecP224K1FieldElement secP224K1FieldElement8 = new SecP224K1FieldElement(iArrCreate5);
        SecP224K1Field.subtract(iArrCreate2, secP224K1FieldElement7.f27701x, secP224K1FieldElement8.f27701x);
        SecP224K1Field.multiplyAddToExt(secP224K1FieldElement8.f27701x, iArrCreate, iArrCreateExt);
        SecP224K1Field.reduce(iArrCreateExt, secP224K1FieldElement8.f27701x);
        SecP224K1FieldElement secP224K1FieldElement9 = new SecP224K1FieldElement(iArrCreate4);
        if (!zIsOne) {
            SecP224K1Field.multiply(secP224K1FieldElement9.f27701x, secP224K1FieldElement5.f27701x, secP224K1FieldElement9.f27701x);
        }
        if (!zIsOne2) {
            SecP224K1Field.multiply(secP224K1FieldElement9.f27701x, secP224K1FieldElement6.f27701x, secP224K1FieldElement9.f27701x);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP224K1Point(this.curve, this.f27683x, this.f27684y.negate(), this.zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP224K1FieldElement secP224K1FieldElement = (SecP224K1FieldElement) this.f27684y;
        if (secP224K1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP224K1FieldElement secP224K1FieldElement2 = (SecP224K1FieldElement) this.f27683x;
        SecP224K1FieldElement secP224K1FieldElement3 = (SecP224K1FieldElement) this.zs[0];
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.square(secP224K1FieldElement.f27701x, iArrCreate);
        int[] iArrCreate2 = Nat224.create();
        SecP224K1Field.square(iArrCreate, iArrCreate2);
        int[] iArrCreate3 = Nat224.create();
        SecP224K1Field.square(secP224K1FieldElement2.f27701x, iArrCreate3);
        SecP224K1Field.reduce32(Nat224.addBothTo(iArrCreate3, iArrCreate3, iArrCreate3), iArrCreate3);
        SecP224K1Field.multiply(iArrCreate, secP224K1FieldElement2.f27701x, iArrCreate);
        ...
        SecP224K1Field.square(iArrCreate3, secP224K1FieldElement4.f27701x);
        SecP224K1Field.subtract(secP224K1FieldElement4.f27701x, iArrCreate, secP224K1FieldElement4.f27701x);
        SecP224K1Field.subtract(secP224K1FieldElement4.f27701x, iArrCreate, secP224K1FieldElement4.f27701x);
        SecP224K1FieldElement secP224K1FieldElement5 = new SecP224K1FieldElement(iArrCreate);
        SecP224K1Field.subtract(iArrCreate, secP224K1FieldElement4.f27701x, secP224K1FieldElement5.f27701x);
        SecP224K1Field.multiply(secP224K1FieldElement5.f27701x, iArrCreate3, secP224K1FieldElement5.f27701x);
        SecP224K1Field.subtract(secP224K1FieldElement5.f27701x, iArrCreate4, secP224K1FieldElement5.f27701x);
        SecP224K1FieldElement secP224K1FieldElement6 = new SecP224K1FieldElement(iArrCreate3);
        SecP224K1Field.twice(secP224K1FieldElement.f27701x, secP224K1FieldElement6.f27701x);
        if (!secP224K1FieldElement3.isOne()) {
            SecP224K1Field.multiply(secP224K1FieldElement6.f27701x, secP224K1FieldElement3.f27701x, secP224K1FieldElement6.f27701x);
        }
