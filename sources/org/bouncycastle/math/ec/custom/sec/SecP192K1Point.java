...
public class SecP192K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP192K1FieldElement secP192K1FieldElement = (SecP192K1FieldElement) this.f27683x;
        SecP192K1FieldElement secP192K1FieldElement2 = (SecP192K1FieldElement) this.f27684y;
        ...
        if (zIsOne) {
            iArr = secP192K1FieldElement3.f27697x;
            iArr2 = secP192K1FieldElement4.f27697x;
        } else {
            SecP192K1Field.square(secP192K1FieldElement5.f27697x, iArrCreate2);
            SecP192K1Field.multiply(iArrCreate2, secP192K1FieldElement3.f27697x, iArrCreate);
            SecP192K1Field.multiply(iArrCreate2, secP192K1FieldElement5.f27697x, iArrCreate2);
            SecP192K1Field.multiply(iArrCreate2, secP192K1FieldElement4.f27697x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP192K1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP192K1FieldElement.f27697x;
            iArr4 = secP192K1FieldElement2.f27697x;
        } else {
            SecP192K1Field.square(secP192K1FieldElement6.f27697x, iArrCreate3);
            SecP192K1Field.multiply(iArrCreate3, secP192K1FieldElement.f27697x, iArrCreateExt);
            SecP192K1Field.multiply(iArrCreate3, secP192K1FieldElement6.f27697x, iArrCreate3);
            SecP192K1Field.multiply(iArrCreate3, secP192K1FieldElement2.f27697x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP192K1Field.square(iArrCreate, secP192K1FieldElement7.f27697x);
        SecP192K1Field.subtract(secP192K1FieldElement7.f27697x, iArrCreate5, secP192K1FieldElement7.f27697x);
        SecP192K1FieldElement secP192K1FieldElement8 = new SecP192K1FieldElement(iArrCreate5);
        SecP192K1Field.subtract(iArrCreate2, secP192K1FieldElement7.f27697x, secP192K1FieldElement8.f27697x);
        SecP192K1Field.multiplyAddToExt(secP192K1FieldElement8.f27697x, iArrCreate, iArrCreateExt);
        SecP192K1Field.reduce(iArrCreateExt, secP192K1FieldElement8.f27697x);
        SecP192K1FieldElement secP192K1FieldElement9 = new SecP192K1FieldElement(iArrCreate4);
        if (!zIsOne) {
            SecP192K1Field.multiply(secP192K1FieldElement9.f27697x, secP192K1FieldElement5.f27697x, secP192K1FieldElement9.f27697x);
        }
        if (!zIsOne2) {
            SecP192K1Field.multiply(secP192K1FieldElement9.f27697x, secP192K1FieldElement6.f27697x, secP192K1FieldElement9.f27697x);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP192K1Point(this.curve, this.f27683x, this.f27684y.negate(), this.zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP192K1FieldElement secP192K1FieldElement = (SecP192K1FieldElement) this.f27684y;
        if (secP192K1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP192K1FieldElement secP192K1FieldElement2 = (SecP192K1FieldElement) this.f27683x;
        SecP192K1FieldElement secP192K1FieldElement3 = (SecP192K1FieldElement) this.zs[0];
        int[] iArrCreate = Nat192.create();
        SecP192K1Field.square(secP192K1FieldElement.f27697x, iArrCreate);
        int[] iArrCreate2 = Nat192.create();
        SecP192K1Field.square(iArrCreate, iArrCreate2);
        int[] iArrCreate3 = Nat192.create();
        SecP192K1Field.square(secP192K1FieldElement2.f27697x, iArrCreate3);
        SecP192K1Field.reduce32(Nat192.addBothTo(iArrCreate3, iArrCreate3, iArrCreate3), iArrCreate3);
        SecP192K1Field.multiply(iArrCreate, secP192K1FieldElement2.f27697x, iArrCreate);
        ...
        SecP192K1Field.square(iArrCreate3, secP192K1FieldElement4.f27697x);
        SecP192K1Field.subtract(secP192K1FieldElement4.f27697x, iArrCreate, secP192K1FieldElement4.f27697x);
        SecP192K1Field.subtract(secP192K1FieldElement4.f27697x, iArrCreate, secP192K1FieldElement4.f27697x);
        SecP192K1FieldElement secP192K1FieldElement5 = new SecP192K1FieldElement(iArrCreate);
        SecP192K1Field.subtract(iArrCreate, secP192K1FieldElement4.f27697x, secP192K1FieldElement5.f27697x);
        SecP192K1Field.multiply(secP192K1FieldElement5.f27697x, iArrCreate3, secP192K1FieldElement5.f27697x);
        SecP192K1Field.subtract(secP192K1FieldElement5.f27697x, iArrCreate4, secP192K1FieldElement5.f27697x);
        SecP192K1FieldElement secP192K1FieldElement6 = new SecP192K1FieldElement(iArrCreate3);
        SecP192K1Field.twice(secP192K1FieldElement.f27697x, secP192K1FieldElement6.f27697x);
        if (!secP192K1FieldElement3.isOne()) {
            SecP192K1Field.multiply(secP192K1FieldElement6.f27697x, secP192K1FieldElement3.f27697x, secP192K1FieldElement6.f27697x);
        }
