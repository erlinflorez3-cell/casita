...
public class SecP256R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP256R1FieldElement secP256R1FieldElement = (SecP256R1FieldElement) this.f27683x;
        SecP256R1FieldElement secP256R1FieldElement2 = (SecP256R1FieldElement) this.f27684y;
        ...
        if (zIsOne) {
            iArr = secP256R1FieldElement3.f27707x;
            iArr2 = secP256R1FieldElement4.f27707x;
        } else {
            SecP256R1Field.square(secP256R1FieldElement5.f27707x, iArrCreate2);
            SecP256R1Field.multiply(iArrCreate2, secP256R1FieldElement3.f27707x, iArrCreate);
            SecP256R1Field.multiply(iArrCreate2, secP256R1FieldElement5.f27707x, iArrCreate2);
            SecP256R1Field.multiply(iArrCreate2, secP256R1FieldElement4.f27707x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP256R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP256R1FieldElement.f27707x;
            iArr4 = secP256R1FieldElement2.f27707x;
        } else {
            SecP256R1Field.square(secP256R1FieldElement6.f27707x, iArrCreate3);
            SecP256R1Field.multiply(iArrCreate3, secP256R1FieldElement.f27707x, iArrCreateExt);
            SecP256R1Field.multiply(iArrCreate3, secP256R1FieldElement6.f27707x, iArrCreate3);
            SecP256R1Field.multiply(iArrCreate3, secP256R1FieldElement2.f27707x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP256R1Field.square(iArrCreate, secP256R1FieldElement7.f27707x);
        SecP256R1Field.subtract(secP256R1FieldElement7.f27707x, iArrCreate5, secP256R1FieldElement7.f27707x);
        SecP256R1FieldElement secP256R1FieldElement8 = new SecP256R1FieldElement(iArrCreate5);
        SecP256R1Field.subtract(iArrCreate2, secP256R1FieldElement7.f27707x, secP256R1FieldElement8.f27707x);
        SecP256R1Field.multiplyAddToExt(secP256R1FieldElement8.f27707x, iArrCreate, iArrCreateExt);
        SecP256R1Field.reduce(iArrCreateExt, secP256R1FieldElement8.f27707x);
        SecP256R1FieldElement secP256R1FieldElement9 = new SecP256R1FieldElement(iArrCreate4);
        if (!zIsOne) {
            SecP256R1Field.multiply(secP256R1FieldElement9.f27707x, secP256R1FieldElement5.f27707x, secP256R1FieldElement9.f27707x);
        }
        if (!zIsOne2) {
            SecP256R1Field.multiply(secP256R1FieldElement9.f27707x, secP256R1FieldElement6.f27707x, secP256R1FieldElement9.f27707x);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP256R1Point(this.curve, this.f27683x, this.f27684y.negate(), this.zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP256R1FieldElement secP256R1FieldElement = (SecP256R1FieldElement) this.f27684y;
        if (secP256R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP256R1FieldElement secP256R1FieldElement2 = (SecP256R1FieldElement) this.f27683x;
        SecP256R1FieldElement secP256R1FieldElement3 = (SecP256R1FieldElement) this.zs[0];
        int[] iArrCreate = Nat256.create();
        int[] iArrCreate2 = Nat256.create();
        int[] iArrCreate3 = Nat256.create();
        SecP256R1Field.square(secP256R1FieldElement.f27707x, iArrCreate3);
        int[] iArrCreate4 = Nat256.create();
        SecP256R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP256R1FieldElement3.isOne();
        int[] iArr = secP256R1FieldElement3.f27707x;
        if (!zIsOne) {
            SecP256R1Field.square(secP256R1FieldElement3.f27707x, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP256R1Field.subtract(secP256R1FieldElement2.f27707x, iArr, iArrCreate);
        SecP256R1Field.add(secP256R1FieldElement2.f27707x, iArr, iArrCreate2);
        ...
        SecP256R1Field.square(iArrCreate2, secP256R1FieldElement4.f27707x);
        SecP256R1Field.subtract(secP256R1FieldElement4.f27707x, iArrCreate3, secP256R1FieldElement4.f27707x);
        SecP256R1Field.subtract(secP256R1FieldElement4.f27707x, iArrCreate3, secP256R1FieldElement4.f27707x);
        SecP256R1FieldElement secP256R1FieldElement5 = new SecP256R1FieldElement(iArrCreate3);
        SecP256R1Field.subtract(iArrCreate3, secP256R1FieldElement4.f27707x, secP256R1FieldElement5.f27707x);
        SecP256R1Field.multiply(secP256R1FieldElement5.f27707x, iArrCreate2, secP256R1FieldElement5.f27707x);
        SecP256R1Field.subtract(secP256R1FieldElement5.f27707x, iArrCreate, secP256R1FieldElement5.f27707x);
        SecP256R1FieldElement secP256R1FieldElement6 = new SecP256R1FieldElement(iArrCreate2);
        SecP256R1Field.twice(secP256R1FieldElement.f27707x, secP256R1FieldElement6.f27707x);
        if (!zIsOne) {
            SecP256R1Field.multiply(secP256R1FieldElement6.f27707x, secP256R1FieldElement3.f27707x, secP256R1FieldElement6.f27707x);
        }
