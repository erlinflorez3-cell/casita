...
public class Curve25519Field {
    ...
    private static int addPExtTo(int[] iArr) {
        ...
        long j4 = jIncAt + (((-1) - (((-1) - ((long) iArr[8])) | ((-1) - M))) - 19);
        iArr[8] = (int) j4;
        long jDecAt = j4 >> 32;
        if (jDecAt != 0) {
            jDecAt = Nat.decAt(15, iArr, 9);
        }
        long j5 = jDecAt + ((-1) - (((-1) - ((long) iArr[15])) | ((-1) - M))) + ((-1) - (((-1) - M) | ((-1) - ((long) (iArr2[15] + 1)))));
        iArr[15] = (int) j5;
        return (int) (j5 >> 32);
    }
    ...
    private static int addPTo(int[] iArr) {
        ...
        long j3 = jDecAt + ((-1) - (((-1) - M) | ((-1) - ((long) iArr[7])))) + CacheValidityPolicy.MAX_AGE;
        iArr[7] = (int) j3;
        return (int) (j3 >> 32);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        int i3 = iArr2[7];
        iArr2[7] = (i3 & Integer.MAX_VALUE) + Nat.addWordTo(7, (iMulByWordAddTo + ((i3 >>> 31) - (i2 >>> 31))) * 19, iArr2);
        if (Nat256.gte(iArr2, P)) {
            subPFrom(iArr2);
        }
    }
    ...
    public static void reduce27(int i2, int[] iArr) {
        int i3 = iArr[7];
        iArr[7] = (i3 & Integer.MAX_VALUE) + Nat.addWordTo(7, ((-1) - (((-1) - (i2 << 1)) & ((-1) - (i3 >>> 31)))) * 19, iArr);
    ...
    private static int subPExtFrom(int[] iArr) {
        ...
        long j5 = jDecAt + (((long) iArr[8]) & M) + 19;
        iArr[8] = (int) j5;
        long jIncAt = j5 >> 32;
        if (jIncAt != 0) {
            jIncAt = Nat.incAt(15, iArr, 9);
        }
        long j6 = jIncAt + (((-1) - (((-1) - ((long) iArr[15])) | ((-1) - M))) - ((-1) - (((-1) - M) | ((-1) - ((long) (iArr2[15] + 1))))));
        iArr[15] = (int) j6;
        return (int) (j6 >> 32);
    }

    private static int subPFrom(int[] iArr) {
        long j2 = ((-1) - (((-1) - ((long) iArr[0])) | ((-1) - M))) + 19;
        iArr[0] = (int) j2;
        long jIncAt = j2 >> 32;
        if (jIncAt != 0) {
            jIncAt = Nat.incAt(7, iArr, 1);
        }
        long j3 = jIncAt + (((-1) - (((-1) - M) | ((-1) - ((long) iArr[7])))) - CacheValidityPolicy.MAX_AGE);
        iArr[7] = (int) j3;
        return (int) (j3 >> 32);
    }
