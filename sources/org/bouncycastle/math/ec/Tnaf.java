...
class Tnaf {
    ...
    public static BigInteger norm(byte b2, ZTauElement zTauElement) {
        ...
        BigInteger bigIntegerMultiply = zTauElement.f27685u.multiply(zTauElement.f27685u);
        BigInteger bigIntegerMultiply2 = zTauElement.f27685u.multiply(zTauElement.f27686v);
        BigInteger bigIntegerShiftLeft = zTauElement.f27686v.multiply(zTauElement.f27686v).shiftLeft(1);
        if (b2 == 1) {
    ...
    public static ZTauElement partModReduction(BigInteger bigInteger, int i2, byte b2, BigInteger[] bigIntegerArr, byte b3, byte b4) {
        ...
        return new ZTauElement(bigInteger.subtract(bigIntegerAdd.multiply(zTauElementRound.f27685u)).subtract(BigInteger.valueOf(2L).multiply(bigIntegerArr[1]).multiply(zTauElementRound.f27686v)), bigIntegerArr[1].multiply(zTauElementRound.f27685u).subtract(bigIntegerArr[0].multiply(zTauElementRound.f27686v)));
    }

    /* JADX WARN: Code restructure failed: missing block: B:21:0x0061, code lost:
    
        if (r7.compareTo(org.bouncycastle.math.ec.ECConstants.ONE) >= 0) goto L22;
     */
    ...
    */
    public static org.bouncycastle.math.ec.ZTauElement round(org.bouncycastle.math.ec.SimpleBigDecimal r9, org.bouncycastle.math.ec.SimpleBigDecimal r10, byte r11) {
        /*
            int r1 = r9.getScale()
            int r0 = r10.getScale()
            if (r0 != r1) goto La8
        ...
        L10:
            ...
            org.bouncycastle.math.ec.SimpleBigDecimal r9 = r9.subtract(r2)
            org.bouncycastle.math.ec.SimpleBigDecimal r6 = r10.subtract(r3)
            org.bouncycastle.math.ec.SimpleBigDecimal r0 = r9.add(r9)
            if (r11 != r1) goto L9b
            org.bouncycastle.math.ec.SimpleBigDecimal r8 = r0.add(r6)
        L2a:
            org.bouncycastle.math.ec.SimpleBigDecimal r0 = r6.add(r6)
            org.bouncycastle.math.ec.SimpleBigDecimal r4 = r0.add(r6)
            org.bouncycastle.math.ec.SimpleBigDecimal r0 = r4.add(r6)
            if (r11 != r1) goto L92
            org.bouncycastle.math.ec.SimpleBigDecimal r7 = r9.subtract(r4)
            org.bouncycastle.math.ec.SimpleBigDecimal r6 = r9.add(r0)
        L40:
            java.math.BigInteger r0 = org.bouncycastle.math.ec.ECConstants.ONE
            int r0 = r8.compareTo(r0)
            r4 = 0
            if (r0 < 0) goto L87
            java.math.BigInteger r0 = org.bouncycastle.math.ec.Tnaf.MINUS_ONE
        ...
        L66:
            ...
            org.bouncycastle.math.ec.ZTauElement r0 = new org.bouncycastle.math.ec.ZTauElement
            r0.<init>(r2, r1)
            return r0
        L7e:
            java.math.BigInteger r0 = org.bouncycastle.math.ec.Tnaf.MINUS_TWO
        ...
        L90:
            ...
            goto L53
        L92:
            org.bouncycastle.math.ec.SimpleBigDecimal r7 = r9.add(r4)
            org.bouncycastle.math.ec.SimpleBigDecimal r6 = r9.subtract(r0)
            goto L40
        L9b:
            org.bouncycastle.math.ec.SimpleBigDecimal r8 = r0.subtract(r6)
            goto L2a
        La0:
    ...
    public static byte[] tauAdicNaf(byte b2, ZTauElement zTauElement) {
        ...
        BigInteger bigIntegerClearBit = zTauElement.f27685u;
        BigInteger bigIntegerNegate = zTauElement.f27686v;
        int i2 = 0;
        int i3 = 0;
        while (true) {
    ...
    public static byte[] tauAdicWNaf(byte b2, ZTauElement zTauElement, byte b3, BigInteger bigInteger, BigInteger bigInteger2, ZTauElement[] zTauElementArr) {
        ...
        BigInteger bigIntegerAdd = zTauElement.f27685u;
        BigInteger bigIntegerNegate = zTauElement.f27686v;
        int i2 = 0;
        while (true) {
            ...
            if (bigIntegerAdd.testBit(0)) {
                ...
                if (z2) {
                    bigIntegerAdd = bigIntegerAdd.subtract(zTauElementArr[bIntValue].f27685u);
                    bigIntegerNegate = bigIntegerNegate.subtract(zTauElementArr[bIntValue].f27686v);
                } else {
                    bigIntegerAdd = bigIntegerAdd.add(zTauElementArr[bIntValue].f27685u);
                    bigIntegerNegate = bigIntegerNegate.add(zTauElementArr[bIntValue].f27686v);
                }
            } else {
                bArr[i2] = 0;
            }
            BigInteger bigIntegerShiftRight2 = bigIntegerAdd.shiftRight(1);
            BigInteger bigIntegerAdd2 = b2 == 1 ? bigIntegerNegate.add(bigIntegerShiftRight2) : bigIntegerNegate.subtract(bigIntegerShiftRight2);
