...
public class Skein {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        private void addSkeinMacAlgorithm(ConfigurableProvider configurableProvider, int i2, int i3) {
            String str = "Skein-MAC-" + i2 + Global.HYPHEN + i3;
            StringBuilder sb = new StringBuilder();
            String str2 = PREFIX;
            String string = sb.append(str2).append("$SkeinMac_").append(i2).append(Global.UNDERSCORE).append(i3).toString();
            String str3 = str2 + "$SkeinMacKeyGenerator_" + i2 + Global.UNDERSCORE + i3;
            configurableProvider.addAlgorithm("Mac." + str, string);
            configurableProvider.addAlgorithm("Alg.Alias.Mac.Skein-MAC" + i2 + RemoteSettings.FORWARD_SLASH_STRING + i3, str);
            configurableProvider.addAlgorithm("KeyGenerator." + str, str3);
            configurableProvider.addAlgorithm("Alg.Alias.KeyGenerator.Skein-MAC" + i2 + RemoteSettings.FORWARD_SLASH_STRING + i3, str);
        }
