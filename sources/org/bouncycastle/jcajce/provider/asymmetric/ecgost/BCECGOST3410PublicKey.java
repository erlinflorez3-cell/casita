...
public class BCECGOST3410PublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public String toString() {
        ...
        stringBuffer.append("            X: ").append(q2.getAffineXCoord().toBigInteger().toString(16)).append(strLineSeparator);
        stringBuffer.append("            Y: ").append(q2.getAffineYCoord().toBigInteger().toString(16)).append(strLineSeparator);
