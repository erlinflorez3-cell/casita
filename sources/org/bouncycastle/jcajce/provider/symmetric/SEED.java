    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        protected AlgorithmParameters engineGenerateParameters() throws Throwable {
            ...
            if (this.random == null) {
                ...
                Constructor<?> constructor = Class.forName(Wg.Zd("C}.\u0004c$!\u001a>&8n\u00076fs\u0006\u0003\u001bxx\u0003ZKhQ", (short) (ZN.Xd() ^ 6955), (short) (ZN.Xd() ^ 17677))).getConstructor(new Class[0]);
                try {
            ...
            Object[] objArr2 = {bArr};
            Method method = Class.forName(C1561oA.Xd(">6L8\u0006L?>QOGSY\u000f5HGZXL:JXO[Z", (short) (ZN.Xd() ^ 26092))).getMethod(Wg.vd("^Tje6ljZk", (short) (ZN.Xd() ^ 30350)), byte[].class);
            try {
                method.setAccessible(true);
                method.invoke(secureRandom, objArr2);
                try {
                    AlgorithmParameters algorithmParametersCreateParametersInstance = createParametersInstance(Qg.kd("\u001f\u0010\u000f\r", (short) (C1607wl.Xd() ^ 32537), (short) (C1607wl.Xd() ^ 14331)));
