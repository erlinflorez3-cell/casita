    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        protected AlgorithmParameters engineGenerateParameters() throws Throwable {
            ...
            if (this.random == null) {
                ...
                Constructor<?> constructor = Class.forName(C1561oA.od("\u0011\u0007\u001b\u0005P\u0015\u0006\u0003\u0014\u0010\u0006\u0010\u0014Gk|y\u000b\u0007xdr~s}z", (short) (C1580rY.Xd() ^ (-15879)))).getConstructor(new Class[0]);
                try {
            ...
            Object[] objArr2 = {bArr};
            Method method = Class.forName(C1561oA.Kd("PH^J\u0018^QPcaYek!GZYlj^L\\jaml", (short) (C1633zX.Xd() ^ (-19233)))).getMethod(Wg.Zd("T\u001cPl[%AR\u0002", (short) (C1499aX.Xd() ^ (-12539)), (short) (C1499aX.Xd() ^ (-26734))), byte[].class);
            try {
                method.setAccessible(true);
                method.invoke(secureRandom, objArr2);
                try {
                    AlgorithmParameters algorithmParametersCreateParametersInstance = createParametersInstance(C1561oA.Xd("d`b_", (short) (C1607wl.Xd() ^ 10091)));
