...
public final class RC2 {
    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        protected AlgorithmParameters engineGenerateParameters() throws Throwable {
            ...
            String strYd = C1561oA.yd("XH6", (short) (ZN.Xd() ^ 9147));
            if (rC2ParameterSpec != null) {
                try {
                    AlgorithmParameters algorithmParametersCreateParametersInstance = createParametersInstance(strYd);
            ...
            if (this.random == null) {
                ...
                Constructor<?> constructor = Class.forName(C1561oA.Yd("\n\u0002\u0018\u0004Q\u0018\u000b\n\u001d\u001b\u0013\u001f%Z\u0001\u0014\u0013&$\u0018\u0006\u0016$\u001b'&", (short) (Od.Xd() ^ (-17064)))).getConstructor(new Class[0]);
                try {
            ...
            Object[] objArr2 = {bArr};
            Method method = Class.forName(Xg.qd("vn\u0005p>\u0005wv\n\b\u007f\f\u0012Gm\u0001\u007f\u0013\u0011\u0005r\u0003\u0011\b\u0014\u0013", (short) (C1633zX.Xd() ^ (-9416)), (short) (C1633zX.Xd() ^ (-26321)))).getMethod(Jg.Wd("\u0010}P\u0002zx2W\u0017", (short) (C1580rY.Xd() ^ (-14149)), (short) (C1580rY.Xd() ^ (-32449))), byte[].class);
            try {
                method.setAccessible(true);
                method.invoke(secureRandom, objArr2);
                try {
                    AlgorithmParameters algorithmParametersCreateParametersInstance2 = createParametersInstance(strYd);
