    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        protected AlgorithmParameters engineGenerateParameters() throws Throwable {
            ...
            if (this.random == null) {
                ...
                Constructor<?> constructor = Class.forName(Wg.vd("\u001a\u0010$\u000ea&\u0017\u0014-)\u001f)5h\r\u001e\u0003\u0014\u0010\u0002u\u0004\u0010\u0005\u0017\u0014", (short) (FB.Xd() ^ 28031))).getConstructor(new Class[0]);
                try {
            ...
            Object[] objArr2 = {bArr};
            Method method = Class.forName(Qg.kd(";1E/z?0->:0:>q\u0016'$51#\u000f\u001d)\u001e(%", (short) (OY.Xd() ^ 21370), (short) (OY.Xd() ^ 29135))).getMethod(hg.Vd("4*<7\u0004:4$1", (short) (C1607wl.Xd() ^ 17373), (short) (C1607wl.Xd() ^ AuthApiStatusCodes.AUTH_API_SERVER_ERROR)), byte[].class);
            try {
                method.setAccessible(true);
                method.invoke(secureRandom, objArr2);
                try {
                    AlgorithmParameters algorithmParametersCreateParametersInstance = createParametersInstance(C1561oA.ud("\u0002\u0002\u000f", (short) (C1633zX.Xd() ^ (-10000))));
    ...
    public static class KeyGenerator extends BaseKeyGenerator {
        ...
        protected SecretKey engineGenerateKey() throws Throwable {
            if (this.uninitialised) {
                ...
                short sXd = (short) (OY.Xd() ^ 20243);
                int[] iArr = new int["vl\u0001j>\u0003spyuku\u00025Yj_pl^R`lac`".length()];
                QB qb = new QB("vl\u0001j>\u0003spyuku\u00025Yj_pl^R`lac`");
                int i2 = 0;
                while (qb.YK()) {
                    int iKK = qb.KK();
                    Xu xuXd = Xu.Xd(iKK);
