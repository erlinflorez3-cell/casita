    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        protected AlgorithmParameters engineGenerateParameters() throws Throwable {
            ...
            if (this.random == null) {
                ...
                Constructor<?> constructor = Class.forName(C1561oA.Yd("\u0017\u000f%\u0011^%\u0018\u0017*( ,2g\u000e! 31%\u0013#1(43", (short) (OY.Xd() ^ 27037))).getConstructor(new Class[0]);
                try {
            ...
            Object[] objArr2 = {bArr};
            Method method = Class.forName(Xg.qd("E=S?\rSFEXVNZ`\u0016<ONa_SAQ_Vba", (short) (C1607wl.Xd() ^ 12857), (short) (C1607wl.Xd() ^ 31926))).getMethod(Jg.Wd("[+;q3%\u001dHL", (short) (C1499aX.Xd() ^ (-12464)), (short) (C1499aX.Xd() ^ (-4267))), byte[].class);
            try {
                method.setAccessible(true);
                method.invoke(secureRandom, objArr2);
                try {
                    AlgorithmParameters algorithmParametersCreateParametersInstance = createParametersInstance(ZO.xd("&\u0015\u001b", (short) (C1499aX.Xd() ^ (-21993)), (short) (C1499aX.Xd() ^ (-19064))));
    ...
    public static class KeyGenerator extends BaseKeyGenerator {
        ...
        protected SecretKey engineGenerateKey() throws Throwable {
            if (this.uninitialised) {
                ...
                short sXd = (short) (ZN.Xd() ^ 14918);
                short sXd2 = (short) (ZN.Xd() ^ 2292);
                int[] iArr = new int["k?t\n(6,\u001d}>#|\u001dW_\u000b:\u001fcZvTcUWY".length()];
                QB qb = new QB("k?t\n(6,\u001d}>#|\u001dW_\u000b:\u001fcZvTcUWY");
                int i2 = 0;
                while (qb.YK()) {
                    int iKK = qb.KK();
