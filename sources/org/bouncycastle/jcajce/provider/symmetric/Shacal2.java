    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        protected AlgorithmParameters engineGenerateParameters() throws Throwable {
            ...
            if (this.random == null) {
                ...
                Constructor<?> constructor = Class.forName(Xg.qd("OG]I\u0017]POb`Xdj FYXki]K[i`lk", (short) (Od.Xd() ^ (-4290)), (short) (Od.Xd() ^ (-26573)))).getConstructor(new Class[0]);
                try {
            ...
            Object[] objArr2 = {bArr};
            Method method = Class.forName(Jg.Wd("s\u001c\u0015`\u00119\u000fmcC\u001e\nr\n\u0013\u0006G,\r`1#\u0014jY:", (short) (C1499aX.Xd() ^ (-19619)), (short) (C1499aX.Xd() ^ (-10451)))).getMethod(ZO.xd("fmN(\u00078%io", (short) (ZN.Xd() ^ 15878), (short) (ZN.Xd() ^ 13403)), byte[].class);
            try {
                method.setAccessible(true);
                method.invoke(secureRandom, objArr2);
                short sXd = (short) (C1633zX.Xd() ^ (-31155));
                short sXd2 = (short) (C1633zX.Xd() ^ (-32095));
                int[] iArr = new int["P\u0017z\u0006\u000fe\u0013".length()];
                QB qb = new QB("P\u0017z\u0006\u000fe\u0013");
                int i2 = 0;
                while (qb.YK()) {
                    int iKK = qb.KK();
