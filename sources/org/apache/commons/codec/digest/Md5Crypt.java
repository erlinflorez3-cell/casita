...
public class Md5Crypt {
    ...
    public static String md5Crypt(byte[] bArr, String str, String str2) throws Throwable {
        short sXd = (short) (ZN.Xd() ^ 3289);
        ...
        try {
            ...
            return md5Crypt(bArr, str, str2, (SecureRandom) constructor.newInstance(objArr));
    ...
    public static String md5Crypt(byte[] bArr, String str, String str2, Random random) {
        ...
        for (int i2 = length; i2 > 0; i2 -= 16) {
            md5Digest.update(bArrDigest, 0, Math.min(i2, 16));
        }
