...
public class Sha2Crypt {
    ...
    private static String sha2Crypt(byte[] bArr, String str, String str2, int i2, String str3) {
        ...
        int i5 = 0;
        while (i5 < length - i2) {
            System.arraycopy(bArrDigest3, 0, bArr2, i5, i2);
            i5 += i2;
        }
        System.arraycopy(bArrDigest3, 0, bArr2, i5, length - i5);
        ...
        int i7 = 0;
        while (i7 < length2 - i2) {
            System.arraycopy(bArrDigest4, 0, bArr3, i7, i2);
            i7 += i2;
        }
        System.arraycopy(bArrDigest4, 0, bArr3, i7, length2 - i7);
        for (int i8 = 0; i8 <= iMax - 1; i8++) {
            ...
            if (i9 != 0) {
                ...
                i3 = 0;
                digest.update(bArrDigest2, 0, i2);
            }
            if (i8 % 3 != 0) {
                digest.update(bArr3, i3, length2);
            }
            if (i8 % 7 != 0) {
                digest.update(bArr2, i3, length);
            }
            if (i9 != 0) {
                digest.update(bArrDigest2, i3, i2);
            } else {
                digest.update(bArr2, i3, length);
            }
