...
@QualifierForLiterals(stringPatterns = {}, value = {LiteralKind.STRING})
@Retention(RetentionPolicy.RUNTIME)
@SubtypeOf({MonotonicNonNull.class})
@DefaultFor(names = {}, namesExceptions = {}, typeKinds = {}, types = {}, value = {TypeUseLocation.EXCEPTION_PARAMETER})
@Documented
