...
public class Blake2bDigest implements ExtendedDigest {
    ...
    private final long bytes2long(byte[] bArr, int i2) {
        ...
        long j6 = ((j3 + j5) - (j3 & j5)) | ((((long) bArr[i2 + 2]) & 255) << 16);
        long j7 = ((-1) - (((-1) - ((long) bArr[i2 + 3])) | ((-1) - 255))) << 24;
        long j8 = (j6 + j7) - (j6 & j7);
        long j9 = bArr[i2 + 4];
        long j10 = ((j9 + 255) - (j9 | 255)) << 32;
        long j11 = (j8 + j10) - (j8 & j10);
        long j12 = (((long) bArr[i2 + 5]) & 255) << 40;
        return (((-1) - (((-1) - ((long) bArr[i2 + 7])) | ((-1) - 255))) << 56) | ((-1) - (((-1) - ((j11 + j12) - (j11 & j12))) & ((-1) - ((((long) bArr[i2 + 6]) & 255) << 48))));
    }
    ...
    private void init() {
        if (this.chainValue == null) {
            long[] jArr = {jArr[0] ^ ((long) ((-1) - (((-1) - (this.digestLength | (this.keyLength << 8))) & ((-1) - R.attr.theme)))), jArr[1], jArr[2], jArr[3], j, jArr[5], 0, 0};
    ...
    private void initializeInternalState() {
        ...
        long[] jArr3 = this.internalState;
        jArr3[12] = this.f27884t0 ^ jArr2[4];
        jArr3[13] = this.t1 ^ jArr2[5];
        jArr3[14] = this.f27883f0 ^ jArr2[6];
        jArr3[15] = jArr2[7];
    }
