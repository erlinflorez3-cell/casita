...
public class SkeinEngine implements Memoable {
    ...
    private static class UbiTweak {
        ...
        public void advancePosition(int i2) {
            ...
            long j3 = jArr3[0];
            jArr2[0] = (j3 + 4294967295L) - (j3 | 4294967295L);
            ...
            long j6 = ((-1) - (((-1) - jArr2[1]) | ((-1) - 4294967295L))) << 32;
            long j7 = jArr2[0];
            jArr4[0] = j6 | ((j7 + 4294967295L) - (j7 | 4294967295L));
            long j8 = (-1) - (((-1) - jArr4[1]) | ((-1) - (-4294967296L)));
            long j9 = jArr2[2];
            long j10 = (j9 + 4294967295L) - (j9 | 4294967295L);
            jArr4[1] = (j10 + j8) - (j10 & j8);
        }

        public int getType() {
            return (int) ((-1) - (((-1) - (this.tweak[1] >>> 56)) | ((-1) - 63)));
        }
        ...
        public void setFirst(boolean z2) {
            if (z2) {
                ...
                long[] jArr2 = this.tweak;
                jArr2[1] = (-1) - (((-1) - jArr2[1]) | ((-1) - (-4611686018427387905L)));
            }
        }
        ...
        public void setType(int i2) {
            long[] jArr = this.tweak;
            long j2 = jArr[1];
            long j3 = (j2 - 274877906944L) - (j2 | (-274877906944L));
            long j4 = ((-1) - (((-1) - ((long) i2)) | ((-1) - 63))) << 56;
            jArr[1] = (j3 + j4) - (j3 & j4);
        }
    ...
    private static Integer variantIdentifier(int i2, int i3) {
        int i4 = i3 << 16;
        return new Integer((i2 + i4) - (i2 & i4));
    }
