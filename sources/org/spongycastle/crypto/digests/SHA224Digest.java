...
public class SHA224Digest extends GeneralDigest implements EncodableDigest {
    ...
    private int Maj(int i2, int i3, int i4) {
        return ((i2 & i4) ^ (i2 & i3)) ^ ((i3 + i4) - (i3 | i4));
    }
    ...
    private int Sum0(int i2) {
        ...
        int i6 = i2 >>> 13;
        int i7 = i2 << 19;
        return ((-1) - (((-1) - (i2 << 10)) & ((-1) - (i2 >>> 22)))) ^ (i5 ^ ((i6 + i7) - (i6 & i7)));
    }

    private int Sum1(int i2) {
        int i3 = i2 >>> 6;
        int i4 = i2 << 26;
        return ((i2 << 7) | (i2 >>> 25)) ^ (((i3 + i4) - (i3 & i4)) ^ ((i2 >>> 11) | (i2 << 21)));
    }
    ...
    protected void processWord(byte[] bArr, int i2) {
        int i3 = (-1) - (((-1) - (bArr[i2] << Ascii.CAN)) & ((-1) - (((-1) - (((-1) - bArr[i2 + 1]) | ((-1) - 255))) << 16)));
