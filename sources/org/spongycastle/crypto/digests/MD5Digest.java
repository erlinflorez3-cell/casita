...
public class MD5Digest extends GeneralDigest {
    ...
    private int F(int i2, int i3, int i4) {
        return (-1) - (((-1) - ((-1) - (((-1) - (~i2)) | ((-1) - i4)))) & ((-1) - ((i3 + i2) - (i3 | i2))));
    }

    private int G(int i2, int i3, int i4) {
        return (-1) - (((-1) - (i2 & i4)) & ((-1) - (i3 & (~i4))));
    }
    ...
    protected void processBlock() {
        ...
        int i4 = this.H3;
        int i5 = this.H4;
        int iRotateLeft = rotateLeft(((i2 + F(i3, i4, i5)) + this.X[0]) - 680876936, 7) + i3;
        int iRotateLeft2 = rotateLeft(((i5 + F(iRotateLeft, i3, i4)) + this.X[1]) - 389564586, 12) + iRotateLeft;
        int iRotateLeft3 = rotateLeft(i4 + F(iRotateLeft2, iRotateLeft, i3) + this.X[2] + 606105819, 17) + iRotateLeft2;
        int iRotateLeft4 = rotateLeft(((i3 + F(iRotateLeft3, iRotateLeft2, iRotateLeft)) + this.X[3]) - 1044525330, 22) + iRotateLeft3;
    ...
    protected void processWord(byte[] bArr, int i2) {
        ...
        int i7 = ((i5 + i6) - (i5 & i6)) | ((bArr[i2 + 2] & 255) << 16);
        byte b3 = bArr[i2 + 3];
        iArr[i3] = (((b3 + 255) - (b3 | 255)) << 24) | i7;
        if (i4 == 16) {
            processBlock();
        }
    }
