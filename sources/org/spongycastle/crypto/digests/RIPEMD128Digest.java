...
public class RIPEMD128Digest extends GeneralDigest {
    ...
    protected void processBlock() {
        ...
        int iFF4 = FF4(i2, i3, i4, i5, this.X[5], 8);
        int iFF42 = FF4(i5, iFF4, i3, i4, this.X[14], 9);
        int iFF43 = FF4(i4, iFF42, iFF4, i3, this.X[7], 9);
        int iFF44 = FF4(i3, iFF43, iFF42, iFF4, this.X[0], 11);
    ...
    protected void processWord(byte[] bArr, int i2) {
        ...
        byte b2 = bArr[i2 + 1];
        int i6 = (-1) - (((-1) - ((-1) - (((-1) - i5) & ((-1) - (((b2 + 255) - (b2 | 255)) << 8))))) & ((-1) - (((-1) - (((-1) - bArr[i2 + 2]) | ((-1) - 255))) << 16)));
        byte b3 = bArr[i2 + 3];
        iArr[i3] = (-1) - (((-1) - (((b3 + 255) - (b3 | 255)) << 24)) & ((-1) - i6));
        if (i4 == 16) {
            processBlock();
        }
    }
