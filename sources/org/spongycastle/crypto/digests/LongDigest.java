...
public abstract class LongDigest implements ExtendedDigest, Memoable, EncodableDigest {
    ...
    private long Ch(long j2, long j3, long j4) {
        long j5 = (-1) - (((-1) - j3) | ((-1) - j2));
        long j6 = ~j2;
        return ((j6 + j4) - (j6 | j4)) ^ j5;
    }

    private long Maj(long j2, long j3, long j4) {
        return (((j2 + j4) - (j2 | j4)) ^ ((j2 + j3) - (j2 | j3))) ^ ((j3 + j4) - (j3 | j4));
    }

    private long Sigma0(long j2) {
        return (j2 >>> 7) ^ (((-1) - (((-1) - (j2 << 63)) & ((-1) - (j2 >>> 1)))) ^ ((-1) - (((-1) - (j2 << 56)) & ((-1) - (j2 >>> 8)))));
    }
    ...
    private long Sum0(long j2) {
        return ((-1) - (((-1) - (j2 >>> 39)) & ((-1) - (j2 << 25)))) ^ (((-1) - (((-1) - (j2 << 36)) & ((-1) - (j2 >>> 28)))) ^ ((j2 << 30) | (j2 >>> 34)));
    }

    private long Sum1(long j2) {
        long j3 = j2 << 50;
        long j4 = j2 >>> 14;
        return ((j2 >>> 41) | (j2 << 23)) ^ (((j3 + j4) - (j3 & j4)) ^ ((j2 << 46) | (j2 >>> 18)));
    }
    ...
    private void adjustByteCounts() {
        ...
        if (j2 > 2305843009213693951L) {
            ...
            this.byteCount1 = (-1) - (((-1) - j2) | ((-1) - 2305843009213693951L));
        }
    }
