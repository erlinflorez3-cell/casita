...
public class SHA256Digest extends GeneralDigest implements EncodableDigest {
    ...
    private int Ch(int i2, int i3, int i4) {
        return ((~i2) & i4) ^ ((-1) - (((-1) - i3) | ((-1) - i2)));
    }

    private int Maj(int i2, int i3, int i4) {
        return (((i2 + i4) - (i2 | i4)) ^ (i2 & i3)) ^ (i3 & i4);
    }

    private int Sum0(int i2) {
        int i3 = i2 >>> 13;
        int i4 = i2 << 19;
        return ((i2 << 10) | (i2 >>> 22)) ^ (((-1) - (((-1) - (i2 >>> 2)) & ((-1) - (i2 << 30)))) ^ ((i3 + i4) - (i3 & i4)));
    }

    private int Sum1(int i2) {
        return ((i2 << 7) | (i2 >>> 25)) ^ (((-1) - (((-1) - (i2 >>> 6)) & ((-1) - (i2 << 26)))) ^ ((-1) - (((-1) - (i2 >>> 11)) & ((-1) - (i2 << 21)))));
    }

    private int Theta0(int i2) {
        int i3 = i2 >>> 7;
        int i4 = i2 << 25;
        return (i2 >>> 3) ^ (((i3 + i4) - (i3 & i4)) ^ ((-1) - (((-1) - (i2 >>> 18)) & ((-1) - (i2 << 14)))));
    }

    private int Theta1(int i2) {
        int i3 = i2 >>> 17;
        int i4 = i2 << 15;
        return (i2 >>> 10) ^ (((i3 + i4) - (i3 & i4)) ^ ((-1) - (((-1) - (i2 >>> 19)) & ((-1) - (i2 << 13)))));
    }
    ...
    protected void processWord(byte[] bArr, int i2) {
        ...
        byte b3 = bArr[i2 + 2];
        int i5 = (-1) - (((-1) - (bArr[i2 + 3] & 255)) & ((-1) - ((-1) - (((-1) - i4) & ((-1) - (((b3 + 255) - (b3 | 255)) << 8))))));
        int[] iArr = this.X;
        int i6 = this.xOff;
        iArr[i6] = i5;
        int i7 = i6 + 1;
