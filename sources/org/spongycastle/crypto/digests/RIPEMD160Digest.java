...
public class RIPEMD160Digest extends GeneralDigest {
    ...
    private int f3(int i2, int i3, int i4) {
        int i5 = ~i3;
        return ((i2 + i5) - (i2 & i5)) ^ i4;
    }

    private int f4(int i2, int i3, int i4) {
        int i5 = ~i4;
        return (-1) - (((-1) - ((i2 + i4) - (i2 | i4))) & ((-1) - ((i3 + i5) - (i3 | i5))));
    }

    private int f5(int i2, int i3, int i4) {
        return i2 ^ ((-1) - (((-1) - i3) & ((-1) - (~i4))));
    }
    ...
    protected void processBlock() {
        ...
        int i5 = this.H3;
        int i6 = this.H4;
        int iRL = RL(f1(i3, i4, i5) + i2 + this.X[0], 11) + i6;
        int iRL2 = RL(i4, 10);
        int iRL3 = RL(f1(iRL, i3, iRL2) + i6 + this.X[1], 14) + i5;
        int iRL4 = RL(i3, 10);
        int iRL5 = RL(f1(iRL3, iRL, iRL4) + i5 + this.X[2], 15) + iRL2;
        int iRL6 = RL(iRL, 10);
        ...
        int iRL33 = RL(i2 + f5(i3, i4, i5) + this.X[5] + 1352829926, 8) + i6;
        int iRL34 = RL(i4, 10);
        int iRL35 = RL(i6 + f5(iRL33, i3, iRL34) + this.X[14] + 1352829926, 9) + i5;
        int iRL36 = RL(i3, 10);
        int iRL37 = RL(i5 + f5(iRL35, iRL33, iRL36) + this.X[7] + 1352829926, 9) + iRL34;
    ...
    protected void processWord(byte[] bArr, int i2) {
        ...
        int i4 = i3 + 1;
        this.xOff = i4;
        int i5 = (-1) - (((-1) - ((-1) - (((-1) - bArr[i2]) | ((-1) - 255)))) & ((-1) - ((bArr[i2 + 1] & 255) << 8)));
        int i6 = (bArr[i2 + 2] & 255) << 16;
        int i7 = (i5 + i6) - (i5 & i6);
        byte b2 = bArr[i2 + 3];
        iArr[i3] = (((b2 + 255) - (b2 | 255)) << 24) | i7;
        if (i4 == 16) {
            processBlock();
        }
    }
