...
public abstract class Pack {
    public static int bigEndianToInt(byte[] bArr, int i2) {
        ...
        return ((-1) - (((-1) - bArr[i2 + 3]) | ((-1) - 255))) | ((i3 + i4) - (i3 & i4)) | (((-1) - (((-1) - bArr[i2 + 2]) | ((-1) - 255))) << 8);
    }
    ...
    public static long bigEndianToLong(byte[] bArr, int i2) {
        long jBigEndianToInt = bigEndianToInt(bArr, i2);
        return (((long) bigEndianToInt(bArr, i2 + 4)) & 4294967295L) | (((jBigEndianToInt + 4294967295L) - (jBigEndianToInt | 4294967295L)) << 32);
    }
    ...
    public static int littleEndianToInt(byte[] bArr, int i2) {
        ...
        int i5 = (i3 + i4) - (i3 & i4);
        int i6 = (bArr[i2 + 2] & 255) << 16;
        return (bArr[i2 + 3] << Ascii.CAN) | ((i5 + i6) - (i5 & i6));
    }
    ...
    public static long littleEndianToLong(byte[] bArr, int i2) {
        ...
        return (-1) - (((-1) - (((jLittleEndianToInt + 4294967295L) - (jLittleEndianToInt | 4294967295L)) << 32)) & ((-1) - ((-1) - (((-1) - ((long) iLittleEndianToInt)) | ((-1) - 4294967295L)))));
    }
    ...
    public static void longToBigEndian(long j2, byte[] bArr, int i2) {
        ...
        intToBigEndian((int) ((-1) - (((-1) - j2) | ((-1) - 4294967295L))), bArr, i2 + 4);
    }
    ...
    public static void longToLittleEndian(long j2, byte[] bArr, int i2) {
        intToLittleEndian((int) ((4294967295L + j2) - (4294967295L | j2)), bArr, i2);
