    ...
    private int procedure_A(int i2, int i3, BigInteger[] bigIntegerArr, int i4) {
        ...
        while (i10 < i7) {
            ...
            while (true) {
                ...
                while (i12 < i11) {
                    int i13 = i12 + 1;
                    bigIntegerArr2[i13] = bigIntegerArr2[i12].multiply(bigInteger2).add(bigInteger).mod(TWO.pow(i8));
                    i12 = i13;
                }
                BigInteger bigInteger3 = new BigInteger(AdkSettings.PLATFORM_TYPE_MOBILE);
                for (int i14 = i5; i14 < i11; i14++) {
                    bigInteger3 = bigInteger3.add(bigIntegerArr2[i14].multiply(TWO.pow(i14 * 16)));
                }
                bigIntegerArr2[i5] = bigIntegerArr2[i11];
                BigInteger bigInteger4 = TWO;
                int i15 = i9 + 1;
                BigInteger bigIntegerAdd = bigInteger4.pow(iArr[i9] - 1).divide(bigIntegerArr3[i15]).add(bigInteger4.pow(iArr[i9] - 1).multiply(bigInteger3).divide(bigIntegerArr3[i15].multiply(bigInteger4.pow(i11 * 16))));
                BigInteger bigIntegerMod = bigIntegerAdd.mod(bigInteger4);
                BigInteger bigInteger5 = ONE;
                if (bigIntegerMod.compareTo(bigInteger5) == 0) {
                    bigIntegerAdd = bigIntegerAdd.add(bigInteger5);
                }
                int i16 = 0;
                while (true) {
                    long j2 = i16;
                    ...
                    BigInteger bigIntegerAdd2 = bigIntegerMultiply.add(bigInteger6);
                    bigIntegerArr3[i9] = bigIntegerAdd2;
                    BigInteger bigInteger7 = TWO;
                    if (bigIntegerAdd2.compareTo(bigInteger7.pow(iArr[i9])) == 1) {
                        break;
                    }
                    if (bigInteger7.modPow(bigIntegerArr3[i15].multiply(bigIntegerAdd.add(BigInteger.valueOf(j2))), bigIntegerArr3[i9]).compareTo(bigInteger6) == 0 && bigInteger7.modPow(bigIntegerAdd.add(BigInteger.valueOf(j2)), bigIntegerArr3[i9]).compareTo(bigInteger6) != 0) {
                        break;
                    }
                    i16 += 2;
                }
    ...
    private long procedure_Aa(long j2, long j3, BigInteger[] bigIntegerArr, int i2) {
        ...
        while (i7 < i5) {
            ...
            while (true) {
                ...
                while (i10 < i9) {
                    int i11 = i10 + 1;
                    bigIntegerArr2[i11] = bigIntegerArr2[i10].multiply(bigInteger2).add(bigInteger).mod(TWO.pow(i8));
                    i10 = i11;
                }
                BigInteger bigInteger3 = new BigInteger(AdkSettings.PLATFORM_TYPE_MOBILE);
                for (int i12 = i3; i12 < i9; i12++) {
                    bigInteger3 = bigInteger3.add(bigIntegerArr2[i12].multiply(TWO.pow(i12 * 32)));
                }
                bigIntegerArr2[i3] = bigIntegerArr2[i9];
                BigInteger bigInteger4 = TWO;
                int i13 = i6 + 1;
                BigInteger bigIntegerAdd = bigInteger4.pow(iArr[i6] - 1).divide(bigIntegerArr3[i13]).add(bigInteger4.pow(iArr[i6] - 1).multiply(bigInteger3).divide(bigIntegerArr3[i13].multiply(bigInteger4.pow(i9 * 32))));
                BigInteger bigIntegerMod = bigIntegerAdd.mod(bigInteger4);
                BigInteger bigInteger5 = ONE;
                if (bigIntegerMod.compareTo(bigInteger5) == 0) {
                    bigIntegerAdd = bigIntegerAdd.add(bigInteger5);
                ...
                while (true) {
                    ...
                    BigInteger bigInteger7 = TWO;
                    if (bigIntegerAdd2.compareTo(bigInteger7.pow(iArr[i6])) == 1) {
                        break;
                    }
                    if (bigInteger7.modPow(bigIntegerArr3[i13].multiply(bigIntegerAdd.add(BigInteger.valueOf(j4))), bigIntegerArr3[i6]).compareTo(bigInteger6) == 0 && bigInteger7.modPow(bigIntegerAdd.add(BigInteger.valueOf(j4)), bigIntegerArr3[i6]).compareTo(bigInteger6) != 0) {
                        break;
                    }
                    i14 += 2;
                }
