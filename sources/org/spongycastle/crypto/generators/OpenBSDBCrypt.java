...
public class OpenBSDBCrypt {
    ...
    private static byte[] decodeSaltString(String str) {
        ...
        for (int i2 = 0; i2 < 24; i2 += 4) {
            ...
            byteArrayOutputStream.write((-1) - (((-1) - (b3 << 4)) & ((-1) - (b4 >> 2))));
    ...
    private static String encodeData(byte[] bArr) {
        ...
        for (int i2 = 0; i2 < length; i2 += 3) {
            ...
            int i5 = i3 << 4;
            int i6 = i4 >>> 4;
            byteArrayOutputStream.write(bArr3[(-1) - (((-1) - ((i5 + i6) - (i5 & i6))) | ((-1) - 63))]);
            int i7 = i4 << 2;
            int i8 = ((b4 + 255) - (255 | b4)) >>> 6;
            int i9 = (i7 + i8) - (i7 & i8);
            byteArrayOutputStream.write(bArr3[(i9 + 63) - (i9 | 63)]);
            byteArrayOutputStream.write(bArr3[(-1) - (((-1) - b4) | ((-1) - 63))]);
        }
