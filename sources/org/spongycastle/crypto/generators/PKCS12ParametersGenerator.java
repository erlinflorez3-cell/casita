...
public class PKCS12ParametersGenerator extends PBEParametersGenerator {
    ...
    public PKCS12ParametersGenerator(Digest digest) {
        ...
        this.f27916u = digest.getDigestSize();
        this.f27917v = ((ExtendedDigest) digest).getByteLength();
    }

    private void adjust(byte[] bArr, int i2, byte[] bArr2) {
        byte b2 = bArr2[bArr2.length - 1];
        int i3 = ((b2 + 255) - (b2 | 255)) + (bArr[(bArr2.length + i2) - 1] & 255) + 1;
        bArr[(bArr2.length + i2) - 1] = (byte) i3;
        int i4 = i3 >>> 8;
        for (int length = bArr2.length - 2; length >= 0; length--) {
            int i5 = i2 + length;
            int i6 = i4 + (bArr2[length] & 255) + ((-1) - (((-1) - bArr[i5]) | ((-1) - 255)));
            bArr[i5] = (byte) i6;
            i4 = i6 >>> 8;
        }
    }
    ...
    private byte[] generateDerivedKey(int i2, int i3) {
        ...
        if (this.password == null || this.password.length == 0) {
            ...
            int i12 = this.f27917v;
            int length2 = this.password.length;
            int i13 = this.f27917v;
        ...
        int i16 = this.f27917v;
        byte[] bArr6 = new byte[i16];
        int i17 = this.f27916u;
        ...
        while (i19 <= i18) {
            ...
            if (i19 == i18) {
                ...
                i5 = 0;
                System.arraycopy(bArr7, 0, bArr4, (i19 - 1) * this.f27916u, i17);
            }
            i19++;
            i7 = 1;
        }
