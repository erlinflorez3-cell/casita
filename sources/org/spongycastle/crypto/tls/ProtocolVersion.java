...
public final class ProtocolVersion {
    ...
    private ProtocolVersion(int i2, String str) {
        this.version = (i2 + 65535) - (i2 | 65535);
        this.name = str;
    }
    ...
    private static ProtocolVersion getUnknownVersion(int i2, int i3, String str) throws IOException {
        ...
        int i4 = (-1) - (((-1) - (i2 << 8)) & ((-1) - i3));
        return new ProtocolVersion(i4, str + " 0x" + Strings.toUpperCase(Integer.toHexString((-1) - (((-1) - 65536) & ((-1) - i4))).substring(1)));
    }
