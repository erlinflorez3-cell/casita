...
class DTLSRecordLayer implements DatagramTransport {
    ...
    private static long getMacSequenceNumber(int i2, long j2) {
        long j3 = (((long) i2) & 4294967295L) << 48;
        return (j3 + j2) - (j3 & j2);
    }
    ...
    /* JADX WARN: Type inference failed for: r8v1, types: [org.spongycastle.crypto.tls.DTLSEpoch, org.spongycastle.crypto.tls.DTLSHandshakeRetransmit] */
