...
public class DTLSClientProtocol extends DTLSProtocol {
    ...
    protected DTLSTransport clientHandshake(ClientHandshakeState clientHandshakeState, DTLSRecordLayer dTLSRecordLayer) throws IOException {
        ...
        while (messageReceiveMessage.getType() == 3) {
            ...
            byte[] bArrPatchClientHelloWithCookie = patchClientHelloWithCookie(bArrGenerateClientHello, processHelloVerifyRequest(clientHandshakeState, messageReceiveMessage.getBody()));
        ...
        if (messageReceiveMessage.getType() != 2) {
        ...
        processServerHello(clientHandshakeState, messageReceiveMessage.getBody());
        ...
        if (clientHandshakeState.resumedSession) {
            ...
            processFinished(dTLSReliableHandshake.receiveMessageBody((short) 20), TlsUtils.calculateVerifyData(clientHandshakeState.clientContext, "server finished", TlsProtocol.getCurrentPRFHash(clientHandshakeState.clientContext, dTLSReliableHandshake.getHandshakeHash(), null)));
