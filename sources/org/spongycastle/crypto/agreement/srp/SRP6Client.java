...
public class SRP6Client {
    ...
    protected BigInteger f27874a;
    protected Digest digest;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    protected BigInteger f27875g;
    protected SecureRandom random;

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    protected BigInteger f27876u;

    /* JADX INFO: renamed from: x, reason: collision with root package name */
    protected BigInteger f27877x;

    private BigInteger calculateS() {
        BigInteger bigIntegerCalculateK = SRP6Util.calculateK(this.digest, this.N, this.f27875g);
        return this.B.subtract(this.f27875g.modPow(this.f27877x, this.N).multiply(bigIntegerCalculateK).mod(this.N)).mod(this.N).modPow(this.f27876u.multiply(this.f27877x).add(this.f27874a), this.N);
    }
    ...
    public BigInteger calculateSecret(BigInteger bigInteger) throws CryptoException {
        ...
        this.f27876u = SRP6Util.calculateU(this.digest, this.N, this.A, bigIntegerValidatePublicValue);
    ...
    public BigInteger generateClientCredentials(byte[] bArr, byte[] bArr2, byte[] bArr3) {
        this.f27877x = SRP6Util.calculateX(this.digest, this.N, bArr, bArr2, bArr3);
        BigInteger bigIntegerSelectPrivateValue = selectPrivateValue();
        this.f27874a = bigIntegerSelectPrivateValue;
        BigInteger bigIntegerModPow = this.f27875g.modPow(bigIntegerSelectPrivateValue, this.N);
    ...
    protected BigInteger selectPrivateValue() {
        return SRP6Util.generatePrivateValue(this.digest, this.N, this.f27875g, this.random);
    }
