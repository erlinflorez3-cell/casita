...
public class SRP6Server {
    ...
    protected BigInteger f27878b;
    protected Digest digest;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    protected BigInteger f27879g;
    protected SecureRandom random;

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    protected BigInteger f27880u;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    protected BigInteger f27881v;

    private BigInteger calculateS() {
        return this.f27881v.modPow(this.f27880u, this.N).multiply(this.A).mod(this.N).modPow(this.f27878b, this.N);
    }
    ...
    public BigInteger calculateSecret(BigInteger bigInteger) throws CryptoException {
        ...
        this.f27880u = SRP6Util.calculateU(this.digest, this.N, bigIntegerValidatePublicValue, this.B);
    ...
    public BigInteger generateServerCredentials() {
        BigInteger bigIntegerCalculateK = SRP6Util.calculateK(this.digest, this.N, this.f27879g);
        this.f27878b = selectPrivateValue();
        BigInteger bigIntegerMod = bigIntegerCalculateK.multiply(this.f27881v).mod(this.N).add(this.f27879g.modPow(this.f27878b, this.N)).mod(this.N);
    ...
    public void init(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, Digest digest, SecureRandom secureRandom) {
        this.N = bigInteger;
        this.f27879g = bigInteger2;
        this.f27881v = bigInteger3;
    ...
    protected BigInteger selectPrivateValue() {
        return SRP6Util.generatePrivateValue(this.digest, this.N, this.f27879g, this.random);
    }
