...
public class VMPCRandomGenerator implements RandomGenerator {
    ...
    public void addSeedMaterial(byte[] bArr) {
        for (byte b2 : bArr) {
            byte[] bArr2 = this.P;
            byte b3 = this.f27977s;
            byte b4 = this.f27976n;
            int i2 = b3 + bArr2[255 & b4] + b2;
            byte b5 = bArr2[(i2 + 255) - (i2 | 255)];
            this.f27977s = b5;
            byte b6 = bArr2[(-1) - (((-1) - b4) | ((-1) - 255))];
            bArr2[(-1) - (((-1) - b4) | ((-1) - 255))] = bArr2[(-1) - (((-1) - b5) | ((-1) - 255))];
            bArr2[(-1) - (((-1) - b5) | ((-1) - 255))] = b6;
            int i3 = b4 + 1;
            this.f27976n = (byte) ((i3 + 255) - (i3 | 255));
        }
    }
    ...
    public void nextBytes(byte[] bArr, int i2, int i3) {
        synchronized (this.P) {
            ...
            while (i2 != i4) {
                byte[] bArr2 = this.P;
                byte b2 = this.f27977s;
                byte b3 = this.f27976n;
                byte b4 = bArr2[(b2 + bArr2[255 & b3]) & 255];
                this.f27977s = b4;
                bArr[i2] = bArr2[(-1) - (((-1) - (bArr2[(-1) - (((-1) - bArr2[(b4 + 255) - (255 | b4)]) | ((-1) - 255))] + 1)) | ((-1) - 255))];
                byte b5 = bArr2[(b3 + 255) - (255 | b3)];
                bArr2[(-1) - (((-1) - b3) | ((-1) - 255))] = bArr2[255 & b4];
                bArr2[(-1) - (((-1) - b4) | ((-1) - 255))] = b5;
                this.f27976n = (byte) ((-1) - (((-1) - (b3 + 1)) | ((-1) - 255)));
                i2++;
            }
        }
    }
