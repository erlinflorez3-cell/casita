...
public class IDEAEngine implements BlockCipher {
    ...
    private int bytesToWord(byte[] bArr, int i2) {
        return ((-1) - (((-1) - (bArr[i2] << 8)) | ((-1) - 65280))) + ((-1) - (((-1) - bArr[i2 + 1]) | ((-1) - 255)));
    }
    ...
    private int[] expandKey(byte[] bArr) {
        ...
        for (i2 = 8; i2 < 52; i2++) {
            ...
            if (i4 < 6) {
                int i5 = iArr[i2 - 7];
                int i6 = ((i5 + 127) - (i5 | 127)) << 9;
                int i7 = iArr[i2 - 6] >> 7;
                int i8 = (i6 + i7) - (i6 & i7);
                iArr[i2] = (i8 + 65535) - (i8 | 65535);
            } else if (i4 == 6) {
                int i9 = (-1) - (((-1) - ((iArr[i2 - 7] & 127) << 9)) & ((-1) - (iArr[i2 - 14] >> 7)));
                iArr[i2] = (i9 + 65535) - (i9 | 65535);
            } else {
                int i10 = iArr[i2 - 15];
                int i11 = ((i10 + 127) - (i10 | 127)) << 9;
                int i12 = iArr[i2 - 14] >> 7;
                int i13 = (i11 + i12) - (i11 & i12);
                iArr[i2] = (i13 + 65535) - (i13 | 65535);
            }
        }
        return iArr;
    }
    ...
    private void ideaFunc(int[] iArr, byte[] bArr, int i2, byte[] bArr2, int i3) {
        ...
        while (i4 < 8) {
            ...
            int i6 = (-1) - (((-1) - (iBytesToWord2 + iArr[i5 + 1])) | ((-1) - 65535));
            int i7 = (iBytesToWord3 + iArr[i5 + 2]) & 65535;
            int iMul2 = mul(iBytesToWord4, iArr[i5 + 3]);
            int i8 = i5 + 5;
            int iMul3 = mul(i7 ^ iMul, iArr[i5 + 4]);
            i5 += 6;
            int iMul4 = mul((-1) - (((-1) - ((i6 ^ iMul2) + iMul3)) | ((-1) - 65535)), iArr[i8]);
            int i9 = iMul3 + iMul4;
            int i10 = (65535 + i9) - (65535 | i9);
            iBytesToWord = iMul ^ iMul4;
            iBytesToWord4 = iMul2 ^ i10;
            i4++;
            iBytesToWord2 = i7 ^ iMul4;
            iBytesToWord3 = i6 ^ i10;
        }
