...
public abstract class SerpentEngineBase implements BlockCipher {
    ...
    protected final void ib1(int i2, int i3, int i4, int i5) {
        int i6 = i5 ^ i3;
        int i7 = i2 ^ ((i3 + i6) - (i3 | i6));
        int i8 = i6 ^ i7;
        int i9 = i4 ^ i8;
        this.X3 = i9;
        int i10 = i3 ^ ((i6 + i7) - (i6 | i7));
        int i11 = i7 ^ (i9 | i10);
        this.X1 = i11;
        int i12 = ~i11;
        int i13 = i10 ^ i9;
    ...
    protected final void ib2(int i2, int i3, int i4, int i5) {
        ...
        int i10 = (i3 & i9) ^ i8;
        this.X0 = i10;
        int i11 = ((-1) - (((-1) - (((-1) - (((-1) - i2) & ((-1) - i7))) ^ i5)) & ((-1) - i8))) ^ i6;
        this.X3 = i11;
        int i12 = ~i9;
        int i13 = (-1) - (((-1) - i11) & ((-1) - i10));
        this.X1 = i12 ^ i13;
    ...
    protected final void ib4(int i2, int i3, int i4, int i5) {
        int i6 = i3 ^ ((-1) - (((-1) - ((i4 + i5) - (i4 & i5))) | ((-1) - i2)));
        int i7 = i4 ^ ((i2 + i6) - (i2 | i6));
        int i8 = i5 ^ i7;
        this.X1 = i8;
        int i9 = ~i2;
        int i10 = ((-1) - (((-1) - i7) | ((-1) - i8))) ^ i6;
        this.X3 = i10;
        int i11 = i5 ^ ((-1) - (((-1) - i8) & ((-1) - i9)));
        this.X0 = i10 ^ i11;
    ...
    protected final void ib7(int i2, int i3, int i4, int i5) {
        ...
        this.X3 = i10;
        int i11 = i3 ^ i9;
        int i12 = ((-1) - (((-1) - ((~i5) ^ i10)) & ((-1) - i11))) ^ i2;
        this.X1 = i12;
        int i13 = (i11 ^ i4) ^ ((-1) - (((-1) - i5) & ((-1) - i12)));
        this.X0 = i13;
        this.X2 = ((i2 & i10) ^ i13) ^ (i7 ^ i12);
    }
    ...
    protected final void sb2(int i2, int i3, int i4, int i5) {
        ...
        int i12 = i9 ^ i11;
        this.X3 = i12;
        int i13 = i2 ^ ((i11 | i5) & ((i8 + i9) - (i8 & i9)));
        this.X2 = i13;
        this.X1 = (i13 ^ ((i5 + i6) - (i5 & i6))) ^ (i7 ^ i12);
    }
    ...
    protected final void sb3(int i2, int i3, int i4, int i5) {
        ...
        this.X2 = i11;
        int i12 = (i8 ^ i3) ^ i10;
        int i13 = i6 ^ ((-1) - (((-1) - i9) | ((-1) - i12)));
        this.X0 = i13;
        int i14 = i13 & i11;
        this.X1 = i12 ^ i14;
        this.X3 = ((-1) - (((-1) - i3) & ((-1) - i5))) ^ (i9 ^ i14);
    }
    ...
    protected final void sb5(int i2, int i3, int i4, int i5) {
        ...
        int i7 = i2 ^ i3;
        int i8 = i2 ^ i5;
        int i9 = (i4 ^ i6) ^ ((-1) - (((-1) - i7) & ((-1) - i8)));
        this.X0 = i9;
        int i10 = i5 & i9;
        int i11 = (i7 ^ i9) ^ i10;
        this.X1 = i11;
        int i12 = i8 ^ ((-1) - (((-1) - i9) & ((-1) - i6)));
        this.X2 = ((-1) - (((-1) - i7) & ((-1) - i10))) ^ i12;
        this.X3 = ((-1) - (((-1) - i12) | ((-1) - i11))) ^ (i3 ^ i10);
    }
    ...
    protected final void sb6(int i2, int i3, int i4, int i5) {
        ...
        int i10 = i3 ^ i9;
        this.X1 = i10;
        int i11 = ((i7 + i10) - (i7 & i10)) ^ i5;
        int i12 = ((i9 + i11) - (i9 | i11)) ^ i8;
        this.X2 = i12;
        int i13 = i11 ^ i9;
        this.X0 = i12 ^ i13;
        this.X3 = ((i13 + i8) - (i13 | i8)) ^ (~i9);
    }

    protected final void sb7(int i2, int i3, int i4, int i5) {
        int i6 = i3 ^ i4;
        int i7 = ((-1) - (((-1) - i4) | ((-1) - i6))) ^ i5;
        int i8 = i2 ^ i7;
        int i9 = i3 ^ ((-1) - (((-1) - (i5 | i6)) | ((-1) - i8)));
        this.X1 = i9;
        int i10 = ((i2 + i8) - (i2 | i8)) ^ i6;
        this.X3 = i10;
        int i11 = ((i9 + i7) - (i9 & i7)) ^ i8;
        int i12 = i7 ^ ((-1) - (((-1) - i10) | ((-1) - i11)));
        this.X2 = i12;
        this.X0 = ((i10 + i12) - (i10 | i12)) ^ (~i11);
    }
}
