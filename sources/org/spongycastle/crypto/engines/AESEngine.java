...
public class AESEngine implements BlockCipher {
    ...
    private static int FFmulX(int i2) {
        return ((((i2 + m1) - (i2 | m1)) >>> 7) * 27) ^ (((-1) - (((-1) - m2) | ((-1) - i2))) << 1);
    }
    ...
    private void decryptBlock(int[][] iArr) {
        ...
        while (i5 > i4) {
            int[] iArr3 = Tinv0;
            int i6 = iShift2 >> 24;
            int iShift5 = (((iArr3[(iShift + 255) - (255 | iShift)] ^ shift(iArr3[(-1) - (((-1) - (iShift4 >> 8)) | ((-1) - 255))], 24)) ^ shift(iArr3[(iShift3 >> 16) & 255], 16)) ^ shift(iArr3[(i6 + 255) - (i6 | 255)], 8)) ^ iArr[i5][c2];
            int iShift6 = (((shift(iArr3[(-1) - (((-1) - (iShift >> 8)) | ((-1) - 255))], 24) ^ iArr3[255 & iShift2]) ^ shift(iArr3[(-1) - (((-1) - (iShift4 >> 16)) | ((-1) - 255))], 16)) ^ shift(iArr3[(iShift3 >> 24) & 255], 8)) ^ iArr[i5][i4];
            int i7 = iShift2 >> 8;
            int iShift7 = (shift(iArr3[(i7 + 255) - (i7 | 255)], 24) ^ iArr3[(-1) - (((-1) - iShift3) | ((-1) - 255))]) ^ shift(iArr3[(-1) - (((-1) - (iShift >> 16)) | ((-1) - 255))], 16);
            int i8 = iShift4 >> 24;
            int iShift8 = (iShift7 ^ shift(iArr3[(i8 + 255) - (i8 | 255)], 8)) ^ iArr[i5][2];
            int i9 = iShift >> 24;
            int i10 = i5 - 1;
            int iShift9 = (shift(iArr3[(i9 + 255) - (i9 | 255)], 8) ^ ((iArr3[(-1) - (((-1) - iShift4) | ((-1) - 255))] ^ shift(iArr3[(iShift3 >> 8) & 255], 24)) ^ shift(iArr3[(iShift2 >> 16) & 255], 16))) ^ iArr[i5][c3];
            int i11 = iShift8 >> 16;
            iShift = (((iArr3[(-1) - (((-1) - iShift5) | ((-1) - 255))] ^ shift(iArr3[(-1) - (((-1) - (iShift9 >> 8)) | ((-1) - 255))], 24)) ^ shift(iArr3[(i11 + 255) - (i11 | 255)], 16)) ^ shift(iArr3[(-1) - (((-1) - (iShift6 >> 24)) | ((-1) - 255))], 8)) ^ iArr[i10][0];
            int i12 = iShift5 >> 8;
            int iShift10 = iArr3[(-1) - (((-1) - iShift6) | ((-1) - 255))] ^ shift(iArr3[(i12 + 255) - (i12 | 255)], 24);
            int i13 = iShift9 >> 16;
            iShift2 = ((iShift10 ^ shift(iArr3[(i13 + 255) - (i13 | 255)], 16)) ^ shift(iArr3[(-1) - (((-1) - (iShift8 >> 24)) | ((-1) - 255))], 8)) ^ iArr[i10][1];
            int i14 = iShift6 >> 8;
            int iShift11 = shift(iArr3[(i14 + 255) - (i14 | 255)], 24) ^ iArr3[255 & iShift8];
            int i15 = iShift5 >> 16;
            iShift3 = ((iShift11 ^ shift(iArr3[(i15 + 255) - (i15 | 255)], 16)) ^ shift(iArr3[(iShift9 >> 24) & 255], 8)) ^ iArr[i10][2];
            int i16 = iShift5 >> 24;
            i5 -= 2;
            iShift4 = iArr[i10][3] ^ (((iArr3[iShift9 & 255] ^ shift(iArr3[(-1) - (((-1) - (iShift8 >> 8)) | ((-1) - 255))], 24)) ^ shift(iArr3[(-1) - (((-1) - (iShift6 >> 16)) | ((-1) - 255))], 16)) ^ shift(iArr3[(i16 + 255) - (i16 | 255)], 8));
            c2 = 0;
            i4 = 1;
            c3 = 3;
        }
        int[] iArr4 = Tinv0;
        int iShift12 = (((iArr4[255 & iShift] ^ shift(iArr4[(iShift4 >> 8) & 255], 24)) ^ shift(iArr4[(-1) - (((-1) - (iShift3 >> 16)) | ((-1) - 255))], 16)) ^ shift(iArr4[(-1) - (((-1) - (iShift2 >> 24)) | ((-1) - 255))], 8)) ^ iArr[i5][0];
        int i17 = iShift4 >> 16;
        int iShift13 = (iArr4[(iShift2 + 255) - (255 | iShift2)] ^ shift(iArr4[(iShift >> 8) & 255], 24)) ^ shift(iArr4[(i17 + 255) - (i17 | 255)], 16);
        int i18 = iShift3 >> 24;
        int iShift14 = (iShift13 ^ shift(iArr4[(i18 + 255) - (i18 | 255)], 8)) ^ iArr[i5][1];
        int iShift15 = (((iArr4[255 & iShift3] ^ shift(iArr4[(iShift2 >> 8) & 255], 24)) ^ shift(iArr4[(-1) - (((-1) - (iShift >> 16)) | ((-1) - 255))], 16)) ^ shift(iArr4[(-1) - (((-1) - (iShift4 >> 24)) | ((-1) - 255))], 8)) ^ iArr[i5][2];
        int iShift16 = (shift(iArr4[(iShift >> 24) & 255], 8) ^ ((iArr4[(iShift4 + 255) - (iShift4 | 255)] ^ shift(iArr4[(iShift3 >> 8) & 255], 24)) ^ shift(iArr4[(-1) - (((-1) - (iShift2 >> 16)) | ((-1) - 255))], 16))) ^ iArr[i5][3];
        byte[] bArr = Si;
        int i19 = iShift15 >> 16;
        int i20 = (((bArr[255 & iShift12] & 255) ^ (((-1) - (((-1) - bArr[(iShift16 >> 8) & 255]) | ((-1) - 255))) << 8)) ^ ((bArr[(i19 + 255) - (i19 | 255)] & 255) << 16)) ^ (bArr[(-1) - (((-1) - (iShift14 >> 24)) | ((-1) - 255))] << Ascii.CAN);
        int[] iArr5 = iArr[0];
        this.C0 = i20 ^ iArr5[0];
        int i21 = iShift12 >> 8;
        int i22 = (((-1) - (((-1) - bArr[255 & iShift14]) | ((-1) - 255))) ^ ((bArr[(i21 + 255) - (i21 | 255)] & 255) << 8)) ^ ((bArr[(iShift16 >> 16) & 255] & 255) << 16);
        int i23 = iShift15 >> 24;
        this.C1 = (i22 ^ (bArr[(i23 + 255) - (i23 | 255)] << Ascii.CAN)) ^ iArr5[1];
        int i24 = iShift14 >> 8;
        int i25 = (((-1) - (((-1) - bArr[(iShift15 + 255) - (255 | iShift15)]) | ((-1) - 255))) ^ (((-1) - (((-1) - bArr[(i24 + 255) - (i24 | 255)]) | ((-1) - 255))) << 8)) ^ (((-1) - (((-1) - bArr[(iShift12 >> 16) & 255]) | ((-1) - 255))) << 16);
        int i26 = iShift16 >> 24;
        this.C2 = (i25 ^ (bArr[(i26 + 255) - (i26 | 255)] << Ascii.CAN)) ^ iArr5[2];
        int i27 = (-1) - (((-1) - bArr[iShift16 & 255]) | ((-1) - 255));
        byte b2 = bArr[(-1) - (((-1) - (iShift15 >> 8)) | ((-1) - 255))];
        int i28 = (i27 ^ (((b2 + 255) - (b2 | 255)) << 8)) ^ ((bArr[(iShift14 >> 16) & 255] & 255) << 16);
        int i29 = iShift12 >> 24;
        this.C3 = (i28 ^ (bArr[(i29 + 255) - (i29 | 255)] << Ascii.CAN)) ^ iArr5[3];
    }
    ...
    private void encryptBlock(int[][] iArr) {
        ...
        while (i4 < this.ROUNDS - i3) {
            int[] iArr3 = T0;
            int iShift5 = (((iArr3[255 & iShift] ^ shift(iArr3[(-1) - (((-1) - (iShift2 >> 8)) | ((-1) - 255))], 24)) ^ shift(iArr3[(iShift3 >> 16) & 255], 16)) ^ shift(iArr3[(iShift4 >> 24) & 255], 8)) ^ iArr[i4][c2];
            int i5 = iShift4 >> 16;
            int iShift6 = (((shift(iArr3[(iShift3 >> 8) & 255], 24) ^ iArr3[(-1) - (((-1) - iShift2) | ((-1) - 255))]) ^ shift(iArr3[(i5 + 255) - (i5 | 255)], 16)) ^ shift(iArr3[(-1) - (((-1) - (iShift >> 24)) | ((-1) - 255))], 8)) ^ iArr[i4][i3];
            int i6 = iShift2 >> 24;
            int iShift7 = (((shift(iArr3[(-1) - (((-1) - (iShift4 >> 8)) | ((-1) - 255))], 24) ^ iArr3[255 & iShift3]) ^ shift(iArr3[(iShift >> 16) & 255], 16)) ^ shift(iArr3[(i6 + 255) - (i6 | 255)], 8)) ^ iArr[i4][2];
            int iShift8 = (shift(iArr3[(-1) - (((-1) - (iShift >> 8)) | ((-1) - 255))], 24) ^ iArr3[(iShift4 + 255) - (iShift4 | 255)]) ^ shift(iArr3[(iShift2 >> 16) & 255], 16);
            int i7 = iShift3 >> 24;
            int i8 = i4 + 1;
            int iShift9 = (iShift8 ^ shift(iArr3[(i7 + 255) - (i7 | 255)], 8)) ^ iArr[i4][c3];
            int i9 = iShift6 >> 8;
            int iShift10 = iArr3[(iShift5 + 255) - (iShift5 | 255)] ^ shift(iArr3[(i9 + 255) - (i9 | 255)], 24);
            int i10 = iShift7 >> 16;
            int iShift11 = iShift10 ^ shift(iArr3[(i10 + 255) - (i10 | 255)], 16);
            int i11 = iShift9 >> 24;
            iShift = (iShift11 ^ shift(iArr3[(i11 + 255) - (i11 | 255)], 8)) ^ iArr[i8][0];
            iShift2 = (((iArr3[iShift6 & 255] ^ shift(iArr3[(iShift7 >> 8) & 255], 24)) ^ shift(iArr3[(-1) - (((-1) - (iShift9 >> 16)) | ((-1) - 255))], 16)) ^ shift(iArr3[(iShift5 >> 24) & 255], 8)) ^ iArr[i8][1];
            int i12 = iShift9 >> 8;
            iShift3 = (((shift(iArr3[(i12 + 255) - (i12 | 255)], 24) ^ iArr3[255 & iShift7]) ^ shift(iArr3[(iShift5 >> 16) & 255], 16)) ^ shift(iArr3[(iShift6 >> 24) & 255], 8)) ^ iArr[i8][2];
            int i13 = iShift6 >> 16;
            i4 += 2;
            iShift4 = (((iArr3[(-1) - (((-1) - iShift9) | ((-1) - 255))] ^ shift(iArr3[(iShift5 >> 8) & 255], 24)) ^ shift(iArr3[(i13 + 255) - (i13 | 255)], 16)) ^ shift(iArr3[(-1) - (((-1) - (iShift7 >> 24)) | ((-1) - 255))], 8)) ^ iArr[i8][3];
            c2 = 0;
            i3 = 1;
            c3 = 3;
        }
        int[] iArr4 = T0;
        int iShift12 = (((iArr4[(iShift + 255) - (255 | iShift)] ^ shift(iArr4[(-1) - (((-1) - (iShift2 >> 8)) | ((-1) - 255))], 24)) ^ shift(iArr4[(iShift3 >> 16) & 255], 16)) ^ shift(iArr4[(iShift4 >> 24) & 255], 8)) ^ iArr[i4][0];
        int iShift13 = (((iArr4[255 & iShift2] ^ shift(iArr4[(-1) - (((-1) - (iShift3 >> 8)) | ((-1) - 255))], 24)) ^ shift(iArr4[(-1) - (((-1) - (iShift4 >> 16)) | ((-1) - 255))], 16)) ^ shift(iArr4[(-1) - (((-1) - (iShift >> 24)) | ((-1) - 255))], 8)) ^ iArr[i4][1];
        int iShift14 = (((iArr4[255 & iShift3] ^ shift(iArr4[(-1) - (((-1) - (iShift4 >> 8)) | ((-1) - 255))], 24)) ^ shift(iArr4[(iShift >> 16) & 255], 16)) ^ shift(iArr4[(-1) - (((-1) - (iShift2 >> 24)) | ((-1) - 255))], 8)) ^ iArr[i4][2];
        int iShift15 = shift(iArr4[(-1) - (((-1) - (iShift >> 8)) | ((-1) - 255))], 24) ^ iArr4[(iShift4 + 255) - (iShift4 | 255)];
        int i14 = iShift2 >> 16;
        int iShift16 = (iShift15 ^ shift(iArr4[(i14 + 255) - (i14 | 255)], 16)) ^ shift(iArr4[(iShift3 >> 24) & 255], 8);
        int i15 = i4 + 1;
        int i16 = iShift16 ^ iArr[i4][3];
        byte[] bArr = S;
        int i17 = ((-1) - (((-1) - bArr[255 & iShift12]) | ((-1) - 255))) ^ (((-1) - (((-1) - bArr[(-1) - (((-1) - (iShift13 >> 8)) | ((-1) - 255))]) | ((-1) - 255))) << 8);
        byte b2 = bArr[(-1) - (((-1) - (iShift14 >> 16)) | ((-1) - 255))];
        int i18 = (i17 ^ (((b2 + 255) - (b2 | 255)) << 16)) ^ (bArr[(-1) - (((-1) - (i16 >> 24)) | ((-1) - 255))] << Ascii.CAN);
        int[] iArr5 = iArr[i15];
        this.C0 = i18 ^ iArr5[0];
        byte b3 = bArr[255 & iShift13];
        this.C1 = (((((b3 + 255) - (b3 | 255)) ^ (((-1) - (((-1) - bArr[(iShift14 >> 8) & 255]) | ((-1) - 255))) << 8)) ^ ((bArr[(i16 >> 16) & 255] & 255) << 16)) ^ (bArr[(iShift12 >> 24) & 255] << Ascii.CAN)) ^ iArr5[1];
        this.C2 = ((((bArr[255 & iShift14] & 255) ^ ((bArr[(-1) - (((-1) - (i16 >> 8)) | ((-1) - 255))] & 255) << 8)) ^ ((bArr[(iShift12 >> 16) & 255] & 255) << 16)) ^ (bArr[(iShift13 >> 24) & 255] << Ascii.CAN)) ^ iArr5[2];
        byte b4 = bArr[i16 & 255];
        int i19 = iShift12 >> 8;
        int i20 = iShift14 >> 24;
        this.C3 = (((((b4 + 255) - (b4 | 255)) ^ (((-1) - (((-1) - bArr[(i19 + 255) - (i19 | 255)]) | ((-1) - 255))) << 8)) ^ (((-1) - (((-1) - bArr[(iShift13 >> 16) & 255]) | ((-1) - 255))) << 16)) ^ (bArr[(i20 + 255) - (i20 | 255)] << Ascii.CAN)) ^ iArr5[3];
    }

    private int[][] generateWorkingKey(byte[] bArr, boolean z2) {
        int length = bArr.length;
        if (length < 16 || length > 32 || (length + 7) - (7 | length) != 0) {
    ...
    private static int subWord(int i2) {
        byte[] bArr = S;
        int i3 = (-1) - (((-1) - bArr[255 & i2]) | ((-1) - 255));
        int i4 = i2 >> 8;
        int i5 = (bArr[(i4 + 255) - (i4 | 255)] & 255) << 8;
        byte b2 = bArr[(i2 >> 16) & 255];
        int i6 = (-1) - (((-1) - ((i3 + i5) - (i3 & i5))) & ((-1) - (((b2 + 255) - (b2 | 255)) << 16)));
        int i7 = i2 >> 24;
        return (-1) - (((-1) - (bArr[(i7 + 255) - (i7 | 255)] << Ascii.CAN)) & ((-1) - i6));
    }
    ...
    private void unpackBlock(byte[] bArr, int i2) {
        ...
        this.C0 = i3;
        byte b2 = bArr[i2 + 1];
        int i4 = (-1) - (((-1) - (((b2 + 255) - (b2 | 255)) << 8)) & ((-1) - i3));
        this.C0 = i4;
        int i5 = i4 | ((bArr[i2 + 2] & 255) << 16);
        this.C0 = i5;
        this.C0 = i5 | (bArr[i2 + 3] << Ascii.CAN);
        int i6 = (-1) - (((-1) - bArr[i2 + 4]) | ((-1) - 255));
        this.C1 = i6;
        int i7 = (bArr[i2 + 5] & 255) << 8;
        int i8 = (i7 + i6) - (i7 & i6);
        this.C1 = i8;
        int i9 = i8 | (((-1) - (((-1) - bArr[i2 + 6]) | ((-1) - 255))) << 16);
        this.C1 = i9;
        int i10 = bArr[i2 + 7] << Ascii.CAN;
        this.C1 = (i9 + i10) - (i9 & i10);
        int i11 = bArr[i2 + 8] & 255;
        this.C2 = i11;
        byte b3 = bArr[i2 + 9];
        int i12 = (((b3 + 255) - (b3 | 255)) << 8) | i11;
        this.C2 = i12;
        int i13 = i12 | ((bArr[i2 + 10] & 255) << 16);
        this.C2 = i13;
        int i14 = bArr[i2 + 11] << Ascii.CAN;
        this.C2 = (i13 + i14) - (i13 & i14);
        int i15 = bArr[i2 + 12] & 255;
        this.C3 = i15;
        byte b4 = bArr[i2 + 13];
        int i16 = (((b4 + 255) - (b4 | 255)) << 8) | i15;
        this.C3 = i16;
        int i17 = (-1) - (((-1) - i16) & ((-1) - ((bArr[i2 + 14] & 255) << 16)));
        this.C3 = i17;
        int i18 = bArr[i2 + 15] << Ascii.CAN;
        this.C3 = (i18 + i17) - (i18 & i17);
    }
