...
public class SM4Engine implements BlockCipher {
    ...
    private int tau(int i2) {
        byte[] bArr = Sbox;
        int i3 = (-1) - (((-1) - bArr[(-1) - (((-1) - (i2 >> 24)) | ((-1) - 255))]) | ((-1) - 255));
        int i4 = (-1) - (((-1) - bArr[(i2 >> 16) & 255]) | ((-1) - 255));
        byte b2 = bArr[(-1) - (((-1) - (i2 >> 8)) | ((-1) - 255))];
        int i5 = (b2 + 255) - (b2 | 255);
        byte b3 = bArr[(i2 + 255) - (i2 | 255)];
        return (-1) - (((-1) - ((b3 + 255) - (b3 | 255))) & ((-1) - ((-1) - (((-1) - ((-1) - (((-1) - (i3 << 24)) & ((-1) - (i4 << 16))))) & ((-1) - (i5 << 8))))));
    }
