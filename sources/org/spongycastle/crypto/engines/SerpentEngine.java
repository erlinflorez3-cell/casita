...
public final class SerpentEngine extends SerpentEngineBase {
    ...
    protected void decryptBlock(byte[] bArr, int i2, byte[] bArr2, int i3) {
        ...
        this.X3 = Pack.littleEndianToInt(bArr, i2 + 12) ^ this.wKey[131];
    ...
    protected int[] makeWorkingKey(byte[] bArr) throws IllegalArgumentException {
        ...
        for (int i6 = 8; i6 < 16; i6++) {
            int i7 = i6 - 8;
            iArr[i6] = rotateLeft(((-1640531527) ^ (((iArr[i7] ^ iArr[i6 - 5]) ^ iArr[i6 - 3]) ^ iArr[i6 - 1])) ^ i7, 11);
        }
        System.arraycopy(iArr, 8, iArr2, 0, 8);
        for (int i8 = 8; i8 < 132; i8++) {
            iArr2[i8] = rotateLeft(((((iArr2[i8 - 8] ^ iArr2[i8 - 5]) ^ iArr2[i8 - 3]) ^ iArr2[i8 - 1]) ^ (-1640531527)) ^ i8, 11);
        }
