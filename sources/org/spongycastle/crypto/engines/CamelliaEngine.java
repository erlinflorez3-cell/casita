...
public class CamelliaEngine implements BlockCipher {
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i2) {
        ...
        int i4 = iArr3[(-1) - (((-1) - i3) | ((-1) - 255))];
        int[] iArr4 = SBOX3_3033;
        int i5 = i3 >>> 8;
        int i6 = i4 ^ iArr4[(i5 + 255) - (i5 | 255)];
        int[] iArr5 = SBOX2_0222;
        int i7 = i6 ^ iArr5[(-1) - (((-1) - (i3 >>> 16)) | ((-1) - 255))];
        int[] iArr6 = SBOX1_1110;
        int i8 = iArr6[(-1) - (((-1) - (i3 >>> 24)) | ((-1) - 255))] ^ i7;
        int i9 = iArr[1] ^ iArr2[i2 + 1];
        int i10 = i9 >>> 16;
        int i11 = (iArr6[(i9 + 255) - (255 | i9)] ^ iArr3[(-1) - (((-1) - (i9 >>> 8)) | ((-1) - 255))]) ^ iArr4[(i10 + 255) - (i10 | 255)];
        int i12 = i9 >>> 24;
        int i13 = (iArr5[(i12 + 255) - (i12 | 255)] ^ i11) ^ i8;
        iArr[2] = iArr[2] ^ i13;
        int iRightRotate = (rightRotate(i8, 8) ^ i13) ^ iArr[3];
        iArr[3] = iRightRotate;
        int i14 = iArr[2] ^ iArr2[i2 + 2];
        int i15 = i14 >>> 16;
        int i16 = iArr6[(-1) - (((-1) - (i14 >>> 24)) | ((-1) - 255))] ^ ((iArr3[255 & i14] ^ iArr4[(-1) - (((-1) - (i14 >>> 8)) | ((-1) - 255))]) ^ iArr5[(i15 + 255) - (i15 | 255)]);
        int i17 = iArr2[i2 + 3] ^ iRightRotate;
        int i18 = i17 >>> 8;
        int i19 = iArr6[255 & i17] ^ iArr3[(i18 + 255) - (i18 | 255)];
        int i20 = i17 >>> 16;
        int i21 = (iArr5[(i17 >>> 24) & 255] ^ (i19 ^ iArr4[(i20 + 255) - (i20 | 255)])) ^ i16;
        iArr[0] = iArr[0] ^ i21;
    ...
    private void camelliaFLs(int[] iArr, int[] iArr2, int i2) {
        ...
        iArr[1] = iLeftRotate;
        iArr[0] = ((-1) - (((-1) - iLeftRotate) & ((-1) - iArr2[i2 + 1]))) ^ iArr[0];
        int i6 = iArr[2];
        int i7 = iArr2[i2 + 3];
        int i8 = iArr[3];
        int i9 = i6 ^ ((-1) - (((-1) - i7) & ((-1) - i8)));
        iArr[2] = i9;
        int i10 = iArr2[i2 + 2];
        iArr[3] = leftRotate((i10 + i9) - (i10 | i9), 1) ^ i8;
    }
    ...
    private static void decroldq(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i12 = i3 + 3;
        iArr2[i4] = (-1) - (((-1) - (iArr[i10] << i2)) & ((-1) - (iArr[i12] >>> i7)));
        int i13 = i4 + 1;
        int i14 = iArr[i12] << i2;
        int i15 = iArr[i3] >>> i7;
        iArr2[i13] = (i14 + i15) - (i14 & i15);
        iArr[i3] = iArr2[i5];
        iArr[i6] = iArr2[i8];
        iArr[i10] = iArr2[i4];
        iArr[i12] = iArr2[i13];
    ...
    private static void decroldqo32(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i10 = 64 - i2;
        int i11 = iArr[i9] >>> i10;
        iArr2[i5] = (i8 + i11) - (i8 & i11);
        int i12 = i4 + 3;
        int i13 = i3 + 3;
        iArr2[i12] = (-1) - (((-1) - (iArr[i9] << i7)) & ((-1) - (iArr[i13] >>> i10)));
        iArr2[i4] = (iArr[i13] << i7) | (iArr[i3] >>> i10);
        int i14 = i4 + 1;
        int i15 = iArr[i3] << i7;
        int i16 = iArr[i6] >>> i10;
    ...
    private static void roldq(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i11 = i3 + 2;
        int i12 = iArr[i11] >>> i7;
        iArr2[i9] = (i10 + i12) - (i10 & i12);
        int i13 = i4 + 2;
        int i14 = iArr[i11] << i2;
        int i15 = i3 + 3;
        int i16 = iArr[i15] >>> i7;
        iArr2[i13] = (i14 + i16) - (i14 & i16);
        int i17 = i4 + 3;
        iArr2[i17] = (-1) - (((-1) - (iArr[i15] << i2)) & ((-1) - (iArr[i3] >>> i7)));
        iArr[i3] = iArr2[i4];
        iArr[i6] = iArr2[i9];
        iArr[i11] = iArr2[i13];
        iArr[i15] = iArr2[i17];
    ...
    private static void roldqo32(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        iArr2[i13] = (i14 + i15) - (i14 & i15);
        int i16 = i4 + 3;
        iArr2[i16] = (-1) - (((-1) - (iArr[i5] >>> i8)) & ((-1) - (iArr[i3] << i6)));
        iArr[i3] = iArr2[i4];
        iArr[i5] = iArr2[i9];
        iArr[i7] = iArr2[i13];
        iArr[i11] = iArr2[i16];
