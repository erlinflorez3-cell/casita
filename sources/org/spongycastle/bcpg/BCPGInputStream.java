...
public class BCPGInputStream extends InputStream implements PacketTags {
    ...
    private static class PartialInputStream extends InputStream {
        ...
        PartialInputStream(BCPGInputStream bCPGInputStream, boolean z2, int i2) {
    ...
    public Packet readPacket() throws IOException {
        ...
        if ((i6 + 64) - (64 | i6) != 0) {
            ...
            if (i3 < 192) {
                ...
                i4 = ((-1) - (((-1) - (this.in.read() << 24)) & ((-1) - (this.in.read() << 16)))) | (this.in.read() << 8);
                i5 = this.in.read();
                i3 = (-1) - (((-1) - i4) & ((-1) - i5));
                z2 = false;
                i7 = i3;
            ...
            if (i8 != 0) {
                if (i8 == 1) {
                    ...
                    i4 = (-1) - (((-1) - ((-1) - (((-1) - (read() << 24)) & ((-1) - (read() << 16))))) & ((-1) - (read() << 8)));
                    i5 = read();
                } else if (i8 != 3) {
