...
public class SignaturePacket extends ContainedPacket implements PublicKeyAlgorithmTags {
    ...
    SignaturePacket(BCPGInputStream bCPGInputStream) throws IOException {
        ...
        if (i2 == 3 || i2 == 2) {
            ...
            this.creationTime = (((-1) - (((-1) - ((((long) bCPGInputStream.read()) << 24) | ((long) (bCPGInputStream.read() << 16)))) & ((-1) - ((long) (bCPGInputStream.read() << 8))))) | ((long) bCPGInputStream.read())) * 1000;
            long j2 = this.keyID | (((long) bCPGInputStream.read()) << 56);
            this.keyID = j2;
            long j3 = ((long) bCPGInputStream.read()) << 48;
            long j4 = (j2 + j3) - (j2 & j3);
            this.keyID = j4;
            long j5 = ((long) bCPGInputStream.read()) << 40;
            long j6 = (j4 + j5) - (j4 & j5);
            this.keyID = j6;
            long j7 = j6 | (((long) bCPGInputStream.read()) << 32);
            this.keyID = j7;
            long j8 = j7 | (((long) bCPGInputStream.read()) << 24);
            this.keyID = j8;
            long j9 = ((long) bCPGInputStream.read()) << 16;
            long j10 = (j8 + j9) - (j8 & j9);
            this.keyID = j10;
            long j11 = j10 | (((long) bCPGInputStream.read()) << 8);
            this.keyID = j11;
            this.keyID = j11 | ((long) bCPGInputStream.read());
            ...
            this.keyAlgorithm = bCPGInputStream.read();
            this.hashAlgorithm = bCPGInputStream.read();
            int i3 = bCPGInputStream.read() << 8;
            int i4 = bCPGInputStream.read();
            byte[] bArr = new byte[(i3 + i4) - (i3 & i4)];
            ...
            for (int i5 = 0; i5 != this.hashedData.length; i5++) {
                SignatureSubpacket signatureSubpacket = (SignatureSubpacket) vector.elementAt(i5);
                ...
                this.hashedData[i5] = signatureSubpacket;
            }
            ...
            for (int i6 = 0; i6 != this.unhashedData.length; i6++) {
                SignatureSubpacket signatureSubpacket2 = (SignatureSubpacket) vector.elementAt(i6);
                if (signatureSubpacket2 instanceof IssuerKeyID) {
                    this.keyID = ((IssuerKeyID) signatureSubpacket2).getKeyID();
                }
                this.unhashedData[i6] = signatureSubpacket2;
            }
        }
        byte[] bArr3 = new byte[2];
        this.fingerPrint = bArr3;
        bCPGInputStream.readFully(bArr3);
        int i7 = this.keyAlgorithm;
        if (i7 == 1 || i7 == 3) {
    ...
    public byte[] getSignatureTrailer() {
        int i2 = this.version;
        if (i2 == 3 || i2 == 2) {
            return new byte[]{(byte) this.signatureType, (byte) (r3 >> 24), (byte) (r3 >> 16), (byte) (r3 >> 8), (byte) (this.creationTime / 1000)};
        }
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        try {
