...
public class DefaultCMSSignatureAlgorithmNameGenerator implements CMSSignatureAlgorithmNameGenerator {
    ...
    public DefaultCMSSignatureAlgorithmNameGenerator() {
        ...
        map2.put(PKCSObjectIdentifiers.md2, MessageDigestAlgorithms.MD2);
        map2.put(PKCSObjectIdentifiers.md4, "MD4");
        map2.put(PKCSObjectIdentifiers.md5, MessageDigestAlgorithms.MD5);
        map2.put(OIWObjectIdentifiers.idSHA1, "SHA1");
        map2.put(NISTObjectIdentifiers.id_sha224, "SHA224");
        map2.put(NISTObjectIdentifiers.id_sha256, McElieceCCA2ParameterSpec.DEFAULT_MD);
    ...
    public String getSignatureName(AlgorithmIdentifier algorithmIdentifier, AlgorithmIdentifier algorithmIdentifier2) {
        ...
        return !digestAlgName.equals(algorithmIdentifier2.getAlgorithm().getId()) ? digestAlgName + "with" + getEncryptionAlgName(algorithmIdentifier2.getAlgorithm()) : getDigestAlgName(algorithmIdentifier.getAlgorithm()) + "with" + getEncryptionAlgName(algorithmIdentifier2.getAlgorithm());
    }
