...
public class JceKTSKeyTransRecipientInfoGenerator extends KeyTransRecipientInfoGenerator {
    ...
    private static byte[] getEncodedRecipID(IssuerAndSerialNumber issuerAndSerialNumber) throws CertificateEncodingException {
        try {
            ...
            throw new CertificateEncodingException("Cannot process extracted IssuerAndSerialNumber: " + e2.getMessage()) { // from class: org.spongycastle.cms.jcajce.JceKTSKeyTransRecipientInfoGenerator.1
    ...
    private static byte[] getEncodedSubKeyId(byte[] bArr) {
        try {
            ...
            throw new IllegalArgumentException("Cannot process subject key identifier: " + e2.getMessage()) { // from class: org.spongycastle.cms.jcajce.JceKTSKeyTransRecipientInfoGenerator.2
                @Override // java.lang.Throwable
                public Throwable getCause() {
                    return e2;
                }
