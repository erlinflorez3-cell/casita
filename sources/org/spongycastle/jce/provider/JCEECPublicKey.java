...
public class JCEECPublicKey implements ECPublicKey, org.spongycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public JCEECPublicKey(String str, ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.ecSpec = params;
        this.f28009q = EC5Util.convertPoint(params, eCPublicKeySpec.getW(), false);
    }

    public JCEECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters) {
        this.algorithm = str;
        this.f28009q = eCPublicKeyParameters.getQ();
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(String str, JCEECPublicKey jCEECPublicKey) {
        this.algorithm = str;
        this.f28009q = jCEECPublicKey.f28009q;
    ...
    public JCEECPublicKey(String str, org.spongycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        this.algorithm = str;
        this.f28009q = eCPublicKeySpec.getQ();
        ...
        if (this.f28009q.getCurve() == null) {
            this.f28009q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f28009q.getAffineXCoord().toBigInteger(), this.f28009q.getAffineYCoord().toBigInteger(), false);
        }
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f28009q = EC5Util.convertPoint(params, eCPublicKey.getW(), false);
    }
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (subjectPublicKeyInfo.getAlgorithmId().getAlgorithm().equals(CryptoProObjectIdentifiers.gostR3410_2001)) {
            ...
            try {
                ...
                this.f28009q = curve2.createPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2), false);
        ...
        this.f28009q = new X9ECPoint(curve, dEROctetString).getPoint();
    }
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            BigInteger bigInteger = this.f28009q.getAffineXCoord().toBigInteger();
            BigInteger bigInteger2 = this.f28009q.getAffineYCoord().toBigInteger();
    ...
    public ECPoint getQ() {
        return this.ecSpec == null ? this.f28009q.getDetachedPoint() : this.f28009q;
    }

    @Override // java.security.interfaces.ECPublicKey
    public java.security.spec.ECPoint getW() {
        return new java.security.spec.ECPoint(this.f28009q.getAffineXCoord().toBigInteger(), this.f28009q.getAffineYCoord().toBigInteger());
    }
    ...
    public String toString() {
        ...
        stringBuffer.append("            X: ").append(this.f28009q.getAffineXCoord().toBigInteger().toString(16)).append(strLineSeparator);
        stringBuffer.append("            Y: ").append(this.f28009q.getAffineYCoord().toBigInteger().toString(16)).append(strLineSeparator);
