...
public class PKIXNameConstraintValidator {
    ...
    private boolean isIPConstrained(byte[] bArr, byte[] bArr2) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            byte b2 = bArr2[i2];
            byte b3 = bArr3[i2];
            bArr4[i2] = (byte) ((b2 + b3) - (b2 | b3));
            byte b4 = bArr[i2];
            byte b5 = bArr3[i2];
            bArr5[i2] = (byte) ((b4 + b5) - (b4 | b5));
        }
    ...
    private static byte[] max(byte[] bArr, byte[] bArr2) {
        for (int i2 = 0; i2 < bArr.length; i2++) {
            if ((-1) - (((-1) - bArr[i2]) | ((-1) - 65535)) > (-1) - (((-1) - 65535) | ((-1) - bArr2[i2]))) {
                return bArr;
            }
        }
        return bArr2;
    ...
    private byte[][] minMaxIPs(byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            byte b2 = bArr[i2];
            byte b3 = bArr2[i2];
            bArr5[i2] = (byte) ((b2 + b3) - (b2 | b3));
            byte b4 = bArr[i2];
            byte b5 = bArr2[i2];
            bArr6[i2] = (byte) ((-1) - (((-1) - ((-1) - (((-1) - b4) | ((-1) - b5)))) & ((-1) - (~b5))));
            bArr7[i2] = (byte) (bArr3[i2] & bArr4[i2]);
            byte b6 = bArr3[i2];
            byte b7 = bArr4[i2];
            bArr8[i2] = (byte) (((-1) - (((-1) - b6) | ((-1) - b7))) | (~b7));
        }
    ...
    private static byte[] or(byte[] bArr, byte[] bArr2) {
        ...
        for (int i2 = 0; i2 < bArr.length; i2++) {
            bArr3[i2] = (byte) ((-1) - (((-1) - bArr[i2]) & ((-1) - bArr2[i2])));
        }
        return bArr3;
    }
    ...
    private String stringifyIP(byte[] bArr) {
        ...
        for (int i2 = 0; i2 < bArr.length / 2; i2++) {
            str = str + Integer.toString((-1) - (((-1) - bArr[i2]) | ((-1) - 255))) + ".";
        }
