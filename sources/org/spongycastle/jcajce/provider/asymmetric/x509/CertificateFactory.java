...
public class CertificateFactory extends CertificateFactorySpi {
    ...
    private Certificate readPEMCertificate(InputStream inputStream) throws CertificateParsingException, IOException {
        ...
        if (pEMObject != null) {
            return new X509CertificateObject(this.bcHelper, org.spongycastle.asn1.x509.Certificate.getInstance(pEMObject));
        }
        return null;
    }
    ...
    public CRL engineGenerateCRL(InputStream inputStream) throws CRLException {
        ...
        try {
            ...
            return i2 != 48 ? readPEMCRL(pushbackInputStream) : readDERCRL(new ASN1InputStream((InputStream) pushbackInputStream, true));
    ...
    public CertPath engineGenerateCertPath(List list) throws Throwable {
        for (Object obj : list) {
            if (obj != null && !(obj instanceof X509Certificate)) {
                Object[] objArr = {C1561oA.ud("fbkk\u0016XcafRY]a\rZZX\t@\u001c\u0016\u001e'HTUIEG@=O?xG9@:7GqH88:2k.<.);/3+b\u0005&23\u000e\u001e0#C", (short) (OY.Xd() ^ 1411)) + obj.toString()};
                Constructor<?> constructor = Class.forName(C1561oA.yd("d\\nZ$jYXgeYeg\u001dOR|\u007f6LkyxnhlcbrdAu}\u0001\t\u000e\u007f\u0007\u0003", (short) (C1580rY.Xd() ^ (-24849)))).getConstructor(Class.forName(C1561oA.Yd("\u0007~\u0015\u0001N\u000e\u0004\u0012\fSy\u001c\u001b\u0013\u0019\u0013", (short) (C1580rY.Xd() ^ (-27763)))));
                try {
    ...
    public Certificate engineGenerateCertificate(InputStream inputStream) throws CertificateException {
        ...
        try {
            ...
            pushbackInputStream.unread(i2);
            return i2 != 48 ? readPEMCertificate(pushbackInputStream) : readDERCertificate(new ASN1InputStream(pushbackInputStream));
        } catch (Exception e2) {
