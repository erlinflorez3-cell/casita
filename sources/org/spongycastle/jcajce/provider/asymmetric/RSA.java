...
public class RSA {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            addPSSSignature(configurableProvider, McElieceCCA2ParameterSpec.DEFAULT_MD, "org.spongycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA256withRSA");
            ...
            if (configurableProvider.hasAlgorithm("MessageDigest", MessageDigestAlgorithms.MD2)) {
                addDigestSignature(configurableProvider, MessageDigestAlgorithms.MD2, "org.spongycastle.jcajce.provider.asymmetric.rsa.DigestSignatureSpi$MD2", PKCSObjectIdentifiers.md2WithRSAEncryption);
            }
            ...
            if (configurableProvider.hasAlgorithm("MessageDigest", MessageDigestAlgorithms.MD5)) {
                addDigestSignature(configurableProvider, MessageDigestAlgorithms.MD5, "org.spongycastle.jcajce.provider.asymmetric.rsa.DigestSignatureSpi$MD5", PKCSObjectIdentifiers.md5WithRSAEncryption);
                addISO9796Signature(configurableProvider, MessageDigestAlgorithms.MD5, "org.spongycastle.jcajce.provider.asymmetric.rsa.ISOSignatureSpi$MD5WithRSAEncryption");
            }
            ...
            addDigestSignature(configurableProvider, McElieceCCA2ParameterSpec.DEFAULT_MD, "org.spongycastle.jcajce.provider.asymmetric.rsa.DigestSignatureSpi$SHA256", PKCSObjectIdentifiers.sha256WithRSAEncryption);
            ...
            addDigestSignature(configurableProvider, "SHA512(224)", "org.spongycastle.jcajce.provider.asymmetric.rsa.DigestSignatureSpi$SHA512_224", null);
            addDigestSignature(configurableProvider, "SHA512(256)", "org.spongycastle.jcajce.provider.asymmetric.rsa.DigestSignatureSpi$SHA512_256", null);
            ...
            addISO9796Signature(configurableProvider, McElieceCCA2ParameterSpec.DEFAULT_MD, "org.spongycastle.jcajce.provider.asymmetric.rsa.ISOSignatureSpi$SHA256WithRSAEncryption");
            ...
            addX931Signature(configurableProvider, McElieceCCA2ParameterSpec.DEFAULT_MD, "org.spongycastle.jcajce.provider.asymmetric.rsa.X931SignatureSpi$SHA256WithRSAEncryption");
