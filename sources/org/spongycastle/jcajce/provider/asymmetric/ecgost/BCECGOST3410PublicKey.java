...
public class BCECGOST3410PublicKey implements ECPublicKey, org.spongycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public BCECGOST3410PublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f27997q = EC5Util.convertPoint(params, eCPublicKey.getW(), false);
    }
    ...
    public BCECGOST3410PublicKey(ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.ecSpec = params;
        this.f27997q = EC5Util.convertPoint(params, eCPublicKeySpec.getW(), false);
    }
    ...
    public BCECGOST3410PublicKey(BCECGOST3410PublicKey bCECGOST3410PublicKey) {
        this.algorithm = "ECGOST3410";
        this.f27997q = bCECGOST3410PublicKey.f27997q;
    ...
    public BCECGOST3410PublicKey(org.spongycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        this.algorithm = "ECGOST3410";
        this.f27997q = eCPublicKeySpec.getQ();
        ...
        if (this.f27997q.getCurve() == null) {
            this.f27997q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f27997q.getAffineXCoord().toBigInteger(), this.f27997q.getAffineYCoord().toBigInteger());
        }
        this.ecSpec = null;
    }
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            this.f27997q = curve.createPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
    ...
    public byte[] getEncoded() {
        ...
        BigInteger bigInteger = this.f27997q.getAffineXCoord().toBigInteger();
        BigInteger bigInteger2 = this.f27997q.getAffineYCoord().toBigInteger();
    ...
    public ECPoint getQ() {
        return this.ecSpec == null ? this.f27997q.getDetachedPoint() : this.f27997q;
    }

    @Override // java.security.interfaces.ECPublicKey
    public java.security.spec.ECPoint getW() {
        return new java.security.spec.ECPoint(this.f27997q.getAffineXCoord().toBigInteger(), this.f27997q.getAffineYCoord().toBigInteger());
    }
    ...
    public String toString() {
        ...
        stringBuffer.append("            X: ").append(this.f27997q.getAffineXCoord().toBigInteger().toString(16)).append(strLineSeparator);
        stringBuffer.append("            Y: ").append(this.f27997q.getAffineYCoord().toBigInteger().toString(16)).append(strLineSeparator);
