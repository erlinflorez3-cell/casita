    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        protected AlgorithmParameters engineGenerateParameters() throws Throwable {
            ...
            if (this.random == null) {
                ...
                Constructor<?> constructor = Class.forName(C1561oA.ud("qg{e1ufctpfpt(L]ZkgYES_T^[", (short) (C1499aX.Xd() ^ (-28278)))).getConstructor(new Class[0]);
                try {
            ...
            Object[] objArr2 = {bArr};
            Method method = Class.forName(C1561oA.yd("rh|f2vgduqgqu)M^[lhZFT`U_\\", (short) (C1607wl.Xd() ^ 16389))).getMethod(C1561oA.Yd("ldxuD|xjy", (short) (OY.Xd() ^ 6013)), byte[].class);
            try {
                method.setAccessible(true);
                method.invoke(secureRandom, objArr2);
                try {
                    AlgorithmParameters algorithmParametersCreateParametersInstance = createParametersInstance(Xg.qd("\u001d&+-\f\u0013\r\u0011\u0015", (short) (C1607wl.Xd() ^ 12812), (short) (C1607wl.Xd() ^ 21018)));
