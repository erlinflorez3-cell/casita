    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        protected AlgorithmParameters engineGenerateParameters() throws Throwable {
            ...
            if (this.random == null) {
                ...
                Constructor<?> constructor = Class.forName(Jg.Wd("\u001fid!k\u0015\\\u001d\r[Z7\u001aP\f\u0002=aD\u000b6'\n\u0002l<", (short) (ZN.Xd() ^ 12645), (short) (ZN.Xd() ^ 31253))).getConstructor(new Class[0]);
                try {
            ...
            Object[] objArr2 = {bArr};
            Method method = Class.forName(ZO.xd("DIfz#zW,.(XI`e?[S_W*EG\u000e5?\u0012", (short) (Od.Xd() ^ (-22007)), (short) (Od.Xd() ^ (-6128)))).getMethod(C1626yg.Ud("a>v:\u001a\u0006\u0016c\u0018", (short) (C1607wl.Xd() ^ 20709), (short) (C1607wl.Xd() ^ 25775)), byte[].class);
            try {
                method.setAccessible(true);
                method.invoke(secureRandom, objArr2);
                try {
                    AlgorithmParameters algorithmParametersCreateParametersInstance = createParametersInstance(Ig.wd("#oL\"", (short) (C1499aX.Xd() ^ (-21118))));
