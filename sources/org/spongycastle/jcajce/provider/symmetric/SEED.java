    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        protected AlgorithmParameters engineGenerateParameters() throws Throwable {
            ...
            if (this.random == null) {
                ...
                Constructor<?> constructor = Class.forName(C1626yg.Ud("\rkM8{x?\u000295tRs\fD~\u0002\u0017(f\fyHQbW", (short) (Od.Xd() ^ (-2307)), (short) (Od.Xd() ^ (-7728)))).getConstructor(new Class[0]);
                try {
            ...
            Object[] objArr2 = {bArr};
            Method method = Class.forName(Ig.wd("LtwJ\u0007(.C\u001f{lEz;J|1[~8]'PD\f\u0004", (short) (OY.Xd() ^ 15645))).getMethod(EO.Od("|D)\u0005qV]\u001ew", (short) (ZN.Xd() ^ 11069)), byte[].class);
            try {
                method.setAccessible(true);
                method.invoke(secureRandom, objArr2);
                try {
                    AlgorithmParameters algorithmParametersCreateParametersInstance = createParametersInstance(C1561oA.Qd("\u0013\u0004\u0003\u0001", (short) (C1633zX.Xd() ^ (-681))));
