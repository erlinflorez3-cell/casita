...
public final class RC2 {
    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        protected AlgorithmParameters engineGenerateParameters() throws Throwable {
            ...
            String strKd = C1561oA.Kd("XJ:", (short) (C1607wl.Xd() ^ 27466));
            if (rC2ParameterSpec != null) {
                try {
                    AlgorithmParameters algorithmParametersCreateParametersInstance = createParametersInstance(strKd);
            ...
            if (this.random == null) {
                ...
                Constructor<?> constructor = Class.forName(Wg.Zd("M\u0001i\u0001))`\u0017x@nREU-\u000bU!h\u0013P\u0017zZ1\f", (short) (OY.Xd() ^ 23453), (short) (OY.Xd() ^ 31105))).getConstructor(new Class[0]);
                try {
            ...
            Object[] objArr2 = {bArr};
            Method method = Class.forName(C1561oA.Xd("\u0004{\u0012}K\u0012\u0005\u0004\u0017\u0015\r\u0019\u001fTz\u000e\r \u001e\u0012\u007f\u0010\u001e\u0015! ", (short) (Od.Xd() ^ (-17428)))).getMethod(Wg.vd("meyvE}ykj", (short) (Od.Xd() ^ (-24382))), byte[].class);
            try {
                method.setAccessible(true);
                method.invoke(secureRandom, objArr2);
                try {
                    AlgorithmParameters algorithmParametersCreateParametersInstance2 = createParametersInstance(strKd);
