...
public final class AES {
    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        protected AlgorithmParameters engineGenerateParameters() throws Throwable {
            ...
            if (this.random == null) {
                ...
                Constructor<?> constructor = Class.forName(Wg.vd("xn\u0003l8|mj{wmw{/Sdarn`LZf[eb", (short) (C1633zX.Xd() ^ (-27861)))).getConstructor(new Class[0]);
                try {
            ...
            Object[] objArr2 = {bArr};
            Method method = Class.forName(Qg.kd("ZPdN\u001a^OL]YOY]\u00115FCTPB.<H=GD", (short) (OY.Xd() ^ 17112), (short) (OY.Xd() ^ 16173))).getMethod(hg.Vd("`Vhc0f`P]", (short) (Od.Xd() ^ (-11255)), (short) (Od.Xd() ^ (-14754))), byte[].class);
            try {
                method.setAccessible(true);
                method.invoke(secureRandom, objArr2);
                try {
                    AlgorithmParameters algorithmParametersCreateParametersInstance = createParametersInstance(C1561oA.ud("gjw", (short) (Od.Xd() ^ (-3362))));
    ...
    public static class AlgParamGenCCM extends BaseAlgorithmParameterGenerator {
        ...
        protected AlgorithmParameters engineGenerateParameters() throws Throwable {
            ...
            if (this.random == null) {
                short sXd = (short) (C1607wl.Xd() ^ 13025);
                int[] iArr = new int["h^r\\0tebkg]gs'K\\Qb^PDR^SUR".length()];
                QB qb = new QB("h^r\\0tebkg]gs'K\\Qb^PDR^SUR");
                int i2 = 0;
                while (qb.YK()) {
                    int iKK = qb.KK();
                    Xu xuXd = Xu.Xd(iKK);
            ...
            SecureRandom secureRandom = this.random;
            Object[] objArr2 = {bArr};
            Method method = Class.forName(C1561oA.Yd("&\u001e4 m4'&97/;Av\u001d0/B@4\"2@7CB", (short) (C1499aX.Xd() ^ (-28930)))).getMethod(Xg.qd("\u001e\u0016*'u.*\u001c+", (short) (C1499aX.Xd() ^ (-24862)), (short) (C1499aX.Xd() ^ (-8394))), byte[].class);
            try {
                method.setAccessible(true);
                method.invoke(secureRandom, objArr2);
                try {
                    AlgorithmParameters algorithmParametersCreateParametersInstance = createParametersInstance(Jg.Wd("\u001a-G", (short) (C1607wl.Xd() ^ 4036), (short) (C1607wl.Xd() ^ 18195)));
    ...
    public static class AlgParamGenGCM extends BaseAlgorithmParameterGenerator {
        ...
        protected AlgorithmParameters engineGenerateParameters() throws Throwable {
            ...
            if (this.random == null) {
                Object[] objArr = new Object[0];
                Constructor<?> constructor = Class.forName(ZO.xd("\u0010']q!mgp\u0010|i[A\u001f\u0011KP\u0011\nv\u001f\"}mug", (short) (C1580rY.Xd() ^ (-13435)), (short) (C1580rY.Xd() ^ (-25409)))).getConstructor(new Class[0]);
                try {
                    constructor.setAccessible(true);
                    this.random = (SecureRandom) constructor.newInstance(objArr);
                } catch (InvocationTargetException e2) {
            ...
            SecureRandom secureRandom = this.random;
            short sXd = (short) (C1633zX.Xd() ^ (-14691));
            short sXd2 = (short) (C1633zX.Xd() ^ (-838));
            int[] iArr = new int["FSn\u0001\r`\u000bzue]\u007fp\rdpI\u000fP\u001f\u001d\u000e\u000fa%\u0013".length()];
            QB qb = new QB("FSn\u0001\r`\u000bzue]\u007fp\rdpI\u000fP\u001f\u001d\u000e\u000fa%\u0013");
            int i2 = 0;
            while (qb.YK()) {
                int iKK = qb.KK();
                Xu xuXd = Xu.Xd(iKK);
            ...
            Object[] objArr2 = {bArr};
            Method method = Class.forName(new String(iArr, 0, i2)).getMethod(Ig.wd("E\u000e-O,\u0016jB!", (short) (Od.Xd() ^ (-3492))), byte[].class);
            try {
                method.setAccessible(true);
                method.invoke(secureRandom, objArr2);
                short sXd3 = (short) (C1580rY.Xd() ^ (-5575));
                ...
                try {
                    ...
                    algorithmParametersCreateParametersInstance.init(new GCMParameters(bArr, 12).getEncoded());
                    return algorithmParametersCreateParametersInstance;
                } catch (Exception e3) {
                    throw new RuntimeException(e3.getMessage());
                }
