...
class PGPExampleUtil {
    ...
    static byte[] compressFile(String str, int i2) throws IOException {
    ...
    static PGPPrivateKey findSecretKey(PGPSecretKeyRingCollection pGPSecretKeyRingCollection, long j2, char[] cArr) throws PGPException, NoSuchProviderException {
