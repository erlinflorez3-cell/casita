...
public class BCMcEliecePrivateKey implements CipherParameters, PrivateKey {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f28175n == bCMcEliecePrivateKey.f28175n && this.f28174k == bCMcEliecePrivateKey.f28174k && this.field.equals(bCMcEliecePrivateKey.field) && this.goppaPoly.equals(bCMcEliecePrivateKey.goppaPoly) && this.sInv.equals(bCMcEliecePrivateKey.sInv) && this.p1.equals(bCMcEliecePrivateKey.p1) && this.p2.equals(bCMcEliecePrivateKey.p2) && this.f28173h.equals(bCMcEliecePrivateKey.f28173h);
    }
    ...
    public byte[] getEncoded() {
        try {
            try {
                return new PrivateKeyInfo(new AlgorithmIdentifier(getOID(), DERNull.INSTANCE), new McEliecePrivateKey(new ASN1ObjectIdentifier(this.oid), this.f28175n, this.f28174k, this.field, this.goppaPoly, this.sInv, this.p1, this.p2, this.f28173h, this.qInv)).getEncoded();
    ...
    public int hashCode() {
        return this.f28174k + this.f28175n + this.field.hashCode() + this.goppaPoly.hashCode() + this.sInv.hashCode() + this.p1.hashCode() + this.p2.hashCode() + this.f28173h.hashCode();
    }

    public String toString() {
        return (((((" length of the code          : " + this.f28175n + "\n") + " dimension of the code       : " + this.f28174k + "\n") + " irreducible Goppa polynomial: " + this.goppaPoly + "\n") + " (k x k)-matrix S^-1         : " + this.sInv + "\n") + " permutation P1              : " + this.p1 + "\n") + " permutation P2              : " + this.p2;
    }
}
