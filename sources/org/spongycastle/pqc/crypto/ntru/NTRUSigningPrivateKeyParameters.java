...
public class NTRUSigningPrivateKeyParameters extends AsymmetricKeyParameter {
    ...
    public static class Basis {
        ...
        public Polynomial f28159f;
        public Polynomial fPrime;

        /* JADX INFO: renamed from: h, reason: collision with root package name */
        public IntegerPolynomial f28160h;
        NTRUSigningKeyGenerationParameters params;

        Basis(InputStream inputStream, NTRUSigningKeyGenerationParameters nTRUSigningKeyGenerationParameters, boolean z2) throws IOException {
            int i2 = nTRUSigningKeyGenerationParameters.N;
            int i3 = nTRUSigningKeyGenerationParameters.f28155q;
            int i4 = nTRUSigningKeyGenerationParameters.f28154d1;
            ...
            if (nTRUSigningKeyGenerationParameters.polyType == 1) {
                this.f28159f = ProductFormPolynomial.fromBinary(inputStream, i2, i4, i5, i6 + 1, i6);
            } else {
                IntegerPolynomial integerPolynomialFromBinary3Tight = IntegerPolynomial.fromBinary3Tight(inputStream, i2);
                this.f28159f = z3 ? new SparseTernaryPolynomial(integerPolynomialFromBinary3Tight) : new DenseTernaryPolynomial(integerPolynomialFromBinary3Tight);
            }
            if (nTRUSigningKeyGenerationParameters.basisType == 0) {
                ...
                for (int i7 = 0; i7 < integerPolynomialFromBinary.coeffs.length; i7++) {
            ...
            if (z2) {
                this.f28160h = IntegerPolynomial.fromBinary(inputStream, i2, i3);
            }
        }
        ...
        protected Basis(Polynomial polynomial, Polynomial polynomial2, IntegerPolynomial integerPolynomial, NTRUSigningKeyGenerationParameters nTRUSigningKeyGenerationParameters) {
            this.f28159f = polynomial;
            this.fPrime = polynomial2;
            this.f28160h = integerPolynomial;
            this.params = nTRUSigningKeyGenerationParameters;
        }
        ...
        void encode(OutputStream outputStream, boolean z2) throws IOException {
            int i2 = this.params.f28155q;
            outputStream.write(getEncoded(this.f28159f));
            if (this.params.basisType == 0) {
                IntegerPolynomial integerPolynomial = this.fPrime.toIntegerPolynomial();
                for (int i3 = 0; i3 < integerPolynomial.coeffs.length; i3++) {
            ...
            if (z2) {
                outputStream.write(this.f28160h.toBinary(i2));
            }
        }
        ...
        public boolean equals(Object obj) {
            ...
            Polynomial polynomial = this.f28159f;
            if (polynomial == null) {
                if (basis.f28159f != null) {
                    return false;
                }
            } else if (!polynomial.equals(basis.f28159f)) {
                return false;
            }
            ...
            IntegerPolynomial integerPolynomial = this.f28160h;
            if (integerPolynomial == null) {
                if (basis.f28160h != null) {
                    return false;
                }
            } else if (!integerPolynomial.equals(basis.f28160h)) {
                return false;
            }
    ...
    public boolean equals(Object obj) {
        ...
        for (int i2 = 0; i2 < this.bases.size(); i2++) {
            ...
            if (!basis.f28159f.equals(basis2.f28159f) || !basis.fPrime.equals(basis2.fPrime)) {
                return false;
            }
            if ((i2 != 0 && !basis.f28160h.equals(basis2.f28160h)) || !basis.params.equals(basis2.params)) {
                return false;
            }
        }
        return true;
