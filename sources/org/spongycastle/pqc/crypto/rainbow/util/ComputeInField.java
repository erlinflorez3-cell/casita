    ...
    */
    private void computeZerosUnder(boolean r11) throws java.lang.RuntimeException {
        ...
        L12:
            ...
            r0 = r1[r7]
            short r0 = r0[r7]
            short r4 = org.spongycastle.pqc.crypto.rainbow.util.GF2Field.invElem(r0)
            if (r4 == 0) goto L50
            r3 = r7
        L26:
            if (r3 >= r8) goto L45
            ...
            r0 = r0[r7]
            short r0 = r0[r3]
            short r0 = org.spongycastle.pqc.crypto.rainbow.util.GF2Field.multElem(r0, r4)
            short r2 = org.spongycastle.pqc.crypto.rainbow.util.GF2Field.multElem(r5, r0)
            short[][] r0 = r10.A
            r1 = r0[r6]
            short r0 = r1[r3]
            short r0 = org.spongycastle.pqc.crypto.rainbow.util.GF2Field.addElem(r0, r2)
            r1[r3] = r0
            int r3 = r3 + 1
            goto L26
        L45:
    ...
    private void substitute() throws RuntimeException {
        ...
        for (int length = this.A.length - 2; length >= 0; length--) {
            ...
            for (int length2 = sArr3.length - 1; length2 > length; length2--) {
                sAddElem = GF2Field.addElem(sAddElem, GF2Field.multElem(this.A[length][length2], this.f28165x[length2]));
            }
            short sInvElem2 = GF2Field.invElem(this.A[length][length]);
            if (sInvElem2 == 0) {
                throw new RuntimeException("Not solvable equation system");
            }
            this.f28165x[length] = GF2Field.multElem(sAddElem, sInvElem2);
        }
    }
    ...
    public short[] solveEquation(short[][] sArr, short[] sArr2) {
        try {
            ...
            this.f28165x = new short[sArr.length];
            for (int i2 = 0; i2 < sArr.length; i2++) {
                for (int i3 = 0; i3 < sArr[0].length; i3++) {
