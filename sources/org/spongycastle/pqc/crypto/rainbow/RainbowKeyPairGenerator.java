...
public class RainbowKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private void computePublicKey() {
        ...
        for (int i18 = 0; i18 < i3; i18++) {
            ...
            sArr14[i18] = GF2Field.addElem(sArr14[i18], this.f28162b1[i18]);
        }
    ...
    private void generateL1() {
        ...
        this.f28162b1 = new short[i2];
        for (int i5 = 0; i5 < i2; i5++) {
            this.f28162b1[i5] = (short) ((-1) - (((-1) - this.sr.nextInt()) | ((-1) - 255)));
        }
    }
    ...
    private void generateL2() {
        ...
        for (int i5 = 0; i5 < i2; i5++) {
            this.b2[i5] = (short) ((-1) - (((-1) - this.sr.nextInt()) | ((-1) - 255)));
        }
    }

    private void initializeDefault() throws Throwable {
        short sXd = (short) (ZN.Xd() ^ 21314);
        int[] iArr = new int["Lz@I\u0011\u001bv7 /*M\u001dIp\u001fIw/\u0018;\u00052&Wo".length()];
        QB qb = new QB("Lz@I\u0011\u001bv7 /*M\u001dIp\u001fIw/\u0018;\u00052&Wo");
        int i2 = 0;
        while (qb.YK()) {
            int iKK = qb.KK();
            Xu xuXd = Xu.Xd(iKK);
    ...
    public AsymmetricCipherKeyPair genKeyPair() throws Throwable {
        ...
        keygen();
        RainbowPrivateKeyParameters rainbowPrivateKeyParameters = new RainbowPrivateKeyParameters(this.A1inv, this.f28162b1, this.A2inv, this.b2, this.vi, this.layers);
        int[] iArr = this.vi;
    ...
    public void initialize(KeyGenerationParameters keyGenerationParameters) throws Throwable {
        ...
        Object[] objArr = new Object[0];
        Constructor<?> constructor = Class.forName(C1561oA.Qd("si}g3whevrhrv*N_\\mi[GUaV`]", (short) (ZN.Xd() ^ 11303))).getConstructor(new Class[0]);
        try {
            constructor.setAccessible(true);
