...
public class ProductFormPolynomial implements Polynomial {
    ...
    private SparseTernaryPolynomial f28206f1;
    ...
    public ProductFormPolynomial(SparseTernaryPolynomial sparseTernaryPolynomial, SparseTernaryPolynomial sparseTernaryPolynomial2, SparseTernaryPolynomial sparseTernaryPolynomial3) {
        this.f28206f1 = sparseTernaryPolynomial;
    ...
    public boolean equals(Object obj) {
        ...
        SparseTernaryPolynomial sparseTernaryPolynomial = this.f28206f1;
        if (sparseTernaryPolynomial == null) {
            if (productFormPolynomial.f28206f1 != null) {
                return false;
            }
        } else if (!sparseTernaryPolynomial.equals(productFormPolynomial.f28206f1)) {
            return false;
        }
    ...
    public BigIntPolynomial mult(BigIntPolynomial bigIntPolynomial) {
        BigIntPolynomial bigIntPolynomialMult = this.f2.mult(this.f28206f1.mult(bigIntPolynomial));
    ...
    public IntegerPolynomial mult(IntegerPolynomial integerPolynomial) {
        IntegerPolynomial integerPolynomialMult = this.f2.mult(this.f28206f1.mult(integerPolynomial));
    ...
    public byte[] toBinary() {
        byte[] binary = this.f28206f1.toBinary();
    ...
    public IntegerPolynomial toIntegerPolynomial() {
        IntegerPolynomial integerPolynomialMult = this.f28206f1.mult(this.f2.toIntegerPolynomial());
