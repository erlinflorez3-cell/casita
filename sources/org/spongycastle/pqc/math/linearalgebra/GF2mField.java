...
public class GF2mField {
    ...
    public String elementToStr(int i2) {
        ...
        for (int i3 = 0; i3 < this.degree; i3++) {
            str = (-1) - (((-1) - ((byte) i2)) | ((-1) - 1)) == 0 ? AdkSettings.PLATFORM_TYPE_MOBILE + str : "1" + str;
            i2 >>>= 1;
        }
        return str;
    }
    ...
    public int getRandomNonZeroElement() throws Throwable {
        ...
        Constructor<?> constructor = Class.forName(Jg.Wd("h5A_\u0003>c9>p>=y\u0004\u001ceV^\u0013Y=\u0002aO\u000ea", (short) (C1633zX.Xd() ^ (-29564)), (short) (C1633zX.Xd() ^ (-8534)))).getConstructor(new Class[0]);
        try {
