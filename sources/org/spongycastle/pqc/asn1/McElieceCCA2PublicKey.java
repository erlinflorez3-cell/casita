...
public class McElieceCCA2PublicKey extends ASN1Object {
    ...
    private McElieceCCA2PublicKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f28093n = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
        this.f28094t = ((ASN1Integer) aSN1Sequence.getObjectAt(2)).getValue().intValue();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f28093n));
        aSN1EncodableVector.add(new ASN1Integer(this.f28094t));
