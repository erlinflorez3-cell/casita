...
public class McElieceCCA2PrivateKey extends ASN1Object {
    ...
    public McElieceCCA2PrivateKey(ASN1ObjectIdentifier aSN1ObjectIdentifier, int i2, int i3, GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM, Permutation permutation, GF2Matrix gF2Matrix, PolynomialGF2mSmallM[] polynomialGF2mSmallMArr) {
    ...
    private McElieceCCA2PrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f28092n = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
        this.f28091k = ((ASN1Integer) aSN1Sequence.getObjectAt(2)).getValue().intValue();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f28092n));
        aSN1EncodableVector.add(new ASN1Integer(this.f28091k));
