...
public class RainbowPrivateKey extends ASN1Object {
    ...
    private RainbowPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f28103b1 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(2)).getObjectAt(0)).getOctets();
        ...
        while (i5 < aSN1Sequence4.size()) {
            ...
            while (i2 < aSN1Sequence6.size()) {
                ASN1Sequence aSN1Sequence7 = (ASN1Sequence) aSN1Sequence6.getObjectAt(i2);
                bArr[i5][i2] = new byte[aSN1Sequence7.size()][];
                for (int i6 = 0; i6 < aSN1Sequence7.size(); i6++) {
                    bArr[i5][i2][i6] = ((ASN1OctetString) aSN1Sequence7.getObjectAt(i6)).getOctets();
                }
                i2++;
            }
            ...
            for (int i7 = 0; i7 < aSN1Sequence8.size(); i7++) {
                ...
                bArr2[i5][i7] = new byte[aSN1Sequence9.size()][];
                for (int i8 = 0; i8 < aSN1Sequence9.size(); i8++) {
                    bArr2[i5][i7][i8] = ((ASN1OctetString) aSN1Sequence9.getObjectAt(i8)).getOctets();
                }
            }
            ...
            for (int i9 = 0; i9 < aSN1Sequence10.size(); i9++) {
                bArr3[i5][i9] = ((ASN1OctetString) aSN1Sequence10.getObjectAt(i9)).getOctets();
            }
    ...
    public RainbowPrivateKey(short[][] sArr, short[] sArr2, short[][] sArr3, short[] sArr4, int[] iArr, Layer[] layerArr) {
        ...
        this.f28103b1 = RainbowUtil.convertArray(sArr2);
    ...
    public short[] getB1() {
        return RainbowUtil.convertArray(this.f28103b1);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        for (int i2 = 0; i2 < this.invA1.length; i2++) {
            aSN1EncodableVector2.add(new DEROctetString(this.invA1[i2]));
        }
        aSN1EncodableVector.add(new DERSequence(aSN1EncodableVector2));
        ASN1EncodableVector aSN1EncodableVector3 = new ASN1EncodableVector();
        aSN1EncodableVector3.add(new DEROctetString(this.f28103b1));
        aSN1EncodableVector.add(new DERSequence(aSN1EncodableVector3));
        ASN1EncodableVector aSN1EncodableVector4 = new ASN1EncodableVector();
        for (int i3 = 0; i3 < this.invA2.length; i3++) {
            aSN1EncodableVector4.add(new DEROctetString(this.invA2[i3]));
        }
        ...
        for (int i4 = 0; i4 < this.layers.length; i4++) {
            ...
            for (int i5 = 0; i5 < bArrConvertArray.length; i5++) {
                ...
                for (int i6 = 0; i6 < bArrConvertArray[i5].length; i6++) {
                    aSN1EncodableVector10.add(new DEROctetString(bArrConvertArray[i5][i6]));
                }
            ...
            for (int i7 = 0; i7 < bArrConvertArray2.length; i7++) {
                ...
                for (int i8 = 0; i8 < bArrConvertArray2[i7].length; i8++) {
                    aSN1EncodableVector12.add(new DEROctetString(bArrConvertArray2[i7][i8]));
                }
