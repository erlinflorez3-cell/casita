    ...
    private ASN1Primitive encode(int[] iArr, byte[][] bArr, byte[][] bArr2, byte[][][] bArr3, byte[][][] bArr4, byte[][][] bArr5, Treehash[][] treehashArr, Treehash[][] treehashArr2, Vector[] vectorArr, Vector[] vectorArr2, Vector[][] vectorArr3, Vector[][] vectorArr4, GMSSLeaf[] gMSSLeafArr, GMSSLeaf[] gMSSLeafArr2, GMSSLeaf[] gMSSLeafArr3, int[] iArr2, byte[][] bArr6, GMSSRootCalc[] gMSSRootCalcArr, byte[][] bArr7, GMSSRootSig[] gMSSRootSigArr, GMSSParameters gMSSParameters, AlgorithmIdentifier[] algorithmIdentifierArr) {
        ...
        for (int i3 = 0; i3 < bArr3.length; i3++) {
            for (int i4 = 0; i4 < bArr3[i3].length; i4++) {
                aSN1EncodableVector5.add(new DEROctetString(bArr3[i3][i4]));
            }
        ...
        for (int i5 = 0; i5 < bArr4.length; i5++) {
            for (int i6 = 0; i6 < bArr4[i5].length; i6++) {
                aSN1EncodableVector7.add(new DEROctetString(bArr4[i5][i6]));
            }
        ...
        for (int i7 = 0; i7 < treehashArr.length; i7++) {
            for (int i8 = 0; i8 < treehashArr[i7].length; i8++) {
                aSN1EncodableVector11.add(new DERSequence(algorithmIdentifierArr[0]));
                int i9 = treehashArr[i7][i8].getStatInt()[1];
                aSN1EncodableVector12.add(new DEROctetString(treehashArr[i7][i8].getStatByte()[0]));
                aSN1EncodableVector12.add(new DEROctetString(treehashArr[i7][i8].getStatByte()[1]));
                aSN1EncodableVector12.add(new DEROctetString(treehashArr[i7][i8].getStatByte()[2]));
                for (int i10 = 0; i10 < i9; i10++) {
                    aSN1EncodableVector12.add(new DEROctetString(treehashArr[i7][i8].getStatByte()[i10 + 3]));
                }
                aSN1EncodableVector11.add(new DERSequence(aSN1EncodableVector12));
                aSN1EncodableVector12 = new ASN1EncodableVector();
                aSN1EncodableVector13.add(new ASN1Integer(treehashArr[i7][i8].getStatInt()[0]));
                aSN1EncodableVector13.add(new ASN1Integer(i9));
                aSN1EncodableVector13.add(new ASN1Integer(treehashArr[i7][i8].getStatInt()[2]));
                aSN1EncodableVector13.add(new ASN1Integer(treehashArr[i7][i8].getStatInt()[3]));
                aSN1EncodableVector13.add(new ASN1Integer(treehashArr[i7][i8].getStatInt()[4]));
                aSN1EncodableVector13.add(new ASN1Integer(treehashArr[i7][i8].getStatInt()[5]));
                for (int i11 = 0; i11 < i9; i11++) {
                    aSN1EncodableVector13.add(new ASN1Integer(treehashArr[i7][i8].getStatInt()[i11 + 6]));
                }
        ...
        for (int i12 = 0; i12 < treehashArr2.length; i12++) {
            for (int i13 = 0; i13 < treehashArr2[i12].length; i13++) {
                ...
                aSN1EncodableVector17.add(new DEROctetString(treehashArr2[i12][i13].getStatByte()[0]));
                aSN1EncodableVector17.add(new DEROctetString(treehashArr2[i12][i13].getStatByte()[1]));
                aSN1EncodableVector17.add(new DEROctetString(treehashArr2[i12][i13].getStatByte()[2]));
                for (int i15 = 0; i15 < i14; i15++) {
                    aSN1EncodableVector17.add(new DEROctetString(treehashArr2[i12][i13].getStatByte()[i15 + 3]));
                }
                aSN1EncodableVector16.add(new DERSequence(aSN1EncodableVector17));
                aSN1EncodableVector17 = new ASN1EncodableVector();
                aSN1EncodableVector18.add(new ASN1Integer(treehashArr2[i12][i13].getStatInt()[0]));
                aSN1EncodableVector18.add(new ASN1Integer(i14));
                aSN1EncodableVector18.add(new ASN1Integer(treehashArr2[i12][i13].getStatInt()[2]));
                aSN1EncodableVector18.add(new ASN1Integer(treehashArr2[i12][i13].getStatInt()[3]));
                aSN1EncodableVector18.add(new ASN1Integer(treehashArr2[i12][i13].getStatInt()[4]));
                aSN1EncodableVector18.add(new ASN1Integer(treehashArr2[i12][i13].getStatInt()[5]));
                for (int i16 = 0; i16 < i14; i16++) {
                    aSN1EncodableVector18.add(new ASN1Integer(treehashArr2[i12][i13].getStatInt()[i16 + 6]));
                }
        ...
        for (int i17 = 0; i17 < bArr5.length; i17++) {
            for (int i18 = 0; i18 < bArr5[i17].length; i18++) {
                aSN1EncodableVector19.add(new DEROctetString(bArr5[i17][i18]));
            }
        ...
        for (int i19 = 0; i19 < vectorArr.length; i19++) {
            for (int i20 = 0; i20 < vectorArr[i19].size(); i20++) {
                aSN1EncodableVector21.add(new DEROctetString((byte[]) vectorArr[i19].elementAt(i20)));
            }
        ...
        for (int i21 = 0; i21 < vectorArr2.length; i21++) {
            for (int i22 = 0; i22 < vectorArr2[i21].size(); i22++) {
                aSN1EncodableVector23.add(new DEROctetString((byte[]) vectorArr2[i21].elementAt(i22)));
            }
        ...
        for (int i23 = 0; i23 < vectorArr3.length; i23++) {
            for (int i24 = 0; i24 < vectorArr3[i23].length; i24++) {
                for (int i25 = 0; i25 < vectorArr3[i23][i24].size(); i25++) {
                    aSN1EncodableVector25.add(new DEROctetString((byte[]) vectorArr3[i23][i24].elementAt(i25)));
                }
        ...
        for (int i26 = 0; i26 < vectorArr4.length; i26++) {
            for (int i27 = 0; i27 < vectorArr4[i26].length; i27++) {
                for (int i28 = 0; i28 < vectorArr4[i26][i27].size(); i28++) {
                    aSN1EncodableVector28.add(new DEROctetString((byte[]) vectorArr4[i26][i27].elementAt(i28)));
                }
        ...
        for (int i32 : iArr2) {
            aSN1EncodableVector43.add(new ASN1Integer(i32));
        }
        ...
        for (int i33 = 0; i33 < gMSSRootCalcArr.length; i33++) {
            ...
            aSN1EncodableVector47.add(new DEROctetString(gMSSRootCalcArr[i33].getStatByte()[0]));
            int i36 = 0;
            while (i36 < i34) {
                i36++;
                aSN1EncodableVector47.add(new DEROctetString(gMSSRootCalcArr[i33].getStatByte()[i36]));
            }
            for (int i37 = 0; i37 < i35; i37++) {
                aSN1EncodableVector47.add(new DEROctetString(gMSSRootCalcArr[i33].getStatByte()[i34 + 1 + i37]));
            }
            ...
            aSN1EncodableVector48.add(new ASN1Integer(gMSSRootCalcArr[i33].getStatInt()[1]));
            aSN1EncodableVector48.add(new ASN1Integer(gMSSRootCalcArr[i33].getStatInt()[2]));
            aSN1EncodableVector48.add(new ASN1Integer(gMSSRootCalcArr[i33].getStatInt()[3]));
            aSN1EncodableVector48.add(new ASN1Integer(gMSSRootCalcArr[i33].getStatInt()[4]));
            aSN1EncodableVector48.add(new ASN1Integer(gMSSRootCalcArr[i33].getStatInt()[5]));
            aSN1EncodableVector48.add(new ASN1Integer(gMSSRootCalcArr[i33].getStatInt()[6]));
            aSN1EncodableVector48.add(new ASN1Integer(i35));
            for (int i38 = 0; i38 < i34; i38++) {
                aSN1EncodableVector48.add(new ASN1Integer(gMSSRootCalcArr[i33].getStatInt()[i38 + 8]));
            }
            for (int i39 = 0; i39 < i35; i39++) {
                aSN1EncodableVector48.add(new ASN1Integer(gMSSRootCalcArr[i33].getStatInt()[i34 + 8 + i39]));
            }
            ...
            if (gMSSRootCalcArr[i33].getTreehash() != null) {
                for (int i40 = 0; i40 < gMSSRootCalcArr[i33].getTreehash().length; i40++) {
                    ...
                    aSN1EncodableVector52.add(new DEROctetString(gMSSRootCalcArr[i33].getTreehash()[i40].getStatByte()[0]));
                    aSN1EncodableVector52.add(new DEROctetString(gMSSRootCalcArr[i33].getTreehash()[i40].getStatByte()[1]));
                    aSN1EncodableVector52.add(new DEROctetString(gMSSRootCalcArr[i33].getTreehash()[i40].getStatByte()[2]));
                    for (int i42 = 0; i42 < i41; i42++) {
                        aSN1EncodableVector52.add(new DEROctetString(gMSSRootCalcArr[i33].getTreehash()[i40].getStatByte()[i42 + 3]));
                    }
                    aSN1EncodableVector51.add(new DERSequence(aSN1EncodableVector52));
                    aSN1EncodableVector52 = new ASN1EncodableVector();
                    aSN1EncodableVector53.add(new ASN1Integer(gMSSRootCalcArr[i33].getTreehash()[i40].getStatInt()[0]));
                    aSN1EncodableVector53.add(new ASN1Integer(i41));
                    aSN1EncodableVector53.add(new ASN1Integer(gMSSRootCalcArr[i33].getTreehash()[i40].getStatInt()[2]));
                    aSN1EncodableVector53.add(new ASN1Integer(gMSSRootCalcArr[i33].getTreehash()[i40].getStatInt()[3]));
                    aSN1EncodableVector53.add(new ASN1Integer(gMSSRootCalcArr[i33].getTreehash()[i40].getStatInt()[4]));
                    aSN1EncodableVector53.add(new ASN1Integer(gMSSRootCalcArr[i33].getTreehash()[i40].getStatInt()[5]));
                    for (int i43 = 0; i43 < i41; i43++) {
                        aSN1EncodableVector53.add(new ASN1Integer(gMSSRootCalcArr[i33].getTreehash()[i40].getStatInt()[i43 + 6]));
                    }
            ...
            if (gMSSRootCalcArr[i33].getRetain() != null) {
                for (int i44 = 0; i44 < gMSSRootCalcArr[i33].getRetain().length; i44++) {
                    for (int i45 = 0; i45 < gMSSRootCalcArr[i33].getRetain()[i44].size(); i45++) {
                        aSN1EncodableVector54.add(new DEROctetString((byte[]) gMSSRootCalcArr[i33].getRetain()[i44].elementAt(i45)));
                    }
        ...
        for (int i46 = 0; i46 < gMSSRootSigArr.length; i46++) {
            ...
            new ASN1EncodableVector();
            aSN1EncodableVector58.add(new DEROctetString(gMSSRootSigArr[i46].getStatByte()[0]));
            aSN1EncodableVector58.add(new DEROctetString(gMSSRootSigArr[i46].getStatByte()[1]));
            aSN1EncodableVector58.add(new DEROctetString(gMSSRootSigArr[i46].getStatByte()[2]));
            aSN1EncodableVector58.add(new DEROctetString(gMSSRootSigArr[i46].getStatByte()[3]));
            aSN1EncodableVector58.add(new DEROctetString(gMSSRootSigArr[i46].getStatByte()[4]));
            aSN1EncodableVector57.add(new DERSequence(aSN1EncodableVector58));
            aSN1EncodableVector58 = new ASN1EncodableVector();
            aSN1EncodableVector59.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[0]));
            aSN1EncodableVector59.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[1]));
            aSN1EncodableVector59.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[2]));
            aSN1EncodableVector59.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[3]));
            aSN1EncodableVector59.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[4]));
            aSN1EncodableVector59.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[5]));
            aSN1EncodableVector59.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[6]));
            aSN1EncodableVector59.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[7]));
            aSN1EncodableVector59.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[8]));
        ...
        for (int i47 = 0; i47 < gMSSParameters.getHeightOfTrees().length; i47++) {
            aSN1EncodableVector61.add(new ASN1Integer(gMSSParameters.getHeightOfTrees()[i47]));
            aSN1EncodableVector62.add(new ASN1Integer(gMSSParameters.getWinternitzParameter()[i47]));
            aSN1EncodableVector63.add(new ASN1Integer(gMSSParameters.getK()[i47]));
        }
        aSN1EncodableVector60.add(new ASN1Integer(gMSSParameters.getNumOfLayers()));
