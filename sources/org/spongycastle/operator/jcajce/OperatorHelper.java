...
class OperatorHelper {
    ...
    private static String getDigestName(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        ...
        return iIndexOf > 0 ? digestName.substring(0, iIndexOf) + digestName.substring(iIndexOf + 1) : MessageDigestUtils.getDigestName(aSN1ObjectIdentifier);
    }
    ...
    public X509Certificate convertCertificate(X509CertificateHolder x509CertificateHolder) throws Throwable {
        try {
            CertificateFactory certificateFactoryCreateCertificateFactory = this.helper.createCertificateFactory(C1561oA.yd("\u001dqwqy", (short) (C1633zX.Xd() ^ (-29348))));
            ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(x509CertificateHolder.getEncoded());
            Class<?> cls = Class.forName(C1561oA.Yd("\u0015\r#\u000f\\#\u0016\u0015(&\u001e*0e\u001c\u001f-0j\u0001$25+)-(';-\u000f+.@<@H", (short) (OY.Xd() ^ 6656)));
            Class<?>[] clsArr = new Class[1];
            clsArr[0] = Class.forName(Xg.qd("WOeQ\u001f[b\">dgmmMonb_l", (short) (C1633zX.Xd() ^ (-25877)), (short) (C1633zX.Xd() ^ (-20458))));
            Object[] objArr = {byteArrayInputStream};
            short sXd = (short) (C1633zX.Xd() ^ (-32679));
            short sXd2 = (short) (C1633zX.Xd() ^ (-29909));
            int[] iArr = new int["1n6j6tFt\u0011r.m!]/f#u%".length()];
            QB qb = new QB("1n6j6tFt\u0011r.m!]/f#u%");
            int i2 = 0;
            while (qb.YK()) {
                int iKK = qb.KK();
                Xu xuXd = Xu.Xd(iKK);
            ...
            throw new OpCertificateException(C1626yg.Ud("\u001bG=DjN\u000bW:7=E\u001eY\\/bn\u0001Nr0;'r\u0016\u0013\u007f|\u001b>{\u007fz,\u0006L\u000b\u0019o", (short) (C1580rY.Xd() ^ (-27324)), (short) (C1580rY.Xd() ^ (-23826))) + e3.getMessage(), e3);
        } catch (NoSuchProviderException e4) {
            throw new OpCertificateException(ZO.xd("fsN\u000e37Z!j\u000e\b`q-J\u000ebXY}\u001c\u0017$^b\u001a^z15", (short) (ZN.Xd() ^ 16115), (short) (ZN.Xd() ^ 28104)) + e4.getMessage(), e4);
        }
    }
