...
public class SecT571Field {
    ...
    protected static void implMultiply(long[] jArr, long[] jArr2, long[] jArr3) {
        ...
        for (int i5 = 56; i5 >= 0; i5 -= 8) {
            for (int i6 = 1; i6 < 9; i6 += 2) {
                ...
                jArr7 = jArr7;
                addBothTo(jArr4, ((-1) - (((-1) - i7) | ((-1) - 15))) * 9, jArr7, ((i7 >>> 4) & 15) * 9, jArr3, i6 - 1);
            }
        ...
        for (int i8 = 56; i8 >= 0; i8 -= 8) {
            for (int i9 = 0; i9 < 9; i9 += 2) {
                ...
                int i11 = (-1) - (((-1) - i10) | ((-1) - 15));
                int i12 = i10 >>> 4;
                jArr7 = jArr7;
                addBothTo(jArr4, i11 * 9, jArr7, ((i12 + 15) - (i12 | 15)) * 9, jArr3, i9);
            }
            if (i8 > 0) {
    ...
    protected static void implMulwAcc(long[] jArr, long j2, long[] jArr2, int i2) {
        ...
        while (i4 < 9) {
            long j5 = jArr[i4];
            long j6 = j4 ^ jArr3[(-1) - (((-1) - ((int) j5)) | ((-1) - 31))];
            int i5 = 60;
            long j7 = 0;
            do {
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        for (int i3 = 0; i3 < 4; i3++) {
            ...
            jArrCreate64[i3] = (-1) - (((-1) - ((-1) - (((-1) - 4294967295L) | ((-1) - jUnshuffle)))) & ((-1) - (jUnshuffle2 << 32)));
            long j2 = jUnshuffle >>> 32;
            long j3 = (-4294967296L) & jUnshuffle2;
            jArrCreate642[i3] = (j2 + j3) - (j2 & j3);
        }
        long jUnshuffle3 = Interleave.unshuffle(jArr[i2]);
        jArrCreate64[4] = (-1) - (((-1) - 4294967295L) | ((-1) - jUnshuffle3));
