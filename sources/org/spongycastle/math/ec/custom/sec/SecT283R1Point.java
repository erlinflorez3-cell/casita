...
public class SecT283R1Point extends ECPoint.AbstractF2m {
    ...
    SecT283R1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z2) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementMultiply4.isZero()) {
                return new SecT283R1Point(curve, eCFieldElementMultiply4, curve.getB().sqrt(), this.withCompression);
            }
        ...
        return new SecT283R1Point(curve, eCFieldElementMultiply4, eCFieldElementSquarePlusProduct, new ECFieldElement[]{eCFieldElementMultiply5}, this.withCompression);
    }
