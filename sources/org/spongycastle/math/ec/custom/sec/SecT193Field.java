...
public class SecT193Field {
    ...
    protected static void implMulwAcc(long j2, long j3, long[] jArr, int i2) {
        ...
        int i3 = (int) j2;
        long j8 = (jArr2[(-1) - (((-1) - (i3 >>> 3)) | ((-1) - 7))] << 3) ^ jArr2[7 & i3];
        long j9 = 0;
        int i4 = 36;
        do {
            int i5 = (int) (j2 >>> i4);
            int i6 = i5 >>> 6;
            long j10 = (jArr2[(i5 + 7) - (7 | i5)] ^ (jArr2[(i5 >>> 3) & 7] << 3)) ^ (jArr2[(i6 + 7) - (i6 | 7)] << 6);
            int i7 = i5 >>> 9;
            int i8 = i5 >>> 12;
            long j11 = (j10 ^ (jArr2[(i7 + 7) - (i7 | 7)] << 9)) ^ (jArr2[(i8 + 7) - (i8 | 7)] << 12);
            j8 ^= j11 << i4;
            j9 ^= j11 >>> (-i4);
            i4 -= 15;
        } while (i4 > 0);
        jArr[i2] = jArr[i2] ^ ((-1) - (((-1) - M49) | ((-1) - j8)));
        int i9 = i2 + 1;
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j3 = (-1) - (((-1) - (jUnshuffle >>> 32)) & ((-1) - ((-1) - (((-1) - jUnshuffle2) | ((-1) - (-4294967296L))))));
        long jUnshuffle3 = Interleave.unshuffle(jArr[2]);
        long j4 = ((-1) - (((-1) - jUnshuffle3) | ((-1) - 4294967295L))) ^ (jArr[3] << 32);
