...
public class SecT571R1Point extends ECPoint.AbstractF2m {
    ...
    SecT571R1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z2) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementMultiply4.isZero()) {
                return new SecT571R1Point(curve, eCFieldElementMultiply4, SecT571R1Curve.SecT571R1_B_SQRT, this.withCompression);
            }
        ...
        return new SecT571R1Point(curve, eCFieldElementMultiply4, eCFieldElementSquarePlusProduct, new ECFieldElement[]{eCFieldElementMultiply5}, this.withCompression);
    }
