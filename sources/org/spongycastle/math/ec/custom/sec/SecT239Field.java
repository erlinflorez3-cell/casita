...
public class SecT239Field {
    ...
    protected static void implExpand(long[] jArr, long[] jArr2) {
        ...
        long j6 = (j2 >>> 60) ^ (j3 << 4);
        jArr2[1] = (j6 + M60) - (j6 | M60);
        long j7 = (j3 >>> 56) ^ (j4 << 8);
        jArr2[2] = (j7 + M60) - (j7 | M60);
        jArr2[3] = (j4 >>> 52) ^ (j5 << 12);
    }
    ...
    protected static void implMulwAcc(long j2, long j3, long[] jArr, int i2) {
        ...
        int i3 = (int) j2;
        long j8 = (jArr2[(-1) - (((-1) - (i3 >>> 3)) | ((-1) - 7))] << 3) ^ jArr2[(-1) - (((-1) - i3) | ((-1) - 7))];
        long j9 = 0;
        int i4 = 54;
        do {
            int i5 = (int) (j2 >>> i4);
        ...
        long j12 = j2 & 585610922974906400L;
        long j13 = (j3 << 4) >> 63;
        jArr[i2] = jArr[i2] ^ ((-1) - (((-1) - M60) | ((-1) - j8)));
        int i7 = i2 + 1;
        jArr[i7] = ((((((j12 + j13) - (j12 | j13)) >>> 5) ^ j9) << 4) ^ (j8 >>> 60)) ^ jArr[i7];
    }
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j6 = (-1) - (((-1) - (jUnshuffle3 & 4294967295L)) & ((-1) - (jUnshuffle4 << 32)));
        long j7 = jUnshuffle3 >>> 32;
        long j8 = (-1) - (((-1) - jUnshuffle4) | ((-1) - (-4294967296L)));
        long j9 = (j8 + j7) - (j8 & j7);
        long j10 = j9 >>> 49;
        long j11 = (j5 >>> 49) | (j9 << 15);
        long j12 = j9 ^ (j5 << 15);
        long[] jArrCreateExt64 = Nat256.createExt64();
        int[] iArr = {39, 120};
        int i2 = 0;
        for (int i3 = 2; i2 < i3; i3 = 2) {
            ...
            int i5 = i4 >>> 6;
            int i6 = (i4 + 63) - (i4 | 63);
            jArrCreateExt64[i5] = jArrCreateExt64[i5] ^ (j5 << i6);
            int i7 = i5 + 1;
            long j13 = j12 << i6;
            int i8 = -i6;
            long j14 = j5 >>> i8;
            jArrCreateExt64[i7] = jArrCreateExt64[i7] ^ ((j13 + j14) - (j13 & j14));
            int i9 = i5 + 2;
            jArrCreateExt64[i9] = jArrCreateExt64[i9] ^ ((-1) - (((-1) - (j11 << i6)) & ((-1) - (j12 >>> i8))));
            int i10 = i5 + 3;
            jArrCreateExt64[i10] = jArrCreateExt64[i10] ^ ((-1) - (((-1) - (j10 << i6)) & ((-1) - (j11 >>> i8))));
            int i11 = i5 + 4;
            jArrCreateExt64[i11] = jArrCreateExt64[i11] ^ (j10 >>> i8);
            i2++;
        }
    ...
    public static int trace(long[] jArr) {
        int i2 = (int) ((jArr[0] ^ (jArr[1] >>> 17)) ^ (jArr[2] >>> 34));
        return (i2 + 1) - (i2 | 1);
    }
}
