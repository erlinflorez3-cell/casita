...
public class SecT163R1Point extends ECPoint.AbstractF2m {
    ...
    SecT163R1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z2) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        ECFieldElement eCFieldElementMultiply6 = this.f28048x;
        ...
        ECFieldElement eCFieldElement = this.f28049y;
        ...
        if (rawXCoord.isZero()) {
            ...
            eCFieldElementMultiply4 = eCFieldElementDivide.square().add(eCFieldElementDivide).add(xCoord).add(curve.getA());
            if (eCFieldElementMultiply4.isZero()) {
                return new SecT163R1Point(curve, eCFieldElementMultiply4, curve.getB().sqrt(), this.withCompression);
            }
        ...
        return new SecT163R1Point(curve, eCFieldElementMultiply4, eCFieldElementSquarePlusProduct, new ECFieldElement[]{eCFieldElementMultiply5}, this.withCompression);
    }
    ...
    public ECFieldElement getYCoord() {
        ECFieldElement eCFieldElement = this.f28048x;
        ECFieldElement eCFieldElement2 = this.f28049y;
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        ECFieldElement eCFieldElementMultiply = this.f28048x;
