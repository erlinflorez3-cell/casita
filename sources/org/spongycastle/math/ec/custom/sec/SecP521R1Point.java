...
public class SecP521R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP521R1FieldElement secP521R1FieldElement = (SecP521R1FieldElement) this.f28048x;
        SecP521R1FieldElement secP521R1FieldElement2 = (SecP521R1FieldElement) this.f28049y;
        ...
        if (zIsOne) {
            iArr = secP521R1FieldElement3.f28076x;
            iArr2 = secP521R1FieldElement4.f28076x;
        } else {
            SecP521R1Field.square(secP521R1FieldElement5.f28076x, iArrCreate3);
            SecP521R1Field.multiply(iArrCreate3, secP521R1FieldElement3.f28076x, iArrCreate2);
            SecP521R1Field.multiply(iArrCreate3, secP521R1FieldElement5.f28076x, iArrCreate3);
            SecP521R1Field.multiply(iArrCreate3, secP521R1FieldElement4.f28076x, iArrCreate3);
            iArr = iArrCreate2;
            iArr2 = iArrCreate3;
        }
        boolean zIsOne2 = secP521R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP521R1FieldElement.f28076x;
            iArr4 = secP521R1FieldElement2.f28076x;
        } else {
            SecP521R1Field.square(secP521R1FieldElement6.f28076x, iArrCreate4);
            SecP521R1Field.multiply(iArrCreate4, secP521R1FieldElement.f28076x, iArrCreate);
            SecP521R1Field.multiply(iArrCreate4, secP521R1FieldElement6.f28076x, iArrCreate4);
            SecP521R1Field.multiply(iArrCreate4, secP521R1FieldElement2.f28076x, iArrCreate4);
            iArr3 = iArrCreate;
            iArr4 = iArrCreate4;
        }
        ...
        SecP521R1Field.square(iArrCreate2, secP521R1FieldElement7.f28076x);
        SecP521R1Field.add(secP521R1FieldElement7.f28076x, iArrCreate6, secP521R1FieldElement7.f28076x);
        SecP521R1Field.subtract(secP521R1FieldElement7.f28076x, iArrCreate3, secP521R1FieldElement7.f28076x);
        SecP521R1Field.subtract(secP521R1FieldElement7.f28076x, iArrCreate3, secP521R1FieldElement7.f28076x);
        SecP521R1FieldElement secP521R1FieldElement8 = new SecP521R1FieldElement(iArrCreate6);
        SecP521R1Field.subtract(iArrCreate3, secP521R1FieldElement7.f28076x, secP521R1FieldElement8.f28076x);
        SecP521R1Field.multiply(secP521R1FieldElement8.f28076x, iArrCreate2, iArrCreate2);
        SecP521R1Field.subtract(iArrCreate2, iArrCreate, secP521R1FieldElement8.f28076x);
        SecP521R1FieldElement secP521R1FieldElement9 = new SecP521R1FieldElement(iArrCreate5);
        if (!zIsOne) {
            SecP521R1Field.multiply(secP521R1FieldElement9.f28076x, secP521R1FieldElement5.f28076x, secP521R1FieldElement9.f28076x);
        }
        if (!zIsOne2) {
            SecP521R1Field.multiply(secP521R1FieldElement9.f28076x, secP521R1FieldElement6.f28076x, secP521R1FieldElement9.f28076x);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP521R1Point(this.curve, this.f28048x, this.f28049y.negate(), this.zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP521R1FieldElement secP521R1FieldElement = (SecP521R1FieldElement) this.f28049y;
        if (secP521R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP521R1FieldElement secP521R1FieldElement2 = (SecP521R1FieldElement) this.f28048x;
        SecP521R1FieldElement secP521R1FieldElement3 = (SecP521R1FieldElement) this.zs[0];
        int[] iArrCreate = Nat.create(17);
        int[] iArrCreate2 = Nat.create(17);
        int[] iArrCreate3 = Nat.create(17);
        SecP521R1Field.square(secP521R1FieldElement.f28076x, iArrCreate3);
        int[] iArrCreate4 = Nat.create(17);
        SecP521R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP521R1FieldElement3.isOne();
        int[] iArr = secP521R1FieldElement3.f28076x;
        if (!zIsOne) {
            SecP521R1Field.square(secP521R1FieldElement3.f28076x, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP521R1Field.subtract(secP521R1FieldElement2.f28076x, iArr, iArrCreate);
        SecP521R1Field.add(secP521R1FieldElement2.f28076x, iArr, iArrCreate2);
        ...
        SecP521R1Field.multiply(iArrCreate3, secP521R1FieldElement2.f28076x, iArrCreate3);
        ...
        SecP521R1Field.square(iArrCreate2, secP521R1FieldElement4.f28076x);
        SecP521R1Field.subtract(secP521R1FieldElement4.f28076x, iArrCreate3, secP521R1FieldElement4.f28076x);
        SecP521R1Field.subtract(secP521R1FieldElement4.f28076x, iArrCreate3, secP521R1FieldElement4.f28076x);
        SecP521R1FieldElement secP521R1FieldElement5 = new SecP521R1FieldElement(iArrCreate3);
        SecP521R1Field.subtract(iArrCreate3, secP521R1FieldElement4.f28076x, secP521R1FieldElement5.f28076x);
        SecP521R1Field.multiply(secP521R1FieldElement5.f28076x, iArrCreate2, secP521R1FieldElement5.f28076x);
        SecP521R1Field.subtract(secP521R1FieldElement5.f28076x, iArrCreate, secP521R1FieldElement5.f28076x);
        SecP521R1FieldElement secP521R1FieldElement6 = new SecP521R1FieldElement(iArrCreate2);
        SecP521R1Field.twice(secP521R1FieldElement.f28076x, secP521R1FieldElement6.f28076x);
        if (!zIsOne) {
            SecP521R1Field.multiply(secP521R1FieldElement6.f28076x, secP521R1FieldElement3.f28076x, secP521R1FieldElement6.f28076x);
        }
