...
public class SecT409Field {
    ...
    protected static void implExpand(long[] jArr, long[] jArr2) {
        ...
        long j10 = (j5 >>> 44) ^ (j6 << 20);
        jArr2[4] = (j10 + M59) - (j10 | M59);
    ...
    protected static void implMulwAcc(long[] jArr, long j2, long[] jArr2, int i2) {
        ...
        for (int i3 = 0; i3 < 7; i3++) {
            long j7 = jArr[i3];
            int i4 = (int) j7;
            long j8 = jArr3[7 & i4] ^ (jArr3[(-1) - (((-1) - (i4 >>> 3)) | ((-1) - 7))] << 3);
            long j9 = 0;
            int i5 = 54;
            do {
                int i6 = (int) (j7 >>> i5);
                long j10 = jArr3[7 & i6] ^ (jArr3[(i6 >>> 3) & 7] << 3);
                j8 ^= j10 << i5;
                j9 ^= j10 >>> (-i5);
                i5 -= 6;
            } while (i5 > 0);
            int i7 = i2 + i3;
            jArr2[i7] = jArr2[i7] ^ ((M59 + j8) - (M59 | j8));
            int i8 = i7 + 1;
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j4 = jUnshuffle2 & (-4294967296L);
        long j5 = (j3 + j4) - (j3 & j4);
        ...
        long j7 = (-1) - (((-1) - (jUnshuffle3 >>> 32)) & ((-1) - ((-1) - (((-1) - jUnshuffle4) | ((-1) - (-4294967296L))))));
        long jUnshuffle5 = Interleave.unshuffle(jArr[4]);
        long jUnshuffle6 = Interleave.unshuffle(jArr[5]);
        long j8 = (-1) - (((-1) - (jUnshuffle5 & 4294967295L)) & ((-1) - (jUnshuffle6 << 32)));
        long j9 = jUnshuffle5 >>> 32;
        long j10 = (-1) - (((-1) - jUnshuffle6) | ((-1) - (-4294967296L)));
        long j11 = (j9 + j10) - (j9 & j10);
        long jUnshuffle7 = Interleave.unshuffle(jArr[6]);
        long j12 = jUnshuffle7 >>> 32;
        jArr2[0] = j2 ^ (j5 << 44);
        jArr2[1] = (j6 ^ (j7 << 44)) ^ (j5 >>> 20);
        jArr2[2] = (j8 ^ (j11 << 44)) ^ (j7 >>> 20);
        jArr2[3] = (((j12 << 44) ^ ((-1) - (((-1) - jUnshuffle7) | ((-1) - 4294967295L)))) ^ (j11 >>> 20)) ^ (j5 << 13);
        jArr2[4] = (j5 >>> 51) ^ ((jUnshuffle7 >>> 52) ^ (j7 << 13));
        jArr2[5] = (j11 << 13) ^ (j7 >>> 51);
        jArr2[6] = (j12 << 13) ^ (j11 >>> 51);
    }
