...
public class SecT233K1Point extends ECPoint.AbstractF2m {
    ...
    SecT233K1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z2) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            eCFieldElementMultiply4 = eCFieldElementDivide.square().add(eCFieldElementDivide).add(xCoord);
            if (eCFieldElementMultiply4.isZero()) {
                return new SecT233K1Point(curve, eCFieldElementMultiply4, curve.getB(), this.withCompression);
            }
        ...
        return new SecT233K1Point(curve, eCFieldElementMultiply4, eCFieldElementSquarePlusProduct, new ECFieldElement[]{eCFieldElementMultiply5}, this.withCompression);
    }
