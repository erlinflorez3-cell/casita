...
public abstract class ECCurve {
    ...
    protected ECFieldElement f28038a;

    /* JADX INFO: renamed from: b */
    protected ECFieldElement f28039b;
    ...
    public static abstract class AbstractF2m extends ECCurve {
        ...
        public boolean isKoblitz() {
            return this.order != null && this.cofactor != null && this.f28039b.isOne() && (this.f28038a.isZero() || this.f28038a.isOne());
        }
    ...
    public static abstract class AbstractFp extends ECCurve {
        ...
        protected ECPoint decompressPoint(int i2, BigInteger bigInteger) {
            ECFieldElement eCFieldElementFromBigInteger = fromBigInteger(bigInteger);
            ECFieldElement eCFieldElementSqrt = eCFieldElementFromBigInteger.square().add(this.f28038a).multiply(eCFieldElementFromBigInteger).add(this.f28039b).sqrt();
    ...
    public static class F2m extends AbstractF2m {
        ...
        public F2m(int i2, int i3, int i4, int i5, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
            ...
            this.f28038a = fromBigInteger(bigInteger);
            this.f28039b = fromBigInteger(bigInteger2);
            this.coord = 6;
        }
        ...
        protected F2m(int i2, int i3, int i4, int i5, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger, BigInteger bigInteger2) {
            ...
            this.infinity = new ECPoint.F2m(this, null, null);
            this.f28038a = eCFieldElement;
            this.f28039b = eCFieldElement2;
            this.coord = 6;
        }
        ...
        protected ECCurve cloneCurve() {
            return new F2m(this.f28040m, this.k1, this.k2, this.k3, this.f28038a, this.f28039b, this.order, this.cofactor);
        }
        ...
        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.F2m(this.f28040m, this.k1, this.k2, this.k3, bigInteger);
        }
    ...
    public static class Fp extends AbstractFp {
        ...
        public Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, BigInteger bigInteger5) {
            super(bigInteger);
            this.f28041q = bigInteger;
            this.f28042r = ECFieldElement.Fp.calculateResidue(bigInteger);
            this.infinity = new ECPoint.Fp(this, null, null);
            this.f28038a = fromBigInteger(bigInteger2);
            this.f28039b = fromBigInteger(bigInteger3);
        ...
        @Override // org.spongycastle.math.ec.ECCurve
        protected ECCurve cloneCurve() {
            return new Fp(this.f28041q, this.f28042r, this.f28038a, this.f28039b, this.order, this.cofactor);
        }
        ...
        @Override // org.spongycastle.math.ec.ECCurve
        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.Fp(this.f28041q, this.f28042r, bigInteger);
        }

        @Override // org.spongycastle.math.ec.ECCurve
        public int getFieldSize() {
            return this.f28041q.bitLength();
        }
        ...
        public ECPoint importPoint(ECPoint eCPoint) {
            ...
            return (this == eCPoint.getCurve() || getCoordinateSystem() != 2 || eCPoint.isInfinity() || !((coordinateSystem = eCPoint.getCurve().getCoordinateSystem()) == 2 || coordinateSystem == 3 || coordinateSystem == 4)) ? super.importPoint(eCPoint) : new ECPoint.Fp(this, fromBigInteger(eCPoint.f28048x.toBigInteger()), fromBigInteger(eCPoint.f28049y.toBigInteger()), new ECFieldElement[]{fromBigInteger(eCPoint.zs[0].toBigInteger())}, eCPoint.withCompression);
        }
