...
public abstract class WNafUtil {
    ...
    public static int[] generateCompactWindowNaf(int i2, BigInteger bigInteger) {
        ...
        while (i6 <= bigInteger.bitLength()) {
            if (bigInteger.testBit(i6) == z2) {
                ...
                int i8 = (iIntValue + i4) - (iIntValue | i4);
                if (z2) {
                    i8++;
                }
                z2 = (-1) - (((-1) - i8) | ((-1) - i5)) != 0;
    ...
    public static byte[] generateJSF(BigInteger bigInteger, BigInteger bigInteger2) {
        BigInteger bigIntegerShiftRight = bigInteger2;
        BigInteger bigIntegerShiftRight2 = bigInteger;
        int iMax = Math.max(bigIntegerShiftRight2.bitLength(), bigIntegerShiftRight.bitLength()) + 1;
        ...
        int i5 = 0;
        while (true) {
            if ((i2 | i3) == 0 && bigIntegerShiftRight2.bitLength() <= i4 && bigIntegerShiftRight.bitLength() <= i4) {
                break;
            }
            int iIntValue = (bigIntegerShiftRight2.intValue() >>> i4) + i2;
            int i6 = iIntValue & 7;
            int iIntValue2 = (bigIntegerShiftRight.intValue() >>> i4) + i3;
            int i7 = iIntValue2 & 7;
            int i8 = (-1) - (((-1) - iIntValue) | ((-1) - 1));
            if (i8 != 0) {
                i8 -= (iIntValue + 2) - (2 | iIntValue);
                if (i6 + i8 == 4 && (iIntValue2 + 3) - (3 | iIntValue2) == 2) {
                    i8 = -i8;
                }
            }
            int i9 = iIntValue2 & 1;
            if (i9 != 0) {
                i9 -= (-1) - (((-1) - iIntValue2) | ((-1) - 2));
                if (i7 + i9 == 4 && (-1) - (((-1) - iIntValue) | ((-1) - 3)) == 2) {
                    i9 = -i9;
                }
            }
            if ((i2 << 1) == i8 + 1) {
    ...
    public static byte[] generateWindowNaf(int i2, BigInteger bigInteger) {
        ...
        while (i6 <= bigInteger.bitLength()) {
            if (bigInteger.testBit(i6) == z2) {
                ...
                bigInteger = bigInteger.shiftRight(i6);
                int iIntValue = (-1) - (((-1) - bigInteger.intValue()) | ((-1) - i4));
                if (z2) {
                    iIntValue++;
                }
                z2 = (iIntValue & i5) != 0;
