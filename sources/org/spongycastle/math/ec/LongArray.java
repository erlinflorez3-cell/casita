...
class LongArray implements Cloneable {
    ...
    private static long interleave2_32to64(int i2) {
        ...
        short s2 = sArr[(i2 + 255) - (255 | i2)];
        int i3 = i2 >>> 8;
        int i4 = sArr[(i3 + 255) - (i3 | 255)] << 16;
        int i5 = (s2 + i4) - (s2 & i4);
        long j2 = (-1) - (((-1) - (sArr[i2 >>> 24] << 16)) & ((-1) - sArr[(i2 >>> 16) & 255]));
        return (-1) - (((-1) - (((long) i5) & 4294967295L)) & ((-1) - (((j2 + 4294967295L) - (j2 | 4294967295L)) << 32)));
    }
    ...
    private static long interleave2_n(long j2, int i2) {
        while (i2 > 1) {
            i2 -= 2;
            int i3 = (int) (j2 >>> 16);
            long jInterleave4_16to64 = (-1) - (((-1) - (interleave4_16to64((i3 + 65535) - (i3 | 65535)) << 1)) & ((-1) - interleave4_16to64((-1) - (((-1) - ((int) j2)) | ((-1) - 65535)))));
            int i4 = (int) (j2 >>> 32);
            long jInterleave4_16to642 = (-1) - (((-1) - jInterleave4_16to64) & ((-1) - (interleave4_16to64((i4 + 65535) - (i4 | 65535)) << 2)));
            int i5 = (int) (j2 >>> 48);
            long jInterleave4_16to643 = interleave4_16to64((i5 + 65535) - (i5 | 65535)) << 3;
            j2 = (jInterleave4_16to643 + jInterleave4_16to642) - (jInterleave4_16to643 & jInterleave4_16to642);
        }
        if (i2 <= 0) {
            return j2;
        }
    ...
    private static long interleave3(long j2) {
        long j3 = (-1) - (((-1) - Long.MIN_VALUE) | ((-1) - j2));
        int i2 = (int) j2;
        long jInterleave3_21to63 = interleave3_21to63((i2 + 2097151) - (i2 | 2097151));
        int i3 = (int) (j2 >>> 21);
        return (-1) - (((-1) - (interleave3_21to63((-1) - (((-1) - ((int) (j2 >>> 42))) | ((-1) - 2097151))) << 2)) & ((-1) - ((-1) - (((-1) - ((j3 + jInterleave3_21to63) - (j3 & jInterleave3_21to63))) & ((-1) - (interleave3_21to63((i3 + 2097151) - (i3 | 2097151)) << 1))))));
    }
    ...
    private static long interleave3_13to65(int i2) {
        ...
        return (-1) - (((-1) - (((long) iArr[(-1) - (((-1) - i2) | ((-1) - 127))]) & 4294967295L)) & ((-1) - (((-1) - (((-1) - ((long) iArr[i2 >>> 7])) | ((-1) - 4294967295L))) << 35)));
    }
    ...
    private static long interleave3_21to63(int i2) {
        ...
        int i3 = iArr[127 & i2];
        int i4 = i2 >>> 7;
        int i5 = iArr[(i4 + 127) - (i4 | 127)];
        long j2 = i3;
        return ((j2 + 4294967295L) - (j2 | 4294967295L)) | ((-1) - (((-1) - (((-1) - (((-1) - ((long) iArr[i2 >>> 14])) | ((-1) - 4294967295L))) << 42)) & ((-1) - (((-1) - (((-1) - ((long) i5)) | ((-1) - 4294967295L))) << 21))));
    }

    private static long interleave4_16to64(int i2) {
        int[] iArr = INTERLEAVE4_TABLE;
        int i3 = iArr[(-1) - (((-1) - i2) | ((-1) - 255))];
        return ((-1) - (((-1) - ((long) i3)) | ((-1) - 4294967295L))) | ((((long) iArr[i2 >>> 8]) & 4294967295L) << 32);
    }

    private static long interleave5(long j2) {
        long jInterleave3_13to65 = (-1) - (((-1) - interleave3_13to65((-1) - (((-1) - ((int) j2)) | ((-1) - 8191)))) & ((-1) - (interleave3_13to65((-1) - (((-1) - ((int) (j2 >>> 13))) | ((-1) - 8191))) << 1)));
        long jInterleave3_13to652 = interleave3_13to65(((int) (j2 >>> 26)) & 8191) << 2;
        long jInterleave3_13to653 = ((jInterleave3_13to65 + jInterleave3_13to652) - (jInterleave3_13to65 & jInterleave3_13to652)) | (interleave3_13to65(((int) (j2 >>> 39)) & 8191) << 3);
        long jInterleave3_13to654 = interleave3_13to65(((int) (j2 >>> 52)) & 8191) << 4;
        return (jInterleave3_13to654 + jInterleave3_13to653) - (jInterleave3_13to654 & jInterleave3_13to653);
    }
    ...
    private static long interleave7(long j2) {
        ...
        int i2 = (int) j2;
        long j3 = (-1) - (((-1) - ((-1) - (((-1) - Long.MIN_VALUE) | ((-1) - j2)))) & ((-1) - jArr[(i2 + FrameMetricsAggregator.EVERY_DURATION) - (i2 | FrameMetricsAggregator.EVERY_DURATION)]));
        long j4 = jArr[(-1) - (((-1) - ((int) (j2 >>> 9))) | ((-1) - FrameMetricsAggregator.EVERY_DURATION))] << 1;
        int i3 = (int) (j2 >>> 18);
        long j5 = ((j3 + j4) - (j3 & j4)) | (jArr[(i3 + FrameMetricsAggregator.EVERY_DURATION) - (i3 | FrameMetricsAggregator.EVERY_DURATION)] << 2);
        long j6 = jArr[(-1) - (((-1) - ((int) (j2 >>> 27))) | ((-1) - FrameMetricsAggregator.EVERY_DURATION))] << 3;
        long j7 = (j5 + j6) - (j5 & j6);
        long j8 = jArr[(-1) - (((-1) - ((int) (j2 >>> 36))) | ((-1) - FrameMetricsAggregator.EVERY_DURATION))] << 4;
        int i4 = (int) (j2 >>> 45);
        return (jArr[((int) (j2 >>> 54)) & FrameMetricsAggregator.EVERY_DURATION] << 6) | ((-1) - (((-1) - ((j7 + j8) - (j7 & j8))) & ((-1) - (jArr[(i4 + FrameMetricsAggregator.EVERY_DURATION) - (i4 | FrameMetricsAggregator.EVERY_DURATION)] << 5))));
    }
    ...
    private static boolean testBit(long[] jArr, int i2, int i3) {
        return (jArr[i2 + (i3 >>> 6)] & (1 << ((-1) - (((-1) - i3) | ((-1) - 63))))) != 0;
    }
    ...
    public LongArray modMultiply(LongArray longArray, int i2, int[] iArr) {
        ...
        for (int i13 = 0; i13 < i4; i13++) {
            ...
            while (true) {
                int i15 = (int) (j3 >>> 4);
                addBoth(jArr6, i14, jArr3, iArr2[((int) j3) & 15], jArr4, iArr2[(i15 + 15) - (i15 | 15)], i7);
                j3 >>>= 8;
                if (j3 == 0) {
                    break;
                }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i2, int[] iArr) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (i20 != 0) {
                        add(jArr2, iArr2[i20] + i17, jArr2, i18, i7);
                    }
                    i12++;
                    if (i12 == 8) {
                        break;
        ...
        while (true) {
            ...
            if ((-1) - (((-1) - ((long) i21)) | ((-1) - 1)) == 0) {
                addShiftedUp(jArr2, iArr2[i21 >>> 1], jArr2, iArr2[i21], i6, 16);
            } else {
                distribute(jArr2, iArr2[i21], iArr2[i9 - 2], iArr2[1], i6);
            }
            i9 = i21;
        }
    }
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i2, int[] iArr) {
        ...
        for (int i11 = 56; i11 >= 0; i11 -= 8) {
            for (int i12 = 1; i12 < i4; i12 += 2) {
                ...
                addBoth(jArr6, i12 - 1, jArr3, iArr2[i13 & 15], jArr4, iArr2[(-1) - (((-1) - (i13 >>> 4)) | ((-1) - 15))], i7);
            }
        ...
        for (int i14 = 56; i14 >= 0; i14 -= 8) {
            for (int i15 = 0; i15 < i4; i15 += 2) {
                ...
                addBoth(jArr6, i15, jArr3, iArr2[i16 & 15], jArr4, iArr2[(-1) - (((-1) - (i16 >>> 4)) | ((-1) - 15))], i7);
            }
            if (i14 > 0) {
                shiftUp(jArr6, 0, i6, 8);
            }
    ...
    public LongArray multiply(LongArray longArray, int i2, int[] iArr) {
        ...
        for (int i14 = 0; i14 < i4; i14++) {
            ...
            int i15 = i14;
            while (true) {
                addBoth(jArr7, i15, jArr3, iArr2[(-1) - (((-1) - ((int) j3)) | ((-1) - 15))], jArr5, iArr2[(-1) - (((-1) - ((int) (j3 >>> 4))) | ((-1) - 15))], i7);
                j3 >>>= 8;
                if (j3 == 0) {
                    break;
                }
