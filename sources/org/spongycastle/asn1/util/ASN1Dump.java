...
public class ASN1Dump {
    ...
    static void _dumpAsString(String str, boolean z2, ASN1Primitive aSN1Primitive, StringBuffer stringBuffer) {
        ...
        if (aSN1Primitive instanceof BERApplicationSpecific) {
            stringBuffer.append(outputApplicationSpecific("BER", str, z2, aSN1Primitive, strLineSeparator));
            return;
        }
        if (aSN1Primitive instanceof DERApplicationSpecific) {
            stringBuffer.append(outputApplicationSpecific("DER", str, z2, aSN1Primitive, strLineSeparator));
            return;
        }
