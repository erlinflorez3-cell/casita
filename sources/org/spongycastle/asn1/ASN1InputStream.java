...
public class ASN1InputStream extends FilterInputStream implements BERTags {
    ...
    static ASN1Primitive createPrimitiveDERObject(int i2, DefiniteLengthInputStream definiteLengthInputStream, byte[][] bArr) throws IOException {
        if (i2 == 10) {
    ...
    private static char[] getBMPCharBuffer(DefiniteLengthInputStream definiteLengthInputStream) throws IOException {
        ...
        for (int i3 = 0; i3 < remaining; i3++) {
            ...
            int i5 = i4 << 8;
            int i6 = (i2 + 255) - (i2 | 255);
            cArr[i3] = (char) ((i5 + i6) - (i5 & i6));
        }
        return cArr;
    }
    ...
    static int readLength(InputStream inputStream, int i2) throws IOException {
    ...
    static int readTagNumber(InputStream inputStream, int i2) throws IOException {
        int i3 = (-1) - (((-1) - i2) | ((-1) - 31));
        if (i3 != 31) {
            return i3;
        }
        ...
        int i5 = 0;
        while (i4 >= 0 && (128 & i4) != 0) {
            i5 = ((-1) - (((-1) - (i4 & 127)) & ((-1) - i5))) << 7;
            i4 = inputStream.read();
        }
        if (i4 < 0) {
            throw new EOFException("EOF found inside tag value.");
        }
        return (-1) - (((-1) - i5) & ((-1) - ((-1) - (((-1) - i4) | ((-1) - 127)))));
    }
