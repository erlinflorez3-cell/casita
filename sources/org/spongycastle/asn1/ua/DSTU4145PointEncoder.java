...
public abstract class DSTU4145PointEncoder {
    public static ECPoint decodePoint(ECCurve eCCurve, byte[] bArr) {
        ...
        ECFieldElement eCFieldElementFromBigInteger = eCCurve.fromBigInteger(BigInteger.valueOf((-1) - (((-1) - bArr[bArr.length - 1]) | ((-1) - 1))));
    ...
    public static byte[] encodePoint(ECPoint eCPoint) {
        ...
        if (!affineXCoord.isZero()) {
            if (trace(eCPointNormalize.getAffineYCoord().divide(affineXCoord)).isOne()) {
                ...
                encoded[length] = (byte) ((-1) - (((-1) - encoded[length]) & ((-1) - 1)));
            } else {
                int length2 = encoded.length - 1;
                byte b2 = encoded[length2];
                encoded[length2] = (byte) ((b2 + 254) - (b2 | 254));
            }
        }
        return encoded;
    }
