...
public class GeneralName extends ASN1Object implements ASN1Choice {
    ...
    private int[] parseIPv6(String str) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if (strNextToken.equals(Global.COLON)) {
                iArr[i3] = 0;
                i2 = i3;
                i3++;
                ...
                int i5 = i3 + 1;
                iArr[i3] = (-1) - (((-1) - (Integer.parseInt(stringTokenizer2.nextToken()) << 8)) & ((-1) - Integer.parseInt(stringTokenizer2.nextToken())));
                i3 += 2;
                iArr[i5] = (-1) - (((-1) - Integer.parseInt(stringTokenizer2.nextToken())) & ((-1) - (Integer.parseInt(stringTokenizer2.nextToken()) << 8)));
            }
        }
        if (i3 != 8) {
            int i6 = i3 - i2;
    ...
    */
    public java.lang.String toString() {
        /*
            ...
            r0 = 6
            if (r1 == r0) goto L39
            org.spongycastle.asn1.ASN1Encodable r0 = r3.obj
        ...
        L39:
            org.spongycastle.asn1.ASN1Encodable r0 = r3.obj
            org.spongycastle.asn1.DERIA5String r0 = org.spongycastle.asn1.DERIA5String.getInstance(r0)
