...
public class TBSCertList extends ASN1Object {
    ...
    private class EmptyEnumeration implements Enumeration {
        ...
        /* synthetic */ EmptyEnumeration(TBSCertList tBSCertList, AnonymousClass1 anonymousClass1) {
            this();
        }
    ...
    public TBSCertList(ASN1Sequence aSN1Sequence) {
        ...
        if (i3 < aSN1Sequence.size() && !(aSN1Sequence.getObjectAt(i3) instanceof DERTaggedObject)) {
