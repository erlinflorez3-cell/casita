...
public abstract class AbstractSubscriberInfo implements SubscriberInfo {
    ...
    protected AbstractSubscriberInfo(Class cls, Class<? extends SubscriberInfo> cls2, boolean z2) {
    ...
    protected SubscriberMethod createSubscriberMethod(String str, Class<?> cls, ThreadMode threadMode, int i2, boolean z2) {
        try {
