...
class SubscriberMethodFinder {
    ...
    SubscriberMethodFinder(List<SubscriberInfoIndex> list, boolean z2, boolean z3) {
    ...
    private void findUsingReflectionInSingleClass(FindState findState) {
        ...
        for (Method method : methods) {
            ...
            if ((modifiers + 1) - (1 | modifiers) != 0 && (modifiers & MODIFIERS_IGNORE) == 0) {
                Class<?>[] parameterTypes = method.getParameterTypes();
                if (parameterTypes.length == 1) {
                    Subscribe subscribe = (Subscribe) Kl.zd(method, Subscribe.class);
                    if (subscribe != null) {
