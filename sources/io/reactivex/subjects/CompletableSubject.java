    ...
    void remove(CompletableDisposable completableDisposable) {
        ...
        do {
            ...
            if (length == 1) {
                ...
                completableDisposableArr2 = new CompletableDisposable[length - 1];
                System.arraycopy(completableDisposableArr, 0, completableDisposableArr2, 0, i2);
                System.arraycopy(completableDisposableArr, i2 + 1, completableDisposableArr2, i2, (length - i2) - 1);
            }
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(this.observers, completableDisposableArr, completableDisposableArr2));
    }
