    ...
    void remove(PublishSubscription<T> publishSubscription) {
        ...
        do {
            ...
            if (length == 1) {
                ...
                publishSubscriptionArr2 = new PublishSubscription[length - 1];
                System.arraycopy(publishSubscriptionArr, 0, publishSubscriptionArr2, 0, i2);
                System.arraycopy(publishSubscriptionArr, i2 + 1, publishSubscriptionArr2, i2, (length - i2) - 1);
            }
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(this.subscribers, publishSubscriptionArr, publishSubscriptionArr2));
    }
