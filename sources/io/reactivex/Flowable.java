...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    public static <T, R> Flowable<R> combineLatestDelayError(Function<? super Object[], ? extends R> function, int i2, Publisher<? extends T>... publisherArr) {
        return combineLatestDelayError(publisherArr, function, i2);
    }
    ...
    public static <T, R> Flowable<R> combineLatestDelayError(Publisher<? extends T>[] publisherArr, Function<? super Object[], ? extends R> function, int i2) {
        ...
        ObjectHelper.requireNonNull(function, "combiner is null");
        ObjectHelper.verifyPositive(i2, "bufferSize");
        return publisherArr.length == 0 ? empty() : RxJavaPlugins.onAssembly(new FlowableCombineLatest((Publisher[]) publisherArr, (Function) function, i2, true));
    }
    ...
    public static <T> Flowable<T> concat(Publisher<? extends Publisher<? extends T>> publisher, int i2) {
        return fromPublisher(publisher).concatMap(Functions.identity(), i2);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> concatArrayEagerDelayError(int i2, int i3, Publisher<? extends T>... publisherArr) {
        return fromArray(publisherArr).concatMapEagerDelayError(Functions.identity(), i2, i3, true);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> concatDelayError(Publisher<? extends Publisher<? extends T>> publisher, int i2, boolean z2) {
        return fromPublisher(publisher).concatMapDelayError(Functions.identity(), i2, z2);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t2, T t3) {
        ObjectHelper.requireNonNull(t2, "item1 is null");
        ObjectHelper.requireNonNull(t3, "item2 is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t2, T t3, T t4) {
        ObjectHelper.requireNonNull(t2, "item1 is null");
        ObjectHelper.requireNonNull(t3, "item2 is null");
        ObjectHelper.requireNonNull(t4, "item3 is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t2, T t3, T t4, T t5) {
        ObjectHelper.requireNonNull(t2, "item1 is null");
        ObjectHelper.requireNonNull(t3, "item2 is null");
        ObjectHelper.requireNonNull(t4, "item3 is null");
        ObjectHelper.requireNonNull(t5, "item4 is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t2, T t3, T t4, T t5, T t6) {
        ObjectHelper.requireNonNull(t2, "item1 is null");
        ObjectHelper.requireNonNull(t3, "item2 is null");
        ObjectHelper.requireNonNull(t4, "item3 is null");
        ObjectHelper.requireNonNull(t5, "item4 is null");
        ObjectHelper.requireNonNull(t6, "item5 is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t2, T t3, T t4, T t5, T t6, T t7) {
        ObjectHelper.requireNonNull(t2, "item1 is null");
        ObjectHelper.requireNonNull(t3, "item2 is null");
        ObjectHelper.requireNonNull(t4, "item3 is null");
        ObjectHelper.requireNonNull(t5, "item4 is null");
        ObjectHelper.requireNonNull(t6, "item5 is null");
        ObjectHelper.requireNonNull(t7, "item6 is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t2, T t3, T t4, T t5, T t6, T t7, T t8) {
        ObjectHelper.requireNonNull(t2, "item1 is null");
        ObjectHelper.requireNonNull(t3, "item2 is null");
        ObjectHelper.requireNonNull(t4, "item3 is null");
        ObjectHelper.requireNonNull(t5, "item4 is null");
        ObjectHelper.requireNonNull(t6, "item5 is null");
        ObjectHelper.requireNonNull(t7, "item6 is null");
        ObjectHelper.requireNonNull(t8, "item7 is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t2, T t3, T t4, T t5, T t6, T t7, T t8, T t9) {
        ObjectHelper.requireNonNull(t2, "item1 is null");
        ObjectHelper.requireNonNull(t3, "item2 is null");
        ObjectHelper.requireNonNull(t4, "item3 is null");
        ObjectHelper.requireNonNull(t5, "item4 is null");
        ...
        ObjectHelper.requireNonNull(t7, "item6 is null");
        ObjectHelper.requireNonNull(t8, "item7 is null");
        ObjectHelper.requireNonNull(t9, "item8 is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t2, T t3, T t4, T t5, T t6, T t7, T t8, T t9, T t10) {
        ObjectHelper.requireNonNull(t2, "item1 is null");
        ObjectHelper.requireNonNull(t3, "item2 is null");
        ObjectHelper.requireNonNull(t4, "item3 is null");
        ObjectHelper.requireNonNull(t5, "item4 is null");
        ...
        ObjectHelper.requireNonNull(t8, "item7 is null");
        ObjectHelper.requireNonNull(t9, "item8 is null");
        ObjectHelper.requireNonNull(t10, "item9 is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t2, T t3, T t4, T t5, T t6, T t7, T t8, T t9, T t10, T t11) {
        ObjectHelper.requireNonNull(t2, "item1 is null");
        ObjectHelper.requireNonNull(t3, "item2 is null");
        ObjectHelper.requireNonNull(t4, "item3 is null");
        ObjectHelper.requireNonNull(t5, "item4 is null");
        ...
        ObjectHelper.requireNonNull(t9, "item8 is null");
        ObjectHelper.requireNonNull(t10, "item9 is null");
        ObjectHelper.requireNonNull(t11, "item10 is null");
    ...
    public static <T> Flowable<T> merge(Publisher<? extends Publisher<? extends T>> publisher, int i2) {
        return fromPublisher(publisher).flatMap(Functions.identity(), i2);
    }
    ...
    public static <T> Flowable<T> mergeArray(int i2, int i3, Publisher<? extends T>... publisherArr) {
        return fromArray(publisherArr).flatMap(Functions.identity(), false, i2, i3);
    }
    ...
    public static <T> Flowable<T> mergeArrayDelayError(int i2, int i3, Publisher<? extends T>... publisherArr) {
        return fromArray(publisherArr).flatMap(Functions.identity(), true, i2, i3);
    }
    ...
    public static <T> Flowable<T> mergeDelayError(Publisher<? extends Publisher<? extends T>> publisher, int i2) {
        return fromPublisher(publisher).flatMap(Functions.identity(), true, i2);
    }
    ...
    public static <T> Single<Boolean> sequenceEqual(Publisher<? extends T> publisher, Publisher<? extends T> publisher2, int i2) {
        return sequenceEqual(publisher, publisher2, ObjectHelper.equalsPredicate(), i2);
    }
    ...
    public static <T> Flowable<T> switchOnNext(Publisher<? extends Publisher<? extends T>> publisher, int i2) {
        return fromPublisher(publisher).switchMap(Functions.identity(), i2);
    }
    ...
    public static <T> Flowable<T> switchOnNextDelayError(Publisher<? extends Publisher<? extends T>> publisher, int i2) {
        return fromPublisher(publisher).switchMapDelayError(Functions.identity(), i2);
    }
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    public static <T, D> Flowable<T> using(Callable<? extends D> callable, Function<? super D, ? extends Publisher<? extends T>> function, Consumer<? super D> consumer, boolean z2) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableUsing(callable, function, consumer, z2));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T1, T2, R> Flowable<R> zip(Publisher<? extends T1> publisher, Publisher<? extends T2> publisher2, BiFunction<? super T1, ? super T2, ? extends R> biFunction, boolean z2) {
        ObjectHelper.requireNonNull(publisher, "source1 is null");
        ObjectHelper.requireNonNull(publisher2, "source2 is null");
        return zipArray(Functions.toFunction(biFunction), z2, bufferSize(), publisher, publisher2);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T1, T2, R> Flowable<R> zip(Publisher<? extends T1> publisher, Publisher<? extends T2> publisher2, BiFunction<? super T1, ? super T2, ? extends R> biFunction, boolean z2, int i2) {
        ObjectHelper.requireNonNull(publisher, "source1 is null");
        ObjectHelper.requireNonNull(publisher2, "source2 is null");
        return zipArray(Functions.toFunction(biFunction), z2, i2, publisher, publisher2);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T, R> Flowable<R> zipArray(Function<? super Object[], ? extends R> function, boolean z2, int i2, Publisher<? extends T>... publisherArr) {
        if (publisherArr.length == 0) {
            return empty();
        }
        ObjectHelper.requireNonNull(function, "zipper is null");
        ObjectHelper.verifyPositive(i2, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableZip(publisherArr, null, function, i2, z2));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T, R> Flowable<R> zipIterable(Iterable<? extends Publisher<? extends T>> iterable, Function<? super Object[], ? extends R> function, boolean z2, int i2) {
        ObjectHelper.requireNonNull(function, "zipper is null");
        ObjectHelper.requireNonNull(iterable, "sources is null");
        ObjectHelper.verifyPositive(i2, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableZip(null, iterable, function, i2, z2));
    }
    ...
    public final T blockingFirst(T t2) {
        ...
        subscribe((FlowableSubscriber) blockingFirstSubscriber);
        T tBlockingGet = blockingFirstSubscriber.blockingGet();
        return tBlockingGet != null ? tBlockingGet : t2;
    }
    ...
    @SchedulerSupport("9;;3")
    @BackpressureSupport(BackpressureKind.FULL)
    public final void blockingSubscribe(Consumer<? super T> consumer, int i2) {
        FlowableBlockingSubscribe.subscribe(this, consumer, Functions.ON_ERROR_MISSING, Functions.EMPTY_ACTION, i2);
    }
    ...
    @SchedulerSupport("9;;3")
    @BackpressureSupport(BackpressureKind.FULL)
    public final void blockingSubscribe(Consumer<? super T> consumer, Consumer<? super Throwable> consumer2, int i2) {
        FlowableBlockingSubscribe.subscribe(this, consumer, consumer2, Functions.EMPTY_ACTION, i2);
    }
    ...
    @SchedulerSupport("9;;3")
    @BackpressureSupport(BackpressureKind.FULL)
    public final void blockingSubscribe(Consumer<? super T> consumer, Consumer<? super Throwable> consumer2, Action action, int i2) {
        FlowableBlockingSubscribe.subscribe(this, consumer, consumer2, action, i2);
    }
    ...
    public final Flowable<List<T>> buffer(int i2, int i3) {
        return (Flowable<List<T>>) buffer(i2, i3, ArrayListSupplier.asCallable());
    }
    ...
    public final <U extends Collection<? super T>> Flowable<U> buffer(int i2, int i3, Callable<U> callable) {
        ObjectHelper.verifyPositive(i2, MetricSummary.JsonKeys.COUNT);
    ...
    public final Flowable<List<T>> buffer(long j2, long j3, TimeUnit timeUnit) {
        return (Flowable<List<T>>) buffer(j2, j3, timeUnit, Schedulers.computation(), ArrayListSupplier.asCallable());
    }
    ...
    public final Flowable<List<T>> buffer(long j2, long j3, TimeUnit timeUnit, Scheduler scheduler) {
        return (Flowable<List<T>>) buffer(j2, j3, timeUnit, scheduler, ArrayListSupplier.asCallable());
    }
    ...
    public final Flowable<List<T>> buffer(long j2, TimeUnit timeUnit, Scheduler scheduler) {
        return (Flowable<List<T>>) buffer(j2, timeUnit, scheduler, Integer.MAX_VALUE, ArrayListSupplier.asCallable(), false);
    }
    ...
    public final Flowable<List<T>> buffer(long j2, TimeUnit timeUnit, Scheduler scheduler, int i2) {
        return (Flowable<List<T>>) buffer(j2, timeUnit, scheduler, i2, ArrayListSupplier.asCallable(), false);
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final <U extends Collection<? super T>> Flowable<U> buffer(long j2, TimeUnit timeUnit, Scheduler scheduler, int i2, Callable<U> callable, boolean z2) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(callable, "bufferSupplier is null");
        ObjectHelper.verifyPositive(i2, MetricSummary.JsonKeys.COUNT);
        return RxJavaPlugins.onAssembly(new FlowableBufferTimed(this, j2, j2, timeUnit, scheduler, callable, i2, z2));
    }
    ...
    public final Completable concatMapCompletableDelayError(Function<? super T, ? extends CompletableSource> function, boolean z2, int i2) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i2, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapCompletable(this, function, z2 ? ErrorMode.END : ErrorMode.BOUNDARY, i2));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapDelayError(Function<? super T, ? extends Publisher<? extends R>> function, int i2, boolean z2) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i2, "prefetch");
        if (!(this instanceof ScalarCallable)) {
            return RxJavaPlugins.onAssembly(new FlowableConcatMap(this, function, i2, z2 ? ErrorMode.END : ErrorMode.BOUNDARY));
        }
        Object objCall = ((ScalarCallable) this).call();
        return objCall == null ? empty() : FlowableScalarXMap.scalarXMap(objCall, function);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapEagerDelayError(Function<? super T, ? extends Publisher<? extends R>> function, int i2, int i3, boolean z2) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i2, "maxConcurrency");
        ObjectHelper.verifyPositive(i3, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapEager(this, function, i2, i3, z2 ? ErrorMode.END : ErrorMode.BOUNDARY));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapEagerDelayError(Function<? super T, ? extends Publisher<? extends R>> function, boolean z2) {
        return concatMapEagerDelayError(function, bufferSize(), bufferSize(), z2);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapMaybeDelayError(Function<? super T, ? extends MaybeSource<? extends R>> function, boolean z2) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapMaybeDelayError(Function<? super T, ? extends MaybeSource<? extends R>> function, boolean z2, int i2) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i2, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapMaybe(this, function, z2 ? ErrorMode.END : ErrorMode.BOUNDARY, i2));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapSingleDelayError(Function<? super T, ? extends SingleSource<? extends R>> function, boolean z2) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapSingleDelayError(Function<? super T, ? extends SingleSource<? extends R>> function, boolean z2, int i2) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i2, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapSingle(this, function, z2 ? ErrorMode.END : ErrorMode.BOUNDARY, i2));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> delay(long j2, TimeUnit timeUnit, Scheduler scheduler, boolean z2) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableDelay(this, Math.max(0L, j2), timeUnit, scheduler, z2));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> delay(long j2, TimeUnit timeUnit, boolean z2) {
    ...
    public final Single<T> elementAt(long j2, T t2) {
        ...
        ObjectHelper.requireNonNull(t2, "defaultItem is null");
        return RxJavaPlugins.onAssembly(new FlowableElementAtSingle(this, j2, t2));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z2) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z2, int i2) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z2, int i2, int i3) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.requireNonNull(biFunction, "combiner is null");
        ObjectHelper.verifyPositive(i2, "maxConcurrency");
        ObjectHelper.verifyPositive(i3, "bufferSize");
        return flatMap(FlowableInternalHelper.flatMapWithCombiner(function, biFunction), z2, i2, i3);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends R>> function, boolean z2) {
        return flatMap(function, z2, bufferSize(), bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends R>> function, boolean z2, int i2) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends R>> function, boolean z2, int i2, int i3) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i2, "maxConcurrency");
        ObjectHelper.verifyPositive(i3, "bufferSize");
        if (!(this instanceof ScalarCallable)) {
            return RxJavaPlugins.onAssembly(new FlowableFlatMap(this, function, z2, i2, i3));
        }
        Object objCall = ((ScalarCallable) this).call();
        return objCall == null ? empty() : FlowableScalarXMap.scalarXMap(objCall, function);
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Completable flatMapCompletable(Function<? super T, ? extends CompletableSource> function, boolean z2, int i2) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i2, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapCompletableCompletable(this, function, z2, i2));
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final <R> Flowable<R> flatMapMaybe(Function<? super T, ? extends MaybeSource<? extends R>> function, boolean z2, int i2) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i2, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapMaybe(this, function, z2, i2));
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final <R> Flowable<R> flatMapSingle(Function<? super T, ? extends SingleSource<? extends R>> function, boolean z2, int i2) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i2, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapSingle(this, function, z2, i2));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <K, V> Flowable<GroupedFlowable<K, V>> groupBy(Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2, boolean z2) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <K, V> Flowable<GroupedFlowable<K, V>> groupBy(Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2, boolean z2, int i2) {
        ObjectHelper.requireNonNull(function, "keySelector is null");
        ObjectHelper.requireNonNull(function2, "valueSelector is null");
        ObjectHelper.verifyPositive(i2, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableGroupBy(this, function, function2, i2, z2, null));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <K, V> Flowable<GroupedFlowable<K, V>> groupBy(Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2, boolean z2, int i2, Function<? super Consumer<Object>, ? extends Map<K, Object>> function3) {
        ObjectHelper.requireNonNull(function, "keySelector is null");
        ObjectHelper.requireNonNull(function2, "valueSelector is null");
        ObjectHelper.verifyPositive(i2, "bufferSize");
        ObjectHelper.requireNonNull(function3, "evictingMapFactory is null");
        return RxJavaPlugins.onAssembly(new FlowableGroupBy(this, function, function2, i2, z2, function3));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <K> Flowable<GroupedFlowable<K, T>> groupBy(Function<? super T, ? extends K> function, boolean z2) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> observeOn(Scheduler scheduler, boolean z2) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> observeOn(Scheduler scheduler, boolean z2, int i2) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(i2, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableObserveOn(this, scheduler, z2, i2));
    }
    ...
    public final Flowable<T> onBackpressureBuffer(int i2, Action action) {
        return onBackpressureBuffer(i2, false, false, action);
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> onBackpressureBuffer(int i2, boolean z2) {
        return onBackpressureBuffer(i2, z2, false);
    }
    ...
    @BackpressureSupport(BackpressureKind.SPECIAL)
    @CheckReturnValue
    public final Flowable<T> onBackpressureBuffer(int i2, boolean z2, boolean z3) {
        ObjectHelper.verifyPositive(i2, "capacity");
        return RxJavaPlugins.onAssembly(new FlowableOnBackpressureBuffer(this, i2, z3, z2, Functions.EMPTY_ACTION));
    }
    ...
    @BackpressureSupport(BackpressureKind.SPECIAL)
    @CheckReturnValue
    public final Flowable<T> onBackpressureBuffer(int i2, boolean z2, boolean z3, Action action) {
        ObjectHelper.requireNonNull(action, "onOverflow is null");
        ObjectHelper.verifyPositive(i2, "capacity");
        return RxJavaPlugins.onAssembly(new FlowableOnBackpressureBuffer(this, i2, z3, z2, action));
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Flowable<T> onBackpressureBuffer(boolean z2) {
    ...
    public final Flowable<T> rebatchRequests(int i2) {
        return observeOn(ImmediateThinScheduler.INSTANCE, true, i2);
    }
    ...
    public final <R> Single<R> reduce(R r2, BiFunction<R, ? super T, R> biFunction) {
        ObjectHelper.requireNonNull(r2, "seed is null");
        ObjectHelper.requireNonNull(biFunction, "reducer is null");
        return RxJavaPlugins.onAssembly(new FlowableReduceSeedSingle(this, r2, biFunction));
    }
    ...
    public final Flowable<T> repeat(long j2) {
        if (j2 >= 0) {
            return j2 == 0 ? empty() : RxJavaPlugins.onAssembly(new FlowableRepeat(this, j2));
        }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> sample(long j2, TimeUnit timeUnit, Scheduler scheduler, boolean z2) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableSampleTimed(this, j2, timeUnit, scheduler, z2));
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> sample(long j2, TimeUnit timeUnit, boolean z2) {
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final <U> Flowable<T> sample(Publisher<U> publisher, boolean z2) {
        ObjectHelper.requireNonNull(publisher, "sampler is null");
        return RxJavaPlugins.onAssembly(new FlowableSamplePublisher(this, publisher, z2));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> scan(R r2, BiFunction<R, ? super T, R> biFunction) {
        ObjectHelper.requireNonNull(r2, "initialValue is null");
    ...
    public final Flowable<T> skip(long j2) {
        return j2 <= 0 ? RxJavaPlugins.onAssembly(this) : RxJavaPlugins.onAssembly(new FlowableSkip(this, j2));
    }
    ...
    public final Flowable<T> skipLast(int i2) {
        if (i2 >= 0) {
            return i2 == 0 ? RxJavaPlugins.onAssembly(this) : RxJavaPlugins.onAssembly(new FlowableSkipLast(this, i2));
        }
    ...
    public final Flowable<T> skipLast(long j2, TimeUnit timeUnit) {
        return skipLast(j2, timeUnit, Schedulers.computation(), false, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Flowable<T> skipLast(long j2, TimeUnit timeUnit, Scheduler scheduler, boolean z2) {
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Flowable<T> skipLast(long j2, TimeUnit timeUnit, Scheduler scheduler, boolean z2, int i2) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(i2, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableSkipLastTimed(this, j2, timeUnit, scheduler, i2 << 1, z2));
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Flowable<T> skipLast(long j2, TimeUnit timeUnit, boolean z2) {
        return skipLast(j2, timeUnit, Schedulers.computation(), z2, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    public final Flowable<T> subscribeOn(Scheduler scheduler, boolean z2) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableSubscribeOn(this, scheduler, z2));
    }
    ...
    public final <R> Flowable<R> switchMap(Function<? super T, ? extends Publisher<? extends R>> function, int i2) {
        return switchMap0(function, i2, false);
    }

    /* JADX WARN: Multi-variable type inference failed */
    <R> Flowable<R> switchMap0(Function<? super T, ? extends Publisher<? extends R>> function, int i2, boolean z2) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i2, "bufferSize");
        if (!(this instanceof ScalarCallable)) {
            return RxJavaPlugins.onAssembly(new FlowableSwitchMap(this, function, i2, z2));
        }
        Object objCall = ((ScalarCallable) this).call();
        return objCall == null ? empty() : FlowableScalarXMap.scalarXMap(objCall, function);
    }
    ...
    public final <R> Flowable<R> switchMapDelayError(Function<? super T, ? extends Publisher<? extends R>> function, int i2) {
        return switchMap0(function, i2, true);
    }
    ...
    public final Flowable<T> takeLast(int i2) {
        if (i2 >= 0) {
            return i2 == 0 ? RxJavaPlugins.onAssembly(new FlowableIgnoreElements(this)) : i2 == 1 ? RxJavaPlugins.onAssembly(new FlowableTakeLastOne(this)) : RxJavaPlugins.onAssembly(new FlowableTakeLast(this, i2));
        }
        throw new IndexOutOfBoundsException("count >= 0 required but it was " + i2);
    }
    ...
    public final Flowable<T> takeLast(long j2, long j3, TimeUnit timeUnit) {
        return takeLast(j2, j3, timeUnit, Schedulers.computation(), false, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> takeLast(long j2, long j3, TimeUnit timeUnit, Scheduler scheduler, boolean z2, int i2) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(i2, "bufferSize");
        if (j2 >= 0) {
            return RxJavaPlugins.onAssembly(new FlowableTakeLastTimed(this, j2, j3, timeUnit, scheduler, i2, z2));
        }
    ...
    public final Flowable<T> takeLast(long j2, TimeUnit timeUnit) {
        return takeLast(j2, timeUnit, Schedulers.computation(), false, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> takeLast(long j2, TimeUnit timeUnit, Scheduler scheduler, boolean z2) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> takeLast(long j2, TimeUnit timeUnit, Scheduler scheduler, boolean z2, int i2) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> takeLast(long j2, TimeUnit timeUnit, boolean z2) {
        return takeLast(j2, timeUnit, Schedulers.computation(), z2, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final TestSubscriber<T> test(long j2, boolean z2) {
        TestSubscriber<T> testSubscriber = new TestSubscriber<>(j2);
        if (z2) {
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> throttleLatest(long j2, TimeUnit timeUnit) {
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> throttleLatest(long j2, TimeUnit timeUnit, Scheduler scheduler) {
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> throttleLatest(long j2, TimeUnit timeUnit, Scheduler scheduler, boolean z2) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableThrottleLatest(this, j2, timeUnit, scheduler, z2));
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> throttleLatest(long j2, TimeUnit timeUnit, boolean z2) {
    ...
    public final Flowable<Flowable<T>> window(long j2, long j3, int i2) {
        ...
        ObjectHelper.verifyPositive(j2, MetricSummary.JsonKeys.COUNT);
        ObjectHelper.verifyPositive(i2, "bufferSize");
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<Flowable<T>> window(long j2, TimeUnit timeUnit, long j3, boolean z2) {
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<Flowable<T>> window(long j2, TimeUnit timeUnit, Scheduler scheduler, long j3, boolean z2) {
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<Flowable<T>> window(long j2, TimeUnit timeUnit, Scheduler scheduler, long j3, boolean z2, int i2) {
        ObjectHelper.verifyPositive(i2, "bufferSize");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.verifyPositive(j3, MetricSummary.JsonKeys.COUNT);
        return RxJavaPlugins.onAssembly(new FlowableWindowTimed(this, j2, j2, timeUnit, scheduler, j3, i2, z2));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, R> Flowable<R> zipWith(Publisher<? extends U> publisher, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z2) {
        return zip(this, publisher, biFunction, z2);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, R> Flowable<R> zipWith(Publisher<? extends U> publisher, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z2, int i2) {
        return zip(this, publisher, biFunction, z2, i2);
    }
}
