...
public final class RxJavaPlugins {
    static volatile Consumer<? super Throwable> errorHandler = null;
    static volatile boolean failNonBlockingScheduler = false;
    static volatile boolean lockdown = false;
    static volatile BooleanSupplier onBeforeBlocking = null;
    static volatile Function<? super Completable, ? extends Completable> onCompletableAssembly = null;
    static volatile BiFunction<? super Completable, ? super CompletableObserver, ? extends CompletableObserver> onCompletableSubscribe = null;
    static volatile Function<? super Scheduler, ? extends Scheduler> onComputationHandler = null;
    static volatile Function<? super ConnectableFlowable, ? extends ConnectableFlowable> onConnectableFlowableAssembly = null;
    static volatile Function<? super ConnectableObservable, ? extends ConnectableObservable> onConnectableObservableAssembly = null;
    static volatile Function<? super Flowable, ? extends Flowable> onFlowableAssembly = null;
    static volatile BiFunction<? super Flowable, ? super Subscriber, ? extends Subscriber> onFlowableSubscribe = null;
    static volatile Function<? super Callable<Scheduler>, ? extends Scheduler> onInitComputationHandler = null;
    static volatile Function<? super Callable<Scheduler>, ? extends Scheduler> onInitIoHandler = null;
    static volatile Function<? super Callable<Scheduler>, ? extends Scheduler> onInitNewThreadHandler = null;
    static volatile Function<? super Callable<Scheduler>, ? extends Scheduler> onInitSingleHandler = null;
    static volatile Function<? super Scheduler, ? extends Scheduler> onIoHandler = null;
    static volatile Function<? super Maybe, ? extends Maybe> onMaybeAssembly = null;
    static volatile BiFunction<? super Maybe, ? super MaybeObserver, ? extends MaybeObserver> onMaybeSubscribe = null;
    static volatile Function<? super Scheduler, ? extends Scheduler> onNewThreadHandler = null;
    static volatile Function<? super Observable, ? extends Observable> onObservableAssembly = null;
    static volatile BiFunction<? super Observable, ? super Observer, ? extends Observer> onObservableSubscribe = null;
    static volatile Function<? super ParallelFlowable, ? extends ParallelFlowable> onParallelAssembly = null;
    static volatile Function<? super Runnable, ? extends Runnable> onScheduleHandler = null;
    static volatile Function<? super Single, ? extends Single> onSingleAssembly = null;
    static volatile Function<? super Scheduler, ? extends Scheduler> onSingleHandler = null;
    static volatile BiFunction<? super Single, ? super SingleObserver, ? extends SingleObserver> onSingleSubscribe = null;

    private RxJavaPlugins() {
        throw new IllegalStateException("No instances!");
    }

    static <T, U, R> R apply(BiFunction<T, U, R> biFunction, T t2, U u2) {
        try {
    ...
    static <T, R> R apply(Function<T, R> function, T t2) {
        try {
