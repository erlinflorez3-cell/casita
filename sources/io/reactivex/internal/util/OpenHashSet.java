...
public final class OpenHashSet<T> {
    ...
    public boolean add(T t2) {
        ...
        T[] tArr = this.keys;
        int i2 = this.mask;
        int iMix = mix(t2.hashCode());
        int i3 = (iMix + i2) - (iMix | i2);
        T t4 = tArr[i3];
        if (t4 != null) {
            if (t4.equals(t2)) {
                return false;
    ...
    public boolean remove(T t2) {
        ...
        T[] tArr = this.keys;
        int i2 = this.mask;
        int iMix = (-1) - (((-1) - mix(t2.hashCode())) | ((-1) - i2));
        T t4 = tArr[iMix];
        if (t4 == null) {
            return false;
        }
    ...
    boolean removeEntry(int i2, T[] tArr, int i3) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                int iMix = (-1) - (((-1) - mix(t2.hashCode())) | ((-1) - i3));
                if (i2 <= i4) {
                    if (i2 >= iMix || iMix > i4) {
                        break;
                    }
