...
public final class ParallelFromPublisher<T> extends ParallelFlowable<T> {
    ...
    static final class ParallelDispatcher<T> extends AtomicInteger implements FlowableSubscriber<T> {
        ...
        final class RailSubscription implements Subscription {
            ...
            public void cancel() {
                if (ParallelDispatcher.this.requests.compareAndSet(this.f19770j + this.f19771m, 0L, 1L)) {
            ...
            public void request(long j2) {
                ...
                if (SubscriptionHelper.validate(j2)) {
                    ...
                    do {
                        j3 = atomicLongArray.get(this.f19770j);
                        if (j3 == Long.MAX_VALUE) {
                            return;
                        }
                    } while (!atomicLongArray.compareAndSet(this.f19770j, j3, BackpressureHelper.addCap(j3, j2)));
                    if (ParallelDispatcher.this.subscriberCount.get() == this.f19771m) {
