...
public final class FlowableCombineLatest<T, R> extends Flowable<R> {
    ...
    public FlowableCombineLatest(Iterable<? extends Publisher<? extends T>> iterable, Function<? super Object[], ? extends R> function, int i2, boolean z2) {
        this.array = null;
    ...
    public FlowableCombineLatest(Publisher<? extends T>[] publisherArr, Function<? super Object[], ? extends R> function, int i2, boolean z2) {
