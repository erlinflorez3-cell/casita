...
public final class FlowableFlattenIterable<T, R> extends AbstractFlowableWithUpstream<T, R> {
    ...
    static final class FlattenIterableSubscriber<T, R> extends BasicIntQueueSubscription<R> implements FlowableSubscriber<T> {
        ...
        boolean checkTerminated(boolean z2, boolean z3, Subscriber<?> subscriber, SimpleQueue<?> simpleQueue) {
            if (this.cancelled) {
                this.current = null;
                simpleQueue.clear();
                return true;
        ...
        /* JADX WARN: Code restructure failed: missing block: B:46:0x0097, code lost:
            ...
            if (checkTerminated(r1, r0, r9, r8) == false) goto L53;
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:56:0x00b1, code lost:
            ...
            if (r14 == Long.MAX_VALUE) goto L58;
         */
        ...
        */
        ...
        public int requestFusion(int i2) {
            return ((i2 + 1) - (i2 | 1) == 0 || this.fusionMode != 1) ? 0 : 1;
        }
    }
