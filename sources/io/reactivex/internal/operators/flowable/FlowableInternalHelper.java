...
public final class FlowableInternalHelper {
    ...
    static final class BufferedReplayCallable<T> implements Callable<ConnectableFlowable<T>> {
        ...
        BufferedReplayCallable(Flowable<T> flowable, int i2) {
    ...
    static final class BufferedTimedReplay<T> implements Callable<ConnectableFlowable<T>> {
        ...
        BufferedTimedReplay(Flowable<T> flowable, int i2, long j2, TimeUnit timeUnit, Scheduler scheduler) {
            this.parent = flowable;
            this.bufferSize = i2;
            this.time = j2;
            this.unit = timeUnit;
    ...
    static final class FlatMapWithCombinerInner<U, R, T> implements Function<U, R> {
        ...
        public R apply(U u2) throws Exception {
            return this.combiner.apply(this.f19747t, u2);
        }
    }
    ...
    static final class TimedReplay<T> implements Callable<ConnectableFlowable<T>> {
        ...
        TimedReplay(Flowable<T> flowable, long j2, TimeUnit timeUnit, Scheduler scheduler) {
            this.parent = flowable;
            this.time = j2;
            this.unit = timeUnit;
            this.scheduler = scheduler;
