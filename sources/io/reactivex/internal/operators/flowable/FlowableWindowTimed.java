...
public final class FlowableWindowTimed<T> extends AbstractFlowableWithUpstream<T, Flowable<T>> {
    ...
    static final class WindowExactUnboundedSubscriber<T> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements FlowableSubscriber<T>, Subscription, Runnable {
         ...
         */
        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Type inference failed for: r5v0, types: [io.reactivex.processors.UnicastProcessor<T>] */
        /* JADX WARN: Type inference fix 'apply assigned field type' failed
        java.lang.UnsupportedOperationException: ArgType.getObject(), call class: class jadx.core.dex.instructions.args.ArgType$UnknownArg
        	at jadx.core.dex.instructions.args.ArgType.getObject(ArgType.java:593)
        	at jadx.core.dex.attributes.nodes.ClassTypeVarsAttr.getTypeVarsMapFor(ClassTypeVarsAttr.java:35)
        ...
        */
        void drainLoop() {
            /*
                r10 = this;
                io.reactivex.internal.fuseable.SimplePlainQueue<U> r6 = r10.queue
                org.reactivestreams.Subscriber<? super V> r3 = r10.downstream
                io.reactivex.processors.UnicastProcessor<T> r5 = r10.window
                r4 = 1
            L7:
                boolean r2 = r10.terminated
                boolean r0 = r10.done
                java.lang.Object r1 = r6.poll()
                r9 = 0
                if (r0 == 0) goto L2e
                if (r1 == 0) goto L18
                java.lang.Object r0 = io.reactivex.internal.operators.flowable.FlowableWindowTimed.WindowExactUnboundedSubscriber.NEXT
                if (r1 != r0) goto L2e
            L18:
                r10.window = r9
                r6.clear()
            ...
            L38:
                ...
                io.reactivex.processors.UnicastProcessor r5 = io.reactivex.processors.UnicastProcessor.create(r0)
                r10.window = r5
    ...
    static final class WindowSkipSubscriber<T> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements Subscription, Runnable {
        ...
        static final class SubjectWork<T> {
            ...
            final UnicastProcessor<T> f19754w;

            SubjectWork(UnicastProcessor<T> unicastProcessor, boolean z2) {
                this.f19754w = unicastProcessor;
                this.open = z2;
            }
        }
        ...
        void drainLoop() {
            ...
            while (!this.terminated) {
                ...
                if (z3) {
                    ...
                    if (!subjectWork.open) {
                        list.remove(subjectWork.f19754w);
                        subjectWork.f19754w.onComplete();
