        ...
        */
        void drain() {
            ...
            L60:
                ...
                goto L1b
            L63:
                io.reactivex.functions.Function<? super T, ? extends io.reactivex.MaybeSource<? extends R>> r0 = r10.mapper     // Catch: java.lang.Throwable -> L86
                ...
                io.reactivex.MaybeSource r1 = (io.reactivex.MaybeSource) r1     // Catch: java.lang.Throwable -> L86
                r10.state = r5
                io.reactivex.internal.operators.mixed.ObservableConcatMapMaybe$ConcatMapMaybeMainObserver$ConcatMapMaybeObserver<R> r0 = r10.inner
                r1.subscribe(r0)
                goto L1b
            L79:
                r0 = 2
