...
public final class ObservableGroupJoin<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AbstractObservableWithUpstream<TLeft, R> {
    ...
    static final class GroupJoinDisposable<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AtomicInteger implements Disposable, JoinSupport {
            ...
            while (!this.cancelled) {
                ...
                if (z3) {
                    ...
                    if (num == LEFT_VALUE) {
                        ...
                        this.leftIndex = i2 + 1;
                        this.lefts.put(Integer.valueOf(i2), (UnicastSubject<TRight>) unicastSubjectCreate);
                        try {
        ...
        public void innerClose(boolean z2, LeftRightEndObserver leftRightEndObserver) {
            synchronized (this) {
                this.queue.offer(z2 ? LEFT_CLOSE : RIGHT_CLOSE, leftRightEndObserver);
            }
            drain();
        }
    ...
    interface JoinSupport {
        void innerClose(boolean z2, LeftRightEndObserver leftRightEndObserver);
