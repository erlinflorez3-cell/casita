    ...
    static final class ConcatMapEagerMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable, InnerQueuedObserverSupport<R> {
        ...
        public void drain() {
            ...
            while (true) {
                ...
                InnerQueuedObserver<R> innerQueuedObserverPoll = this.current;
                if (innerQueuedObserverPoll == null) {
                    ...
                    innerQueuedObserverPoll = arrayDeque.poll();
                ...
                if (innerQueuedObserverPoll != null) {
                    SimpleQueue<R> simpleQueueQueue = innerQueuedObserverPoll.queue();
                    while (!this.cancelled) {
                        boolean zIsDone = innerQueuedObserverPoll.isDone();
                        if (errorMode == ErrorMode.IMMEDIATE && this.error.get() != null) {
                            simpleQueue.clear();
                            disposeAll();
                            observer.onError(this.error.terminate());
