...
public final class ObservableGroupBy<T, K, V> extends AbstractObservableWithUpstream<T, GroupedObservable<K, V>> {
    ...
    public static final class GroupByObserver<T, K, V> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void onNext(T t2) {
            try {
                ...
                try {
                    groupedUnicast2.onNext(ObjectHelper.requireNonNull(this.valueSelector.apply(t2), "The value supplied is null"));
                } catch (Throwable th) {
    ...
    static final class State<T, K> extends AtomicInteger implements Disposable, ObservableSource<T> {
        ...
        boolean checkTerminated(boolean z2, boolean z3, Observer<? super T> observer, boolean z4) {
            if (this.cancelled.get()) {
                this.queue.clear();
