...
public class ReactNativeFirebaseAppModule extends ReactNativeFirebaseModule {
    ...
    public static void configureAuthDomain(String str, String str2) {
        if (str2 == null) {
            ...
            String str3 = str + " custom authDomain " + str2;
    ...
    @ReactMethod
    public void eventsAddListener(String str) throws Throwable {
    ...
    @ReactMethod
    public void eventsNotifyReady(Boolean bool) throws Throwable {
        ReactNativeFirebaseEventEmitter.getSharedInstance().notifyJsReady(bool);
    }

    @ReactMethod
    public void eventsPing(String str, ReadableMap readableMap, Promise promise) throws Throwable {
    ...
    public void preferencesSetBool(String str, boolean z2, Promise promise) {
        ReactNativeFirebasePreferences.getSharedInstance().setBooleanValue(str, z2);
        promise.resolve(null);
    }
