...
public class ReactNativeFirebaseAnalyticsModule extends ReactNativeFirebaseModule {
    ...
    public void setSessionTimeoutDuration(double d2, final Promise promise) {
        this.module.setSessionTimeoutDuration((long) d2).addOnCompleteListener(new OnCompleteListener() { // from class: io.invertase.firebase.analytics.ReactNativeFirebaseAnalyticsModule$$ExternalSyntheticLambda9
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
