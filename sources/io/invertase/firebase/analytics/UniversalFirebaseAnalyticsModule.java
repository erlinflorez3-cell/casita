...
public class UniversalFirebaseAnalyticsModule extends UniversalFirebaseModule {
    ...
    public /* synthetic */ Void lambda$setConsent$8(Bundle bundle) throws Exception {
        boolean z2 = bundle.getBoolean("analytics_storage");
        boolean z3 = bundle.getBoolean("ad_storage");
        boolean z4 = bundle.getBoolean("ad_user_data");
        boolean z5 = bundle.getBoolean("ad_personalization");
        EnumMap enumMap = new EnumMap(FirebaseAnalytics.ConsentType.class);
        enumMap.put(FirebaseAnalytics.ConsentType.ANALYTICS_STORAGE, z2 ? FirebaseAnalytics.ConsentStatus.GRANTED : FirebaseAnalytics.ConsentStatus.DENIED);
        enumMap.put(FirebaseAnalytics.ConsentType.AD_STORAGE, z3 ? FirebaseAnalytics.ConsentStatus.GRANTED : FirebaseAnalytics.ConsentStatus.DENIED);
        enumMap.put(FirebaseAnalytics.ConsentType.AD_USER_DATA, z4 ? FirebaseAnalytics.ConsentStatus.GRANTED : FirebaseAnalytics.ConsentStatus.DENIED);
        enumMap.put(FirebaseAnalytics.ConsentType.AD_PERSONALIZATION, z5 ? FirebaseAnalytics.ConsentStatus.GRANTED : FirebaseAnalytics.ConsentStatus.DENIED);
    ...
    public /* synthetic */ Void lambda$setSessionTimeoutDuration$2(long j2) throws Exception {
    ...
    Task<Void> setSessionTimeoutDuration(final long j2) {
        return Tasks.call(new Callable() { // from class: io.invertase.firebase.analytics.UniversalFirebaseAnalyticsModule$$ExternalSyntheticLambda8
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.lambda$setSessionTimeoutDuration$2(j2);
            }
        });
    }
