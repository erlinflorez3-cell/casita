    ...
    public void getInitialNotification(Promise promise) {
        ...
        if (currentActivity != null && (intent = currentActivity.getIntent()) != null && intent.getExtras() != null) {
            ...
            if (string != null && this.initialNotificationMap.get(string) == null) {
                ...
                WritableMap writableMapPopRemoteMessageMapFromMessagingStore = remoteMessage == null ? popRemoteMessageMapFromMessagingStore(string) : ReactNativeFirebaseMessagingSerializer.remoteMessageToWritableMap(remoteMessage);
    ...
    public void onNewIntent(Intent intent) throws Throwable {
        ...
        if (string != null) {
            ...
            if (writableMapPopRemoteMessageMapFromMessagingStore != null) {
                ...
                ReactNativeFirebaseEventEmitter.getSharedInstance().sendEvent(ReactNativeFirebaseMessagingSerializer.remoteMessageMapToEvent(writableMapPopRemoteMessageMapFromMessagingStore, true));
            }
        }
    }
