...
abstract class DirectoryProcessor {
    ...
    private static final class SendCachedEnvelopeHint implements Cached, Retryable, SubmissionResult, Flushable, Enqueable {
        ...
        public SendCachedEnvelopeHint(long j2, ILogger iLogger, String str, Queue<String> queue) {
    ...
    DirectoryProcessor(IHub iHub, ILogger iLogger, long j2, int i2) {
        this.hub = iHub;
        this.logger = iLogger;
        this.flushTimeoutMillis = j2;
        this.processedEnvelopes = SynchronizedQueue.synchronizedQueue(new CircularFifoQueue(i2));
    }

    protected abstract boolean isRelevantFileName(String str);

    /* JADX INFO: renamed from: lambda$processDirectory$0$io-sentry-DirectoryProcessor, reason: not valid java name */
    /* synthetic */ boolean m8862lambda$processDirectory$0$iosentryDirectoryProcessor(File file, String str) {
        ...
        try {
            ...
            File[] fileArrListFiles2 = file.listFiles(new FilenameFilter() { // from class: io.sentry.DirectoryProcessor$$ExternalSyntheticLambda0
                ...
                public final boolean accept(File file2, String str) {
                    return this.f$0.m8862lambda$processDirectory$0$iosentryDirectoryProcessor(file2, str);
                }
            });
            this.logger.log(SentryLevel.DEBUG, "Processing %d items from cache dir %s", Integer.valueOf(fileArrListFiles2 != null ? fileArrListFiles2.length : 0), file.getAbsolutePath());
