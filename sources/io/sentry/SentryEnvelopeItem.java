...
public final class SentryEnvelopeItem {
    ...
    private static void ensureAttachmentSizeLimit(long j2, long j3, String str) throws SentryEnvelopeException {
        if (j2 > j3) {
    ...
    public static SentryEnvelopeItem fromAttachment(final ISerializer iSerializer, final ILogger iLogger, final Attachment attachment, final long j2) {
        final CachedItem cachedItem = new CachedItem(new Callable() { // from class: io.sentry.SentryEnvelopeItem$$ExternalSyntheticLambda20
            ...
            public final Object call() {
                return SentryEnvelopeItem.lambda$fromAttachment$15(attachment, j2, iSerializer, iLogger);
            }
        });
    ...
    public static SentryEnvelopeItem fromCheckIn(final ISerializer iSerializer, final CheckIn checkIn) {
        ...
        }, Constants.WUP_CONTENT_TYPE, null), (Callable<byte[]>) new Callable() { // from class: io.sentry.SentryEnvelopeItem$$ExternalSyntheticLambda18
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return cachedItem.getBytes();
            }
    ...
    public static SentryEnvelopeItem fromClientReport(final ISerializer iSerializer, final ClientReport clientReport) throws IOException {
        ...
        }, Constants.WUP_CONTENT_TYPE, null), (Callable<byte[]>) new Callable() { // from class: io.sentry.SentryEnvelopeItem$$ExternalSyntheticLambda15
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return cachedItem.getBytes();
            }
    ...
    public static SentryEnvelopeItem fromEvent(final ISerializer iSerializer, final SentryBaseEvent sentryBaseEvent) {
        ...
        }, Constants.WUP_CONTENT_TYPE, null), (Callable<byte[]>) new Callable() { // from class: io.sentry.SentryEnvelopeItem$$ExternalSyntheticLambda5
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return cachedItem.getBytes();
            }
    ...
    public static SentryEnvelopeItem fromProfilingTrace(final ProfilingTraceData profilingTraceData, final long j2, final ISerializer iSerializer) throws SentryEnvelopeException {
        ...
        final CachedItem cachedItem = new CachedItem(new Callable() { // from class: io.sentry.SentryEnvelopeItem$$ExternalSyntheticLambda23
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return SentryEnvelopeItem.lambda$fromProfilingTrace$18(traceFile, j2, profilingTraceData, iSerializer);
            }
        });
    ...
    public static SentryEnvelopeItem fromReplay(final ISerializer iSerializer, final ILogger iLogger, final SentryReplayEvent sentryReplayEvent, final ReplayRecording replayRecording, final boolean z2) {
        ...
        final CachedItem cachedItem = new CachedItem(new Callable() { // from class: io.sentry.SentryEnvelopeItem$$ExternalSyntheticLambda0
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return SentryEnvelopeItem.lambda$fromReplay$24(iSerializer, sentryReplayEvent, replayRecording, videoFile, iLogger, z2);
            }
        });
    ...
    public static SentryEnvelopeItem fromSession(final ISerializer iSerializer, final Session session) throws IOException {
        ...
        }, Constants.WUP_CONTENT_TYPE, null), (Callable<byte[]>) new Callable() { // from class: io.sentry.SentryEnvelopeItem$$ExternalSyntheticLambda2
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return cachedItem.getBytes();
            }
    ...
    public static SentryEnvelopeItem fromUserFeedback(final ISerializer iSerializer, final UserFeedback userFeedback) {
        ...
        }, Constants.WUP_CONTENT_TYPE, null), (Callable<byte[]>) new Callable() { // from class: io.sentry.SentryEnvelopeItem$$ExternalSyntheticLambda8
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return cachedItem.getBytes();
            }
    ...
    static /* synthetic */ byte[] lambda$fromAttachment$15(Attachment attachment, long j2, ISerializer iSerializer, ILogger iLogger) throws Exception {
        byte[] bArrCall;
        if (attachment.getBytes() != null) {
            byte[] bytes = attachment.getBytes();
            ensureAttachmentSizeLimit(bytes.length, j2, attachment.getFilename());
            return bytes;
        }
        if (attachment.getSerializable() != null) {
            ...
            if (bArrBytesFrom != null) {
                ensureAttachmentSizeLimit(bArrBytesFrom.length, j2, attachment.getFilename());
            ...
            if (attachment.getByteProvider() != null && (bArrCall = attachment.getByteProvider().call()) != null) {
                ensureAttachmentSizeLimit(bArrCall.length, j2, attachment.getFilename());
                return bArrCall;
            }
        }
    ...
    static /* synthetic */ byte[] lambda$fromProfilingTrace$18(File file, long j2, ProfilingTraceData profilingTraceData, ISerializer iSerializer) throws Exception {
        if (!file.exists()) {
            throw new SentryEnvelopeException(String.format("Dropping profiling trace data, because the file '%s' doesn't exists", file.getName()));
        }
        String strEncodeToString = Base64.encodeToString(FileUtils.readBytesFromFile(file.getPath(), j2), 3);
    ...
    static /* synthetic */ byte[] lambda$fromReplay$24(ISerializer iSerializer, SentryReplayEvent sentryReplayEvent, ReplayRecording replayRecording, File file, ILogger iLogger, boolean z2) throws Exception {
        try {
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            try {
                BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(byteArrayOutputStream, UTF_8));
