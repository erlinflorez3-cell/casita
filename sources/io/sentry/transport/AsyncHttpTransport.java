...
public final class AsyncHttpTransport implements ITransport {
    ...
    final class EnvelopeSender implements Runnable {
        ...
        private TransportResult flush() {
            TransportResult transportResultSend = this.failedResult;
            ...
            HintUtils.runIfHasType(this.hint, DiskFlushNotification.class, new HintUtils.SentryConsumer() { // from class: io.sentry.transport.AsyncHttpTransport$EnvelopeSender$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    this.f$0.m8971xad3aa5c9((DiskFlushNotification) obj);
                }
            });
            if (AsyncHttpTransport.this.transportGate.isConnected()) {
                ...
                try {
                    ...
                    transportResultSend = AsyncHttpTransport.this.connection.send(sentryEnvelopeAttachReportToEnvelope);
                    if (!transportResultSend.isSuccess()) {
                        ...
                        if (transportResultSend.getResponseCode() >= 400 && transportResultSend.getResponseCode() != 429) {
                            HintUtils.runIfDoesNotHaveType(this.hint, Retryable.class, new HintUtils.SentryNullableConsumer() { // from class: io.sentry.transport.AsyncHttpTransport$EnvelopeSender$$ExternalSyntheticLambda1
                                ...
                                public final void accept(Object obj) {
                                    this.f$0.m8972xd68efb0a(sentryEnvelopeAttachReportToEnvelope, obj);
                                }
                            });
                        }
                    ...
                    HintUtils.runIfHasType(this.hint, Retryable.class, new HintUtils.SentryConsumer() { // from class: io.sentry.transport.AsyncHttpTransport$EnvelopeSender$$ExternalSyntheticLambda2
                        ...
                        public final void accept(Object obj, Class cls) {
                            this.f$0.m8973x2937a58c(sentryEnvelopeAttachReportToEnvelope, obj, cls);
                        }
                    });
                ...
                HintUtils.runIfHasType(this.hint, Retryable.class, new HintUtils.SentryConsumer() { // from class: io.sentry.transport.AsyncHttpTransport$EnvelopeSender$$ExternalSyntheticLambda4
                    ...
                    @Override // io.sentry.util.HintUtils.SentryHintFallback
                    public final void accept(Object obj, Class cls) {
                        this.f$0.m8974x7be0500e(obj, cls);
                    }
                });
            }
        ...
        /* JADX INFO: renamed from: lambda$flush$1$io-sentry-transport-AsyncHttpTransport$EnvelopeSender, reason: not valid java name */
        /* synthetic */ void m8971xad3aa5c9(DiskFlushNotification diskFlushNotification) {
        ...
        /* JADX INFO: renamed from: lambda$flush$2$io-sentry-transport-AsyncHttpTransport$EnvelopeSender, reason: not valid java name */
        /* synthetic */ void m8972xd68efb0a(SentryEnvelope sentryEnvelope, Object obj) {
            AsyncHttpTransport.this.options.getClientReportRecorder().recordLostEnvelope(DiscardReason.NETWORK_ERROR, sentryEnvelope);
        }

        /* JADX INFO: renamed from: lambda$flush$4$io-sentry-transport-AsyncHttpTransport$EnvelopeSender, reason: not valid java name */
        /* synthetic */ void m8973x2937a58c(SentryEnvelope sentryEnvelope, Object obj, Class cls) {
            LogUtils.logNotInstanceOf(cls, obj, AsyncHttpTransport.this.options.getLogger());
            AsyncHttpTransport.this.options.getClientReportRecorder().recordLostEnvelope(DiscardReason.NETWORK_ERROR, sentryEnvelope);
        }

        /* JADX INFO: renamed from: lambda$flush$6$io-sentry-transport-AsyncHttpTransport$EnvelopeSender, reason: not valid java name */
        /* synthetic */ void m8974x7be0500e(Object obj, Class cls) {
            LogUtils.logNotInstanceOf(cls, obj, AsyncHttpTransport.this.options.getLogger());
            AsyncHttpTransport.this.options.getClientReportRecorder().recordLostEnvelope(DiscardReason.NETWORK_ERROR, this.envelope);
        }

        /* JADX INFO: renamed from: lambda$run$0$io-sentry-transport-AsyncHttpTransport$EnvelopeSender, reason: not valid java name */
        /* synthetic */ void m8975x71a92bcf(TransportResult transportResult, SubmissionResult submissionResult) {
    ...
    private static QueuedThreadPoolExecutor initExecutor(int i2, final IEnvelopeCache iEnvelopeCache, final ILogger iLogger, SentryDateProvider sentryDateProvider) {
        return new QueuedThreadPoolExecutor(1, i2, new AsyncConnectionThreadFactory(), new RejectedExecutionHandler() { // from class: io.sentry.transport.AsyncHttpTransport$$ExternalSyntheticLambda2
    ...
    /* JADX INFO: renamed from: lambda$send$0$io-sentry-transport-AsyncHttpTransport, reason: not valid java name */
    /* synthetic */ void m8970lambda$send$0$iosentrytransportAsyncHttpTransport(Enqueable enqueable) {
    ...
    public void send(SentryEnvelope sentryEnvelope, Hint hint) throws IOException {
        ...
        if (futureSubmit == null || !futureSubmit.isCancelled()) {
            HintUtils.runIfHasType(hint, Enqueable.class, new HintUtils.SentryConsumer() { // from class: io.sentry.transport.AsyncHttpTransport$$ExternalSyntheticLambda3
                @Override // io.sentry.util.HintUtils.SentryConsumer
                public final void accept(Object obj) {
                    this.f$0.m8970lambda$send$0$iosentrytransportAsyncHttpTransport((Enqueable) obj);
                }
            });
        } else {
