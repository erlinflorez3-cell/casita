...
public final class MapObjectWriter implements ObjectWriter {
    ...
    private void serializeTimeZone(ILogger iLogger, TimeZone timeZone) throws IOException {
        try {
            ...
            iLogger.log(SentryLevel.ERROR, "Error when serializing TimeZone", e2);
            nullValue();
        }
    }
    ...
    @Override // io.sentry.ObjectWriter
    public MapObjectWriter value(double d2) throws IOException {
        postValue(Double.valueOf(d2));
        return this;
    }

    @Override // io.sentry.ObjectWriter
    public MapObjectWriter value(long j2) throws IOException {
    ...
    @Override // io.sentry.ObjectWriter
    public MapObjectWriter value(boolean z2) throws IOException {
