...
public final class DefaultTransactionPerformanceCollector implements TransactionPerformanceCollector {
            ...
            try {
                this.options.getExecutorService().schedule(new Runnable() { // from class: io.sentry.DefaultTransactionPerformanceCollector$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m8861lambda$start$0$iosentryDefaultTransactionPerformanceCollector(iTransaction);
                    }
                }, 30000L);
            } catch (RejectedExecutionException e2) {
                this.options.getLogger().log(SentryLevel.ERROR, "Failed to call the executor. Performance collector will not be automatically finished. Did you call Sentry.close()?", e2);
            }
        }
    ...
    public List<PerformanceCollectionData> m8861lambda$start$0$iosentryDefaultTransactionPerformanceCollector(ITransaction iTransaction) {
