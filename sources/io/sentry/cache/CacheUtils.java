...
final class CacheUtils {
            ...
            try {
                ...
                try {
                    if (jsonDeserializer == null) {
                        T t2 = (T) sentryOptions.getSerializer().deserialize(bufferedReader, cls);
                        bufferedReader.close();
                        return t2;
                    }
                    T t3 = (T) sentryOptions.getSerializer().deserializeCollection(bufferedReader, cls, jsonDeserializer);
                    bufferedReader.close();
                    return t3;
                } finally {
                }
    ...
    static <T> void store(SentryOptions sentryOptions, T t2, String str, String str2) {
        File fileEnsureCacheDir = ensureCacheDir(sentryOptions, str);
        if (fileEnsureCacheDir == null) {
        ...
        try {
            ...
            try {
                ...
                try {
                    sentryOptions.getSerializer().serialize(t2, bufferedWriter);
