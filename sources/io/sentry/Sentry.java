...
public final class Sentry {
    ...
    private static <T extends SentryOptions> void applyOptionsConfiguration(OptionsConfiguration<T> optionsConfiguration, T t2) {
        try {
            ...
            t2.getLogger().log(SentryLevel.ERROR, "Error in the 'OptionsConfiguration.configure' callback.", th);
        }
    }
    ...
    public static IHub cloneMainHub() {
        return globalHubMode ? mainHub : mainHub.m8871clone();
    }
    ...
    public static IHub getCurrentHub() {
        ...
        IHub iHubM8871clone = mainHub.m8871clone();
    ...
    public static <T extends SentryOptions> void init(OptionsContainer<T> optionsContainer, OptionsConfiguration<T> optionsConfiguration) throws IllegalAccessException, NoSuchMethodException, InstantiationException, InvocationTargetException {
        init(optionsContainer, optionsConfiguration, false);
    }

    public static <T extends SentryOptions> void init(OptionsContainer<T> optionsContainer, OptionsConfiguration<T> optionsConfiguration, boolean z2) throws IllegalAccessException, NoSuchMethodException, InstantiationException, InvocationTargetException {
        T tCreateInstance = optionsContainer.createInstance();
        applyOptionsConfiguration(optionsConfiguration, tCreateInstance);
        init(tCreateInstance, z2);
    }
    ...
    public static void init(OptionsConfiguration<SentryOptions> optionsConfiguration, boolean z2) {
    ...
    private static synchronized void init(final SentryOptions sentryOptions, boolean z2) {
        if (isEnabled()) {
    ...
    public static ITransaction startTransaction(String str, String str2, String str3, TransactionOptions transactionOptions) {
        ITransaction iTransactionStartTransaction = getCurrentHub().startTransaction(str, str2, transactionOptions);
