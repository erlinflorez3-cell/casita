...
public abstract class EnvelopeFileObserverIntegration implements Integration, Closeable {
    ...
    /* JADX INFO: renamed from: lambda$register$0$io-sentry-android-core-EnvelopeFileObserverIntegration, reason: not valid java name */
    /* synthetic */ void m8909xc62b36a1(IHub iHub, SentryOptions sentryOptions, String str) {
        synchronized (this.startLock) {
            if (!this.isClosed) {
        ...
        try {
            sentryOptions.getExecutorService().submit(new Runnable() { // from class: io.sentry.android.core.EnvelopeFileObserverIntegration$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m8909xc62b36a1(iHub, sentryOptions, path);
                }
            });
        } catch (Throwable th) {
