...
public final class AndroidEnvelopeCache extends EnvelopeCache {
    ...
    private void writeLastReportedAnrMarker(Long l2) {
        ...
        try {
            ...
            try {
                fileOutputStream.write(String.valueOf(l2).getBytes(UTF_8));
    ...
    /* JADX INFO: renamed from: lambda$store$0$io-sentry-android-core-cache-AndroidEnvelopeCache */
    /* synthetic */ void m8918lambda$store$0$iosentryandroidcorecacheAndroidEnvelopeCache(SentryAndroidOptions sentryAndroidOptions, AnrV2Integration.AnrV2Hint anrV2Hint) {
    ...
    public void store(SentryEnvelope sentryEnvelope, Hint hint) {
        ...
        HintUtils.runIfHasType(hint, AnrV2Integration.AnrV2Hint.class, new HintUtils.SentryConsumer() { // from class: io.sentry.android.core.cache.AndroidEnvelopeCache$$ExternalSyntheticLambda0
            ...
            public final void accept(Object obj) {
                this.f$0.m8918lambda$store$0$iosentryandroidcorecacheAndroidEnvelopeCache(sentryAndroidOptions, (AnrV2Integration.AnrV2Hint) obj);
            }
        });
    }
}
