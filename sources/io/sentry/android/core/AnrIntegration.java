...
public final class AnrIntegration implements Integration, Closeable {
    ...
    private Throwable buildAnrThrowable(boolean z2, SentryAndroidOptions sentryAndroidOptions, ApplicationNotResponding applicationNotResponding) {
            ...
            try {
                sentryAndroidOptions.getExecutorService().submit(new Runnable() { // from class: io.sentry.android.core.AnrIntegration$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m8902lambda$register$0$iosentryandroidcoreAnrIntegration(iHub, sentryAndroidOptions);
                    }
                });
            } catch (Throwable th) {
            ...
            if (anrWatchDog == null) {
                ...
                ANRWatchDog aNRWatchDog = new ANRWatchDog(sentryAndroidOptions.getAnrTimeoutIntervalMillis(), sentryAndroidOptions.isAnrReportInDebug(), new ANRWatchDog.ANRListener() { // from class: io.sentry.android.core.AnrIntegration$$ExternalSyntheticLambda1
                    ...
                    public final void onAppNotResponding(ApplicationNotResponding applicationNotResponding) {
                        this.f$0.m8903lambda$startAnrWatchdog$1$iosentryandroidcoreAnrIntegration(iHub, sentryAndroidOptions, applicationNotResponding);
                    }
    ...
    /* JADX INFO: renamed from: lambda$register$0$io-sentry-android-core-AnrIntegration, reason: not valid java name */
    /* synthetic */ void m8902lambda$register$0$iosentryandroidcoreAnrIntegration(IHub iHub, SentryAndroidOptions sentryAndroidOptions) {
        synchronized (this.startLock) {
            if (!this.isClosed) {
    ...
    public void m8903lambda$startAnrWatchdog$1$iosentryandroidcoreAnrIntegration(IHub iHub, SentryAndroidOptions sentryAndroidOptions, ApplicationNotResponding applicationNotResponding) {
