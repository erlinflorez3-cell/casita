...
public final class ViewHierarchyEventProcessor implements EventProcessor {
    ...
    public static byte[] snapshotViewHierarchyAsData(Activity activity, IMainThreadChecker iMainThreadChecker, ISerializer iSerializer, ILogger iLogger) {
        ViewHierarchy viewHierarchySnapshotViewHierarchy = snapshotViewHierarchy(activity, new ArrayList(0), iMainThreadChecker, iLogger);
    ...
    public SentryEvent process(SentryEvent sentryEvent, Hint hint) {
        ...
        ViewHierarchy viewHierarchySnapshotViewHierarchy = snapshotViewHierarchy(CurrentActivityHolder.getInstance().getActivity(), this.options.getViewHierarchyExporters(), this.options.getMainThreadChecker(), this.options.getLogger());
        if (viewHierarchySnapshotViewHierarchy != null) {
