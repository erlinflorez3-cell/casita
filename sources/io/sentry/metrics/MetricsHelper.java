...
public final class MetricsHelper {
    ...
    /* JADX INFO: renamed from: io.sentry.metrics.MetricsHelper$1, reason: invalid class name */
    ...
    public static double convertNanosTo(MeasurementUnit.Duration duration, long j2) {
        switch (AnonymousClass1.$SwitchMap$io$sentry$MeasurementUnit$Duration[duration.ordinal()]) {
            ...
            case 7:
                return j2 / 8.64E13d;
            case 8:
                return (j2 / 8.64E13d) / 7.0d;
            default:
                throw new IllegalArgumentException("Unknown Duration unit: " + duration.name());
        }
    }

    public static void encodeMetrics(long j2, Collection<Metric> collection, StringBuilder sb) {
    ...
    public static long getCutoffTimestampMs(long j2) {
        return (j2 - 10000) - FLUSH_SHIFT_MS;
    }
    ...
    public static long getTimeBucketKey(long j2) {
    ...
    public static String sanitizeName(String str) {
        return NAME_PATTERN.matcher(str).replaceAll(Global.UNDERSCORE);
    }
    ...
    public static void setFlushShiftMs(long j2) {
        FLUSH_SHIFT_MS = j2;
    }
}
