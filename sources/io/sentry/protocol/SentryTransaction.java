...
public final class SentryTransaction extends SentryBaseEvent implements JsonUnknown, JsonSerializable {
    ...
    public SentryTransaction(String str, Double d2, Double d3, List<SentrySpan> list, Map<String, MeasurementValue> map, Map<String, List<MetricSummary>> map2, TransactionInfo transactionInfo) {
