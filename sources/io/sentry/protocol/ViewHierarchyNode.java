...
public final class ViewHierarchyNode implements JsonUnknown, JsonSerializable {
    ...
    private Double f19778x;

    /* JADX INFO: renamed from: y, reason: collision with root package name */
    private Double f19779y;
            ...
            while (objectReader.peek() == JsonToken.NAME) {
                ...
                switch (strNextName) {
                    ...
                    case "height":
                        ...
                        break;
                    case "x":
                        viewHierarchyNode.f19778x = objectReader.nextDoubleOrNull();
                        break;
                    case "y":
                        viewHierarchyNode.f19779y = objectReader.nextDoubleOrNull();
                        break;
                    case "tag":
    ...
    public void serialize(ObjectWriter objectWriter, ILogger iLogger) throws IOException {
        ...
        if (this.f19778x != null) {
            objectWriter.name("x").value(this.f19778x);
        }
        if (this.f19779y != null) {
            objectWriter.name("y").value(this.f19779y);
        }
