...
public final class SentryTracer implements ITransaction {
    ...
    /* JADX INFO: renamed from: io.sentry.SentryTracer$1 */
    ...
    /* JADX INFO: renamed from: io.sentry.SentryTracer$2 */
        ...
        if (!this.root.isFinished() && this.instrumenter.equals(instrumenter)) {
            ...
            Span span = new Span(this.root.getTraceId(), spanId, this, str, this.hub, sentryDate, spanOptions, new SpanFinishedCallback() { // from class: io.sentry.SentryTracer$$ExternalSyntheticLambda3
                ...
                public final void execute(Span span2) {
                    this.f$0.m8880lambda$createChild$3$iosentrySentryTracer(span2);
                }
            });
    ...
    public void finish(SpanStatus spanStatus, SentryDate sentryDate, boolean z2, Hint hint) {
        ...
        if (!this.transactionOptions.isWaitForChildren() || hasAllChildrenFinished()) {
            ...
            this.root.setSpanFinishedCallback(new SpanFinishedCallback() { // from class: io.sentry.SentryTracer$$ExternalSyntheticLambda1
                @Override // io.sentry.SpanFinishedCallback
                public final void execute(Span span2) {
                    this.f$0.m8881lambda$finish$0$iosentrySentryTracer(spanFinishedCallback, atomicReference, span2);
                }
            });
            ...
            this.hub.configureScope(new ScopeCallback() { // from class: io.sentry.SentryTracer$$ExternalSyntheticLambda2
                @Override // io.sentry.ScopeCallback
                public final void run(IScope iScope) {
                    this.f$0.m8883lambda$finish$2$iosentrySentryTracer(iScope);
                }
            });
            ...
            if (z2 && this.children.isEmpty() && this.transactionOptions.getIdleTimeout() != null) {
    ...
    public void forceFinish(SpanStatus spanStatus, boolean z2, Hint hint) {
        ...
        finish(spanStatus, sentryDateNow, z2, hint);
    }
    ...
    /* JADX INFO: renamed from: lambda$createChild$3$io-sentry-SentryTracer */
    /* synthetic */ void m8880lambda$createChild$3$iosentrySentryTracer(Span span) {
        TransactionPerformanceCollector transactionPerformanceCollector = this.transactionPerformanceCollector;
        if (transactionPerformanceCollector != null) {
    ...
    /* JADX INFO: renamed from: lambda$finish$0$io-sentry-SentryTracer */
    /* synthetic */ void m8881lambda$finish$0$iosentrySentryTracer(SpanFinishedCallback spanFinishedCallback, AtomicReference atomicReference, Span span) {
        ...
        TransactionPerformanceCollector transactionPerformanceCollector = this.transactionPerformanceCollector;
        if (transactionPerformanceCollector != null) {
            atomicReference.set(transactionPerformanceCollector.m8861lambda$start$0$iosentryDefaultTransactionPerformanceCollector(this));
        }
    }

    /* JADX INFO: renamed from: lambda$finish$1$io-sentry-SentryTracer */
    /* synthetic */ void m8882lambda$finish$1$iosentrySentryTracer(IScope iScope, ITransaction iTransaction) {
        if (iTransaction == this) {
            iScope.clearTransaction();
        }
    }

    /* JADX INFO: renamed from: lambda$finish$2$io-sentry-SentryTracer */
    /* synthetic */ void m8883lambda$finish$2$iosentrySentryTracer(final IScope iScope) {
        iScope.withTransaction(new Scope.IWithTransaction() { // from class: io.sentry.SentryTracer$$ExternalSyntheticLambda0
            ...
            public final void accept(ITransaction iTransaction) {
                this.f$0.m8882lambda$finish$1$iosentrySentryTracer(iScope, iTransaction);
            }
        });
    }
