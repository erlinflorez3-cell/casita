...
final class Dsn {
    ...
    Dsn(String str) throws IllegalArgumentException {
        try {
            ...
            String[] strArrSplit = userInfo.split(Global.COLON, -1);
            ...
            int iLastIndexOf = path.lastIndexOf(RemoteSettings.FORWARD_SLASH_STRING) + 1;
            String strSubstring = path.substring(0, iLastIndexOf);
            strSubstring = strSubstring.endsWith(RemoteSettings.FORWARD_SLASH_STRING) ? strSubstring : strSubstring + RemoteSettings.FORWARD_SLASH_STRING;
