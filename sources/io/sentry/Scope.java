...
public final class Scope implements IScope {
    ...
    private Queue<Breadcrumb> createBreadcrumbsList(int i2) {
        return i2 > 0 ? SynchronizedQueue.synchronizedQueue(new CircularFifoQueue(i2)) : SynchronizedQueue.synchronizedQueue(new DisabledQueue());
    }
    ...
    public Session endSession() {
        ...
        synchronized (this.sessionLock) {
            ...
            if (this.session != null) {
                this.session.end();
                Session sessionM8884clone = this.session.m8884clone();
                this.session = null;
                session = sessionM8884clone;
            }
        }
        return session;
    }
    ...
    public SessionPair startSession() {
        ...
        synchronized (this.sessionLock) {
            ...
            if (this.options.getRelease() != null) {
                ...
                sessionPair = new SessionPair(this.session.m8884clone(), session != null ? session.m8884clone() : null);
            } else {
    ...
    public Session withSession(IWithSession iWithSession) {
        ...
        synchronized (this.sessionLock) {
            ...
            sessionM8884clone = this.session != null ? this.session.m8884clone() : null;
        }
        return sessionM8884clone;
    }
