...
public final class JsonObjectReader implements ObjectReader {
        ...
        if (this.jsonReader.hasNext()) {
            do {
                try {
                    ...
                    iLogger.log(SentryLevel.WARNING, "Failed to deserialize object in list.", e2);
                }
    ...
    public TimeZone nextTimeZoneOrNull(ILogger iLogger) throws IOException {
        ...
        try {
            ...
            iLogger.log(SentryLevel.ERROR, "Error when deserializing TimeZone", e2);
            return null;
        }
    }
