...
public final class RRWebBreadcrumbEvent extends RRWebEvent implements JsonUnknown, JsonSerializable {
                ...
                switch (strNextName) {
                    ...
                    case "level":
                        try {
                            ...
                            iLogger.log(SentryLevel.DEBUG, e2, "Error when deserializing SentryLevel", new Object[0]);
                            break;
                        }
                        break;
                    case "message":
    ...
    public void setBreadcrumbTimestamp(double d2) {
        this.breadcrumbTimestamp = d2;
    }
