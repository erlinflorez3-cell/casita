...
final class Utils {
    ...
    static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        public String toString() {
            ...
            for (int i2 = 1; i2 < this.typeArguments.length; i2++) {
                sb.append(", ").append(Utils.typeToString(this.typeArguments[i2]));
            }
    ...
    private static final class WildcardTypeImpl implements WildcardType {
        ...
        public String toString() {
            return this.lowerBound != null ? "? super " + Utils.typeToString(this.lowerBound) : this.upperBound == Object.class ? Global.QUESTION : "? extends " + Utils.typeToString(this.upperBound);
        }
    }
