...
final class DefaultCallAdapterFactory extends CallAdapter.Factory {
    ...
    class AnonymousClass1 implements CallAdapter<Object, Call<?>> {
        ...
        AnonymousClass1(Type type, Executor executor) {
            type = type;
            executor = executor;
        }
    ...
    static final class ExecutorCallbackCall<T> implements Call<T> {
        ...
        class AnonymousClass1 implements Callback<T> {
            ...
            /* synthetic */ void m10858x714e864(Callback callback, Throwable th) {
                callback.onFailure(ExecutorCallbackCall.this, th);
            }

            /* JADX INFO: renamed from: lambda$onResponse$0$retrofit2-DefaultCallAdapterFactory$ExecutorCallbackCall$1 */
            /* synthetic */ void m10859xddacc936(Callback callback, Response response) {
            ...
            public void onFailure(Call<T> call, final Throwable th) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.DefaultCallAdapterFactory$ExecutorCallbackCall$1$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        this.f$0.m10858x714e864(callback, th);
                    }
                });
            }
            ...
            public void onResponse(Call<T> call, final Response<T> response) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.DefaultCallAdapterFactory$ExecutorCallbackCall$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m10859xddacc936(callback, response);
                    }
                });
            }
        }
    ...
    public CallAdapter<?, ?> get(Type type, Annotation[] annotationArr, Retrofit retrofit) {
        ...
        if (type instanceof ParameterizedType) {
            return new CallAdapter<Object, Call<?>>() { // from class: retrofit2.DefaultCallAdapterFactory.1
                ...
                AnonymousClass1(Type type2, Executor executor) {
                    type = type2;
                    executor = executor;
                }
