...
public final class Retrofit {
    ...
    public static final class Builder {
        ...
        public Retrofit build() {
            ...
            List<? extends CallAdapter.Factory> listCreateDefaultCallAdapterFactories = builtInFactories.createDefaultCallAdapterFactories(executor);
            ...
            return new Retrofit(okHttpClient, this.baseUrl, Collections.unmodifiableList(arrayList2), size, Collections.unmodifiableList(arrayList), listCreateDefaultCallAdapterFactories.size(), executor, this.validateEagerly);
        }
    ...
    Retrofit(Call.Factory factory, HttpUrl httpUrl, List<Converter.Factory> list, int i2, List<CallAdapter.Factory> list2, int i3, @Nullable Executor executor, boolean z2) {
