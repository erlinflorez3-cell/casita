...
public class RNShareImpl implements ActivityEventListener {
    ...
    /* JADX INFO: renamed from: cl.json.RNShareImpl$1 */
    ...
    public void onActivityResult(int i2, int i3, Intent intent) {
        if (i2 == 16845) {
            if (i3 == 0) {
                ...
                writableMapCreateMap.putBoolean(FirebaseAnalytics.Param.SUCCESS, false);
            ...
            if (i3 == -1) {
                ...
                writableMapCreateMap2.putBoolean(FirebaseAnalytics.Param.SUCCESS, true);
    ...
    public void open(ReadableMap readableMap, Promise promise) {
        ...
        try {
            ...
            TargetChosenReceiver.callbackReject(e3.getMessage());
        }
    }
