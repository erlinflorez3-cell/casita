...
public class FacebookStoriesShare extends SingleShareIntent {
    ...
    private void shareStory(ReadableMap readableMap) {
        ...
        if (boolValueOf.booleanValue()) {
            ShareFile shareFile = new ShareFile(hasValidKey("backgroundImage", readableMap) ? readableMap.getString("backgroundImage") : hasValidKey("backgroundVideo", readableMap) ? readableMap.getString("backgroundVideo") : "", ClipboardModule.MIMETYPE_JPEG, AppStateModule.APP_STATE_BACKGROUND, zValueOf, this.reactContext);
