...
public class MultipartEntityBuilder {
    ...
    MultipartFormEntity buildEntity() {
        ...
        int i2 = AnonymousClass1.$SwitchMap$cz$msebera$android$httpclient$entity$mime$HttpMultipartMode[httpMultipartMode.ordinal()];
        AbstractMultipartForm httpStrictMultipart = i2 != 1 ? i2 != 2 ? new HttpStrictMultipart(charset, strGenerateBoundary, arrayList2) : new HttpRFC6532Multipart(charset, strGenerateBoundary, arrayList2) : new HttpBrowserCompatibleMultipart(charset, strGenerateBoundary, arrayList2);
