...
public interface ManagedClientConnection extends HttpRoutedConnection, ManagedHttpClientConnection, ConnectionReleaseTrigger {
    ...
    void tunnelProxy(HttpHost httpHost, boolean z2, HttpParams httpParams) throws IOException;

    void tunnelTarget(boolean z2, HttpParams httpParams) throws IOException;
