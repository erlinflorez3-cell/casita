...
public class SSLSocketFactory implements LayeredConnectionSocketFactory, SchemeLayeredSocketFactory, LayeredSchemeSocketFactory, LayeredSocketFactory {
    ...
    public Socket connectSocket(Socket socket, String str, int i2, InetAddress inetAddress, int i3, HttpParams httpParams) throws IOException {
        ...
        return connectSocket(socket, new HttpInetSocketAddress(new HttpHost(str, i2), inetAddressResolve, i2), inetSocketAddress, httpParams);
    }
    ...
    public Socket createLayeredSocket(Socket socket, String str, int i2, HttpParams httpParams) throws IOException {
