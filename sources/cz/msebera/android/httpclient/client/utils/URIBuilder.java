...
public class URIBuilder {
    ...
    private String buildString() {
        ...
        if (str2 != null) {
            ...
            if (this.encodedAuthority != null) {
                ...
                if (this.port >= 0) {
                    sb.append(Global.COLON).append(this.port);
                }
            }
            ...
            if (this.encodedQuery != null) {
                sb.append(Global.QUESTION).append(this.encodedQuery);
            } else {
                List<NameValuePair> list2 = this.queryParams;
                if (list2 != null && !list2.isEmpty()) {
                    sb.append(Global.QUESTION).append(encodeUrlForm(this.queryParams));
                } else if (this.query != null) {
                    sb.append(Global.QUESTION).append(encodeUric(this.query));
                }
            }
        }
    ...
    private static String normalizePath(String str, boolean z2) {
        return TextUtils.isBlank(str) ? "" : (z2 || str.startsWith(RemoteSettings.FORWARD_SLASH_STRING)) ? str : RemoteSettings.FORWARD_SLASH_STRING + str;
    }
