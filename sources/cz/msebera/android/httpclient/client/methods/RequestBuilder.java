...
public class RequestBuilder {
    ...
    public HttpUriRequest build() {
        ...
        URI uriCreate = this.uri;
        if (uriCreate == null) {
            uriCreate = URI.create(RemoteSettings.FORWARD_SLASH_STRING);
        }
        ...
        if (list != null && !list.isEmpty()) {
            if (urlEncodedFormEntity == null && (HttpPost.METHOD_NAME.equalsIgnoreCase(this.method) || "PUT".equalsIgnoreCase(this.method))) {
                ...
                try {
                    uriCreate = new URIBuilder(uriCreate).setCharset(this.charset).addParameters(this.parameters).build();
        ...
        internalRequest.setURI(uriCreate);
