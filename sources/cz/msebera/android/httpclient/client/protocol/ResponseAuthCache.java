    ...
    public void process(HttpResponse httpResponse, HttpContext httpContext) throws HttpException, IOException {
        ...
        if (httpHost != null && authState != null) {
            ...
            if (isCachable(authState)) {
                ...
                int i2 = AnonymousClass1.$SwitchMap$cz$msebera$android$httpclient$auth$AuthProtocolState[authState.getState().ordinal()];
                if (i2 == 1) {
        ...
        if (isCachable(authState2)) {
            ...
            int i3 = AnonymousClass1.$SwitchMap$cz$msebera$android$httpclient$auth$AuthProtocolState[authState2.getState().ordinal()];
            if (i3 == 1) {
