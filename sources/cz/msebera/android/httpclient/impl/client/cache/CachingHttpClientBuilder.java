...
public class CachingHttpClientBuilder extends HttpClientBuilder {
    ...
    protected ClientExecChain decorateMainExec(ClientExecChain clientExecChain) {
        ...
        if (heapResourceFactory == null) {
            heapResourceFactory = this.cacheDir == null ? new HeapResourceFactory() : new FileResourceFactory(this.cacheDir);
        }
        ...
        if (cacheInvalidator == null) {
            cacheInvalidator = new CacheInvalidator(cacheKeyGenerator, basicHttpCacheStorage);
        }
        return new CachingExec(clientExecChain, new BasicHttpCache(heapResourceFactory, basicHttpCacheStorage, cacheConfig, cacheKeyGenerator, cacheInvalidator), cacheConfig, asynchronousValidatorCreateAsynchronousRevalidator);
    }
    ...
    public CachingHttpClientBuilder setDeleteCache(boolean z2) {
        this.deleteCache = z2;
        return this;
    }
