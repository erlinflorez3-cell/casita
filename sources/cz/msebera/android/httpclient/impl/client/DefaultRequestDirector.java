...
public class DefaultRequestDirector implements RequestDirector {
                ...
                try {
                    ...
                    if (response != null) {
                        ...
                        if (zKeepAlive) {
                            ...
                            if (this.log.isDebugEnabled()) {
                                this.log.debug("Connection can be kept alive " + (keepAliveDuration > 0 ? "for " + keepAliveDuration + Global.BLANK + TimeUnit.MILLISECONDS : "indefinitely"));
                            }
    ...
    protected RoutedRequest handleResponse(RoutedRequest routedRequest, HttpResponse httpResponse, HttpContext httpContext) throws HttpException, IOException {
        ...
        if (HttpClientParams.isAuthenticating(params)) {
            ...
            boolean zIsAuthenticationRequested2 = this.authenticator.isAuthenticationRequested(proxyHost, httpResponse, this.proxyAuthStrategy, this.proxyAuthState, httpContext);
            ...
            if (zIsAuthenticationRequested2 && this.authenticator.authenticate(proxyHost, httpResponse, this.proxyAuthStrategy, this.proxyAuthState, httpContext)) {
                return routedRequest;
            }
        }
