...
public class ServerBootstrap {
    ...
    /* JADX WARN: Type inference failed for: r12v0, types: [cz.msebera.android.httpclient.protocol.HttpRequestHandlerMapper] */
    /* JADX WARN: Type inference failed for: r12v1, types: [cz.msebera.android.httpclient.protocol.HttpRequestHandlerMapper] */
    /* JADX WARN: Type inference failed for: r12v2, types: [cz.msebera.android.httpclient.protocol.UriHttpRequestHandlerMapper] */
    public HttpServer create() {
        ...
        return new HttpServer(i2, inetAddress, socketConfig, serverSocketFactory, httpService, defaultBHttpServerConnectionFactory, this.sslSetupHandler, exceptionLogger);
    }
