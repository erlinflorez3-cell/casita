...
public class RFC2965Spec extends RFC2109Spec {
    ...
    RFC2965Spec(boolean z2, CommonCookieAttributeHandler... commonCookieAttributeHandlerArr) {
        super(z2, commonCookieAttributeHandlerArr);
    }
    ...
    protected void formatCookieAsVer(CharArrayBuffer charArrayBuffer, Cookie cookie, int i2) {
        String attribute;
        int[] ports;
