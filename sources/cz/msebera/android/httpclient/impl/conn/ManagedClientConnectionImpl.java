...
class ManagedClientConnectionImpl implements ManagedClientConnection {
    ...
    public boolean isResponseAvailable(int i2) throws IOException {
        return ensureConnection().isResponseAvailable(i2);
    }
    ...
    public void open(HttpRoute httpRoute, HttpContext httpContext, HttpParams httpParams) throws IOException {
        ...
        synchronized (this) {
            ...
            Asserts.check(!r1.isConnected(), "Connection already open");
            connection = this.poolEntry.getConnection();
        }
    ...
    public void setSocketTimeout(int i2) {
        ensureConnection().setSocketTimeout(i2);
    }
    ...
    public void tunnelProxy(HttpHost httpHost, boolean z2, HttpParams httpParams) throws IOException {
        ...
        connection.update(null, httpHost, z2, httpParams);
        synchronized (this) {
            if (this.poolEntry == null) {
                throw new InterruptedIOException();
            }
            this.poolEntry.getTracker().tunnelProxy(httpHost, z2);
        }
    }
    ...
    public void tunnelTarget(boolean z2, HttpParams httpParams) throws IOException {
        ...
        connection.update(null, targetHost, z2, httpParams);
        synchronized (this) {
            if (this.poolEntry == null) {
                throw new InterruptedIOException();
            }
            this.poolEntry.getTracker().tunnelTarget(z2);
        }
    }
