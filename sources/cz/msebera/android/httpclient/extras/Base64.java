...
public class Base64 {
    ...
    static class Decoder extends Coder {
        ...
        public Decoder(int i2, byte[] bArr) {
            this.output = bArr;
            this.alphabet = (i2 + 8) - (i2 | 8) == 0 ? DECODE : DECODE_WEBSAFE;
            this.state = 0;
            this.value = 0;
        }
            ...
            while (i4 < i6) {
                if (i5 == 0) {
                    while (true) {
                        ...
                        int i10 = iArr[(-1) - (((-1) - bArr[i4]) | ((-1) - 255))] << 18;
                        byte b2 = bArr[i4 + 1];
                        int i11 = iArr[(b2 + 255) - (b2 | 255)] << 12;
                        i7 = (-1) - (((-1) - (((i10 + i11) - (i10 & i11)) | (iArr[(-1) - (((-1) - bArr[i4 + 2]) | ((-1) - 255))] << 6))) & ((-1) - iArr[bArr[i4 + 3] & 255]));
                        if (i7 < 0) {
                            break;
                        }
                        bArr2[i8 + 2] = (byte) i7;
    ...
    static class Encoder extends Coder {
        ...
        public Encoder(int i2, byte[] bArr) {
            this.output = bArr;
            this.do_padding = (i2 + 1) - (1 | i2) == 0;
            boolean z2 = (-1) - (((-1) - i2) | ((-1) - 2)) == 0;
            this.do_newline = z2;
            this.do_cr = (-1) - (((-1) - i2) | ((-1) - 4)) != 0;
            this.alphabet = (i2 + 8) - (i2 | 8) == 0 ? ENCODE : ENCODE_WEBSAFE;
