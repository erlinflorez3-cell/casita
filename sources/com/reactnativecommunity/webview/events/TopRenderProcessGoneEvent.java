...
public final class TopRenderProcessGoneEvent extends Event<TopRenderProcessGoneEvent> {
    ...
    @InterfaceC1492Gx
    @Metadata(bv = {}, d1 = {"Я\u0014\u001d<K!&i\u000eӵLcz\u0004I\u0006>\u00176Ȑ\u0005ӳ-(Մ7f\u00198pIkH¯VS8\u000f<\bB%s$ E\u0012٬lԥ&\tWȞ˝kq"}, d2 = {"\u001ab^:\"9>O\u0017\u000e\u0004Z;\u0001\u001a/c\n0\u0004P\n\u001b&[9 <s69Y\u0010i7~\u00167\\Q\u0005Z>)\u0002hj8\u0007p\u0017[\u0001%GZ\\\u000ef[r\u001d%\u0012c\u001d\r\t\u0017\rd=-rN@t", "", "u(E", "\u0013U4\u001bG&'/\u0001^", "", "@dP0gsGO(\u0003\f^s\u000f\t,v\u0004(\u000e:\u000e\u0017\u001eGk\u001c<"}, k = 1, mv = {1, 9, 0}, pn = "", xi = 48, xs = "")
    ...
    public TopRenderProcessGoneEvent(int i2, WritableMap mEventData) {
        super(i2);
