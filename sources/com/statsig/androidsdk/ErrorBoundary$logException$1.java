...
final class ErrorBoundary$logException$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    ErrorBoundary$logException$1(ErrorBoundary errorBoundary, Throwable th, String str, Continuation<? super ErrorBoundary$logException$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ErrorBoundary$logException$1(this.this$0, this.$exception, this.$tag, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ErrorBoundary$logException$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Exception {
        ...
        pairArr[0] = TuplesKt.to(SentryEvent.JsonKeys.EXCEPTION, canonicalName);
        pairArr[1] = TuplesKt.to("info", ExceptionsKt.stackTraceToString(new RuntimeException(this.$exception)));
        pairArr[2] = TuplesKt.to("statsigMetadata", statsigMetadata);
        String str = this.$tag;
        if (str == null) {
            str = "unknown";
        }
        ...
        httpURLConnection.setRequestProperty("Content-Type", Constants.WUP_CONTENT_TYPE);
