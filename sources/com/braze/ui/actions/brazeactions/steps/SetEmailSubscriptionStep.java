...
@InterfaceC1492Gx
@Metadata(bv = {}, d1 = {"Я.\u001d<K!&i\u0016DLcz\u0004I\u0006>\u00176B\u0005#4\u0012\u0006\u0010nʑA0ZeP\u008cZS8\u000fsڔ<$q$yّAڦ\u001a\u0014̝9O|f(sPZŲG\u000f\u0014\u0016Ax:Nmx\f\u0018?6PvW3{w\u0004M)\u000bD\u000e82PB*\t\u000f%BH>\u0003+GY\u0013*0nx\u0001f]\\\u0013\u001b*\u0006l\"Ә\"boޮNJr`H3ݳ\u0007v"}, d2 = {"\u001ab^:\")KO.~Dn0F\u0005-t\u00042\u0005NJ\u0014$C\u0005\u000e8t49c\u0007.\u0001{%.XQ\u0005Y4-tp]=\u000eQ<K\u0005%TPY;`\\{+#\u0012ec", "\u001ab^:\")KO.~Dn0F\u0005-t\u00042\u0005NJ\u0014$C\u0005\u000e8t49c\u0007.\u0001{%.XQ\u0005H0,\u0015En5\u001cc\bL\u0006+QU<;\\]H", "u(E", "\"@6", "", "5dc!4\u000e", "u(;7T=:\u001d z\u0004`uj\u0018<i\t*Q", "7rE._0=", "", "2`c.", "\u001ab^:\")KO.~Dn0F\u0005-t\u00042\u0005NJ\u0014$C\u0005\u000e8t49c\u0007.\u0001{%.XQ\u0005YC\u001e G]H\u00039", "@t]", "", "1n]AX?M", "\u001a`]1e6BRb|\u0005g;|\u0012>/]2\u0005O\u0001*&\u001d", "/mS?b0=\u001b'}\u0001&<\u0001\u0003<e\u0007(wN\u0001"}, k = 1, mv = {1, 8, 0}, pn = "", xi = 48, xs = "")
public final class SetEmailSubscriptionStep extends BaseBrazeActionStep {
    ...
    public void run(Context context, final StepData data) {
        ...
        if (notificationSubscriptionTypeFromValue == null) {
            BrazeLogger.brazelog$default(BrazeLogger.INSTANCE, (Object) this, (BrazeLogger.Priority) null, (Throwable) null, false, (Function0) new Function0<String>() { // from class: com.braze.ui.actions.brazeactions.steps.SetEmailSubscriptionStep.run.1
                {
                    super(0);
                }
            ...
            BaseBrazeActionStep.Companion.runOnUser$android_sdk_ui_release(Braze.Companion.getInstance(context), new Function1<BrazeUser, Unit>() { // from class: com.braze.ui.actions.brazeactions.steps.SetEmailSubscriptionStep.run.2
                {
                    super(1);
                }
                ...
                public final void invoke2(BrazeUser it) {
                    ...
                    it.setEmailNotificationSubscriptionType(notificationSubscriptionTypeFromValue);
                }
            });
        }
    }
