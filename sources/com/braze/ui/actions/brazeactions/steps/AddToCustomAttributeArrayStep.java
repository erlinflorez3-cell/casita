...
@InterfaceC1492Gx
@Metadata(bv = {}, d1 = {"Я&\u001d<K!&i\u0016DLcz\u0004I\u0006>\u00146Ȑ\u0007\"B\u0012\u007fјnjG0L͜P.hS2şqە4:ӋTqq:\u0016\u001f\u0004\"\u07beSNug7Xh\f[\u000f4\u0018)n:Lmx\f\u0016UF\u000b\u0006M8eok?\u0011xD\f82P@*\t\u000f\u001dBH>zAWƠ\u0010\u001b"}, d2 = {"\u001ab^:\")KO.~Dn0F\u0005-t\u00042\u0005NJ\u0014$C\u0005\u000e8t49c\u0007.\u0001{%.XQ\u0005G3\u001d\u0004r?I\u0015r6VR6VYR)lar\u0019!\u001fV\"<:\r\u0010/", "\u001ab^:\")KO.~Dn0F\u0005-t\u00042\u0005NJ\u0014$C\u0005\u000e8t49c\u0007.\u0001{%.XQ\u0005H0,\u0015En5\u001cc\bL\u0006+QU<;\\]H", "u(E", "7rE._0=", "", "2`c.", "\u001ab^:\")KO.~Dn0F\u0005-t\u00042\u0005NJ\u0014$C\u0005\u000e8t49c\u0007.\u0001{%.XQ\u0005YC\u001e G]H\u00039", "@t]", "", "1n]AX?M", "\u001a`]1e6BRb|\u0005g;|\u0012>/]2\u0005O\u0001*&\u001d", "/mS?b0=\u001b'}\u0001&<\u0001\u0003<e\u0007(wN\u0001"}, k = 1, mv = {1, 8, 0}, pn = "", xi = 48, xs = "")
public final class AddToCustomAttributeArrayStep extends BaseBrazeActionStep {
    ...
    public void run(Context context, StepData data) {
        ...
        BaseBrazeActionStep.Companion.runOnUser$android_sdk_ui_release(Braze.Companion.getInstance(context), new Function1<BrazeUser, Unit>() { // from class: com.braze.ui.actions.brazeactions.steps.AddToCustomAttributeArrayStep.run.1
            ...
            public final void invoke2(BrazeUser it) {
                ...
                it.addToCustomAttributeArray(strValueOf, strValueOf2);
            }
        });
    }
}
