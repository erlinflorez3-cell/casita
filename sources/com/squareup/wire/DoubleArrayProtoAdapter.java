...
public final class DoubleArrayProtoAdapter extends ProtoAdapter<double[]> {
    ...
    public void encode(ProtoWriter writer, double[] value) throws IOException {
        ...
        for (double d2 : value) {
            this.originalAdapter.encode(writer, Double.valueOf(d2));
        }
    }
    ...
    @Override // com.squareup.wire.ProtoAdapter
    public void encodeWithTag(ProtoWriter writer, int i2, double[] dArr) throws IOException {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (dArr != null) {
            if (dArr.length == 0) {
                return;
            }
            super.encodeWithTag(writer, i2, dArr);
        }
    }

    @Override // com.squareup.wire.ProtoAdapter
    public void encodeWithTag(ReverseProtoWriter writer, int i2, double[] dArr) throws IOException {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (dArr != null) {
            if (dArr.length == 0) {
                return;
    ...
    public int encodedSize(double[] value) {
        ...
        int iEncodedSize = 0;
        for (double d2 : value) {
            iEncodedSize += this.originalAdapter.encodedSize(Double.valueOf(d2));
        }
        return iEncodedSize;
    }

    @Override // com.squareup.wire.ProtoAdapter
    public int encodedSizeWithTag(int i2, double[] dArr) {
