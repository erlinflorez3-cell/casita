...
public final class LongArrayProtoAdapter extends ProtoAdapter<long[]> {
    ...
    public void encode(ProtoWriter writer, long[] value) throws IOException {
        ...
        for (long j2 : value) {
            this.originalAdapter.encode(writer, Long.valueOf(j2));
        }
    }
    ...
    @Override // com.squareup.wire.ProtoAdapter
    public void encodeWithTag(ProtoWriter writer, int i2, long[] jArr) throws IOException {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (jArr != null) {
            if (jArr.length == 0) {
                return;
            }
            super.encodeWithTag(writer, i2, jArr);
        }
    }

    @Override // com.squareup.wire.ProtoAdapter
    public void encodeWithTag(ReverseProtoWriter writer, int i2, long[] jArr) throws IOException {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (jArr != null) {
            if (jArr.length == 0) {
                return;
    ...
    public int encodedSize(long[] value) {
        ...
        int iEncodedSize = 0;
        for (long j2 : value) {
            iEncodedSize += this.originalAdapter.encodedSize(Long.valueOf(j2));
        }
        return iEncodedSize;
    }

    @Override // com.squareup.wire.ProtoAdapter
    public int encodedSizeWithTag(int i2, long[] jArr) {
