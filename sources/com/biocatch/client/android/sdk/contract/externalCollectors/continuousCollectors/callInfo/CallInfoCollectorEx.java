...
import com.biocatch.client.android.sdk.collection.collectors.callInfo.CallInfoModel;
...
public abstract class CallInfoCollectorEx extends ContinuousCollectorEx<CallInfoModelEx> {
    ...
    public void onCollectedData(CallInfoModelEx collectionItem) {
        Intrinsics.checkNotNullParameter(collectionItem, "collectionItem");
        addToQueue(new CallInfoModel(getContextIDCache().get(), getCurrentEventId(), System.currentTimeMillis(), collectionItem.getState()));
    }
