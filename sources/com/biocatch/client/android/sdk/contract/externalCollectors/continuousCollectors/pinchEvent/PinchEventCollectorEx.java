...
import com.biocatch.client.android.sdk.collection.collectors.gestures.PinchEventModel;
...
public abstract class PinchEventCollectorEx extends ContinuousCollectorEx<PinchEventModelEx> {
    ...
    public void onCollectedData(PinchEventModelEx collectionItem) {
        ...
        addToQueue(new PinchEventModel(getContextIDCache().get(), currentEventId, System.currentTimeMillis(), gestureLocationMaskGesture.getX(), gestureLocationMaskGesture.getY(), collectionItem.getScale()));
    }
