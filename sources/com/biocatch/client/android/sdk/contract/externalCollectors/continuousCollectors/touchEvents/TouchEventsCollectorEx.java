...
public abstract class TouchEventsCollectorEx extends ContinuousCollectorEx<TouchEventModelEx> {
    ...
    public void onCollectedData(TouchEventModelEx collectionItem) {
        Intrinsics.checkNotNullParameter(collectionItem, "collectionItem");
        Utils utilsProvideUtils = SdkInjectorKt.getCommonInjector().provideUtils();
        ...
        CoordinatesMaskingService coordinatesMaskingServiceProvideCoordinatesMaskingService = SdkInjectorKt.getCommonInjector().provideCoordinatesMaskingService();
        long currentEventId = getCurrentEventId();
        TouchLocation touchLocationMaskTouch = coordinatesMaskingServiceProvideCoordinatesMaskingService.maskTouch(new TouchLocation((int) collectionItem.getX(), (int) collectionItem.getY()));
        addToQueue(new TouchEventModel(Integer.valueOf(getContextIDCache().get()), Long.valueOf(currentEventId), System.currentTimeMillis(), Integer.valueOf(collectionItem.getRecognitionState()), collectionItem.getHash(), Integer.valueOf(touchLocationMaskTouch.getX()), Integer.valueOf(touchLocationMaskTouch.getY()), Integer.valueOf(collectionItem.getPointerID()), Double.valueOf(collectionItem.getTouchSizeMajor()), Double.valueOf(collectionItem.getTouchSizeMinor()), Float.valueOf(collectionItem.getTouchPressure()), Integer.valueOf(collectionItem.getSourceType()), Double.valueOf(utilsProvideUtils.truncate(collectionItem.getSize(), configurationRepositoryProvideConfigurationRepository.getInt(ConfigurationFields.touchSizePrecision))), Double.valueOf(collectionItem.getTouchAreaOrientation()), null, 16384, null));
    }
