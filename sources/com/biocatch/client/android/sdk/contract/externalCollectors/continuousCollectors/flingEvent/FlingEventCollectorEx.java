...
import com.biocatch.client.android.sdk.collection.collectors.gestures.FlingEventModel;
...
public abstract class FlingEventCollectorEx extends ContinuousCollectorEx<FlingEventModelEx> {
    ...
    public void onCollectedData(FlingEventModelEx collectionItem) {
        Intrinsics.checkNotNullParameter(collectionItem, "collectionItem");
        addToQueue(new FlingEventModel(getContextIDCache().get(), getCurrentEventId(), System.currentTimeMillis(), collectionItem.getStartX(), collectionItem.getStartY(), collectionItem.getVelocityX(), collectionItem.getVelocityY()));
    }
