...
import com.biocatch.client.android.sdk.collection.collectors.application.ApplicationEventModel;
...
public abstract class ApplicationEventsCollectorEx extends ContinuousCollectorEx<ApplicationEventModelEx> {
    ...
    public void onCollectedData(ApplicationEventModelEx collectionItem) {
        Intrinsics.checkNotNullParameter(collectionItem, "collectionItem");
        addToQueue(new ApplicationEventModel(getContextIDCache().get(), getCurrentEventId(), System.currentTimeMillis(), collectionItem.getApplicationLocation()));
    }
