package com.biocatch.client.android.sdk.contract.externalCollectors.continuousCollectors.wifiInfo;
...
import com.biocatch.client.android.sdk.collection.collectors.wifi.WifiInfoModel;
...
public abstract class WifiInfoCollectorEx extends ContinuousCollectorEx<WifiInfoModelEx> {
    ...
    public void onCollectedData(WifiInfoModelEx collectionItem) {
        ...
        int i2 = configurationRepositoryProvideConfigurationRepository.getInt(ConfigurationFields.ssidTruncationLength);
        String ssid = collectionItem.getSsid();
        if (ssid == null) {
            ssid = "";
        }
        addToQueue(new WifiInfoModel(getContextIDCache().get(), currentEventId, System.currentTimeMillis(), hashServiceProvideHashService$sdk_3_3_0_936_release.getTruncatedHash(ssid, i2), collectionItem.getBssid(), collectionItem.getIp()));
    }
