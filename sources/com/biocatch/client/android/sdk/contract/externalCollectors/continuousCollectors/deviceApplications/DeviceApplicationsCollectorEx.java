...
import com.biocatch.client.android.sdk.collection.collectors.application.DeviceApplicationModel;
...
public abstract class DeviceApplicationsCollectorEx extends ContinuousCollectorEx<DeviceApplicationModelEx> {
    ...
    public void onCollectedData(DeviceApplicationModelEx collectionItem) {
        Intrinsics.checkNotNullParameter(collectionItem, "collectionItem");
        addToQueue(new DeviceApplicationModel(getContextIDCache().get(), getCurrentEventId(), System.currentTimeMillis(), collectionItem.getApplicationName(), collectionItem.getPackageName(), collectionItem.getApplicationInstallationState(), collectionItem.getPermissions(), collectionItem.getFirstInstallTime()));
    }
