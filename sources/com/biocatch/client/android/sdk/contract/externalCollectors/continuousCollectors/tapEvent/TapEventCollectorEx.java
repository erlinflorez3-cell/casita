...
import com.biocatch.client.android.sdk.collection.collectors.gestures.TapEventModel;
...
public abstract class TapEventCollectorEx extends ContinuousCollectorEx<TapEventModelEx> {
    ...
    public void onCollectedData(TapEventModelEx collectionItem) {
        ...
        GestureLocation gestureLocationMaskGesture = coordinatesMaskingServiceProvideCoordinatesMaskingService.maskGesture(new GestureLocation(collectionItem.getX(), collectionItem.getY()));
        addToQueue(new TapEventModel(getContextIDCache().get(), currentEventId, System.currentTimeMillis(), gestureLocationMaskGesture.getX(), gestureLocationMaskGesture.getY()));
    }
