...
import com.biocatch.client.android.sdk.collection.collectors.accessibility.AccessibilityEventModel;
...
public abstract class AccessibilityEventsCollectorEx extends ContinuousCollectorEx<AccessibilityEventModelEx> {
    ...
    public void onCollectedData(AccessibilityEventModelEx collectionItem) {
        Intrinsics.checkNotNullParameter(collectionItem, "collectionItem");
        addToQueue(new AccessibilityEventModel(getContextIDCache().get(), getCurrentEventId(), System.currentTimeMillis(), collectionItem.isAccesibility(), collectionItem.isTouchExploration()));
    }
