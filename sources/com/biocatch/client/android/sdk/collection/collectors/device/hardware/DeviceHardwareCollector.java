...
public final class DeviceHardwareCollector extends OnDemandCollector<DeviceHardwareModel> {
    ...
    public DeviceHardwareModel runCollection() {
        return new DeviceHardwareModel(this.buildInfo.getHardware());
    }
}
