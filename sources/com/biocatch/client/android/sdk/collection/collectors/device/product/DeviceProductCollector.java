...
public final class DeviceProductCollector extends OnDemandCollector<DeviceProductModel> {
    ...
    public DeviceProductModel runCollection() {
        return new DeviceProductModel(this.buildInfo.getProduct());
    }
}
