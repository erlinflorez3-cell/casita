...
public final class LongPressEventModel extends CollectionItem {
    ...
    public LongPressEventModel(int i2, long j2, long j3, float f2, float f3) {
        this.contextID = i2;
        this.eventID = j2;
        this.timestamp = j3;
        this.f2614x = f2;
    ...
    public JSONArray toJSONArray() throws JSONException {
        ...
        jSONArray.put(this.f2614x);
        jSONArray.put(this.f2615y);
        return jSONArray;
    }
}
