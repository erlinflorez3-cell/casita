...
public final class OSCollector extends OnDemandCollector<OSModel> {
    ...
    public OSModel runCollection() {
        return new OSModel(this.buildInfo.getVersion());
    }
}
