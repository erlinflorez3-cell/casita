...
public final class DisplayCollector extends OnDemandCollector<DisplayModel> {
    ...
    public DisplayModel runCollection() {
        ...
        return (activity == null || (resources = activity.getResources()) == null || (displayMetrics = resources.getDisplayMetrics()) == null) ? DisplayModelKt.getNoDisplayPlaceholderModel() : new DisplayModel(-1, displayMetrics.widthPixels, displayMetrics.heightPixels, displayMetrics.xdpi, displayMetrics.ydpi);
    }
}
