...
public final class GyroscopeCollectorSettings extends InteractionSensorSettings {
    ...
    public long getSamplePeriod() {
        return this.configurationRepository.getLong(ConfigurationFields.gyroEventsSamplePeriod);
    }
    ...
    public int getSensorRegistrationDelay() {
        return this.configurationRepository.getInt(ConfigurationFields.gyroEventsSensorRegistrationDelay);
    }

    public final double getThreshold() {
        return this.configurationRepository.getDouble(ConfigurationFields.gyroEventsThreshold);
    }
