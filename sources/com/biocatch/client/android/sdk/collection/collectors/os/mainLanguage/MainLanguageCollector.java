...
public final class MainLanguageCollector extends OnDemandCollector<MainLanguageModel> {
    ...
    public MainLanguageModel runCollection() {
        String string = this.locale.getDafault().toString();
        Intrinsics.checkNotNullExpressionValue(string, "locale.dafault.toString()");
        return new MainLanguageModel(string);
    }
}
