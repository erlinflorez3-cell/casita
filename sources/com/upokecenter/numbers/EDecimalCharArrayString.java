...
final class EDecimalCharArrayString {
    ...
    static EDecimal FromString(char[] cArr, int i2, int i3, EContext eContext, boolean z2) {
        boolean z3;
        ...
        if (i4 > cArr.length) {
            if (z2) {
                throw new NumberFormatException("offset(" + i4 + ") is more than " + cArr.length);
            }
            return null;
        }
        if (i3 <= 0) {
        ...
        if (i3 > cArr.length) {
            if (z2) {
                throw new NumberFormatException("length(" + i3 + ") is more than " + cArr.length);
            }
            return null;
        }
        if (cArr.length - i4 < i3) {
            if (z2) {
                throw new NumberFormatException("chars's length minus " + i4 + "(" + (cArr.length - i4) + ") is less than " + i3);
            }
            return null;
        }
        int i5 = i3 + i4;
        ...
        return ((c2 < '0' || c2 > '9') && (eDecimalParseSpecialValue = ParseSpecialValue(cArr, i4, i5, z3, eContext, z2)) != null) ? eDecimalParseSpecialValue : (eContext == null || !eContext.getHasMaxPrecision() || !eContext.getHasExponentRange() || eContext.isSimplified()) ? ParseOrdinaryNumber(cArr, i4, i5, z3, eContext, z2) : ParseOrdinaryNumberLimitedPrecision(cArr, i4, i5, z3, eContext, z2);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:132:0x0196 A[PHI: r4 r24
  0x0196: PHI (r4v16 boolean) = (r4v15 boolean), (r4v3 boolean), (r4v3 boolean) binds: [B:147:0x01b8, B:139:0x01a5, B:131:0x0194] A[DONT_GENERATE, DONT_INLINE]
  0x0196: PHI (r24v8 boolean) = (r24v6 boolean), (r24v3 boolean), (r24v3 boolean) binds: [B:147:0x01b8, B:139:0x01a5, B:131:0x0194] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static com.upokecenter.numbers.EDecimal ParseOrdinaryNumber(char[] r23, int r24, int r25, boolean r26, com.upokecenter.numbers.EContext r27, boolean r28) {
        /*
            Method dump skipped, instruction units count: 1325
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.upokecenter.numbers.EDecimalCharArrayString.ParseOrdinaryNumber(char[], int, int, boolean, com.upokecenter.numbers.EContext, boolean):com.upokecenter.numbers.EDecimal");
    }
     ...
     */
    /* JADX WARN: Code restructure failed: missing block: B:174:0x0203, code lost:
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static com.upokecenter.numbers.EDecimal ParseOrdinaryNumberLimitedPrecision(char[] r24, int r25, int r26, boolean r27, com.upokecenter.numbers.EContext r28, boolean r29) {
        /*
            Method dump skipped, instruction units count: 597
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.upokecenter.numbers.EDecimalCharArrayString.ParseOrdinaryNumberLimitedPrecision(char[], int, int, boolean, com.upokecenter.numbers.EContext, boolean):com.upokecenter.numbers.EDecimal");
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:104:0x0111, code lost:
        ...
        if (r3 > com.upokecenter.numbers.EDecimalCharArrayString.MaxSafeInt) goto L109;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:112:0x0126, code lost:
        ...
        if (r4 > com.upokecenter.numbers.EDecimalCharArrayString.MaxSafeInt) goto L122;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:168:0x01b6, code lost:
        ...
        if (r4 <= com.upokecenter.numbers.EDecimalCharArrayString.MaxSafeInt) goto L198;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:176:0x01ca, code lost:
        ...
        if (r3 <= com.upokecenter.numbers.EDecimalCharArrayString.MaxSafeInt) goto L182;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:78:0x00ce, code lost:
        ...
        if (r3 > com.upokecenter.numbers.EDecimalCharArrayString.MaxSafeInt) goto L81;
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static com.upokecenter.numbers.EDecimal ParseOrdinaryNumberNoContext(char[] r21, int r22, int r23, boolean r24, boolean r25) {
        /*
            Method dump skipped, instruction units count: 566
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.upokecenter.numbers.EDecimalCharArrayString.ParseOrdinaryNumberNoContext(char[], int, int, boolean, boolean):com.upokecenter.numbers.EDecimal");
    }

    private static EDecimal ParseSpecialValue(char[] cArr, int i2, int i3, boolean z2, EContext eContext, boolean z3) {
        char c2;
        char c3;
        char c4;
        char c5;
        ...
        char c18;
        char c19;
        if (i2 + 8 == i3 && (((c12 = cArr[i2]) == 'I' || c12 == 'i') && (((c13 = cArr[i2 + 1]) == 'N' || c13 == 'n') && (((c14 = cArr[i2 + 2]) == 'F' || c14 == 'f') && (((c15 = cArr[i2 + 3]) == 'I' || c15 == 'i') && (((c16 = cArr[i2 + 4]) == 'N' || c16 == 'n') && (((c17 = cArr[i2 + 5]) == 'I' || c17 == 'i') && (((c18 = cArr[i2 + 6]) == 'T' || c18 == 't') && ((c19 = cArr[i2 + 7]) == 'Y' || c19 == 'y'))))))))) {
        ...
        int i4 = i2 + 3;
        if (i4 == i3 && (((c9 = cArr[i2]) == 'I' || c9 == 'i') && (((c10 = cArr[i2 + 1]) == 'N' || c10 == 'n') && ((c11 = cArr[i2 + 2]) == 'F' || c11 == 'f')))) {
            if (eContext == null || !eContext.isSimplified() || i2 >= i3) {
                return z2 ? EDecimal.NegativeInfinity : EDecimal.PositiveInfinity;
            }
            if (z3) {
        ...
        if (i4 <= i3 && (((c6 = cArr[i2]) == 'N' || c6 == 'n') && (((c7 = cArr[i2 + 1]) == 'A' || c7 == 'a') && ((c8 = cArr[i2 + 2]) == 'N' || c8 == 'n')))) {
            if (eContext != null && eContext.isSimplified() && i2 < i3) {
                if (z3) {
            ...
            eIntegerFromSubstring = i6 > MaxSafeInt ? EInteger.FromSubstring(cArr, i4, i3) : null;
        ...
        int i9 = i2 + 4;
        if (i9 > i3 || !(((c2 = cArr[i2]) == 'S' || c2 == 's') && (((c3 = cArr[i2 + 1]) == 'N' || c3 == 'n') && (((c4 = cArr[i2 + 2]) == 'A' || c4 == 'a') && ((c5 = cArr[i4]) == 'N' || c5 == 'n'))))) {
            return null;
        }
        if (eContext != null && eContext.isSimplified() && i2 < i3) {
            if (z3) {
        ...
        if (i9 == i3) {
            return !z2 ? EDecimal.SignalingNaN : new EDecimal(FastIntegerFixed.Zero, FastIntegerFixed.Zero, (byte) ((z2 ? 1 : 0) | 8));
        }
        ...
        eIntegerFromSubstring = i10 > MaxSafeInt ? EInteger.FromSubstring(cArr, i9, i3) : null;
        int i13 = (-1) - (((-1) - (z2 ? 1 : 0)) & ((-1) - 8));
        if (eIntegerFromSubstring == null) {
