...
public class Crossfade extends Transition {
    ...
    private static RectEvaluator sRectEvaluator = null;
    ...
    public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            final boolean z2 = this.mFadeBehavior != 1;
            ...
            if (rect != null && rect2 != null) {
                ...
                if (bitmapDrawable != null && bitmapDrawable2 != null && !bitmap.sameAs(bitmap2)) {
                    ...
                    objectAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.transitionseverywhere.Crossfade.1
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public void onAnimationUpdate(ValueAnimator valueAnimator) {
                            view.invalidate(bitmapDrawable.getBounds());
                        }
                    });
                    int i2 = this.mFadeBehavior;
                    if (i2 == 2) {
                    ...
                    objectAnimatorOfInt.addListener(new AnimatorListenerAdapter() { // from class: com.transitionseverywhere.Crossfade.2
    ...
    public Crossfade setFadeBehavior(int i2) {
        if (i2 >= 0 && i2 <= 2) {
            this.mFadeBehavior = i2;
        }
        return this;
    }

    public Crossfade setResizeBehavior(int i2) {
        if (i2 >= 0 && i2 <= 1) {
            this.mResizeBehavior = i2;
        }
        return this;
    }
}
