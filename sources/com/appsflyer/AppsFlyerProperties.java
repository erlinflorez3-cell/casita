...
public class AppsFlyerProperties {
    ...
    public static AppsFlyerProperties instance = null;
    ...
    public boolean getBoolean(String str, boolean z2) {
        ...
        return string == null ? z2 : Boolean.parseBoolean(string);
    }
    ...
    public int getLogLevel() {
        return getInt(ConfigurationFields.logLevel, AFLogger.LogLevel.NONE.getLevel());
    }
        ...
        if (monetizationNetwork != null) {
            ...
            try {
                ...
                for (int i2 = 0; i2 < 5; i2++) {
                    this.getMediationNetwork.remove(strArr[i2]);
                }
            ...
            AFLogger.afDebugLog(new StringBuilder("Done loading properties: ").append(this.getMonetizationNetwork).toString());
        }
    }
    ...
    public synchronized void set(String str, int i2) {
        this.getMediationNetwork.put(str, Integer.toString(i2));
    }

    public synchronized void set(String str, long j2) {
        this.getMediationNetwork.put(str, Long.toString(j2));
    }
    ...
    public synchronized void set(String str, boolean z2) {
        this.getMediationNetwork.put(str, Boolean.toString(z2));
    }
