...
public final class AFh1xSDK {
    ...
    public final Map<String, Object> getCurrencyIso4217Code(String str) {
        ...
        try {
            mapEmptyMap = AFg1eSDK.getRevenue(new JSONObject(monetizationNetwork));
            return mapEmptyMap;
        } catch (Exception e2) {
    ...
    public final void getCurrencyIso4217Code(DeepLinkResult deepLinkResult, long j2) {
        this.getMediationNetwork.put("status", deepLinkResult.getStatus().toString());
        this.getMediationNetwork.put("timeout_value", Long.valueOf(j2));
    }
    ...
    public final void getMonetizationNetwork() {
        ...
        if (AFAdRevenueData()) {
            ...
            this.AFAdRevenueData.put("init_to_fg", Long.valueOf(this.component4 - j2));
    ...
    public final void getMonetizationNetwork(int i2) {
        ...
        if (j2 != 0) {
            this.getRevenue.put("net", Long.valueOf(jCurrentTimeMillis - j2));
        } else {
            AFLogger.afInfoLog("Metrics: gcdStart ts is missing");
        }
        this.getRevenue.put("retries", Integer.valueOf(i2));
