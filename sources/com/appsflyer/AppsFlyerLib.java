...
public abstract class AppsFlyerLib {
    ...
    public abstract void anonymizeUser(boolean z2);
    ...
    public abstract void enableFacebookDeferredApplinks(boolean z2);

    public abstract void enableTCFDataCollection(boolean z2);
    ...
    public abstract void setCollectAndroidID(boolean z2);

    public abstract void setCollectIMEI(boolean z2);

    @Deprecated
    public abstract void setCollectOaid(boolean z2);
    ...
    public abstract void setDebugLog(boolean z2);

    public abstract void setDisableAdvertisingIdentifiers(boolean z2);

    public abstract void setDisableNetworkData(boolean z2);
    ...
    public abstract void setIsUpdate(boolean z2);
    ...
    public abstract void stop(boolean z2, Context context);

    public abstract void subscribeForDeepLink(DeepLinkListener deepLinkListener);

    public abstract void subscribeForDeepLink(DeepLinkListener deepLinkListener, long j2);
    ...
    public abstract void waitForCustomerUserId(boolean z2);
}
