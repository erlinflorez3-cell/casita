...
final class hh {
    ...
    static int V(ib ibVar) {
        long j2 = 0;
        for (int i2 = 0; i2 < ibVar.S(); i2++) {
            j2 += (long) Z[ibVar.B(i2) & 255];
        }
        return (int) ((j2 + 7) >> 3);
    }

    static void Z(ib ibVar, cf.I i2) throws IOException {
        long j2 = 0;
        int i3 = 0;
        for (int i4 = 0; i4 < ibVar.S(); i4++) {
            int iB = ibVar.B(i4) & 255;
            int i5 = V[iB];
            byte b2 = Z[iB];
            long j3 = j2 << b2;
            long j4 = i5;
    ...
    final byte[] V(byte[] bArr) throws IOException {
        ...
        int i3 = 0;
        for (byte b2 : bArr) {
            i2 = (-1) - (((-1) - (i2 << 8)) & ((-1) - ((-1) - (((-1) - b2) | ((-1) - 255)))));
            i3 += 8;
            while (i3 >= 8) {
                code = code.Z[(-1) - (((-1) - (i2 >>> (i3 - 8))) | ((-1) - 255))];
                if (code.Z == null) {
        ...
        while (i3 > 0) {
            int i4 = i2 << (8 - i3);
            Code code2 = code.Z[(i4 + 255) - (i4 | 255)];
            if (code2.Z != null || code2.V > i3) {
                break;
            }
            byteArrayOutputStream.write(code2.I);
            i3 -= code2.V;
            code = this.I;
        }
