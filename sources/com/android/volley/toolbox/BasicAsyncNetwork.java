...
public class BasicAsyncNetwork extends AsyncNetwork {
    ...
    public void onRequestFailed(Request<?> request, AsyncNetwork.OnRequestComplete onRequestComplete, IOException iOException, long j2, HttpResponse httpResponse, byte[] bArr) throws Throwable {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void onRequestSucceeded(Request<?> request, long j2, HttpResponse httpResponse, AsyncNetwork.OnRequestComplete onRequestComplete) throws Throwable {
        ...
        if (contentBytes != null) {
            onResponseRead(j2, statusCode, httpResponse, request, onRequestComplete, headers, contentBytes);
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void onResponseRead(long j2, int i2, HttpResponse httpResponse, Request<?> request, AsyncNetwork.OnRequestComplete onRequestComplete, List<Header> list, byte[] bArr) throws Throwable {
    ...
    public void performRequest(final Request<?> request, final AsyncNetwork.OnRequestComplete onRequestComplete) {
        ...
        this.mAsyncStack.executeRequest(request, HttpHeaderParser.getCacheHeaders(request.getCacheEntry()), new AsyncHttpStack.OnRequestComplete() { // from class: com.android.volley.toolbox.BasicAsyncNetwork.1
            ...
            @Override // com.android.volley.toolbox.AsyncHttpStack.OnRequestComplete
            public void onError(IOException iOException) throws Throwable {
