...
public class LayerParser {
    ...
    public static Layer parse(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            switch (jsonReader.selectName(NAMES)) {
                ...
                case 3:
                    ...
                    layerType = iNextInt3 >= Layer.LayerType.UNKNOWN.ordinal() ? Layer.LayerType.UNKNOWN : Layer.LayerType.values()[iNextInt3];
                    break;
                case 4:
                ...
                case 9:
                    ...
                    if (iNextInt4 < Layer.MatteType.values().length) {
                        matteType = Layer.MatteType.values()[iNextInt4];
                        int i2 = AnonymousClass1.$SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType[matteType.ordinal()];
                        if (i2 == 1) {
                ...
                case 16:
                    ...
                    break;
                case 17:
                    fNextDouble5 = (float) (jsonReader.nextDouble() * ((double) Utils.dpScale()));
                    break;
                case 18:
                ...
                case 24:
                    ...
                    if (iNextInt6 < LBlendMode.values().length) {
                        lBlendMode = LBlendMode.values()[iNextInt6];
                    } else {
                        lottieComposition.addWarning("Unsupported Blend Mode: " + iNextInt6);
                        lBlendMode = LBlendMode.NORMAL;
                    }
                    break;
                default:
                    jsonReader.skipName();
        ...
        if (fNextDouble2 > 0.0f) {
            arrayList4.add(new Keyframe(lottieComposition, fValueOf, fValueOf, null, 0.0f, Float.valueOf(fNextDouble2)));
            f2 = 0.0f;
        }
        if (endFrame <= f2) {
            endFrame = lottieComposition.getEndFrame();
        }
        arrayList4.add(new Keyframe(lottieComposition, fValueOf2, fValueOf2, null, fNextDouble2, Float.valueOf(endFrame)));
        arrayList4.add(new Keyframe(lottieComposition, fValueOf, fValueOf, null, endFrame, Float.valueOf(Float.MAX_VALUE)));
        ...
        return new Layer(arrayList2, lottieComposition, strNextString, jNextInt, layerType, jNextInt2, strNextString2, arrayList, animatableTransform, iNextInt, iNextInt2, color, fNextDouble, fNextDouble3, fNextDouble4, fNextDouble5, documentData, animatableTextProperties, arrayList4, matteType, animatableFloatValue, zNextBoolean, blurEffect, dropShadowEffect, lBlendMode);
    }
}
