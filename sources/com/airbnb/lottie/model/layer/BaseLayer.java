...
public abstract class BaseLayer implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElement {
    ...
    BaseLayer(LottieDrawable lottieDrawable, Layer layer) throws Throwable {
    ...
    private void applyMasks(Canvas canvas, Matrix matrix) {
        ...
        for (int i2 = 0; i2 < this.mask.getMasks().size(); i2++) {
            ...
            int i3 = AnonymousClass1.$SwitchMap$com$airbnb$lottie$model$content$Mask$MaskMode[mask.getMaskMode().ordinal()];
            if (i3 != 1) {
                if (i3 == 2) {
                    if (i2 == 0) {
    ...
    private void intersectBoundsWithMask(RectF rectF, Matrix matrix) {
        ...
        if (hasMasksOnThisLayer()) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                Mask mask = this.mask.getMasks().get(i2);
                Path value = this.mask.getMaskAnimations().get(i2).getValue();
                if (value != null) {
                    this.path.set(value);
                    this.path.transform(matrix);
                    int i3 = AnonymousClass1.$SwitchMap$com$airbnb$lottie$model$content$Mask$MaskMode[mask.getMaskMode().ordinal()];
    ...
    private void invalidateSelf() throws Throwable {
    ...
    private void setVisible(boolean z2) throws Throwable {
        if (z2 != this.visible) {
            this.visible = z2;
            invalidateSelf();
        }
    ...
    private void setupInOutAnimations() throws Throwable {
        ...
        this.inOutAnimation.addUpdateListener(new BaseKeyframeAnimation.AnimationListener() { // from class: com.airbnb.lottie.model.layer.BaseLayer$$ExternalSyntheticLambda0
            ...
            public final void onValueChanged() throws Throwable {
                this.f$0.m7017xf49bd987();
            }
        });
    ...
    public void draw(Canvas canvas, Matrix matrix, int i2, DropShadow dropShadow) {
        ...
        int iIntValue = (int) ((((i2 / 255.0f) * ((opacity == null || (value = opacity.getValue()) == null) ? 100 : value.intValue())) / 100.0f) * 255.0f);
        ...
        if (this.rect.width() >= 1.0f && this.rect.height() >= 1.0f) {
            ...
            if (hasMatteOnThisLayer()) {
                ...
                clearCanvas(canvas);
                this.matteLayer.draw(canvas, matrix, i2, null);
                if (L.isTraceEnabled()) {
                    L.beginSection("Layer#restoreLayer");
                }
                canvas.restore();
    ...
    abstract void drawLayer(Canvas canvas, Matrix matrix, int i2, DropShadow dropShadow);
    ...
    /* synthetic */ void m7017xf49bd987() throws Throwable {
    ...
    public void resolveKeyPath(KeyPath keyPath, int i2, List<KeyPath> list, KeyPath keyPath2) {
        ...
        if (baseLayer != null) {
            ...
            if (keyPath.matches(this.matteLayer.getName(), i2) && keyPath.propagateToChildren(getName(), i2)) {
                this.matteLayer.resolveChildKeyPath(keyPath, keyPath.incrementDepthBy(this.matteLayer.getName(), i2) + i2, list, keyPathAddKey);
            }
        }
    ...
    void setOutlineMasksAndMattes(boolean z2) {
