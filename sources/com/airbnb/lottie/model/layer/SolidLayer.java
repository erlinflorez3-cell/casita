...
public class SolidLayer extends BaseLayer {
    ...
    public void drawLayer(Canvas canvas, Matrix matrix, int i2, DropShadow dropShadow) {
        ...
        int iIntValue = (int) ((i2 / 255.0f) * (((iAlpha / 255.0f) * (this.transform.getOpacity() == null ? 100 : this.transform.getOpacity().getValue().intValue())) / 100.0f) * 255.0f);
