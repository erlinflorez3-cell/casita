...
public class CompositionLayer extends BaseLayer {
    ...
    void drawLayer(Canvas canvas, Matrix matrix, int i2, DropShadow dropShadow) {
        ...
        boolean z2 = false;
        boolean z3 = (dropShadow == null && this.dropShadowAnimation == null) ? false : true;
        if ((this.lottieDrawable.isApplyingOpacityToLayersEnabled() && this.layers.size() > 1 && i2 != 255) || (z3 && this.lottieDrawable.isApplyingShadowToLayersEnabled())) {
            z2 = true;
        }
        int i3 = z2 ? 255 : i2;
        ...
        if (canvas.clipRect(this.newClipRect)) {
            for (int size = this.layers.size() - 1; size >= 0; size--) {
                this.layers.get(size).draw(canvasStart, matrix, i3, dropShadow);
            }
        }
        if (z2) {
