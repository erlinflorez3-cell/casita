...
public class DropShadowKeyframeAnimation implements BaseKeyframeAnimation.AnimationListener {
    ...
    public DropShadow evaluate(Matrix matrix, int i2) {
        ...
        DropShadow dropShadow = new DropShadow(fFloatValue2 * AFTER_EFFECT_SOFTNESS_SCALE_FACTOR, fSin, fCos, Color.argb(Math.round((this.opacity.getValue().floatValue() * i2) / 255.0f), Color.red(iIntValue), Color.green(iIntValue), Color.blue(iIntValue)));
