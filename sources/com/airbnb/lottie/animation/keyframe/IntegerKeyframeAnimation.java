...
public class IntegerKeyframeAnimation extends KeyframeAnimation<Integer> {
    ...
    int getIntValue(Keyframe<Integer> keyframe, float f2) {
        ...
        return (this.valueCallback == null || (num = (Integer) this.valueCallback.getValueInternal(keyframe.startFrame, keyframe.endFrame.floatValue(), keyframe.startValue, Integer.valueOf(startValueInt), f2, getLinearCurrentKeyframeProgress(), getProgress())) == null) ? MiscUtils.lerp(keyframe.getStartValueInt(), startValueInt, f2) : num.intValue();
    }
