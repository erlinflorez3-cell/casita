...
public class RepeaterContent implements DrawingContent, PathContent, GreedyContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public void draw(Canvas canvas, Matrix matrix, int i2, DropShadow dropShadow) {
        ...
        for (int i3 = ((int) fFloatValue) - 1; i3 >= 0; i3--) {
            ...
            this.contentGroup.draw(canvas, this.matrix, (int) (i2 * MiscUtils.lerp(fFloatValue3, fFloatValue4, f2 / fFloatValue)), dropShadow);
        }
    }
    ...
    public void resolveKeyPath(KeyPath keyPath, int i2, List<KeyPath> list, KeyPath keyPath2) {
        ...
        for (int i3 = 0; i3 < this.contentGroup.getContents().size(); i3++) {
            Content content = this.contentGroup.getContents().get(i3);
            if (content instanceof KeyPathElementContent) {
                MiscUtils.resolveKeyPath(keyPath, i2, list, keyPath2, (KeyPathElementContent) content);
            }
        }
    }
