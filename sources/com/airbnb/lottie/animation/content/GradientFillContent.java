...
public class GradientFillContent implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    private LinearGradient getLinearGradient() {
        ...
        LinearGradient linearGradient2 = new LinearGradient(value.x, value.y, value2.x, value2.y, iArr, positions, Shader.TileMode.CLAMP);
    ...
    private RadialGradient getRadialGradient() {
        ...
        RadialGradient radialGradient2 = new RadialGradient(f2, f3, fHypot, iArr, positions, Shader.TileMode.CLAMP);
