...
public final class OnAnimationFinishEvent extends Event<OnAnimationFinishEvent> {
    ...
    public OnAnimationFinishEvent(int i2, int i3, boolean z2) {
        super(i2, i3);
        this.isCancelled = z2;
    }
