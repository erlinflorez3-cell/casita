...
@InterfaceC1492Gx
@Metadata(bv = {}, d1 = {"Я\u000e\u001d̉=!4i\bDRo|İY\u0012>éFD\u0015!Z\u0011 \u0007\u0015j\u007fӄǸiI"}, d2 = {"Bn=2g>H`\u001fm\u000fi,f\u0016\u0018u\u0007/", "\u001ab^:\"+R\\\u0015\u000e\bZ*|R+g\u007f1\u000b\n~!\u001fOy\u0017\u0006t/>b}\u001eFq'2\\W\u0005T4-'rn?uw7NL", "", "1n\\zW@GO(\fv\\,E\u00051e\t7uM\u0001\u001e\u0017C}\u000e"}, k = 2, mv = {2, 0, 0}, pn = "", xi = 48, xs = "")
public final class NetworkConnectivityCheckerImplKt {
    public static final NetworkType toNetworkTypeOrNull(String str) {
        ...
        while (true) {
            ...
            next = it.next();
            if (Intrinsics.areEqual(next.toString(), str)) {
                break;
            }
        }
        return next;
