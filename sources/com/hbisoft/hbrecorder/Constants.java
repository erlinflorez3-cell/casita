...
public class Constants {
    ...
    public static final String ON_PAUSE = "Paused";
    public static final String ON_PAUSE_KEY = "onPause";
    public static final String ON_RESUME = "Resumed";
    public static final String ON_RESUME_KEY = "onResume";
