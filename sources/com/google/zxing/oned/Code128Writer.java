...
public final class Code128Writer extends OneDimensionalCodeWriter {
    ...
    private static int chooseCode(CharSequence charSequence, int i2, int i3) {
        ...
        if (cTypeFindCType3 == CType.UNCODABLE) {
            return (i2 >= charSequence.length() || ((cCharAt = charSequence.charAt(i2)) >= ' ' && (i3 != 101 || (cCharAt >= '`' && (cCharAt < 241 || cCharAt > 244))))) ? 100 : 101;
        }
        if (i3 == 101 && cTypeFindCType3 == CType.FNC_1) {
            return 101;
        }
        if (i3 == 99) {
            return 99;
        ...
        if (cTypeFindCType3 == CType.FNC_1 || (cTypeFindCType = findCType(charSequence, i2 + 2)) == CType.UNCODABLE || cTypeFindCType == CType.ONE_DIGIT) {
            return 100;
        }
