...
public final class CodaBarReader extends OneDReader {
    ...
    private int toNarrowWidePattern(int i2) {
        ...
        for (int i17 = 0; i17 < 7; i17++) {
            i15 >>= 1;
            if (iArr[i2 + i17] > ((i17 + 1) - (1 | i17) == 0 ? i10 : i14)) {
                i16 = (i16 + i15) - (i16 & i15);
            }
        }
        while (true) {
    ...
    private void validatePattern(int i2) throws NotFoundException {
        ...
        loop3: while (true) {
            ...
            for (int i14 = 6; i14 >= 0; i14--) {
                int i15 = ((-1) - (((-1) - i14) | ((-1) - 1))) + (((i13 + 1) - (1 | i13)) << 1);
    ...
    public Result decodeRow(int i2, BitArray bitArray, Map<DecodeHintType, ?> map) throws NotFoundException {
        ...
        float f3 = i10;
        float f4 = i2;
        return new Result(this.decodeRowResult.toString(), null, new ResultPoint[]{new ResultPoint(f2, f4), new ResultPoint(f3, f4)}, BarcodeFormat.CODABAR);
    }
}
