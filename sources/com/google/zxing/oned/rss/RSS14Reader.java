...
public final class RSS14Reader extends AbstractRSSReader {
    ...
    /* JADX WARN: Removed duplicated region for block: B:65:0x00bc A[PHI: r9 r11
  0x00bc: PHI (r9v5 boolean) = (r9v2 boolean), (r9v14 boolean) binds: [B:62:0x00b7, B:64:0x00ba] A[DONT_GENERATE, DONT_INLINE]
  0x00bc: PHI (r11v5 boolean) = (r11v2 boolean), (r11v10 boolean) binds: [B:62:0x00b7, B:64:0x00ba] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:66:0x00c0 A[PHI: r9 r11
  0x00c0: PHI (r9v4 boolean) = (r9v2 boolean), (r9v14 boolean) binds: [B:62:0x00b7, B:64:0x00ba] A[DONT_GENERATE, DONT_INLINE]
  0x00c0: PHI (r11v4 boolean) = (r11v2 boolean), (r11v10 boolean) binds: [B:62:0x00b7, B:64:0x00ba] A[DONT_GENERATE, DONT_INLINE]] */
    /*
    ...
    */
    ...
    private FinderPattern parseFoundFinderPattern(BitArray bitArray, int i2, boolean z2, int[] iArr) throws NotFoundException {
        ...
        int i6 = iArr[1];
        if (z2) {
            size2 = (bitArray.getSize() - 1) - i4;
            size = (bitArray.getSize() - 1) - i6;
        } else {
            size = i6;
            size2 = i4;
        }
        return new FinderPattern(finderValue, new int[]{i4, iArr[1]}, size2, size, i2);
    }
