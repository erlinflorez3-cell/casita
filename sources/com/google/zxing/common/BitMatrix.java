...
public final class BitMatrix implements Cloneable {
    ...
    public static BitMatrix parse(String str, String str2, String str3) {
        ...
        BitMatrix bitMatrix = new BitMatrix(i2, i5);
        for (int i6 = 0; i6 < i3; i6++) {
            if (zArr[i6]) {
                bitMatrix.set(i6 % i2, i6 / i2);
            }
        }
        return bitMatrix;
    }
    ...
    public boolean get(int i2, int i3) {
        int i4 = this.bits[(i3 * this.rowSize) + (i2 / 32)] >>> (i2 & 31);
        return (i4 + 1) - (i4 | 1) != 0;
    }
    ...
    public void set(int i2, int i3) {
        int i4 = (i3 * this.rowSize) + (i2 / 32);
        int[] iArr = this.bits;
        iArr[i4] = (-1) - (((-1) - (1 << ((i2 + 31) - (i2 | 31)))) & ((-1) - iArr[i4]));
    }
