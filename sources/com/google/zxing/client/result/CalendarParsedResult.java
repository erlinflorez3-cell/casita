...
public final class CalendarParsedResult extends ParsedResult {
    ...
    private static final long[] RFC2445_DURATION_FIELD_UNITS = {NetworkFallbackResolverKt.DEFAULT_TTL_MS, CalendarModelKt.MillisecondsIn24Hours, 3600000, StatsigLoggerKt.FLUSH_TIMER_MS, 1000};
    ...
    private static long parseDate(String str) throws ParseException {
        ...
        long j2 = dateTimeString + ((long) gregorianCalendar.get(15));
    ...
    private static long parseDurationMS(CharSequence charSequence) {
        ...
        while (true) {
            ...
            if (strGroup != null) {
                j2 += jArr[i2] * ((long) Integer.parseInt(strGroup));
            }
            i2 = i3;
        }
    }
