...
public final class AddressBookDoCoMoResultParser extends AbstractDoCoMoResultParser {
    ...
    public AddressBookParsedResult parse(Result result) {
        ...
        return new AddressBookParsedResult(maybeWrap(name), null, strMatchSingleDoCoMoPrefixedField, strArrMatchDoCoMoPrefixedField2, null, strArrMatchDoCoMoPrefixedField3, null, null, strMatchSingleDoCoMoPrefixedField2, strArrMatchDoCoMoPrefixedField4, null, matchSingleDoCoMoPrefixedField("ORG:", massagedText, true), isStringOfDigits(strMatchSingleDoCoMoPrefixedField3, 8) ? strMatchSingleDoCoMoPrefixedField3 : null, null, matchDoCoMoPrefixedField("URL:", massagedText), null);
    }
}
