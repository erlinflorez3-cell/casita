...
final class ModulusPoly {
    ...
    int evaluateAt(int i2) {
        ...
        for (int i4 = 1; i4 < length; i4++) {
            ...
            iAdd2 = modulusGF.add(modulusGF.multiply(i2, iAdd2), this.coefficients[i4]);
        }
        return iAdd2;
    }
    ...
    ModulusPoly multiplyByMonomial(int i2, int i3) {
        if (i2 < 0) {
            throw new IllegalArgumentException();
        }
        if (i3 == 0) {
