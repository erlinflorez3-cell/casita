...
final class PDF417HighLevelEncoder {
    ...
    private static final byte[] TEXT_PUNCTUATION_RAW = {59, 60, 62, 64, 91, 92, 93, 95, 96, 126, 33, Ascii.CR, 9, 44, 58, 10, 45, 46, 36, 47, 34, 124, 42, 40, 41, Utf8.REPLACEMENT_BYTE, 123, 125, 39, 0};
        ...
        if (i3 >= 6) {
            ...
            while ((i2 + i3) - i5 >= 6) {
                ...
                for (int i6 = 0; i6 < 6; i6++) {
                    j2 = (j2 << 8) + ((long) ((-1) - (((-1) - bArr[i5 + i6]) | ((-1) - 255))));
                }
    ...
    private static void encodeNumeric(String str, int i2, int i3, StringBuilder sb) {
        ...
        while (i4 < i3) {
            ...
            int i5 = i2 + i4;
            BigInteger bigInteger = new BigInteger("1" + str.substring(i5, i5 + iMin));
            do {
    ...
    /* JADX WARN: Removed duplicated region for block: B:68:0x0033 A[EDGE_INSN: B:68:0x0033->B:12:0x0033 BREAK  A[LOOP:0: B:3:0x0009->B:91:0x0009], SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:93:0x0009 A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static int encodeText(java.lang.CharSequence r13, int r14, int r15, java.lang.StringBuilder r16, int r17) {
        /*
