...
public final class Detector {
    ...
    static final class Point {
        ...
        private final int f3540x;

        /* JADX INFO: renamed from: y, reason: collision with root package name */
        private final int f3541y;
        ...
        ResultPoint toResultPoint() {
            return new ResultPoint(this.f3540x, this.f3541y);
        }

        public String toString() {
            return "<" + this.f3540x + TokenParser.SP + this.f3541y + Typography.greater;
        }
    }
    ...
    private void extractParameters(ResultPoint[] resultPointArr) throws NotFoundException {
        ...
        if (this.compact) {
            ...
            this.nbDataBlocks = ((-1) - (((-1) - correctedParameterData) | ((-1) - 2047))) + 1;
        }
    }
    ...
    private Point getMatrixCenter() {
        ...
        try {
            ...
            resultPoint = resultPointArrDetect[0];
            resultPoint2 = resultPointArrDetect[1];
            resultPoint3 = resultPointArrDetect[2];
            resultPoint4 = resultPointArrDetect[3];
        } catch (NotFoundException unused) {
            int width = this.image.getWidth() / 2;
            int height = this.image.getHeight() / 2;
            int i2 = width + 7;
            int i3 = height - 7;
            resultPoint = getFirstDifferent(new Point(i2, i3), false, 1, -1).toResultPoint();
            int i4 = height + 7;
            resultPoint2 = getFirstDifferent(new Point(i2, i4), false, 1, 1).toResultPoint();
            int i5 = width - 7;
            resultPoint3 = getFirstDifferent(new Point(i5, i4), false, -1, 1).toResultPoint();
            resultPoint4 = getFirstDifferent(new Point(i5, i3), false, -1, -1).toResultPoint();
        }
        int iRound = MathUtils.round((((resultPoint.getX() + resultPoint4.getX()) + resultPoint2.getX()) + resultPoint3.getX()) / 4.0f);
        int iRound2 = MathUtils.round((((resultPoint.getY() + resultPoint4.getY()) + resultPoint2.getY()) + resultPoint3.getY()) / 4.0f);
        try {
