...
public final class Decoder {
    ...
    private static final String[] UPPER_TABLE = {"CTRL_PS", Global.BLANK, ExifInterface.GPS_MEASUREMENT_IN_PROGRESS, "B", "C", "D", ExifInterface.LONGITUDE_EAST, "F", "G", "H", "I", "J", "K", "L", "M", "N", "O", "P", "Q", "R", ExifInterface.LATITUDE_SOUTH, ExifInterface.GPS_DIRECTION_TRUE, "U", ExifInterface.GPS_MEASUREMENT_INTERRUPTED, ExifInterface.LONGITUDE_WEST, "X", "Y", "Z", "CTRL_LL", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    private static final String[] LOWER_TABLE = {"CTRL_PS", Global.BLANK, "a", "b", "c", "d", "e", Constants.FLUSH_KEY, "g", "h", ContextChain.TAG_INFRA, "j", "k", "l", "m", com.braze.Constants.BRAZE_PUSH_CUSTOM_NOTIFICATION_ID, "o", "p", "q", "r", com.braze.Constants.BRAZE_PUSH_SUMMARY_TEXT_KEY, "t", "u", "v", "w", "x", "y", "z", "CTRL_US", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    private static final String[] MIXED_TABLE = {"CTRL_PS", Global.BLANK, "\u0001", "\u0002", "\u0003", "\u0004", "\u0005", "\u0006", "\u0007", "\b", "\t", "\n", "\u000b", "\f", "\r", "\u001b", "\u001c", "\u001d", "\u001e", "\u001f", "@", "\\", "^", Global.UNDERSCORE, "`", "|", "~", "\u007f", "CTRL_LL", "CTRL_UL", "CTRL_PL", "CTRL_BS"};
    private static final String[] PUNCT_TABLE = {"", "\r", "\r\n", ". ", ", ", ": ", "!", "\"", "#", "$", "%", "&", "'", "(", ")", ProxyConfig.MATCH_ALL_SCHEMES, "+", ",", Global.HYPHEN, ".", RemoteSettings.FORWARD_SLASH_STRING, Global.COLON, Global.SEMICOLON, "<", "=", ">", Global.QUESTION, "[", "]", "{", "}", "CTRL_UL"};
    private static final String[] DIGIT_TABLE = {"CTRL_PS", Global.BLANK, AdkSettings.PLATFORM_TYPE_MOBILE, "1", ExifInterface.GPS_MEASUREMENT_2D, ExifInterface.GPS_MEASUREMENT_3D, "4", "5", "6", "7", "8", "9", ",", ".", "CTRL_UL", "CTRL_US"};
        ...
        while (i8 < nbLayers) {
            ...
            while (i13 < i10) {
                ...
                while (i15 < i3) {
                    ...
                    int i20 = iArr[i19];
                    int i21 = i12 - i13;
                    zArr[(i10 * 4) + i9 + i14 + i15] = bitMatrix.get(i20, iArr[i21]);
                    zArr[(i10 * 6) + i9 + i14 + i15] = bitMatrix.get(iArr[i21], iArr[i16]);
                    i15++;
                    i3 = 2;
                }
                i13++;
