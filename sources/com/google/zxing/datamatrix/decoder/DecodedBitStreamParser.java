...
final class DecodedBitStreamParser {
    ...
    static {
        char[] cArr = {'!', '\"', '#', Typography.dollar, '%', Typography.amp, '\'', '(', ')', '*', '+', AbstractJsonLexerKt.COMMA, Soundex.SILENT_MARKER, '.', '/', AbstractJsonLexerKt.COLON, ';', Typography.less, '=', Typography.greater, '?', '@', AbstractJsonLexerKt.BEGIN_LIST, '\\', AbstractJsonLexerKt.END_LIST, '^', '_'};
                ...
                if (i2 != 0) {
                    if (i2 != 1) {
                        if (i2 == 2) {
                            ...
                            if (z2) {
                                sb.append((char) (i4 + CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY));
                                z2 = false;
                                i2 = 0;
                            } else {
    ...
    private static void parseTwoBytes(int i2, int i3, int[] iArr) {
        int i4 = ((i2 << 8) + i3) - 1;
        int i5 = i4 / IDStepResponseCodes.STEP_LAUNCH_REQUEST;
        iArr[0] = i5;
        int i6 = i4 - (i5 * IDStepResponseCodes.STEP_LAUNCH_REQUEST);
        int i7 = i6 / 40;
        iArr[1] = i7;
        iArr[2] = i6 - (i7 * 40);
    }
