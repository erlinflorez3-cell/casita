...
class KmlStyleParser {
    ...
    static HashMap<String, String> createStyleMap(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (eventType == 2) {
                if (xmlPullParser.getName().equals(STYLE_MAP_KEY) && xmlPullParser.nextText().equals("normal")) {
                    z2 = true;
    ...
    private static void setIconHotSpot(XmlPullParser xmlPullParser, KmlStyle kmlStyle) {
        try {
            ...
            String str = "Missing 'x' or 'y' attributes in hotSpot for style with id: " + kmlStyle.getStyleId();
        } catch (NumberFormatException unused2) {
            String str2 = "Invalid number in 'x' or 'y' attributes in hotSpot for style with id: " + kmlStyle.getStyleId();
        }
    }
