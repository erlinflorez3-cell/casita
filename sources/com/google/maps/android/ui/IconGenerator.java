...
public class IconGenerator {
    ...
    private static int getStyleColor(int i2) {
        if (i2 == 3) {
            return -3407872;
        }
        if (i2 == 4) {
    ...
    private static int getTextStyle(int i2) {
    ...
    public void setContentRotation(int i2) {
        this.mRotationLayout.setViewRotation(i2);
    }
    ...
    public void setStyle(int i2) {
        setColor(getStyleColor(i2));
        setTextAppearance(this.mContext, getTextStyle(i2));
    }
