...
public class AnalyticsConnectorImpl implements AnalyticsConnector {
    private static volatile AnalyticsConnector zzb = null;
    ...
    public static AnalyticsConnector getInstance(FirebaseApp firebaseApp, Context context, Subscriber subscriber) throws Throwable {
        Preconditions.checkNotNull(firebaseApp);
        Preconditions.checkNotNull(context);
        Preconditions.checkNotNull(subscriber);
        Object[] objArr = new Object[0];
        Method method = Class.forName(C1593ug.zd("=KBQOJF\u0011GTT[MW^\u0019/\\\\cUif", (short) (C1580rY.Xd() ^ (-6642)), (short) (C1580rY.Xd() ^ (-24955)))).getMethod(C1561oA.od("\u0011\u000e\u001cg\u0016\u0015\u0010\f\u0005\u0002\u0014\b\r\u000b^\n\b\r|\u000f\n", (short) (FB.Xd() ^ 9771)), new Class[0]);
        try {
                ...
                synchronized (AnalyticsConnectorImpl.class) {
                    if (zzb == null) {
                        ...
                        if (firebaseApp.isDefaultApp()) {
                            ...
                            bundle.putBoolean(C1561oA.Kd("\u0018\u0016*\u0018z(&'! 2(//\u0006(*&;3<\u000e8,.933", (short) (OY.Xd() ^ 12416)), firebaseApp.isDataCollectionDefaultEnabled());
                        }
