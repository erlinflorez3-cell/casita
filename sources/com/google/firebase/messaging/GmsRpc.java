...
class GmsRpc {
    ...
    private static String base64UrlSafe(byte[] bArr) throws Throwable {
        Class<?> cls = Class.forName(C1561oA.Yd("Vd[jhc_*rrhl/Ddwj<;", (short) (Od.Xd() ^ (-599))));
        Class<?>[] clsArr = {byte[].class, Integer.TYPE};
        Object[] objArr = {bArr, 11};
        short sXd = (short) (C1580rY.Xd() ^ (-19722));
        short sXd2 = (short) (C1580rY.Xd() ^ (-11907));
        int[] iArr = new int["\u001e(\u001e+!#\u0013/\u001465-3-".length()];
        QB qb = new QB("\u001e(\u001e+!#\u0013/\u001465-3-");
        int i2 = 0;
        while (qb.YK()) {
            int iKK = qb.KK();
    ...
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.continueWith(new AdIdManager$Api33Ext4Impl$$ExternalSyntheticLambda0(), new Continuation() { // from class: com.google.firebase.messaging.GmsRpc$$ExternalSyntheticLambda0
            ...
            public final Object then(Task task2) {
                return this.f$0.m7770xb80eb67f(task2);
            }
        });
    }
    ...
    private void setDefaultAttributesToBundle(String str, String str2, Bundle bundle) throws ExecutionException, InterruptedException {
        ...
        bundle.putString(PARAM_CLIENT_VER, "fcm-24.0.3");
    ...
    /* synthetic */ String m7770xb80eb67f(Task task) throws Exception {
        return handleResponse((Bundle) task.getResult(IOException.class));
    }

    Task<Void> setRetainProxiedNotifications(boolean z2) {
