...
public class NotificationParams {
    ...
    public Integer getInteger(String str) {
        ...
        try {
            ...
            String str2 = "Couldn't parse value of " + userFriendlyKey(str) + "(" + string + ") into an int";
            return null;
        }
    }
    ...
    public JSONArray getJSONArray(String str) {
        ...
        try {
            ...
            String str2 = "Malformed JSON for key " + userFriendlyKey(str) + ": " + string + ", falling back to default";
            return null;
        }
    }
    ...
    int[] getLightSettings() {
        ...
        try {
            ...
            String str = "LightSettings is invalid: " + jSONArray + ". " + e2.getMessage() + ". Skipping setting LightSettings";
            return null;
        } catch (JSONException unused) {
            String str2 = "LightSettings is invalid: " + jSONArray + ". Skipping setting LightSettings";
            return null;
        }
    }
    ...
    public String getLocalizedString(Resources resources, String str, String str2) {
        ...
        if (identifier == 0) {
            String str3 = userFriendlyKey(str2 + Constants.MessageNotificationKeys.TEXT_RESOURCE_SUFFIX) + " resource not found: " + str2 + " Default value will be used.";
            return null;
        }
        ...
        try {
            ...
            String str4 = "Missing format argument for " + userFriendlyKey(str2) + ": " + Arrays.toString(localizationArgsForKey) + " Default value will be used.";
            return null;
        }
    }
    ...
    public Long getLong(String str) {
        ...
        try {
            ...
            String str2 = "Couldn't parse value of " + userFriendlyKey(str) + "(" + string + ") into a long";
            return null;
        }
    }
    ...
    Integer getNotificationCount() {
        ...
        String str = "notificationCount is invalid: " + integer + ". Skipping setting notificationCount.";
        return null;
    }
    ...
    Integer getNotificationPriority() {
        ...
        String str = "notificationPriority is invalid " + integer + ". Skipping setting notificationPriority.";
        return null;
    }
    ...
    public long[] getVibrateTimings() {
        ...
        try {
            ...
            String str = "User defined vibrateTimings is invalid: " + jSONArray + ". Skipping setting vibrateTimings.";
            return null;
        }
    }
    ...
    Integer getVisibility() {
        ...
        String str = "visibility is invalid: " + integer + ". Skipping setting visibility.";
        return null;
    }
