...
public class DefaultUserAgentPublisher implements UserAgentPublisher {
    ...
    public String getUserAgent() {
        return this.gamesSDKRegistrar.getRegisteredVersions().isEmpty() ? this.javaSDKVersionUserAgent : this.javaSDKVersionUserAgent + TokenParser.SP + toUserAgent(this.gamesSDKRegistrar.getRegisteredVersions());
    }
}
