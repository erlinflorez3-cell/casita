...
class CrashlyticsController {
    ...
    private void doCloseSessions(boolean z2, SettingsProvider settingsProvider, boolean z3) throws Throwable {
        String str;
    ...
    private void writeApplicationExitInfoEventIfRelevant(String str) throws Throwable {
        if (Build.VERSION.SDK_INT < 30) {
            Logger.getLogger().v(Ig.wd("<rf\u0017,}\u0010A\u0007VEgySDh*#G\u0019R>mrO\">\u000b\u001eC[;'XM\"Zq;", (short) (C1499aX.Xd() ^ (-1057))) + Build.VERSION.SDK_INT);
            return;
        }
        Context context = this.context;
        Object[] objArr = {C1561oA.Yd("\f\u000f!\u0017%\u0019%+", (short) (ZN.Xd() ^ 22345))};
        Method method = Class.forName(Xg.qd("7E<KID@\u000bANNUGQX\u0013)VV]Oc`", (short) (Od.Xd() ^ (-21772)), (short) (Od.Xd() ^ (-19364)))).getMethod(ZO.xd("qKt^\u000b!>g \u0018\u0010n\u0014'}f", (short) (C1499aX.Xd() ^ (-25491)), (short) (C1499aX.Xd() ^ (-7461))), Class.forName(Jg.Wd("\r\u001a\t\r3\fZ\u0001R32lDU4F", (short) (C1499aX.Xd() ^ (-2259)), (short) (C1499aX.Xd() ^ (-8028)))));
        try {
            ...
            short sXd = (short) (C1633zX.Xd() ^ (-6707));
            short sXd2 = (short) (C1633zX.Xd() ^ (-985));
            int[] iArr = new int["F{\u0003|\u0015\u001bVD>O(<\u0013ze\u0019.L\u0012\u000b*\u000b~W'AFV\u001b$\tbZrNkE - 6;\u0018".length()];
            QB qb = new QB("F{\u0003|\u0015\u001bVD>O(<\u0013ze\u0019.L\u0012\u000b*\u000b~W'AFV\u001b$\tbZrNkE - 6;\u0018");
            int i2 = 0;
            while (qb.YK()) {
                int iKK = qb.KK();
                Xu xuXd = Xu.Xd(iKK);
            ...
            logger.v(new String(iArr, 0, i2) + str);
    ...
    void doCloseSessions(SettingsProvider settingsProvider) throws Throwable {
    ...
    boolean finalizeSessions(SettingsProvider settingsProvider) throws Throwable {
        CrashlyticsWorkers.checkBackgroundThread();
    ...
    String getVersionControlInfo() throws Throwable {
        InputStream resourceAsStream = getResourceAsStream(EO.Od("*g\u0007\u001a\u0011i@;RL7d\u0010\u0016\u0006)\u00040\u0014j0\u0006\\]muX*\t5O$\u0007h~B\u0017\u007fS", (short) (C1499aX.Xd() ^ (-27564))));
        if (resourceAsStream == null) {
            return null;
        }
        Logger.getLogger().d(C1561oA.Qd("\u001d/*,f<*66+0.^!,*/,($V\u001f#\u001a\"", (short) (Od.Xd() ^ (-18781))));
        Object[] objArr = {readResource(resourceAsStream), 0};
        Method declaredMethod = Class.forName(C1593ug.zd("u\u0004z\n\b\u0003~I\u0012\u0012\b\fNc\u0004\u0017\n[Z", (short) (C1499aX.Xd() ^ (-12527)), (short) (C1499aX.Xd() ^ (-27616)))).getDeclaredMethod(C1561oA.od("\u0018 \u0014\u001f\u0013\u0013\u0001\u001b}\u001e\u001b\u0011\u0015\r", (short) (ZN.Xd() ^ 12728)), byte[].class, Integer.TYPE);
        try {
    ...
    synchronized void handleUncaughtException(final SettingsProvider settingsProvider, final Thread thread, final Throwable th, final boolean z2) {
            ...
            public Task<Void> call() throws Exception {
                ...
                return !CrashlyticsController.this.dataCollectionArbiter.isAutomaticDataCollectionEnabled() ? Tasks.forResult(null) : settingsProvider.getSettingsAsync().onSuccessTask(CrashlyticsController.this.crashlyticsWorkers.common, new SuccessContinuation<Settings, Void>() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsController.2.1
                    ...
                    public Task<Void> then(Settings settings) throws Exception {
                        ...
                        taskArr[1] = CrashlyticsController.this.reportingCoordinator.sendReports(CrashlyticsController.this.crashlyticsWorkers.common, z2 ? currentSessionId : null);
    ...
    /* synthetic */ void m7725xe0c67ca9(String str) {
    ...
    void openSession(final String str) {
        this.crashlyticsWorkers.common.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsController$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m7725xe0c67ca9(str);
            }
        });
    }

    void saveVersionControlInfo() throws Throwable {
        try {
