...
public class CrashlyticsReportPersistence {
    ...
    private void synthesizeReportFile(File file, List<CrashlyticsReport.Session.Event> list, long j2, boolean z2, String str, String str2) {
        try {
            CrashlyticsReportJsonTransform crashlyticsReportJsonTransform = TRANSFORM;
            CrashlyticsReport crashlyticsReportWithEvents = crashlyticsReportJsonTransform.reportFromJson(readTextFile(file)).withSessionEndFields(j2, z2, str).withAppQualitySessionId(str2).withEvents(list);
    ...
    public void persistEvent(CrashlyticsReport.Session.Event event, String str, boolean z2) {
