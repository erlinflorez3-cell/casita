...
public abstract class CrashlyticsReport {
    ...
    public static abstract class Session {
        ...
        Session withSessionEndFields(long j2, boolean z2, String str) {
    ...
    public CrashlyticsReport withSessionEndFields(long j2, boolean z2, String str) {
        Builder builder = toBuilder();
        if (getSession() != null) {
