...
final class JsonValueObjectEncoderContext implements ObjectEncoderContext, ValueEncoderContext {
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public ObjectEncoderContext add(FieldDescriptor fieldDescriptor, boolean z2) throws IOException {
    ...
    JsonValueObjectEncoderContext add(Object obj, boolean z2) throws IOException {
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public JsonValueObjectEncoderContext add(String str, int i2) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(i2);
    }
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public JsonValueObjectEncoderContext add(String str, long j2) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(j2);
    }
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public JsonValueObjectEncoderContext add(String str, boolean z2) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(z2);
    }
    ...
    @Override // com.google.firebase.encoders.ValueEncoderContext
    public JsonValueObjectEncoderContext add(byte[] bArr) throws Throwable {
        maybeUnNest();
        if (bArr == null) {
            this.jsonWriter.nullValue();
        } else {
            JsonWriter jsonWriter = this.jsonWriter;
            short sXd = (short) (C1580rY.Xd() ^ (-16155));
            short sXd2 = (short) (C1580rY.Xd() ^ (-27706));
            int[] iArr = new int["UcZigb^)qqgk.Ccvi;:".length()];
            QB qb = new QB("UcZigb^)qqgk.Ccvi;:");
            int i2 = 0;
            while (qb.YK()) {
                int iKK = qb.KK();
                Xu xuXd = Xu.Xd(iKK);
            ...
            short sXd3 = (short) (ZN.Xd() ^ 7814);
            int[] iArr2 = new int["v~r}qq_y\\|yosk".length()];
            QB qb2 = new QB("v~r}qq_y\\|yosk");
            int i3 = 0;
            while (qb2.YK()) {
                int iKK2 = qb2.KK();
                Xu xuXd2 = Xu.Xd(iKK2);
            ...
            try {
                ...
                jsonWriter.value((String) declaredMethod.invoke(null, objArr));
    ...
    JsonValueObjectEncoderContext doEncode(ObjectEncoder<Object> objectEncoder, Object obj, boolean z2) throws IOException {
        if (!z2) {
            this.jsonWriter.beginObject();
        }
