...
public final class ImmutableLongArray implements Serializable {
        ...
        public boolean equals(@CheckForNull Object object) {
            ...
            for (Object obj : list) {
                if (obj instanceof Long) {
                    int i3 = i2 + 1;
                    if (this.parent.array[i2] == ((Long) obj).longValue()) {
                        i2 = i3;
                    }
                }
                return false;
    ...
    public static ImmutableLongArray copyOf(Iterable<Long> values) {
        return values instanceof Collection ? copyOf((Collection<Long>) values) : builder().addAll(values).build();
    }
    ...
    public static ImmutableLongArray of(long e02, long e12, long e2) {
        return new ImmutableLongArray(new long[]{e02, e12, e2});
    }

    public static ImmutableLongArray of(long e02, long e12, long e2, long e3) {
        return new ImmutableLongArray(new long[]{e02, e12, e2, e3});
    }

    public static ImmutableLongArray of(long e02, long e12, long e2, long e3, long e4) {
        return new ImmutableLongArray(new long[]{e02, e12, e2, e3, e4});
    }

    public static ImmutableLongArray of(long e02, long e12, long e2, long e3, long e4, long e5) {
        return new ImmutableLongArray(new long[]{e02, e12, e2, e3, e4, e5});
    }
    ...
    public ImmutableLongArray subArray(int startIndex, int endIndex) {
        ...
        long[] jArr = this.array;
        int i2 = this.start;
        return new ImmutableLongArray(jArr, startIndex + i2, i2 + endIndex);
    }
