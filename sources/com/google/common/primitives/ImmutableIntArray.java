...
public final class ImmutableIntArray implements Serializable {
        ...
        public boolean equals(@CheckForNull Object object) {
            ...
            for (Object obj : list) {
                if (obj instanceof Integer) {
                    int i3 = i2 + 1;
                    if (this.parent.array[i2] == ((Integer) obj).intValue()) {
                        i2 = i3;
                    }
                }
                return false;
    ...
    public static ImmutableIntArray copyOf(Iterable<Integer> values) {
        return values instanceof Collection ? copyOf((Collection<Integer>) values) : builder().addAll(values).build();
    }
    ...
    public static ImmutableIntArray of(int e02, int e12, int e2) {
        return new ImmutableIntArray(new int[]{e02, e12, e2});
    }

    public static ImmutableIntArray of(int e02, int e12, int e2, int e3) {
        return new ImmutableIntArray(new int[]{e02, e12, e2, e3});
    }

    public static ImmutableIntArray of(int e02, int e12, int e2, int e3, int e4) {
        return new ImmutableIntArray(new int[]{e02, e12, e2, e3, e4});
    }

    public static ImmutableIntArray of(int e02, int e12, int e2, int e3, int e4, int e5) {
        return new ImmutableIntArray(new int[]{e02, e12, e2, e3, e4, e5});
    }
    ...
    public ImmutableIntArray subArray(int startIndex, int endIndex) {
        ...
        int[] iArr = this.array;
        int i2 = this.start;
        return new ImmutableIntArray(iArr, startIndex + i2, i2 + endIndex);
    }
