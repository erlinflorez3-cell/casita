...
public final class Bytes {
    ...
    private static class ByteArrayAsList extends AbstractList<Byte> implements RandomAccess, Serializable {
        ...
        public Byte set(int index, Byte element) {
            ...
            int i2 = this.start;
            byte b2 = bArr[i2 + index];
            bArr[i2 + index] = ((Byte) Preconditions.checkNotNull(element)).byteValue();
        ...
        public List<Byte> subList(int fromIndex, int toIndex) {
            ...
            byte[] bArr = this.array;
            int i2 = this.start;
            return new ByteArrayAsList(bArr, fromIndex + i2, i2 + toIndex);
        }
    ...
    public static List<Byte> asList(byte... backingArray) {
        return backingArray.length == 0 ? Collections.emptyList() : new ByteArrayAsList(backingArray);
    }
