...
public abstract class ForwardingNavigableMap<K, V> extends ForwardingSortedMap<K, V> implements NavigableMap<K, V> {
    ...
    @CheckForNull
    protected K standardCeilingKey(@ParametricNullness K k2) {
    ...
    @CheckForNull
    protected K standardFloorKey(@ParametricNullness K k2) {
    ...
    @CheckForNull
    protected K standardHigherKey(@ParametricNullness K k2) {
    ...
    @CheckForNull
    protected K standardLowerKey(@ParametricNullness K k2) {
