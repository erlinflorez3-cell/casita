...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    private final class AsSet extends ImmutableSortedSet<C> {
        ...
        public boolean contains(@CheckForNull Object o2) {
            ...
            try {
                return ImmutableRangeSet.this.contains((Comparable) o2);
        ...
        public ImmutableSortedSet<C> subSetImpl(C fromElement, boolean fromInclusive, C toElement, boolean toInclusive) {
            return (fromInclusive || toInclusive || Range.compareOrThrow(fromElement, toElement) != 0) ? subSet(Range.range(fromElement, BoundType.forBoolean(fromInclusive), toElement, BoundType.forBoolean(toInclusive))) : ImmutableSortedSet.of();
        }
    ...
    private ImmutableList<Range<C>> intersectRanges(final Range<C> range) {
        ...
        return iBinarySearch2 == 0 ? ImmutableList.of() : (ImmutableList<Range<C>>) new ImmutableList<Range<C>>() { // from class: com.google.common.collect.ImmutableRangeSet.1
            ...
            public Range<C> get(int index) {
                ...
                return (index == 0 || index == iBinarySearch2 + (-1)) ? ((Range) ImmutableRangeSet.this.ranges.get(index + iBinarySearch)).intersection(range) : (Range) ImmutableRangeSet.this.ranges.get(index + iBinarySearch);
            }
    ...
    public boolean intersects(Range<C> otherRange) {
        ...
        if (iBinarySearch > 0) {
            ...
            if (this.ranges.get(i2).isConnected(otherRange) && !this.ranges.get(i2).intersection(otherRange).isEmpty()) {
                return true;
            }
        }
        return false;
