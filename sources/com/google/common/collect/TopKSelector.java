...
final class TopKSelector<T> {
    ...
    public static <T> TopKSelector<T> least(int k2, Comparator<? super T> comparator) {
        return new TopKSelector<>(comparator, k2);
    }

    private int partition(int i2, int i3, int i4) {
        Object objUncheckedCastNullableTToT = NullnessCasts.uncheckedCastNullableTToT(this.buffer[i4]);
        T[] tArr = this.buffer;
        tArr[i4] = tArr[i3];
        int i5 = i2;
        while (i2 < i3) {
            if (this.comparator.compare((Object) NullnessCasts.uncheckedCastNullableTToT(this.buffer[i2]), objUncheckedCastNullableTToT) < 0) {
                swap(i5, i2);
                i5++;
            }
            i2++;
        ...
        T[] tArr2 = this.buffer;
        tArr2[i3] = tArr2[i5];
        tArr2[i5] = objUncheckedCastNullableTToT;
        return i5;
    }
    ...
    private void trim() {
        int i2 = (this.f3506k * 2) - 1;
        int iLog2 = IntMath.log2(i2, RoundingMode.CEILING) * 3;
        int iMax = 0;
        int i3 = 0;
        int i4 = 0;
        while (true) {
