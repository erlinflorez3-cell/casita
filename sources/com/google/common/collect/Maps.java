...
public final class Maps {
    ...
    class AnonymousClass1<K, V> extends TransformedIterator<Map.Entry<K, V>, K> {
        AnonymousClass1(Iterator backingIterator) {
    ...
    class AnonymousClass10<V1, V2> implements Function<V1, V2> {
        ...
        AnonymousClass10(final Object val$key) {
            val$key = val$key;
        }
    ...
    class AnonymousClass12<K, V2> extends AbstractMapEntry<K, V2> {
        ...
        AnonymousClass12(final Map.Entry val$entry, final EntryTransformer val$transformer) {
            val$entry = val$entry;
    ...
    class AnonymousClass2<K, V> extends TransformedIterator<Map.Entry<K, V>, V> {
        AnonymousClass2(Iterator backingIterator) {
            super(backingIterator);
        }
    ...
    class AnonymousClass3<K, V> extends TransformedIterator<K, Map.Entry<K, V>> {
        final /* synthetic */ Function val$function;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass3(Iterator backingIterator, final Function val$function) {
            super(backingIterator);
    ...
    /* JADX INFO: renamed from: com.google.common.collect.Maps$4 */
    class AnonymousClass4<E> extends ForwardingSet<E> {
        final /* synthetic */ Set val$set;

        AnonymousClass4(final Set val$set) {
            val$set = val$set;
        }
    ...
    class AnonymousClass5<E> extends ForwardingSortedSet<E> {
        final /* synthetic */ SortedSet val$set;

        AnonymousClass5(final SortedSet val$set) {
            val$set = val$set;
        }
    ...
    class AnonymousClass6<E> extends ForwardingNavigableSet<E> {
        final /* synthetic */ NavigableSet val$set;

        AnonymousClass6(final NavigableSet val$set) {
            val$set = val$set;
        }
    ...
    class AnonymousClass7<K, V> extends AbstractMapEntry<K, V> {
        final /* synthetic */ Map.Entry val$entry;

        AnonymousClass7(final Map.Entry val$entry) {
            val$entry = val$entry;
        }
    ...
    class AnonymousClass8<K, V> extends UnmodifiableIterator<Map.Entry<K, V>> {
        final /* synthetic */ Iterator val$entryIterator;

        AnonymousClass8(final Iterator val$entryIterator) {
        ...
        public Map.Entry<K, V> next() {
            return Maps.unmodifiableEntry((Map.Entry) val$entryIterator.next());
        }
    }

    /* JADX INFO: renamed from: com.google.common.collect.Maps$9 */
    class AnonymousClass9<K, V1, V2> implements EntryTransformer<K, V1, V2> {
        AnonymousClass9() {
        }
        ...
        public V2 transformEntry(@ParametricNullness K k2, @ParametricNullness V1 v1) {
            return (V2) val$function.apply(v1);
        }
    }
    ...
    private static abstract class AbstractFilteredMap<K, V> extends ViewCachingAbstractMap<K, V> {
        ...
        public V get(@CheckForNull Object key) {
            V v2 = this.unfiltered.get(key);
            if (v2 == null || !apply(key, v2)) {
                return null;
            }
            return v2;
        }
    ...
    private static class AsMapView<K, V> extends ViewCachingAbstractMap<K, V> {
        ...
        /* JADX INFO: renamed from: com.google.common.collect.Maps$AsMapView$1EntrySetImpl */
    ...
    private static final class BiMapConverter<A, B> extends Converter<A, B> implements Serializable {
        ...
        private static <X, Y> Y convert(BiMap<X, Y> bimap, X input) {
            Y y2 = bimap.get(input);
            Preconditions.checkArgument(y2 != null, "No non-null mapping present for input: %s", input);
            return y2;
        }
    ...
    static abstract class DescendingMap<K, V> extends ForwardingMap<K, V> implements NavigableMap<K, V> {
        ...
        /* JADX INFO: renamed from: com.google.common.collect.Maps$DescendingMap$1EntrySetImpl */
        class C1EntrySetImpl extends EntrySet<K, V> {
            C1EntrySetImpl() {
            }
    ...
    private enum EntryFunction implements Function<Map.Entry<?, ?>, Object> {
        ...
        /* JADX INFO: renamed from: com.google.common.collect.Maps$EntryFunction$1 */
        ...
        /* JADX INFO: renamed from: com.google.common.collect.Maps$EntryFunction$2 */
    ...
    static abstract class EntrySet<K, V> extends Sets.ImprovedAbstractSet<Map.Entry<K, V>> {
        ...
        public boolean remove(@CheckForNull Object o2) {
            if (contains(o2) && (o2 instanceof Map.Entry)) {
                return map().keySet().remove(((Map.Entry) o2).getKey());
            }
            return false;
        }
    ...
    static final class FilteredEntryBiMap<K, V> extends FilteredEntryMap<K, V> implements BiMap<K, V> {
        ...
        class AnonymousClass1 implements Predicate<Map.Entry<V, K>> {
            AnonymousClass1() {
            }
    ...
    static class FilteredEntryMap<K, V> extends AbstractFilteredMap<K, V> {
        ...
        private class EntrySet extends ForwardingSet<Map.Entry<K, V>> {
            ...
            /* JADX INFO: renamed from: com.google.common.collect.Maps$FilteredEntryMap$EntrySet$1 */
            class AnonymousClass1 extends TransformedIterator<Map.Entry<K, V>, Map.Entry<K, V>> {

                /* JADX INFO: renamed from: com.google.common.collect.Maps$FilteredEntryMap$EntrySet$1$1 */
                class C01881 extends ForwardingMapEntry<K, V> {
                    final /* synthetic */ Map.Entry val$entry;

                    C01881(final Map.Entry val$entry) {
                        val$entry = val$entry;
                    }
            ...
            public Iterator<Map.Entry<K, V>> iterator() {
                return new TransformedIterator<Map.Entry<K, V>, Map.Entry<K, V>>(FilteredEntryMap.this.filteredEntrySet.iterator()) { // from class: com.google.common.collect.Maps.FilteredEntryMap.EntrySet.1
                    ...
                    @Override // com.google.common.collect.TransformedIterator
                    public Map.Entry<K, V> transform(final Map.Entry entry2) {
                        return new ForwardingMapEntry<K, V>() { // from class: com.google.common.collect.Maps.FilteredEntryMap.EntrySet.1.1
                            final /* synthetic */ Map.Entry val$entry;

                            C01881(final Map.Entry entry22) {
                                val$entry = entry22;
                            }
    ...
    private static class FilteredEntryNavigableMap<K, V> extends AbstractNavigableMap<K, V> {
        ...
        /* JADX INFO: renamed from: com.google.common.collect.Maps$FilteredEntryNavigableMap$1 */
        class AnonymousClass1 extends NavigableKeySet<K, V> {
            AnonymousClass1(NavigableMap map) {
                super(map);
            }
    ...
    private static final class FilteredMapValues<K, V> extends Values<K, V> {
        ...
        public boolean remove(@CheckForNull Object o2) {
            ...
            while (it.hasNext()) {
                Map.Entry<K, V> next = it.next();
                if (this.predicate.apply(next) && Objects.equal(next.getValue(), o2)) {
                    it.remove();
                    return true;
                }
            }
    ...
    static abstract class IteratorBasedAbstractMap<K, V> extends AbstractMap<K, V> {
        ...
        /* JADX INFO: renamed from: com.google.common.collect.Maps$IteratorBasedAbstractMap$1 */
        ...
        public boolean remove(@CheckForNull Object o2) {
            try {
                ...
                for (Map.Entry<K, V> entry : map().entrySet()) {
                    if (Objects.equal(o2, entry.getValue())) {
    ...
    static <K, V> Iterator<Map.Entry<K, V>> asMapEntryIterator(Set<K> set, final Function<? super K, V> function) {
        return new TransformedIterator<K, Map.Entry<K, V>>(set.iterator()) { // from class: com.google.common.collect.Maps.3
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            AnonymousClass3(Iterator backingIterator, final Function function2) {
                super(backingIterator);
    ...
    static <K, V1, V2> Function<V1, V2> asValueToValueFunction(final EntryTransformer<? super K, V1, V2> transformer, @ParametricNullness final K key) {
        ...
        return new Function<V1, V2>() { // from class: com.google.common.collect.Maps.10
            ...
            AnonymousClass10(final Object key2) {
                val$key = key2;
            }
    ...
    static <K, V> boolean containsEntryImpl(Collection<Map.Entry<K, V>> c2, @CheckForNull Object o2) {
        if (o2 instanceof Map.Entry) {
            return c2.contains(unmodifiableEntry((Map.Entry) o2));
        }
        return false;
    }
    ...
    public static <K, V> MapDifference<K, V> difference(Map<? extends K, ? extends V> left, Map<? extends K, ? extends V> right) {
        return left instanceof SortedMap ? difference((SortedMap) left, (Map) right) : difference(left, right, Equivalence.equals());
    }
    ...
    private static <K, V> void doDifference(Map<? extends K, ? extends V> map, Map<? extends K, ? extends V> map2, Equivalence<? super V> equivalence, Map<K, V> map3, Map<K, V> map4, Map<K, V> map5, Map<K, MapDifference.ValueDifference<V>> map6) {
        for (Map.Entry<? extends K, ? extends V> entry : map.entrySet()) {
            ...
            if (map2.containsKey(key)) {
                Architecture architecture = (Object) NullnessCasts.uncheckedCastNullableTToT(map4.remove(key));
                if (equivalence.equivalent(value, architecture)) {
                    map5.put(key, value);
                } else {
                    map6.put(key, ValueDifferenceImpl.create(value, architecture));
                }
            } else {
                map3.put(key, value);
            }
    ...
    public static <K, V> Map<K, V> filterKeys(Map<K, V> unfiltered, final Predicate<? super K> keyPredicate) {
        ...
        return unfiltered instanceof AbstractFilteredMap ? filterFiltered((AbstractFilteredMap) unfiltered, predicateKeyPredicateOnEntries) : new FilteredKeyMap((Map) Preconditions.checkNotNull(unfiltered), keyPredicate, predicateKeyPredicateOnEntries);
    }
    ...
    static <K, V> Iterator<K> keyIterator(Iterator<Map.Entry<K, V>> entryIterator) {
        return new TransformedIterator<Map.Entry<K, V>, K>(entryIterator) { // from class: com.google.common.collect.Maps.1
            AnonymousClass1(Iterator entryIterator2) {
    ...
    static <K, V> boolean removeEntryImpl(Collection<Map.Entry<K, V>> c2, @CheckForNull Object o2) {
        if (o2 instanceof Map.Entry) {
            return c2.remove(unmodifiableEntry((Map.Entry) o2));
        }
        return false;
    }
    ...
    public static <E> NavigableSet<E> removeOnlyNavigableSet(final NavigableSet<E> set) {
        return new ForwardingNavigableSet<E>() { // from class: com.google.common.collect.Maps.6
            ...
            AnonymousClass6(final NavigableSet set2) {
                val$set = set2;
            }
    ...
    public static <E> Set<E> removeOnlySet(final Set<E> set) {
        return new ForwardingSet<E>() { // from class: com.google.common.collect.Maps.4
            ...
            AnonymousClass4(final Set set2) {
                val$set = set2;
            }
    ...
    public static <E> SortedSet<E> removeOnlySortedSet(final SortedSet<E> set) {
        return new ForwardingSortedSet<E>() { // from class: com.google.common.collect.Maps.5
            ...
            AnonymousClass5(final SortedSet set2) {
                val$set = set2;
            }
    ...
    static <V2, K, V1> Map.Entry<K, V2> transformEntry(final EntryTransformer<? super K, ? super V1, V2> transformer, final Map.Entry<K, V1> entry) {
        ...
        return new AbstractMapEntry<K, V2>() { // from class: com.google.common.collect.Maps.12
            ...
            AnonymousClass12(final Map.Entry entry2, final EntryTransformer transformer2) {
                val$entry = entry2;
    ...
    static <K, V> Map.Entry<K, V> unmodifiableEntry(final Map.Entry<? extends K, ? extends V> entry) {
        ...
        return new AbstractMapEntry<K, V>() { // from class: com.google.common.collect.Maps.7
            ...
            AnonymousClass7(final Map.Entry entry2) {
                val$entry = entry2;
            }
    ...
    static <K, V> UnmodifiableIterator<Map.Entry<K, V>> unmodifiableEntryIterator(final Iterator<Map.Entry<K, V>> entryIterator) {
        return new UnmodifiableIterator<Map.Entry<K, V>>() { // from class: com.google.common.collect.Maps.8
            ...
            AnonymousClass8(final Iterator entryIterator2) {
                val$entryIterator = entryIterator2;
            }
    ...
    static <K, V> Iterator<V> valueIterator(Iterator<Map.Entry<K, V>> entryIterator) {
        return new TransformedIterator<Map.Entry<K, V>, V>(entryIterator) { // from class: com.google.common.collect.Maps.2
            AnonymousClass2(Iterator entryIterator2) {
                super(entryIterator2);
            }
