...
final class RegularImmutableSortedSet<E> extends ImmutableSortedSet<E> {
    ...
    public boolean contains(@CheckForNull Object o2) {
        ...
        try {
            return unsafeBinarySearch(o2) >= 0;
    ...
    RegularImmutableSortedSet<E> getSubSet(int newFromIndex, int newToIndex) {
        return (newFromIndex == 0 && newToIndex == size()) ? this : newFromIndex < newToIndex ? new RegularImmutableSortedSet<>(this.elements.subList(newFromIndex, newToIndex), this.comparator) : emptySet(this.comparator);
    }
