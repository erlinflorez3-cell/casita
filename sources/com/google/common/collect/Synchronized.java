...
final class Synchronized {
    ...
    private static class SynchronizedAsMap<K, V> extends SynchronizedMap<K, Collection<V>> {
        ...
        public boolean containsValue(@CheckForNull Object o2) {
            return values().contains(o2);
        }
    ...
    private static class SynchronizedAsMapEntries<K, V> extends SynchronizedSet<Map.Entry<K, Collection<V>>> {
        ...
        /* JADX INFO: renamed from: com.google.common.collect.Synchronized$SynchronizedAsMapEntries$1 */
        class AnonymousClass1 extends TransformedIterator<Map.Entry<K, Collection<V>>, Map.Entry<K, Collection<V>>> {

            /* JADX INFO: renamed from: com.google.common.collect.Synchronized$SynchronizedAsMapEntries$1$1 */
            class C01951 extends ForwardingMapEntry<K, Collection<V>> {
                final /* synthetic */ Map.Entry val$entry;

                C01951(final Map.Entry val$entry) {
                    val$entry = val$entry;
                }
        ...
        public boolean contains(@CheckForNull Object o2) {
            ...
            synchronized (this.mutex) {
                zContainsEntryImpl = Maps.containsEntryImpl(delegate(), o2);
            }
        ...
        public boolean equals(@CheckForNull Object o2) {
            ...
            synchronized (this.mutex) {
                zEqualsImpl = Sets.equalsImpl(delegate(), o2);
            }
            return zEqualsImpl;
        }
            ...
            return new TransformedIterator<Map.Entry<K, Collection<V>>, Map.Entry<K, Collection<V>>>(super.iterator()) { // from class: com.google.common.collect.Synchronized.SynchronizedAsMapEntries.1
                ...
                public Map.Entry<K, Collection<V>> transform(final Map.Entry entry2) {
                    return new ForwardingMapEntry<K, Collection<V>>() { // from class: com.google.common.collect.Synchronized.SynchronizedAsMapEntries.1.1
                        ...
                        C01951(final Map.Entry entry22) {
                            val$entry = entry22;
                        }
        ...
        public boolean remove(@CheckForNull Object o2) {
            ...
            synchronized (this.mutex) {
                zRemoveEntryImpl = Maps.removeEntryImpl(delegate(), o2);
            }
    ...
    private static class SynchronizedAsMapValues<V> extends SynchronizedCollection<Collection<V>> {
        ...
        /* JADX INFO: renamed from: com.google.common.collect.Synchronized$SynchronizedAsMapValues$1 */
    ...
    static class SynchronizedCollection<E> extends SynchronizedObject implements Collection<E> {
        ...
        public boolean contains(@CheckForNull Object o2) {
            boolean zContains;
            synchronized (this.mutex) {
                zContains = delegate().contains(o2);
            }
            return zContains;
        }
    ...
    private static final class SynchronizedDeque<E> extends SynchronizedQueue<E> implements Deque<E> {
        ...
        public boolean removeFirstOccurrence(@CheckForNull Object o2) {
            ...
            synchronized (this.mutex) {
                zRemoveFirstOccurrence = delegate().removeFirstOccurrence(o2);
            }
        ...
        public boolean removeLastOccurrence(@CheckForNull Object o2) {
            ...
            synchronized (this.mutex) {
                zRemoveLastOccurrence = delegate().removeLastOccurrence(o2);
            }
    ...
    private static class SynchronizedList<E> extends SynchronizedCollection<E> implements List<E> {
        ...
        public int lastIndexOf(@CheckForNull Object o2) {
            int iLastIndexOf;
            synchronized (this.mutex) {
                iLastIndexOf = delegate().lastIndexOf(o2);
            }
            return iLastIndexOf;
        }
    ...
    private static class SynchronizedMultiset<E> extends SynchronizedCollection<E> implements Multiset<E> {
        ...
        public int add(@ParametricNullness E e2, int n2) {
            int iAdd;
            synchronized (this.mutex) {
                iAdd = delegate().add(e2, n2);
            }
            return iAdd;
        }

        @Override // com.google.common.collect.Multiset
        public int count(@CheckForNull Object o2) {
            int iCount;
            synchronized (this.mutex) {
                iCount = delegate().count(o2);
            }
            return iCount;
        }
        ...
        @Override // com.google.common.collect.Multiset
        public int remove(@CheckForNull Object o2, int n2) {
            int iRemove;
            synchronized (this.mutex) {
                iRemove = delegate().remove(o2, n2);
            }
            return iRemove;
        }
    ...
    private static final class SynchronizedTable<R, C, V> extends SynchronizedObject implements Table<R, C, V> {
        ...
        /* JADX INFO: renamed from: com.google.common.collect.Synchronized$SynchronizedTable$1 */
        class AnonymousClass1 implements Function<Map<C, V>, Map<C, V>> {
            ...
            public Map<C, V> apply(Map<C, V> t2) {
                return Synchronized.map(t2, SynchronizedTable.this.mutex);
            }
        }

        /* JADX INFO: renamed from: com.google.common.collect.Synchronized$SynchronizedTable$2 */
        class AnonymousClass2 implements Function<Map<R, V>, Map<R, V>> {
            AnonymousClass2() {
            }
        ...
        public V get(@CheckForNull Object rowKey, @CheckForNull Object columnKey) {
            V v2;
            synchronized (this.mutex) {
                v2 = delegate().get(rowKey, columnKey);
            }
            return v2;
        }
    ...
    public static <E> Collection<E> typePreservingCollection(Collection<E> collection, @CheckForNull Object mutex) {
        return collection instanceof SortedSet ? sortedSet((SortedSet) collection, mutex) : collection instanceof Set ? set((Set) collection, mutex) : collection instanceof List ? list((List) collection, mutex) : collection(collection, mutex);
    }

    public static <E> Set<E> typePreservingSet(Set<E> set, @CheckForNull Object mutex) {
        return set instanceof SortedSet ? sortedSet((SortedSet) set, mutex) : set(set, mutex);
    }
}
