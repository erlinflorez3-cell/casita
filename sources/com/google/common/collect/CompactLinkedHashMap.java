...
class CompactLinkedHashMap<K, V> extends CompactHashMap<K, V> {
    ...
    private void setLink(int i2, long value) {
        requireLinks()[i2] = value;
    }

    private void setPredecessor(int entry, int pred) {
        long jLink = (-1) - (((-1) - link(entry)) | ((-1) - 4294967295L));
        long j2 = ((long) (pred + 1)) << 32;
        setLink(entry, (jLink + j2) - (jLink & j2));
    }
    ...
    private void setSuccessor(int entry, int succ) {
        long jLink = (-1) - (((-1) - link(entry)) | ((-1) - (-4294967296L)));
        long j2 = ((long) (succ + 1)) & 4294967295L;
        setLink(entry, (jLink + j2) - (jLink & j2));
    }
