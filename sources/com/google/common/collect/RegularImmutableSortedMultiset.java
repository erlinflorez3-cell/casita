...
final class RegularImmutableSortedMultiset<E> extends ImmutableSortedMultiset<E> {
    ...
    private int getCount(int index) {
        ...
        int i2 = this.offset;
        return (int) (jArr[(i2 + index) + 1] - jArr[i2 + index]);
    }
    ...
    ImmutableSortedMultiset<E> getSubMultiset(int from, int to) {
        ...
        return from == to ? emptyMultiset(comparator()) : (from == 0 && to == this.length) ? this : new RegularImmutableSortedMultiset(this.elementSet.getSubSet(from, to), this.cumulativeCounts, this.offset + from, to - from);
    }
