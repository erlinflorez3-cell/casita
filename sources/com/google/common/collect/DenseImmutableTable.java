...
final class DenseImmutableTable<R, C, V> extends RegularImmutableTable<R, C, V> {
    ...
    Table.Cell<R, C, V> getCell(int index) {
        int i2 = this.cellRowIndices[index];
        int i3 = this.cellColumnIndices[index];
        return cellOf(rowKeySet().asList().get(i2), columnKeySet().asList().get(i3), Objects.requireNonNull(this.values[i2][i3]));
    }

    @Override // com.google.common.collect.RegularImmutableTable
    V getValue(int i2) {
        return (V) Objects.requireNonNull(this.values[this.cellRowIndices[i2]][this.cellColumnIndices[i2]]);
    }
