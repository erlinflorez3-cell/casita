...
abstract class AbstractTable<R, C, V> implements Table<R, C, V> {
    ...
    class AnonymousClass1 extends TransformedIterator<Table.Cell<R, C, V>, V> {
        AnonymousClass1(final AbstractTable this$0, Iterator backingIterator) {
    ...
    Iterator<V> valuesIterator() {
        return new TransformedIterator<Table.Cell<R, C, V>, V>(this, cellSet().iterator()) { // from class: com.google.common.collect.AbstractTable.1
            AnonymousClass1(AbstractTable this, Iterator backingIterator) {
                super(backingIterator);
            }
