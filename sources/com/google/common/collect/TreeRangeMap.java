...
public final class TreeRangeMap<K extends Comparable, V> implements RangeMap<K, V> {
    ...
    public Range<K> coalescedRange(Range<K> range, V v2) {
        return coalesce(coalesce(range, v2, this.entriesByLowerBound.lowerEntry((Cut<K>) range.lowerBound)), v2, this.entriesByLowerBound.floorEntry((Cut<K>) range.upperBound));
    }
