...
final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
    ...
    static <K, V> RegularImmutableMap<K, V> create(int n2, Object[] alternatingKeysAndValues) {
        return create(n2, alternatingKeysAndValues, null);
    }

    static <K, V> RegularImmutableMap<K, V> create(int n2, Object[] alternatingKeysAndValues, ImmutableMap.Builder<K, V> builder) {
        if (n2 == 0) {
        ...
        Preconditions.checkPositionIndex(n2, alternatingKeysAndValues.length >> 1);
        Object objCreateHashTable = createHashTable(alternatingKeysAndValues, n2, ImmutableSet.chooseTableSize(n2), 0);
        ...
        return new RegularImmutableMap<>(objCreateHashTable, alternatingKeysAndValues, n2);
    }

    @CheckForNull
    private static Object createHashTable(Object[] alternatingKeysAndValues, int n2, int tableSize, int keyOffset) {
        ...
        if (tableSize <= 128) {
            ...
            for (int i5 = 0; i5 < n2; i5++) {
                ...
                while (true) {
                    int i8 = (-1) - (((-1) - iSmear) | ((-1) - i2));
                    int i9 = (-1) - (((-1) - bArr[i8]) | ((-1) - 255));
                    if (i9 == 255) {
                        bArr[i8] = (byte) i7;
                        if (i4 < i5) {
            ...
            return i4 == n2 ? bArr : new Object[]{bArr, Integer.valueOf(i4), duplicateKey};
        }
        if (tableSize <= 32768) {
            ...
            return i11 == n2 ? sArr : new Object[]{sArr, Integer.valueOf(i11), duplicateKey};
        }
        ...
        while (i18 < n2) {
            ...
            Object objRequireNonNull6 = Objects.requireNonNull(alternatingKeysAndValues[i20 ^ 1]);
        ...
        return i19 == n2 ? iArr : new Object[]{iArr, Integer.valueOf(i19), duplicateKey};
    }

    @CheckForNull
    static Object createHashTableOrThrow(Object[] alternatingKeysAndValues, int n2, int tableSize, int keyOffset) {
        Object objCreateHashTable = createHashTable(alternatingKeysAndValues, n2, tableSize, keyOffset);
        if (objCreateHashTable instanceof Object[]) {
    ...
    static Object get(@CheckForNull Object hashTableObject, Object[] alternatingKeysAndValues, int size, int keyOffset, @CheckForNull Object key) {
        ...
        if (hashTableObject instanceof byte[]) {
            ...
            while (true) {
                ...
                if (key.equals(alternatingKeysAndValues[i3])) {
                    return alternatingKeysAndValues[i3 ^ 1];
                }
                iSmear = i2 + 1;
            }
            ...
            while (true) {
                ...
                int i5 = (-1) - (((-1) - sArr[i4]) | ((-1) - 65535));
                if (i5 == 65535) {
                    return null;
                }
                if (key.equals(alternatingKeysAndValues[i5])) {
                    return alternatingKeysAndValues[i5 ^ 1];
                }
                iSmear2 = i4 + 1;
            }
        } else {
            ...
            while (true) {
                int i6 = (iSmear3 + length3) - (iSmear3 | length3);
                int i7 = iArr[i6];
                if (i7 == -1) {
                    return null;
                }
                if (key.equals(alternatingKeysAndValues[i7])) {
                    return alternatingKeysAndValues[i7 ^ 1];
                }
                iSmear3 = i6 + 1;
            }
        }
