...
public abstract class ImmutableMultimap<K, V> extends BaseImmutableMultimap<K, V> implements Serializable {
    ...
    public static class Builder<K, V> {
        ...
        public Builder<K, V> put(K key, V value) {
            ...
            Collection<V> collectionNewMutableValueCollection = this.builderMap.get(key);
            ...
            collectionNewMutableValueCollection.add(value);
            return this;
        }
        ...
        public Builder<K, V> putAll(K key, Iterable<? extends V> values) {
            ...
            if (collection != null) {
                for (V v2 : values) {
                    CollectPreconditions.checkEntryNotNull(key, v2);
                    collection.add(v2);
                }
                return this;
            }
