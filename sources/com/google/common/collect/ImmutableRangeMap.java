...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    ...
    public boolean equals(@CheckForNull Object o2) {
        if (o2 instanceof RangeMap) {
            return asMapOfRanges().equals(((RangeMap) o2).asMapOfRanges());
        }
        return false;
    }
    ...
    public ImmutableRangeMap<K, V> subRangeMap(final Range<K> range) {
        ...
        return (ImmutableRangeMap<K, V>) new ImmutableRangeMap<K, V>(this, new ImmutableList<Range<K>>() { // from class: com.google.common.collect.ImmutableRangeMap.1
            ...
            public Range<K> get(int index) {
                ...
                return (index == 0 || index == i2 + (-1)) ? ((Range) ImmutableRangeMap.this.ranges.get(index + iBinarySearch)).intersection(range) : (Range) ImmutableRangeMap.this.ranges.get(index + iBinarySearch);
            }
            ...
            public ImmutableRangeMap<K, V> subRangeMap(Range<K> subRange) {
                return range.isConnected(subRange) ? this.subRangeMap((Range) subRange.intersection(range)) : ImmutableRangeMap.of();
            }
        };
    }
