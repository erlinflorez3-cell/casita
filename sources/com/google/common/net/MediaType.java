...
public final class MediaType {
    ...
    public static final MediaType APPLICATION_BINARY = createConstant(APPLICATION_TYPE, MIME.ENC_BINARY);
    ...
    public static final MediaType ZIP = createConstant(APPLICATION_TYPE, ResourceUtils.URL_PROTOCOL_ZIP);
    ...
    private static final class Tokenizer {
        ...
        String consumeTokenIfPresent(CharMatcher matcher) {
            Preconditions.checkState(hasMore());
            int i2 = this.position;
            this.position = matcher.negate().indexIn(this.input, i2);
