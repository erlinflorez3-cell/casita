...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
    ...
    class AnonymousClass1 extends AbstractGraph<N> {
        ...
        class C01971 extends AbstractSet<EndpointPair<N>> {
            C01971() {
            }
            ...
            public Iterator<EndpointPair<N>> iterator() {
                return Iterators.transform(AbstractNetwork.this.edges().iterator(), new Function() { // from class: com.google.common.graph.AbstractNetwork$1$1$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return this.f$0.m7680lambda$iterator$0$comgooglecommongraphAbstractNetwork$1$1(obj);
                    }
                });
            }

            /* JADX INFO: renamed from: lambda$iterator$0$com-google-common-graph-AbstractNetwork$1$1, reason: not valid java name */
            /* synthetic */ EndpointPair m7680lambda$iterator$0$comgooglecommongraphAbstractNetwork$1$1(Object obj) {
        ...
        public Set<EndpointPair<N>> edges() {
            return AbstractNetwork.this.allowsParallelEdges() ? super.edges() : new C01971();
        }
    ...
    private Predicate<E> connectedPredicate(final N nodePresent, final N nodeToCheck) {
        return new Predicate<E>() { // from class: com.google.common.graph.AbstractNetwork.2
            ...
            public boolean apply(E e2) {
                return AbstractNetwork.this.incidentNodes(e2).adjacentNode(nodePresent).equals(nodeToCheck);
            }
        };
    }
    ...
    public Set<E> edgesConnecting(N nodeU, N nodeV) {
        ...
        return setOutEdges.size() <= setInEdges.size() ? Collections.unmodifiableSet(Sets.filter(setOutEdges, connectedPredicate(nodeU, nodeV))) : Collections.unmodifiableSet(Sets.filter(setInEdges, connectedPredicate(nodeV, nodeU)));
    }
