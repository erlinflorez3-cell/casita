...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    private static class RangesMatcher extends CharMatcher {
        ...
        RangesMatcher(String description, char[] rangeStarts, char[] rangeEnds) {
            ...
            int i2 = 0;
            while (i2 < rangeStarts.length) {
                Preconditions.checkArgument(rangeStarts[i2] <= rangeEnds[i2]);
                int i3 = i2 + 1;
                if (i3 < rangeStarts.length) {
                    Preconditions.checkArgument(rangeEnds[i2] < rangeStarts[i3]);
                }
                i2 = i3;
            }
        }
    ...
    public static CharMatcher anyOf(final CharSequence sequence) {
        int length = sequence.length();
        return length != 0 ? length != 1 ? length != 2 ? new AnyOf(sequence) : isEither(sequence.charAt(0), sequence.charAt(1)) : is(sequence.charAt(0)) : none();
    }
    ...
    private static IsEither isEither(char c12, char c2) {
        return new IsEither(c12, c2);
    }
    ...
    public static String showCharacter(char c2) {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            cArr[5 - i2] = "0123456789ABCDEF".charAt((c2 + 15) - (15 | c2));
            c2 = (char) (c2 >> 4);
        }
    ...
    public String collapseFrom(CharSequence sequence, char replacement) {
        ...
        while (i2 < length) {
            ...
            if (matches(cCharAt)) {
                if (cCharAt != replacement || (i2 != length - 1 && matches(sequence.charAt(i2 + 1)))) {
                    return finishCollapseFrom(sequence, i2 + 1, length, replacement, new StringBuilder(length).append(sequence, 0, i2).append(replacement), true);
                }
                i2++;
            }
            i2++;
    ...
    CharMatcher precomputedInternal() {
        ...
        return new NegatedFastMatcher(this, precomputedPositive(i2, bitSet, string.endsWith(".negate()") ? string.substring(0, string.length() - ".negate()".length()) : string + ".negate()")) { // from class: com.google.common.base.CharMatcher.1
    ...
    public String trimAndCollapseFrom(CharSequence sequence, char replacement) {
        ...
        int i2 = length - 1;
        int i3 = 0;
        while (i3 < length && matches(sequence.charAt(i3))) {
            i3++;
        }
        int i4 = i2;
        while (i4 > i3 && matches(sequence.charAt(i4))) {
            i4--;
        }
        if (i3 == 0 && i4 == i2) {
        ...
        int i5 = i4 + 1;
        return finishCollapseFrom(sequence, i3, i5, replacement, new StringBuilder(i5 - i3), false);
    }
    ...
    public String trimFrom(CharSequence sequence) {
        ...
        return sequence.subSequence(i2, i3 + 1).toString();
    }
    ...
    public String trimLeadingFrom(CharSequence sequence) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            if (!matches(sequence.charAt(i2))) {
                return sequence.subSequence(i2, length).toString();
            }
        }
        return "";
    }
