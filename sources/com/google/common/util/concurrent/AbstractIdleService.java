...
public abstract class AbstractIdleService implements Service {
    ...
    private final class ThreadNameSupplier implements Supplier<String> {
        ...
        public String get() {
            return AbstractIdleService.this.serviceName() + Global.BLANK + AbstractIdleService.this.state();
        }
    }
    ...
    protected Executor executor() {
        return new Executor() { // from class: com.google.common.util.concurrent.AbstractIdleService$$ExternalSyntheticLambda0
            ...
            public final void execute(Runnable runnable) {
                this.f$0.m7686xc998c392(runnable);
            }
        };
    }
    ...
    /* synthetic */ void m7686xc998c392(Runnable runnable) {
