...
@DoNotMock("^}l(Hrrwz\u0001vV\u0003\u0003\u0001~^(]jdc\u001b:vvtrbq)eVWLLNGWI\u001b8ddb`P\u0015")
public final class ClosingFuture<V> {
    ...
    @InterfaceC1492Gx
    @DoNotMock("^}l(Hrrwz\u0001vV\u0003\u0003\u0001~^(n`Zd4`mUtc`c``\u0011\u0013\u0007WW\u0006\u0011[YW]1YZ.[FJC=I;z|\u0001KMSQC<@w")
    ...
    public void finishToValueAndCloser(final ValueAndCloserConsumer<? super V> consumer, Executor executor) {
        ...
        int i2 = AnonymousClass11.$SwitchMap$com$google$common$util$concurrent$ClosingFuture$State[this.state.get().ordinal()];
        if (i2 == 1) {
