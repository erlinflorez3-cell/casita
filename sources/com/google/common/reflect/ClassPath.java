...
public final class ClassPath {
    ...
    private static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.on(Global.BLANK).omitEmptyStrings();
    ...
    public static class ResourceInfo {
        ...
        static ResourceInfo of(File file, String resourceName, ClassLoader loader) {
            return resourceName.endsWith(".class") ? new ClassInfo(file, resourceName, loader) : new ResourceInfo(file, resourceName, loader);
        }
