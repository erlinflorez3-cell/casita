...
public abstract class Invokable<T, R> implements AnnotatedElement, Member {
    ...
    public final <A extends Annotation> A getAnnotation(Class<A> cls) {
        return (A) Kl.od(this.accessibleObject, cls);
    }

    @Override // java.lang.reflect.AnnotatedElement
    public final Annotation[] getAnnotations() {
        return Kl.oX(this.accessibleObject);
    }

    @Override // java.lang.reflect.AnnotatedElement
    public final Annotation[] getDeclaredAnnotations() {
        return Kl.pX(this.accessibleObject);
    }
    ...
    public final ImmutableList<Parameter> getParameters() {
        ...
        for (int i2 = 0; i2 < genericParameterTypes.length; i2++) {
            builder.add(new Parameter(this, i2, TypeToken.of(genericParameterTypes[i2]), parameterAnnotations[i2], annotatedParameterTypes[i2]));
        }
        return builder.build();
    }
