...
abstract class BinaryReader implements Reader {
    ...
    private static final class SafeHeapReader extends BinaryReader {
        ...
        private int readLittleEndian32_NoCheck() {
            ...
            byte[] bArr = this.buffer;
            this.pos = i2 + 4;
            int i3 = (-1) - (((-1) - (bArr[i2] & 255)) & ((-1) - ((bArr[i2 + 1] & 255) << 8)));
            byte b2 = bArr[i2 + 2];
            int i4 = ((b2 + 255) - (b2 | 255)) << 16;
            return ((bArr[i2 + 3] & 255) << 24) | ((i3 + i4) - (i3 & i4));
        }
        ...
        */
        private int readVarint32() throws java.io.IOException {
            ...
            L7b:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.BinaryReader.SafeHeapReader.readVarint32():int");
        }
                ...
                while (true) {
                    ...
                    if (fieldNumber == 1) {
                        ...
                        try {
                            ...
                            if (!skipField()) {
                                throw new InvalidProtocolBufferException("Unable to parse map entry.", (IOException) e2);
                            }
                        }
                    } else {
