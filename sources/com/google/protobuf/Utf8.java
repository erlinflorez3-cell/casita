...
final class Utf8 {
    ...
    private static class DecodeUtil {
        ...
        public static void handleFourBytes(byte byte1, byte byte2, byte byte3, byte byte4, char[] resultArr, int resultPos) throws InvalidProtocolBufferException {
            ...
            int iTrailingByteValue = ((byte1 & 7) << 18) | (trailingByteValue(byte2) << 12);
            int iTrailingByteValue2 = trailingByteValue(byte3) << 6;
            int i2 = (iTrailingByteValue + iTrailingByteValue2) - (iTrailingByteValue & iTrailingByteValue2);
            int iTrailingByteValue3 = trailingByteValue(byte4);
            int i3 = (i2 + iTrailingByteValue3) - (i2 & iTrailingByteValue3);
        ...
        public static void handleThreeBytes(byte byte1, byte byte2, byte byte3, char[] resultArr, int resultPos) throws InvalidProtocolBufferException {
            ...
            resultArr[resultPos] = (char) ((((byte1 + Ascii.SI) - (byte1 | Ascii.SI)) << 12) | (trailingByteValue(byte2) << 6) | trailingByteValue(byte3));
        }
        ...
        public static void handleTwoBytes(byte byte1, byte byte2, char[] resultArr, int resultPos) throws InvalidProtocolBufferException {
            ...
            int i2 = ((byte1 + Ascii.US) - (byte1 | Ascii.US)) << 6;
            int iTrailingByteValue = trailingByteValue(byte2);
            resultArr[resultPos] = (char) ((i2 + iTrailingByteValue) - (i2 & iTrailingByteValue));
        }
        ...
        private static char lowSurrogate(int codePoint) {
            return (char) (((codePoint + 1023) - (codePoint | 1023)) + okio.Utf8.LOG_SURROGATE_HEADER);
        }
    ...
    static abstract class Processor {
        ...
        final String decodeUtf8Default(ByteBuffer buffer, int index, int size) throws InvalidProtocolBufferException {
            if ((-1) - (((-1) - (index | size)) & ((-1) - ((buffer.limit() - index) - size))) < 0) {
        ...
        final void encodeUtf8Default(String in, ByteBuffer out) {
            ...
            while (i5 < length) {
                try {
                    char cCharAt = in.charAt(i5);
                    if (cCharAt >= 128) {
                        break;
                    }
                    out.put(iPosition + i5, (byte) cCharAt);
                    i5++;
                } catch (IndexOutOfBoundsException unused) {
                    throw new ArrayIndexOutOfBoundsException("Failed writing " + in.charAt(i5) + " at index " + (out.position() + Math.max(i5, (iPosition - out.position()) + 1)));
                }
            }
            if (i5 == length) {
                Java8Compatibility.position(out, iPosition + i5);
                return;
            }
            iPosition += i5;
            while (i5 < length) {
                ...
                if (cCharAt2 < 128) {
                    ...
                    try {
                        ...
                        out.put(i6, (byte) ((-1) - (((-1) - ((cCharAt2 + '?') - (cCharAt2 | '?'))) & ((-1) - 128))));
                        iPosition = i6;
                        ...
                        if (i2 != length) {
                            try {
                                ...
                                if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                    ...
                                    try {
                                        out.put(i7, (byte) ((-1) - (((-1) - ((i4 + 63) - (i4 | 63))) & ((-1) - 128))));
                                        iPosition += 3;
                                        int i8 = codePoint >>> 6;
                                        out.put(i3, (byte) ((-1) - (((-1) - ((i8 + 63) - (i8 | 63))) & ((-1) - 128))));
                                        out.put(iPosition, (byte) ((-1) - (((-1) - ((-1) - (((-1) - codePoint) | ((-1) - 63)))) & ((-1) - 128))));
                                        i5 = i2;
                    ...
                    int i9 = iPosition + 1;
                    int i10 = cCharAt2 >>> 12;
                    int i11 = i10 + CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY;
                    i2 = i10 & CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY;
                    out.put(iPosition, (byte) (i11 - i2));
                    iPosition += 2;
                    int i12 = (cCharAt2 >>> 6) & 63;
                    out.put(i9, (byte) ((i12 + 128) - (i12 & 128)));
                    out.put(iPosition, (byte) (((-1) - ((65535 - cCharAt2) | ((-1) - 63))) | 128));
                }
                i5++;
                iPosition++;
            }
        ...
        */
        final int partialIsValidUtf8Default(final int r9, final java.nio.ByteBuffer r10, int r11, final int r12) {
            ...
            L1a:
                ...
                byte r2 = r10.get(r11)
                if (r0 < r12) goto L31
                int r0 = com.google.protobuf.Utf8.access$000(r6, r2)
                return r0
            L31:
                r11 = r0
            L32:
            ...
            L49:
                ...
                byte r4 = r10.get(r11)
                if (r3 < r12) goto L61
                int r0 = com.google.protobuf.Utf8.access$000(r6, r4)
                return r0
            L5c:
                int r0 = r9 >> 16
                byte r2 = (byte) r0
            ...
            L62:
                ...
                byte r2 = r10.get(r3)
                if (r0 < r12) goto L71
                int r0 = com.google.protobuf.Utf8.access$100(r6, r4, r2)
                return r0
            L71:
                r3 = r0
            L72:
        ...
        int encodeUtf8(String in, byte[] out, int offset, int length) {
            ...
            while (i5 < length2) {
                ...
                if (cCharAt2 < 128 && i6 < i4) {
                    ...
                    i6 += 2;
                    int i8 = (-1) - ((65535 - cCharAt2) | ((-1) - 63));
                    out[i7] = (byte) ((i8 + 128) - (i8 & 128));
                } else {
                    if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || i6 > i4 - 3) {
                        ...
                        if (i9 != in.length()) {
                            ...
                            if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                ...
                                out[i6 + 1] = (byte) ((-1) - (((-1) - ((i10 + 63) - (i10 | 63))) & ((-1) - 128)));
                                int i11 = i6 + 3;
                                out[i6 + 2] = (byte) (((codePoint >>> 6) & 63) | 128);
                                i6 += 4;
                                out[i11] = (byte) ((-1) - (((-1) - ((-1) - (((-1) - codePoint) | ((-1) - 63)))) & ((-1) - 128)));
                                i5 = i9;
                            } else {
                                i5 = i9;
                            }
                    ...
                    int i12 = cCharAt2 >>> '\f';
                    out[i6] = (byte) ((i12 + 480) - (i12 & 480));
                    int i13 = i6 + 2;
                    out[i6 + 1] = (byte) ((-1) - (((-1) - ((-1) - (((-1) - (cCharAt2 >>> 6)) | ((-1) - 63)))) & ((-1) - 128)));
                    i6 += 3;
                    out[i13] = (byte) ((-1) - (((-1) - ((-1) - ((65535 - cCharAt2) | ((-1) - 63)))) & ((-1) - 128)));
                }
                i5++;
            }
            return i6;
    ...
    static final class UnsafeProcessor extends Processor {
        ...
        */
        private static int partialIsValidUtf8(long r11, int r13) {
            ...
            L9:
                ...
                if (r13 <= 0) goto L1a
                long r0 = r11 + r9
                byte r7 = com.google.protobuf.UnsafeUtil.getByte(r11)
                if (r7 < 0) goto L19
                int r13 = r13 + (-1)
                r11 = r0
                goto L9
            ...
            L47:
                int r13 = r13 + (-3)
                long r9 = r9 + r11
                byte r3 = com.google.protobuf.UnsafeUtil.getByte(r11)
                if (r3 > r2) goto L63
                r1 = -96
                if (r7 != r8) goto L56
                if (r3 < r1) goto L63
            ...
            L5c:
                long r11 = r11 + r4
                byte r0 = com.google.protobuf.UnsafeUtil.getByte(r9)
                if (r0 <= r2) goto L7
            L63:
                return r6
            L64:
        ...
        */
        private static int partialIsValidUtf8(final byte[] r11, long r12, int r14) {
            ...
            L9:
                ...
                if (r14 <= 0) goto L1a
                long r2 = r12 + r0
                byte r8 = com.google.protobuf.UnsafeUtil.getByte(r11, r12)
                if (r8 < 0) goto L19
                int r14 = r14 + (-1)
                r12 = r2
                goto L9
            ...
            L29:
                ...
                if (r8 < r2) goto L36
                long r0 = r0 + r12
                byte r2 = com.google.protobuf.UnsafeUtil.getByte(r11, r12)
                if (r2 <= r6) goto L37
            L36:
                return r9
            L37:
            ...
            L47:
                int r14 = r14 + (-3)
                long r0 = r0 + r12
                byte r7 = com.google.protobuf.UnsafeUtil.getByte(r11, r12)
                if (r7 > r6) goto L63
                r5 = -96
                if (r8 != r10) goto L56
                if (r7 < r5) goto L63
            ...
            L6c:
                int r14 = r14 + (-4)
                long r0 = r0 + r12
                byte r4 = com.google.protobuf.UnsafeUtil.getByte(r11, r12)
                if (r4 > r6) goto L8e
                int r5 = r8 << 28
                int r4 = r4 + 112
                int r5 = r5 + r4
                ...
                r0 = 3
                long r12 = r12 + r0
                byte r0 = com.google.protobuf.UnsafeUtil.getByte(r11, r2)
                if (r0 <= r6) goto L7
            L8e:
                return r9
            */
        ...
        private static int unsafeEstimateConsecutiveAscii(long address, final int maxChars) {
            ...
            int i4 = maxChars - i2;
            while (i4 >= 8) {
                long j3 = UnsafeUtil.getLong(address);
                if ((j3 - 9187201950435737472L) - (j3 | (-9187201950435737472L)) != 0) {
                    break;
                }
                address += 8;
                i4 -= 8;
        ...
        private static int unsafeEstimateConsecutiveAscii(byte[] bytes, long offset, final int maxChars) {
            ...
            while (true) {
                int i5 = i2 + 8;
                if (i5 > maxChars || (UnsafeUtil.getLong((Object) bytes, UnsafeUtil.BYTE_ARRAY_BASE_OFFSET + offset) & (-9187201950435737472L)) != 0) {
                    break;
                }
                offset += 8;
                i2 = i5;
        ...
        String decodeUtf8Direct(ByteBuffer buffer, int index, int size) throws InvalidProtocolBufferException {
            int i2 = index | size;
            int iLimit = (buffer.limit() - index) - size;
            if ((i2 + iLimit) - (i2 & iLimit) < 0) {
                throw new ArrayIndexOutOfBoundsException(String.format("buffer limit=%d, index=%d, limit=%d", Integer.valueOf(buffer.limit()), Integer.valueOf(index), Integer.valueOf(size)));
            }
            ...
            while (jAddressOffset < j2) {
                ...
                if (DecodeUtil.isOneByte(b3)) {
                    ...
                    jAddressOffset += 4;
                    DecodeUtil.handleFourBytes(b3, b5, b6, UnsafeUtil.getByte(j5), cArr, i3);
                    i3 += 2;
                }
            }
            return new String(cArr, 0, i3);
            ...
            while (i3 < length2) {
                ...
                if (cCharAt2 >= 128 || j3 >= j4) {
                    if (cCharAt2 < 2048 && j3 <= j4 - 2) {
                        long j5 = j3 + j2;
                        UnsafeUtil.putByte(out, j3, (byte) ((-1) - (((-1) - (cCharAt2 >>> 6)) & ((-1) - 960))));
                        j3 += 2;
                        UnsafeUtil.putByte(out, j5, (byte) ((-1) - (((-1) - ((-1) - ((65535 - cCharAt2) | ((-1) - 63)))) & ((-1) - 128))));
                    } else {
                        if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || j3 > j4 - 3) {
                            ...
                            if (i4 != length2) {
                                ...
                                if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                    ...
                                    j2 = 1;
                                    int i5 = codePoint >>> 18;
                                    UnsafeUtil.putByte(out, j3, (byte) ((i5 + 240) - (i5 & 240)));
                                    int i6 = (-1) - (((-1) - (codePoint >>> 12)) | ((-1) - 63));
                                    UnsafeUtil.putByte(out, j3 + 1, (byte) ((i6 + 128) - (i6 & 128)));
                                    long j6 = j3 + 3;
                                    UnsafeUtil.putByte(out, j3 + 2, (byte) (((-1) - (((-1) - (codePoint >>> 6)) | ((-1) - 63))) | 128));
                                    j3 += 4;
                        ...
                        long j7 = j3 + 2;
                        UnsafeUtil.putByte(out, j3 + 1, (byte) (((-1) - (((-1) - (cCharAt2 >>> 6)) | ((-1) - 63))) | 128));
                        j3 += 3;
                        UnsafeUtil.putByte(out, j7, (byte) ((-1) - (((-1) - (cCharAt2 & '?')) & ((-1) - 128))));
                    }
                    j2 = 1;
                } else {
            ...
            while (i4 < length) {
                ...
                if (cCharAt2 >= c2 || jPosition >= jLimit) {
                    if (cCharAt2 < 2048 && jPosition <= jLimit - 2) {
                        ...
                        int i5 = cCharAt2 >>> 6;
                        UnsafeUtil.putByte(jPosition, (byte) ((i5 + 960) - (i5 & 960)));
                        jPosition += 2;
                        int i6 = (cCharAt2 + '?') - (cCharAt2 | '?');
                        UnsafeUtil.putByte(j3, (byte) ((i6 + 128) - (i6 & 128)));
                    } else {
                        if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || jPosition > jLimit - 3) {
                            ...
                            if (i3 != length) {
                                ...
                                if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                    ...
                                    int i8 = (i7 + 63) - (i7 | 63);
                                    c2 = 128;
                                    UnsafeUtil.putByte(jPosition + 1, (byte) ((-1) - (((-1) - i8) & ((-1) - 128))));
                                    long j4 = jPosition + 3;
                                    int i9 = (-1) - (((-1) - (codePoint >>> 6)) | ((-1) - 63));
                                    UnsafeUtil.putByte(jPosition + 2, (byte) ((i9 + 128) - (i9 & 128)));
                                    jPosition += 4;
                                    UnsafeUtil.putByte(j4, (byte) ((-1) - (((-1) - ((codePoint + 63) - (codePoint | 63))) & ((-1) - 128))));
                                } else {
                                    i4 = i3;
                                }
                            }
                        ...
                        long j5 = jPosition + 2;
                        UnsafeUtil.putByte(jPosition + j2, (byte) (((-1) - (((-1) - (cCharAt2 >>> 6)) | ((-1) - 63))) | 128));
                        jPosition += 3;
                        UnsafeUtil.putByte(j5, (byte) ((-1) - (((-1) - ((-1) - ((65535 - cCharAt2) | ((-1) - 63)))) & ((-1) - 128))));
                    }
                    i3 = i4;
                    c2 = 128;
                } else {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:33:0x0067, code lost:
            ...
            if (com.google.protobuf.UnsafeUtil.getByte(r17, r3) > (-65)) goto L34;
         */
        /* JADX WARN: Code restructure failed: missing block: B:54:0x00aa, code lost:
        
            if (com.google.protobuf.UnsafeUtil.getByte(r17, r3) > (-65)) goto L55;
         */
        @Override // com.google.protobuf.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:14:0x003c, code lost:
            ...
            if (com.google.protobuf.UnsafeUtil.getByte(r3) > (-65)) goto L15;
         */
        /* JADX WARN: Code restructure failed: missing block: B:33:0x006c, code lost:
        
            if (com.google.protobuf.UnsafeUtil.getByte(r3) > (-65)) goto L34;
         */
        /* JADX WARN: Code restructure failed: missing block: B:54:0x00ae, code lost:
        
            if (com.google.protobuf.UnsafeUtil.getByte(r3) > (-65)) goto L55;
         */
        @Override // com.google.protobuf.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
    ...
    static int encodedLength(String string) {
        ...
        int i2 = 0;
        while (i2 < length && string.charAt(i2) < 128) {
            i2++;
        }
        ...
        while (true) {
            if (i2 < length) {
                ...
                if (cCharAt >= 2048) {
                    iEncodedLengthGeneral += encodedLengthGeneral(string, i2);
                    break;
                }
    ...
    public static int estimateConsecutiveAscii(ByteBuffer buffer, int index, int limit) {
        int i2 = limit - 7;
        int i3 = index;
        while (i3 < i2 && (-1) - (((-1) - buffer.getLong(i3)) | ((-1) - (-9187201950435737472L))) == 0) {
            i3 += 8;
        }
        return i3 - index;
    }
