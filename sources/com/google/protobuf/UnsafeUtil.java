...
final class UnsafeUtil {
    ...
    static {
        ...
        BYTE_ARRAY_ALIGNMENT = (int) ((-1) - (((-1) - jArrayBaseOffset) | ((-1) - 7)));
    ...
    public static byte getByteBigEndian(Object target, long offset) {
        int i2 = getInt(target, (-4) & offset);
        long j2 = ~offset;
        int i3 = i2 >>> ((int) (((j2 + 3) - (j2 | 3)) << 3));
        return (byte) ((i3 + 255) - (i3 | 255));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static byte getByteLittleEndian(Object target, long offset) {
        return (byte) ((getInt(target, (-4) & offset) >>> ((int) (((offset + 3) - (offset | 3)) << 3))) & 255);
    }
    ...
    static int mismatch(byte[] left, int leftOff, byte[] right, int rightOff, int length) {
        ...
        int i2 = 0;
        if (HAS_UNSAFE_ARRAY_OPERATIONS) {
            for (int i3 = (BYTE_ARRAY_ALIGNMENT + leftOff) & 7; i2 < length && (i3 + 7) - (7 | i3) != 0; i3++) {
    ...
    public static void putByteBigEndian(Object target, long offset, byte value) {
        ...
        int i4 = ~(255 << i3);
        putInt(target, j2, (((-1) - (((-1) - 255) | ((-1) - value))) << i3) | ((i2 + i4) - (i2 | i4)));
    }
