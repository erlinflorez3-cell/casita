...
public class TypeToken<T> {
    ...
    public static TypeToken<?> getParameterized(Type type, Type... typeArr) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            Type type2 = (Type) Objects.requireNonNull(typeArr[i2], "Type argument must not be null");
    ...
    private static void verifyNoTypeVariable(Type type) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            while (i2 < length) {
                verifyNoTypeVariable(actualTypeArguments[i2]);
                i2++;
            }
            return;
        }
        ...
        while (i2 < length2) {
            verifyNoTypeVariable(upperBounds[i2]);
            i2++;
        }
    }
