...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder excluderM7781clone = m7781clone();
        excluderM7781clone.serializeInnerClasses = false;
        return excluderM7781clone;
    }

    public boolean excludeClass(Class<?> cls, boolean z2) {
        if (this.version != -1.0d && !isValidVersion((Since) Kl.Kd(cls, Since.class), (Until) Kl.Kd(cls, Until.class))) {
            return true;
        }
    ...
    public boolean excludeField(Field field, boolean z2) {
        Expose expose;
        if ((-1) - (((-1) - this.modifiers) | ((-1) - field.getModifiers())) != 0) {
            return true;
        }
        if ((this.version != -1.0d && !isValidVersion((Since) Kl.qd(field, Since.class), (Until) Kl.qd(field, Until.class))) || field.isSynthetic()) {
            return true;
        }
        if ((this.requireExpose && ((expose = (Expose) Kl.qd(field, Expose.class)) == null || (!z2 ? expose.deserialize() : expose.serialize()))) || excludeClass(field.getType(), z2)) {
            return true;
        }
    ...
    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder excluderM7781clone = m7781clone();
        excluderM7781clone.requireExpose = true;
        return excluderM7781clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z2, boolean z3) {
        ...
        if (z2) {
            ...
            excluderM7781clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z3) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            excluderM7781clone.deserializationStrategies = arrayList2;
    ...
    public Excluder withModifiers(int... iArr) {
        Excluder excluderM7781clone = m7781clone();
        excluderM7781clone.modifiers = 0;
        for (int i2 : iArr) {
            excluderM7781clone.modifiers = i2 | excluderM7781clone.modifiers;
        }
        return excluderM7781clone;
    }
