...
public final class C$Gson$Types {
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public String toString() {
            ...
            for (int i2 = 1; i2 < length; i2++) {
                sb.append(", ").append(C$Gson$Types.typeToString(this.typeArguments[i2]));
            }
    ...
    private static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public String toString() {
            return this.lowerBound != null ? "? super " + C$Gson$Types.typeToString(this.lowerBound) : this.upperBound == Object.class ? Global.QUESTION : "? extends " + C$Gson$Types.typeToString(this.upperBound);
        }
    }
    ...
    /* JADX WARN: Type inference failed for: r11v9, types: [java.lang.reflect.GenericArrayType] */
