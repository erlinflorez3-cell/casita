...
public final class JsonAdapterAnnotationTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private static JsonAdapter getAnnotation(Class<?> cls) {
        return (JsonAdapter) Kl.Kd(cls, JsonAdapter.class);
    }
    ...
    TypeAdapter<?> getTypeAdapter(ConstructorConstructor constructorConstructor, Gson gson, TypeToken<?> typeToken, JsonAdapter jsonAdapter, boolean z2) {
        ...
        if (objCreateAdapter instanceof TypeAdapter) {
            ...
            boolean z3 = objCreateAdapter instanceof JsonSerializer;
            if (!z3 && !(objCreateAdapter instanceof JsonDeserializer)) {
            ...
            treeTypeAdapter = new TreeTypeAdapter<>(z3 ? (JsonSerializer) objCreateAdapter : null, objCreateAdapter instanceof JsonDeserializer ? (JsonDeserializer) objCreateAdapter : null, gson, typeToken, z2 ? TREE_TYPE_CLASS_DUMMY_FACTORY : TREE_TYPE_FIELD_DUMMY_FACTORY, zNullSafe);
            zNullSafe = false;
        }
