...
final class zzbc {
    ...
    public final Task zzc(int i2) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        if (this.zza == null) {
            return zzp();
        }
        zzb.zzd("cancelInstall(%d)", Integer.valueOf(i2));
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        this.zza.zzs(new zzas(this, taskCompletionSource, i2, taskCompletionSource), taskCompletionSource);
        return taskCompletionSource.getTask();
    }

    public final Task zzd(List list) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        if (this.zza == null) {
            return zzp();
        }
    ...
    public final Task zze(List list) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        if (this.zza == null) {
            return zzp();
        }
    ...
    public final Task zzf(List list) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        if (this.zza == null) {
            return zzp();
        }
    ...
    public final Task zzg(List list) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        if (this.zza == null) {
            return zzp();
        }
    ...
    public final Task zzh(int i2) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        if (this.zza == null) {
            return zzp();
        }
        zzb.zzd("getSessionState(%d)", Integer.valueOf(i2));
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        this.zza.zzs(new zzaq(this, taskCompletionSource, i2, taskCompletionSource), taskCompletionSource);
        return taskCompletionSource.getTask();
    }

    public final Task zzi() throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        if (this.zza == null) {
            return zzp();
        }
    ...
    public final Task zzj(Collection collection, Collection collection2, com.google.android.play.core.splitinstall.internal.zzn zznVar) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        if (this.zza == null) {
            return zzp();
        }
