...
final class zzba extends zzbb {
    ...
    public final void zzi(int i2, Bundle bundle) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException, RemoteException {
        super.zzi(i2, bundle);
        this.zza.trySetResult(Integer.valueOf(i2));
    }
}
