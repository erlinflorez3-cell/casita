...
final class zza extends SplitInstallSessionState {
    ...
    zza(int i2, int i3, int i4, long j2, long j3, List list, List list2, PendingIntent pendingIntent, List list3) {
        this.zza = i2;
        this.zzb = i3;
        this.zzc = i4;
        this.zzd = j2;
    ...
    public final int hashCode() {
        int i2 = ((((this.zza ^ 1000003) * 1000003) ^ this.zzb) * 1000003) ^ this.zzc;
        long j2 = this.zzd;
        long j3 = j2 ^ (j2 >>> 32);
        long j4 = this.zze;
        long j5 = (j4 >>> 32) ^ j4;
        List list = this.zzf;
        int iHashCode = ((((((i2 * 1000003) ^ ((int) j3)) * 1000003) ^ ((int) j5)) * 1000003) ^ (list == null ? 0 : list.hashCode())) * 1000003;
        List list2 = this.zzg;
