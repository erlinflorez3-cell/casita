...
public class ShapePath {
    ...
    static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i2, Canvas canvas) {
            ...
            double dHypot = Math.hypot(this.operation1.f3319x - this.startX, this.operation1.f3320y - this.startY);
            double dHypot2 = Math.hypot(this.operation2.f3319x - this.operation1.f3319x, this.operation2.f3320y - this.operation1.f3320y);
            ...
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.operation1.f3319x, this.operation1.f3320y);
            this.renderMatrix.preRotate(getStartAngle());
        ...
        float getEndAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation2.f3320y - this.operation1.f3320y) / (this.operation2.f3319x - this.operation1.f3319x)));
        }

        float getStartAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation1.f3320y - this.startY) / (this.operation1.f3319x - this.startX)));
        }
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        @Override // com.google.android.material.shape.ShapePath.ShadowCompatOperation
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i2, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f3320y - this.startY, this.operation.f3319x - this.startX), 0.0f);
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.startX, this.startY);
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f3320y - this.startY) / (this.operation.f3319x - this.startX)));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            matrix.invert(matrix2);
            path.transform(matrix2);
            path.lineTo(this.f3319x, this.f3320y);
            path.transform(matrix);
        }
    }
    ...
    public void lineTo(float f2, float f3) {
        ...
        pathLineOperation.f3319x = f2;
        pathLineOperation.f3320y = f3;
    ...
    public void lineTo(float f2, float f3, float f4, float f5) {
        ...
        pathLineOperation2.f3319x = f4;
        pathLineOperation2.f3320y = f5;
