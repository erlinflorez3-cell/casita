...
public final class SlideDistanceProvider implements VisibilityAnimatorProvider {
    ...
    private int getSlideDistanceOrDefault(Context context) throws Throwable {
        ...
        short sXd = (short) (Od.Xd() ^ (-20583));
        short sXd2 = (short) (Od.Xd() ^ (-31835));
        ...
        Method method = Class.forName(new String(iArr, 0, i3)).getMethod(Jg.Wd("\u001a6c>o\u001c\u001594Bbn", (short) (OY.Xd() ^ 12328), (short) (OY.Xd() ^ 19455)), new Class[0]);
        try {
