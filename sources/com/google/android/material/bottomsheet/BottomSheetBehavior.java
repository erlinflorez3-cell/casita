...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements MaterialBackHandler {
    ...
    class AnonymousClass4 implements ViewUtils.OnApplyWindowInsetsListener {
        ...
        public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat, ViewUtils.RelativePadding relativePadding) throws Throwable {
            boolean z2;
    ...
    class AnonymousClass5 extends ViewDragHelper.Callback {
        ...
        /* JADX WARN: Removed duplicated region for block: B:70:0x0010  */
        @Override // androidx.customview.widget.ViewDragHelper.Callback
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        public void onViewReleased(android.view.View r9, float r10, float r11) throws java.lang.Throwable {
            /*
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) throws Throwable {
        ...
        Method method = Class.forName(C1561oA.ud("$0%2.'!i\u001e)',\u001c$)au!\u001f$\u0014&!", (short) (FB.Xd() ^ 12978))).getMethod(C1561oA.yd("\u0019\u0016(\u0005\u0013 \u001f$,\u001c!.", (short) (FB.Xd() ^ 26902)), new Class[0]);
        try {
            method.setAccessible(true);
            this.peekHeightGestureInsetBuffer = ((Resources) method.invoke(context, objArr)).getDimensionPixelSize(R.dimen.mtrl_min_touch_target_size);
            Object[] objArr2 = {attributeSet, R.styleable.BottomSheetBehavior_Layout};
            Method method2 = Class.forName(C1561oA.Yd("'5,;940z1>>E7AH\u0003\u0019FFM?SP", (short) (ZN.Xd() ^ 750))).getMethod(Jg.Wd("X]Eh\u0018q\fA\f3C\u0019;\u00016\u000bIw_q)\r", (short) (ZN.Xd() ^ 30375), (short) (ZN.Xd() ^ 21522)), Class.forName(Xg.qd("$2)861-w@@6:|\u0011EFE=7KK=,?O", (short) (C1607wl.Xd() ^ 17882), (short) (C1607wl.Xd() ^ 22536))), int[].class);
            try {
                method2.setAccessible(true);
                TypedArray typedArray = (TypedArray) method2.invoke(context, objArr2);
                if (typedArray.hasValue(R.styleable.BottomSheetBehavior_Layout_backgroundTint)) {
                    this.backgroundTint = MaterialResources.getColorStateList(context, typedArray, R.styleable.BottomSheetBehavior_Layout_backgroundTint);
                }
                if (typedArray.hasValue(R.styleable.BottomSheetBehavior_Layout_shapeAppearance)) {
                ...
                if (typedArray.hasValue(R.styleable.BottomSheetBehavior_Layout_android_maxHeight)) {
                    setMaxHeight(typedArray.getDimensionPixelSize(R.styleable.BottomSheetBehavior_Layout_android_maxHeight, -1));
                }
                TypedValue typedValuePeekValue = typedArray.peekValue(R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight);
                ...
                TypedValue typedValuePeekValue2 = typedArray.peekValue(R.styleable.BottomSheetBehavior_Layout_behavior_expandedOffset);
                ...
                setSignificantVelocityThreshold(typedArray.getInt(R.styleable.BottomSheetBehavior_Layout_behavior_significantVelocityThreshold, 500));
                ...
                this.marginLeftSystemWindowInsets = typedArray.getBoolean(R.styleable.BottomSheetBehavior_Layout_marginLeftSystemWindowInsets, false);
                this.marginRightSystemWindowInsets = typedArray.getBoolean(R.styleable.BottomSheetBehavior_Layout_marginRightSystemWindowInsets, false);
                this.marginTopSystemWindowInsets = typedArray.getBoolean(R.styleable.BottomSheetBehavior_Layout_marginTopSystemWindowInsets, false);
                this.shouldRemoveExpandedCorners = typedArray.getBoolean(R.styleable.BottomSheetBehavior_Layout_shouldRemoveExpandedCorners, true);
                typedArray.recycle();
    ...
    private int addAccessibilityActionForState(View view, int i2, int i3) {
    ...
    private void clearAccessibilityAction(View view, int i2) throws Throwable {
        if (view == null) {
            return;
        }
    ...
    private void createMaterialShapeDrawableIfNeeded(Context context) throws Throwable {
        ...
        Object[] objArr = new Object[0];
        Method method = Class.forName(ZO.xd("&\u000f\u001b\u001fcuiO\nX)\u0006-|^\u001f(Fn*t\u0007\u007f", (short) (OY.Xd() ^ 19030), (short) (OY.Xd() ^ 23061))).getMethod(C1626yg.Ud("A\u0003 rmv\u000e+", (short) (ZN.Xd() ^ 17645), (short) (ZN.Xd() ^ 28470)), new Class[0]);
        try {
            method.setAccessible(true);
    ...
    private void replaceAccessibilityActionForState(View view, AccessibilityNodeInfoCompat.AccessibilityActionCompat accessibilityActionCompat, int i2) throws Throwable {
    ...
    private void setWindowInsetsListener(View view) {
        boolean z2 = (Build.VERSION.SDK_INT < 29 || isGestureInsetBottomIgnored() || this.peekHeightAuto) ? false : true;
        if (this.paddingBottomSystemWindowInsets || this.paddingLeftSystemWindowInsets || this.paddingRightSystemWindowInsets || this.marginLeftSystemWindowInsets || this.marginRightSystemWindowInsets || this.marginTopSystemWindowInsets || z2) {
            ViewUtils.doOnApplyWindowInsets(view, new ViewUtils.OnApplyWindowInsetsListener() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.4
                ...
                @Override // com.google.android.material.internal.ViewUtils.OnApplyWindowInsetsListener
                public WindowInsetsCompat onApplyWindowInsets(View view2, WindowInsetsCompat windowInsetsCompat, ViewUtils.RelativePadding relativePadding) throws Throwable {
                    boolean z22;
                    Insets insets = windowInsetsCompat.getInsets(WindowInsetsCompat.Type.systemBars());
                    Insets insets2 = windowInsetsCompat.getInsets(WindowInsetsCompat.Type.mandatorySystemGestures());
                    BottomSheetBehavior.this.insetTop = insets.top;
    ...
    private void updateAccessibilityActions(View view, int i2) throws Throwable {
        if (view == null) {
            return;
        }
    ...
    public void updatePeekHeight(boolean z2) throws Throwable {
        V v2;
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout coordinatorLayout, V v2, MotionEvent motionEvent) {
        ...
        return (actionMasked != 2 || view2 == null || this.ignoreEvents || this.state == 1 || coordinatorLayout.isPointInChildBounds(view2, (int) motionEvent.getX(), (int) motionEvent.getY()) || this.viewDragHelper == null || (i2 = this.initialY) == -1 || Math.abs(((float) i2) - motionEvent.getY()) <= ((float) this.viewDragHelper.getTouchSlop())) ? false : true;
    }
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, V v2, int i2) throws Throwable {
        ...
        for (int i8 = 0; i8 < this.callbacks.size(); i8++) {
            this.callbacks.get(i8).onLayout(v2);
        }
        return true;
    }
    ...
    @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, V v2, View view, int i2, int i3, int[] iArr, int i4) throws Throwable {
        if (i4 == 1) {
            return;
        }
        WeakReference<View> weakReference = this.nestedScrollingChildRef;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void onStopNestedScroll(androidx.coordinatorlayout.widget.CoordinatorLayout r7, V r8, android.view.View r9, int r10) throws java.lang.Throwable {
        /*
            r6 = this;
            int r1 = r8.getTop()
            ...
            return
        Lf:
            boolean r0 = r6.isNestedScrollingCheckEnabled()
            if (r0 == 0) goto L24
            java.lang.ref.WeakReference<android.view.View> r0 = r6.nestedScrollingChildRef
            if (r0 == 0) goto L23
            java.lang.Object r0 = r0.get()
            if (r9 != r0) goto L23
            boolean r0 = r6.nestedScrolled
            if (r0 != 0) goto L24
        L23:
            return
        L24:
            int r0 = r6.lastNestedScrollDy
            r5 = 6
            if (r0 <= 0) goto L34
            boolean r0 = r6.fitToContents
            if (r0 == 0) goto La5
        L2d:
            r0 = 0
            r6.startSettling(r8, r3, r0)
            r6.nestedScrolled = r0
            return
        L34:
            boolean r0 = r6.hideable
            if (r0 == 0) goto L44
            float r0 = r6.getYVelocity()
            boolean r0 = r6.shouldHide(r8, r0)
            if (r0 == 0) goto L44
            r3 = 5
            goto L2d
        L44:
        ...
        L87:
            ...
            goto Lad
        L9d:
            boolean r0 = r6.shouldSkipHalfExpandedStateWhenDragging()
            if (r0 == 0) goto Lad
        La3:
            r3 = r4
            goto L2d
    ...
    void setAccessibilityDelegateView(View view) throws Throwable {
        WeakReference<View> weakReference;
    ...
    public void setFitToContents(boolean z2) throws Throwable {
    ...
    public void setHideable(boolean z2) throws Throwable {
        if (this.hideable != z2) {
            this.hideable = z2;
            if (!z2 && this.state == 5) {
                setState(4);
    ...
    public void setPeekHeight(int i2) throws Throwable {
        setPeekHeight(i2, false);
    }

    public final void setPeekHeight(int i2, boolean z2) throws Throwable {
        if (i2 == -1) {
            if (this.peekHeightAuto) {
                return;
            } else {
    ...
    public void setState(int i2) throws Throwable {
        if (i2 == 1 || i2 == 2) {
            throw new IllegalArgumentException("STATE_" + (i2 == 1 ? "DRAGGING" : "SETTLING") + " should not be set externally.");
        }
        if (!this.hideable && i2 == 5) {
            String str = "Cannot set state: " + i2;
            return;
        }
        int i3 = (i2 == 6 && this.fitToContents && getTopOffsetForState(i2) <= this.fitToContentsOffset) ? 3 : i2;
        WeakReference<V> weakReference = this.viewRef;
        if (weakReference == null || weakReference.get() == null) {
            setStateInternal(i2);
        } else {
            ...
            runAfterLayout(v2, new Runnable() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.1
                ...
                AnonymousClass1(View v22, int i32) {
                    view = v22;
                    i = i32;
                }
