...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) throws Throwable {
            ...
            Class<?> cls = Class.forName(C1561oA.Qd("\u0002\u000e\u0003\u0010\f\u0005~G{\u0007\u0005\ny\u0002\u0007?S~|\u0002q\u0004~", (short) (ZN.Xd() ^ 8446)));
            Class<?>[] clsArr = new Class[2];
            short sXd = (short) (C1499aX.Xd() ^ (-29117));
            short sXd2 = (short) (C1499aX.Xd() ^ (-3578));
            int[] iArr2 = new int["\u007f\u000e\u0005\u0014\u0012\r\tS\u001c\u001c\u0012\u0016Xl!\"!\u0019\u0013''\u0019\b\u001b+".length()];
            QB qb = new QB("\u007f\u000e\u0005\u0014\u0012\r\tS\u001c\u001c\u0012\u0016Xl!\"!\u0019\u0013''\u0019\b\u001b+");
            int i2 = 0;
            while (qb.YK()) {
                int iKK = qb.KK();
                Xu xuXd = Xu.Xd(iKK);
            ...
            short sXd3 = (short) (Od.Xd() ^ (-19324));
            int[] iArr3 = new int["I;L8?C'GK=53\u000fA@=3+=;+8".length()];
            QB qb2 = new QB("I;L8?C'GK=53\u000fA@=3+=;+8");
            int i3 = 0;
            while (qb2.YK()) {
                int iKK2 = qb2.KK();
                Xu xuXd2 = Xu.Xd(iKK2);
    ...
    private class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int i2) {
            CollapsingToolbarLayout.this.currentOffset = i2;
            ...
            float f2 = height;
            CollapsingToolbarLayout.this.collapsingTextHelper.setFadeModeStartFraction(Math.min(1.0f, (r1 - CollapsingToolbarLayout.this.getScrimVisibleHeightTrigger()) / f2));
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attributeSet, int i2) throws Throwable {
    ...
    private int getDefaultContentScrimColorForTitleCollapseFadeMode() throws Throwable {
    ...
    private void updateCollapsedBounds(boolean z2) {
        ...
        int i2 = this.tmpRect.left + (z2 ? titleMarginEnd : titleMarginStart);
        int i3 = this.tmpRect.top + maxOffsetForPinChild + titleMarginTop;
        int i4 = this.tmpRect.right;
        if (!z2) {
            titleMarginStart = titleMarginEnd;
        }
        collapsingTextHelper.setCollapsedBounds(i2, i3, i4 - titleMarginStart, (this.tmpRect.bottom + maxOffsetForPinChild) - titleMarginBottom);
    }
    ...
    public void setExpandedTitleTextAppearance(int i2) throws Throwable {
