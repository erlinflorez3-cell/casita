...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    ...
    public ShapeableImageView(Context context, AttributeSet attributeSet, int i2) throws Throwable {
        ...
        Class<?> cls = Class.forName(C1561oA.Yd("\u0003\u0011\b\u0017\u0015\u0010\fV\r\u001a\u001a!\u0013\u001d$^t\"\")\u001b/,", (short) (C1633zX.Xd() ^ (-31228))));
        Class<?>[] clsArr = {Class.forName(Xg.qd("\u0007\u0015\f\u001b\u0019\u0014\u0010Z##\u0019\u001d_s()( \u001a.. \u000f\"2", (short) (ZN.Xd() ^ 18407), (short) (ZN.Xd() ^ 26562))), int[].class, Integer.TYPE, Integer.TYPE};
        Object[] objArr = {attributeSet, iArr, Integer.valueOf(i2), Integer.valueOf(i3)};
        short sXd = (short) (FB.Xd() ^ 25112);
        short sXd2 = (short) (FB.Xd() ^ 11489);
        int[] iArr2 = new int["5z\u001bNUaX@d\u001eek\u0003|KPei\fQ@U".length()];
        QB qb = new QB("5z\u001bNUaX@d\u001eek\u0003|KPei\fQ@U");
        int i4 = 0;
        while (qb.YK()) {
            int iKK = qb.KK();
            Xu xuXd = Xu.Xd(iKK);
            iArr2[i4] = xuXd.fK(xuXd.CK(iKK) - ((i4 * sXd2) ^ sXd));
            i4++;
        }
        ...
        try {
            ...
            setLayerType(2, null);
            this.strokeColor = MaterialResources.getColorStateList(context2, typedArray, R.styleable.ShapeableImageView_strokeColor);
            this.strokeWidth = typedArray.getDimensionPixelSize(R.styleable.ShapeableImageView_strokeWidth, 0);
            int dimensionPixelSize = typedArray.getDimensionPixelSize(R.styleable.ShapeableImageView_contentPadding, 0);
            ...
            this.leftContentPadding = typedArray.getDimensionPixelSize(R.styleable.ShapeableImageView_contentPaddingLeft, dimensionPixelSize);
            this.topContentPadding = typedArray.getDimensionPixelSize(R.styleable.ShapeableImageView_contentPaddingTop, dimensionPixelSize);
            this.rightContentPadding = typedArray.getDimensionPixelSize(R.styleable.ShapeableImageView_contentPaddingRight, dimensionPixelSize);
            this.bottomContentPadding = typedArray.getDimensionPixelSize(R.styleable.ShapeableImageView_contentPaddingBottom, dimensionPixelSize);
            this.startContentPadding = typedArray.getDimensionPixelSize(R.styleable.ShapeableImageView_contentPaddingStart, Integer.MIN_VALUE);
            this.endContentPadding = typedArray.getDimensionPixelSize(R.styleable.ShapeableImageView_contentPaddingEnd, Integer.MIN_VALUE);
            typedArray.recycle();
