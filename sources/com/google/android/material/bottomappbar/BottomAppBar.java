...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
        ...
        public Behavior() {
            this.fabLayoutListener = new View.OnLayoutChangeListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.Behavior.1
                ...
                public void onLayoutChange(View view, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
                    ...
                    if (bottomAppBar == null || !(((z2 = view instanceof FloatingActionButton)) || (view instanceof ExtendedFloatingActionButton))) {
    ...
    public BottomAppBar(Context context, AttributeSet attributeSet, int i2) throws Throwable {
    ...
    public float getFabTranslationX(int i2) {
        ...
        return ((getMeasuredWidth() / 2) - ((zIsLayoutRtl ? this.leftInset : this.rightInset) + ((this.fabAlignmentModeEndMargin == -1 || findDependentView() == null) ? this.fabOffsetEndMode : (r1.getMeasuredWidth() / 2) + this.fabAlignmentModeEndMargin))) * (zIsLayoutRtl ? -1 : 1);
    }
    ...
    private float getFabTranslationY() {
        ...
        return findDependentView() != null ? (-((getMeasuredHeight() + getBottomInset()) - r2.getMeasuredHeight())) / 2 : 0;
    }
    ...
    public void translateActionMenuView(final ActionMenuView actionMenuView, final int i2, final boolean z2, boolean z3) {
        Runnable runnable = new Runnable() { // from class: com.google.android.material.bottomappbar.BottomAppBar.8
            ...
            public void run() {
                actionMenuView.setTranslationX(BottomAppBar.this.getActionMenuViewTranslationX(r3, i2, z2));
            }
        };
        if (z3) {
    ...
    public static void updateFabAnchorGravity(BottomAppBar bottomAppBar, View view) {
        ...
        if (bottomAppBar.fabAnchorMode == 1) {
            layoutParams.anchorGravity = (-1) - (((-1) - layoutParams.anchorGravity) & ((-1) - 48));
        }
        if (bottomAppBar.fabAnchorMode == 0) {
            int i2 = layoutParams.anchorGravity;
            layoutParams.anchorGravity = (i2 + 80) - (i2 & 80);
        }
    }
