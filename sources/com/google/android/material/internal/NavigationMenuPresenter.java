...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    private class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        private void setAccessibilityDelegate(View view, final int i2, final boolean z2) {
            ViewCompat.setAccessibilityDelegate(view, new AccessibilityDelegateCompat() { // from class: com.google.android.material.internal.NavigationMenuPresenter.NavigationMenuAdapter.1
                ...
                public void onInitializeAccessibilityNodeInfo(View view2, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                    ...
                    accessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(NavigationMenuAdapter.this.adjustItemPositionForA11yDelegate(i2), 1, 1, 1, z2, view2.isSelected()));
                }
            });
        }
        ...
        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public void onBindViewHolder(ViewHolder viewHolder, int i2) throws Throwable {
    ...
    @Override // androidx.appcompat.view.menu.MenuPresenter
    public void initForMenu(Context context, MenuBuilder menuBuilder) throws Throwable {
        this.layoutInflater = LayoutInflater.from(context);
        this.menu = menuBuilder;
        Object[] objArr = new Object[0];
        Method method = Class.forName(hg.Vd("7C8EA:4|1<:?/7<t\t427'94", (short) (C1499aX.Xd() ^ (-2345)), (short) (C1499aX.Xd() ^ (-9109)))).getMethod(C1561oA.ud("+(6\u0013%2-2.\u001e\u001f,", (short) (ZN.Xd() ^ 18876)), new Class[0]);
        try {
            method.setAccessible(true);
            this.paddingSeparator = ((Resources) method.invoke(context, objArr)).getDimensionPixelOffset(R.dimen.design_navigation_separator_vertical_padding);
