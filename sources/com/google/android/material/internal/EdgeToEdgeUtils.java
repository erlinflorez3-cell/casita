...
public class EdgeToEdgeUtils {
    ...
    public static void applyEdgeToEdge(Window window, boolean z2) throws Throwable {
        applyEdgeToEdge(window, z2, null, null);
    }

    public static void applyEdgeToEdge(Window window, boolean z2, Integer num, Integer num2) throws Throwable {
