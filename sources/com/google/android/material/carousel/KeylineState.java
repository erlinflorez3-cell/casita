...
final class KeylineState {
    ...
    static final class Builder {
        ...
        Builder addAnchorKeyline(float f2, float f3, float f4) {
        ...
        Builder addKeyline(float f2, float f3, float f4, boolean z2) {
            return addKeyline(f2, f3, f4, z2, false);
        }

        Builder addKeyline(float f2, float f3, float f4, boolean z2, boolean z3) {
            float fAbs;
            float f5 = f4 / 2.0f;
            float f6 = f2 - f5;
            float f7 = f5 + f2;
            ...
            return addKeyline(f2, f3, f4, z2, z3, fAbs);
        }

        Builder addKeyline(float f2, float f3, float f4, boolean z2, boolean z3, float f5) {
            return addKeyline(f2, f3, f4, z2, z3, f5, 0.0f, 0.0f);
        }

        Builder addKeyline(float f2, float f3, float f4, boolean z2, boolean z3, float f5, float f6, float f7) {
            if (f4 <= 0.0f) {
                return this;
            }
            if (z3) {
        ...
        Builder addKeylineRange(float f2, float f3, float f4, int i2) {
            return addKeylineRange(f2, f3, f4, i2, false);
        }

        Builder addKeylineRange(float f2, float f3, float f4, int i2, boolean z2) {
            if (i2 > 0 && f4 > 0.0f) {
