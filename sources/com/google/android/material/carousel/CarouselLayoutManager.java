...
public class CarouselLayoutManager extends RecyclerView.LayoutManager implements Carousel, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public CarouselLayoutManager(Context context, AttributeSet attributeSet, int i2, int i3) throws Throwable {
        ...
        this.recyclerViewSizeChangeListener = new View.OnLayoutChangeListener() { // from class: com.google.android.material.carousel.CarouselLayoutManager$$ExternalSyntheticLambda1
            ...
            public final void onLayoutChange(View view, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11) {
                this.f$0.m7580x2ff337cb(view, i4, i5, i6, i7, i8, i9, i10, i11);
            }
        };
    ...
    private void addViewAtPosition(RecyclerView.Recycler recycler, int i2, int i3) {
    ...
    private float calculateChildOffsetCenterForLocation(View view, float f2, KeylineRange keylineRange) {
        float fLerp = AnimationUtils.lerp(keylineRange.leftOrTop.locOffset, keylineRange.rightOrBottom.locOffset, keylineRange.leftOrTop.loc, keylineRange.rightOrBottom.loc, f2);
        ...
        return fLerp + ((f2 - keylineRange.rightOrBottom.loc) * ((1.0f - keylineRange.rightOrBottom.mask) + (this.orientationHelper.getMaskMargins((RecyclerView.LayoutParams) view.getLayoutParams()) / this.currentKeylineState.getItemSize())));
    }
    ...
    private int convertFocusDirectionToLayoutDirection(int i2) {
        ...
        String str = "Unknown focus request:" + i2;
        return Integer.MIN_VALUE;
    }
    ...
    private float getDecoratedCenterWithMargins(View view) {
        ...
        return isHorizontal() ? r1.centerX() : r1.centerY();
    }
    ...
    private float getMaskedItemSizeForLocOffset(float f2, KeylineRange keylineRange) {
        return AnimationUtils.lerp(keylineRange.leftOrTop.maskedItemSize, keylineRange.rightOrBottom.maskedItemSize, keylineRange.leftOrTop.locOffset, keylineRange.rightOrBottom.locOffset, f2);
    }
    ...
    private int getScrollOffsetForPosition(int i2, KeylineState keylineState) {
        return isLayoutRtl() ? (int) (((getContainerSize() - keylineState.getLastFocalKeyline().loc) - (i2 * keylineState.getItemSize())) - (keylineState.getItemSize() / 2.0f)) : (int) (((i2 * keylineState.getItemSize()) - keylineState.getFirstFocalKeyline().loc) + (keylineState.getItemSize() / 2.0f));
    }
    ...
    private void logChildrenIfDebugging() {
        if (this.isDebuggingEnabled && Log.isLoggable(TAG, 3)) {
            for (int i2 = 0; i2 < getChildCount(); i2++) {
                ...
                String str = "item position " + getPosition(childAt) + ", center:" + getDecoratedCenterWithMargins(childAt) + ", child index:" + i2;
            }
        }
    }
    ...
    private void setCarouselAttributes(Context context, AttributeSet attributeSet) throws Throwable {
        if (attributeSet != null) {
            int[] iArr = R.styleable.Carousel;
            Class<?> cls = Class.forName(hg.Vd("lxmzvoi2fqotdlq*>igl\\ni", (short) (C1607wl.Xd() ^ 28754), (short) (C1607wl.Xd() ^ 25705)));
            Class<?>[] clsArr = new Class[2];
            short sXd = (short) (FB.Xd() ^ 5588);
            int[] iArr2 = new int["\u0003\u000f\u0004\u0011\r\u0006\u007fH\u000f\r\u0001\u0003CU\b\u0007\u0004yq\u0004\u0002q^o}".length()];
            QB qb = new QB("\u0003\u000f\u0004\u0011\r\u0006\u007fH\u000f\r\u0001\u0003CU\b\u0007\u0004yq\u0004\u0002q^o}");
            int i2 = 0;
            while (qb.YK()) {
                int iKK = qb.KK();
                Xu xuXd = Xu.Xd(iKK);
            ...
            Method method = cls.getMethod(C1561oA.yd("n`uadhPp\u0001rnlDvyvxp\u0007\u0005p}", (short) (Od.Xd() ^ (-10192))), clsArr);
            try {
                method.setAccessible(true);
                TypedArray typedArray = (TypedArray) method.invoke(context, objArr);
                setCarouselAlignment(typedArray.getInt(R.styleable.Carousel_carousel_alignment, 0));
                setOrientation(typedArray.getInt(R.styleable.RecyclerView_android_orientation, 0));
                typedArray.recycle();
    ...
    private void updateChildMaskForLocation(View view, float f2, KeylineRange keylineRange) {
        if (view instanceof Maskable) {
            float fLerp = AnimationUtils.lerp(keylineRange.leftOrTop.mask, keylineRange.rightOrBottom.mask, keylineRange.leftOrTop.loc, keylineRange.rightOrBottom.loc, f2);
    ...
    int getOffsetToScrollToPosition(int i2, KeylineState keylineState) {
        return getScrollOffsetForPosition(i2, keylineState) - this.scrollOffset;
    }

    int getOffsetToScrollToPositionForSnap(int i2, boolean z2) {
    ...
    /* synthetic */ void m7580x2ff337cb(View view, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
    ...
    public void measureChildWithMargins(View view, int i2, int i3) {
        ...
        view.measure(getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingLeft() + getPaddingRight() + layoutParams.leftMargin + layoutParams.rightMargin + i2 + rect.left + rect.right, (int) ((this.keylineStateList == null || this.orientationHelper.orientation != 0) ? layoutParams.width : this.keylineStateList.getDefaultState().getItemSize()), canScrollHorizontally()), getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingTop() + getPaddingBottom() + layoutParams.topMargin + layoutParams.bottomMargin + i3 + rect.top + rect.bottom, (int) ((this.keylineStateList == null || this.orientationHelper.orientation != 1) ? layoutParams.height : this.keylineStateList.getDefaultState().getItemSize()), canScrollVertically()));
    }

    @Override // androidx.recyclerview.widget.RecyclerView.LayoutManager
    public void onAttachedToWindow(RecyclerView recyclerView) throws Throwable {
