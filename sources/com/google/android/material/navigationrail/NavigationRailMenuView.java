...
public class NavigationRailMenuView extends NavigationBarMenuView {
    ...
    boolean isTopGravity() {
        int i2 = this.layoutParams.gravity;
        return (i2 + PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION) - (i2 | PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION) == 48;
    }
    ...
    void setMenuGravity(int i2) {
        if (this.layoutParams.gravity != i2) {
