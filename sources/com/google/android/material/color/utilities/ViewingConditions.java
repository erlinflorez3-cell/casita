...
public final class ViewingConditions {
    ...
    private final double f3316c;
    private final double fl;
    private final double flRoot;

    /* JADX INFO: renamed from: n */
    private final double f3317n;
    ...
    public static ViewingConditions make(double[] dArr, double d2, double d3, double d4, boolean z2) {
        ...
        double d17 = 1.0d - d16;
        double dCbrt = (d16 * d2) + (0.1d * d17 * d17 * Math.cbrt(d14));
        ...
        double d19 = dArr7[1];
        double d20 = dArr7[2];
        double[] dArr8 = {(d18 * 400.0d) / (d18 + 27.13d), (d19 * 400.0d) / (d19 + 27.13d), (400.0d * d20) / (d20 + 27.13d)};
