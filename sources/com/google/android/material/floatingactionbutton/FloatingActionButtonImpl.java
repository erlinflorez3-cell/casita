...
class FloatingActionButtonImpl {
    ...
    class AnonymousClass1 extends AnimatorListenerAdapter {
        ...
        AnonymousClass1(boolean z2, InternalVisibilityChangedListener internalVisibilityChangedListener) {
            z = z2;
    ...
    class AnonymousClass2 extends AnimatorListenerAdapter {
        ...
        AnonymousClass2(boolean z2, InternalVisibilityChangedListener internalVisibilityChangedListener) {
            z = z2;
            internalVisibilityChangedListener = internalVisibilityChangedListener;
        }
    ...
    class AnonymousClass4 implements ValueAnimator.AnimatorUpdateListener {
        ...
        AnonymousClass4(float f2, float f3, float f4, float f5, float f6, float f7, float f8, Matrix matrix) {
            f = f2;
            f = f3;
            f = f4;
            f = f5;
    ...
    /* JADX INFO: renamed from: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl$6 */
    ...
    private AnimatorSet createAnimator(MotionSpec motionSpec, float f2, float f3, float f4) {
        ...
        ObjectAnimator objectAnimatorOfObject = ObjectAnimator.ofObject(this.view, new ImageMatrixProperty(), new MatrixEvaluator() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.3
            ...
            @Override // com.google.android.material.animation.MatrixEvaluator, android.animation.TypeEvaluator
            public Matrix evaluate(float f22, Matrix matrix, Matrix matrix2) {
    ...
    private AnimatorSet createDefaultAnimator(float f2, float f3, float f4, int i2, int i3) throws Throwable {
        AnimatorSet animatorSet = new AnimatorSet();
        ArrayList arrayList = new ArrayList();
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.4
            ...
            AnonymousClass4(float f22, float f23, float f42, float f32, float f6, float f7, float f43, Matrix matrix) {
                f = f22;
                f = f23;
                f = f42;
                f = f32;
        ...
        try {
            Class.forName(C1561oA.ud("P\\Q^ZSM\u0016JUSXHPU\u000e\"MKP@RM", (short) (C1607wl.Xd() ^ 15983))).getMethod(C1561oA.yd("98H'3B?FL>AP", (short) (C1607wl.Xd() ^ 9662)), new Class[0]).setAccessible(true);
            animatorSet.setDuration(MotionUtils.resolveThemeDuration(context, i2, ((Resources) r1.invoke(context2, objArr)).getInteger(R.integer.material_motion_duration_long_1)));
    ...
    void getPadding(Rect rect) {
        ...
        int iMax2 = Math.max(touchTargetPadding, (int) Math.ceil(r5 * SHADOW_MULTIPLIER));
    ...
    void hide(InternalVisibilityChangedListener internalVisibilityChangedListener, boolean z2) {
        if (isOrWillBeHidden()) {
            return;
        }
        ...
        animatorSetCreateAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.1
            ...
            AnonymousClass1(boolean z22, InternalVisibilityChangedListener internalVisibilityChangedListener2) {
                z = z22;
            ...
            public void onAnimationEnd(Animator animator2) {
                ...
                FloatingActionButton floatingActionButton = FloatingActionButtonImpl.this.view;
                boolean z22 = z;
                floatingActionButton.internalSetVisibility(z22 ? 8 : 4, z22);
    ...
    void initializeBackgroundDrawable(ColorStateList colorStateList, PorterDuff.Mode mode, ColorStateList colorStateList2, int i2) {
    ...
    void setEnsureMinTouchTargetSize(boolean z2) {
    ...
    void setShadowPaddingEnabled(boolean z2) {
    ...
    void show(InternalVisibilityChangedListener internalVisibilityChangedListener, boolean z2) {
        if (isOrWillBeShown()) {
            return;
        }
        Animator animator = this.currentAnimator;
        ...
        animatorSetCreateAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.2
            ...
            AnonymousClass2(boolean z22, InternalVisibilityChangedListener internalVisibilityChangedListener2) {
                z = z22;
                internalVisibilityChangedListener = internalVisibilityChangedListener2;
            }
