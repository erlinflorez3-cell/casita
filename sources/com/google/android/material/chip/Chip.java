...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    private class ChipTouchHelper extends ExploreByTouchHelper {
        ...
        protected void onPopulateNodeForVirtualView(int i2, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) throws Throwable {
            ...
            if (closeIconContentDescription != null) {
                ...
                CharSequence charSequence = TextUtils.isEmpty(text) ? "" : text;
                Class<?> cls = Class.forName(C1561oA.od("(4)62+%m\"-+0 (-ey%#(\u0018*%", (short) (C1580rY.Xd() ^ (-8156))));
                Class<?>[] clsArr = {Integer.TYPE, Object[].class};
                Object[] objArr = {Integer.valueOf(i3), new Object[]{charSequence}};
                Method method = cls.getMethod(C1561oA.Kd("CBR2TSKQK", (short) (C1633zX.Xd() ^ (-6470))), clsArr);
                try {
                    method.setAccessible(true);
                    accessibilityNodeInfoCompat.setContentDescription(((String) method.invoke(context, objArr)).trim());
    ...
    public Chip(Context context, AttributeSet attributeSet, int i2) throws Throwable {
        ...
        super.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.google.android.material.chip.Chip$$ExternalSyntheticLambda0
            ...
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z2) {
                this.f$0.m7583lambda$new$0$comgoogleandroidmaterialchipChip(compoundButton, z2);
            }
        });
    }
    ...
    private void updateTextPaintDrawState() throws Throwable {
    ...
    /* JADX INFO: renamed from: lambda$new$0$com-google-android-material-chip-Chip */
    /* synthetic */ void m7583lambda$new$0$comgoogleandroidmaterialchipChip(CompoundButton compoundButton, boolean z2) {
    ...
    */
    ...
    @Override // android.widget.TextView
    public void setTextAppearance(int i2) throws Throwable {
    ...
    public void setTextAppearanceResource(int i2) throws Throwable {
    ...
    @Override // android.widget.TextView
    public void setTextSize(int i2, float f2) throws Throwable {
