...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    private int getThemeResId() throws Throwable {
    ...
    public final Dialog onCreateDialog(Bundle bundle) throws Throwable {
        ...
        Class<?> cls = Class.forName(Jg.Wd("bJv=\u0011I\u001d=)uK(Q5uksZ\u0016V\u001c\n@", (short) (ZN.Xd() ^ 2046), (short) (ZN.Xd() ^ 26757)));
        Class<?>[] clsArr = {Class.forName(ZO.xd("\u0014\u007fK1YO\"\u000bx6-(g\u007fh\u0004\u001f?\u0007(\u0001sVGQ", (short) (C1607wl.Xd() ^ 29755), (short) (C1607wl.Xd() ^ 12265))), int[].class, Integer.TYPE, Integer.TYPE};
        Object[] objArr = {null, iArr, Integer.valueOf(i2), Integer.valueOf(i3)};
        Method method = cls.getMethod(C1626yg.Ud("QXwo,)V\u0011WR)O~\u0004fH\u0012K}\u0014\u001c;", (short) (Od.Xd() ^ (-22659)), (short) (Od.Xd() ^ (-24220))), clsArr);
        try {
            ...
            int color = typedArray.getColor(R.styleable.MaterialTimePicker_backgroundTint, 0);
            typedArray.recycle();
