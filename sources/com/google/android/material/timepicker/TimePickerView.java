...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public TimePickerView(Context context, AttributeSet attributeSet, int i2) {
        ...
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() { // from class: com.google.android.material.timepicker.TimePickerView$$ExternalSyntheticLambda0
            ...
            public final void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup2, int i3, boolean z2) {
                this.f$0.m7671x9f44237d(materialButtonToggleGroup2, i3, z2);
            }
        });
    ...
    /* synthetic */ void m7671x9f44237d(MaterialButtonToggleGroup materialButtonToggleGroup, int i2, boolean z2) {
        if (z2 && this.onPeriodChangeListener != null) {
            this.onPeriodChangeListener.onPeriodChange(i2 == R.id.material_clock_period_pm_button ? 1 : 0);
        }
    }
