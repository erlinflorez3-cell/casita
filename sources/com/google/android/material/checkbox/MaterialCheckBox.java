...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        private String getCheckedStateString() {
            ...
            return i2 != 1 ? i2 != 2 ? "unchecked" : ReactProgressBarViewManager.PROP_INDETERMINATE : "checked";
        }
    ...
    public MaterialCheckBox(Context context, AttributeSet attributeSet, int i2) throws Throwable {
        ...
        TintTypedArray tintTypedArrayObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, R.styleable.MaterialCheckBox, i2, i3, new int[0]);
    ...
    public void setCheckedState(int i2) throws Throwable {
        ...
        if (this.checkedState != i2) {
            ...
            Method method = Class.forName(EO.Od("\u0007dh\u001f\f*\u0011C/op\u0011ijr\bj\u000fg'O8\u0018", (short) (FB.Xd() ^ 14281))).getMethod(C1593ug.zd("ihxX\u007fz|nw^q\u007f\u0005xsv", (short) (C1607wl.Xd() ^ 19842), (short) (C1607wl.Xd() ^ 3573)), Class.forName(C1561oA.Qd("\f\u0002\u0016\u007fK\t|\t\u0001FZ\u0003v\b\u0007", (short) (C1499aX.Xd() ^ (-1700)))));
            try {
