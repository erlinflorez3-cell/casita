...
final class CctTransportBackend implements TransportBackend {
    ...
    CctTransportBackend(Context context, Clock clock, Clock clock2, int i2) throws Throwable {
        this.dataEncoder = BatchedLogRequest.createDataEncoder();
        this.applicationContext = context;
        Object[] objArr = {C1561oA.Xd("3@@A98J@NBNT", (short) (OY.Xd() ^ 6137))};
        Method method = Class.forName(Wg.vd("-92??86~'249-5>v~*,1%76", (short) (C1580rY.Xd() ^ (-17049)))).getMethod(hg.Vd("OLZ8]VVFM2CORD=>", (short) (OY.Xd() ^ 31896), (short) (OY.Xd() ^ 7167)), Class.forName(Qg.kd("\u0001v\u000bt@}q}u;_\u007f|rvn", (short) (Od.Xd() ^ (-7801)), (short) (Od.Xd() ^ (-8470)))));
        try {
            method.setAccessible(true);
            this.connectivityManager = (ConnectivityManager) method.invoke(context, objArr);
    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws Exception {
        Logging.i(LOG_TAG, "Making request to: %s", httpRequest.url);
        URLConnection uRLConnectionOpenConnection = httpRequest.url.openConnection();
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Logging.d(LOG_TAG, "Content-Type: %s", Callback.getHeaderField(httpURLConnection, "Content-Type"));
                    Logging.d(LOG_TAG, "Content-Encoding: %s", Callback.getHeaderField(httpURLConnection, "Content-Encoding"));
                    if (responseCode == 302 || responseCode == 301 || responseCode == 307) {
                        return new HttpResponse(responseCode, new URL(Callback.getHeaderField(httpURLConnection, "Location")), 0L);
                    }
                    if (responseCode != 200) {
                    ...
                    try {
                        InputStream inputStreamMaybeUnGzip = maybeUnGzip(inputStream, Callback.getHeaderField(httpURLConnection, "Content-Encoding"));
                        try {
    ...
    private static int getPackageVersionCode(Context context) throws Throwable {
        try {
            Object[] objArr = new Object[0];
            Method method = Class.forName(C1561oA.ud("p|q~zsm6jusxhpu.Bmkp`rm", (short) (C1499aX.Xd() ^ (-25589)))).getMethod(C1561oA.yd("HES.>?F;PM4GSEJGC", (short) (OY.Xd() ^ 23775)), new Class[0]);
            try {
                method.setAccessible(true);
                PackageManager packageManager = (PackageManager) method.invoke(context, objArr);
                Object[] objArr2 = new Object[0];
                Method method2 = Class.forName(C1561oA.Yd("R`Wfd_[&\\iipbls.Dqqxj~{", (short) (C1607wl.Xd() ^ 10591))).getMethod(Xg.qd("WVfCUXaX_^H\\ib", (short) (C1633zX.Xd() ^ (-14204)), (short) (C1633zX.Xd() ^ (-11592))), new Class[0]);
                try {
                    method2.setAccessible(true);
                    String str = (String) method2.invoke(context, objArr2);
                    Class<?> cls = Class.forName(Jg.Wd("!+\u001cN@>sA\f\u0014\u0016\u0019\u0006*4j\u0001`=diNs\u0006\u0007\u0001M=ETW99", (short) (ZN.Xd() ^ 14172), (short) (ZN.Xd() ^ 4653)));
                    Class<?>[] clsArr = new Class[2];
                    clsArr[0] = Class.forName(ZO.xd("\"m(\"\u0002P6D?\u0012E\u0013\u000f\u0003L\u0015", (short) (C1580rY.Xd() ^ (-2792)), (short) (C1580rY.Xd() ^ (-4865))));
                    clsArr[1] = Integer.TYPE;
                    Object[] objArr3 = {str, 0};
                    Method method3 = cls.getMethod(C1626yg.Ud("A\u0010v\u0005BSKHkw\u0001\\gk", (short) (ZN.Xd() ^ 16353), (short) (ZN.Xd() ^ 21626)), clsArr);
                    try {
            ...
            Logging.e(Ig.wd(":!PO5oh5\u0010\n\u00173Roa\u0003H/\r", (short) (Od.Xd() ^ (-14437))), EO.Od("K49V1f\u00016kL\u00116ii*`\u0015\"|\tJ'4uM\u0014xx\u001f\u001chu pD\u001ceM8", (short) (ZN.Xd() ^ 31625)), e5);
            return -1;
        }
    }
    ...
    private static TelephonyManager getTelephonyManager(Context context) throws Throwable {
        Object[] objArr = {C1561oA.Qd("ulrpf", (short) (C1580rY.Xd() ^ (-27776)))};
        Method method = Class.forName(C1593ug.zd(",:1@>95\u007f6CCJ<FM\b\u001eKKRDXU", (short) (C1607wl.Xd() ^ 21889), (short) (C1607wl.Xd() ^ 11964))).getMethod(C1561oA.Kd("ihxX\u007fz|nw^q\u007f\u0005xsv", (short) (C1580rY.Xd() ^ (-20586))), Class.forName(C1561oA.od("\u001a\u0010$\u000eY\u0017\u000b\u0017\u000fTx\u0019\u0016\f\u0010\b", (short) (C1580rY.Xd() ^ (-4484)))));
        try {
            method.setAccessible(true);
            return (TelephonyManager) method.invoke(context, objArr);
        } catch (InvocationTargetException e2) {
            throw e2.getCause();
        }
    }
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            ...
            return httpResponse.code == 200 ? BackendResponse.ok(httpResponse.nextRequestMillis) : (httpResponse.code >= 500 || httpResponse.code == 404) ? BackendResponse.transientError() : httpResponse.code == 400 ? BackendResponse.invalidPayload() : BackendResponse.fatalError();
