...
final class AutoValue_LogEvent extends LogEvent {
    ...
    /* synthetic */ AutoValue_LogEvent(long j2, Integer num, ComplianceData complianceData, long j3, byte[] bArr, String str, long j4, NetworkConnectionInfo networkConnectionInfo, ExperimentIds experimentIds, AnonymousClass1 anonymousClass1) {
        this(j2, num, complianceData, j3, bArr, str, j4, networkConnectionInfo, experimentIds);
    }
    ...
    public int hashCode() {
        ...
        int iHashCode3 = (((((iHashCode ^ iHashCode2) * 1000003) ^ ((int) (j3 ^ (j3 >>> 32)))) * 1000003) ^ Arrays.hashCode(this.sourceExtension)) * 1000003;
        ...
        int iHashCode5 = (i3 ^ (networkConnectionInfo == null ? 0 : networkConnectionInfo.hashCode())) * 1000003;
        ExperimentIds experimentIds = this.experimentIds;
