...
public class PublicKeyCredentialRequestOptions extends RequestOptions {
    ...
    PublicKeyCredentialRequestOptions(byte[] bArr, Double d2, String str, List list, Integer num, TokenBinding tokenBinding, String str2, AuthenticationExtensions authenticationExtensions, Long l2) {
        this.zza = (byte[]) Preconditions.checkNotNull(bArr);
        this.zzb = d2;
        this.zzc = (String) Preconditions.checkNotNull(str);
        this.zzd = list;
