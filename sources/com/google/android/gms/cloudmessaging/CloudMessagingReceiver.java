...
public abstract class CloudMessagingReceiver extends BroadcastReceiver {
    private static SoftReference zza = null;
    private static SoftReference zzb = null;
    ...
    final /* synthetic */ void zza(Intent intent, final Context context, boolean z2, BroadcastReceiver.PendingResult pendingResult) {
        Executor executorUnconfigurableExecutorService;
        int iOnMessageReceive;
        try {
            Parcelable parcelableExtra = intent.getParcelableExtra(IntentKeys.WRAPPED_INTENT);
            Intent intent2 = parcelableExtra instanceof Intent ? (Intent) parcelableExtra : null;
            if (intent2 != null) {
                iOnMessageReceive = zzb(context, intent2);
            } else if (intent.getExtras() == null) {
                iOnMessageReceive = 500;
            } else {
                ...
                iOnMessageReceive = onMessageReceive(context, cloudMessage);
                try {
            ...
            if (z2 && pendingResult != null) {
                pendingResult.setResultCode(iOnMessageReceive);
            }
        } finally {
