...
public interface IStreetViewPanoramaDelegate extends IInterface {
    void animateTo(StreetViewPanoramaCamera streetViewPanoramaCamera, long j2) throws RemoteException;
    ...
    void setPositionWithRadius(LatLng latLng, int i2) throws RemoteException;

    void setPositionWithRadiusAndSource(LatLng latLng, int i2, @Nullable StreetViewSource streetViewSource) throws RemoteException;
