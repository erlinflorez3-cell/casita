...
public class GoogleMap {
    ...
    public final GroundOverlay addGroundOverlay(GroundOverlayOptions groundOverlayOptions) {
        try {
            ...
            com.google.android.gms.internal.maps.zzr zzrVarAddGroundOverlay = this.zza.addGroundOverlay(groundOverlayOptions);
    ...
    public final Marker addMarker(MarkerOptions markerOptions) {
        ...
        try {
            ...
            com.google.android.gms.internal.maps.zzad zzadVarAddMarker = this.zza.addMarker(markerOptions);
            if (zzadVarAddMarker != null) {
                return markerOptions.zzb() == 1 ? new AdvancedMarker(zzadVarAddMarker) : new Marker(zzadVarAddMarker);
            }
            return null;
        } catch (RemoteException e2) {
            throw new RuntimeRemoteException(e2);
    ...
    public final TileOverlay addTileOverlay(TileOverlayOptions tileOverlayOptions) {
        try {
            ...
            com.google.android.gms.internal.maps.zzam zzamVarAddTileOverlay = this.zza.addTileOverlay(tileOverlayOptions);
    ...
    public final void animateCamera(CameraUpdate cameraUpdate, int i2, CancelableCallback cancelableCallback) {
        try {
            Preconditions.checkNotNull(cameraUpdate, "CameraUpdate must not be null.");
            this.zza.animateCameraWithDurationAndCallback(cameraUpdate.zza(), i2, cancelableCallback == null ? null : new zzab(cancelableCallback));
        } catch (RemoteException e2) {
            throw new RuntimeRemoteException(e2);
        }
    }
