...
public final class VisibleRegion extends AbstractSafeParcelable {
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 3, this.nearRight, i2, false);
        SafeParcelWriter.writeParcelable(parcel, 4, this.farLeft, i2, false);
        SafeParcelWriter.writeParcelable(parcel, 5, this.farRight, i2, false);
        SafeParcelWriter.writeParcelable(parcel, 6, this.latLngBounds, i2, false);
