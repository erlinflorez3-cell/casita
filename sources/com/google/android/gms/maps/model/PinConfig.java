...
public class PinConfig extends AbstractSafeParcelable {
    ...
    public static class Glyph extends AbstractSafeParcelable {
        ...
        public Glyph(String str, int i2) {
            this.zzc = PinConfig.DEFAULT_PIN_GLYPH_COLOR;
            this.zza = str;
            this.zzd = i2;
        }

        Glyph(String str, IBinder iBinder, int i2, int i3) {
            this.zzc = PinConfig.DEFAULT_PIN_GLYPH_COLOR;
            this.zzd = ViewCompat.MEASURED_STATE_MASK;
            this.zza = str;
    ...
    PinConfig(int i2, int i3, Glyph glyph) {
        this.zza = i2;
        this.zzb = i3;
        this.zzc = glyph;
    }
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 4, getGlyph(), i2, false);
        SafeParcelWriter.finishObjectHeader(parcel, iBeginObjectHeader);
    }
}
