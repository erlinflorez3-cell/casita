...
public final class TextRecognizer extends Detector<TextBlock> {
    ...
    public final SparseArray<TextBlock> detect(Frame frame) {
        ...
        if (frame.getBitmap() != null) {
            ...
            int i2 = zzsVarZza.zza;
            int i3 = zzsVarZza.zzb;
            ...
            new YuvImage(bArrArray, format, i2, i3, null).compressToJpeg(new Rect(0, 0, i2, i3), 100, byteArrayOutputStream);
        ...
        for (int i5 = 0; i5 < sparseArray.size(); i5++) {
            sparseArray3.append(sparseArray.keyAt(i5), new TextBlock((SparseArray) sparseArray.valueAt(i5)));
        }
        return sparseArray3;
    }
