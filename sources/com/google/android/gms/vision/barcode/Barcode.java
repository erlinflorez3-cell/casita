...
public class Barcode extends AbstractSafeParcelable {
    ...
    public static class CalendarEvent extends AbstractSafeParcelable {
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            SafeParcelWriter.writeParcelable(parcel, 7, this.start, i2, false);
            SafeParcelWriter.writeParcelable(parcel, 8, this.end, i2, false);
            SafeParcelWriter.finishObjectHeader(parcel, iBeginObjectHeader);
        }
    }
    ...
    public static class ContactInfo extends AbstractSafeParcelable {
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            int iBeginObjectHeader = SafeParcelWriter.beginObjectHeader(parcel);
            SafeParcelWriter.writeParcelable(parcel, 2, this.name, i2, false);
            SafeParcelWriter.writeString(parcel, 3, this.organization, false);
            SafeParcelWriter.writeString(parcel, 4, this.title, false);
            SafeParcelWriter.writeTypedArray(parcel, 5, this.phones, i2, false);
            SafeParcelWriter.writeTypedArray(parcel, 6, this.emails, i2, false);
            SafeParcelWriter.writeStringArray(parcel, 7, this.urls, false);
            SafeParcelWriter.writeTypedArray(parcel, 8, this.addresses, i2, false);
            SafeParcelWriter.finishObjectHeader(parcel, iBeginObjectHeader);
        }
    }
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        ...
        SafeParcelWriter.writeTypedArray(parcel, 6, this.cornerPoints, i2, false);
        SafeParcelWriter.writeParcelable(parcel, 7, this.email, i2, false);
        SafeParcelWriter.writeParcelable(parcel, 8, this.phone, i2, false);
        SafeParcelWriter.writeParcelable(parcel, 9, this.sms, i2, false);
        SafeParcelWriter.writeParcelable(parcel, 10, this.wifi, i2, false);
        SafeParcelWriter.writeParcelable(parcel, 11, this.url, i2, false);
        SafeParcelWriter.writeParcelable(parcel, 12, this.geoPoint, i2, false);
        SafeParcelWriter.writeParcelable(parcel, 13, this.calendarEvent, i2, false);
        SafeParcelWriter.writeParcelable(parcel, 14, this.contactInfo, i2, false);
        SafeParcelWriter.writeParcelable(parcel, 15, this.driverLicense, i2, false);
