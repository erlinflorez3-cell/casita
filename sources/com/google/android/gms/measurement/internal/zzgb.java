...
public interface zzgb extends IInterface {
    ...
    List<zzon> zza(String str, String str2, String str3, boolean z2) throws RemoteException;

    List<zzon> zza(String str, String str2, boolean z2, zzo zzoVar) throws RemoteException;
