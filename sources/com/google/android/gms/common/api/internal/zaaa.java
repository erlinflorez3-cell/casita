...
final class zaaa implements zaca {
    ...
    static /* bridge */ /* synthetic */ void zan(zaaa zaaaVar, int i2, boolean z2) throws Throwable {
    ...
    public final void zau() {
        ...
        try {
            ...
            if (zZax) {
                com.google.android.gms.internal.base.zau zauVar = new com.google.android.gms.internal.base.zau(this.zac);
                zav zavVar = new zav(this);
                Class<?> cls = Class.forName(C1561oA.ud("IUJWSLF\u000fOR\f%=I>E=I", (short) (C1633zX.Xd() ^ (-10704))));
                Class<?>[] clsArr = new Class[1];
                clsArr[0] = Class.forName(C1561oA.yd("<4J6{;1?A\t.RDE9;.(", (short) (C1499aX.Xd() ^ (-22856))));
                Object[] objArr = {zavVar};
                Method method = cls.getMethod(C1561oA.Yd("\u0002\u0002\u0007\t", (short) (OY.Xd() ^ 17917)), clsArr);
                try {
                    method.setAccessible(true);
                    method.invoke(zauVar, objArr);
