...
public final class zaaw implements zabf {
    ...
    public final boolean zaG(int i2) {
        ...
        String str = "mRemainingConnections=" + this.zah;
        String str2 = "GoogleApiClient connecting is in step " + zaJ(this.zag) + " but received callback for step " + zaJ(i2);
        new Exception();
    ...
    /* JADX WARN: Type inference failed for: r0v19, types: [com.google.android.gms.common.api.Api$Client, com.google.android.gms.signin.zae] */
    @Override // com.google.android.gms.common.api.internal.zabf
