    ...
    public final zzaq zza(String str, zzh zzhVar, List<zzaq> list) {
        ...
        switch (zzbs.zza[zzg.zza(str).ordinal()]) {
            ...
            case 4:
                ...
                while (i2 < list.size() - 1) {
                    zzaq zzaqVarZza5 = zzhVar.zza(list.get(i2));
                    zzaq zzaqVarZza6 = zzhVar.zza(list.get(i2 + 1));
            ...
            case 5:
                ...
                while (i2 < list.size()) {
                    zzaqVarZza7 = zzhVar.zza(list.get(i2));
            ...
            case 8:
                ...
                if (zzaqVarZza9 instanceof zzas) {
                    if (SentryEnvelopeItemHeader.JsonKeys.LENGTH.equals(zzaqVarZza10.zzf())) {
