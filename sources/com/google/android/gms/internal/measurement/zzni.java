...
public final class zzni implements zznj {
    ...
    static {
        ...
        zze = zzhrVarZza.zza("measurement.config.cache_time", CalendarModelKt.MillisecondsIn24Hours);
        ...
        zzw = zzhrVarZza.zza("measurement.alarm_manager.minimum_interval", StatsigLoggerKt.FLUSH_TIMER_MS);
        zzx = zzhrVarZza.zza("measurement.upload.minimum_delay", 500L);
        zzy = zzhrVarZza.zza("measurement.monitoring.sample_period_millis", CalendarModelKt.MillisecondsIn24Hours);
        ...
        zzac = zzhrVarZza.zza("measurement.upload.refresh_blacklisted_config_interval", NetworkFallbackResolverKt.DEFAULT_TTL_MS);
        ...
        zzaf = zzhrVarZza.zza("measurement.upload.stale_data_deletion_interval", CalendarModelKt.MillisecondsIn24Hours);
        ...
        zzal = zzhrVarZza.zza("measurement.sdk.attribution.cache.ttl", NetworkFallbackResolverKt.DEFAULT_TTL_MS);
