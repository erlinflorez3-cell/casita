...
public final class zzw extends zzal {
    ...
    public final zzaq zza(zzh zzhVar, List<zzaq> list) {
        ...
        this.zzk.zza(strZzf, zzapVar.zzc(SentryThread.JsonKeys.PRIORITY) ? zzg.zzb(zzapVar.zza(SentryThread.JsonKeys.PRIORITY).zze().doubleValue()) : 1000, (zzar) zzaqVarZza, zzapVar.zza("type").zzf());
        return zzaq.zzc;
    }
}
