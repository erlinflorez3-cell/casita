...
public abstract class zzak extends zzag implements List, RandomAccess {
    ...
    static zzak zzi(Object[] objArr, int i2) {
        return i2 == 0 ? zzam.zza : new zzam(objArr, i2);
    }
    ...
    public zzak subList(int i2, int i3) {
        zzv.zzc(i2, i3, size());
        int i4 = i3 - i2;
        return i4 == size() ? this : i4 == 0 ? zzam.zza : new zzaj(this, i2, i4);
    }

    @Override // java.util.List
    /* JADX INFO: renamed from: zzo, reason: merged with bridge method [inline-methods] */
    public final zzao listIterator(int i2) {
        zzv.zzb(i2, size(), FirebaseAnalytics.Param.INDEX);
        return isEmpty() ? zza : new zzai(this, i2);
    }
}
