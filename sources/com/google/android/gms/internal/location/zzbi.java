...
public final class zzbi extends GoogleApi implements FusedLocationProviderClient {
    ...
    private static Object zzd = null;
    ...
    public final Task<Void> setMockMode(boolean z2) {
        synchronized (zzc) {
            if (!z2) {
                ...
                zzd = obj2;
                RegistrationMethods.Builder builderUnregister = RegistrationMethods.builder().register(zzcb.zza).unregister(zzcc.zza);
                Object[] objArr = new Object[0];
                Method declaredMethod = Class.forName(Wg.Zd("4\u0015nNO\u0019w\u0013O7E'\\@\u0011Aq", (short) (C1580rY.Xd() ^ (-20928)), (short) (C1580rY.Xd() ^ (-26199)))).getDeclaredMethod(C1561oA.Xd("\u001a\u0019)\u0003\u0018!'\u0006*+-#1", (short) (ZN.Xd() ^ 7680)), new Class[0]);
                try {
                    declaredMethod.setAccessible(true);
                    return doRegisterEventListener(builderUnregister.withHolder(ListenerHolders.createListenerHolder(obj2, (Looper) declaredMethod.invoke(null, objArr), Object.class.getSimpleName())).setMethodKey(2420).build());
