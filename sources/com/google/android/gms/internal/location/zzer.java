...
public final class zzer {
    ...
    public static int zzc(int i2, int i3, String str) {
        ...
        if (i2 < 0) {
            strZza = zzes.zza("%s (%s) must not be negative", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i2));
        } else {
            if (i3 < 0) {
            ...
            strZza = zzes.zza("%s (%s) must be less than size (%s)", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i2), Integer.valueOf(i3));
        }
    ...
    public static void zze(int i2, int i3, int i4) {
        if (i2 < 0 || i3 < i2 || i3 > i4) {
            throw new IndexOutOfBoundsException((i2 < 0 || i2 > i4) ? zzf(i2, i4, "start index") : (i3 < 0 || i3 > i4) ? zzf(i3, i4, "end index") : zzes.zza("end index (%s) must not be less than start index (%s)", Integer.valueOf(i3), Integer.valueOf(i2)));
        }
    }
