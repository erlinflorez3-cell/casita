...
public enum zzoa implements zzca {
    UNKNOWN_EVENT(0),
    ...
    ON_DEVICE_DOCUMENT_DETECT_PROCESS(IptcDirectory.TAG_COUNTRY_OR_PRIMARY_LOCATION_NAME),
    ON_DEVICE_DOCUMENT_DETECT_CLOSE(614),
    ON_DEVICE_DOCUMENT_CROP_CREATE(621),
    ON_DEVICE_DOCUMENT_CROP_LOAD(IptcDirectory.TAG_CREDIT),
    ON_DEVICE_DOCUMENT_CROP_PROCESS(623),
    ON_DEVICE_DOCUMENT_CROP_CLOSE(624),
    ON_DEVICE_DOCUMENT_ENHANCE_CREATE(631),
    ON_DEVICE_DOCUMENT_ENHANCE_LOAD(IptcDirectory.TAG_CAPTION),
    ON_DEVICE_DOCUMENT_ENHANCE_PROCESS(IptcDirectory.TAG_LOCAL_CAPTION),
    ON_DEVICE_DOCUMENT_ENHANCE_CLOSE(IptcDirectory.TAG_CAPTION_WRITER),
    OPTIONAL_MODULE_IMAGE_LABELING_CREATE(641),
    OPTIONAL_MODULE_IMAGE_LABELING_INIT(IptcDirectory.TAG_IMAGE_TYPE),
    OPTIONAL_MODULE_IMAGE_LABELING_INFERENCE(IptcDirectory.TAG_IMAGE_ORIENTATION),
    ...
    OPTIONAL_MODULE_SHADOW_REMOVAL_INIT(IptcDirectory.TAG_OBJECT_PREVIEW_FILE_FORMAT),
    OPTIONAL_MODULE_SHADOW_REMOVAL_INFERENCE(IptcDirectory.TAG_OBJECT_PREVIEW_FILE_FORMAT_VERSION),
    OPTIONAL_MODULE_SHADOW_REMOVAL_CLOSE(IptcDirectory.TAG_OBJECT_PREVIEW_DATA),
