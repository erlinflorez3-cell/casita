...
public abstract class zzby extends zzbv implements List, RandomAccess {
    private static final zzcg zza = new zzbw(zzcc.zza, 0);
    public static final /* synthetic */ int zzd = 0;

    zzby() {
    }

    public static zzby zzg(Object[] objArr) {
        if (objArr.length == 0) {
            return zzcc.zza;
        }
        ...
        for (int i2 = 0; i2 < length; i2++) {
            zzcb.zza(objArr2[i2], i2);
        }
        return zzh(objArr2, objArr2.length);
    }

    static zzby zzh(Object[] objArr, int i2) {
        return i2 == 0 ? zzcc.zza : new zzcc(objArr, i2);
    }
    ...
    public zzby subList(int i2, int i3) {
        zzbr.zzc(i2, i3, size());
        int i4 = i3 - i2;
        return i4 == size() ? this : i4 == 0 ? zzcc.zza : new zzbx(this, i2, i4);
    }

    @Override // java.util.List
    /* JADX INFO: renamed from: zzi */
    public final zzcg listIterator(int i2) {
        zzbr.zzb(i2, size(), FirebaseAnalytics.Param.INDEX);
        return isEmpty() ? zza : new zzbw(this, i2);
    }
}
