...
public enum zzb {
    ...
    ANY_OF("any_of"),
    APP_NAME(App.JsonKeys.APP_NAME),
    APP_VERSION(App.JsonKeys.APP_VERSION),
    ARG0("arg0"),
    ARG1("arg1"),
    ATTRIBUTE("attribute"),
    ...
    MAP("map"),
    MAX(MetricSummary.JsonKeys.MAX),
    METADATA("metadata"),
    METRIC("metric"),
    MIN(MetricSummary.JsonKeys.MIN),
    MODE("mode"),
    NAME("name"),
    ...
    PAGE("page"),
    PAGE_PATH("page_path"),
    PARAMS(Message.JsonKeys.PARAMS),
    PARTITION("partition"),
