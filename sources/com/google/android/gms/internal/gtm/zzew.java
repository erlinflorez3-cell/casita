...
public final class zzew {
    ...
    static {
        ...
        zzj = zzev.zza(5000L, 5000L, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzen
        });
        ...
        Integer numValueOf = Integer.valueOf(NikonType2MakernoteDirectory.TAG_NIKON_SCAN);
        zzC = zzev.zza(numValueOf, numValueOf, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzdo
        });
        Long lValueOf = Long.valueOf(CalendarModelKt.MillisecondsIn24Hours);
        zzD = zzev.zza(lValueOf, lValueOf, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzdp
        });
        Integer numValueOf2 = Integer.valueOf(Utils.miliSecondsInMinute);
        zzE = zzev.zza(numValueOf2, numValueOf2, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzdr
        });
        zzF = zzev.zza(61000, 61000, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzds
        });
        zzG = zzev.zza(lValueOf, lValueOf, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzdt
        });
        ...
        zzL = zzev.zza(5000L, 5000L, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzdz
        });
        zzM = zzev.zza(5000L, 5000L, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzea
        });
        Long lValueOf2 = Long.valueOf(StatsigLoggerKt.FLUSH_TIMER_MS);
        zzN = zzev.zza(lValueOf2, lValueOf2, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzeb
        });
        zzO = zzev.zza(1800000L, 1800000L, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzed
        });
        zzP = zzev.zza(lValueOf, lValueOf, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzee
        });
        zzQ = zzev.zza(5000L, 5000L, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzef
        });
