...
public abstract class zzst extends zzsq implements List, RandomAccess {
    ...
    static zzst zzg(Object[] objArr, int i2) {
        return i2 == 0 ? zzsz.zza : new zzsz(objArr, i2);
    }
            ...
            if (size == list.size()) {
                if (list instanceof RandomAccess) {
                    for (int i2 = 0; i2 < size; i2++) {
                        if (zzsk.zza(get(i2), list.get(i2))) {
                        }
                    }
                    return true;
                }
                ...
                while (true) {
                    if (it.hasNext()) {
                        if (!it2.hasNext() || !zzsk.zza(it.next(), it2.next())) {
                            break;
                        }
                    } else if (!it2.hasNext()) {
                        return true;
    ...
    public zzst subList(int i2, int i3) {
        zzsl.zzc(i2, i3, size());
        int i4 = i3 - i2;
        return i4 == size() ? this : i4 == 0 ? zzsz.zza : new zzss(this, i2, i4);
    }

    @Override // java.util.List
    /* JADX INFO: renamed from: zzh, reason: merged with bridge method [inline-methods] */
    public final zztj listIterator(int i2) {
        zzsl.zzb(i2, size(), FirebaseAnalytics.Param.INDEX);
        return isEmpty() ? zza : new zzsr(this, i2);
    }
}
