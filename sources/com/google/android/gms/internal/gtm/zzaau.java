...
final class zzaau {
    ...
    static {
        ...
        if (unsafeZzg != null) {
            if (zZzv) {
                zzaarVar = new zzaas(unsafeZzg);
            } else if (zZzv2) {
                zzaarVar = new zzaar(unsafeZzg);
            }
        }
        zzf = zzaarVar;
        if (zzaarVar != null) {
            try {
                Class<?> cls = zzaarVar.zza.getClass();
        ...
        if (zzaatVar2 == null) {
            ...
            try {
                Class<?> cls2 = zzaatVar2.zza.getClass();
        ...
        zzA(Object[].class);
        Field fieldZzB = zzB();
        if (fieldZzB != null && (zzaatVar = zzf) != null) {
            zzaatVar.zza.objectFieldOffset(fieldZzB);
        }
    ...
    public static void zzD(Object obj, long j2, byte b2) {
        zzaat zzaatVar = zzf;
        long j3 = (-1) - (((-1) - (-4)) | ((-1) - j2));
        int i2 = zzaatVar.zza.getInt(obj, j3);
        int i3 = ((~((int) j2)) & 3) << 3;
        int i4 = ~(255 << i3);
        zzaatVar.zza.putInt(obj, j3, (((255 + b2) - (255 | b2)) << i3) | ((i2 + i4) - (i2 | i4)));
    }
    ...
    public static void zzE(Object obj, long j2, byte b2) {
        ...
        int i4 = ~(255 << i3);
        int i5 = (i2 + i4) - (i2 | i4);
        int i6 = ((-1) - (((-1) - 255) | ((-1) - b2))) << i3;
        zzaatVar.zza.putInt(obj, j3, (i6 + i5) - (i6 & i5));
    }
    ...
    static /* bridge */ /* synthetic */ void zzh(Throwable th) {
        Logger.getLogger(zzaau.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
    ...
    static /* bridge */ /* synthetic */ boolean zzt(Object obj, long j2) {
        int i2 = zzf.zza.getInt(obj, (-4) & j2) >>> ((int) (((-1) - (((-1) - (~j2)) | ((-1) - 3))) << 3));
        return ((byte) ((i2 + 255) - (i2 | 255))) != 0;
    }

    static /* bridge */ /* synthetic */ boolean zzu(Object obj, long j2) {
        return ((byte) ((-1) - (((-1) - (zzf.zza.getInt(obj, (-4) & j2) >>> ((int) (((j2 + 3) - (j2 | 3)) << 3)))) | ((-1) - 255)))) != 0;
    }
