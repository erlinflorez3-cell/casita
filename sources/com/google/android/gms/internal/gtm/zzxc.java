...
final class zzxc extends zztn implements RandomAccess, zzyd, zzzo {
    private static final zzxc zza = new zzxc(new double[0], 0, false);
    private double[] zzb;
    private int zzc;
    ...
    private zzxc(double[] dArr, int i2, boolean z2) {
        super(z2);
        this.zzb = dArr;
        this.zzc = i2;
    }
    ...
    public final /* bridge */ /* synthetic */ zzyd zzd(int i2) {
        if (i2 >= this.zzc) {
            return new zzxc(Arrays.copyOf(this.zzb, i2), this.zzc, true);
        }
