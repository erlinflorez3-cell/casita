...
final class zzyv extends zztn implements RandomAccess, zzyd, zzzo {
    private static final zzyv zza = new zzyv(new long[0], 0, false);
    private long[] zzb;
    private int zzc;
    ...
    private zzyv(long[] jArr, int i2, boolean z2) {
        super(z2);
        this.zzb = jArr;
        this.zzc = i2;
    }
    ...
    public final /* bridge */ /* synthetic */ zzyd zzd(int i2) {
        if (i2 >= this.zzc) {
            return new zzyv(Arrays.copyOf(this.zzb, i2), this.zzc, true);
        }
