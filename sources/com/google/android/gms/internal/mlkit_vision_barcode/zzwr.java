...
public final class zzwr {
    ...
    public final synchronized void zzc(int i2, int i3, long j2, long j3) {
        ...
        this.zza.log(new TelemetryData(0, Arrays.asList(new MethodInvocation(i2, i3, 0, j2, j3, null, null, 0, -1)))).addOnFailureListener(new OnFailureListener() { // from class: com.google.android.gms.internal.mlkit_vision_barcode.zzwq
