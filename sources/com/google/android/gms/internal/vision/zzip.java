...
final class zzip extends zziq<zzjb.zzf> {
    ...
    @Override // com.google.android.gms.internal.vision.zziq
    final Object zza(zzio zzioVar, zzkk zzkkVar, int i2) {
        return zzioVar.zza(zzkkVar, i2);
    }
    ...
    final <UT, UB> UB zza(zzld zzldVar, Object obj, zzio zzioVar, zziu<zzjb.zzf> zziuVar, UB ub, zzlu<UT, UB> zzluVar) throws IOException {
        ...
        int i2 = zzeVar.zzd.zzb;
        boolean z2 = zzeVar.zzd.zzd;
        zzjh zzjhVar = null;
        Object objZza2 = null;
        ...
        if (zzeVar.zzd.zzd) {
            ...
            int i3 = zzis.zza[zzeVar.zzd.zzc.ordinal()];
            if ((i3 == 17 || i3 == 18) && (objZza = zziuVar.zza(zzeVar.zzd)) != null) {
