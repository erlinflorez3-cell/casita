...
interface zzmr {
    ...
    void zza(int i2, zzht zzhtVar) throws IOException;

    <K, V> void zza(int i2, zzkf<K, V> zzkfVar, Map<K, V> map) throws IOException;

    void zza(int i2, Object obj) throws IOException;

    void zza(int i2, Object obj, zzlc zzlcVar) throws IOException;

    void zza(int i2, String str) throws IOException;

    void zza(int i2, List<String> list) throws IOException;

    void zza(int i2, List<?> list, zzlc zzlcVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i2, Object obj, zzlc zzlcVar) throws IOException;

    void zzb(int i2, List<zzht> list) throws IOException;

    @Deprecated
    void zzb(int i2, List<?> list, zzlc zzlcVar) throws IOException;
