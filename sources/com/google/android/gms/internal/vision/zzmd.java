...
final class zzmd {
    ...
    static int zza(CharSequence charSequence, byte[] bArr, int i2, int i3) {
        return zza.zza(charSequence, bArr, i2, i3);
    }
    ...
    public static boolean zza(byte[] bArr, int i2, int i3) {
    ...
    static String zzb(byte[] bArr, int i2, int i3) throws zzjk {
    ...
    public static int zzd(byte[] bArr, int i2, int i3) {
        ...
        if (i4 == 1) {
            return zzb(b2, bArr[i2]);
        }
        if (i4 == 2) {
            return zzb(b2, bArr[i2], bArr[i2 + 1]);
        }
