...
final class zzbe implements ObjectEncoderContext {
    ...
    final zzbe zzd(FieldDescriptor fieldDescriptor, int i2, boolean z2) throws IOException {
        if (!z2 || i2 != 0) {
    ...
    final zzbe zze(FieldDescriptor fieldDescriptor, long j2, boolean z2) throws IOException {
        if (!z2 || j2 != 0) {
            zzbc zzbcVarZzj = zzj(fieldDescriptor);
            int iOrdinal = zzbcVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
