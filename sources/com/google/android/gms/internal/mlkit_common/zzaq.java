...
final class zzaq extends zzai {
    ...
    static zzaq zzg(int i2, Object[] objArr, zzah zzahVar) {
        int iHighestOneBit;
        short[] sArr;
        char c2;
        ?? r2;
        ...
        int i3 = 1;
        if (i2 == 1) {
            zzw.zza(Objects.requireNonNull(objArr[0]), Objects.requireNonNull(objArr[1]));
            return new zzaq(null, objArr, 1);
        }
        zzt.zzb(i2, objArr.length >> 1, FirebaseAnalytics.Param.INDEX);
        char c3 = 2;
        ...
        if (i2 == 1) {
            ...
            if (iHighestOneBit <= 128) {
                    ...
                    while (true) {
                        ...
                        if (i10 == 255) {
                            ...
                            if (objRequireNonNull.equals(objArr[i10])) {
                                int i11 = i10 ^ 1;
                                zzagVar2 = new zzag(objRequireNonNull, objRequireNonNull2, Objects.requireNonNull(objArr[i11]));
                ...
                if (i6 == i2) {
                    ...
                    c3 = 2;
                    r22 = new Object[]{bArr, Integer.valueOf(i6), zzagVar2};
                    c2 = 1;
                    r23 = r22;
                }
                    ...
                    while (true) {
                        ...
                        if (c4 == 65535) {
                            ...
                            if (objRequireNonNull3.equals(objArr[c4])) {
                                int i17 = c4 ^ 1;
                                zzagVar3 = new zzag(objRequireNonNull3, objRequireNonNull4, Objects.requireNonNull(objArr[i17 == true ? 1 : 0]));
                ...
                if (i12 != i2) {
                    c2 = 1;
                    c3 = 2;
                    r23 = new Object[]{sArr, Integer.valueOf(i12), zzagVar3};
                }
                r2 = sArr;
            } else {
                int i18 = 1;
                    ...
                    while (true) {
                        ...
                        if (r1 == b2) {
                            ...
                            if (objRequireNonNull5.equals(objArr[r1])) {
                                int i24 = r1 ^ 1;
                                zzagVar = new zzag(objRequireNonNull5, objRequireNonNull6, Objects.requireNonNull(objArr[i24 == true ? 1 : 0]));
                ...
                if (i20 != i2) {
                    c2 = 1;
                    c3 = 2;
                    r23 = new Object[]{sArr, Integer.valueOf(i20), zzagVar};
                }
                r2 = sArr;
            }
            c3 = 2;
        ...
        return new zzaq(r24, objArr, i2);
    }

    /* JADX WARN: Removed duplicated region for block: B:4:0x0003  */
    /* JADX WARN: Removed duplicated region for block: B:4:0x0003 A[EDGE_INSN: B:44:0x0003->B:4:0x0003 BREAK  A[LOOP:0: B:18:0x0039->B:24:0x004f], EDGE_INSN: B:47:0x0003->B:4:0x0003 BREAK  A[LOOP:1: B:28:0x0063->B:34:0x007d], EDGE_INSN: B:48:0x0003->B:4:0x0003 BREAK  A[LOOP:2: B:36:0x008c->B:42:0x00a1]] */
    ...
    */
    public final java.lang.Object get(@javax.annotation.CheckForNull java.lang.Object r9) {
        ...
        L27:
            ...
            int r3 = r0 + (-1)
            int r0 = r9.hashCode()
            int r2 = com.google.android.gms.internal.mlkit_common.zzy.zza(r0)
        L39:
            r2 = r2 & r3
            r1 = r5[r2]
        ...
        L52:
            ...
            int r3 = r0 + (-1)
            int r0 = r9.hashCode()
            int r0 = com.google.android.gms.internal.mlkit_common.zzy.zza(r0)
        L63:
            int r2 = r0 + r3
            r0 = r0 | r3
            int r2 = r2 - r0
