...
public abstract class zzaz extends zzaw implements List, RandomAccess {
    ...
    static zzaz zzg(Object[] objArr, int i2) {
        return i2 == 0 ? zzbc.zza : new zzbc(objArr, i2);
    }
            ...
            if (size == list.size()) {
                if (list instanceof RandomAccess) {
                    for (int i2 = 0; i2 < size; i2++) {
                        if (zzar.zza(get(i2), list.get(i2))) {
                        }
                    }
                    return true;
                }
    ...
    public zzaz subList(int i2, int i3) {
        zzas.zzc(i2, i3, size());
        int i4 = i3 - i2;
        return i4 == size() ? this : i4 == 0 ? zzbc.zza : new zzay(this, i2, i4);
    }

    @Override // java.util.List
    /* JADX INFO: renamed from: zzh, reason: merged with bridge method [inline-methods] */
    public final zzbg listIterator(int i2) {
        zzas.zzb(i2, size(), FirebaseAnalytics.Param.INDEX);
        return isEmpty() ? zza : new zzax(this, i2);
    }
}
