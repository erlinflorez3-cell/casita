...
public enum zzr implements zzej {
    ...
    PROVIDER_NAVTEQ(OlympusImageProcessingMakernoteDirectory.TagAspectRatio),
    PROVIDER_TELE_ATLAS(OlympusImageProcessingMakernoteDirectory.TagAspectFrame),
    ...
    PROVIDER_TSENTR_EFFEKTIVNYKH_TEKHNOLOGIY(OlympusImageProcessingMakernoteDirectory.TagFacesDetected),
    PROVIDER_EE_GOVERNMENT(4609),
    PROVIDER_EE_MAA_AMET(73745),
    PROVIDER_GASBUDDY(OlympusImageProcessingMakernoteDirectory.TagMaxFaces),
    PROVIDER_DK_GOVERNMENT(4611),
    PROVIDER_DK_GEODATASTYRELSEN(73777),
    PROVIDER_MURCIA_REGION_GOVERNMENT(OlympusFocusInfoMakernoteDirectory.TagExternalFlashZoom),
    PROVIDER_CORREIOS(4614),
    PROVIDER_WEST_WORLD_MEDIA(OlympusImageProcessingMakernoteDirectory.TagFaceDetectFrameCrop),
    PROVIDER_INTERNATIONAL_MAPPING_ASSOCIATION(OlympusFocusInfoMakernoteDirectory.TagInternalFlash),
    PROVIDER_MEDICARE(OlympusFocusInfoMakernoteDirectory.TagManualFlash),
    PROVIDER_POLARIS(OlympusFocusInfoMakernoteDirectory.TagMacroLed),
    ...
    PROVIDER_BR_MINISTERIO_DA_SAUDE(FujifilmMakernoteDirectory.TAG_FINE_PIX_COLOR),
