...
class zzgo extends AbstractMap {
    ...
    private final int zzl(Comparable comparable) {
        ...
        int i4 = 0;
        if (i3 >= 0) {
            int iCompareTo = comparable.compareTo(((zzgi) this.zza[i3]).zza());
            if (iCompareTo > 0) {
                return -(i2 + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i4 <= i3) {
            int i5 = (i4 + i3) / 2;
            int iCompareTo2 = comparable.compareTo(((zzgi) this.zza[i5]).zza());
            if (iCompareTo2 < 0) {
                i3 = i5 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final Object zzm(int i2) {
        zzo();
        Object value = ((zzgi) this.zza[i2]).getValue();
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            if (!zzg(i3).equals(zzgoVar.zzg(i3))) {
                return false;
            }
        }
        if (i2 != size) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        this.zza[i2] = new zzgi(this, comparable, obj);
        this.zzb++;
        return null;
    }
