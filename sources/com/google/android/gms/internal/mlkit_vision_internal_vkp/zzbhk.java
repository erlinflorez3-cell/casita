...
final class zzbhk {
    ...
    public static void zzD(Object obj, long j2, byte b2) {
        zzbhj zzbhjVar = zzf;
        long j3 = ((-4) + j2) - ((-4) | j2);
        int i2 = zzbhjVar.zza.getInt(obj, j3);
        int i3 = ((-1) - (((-1) - (~((int) j2))) | ((-1) - 3))) << 3;
        zzbhjVar.zza.putInt(obj, j3, ((255 & b2) << i3) | (i2 & (~(255 << i3))));
    }
    ...
    public static void zzE(Object obj, long j2, byte b2) {
        ...
        zzbhjVar.zza.putInt(obj, j3, ((255 & b2) << i2) | (zzbhjVar.zza.getInt(obj, j3) & (~(255 << i2))));
    }
    ...
    static /* bridge */ /* synthetic */ boolean zzt(Object obj, long j2) {
        int i2 = zzf.zza.getInt(obj, (-1) - (((-1) - (-4)) | ((-1) - j2)));
        long j3 = ~j2;
        return ((byte) ((-1) - (((-1) - (i2 >>> ((int) (((j3 + 3) - (j3 | 3)) << 3)))) | ((-1) - 255)))) != 0;
    }

    static /* bridge */ /* synthetic */ boolean zzu(Object obj, long j2) {
        return ((byte) ((zzf.zza.getInt(obj, (-4) & j2) >>> ((int) (((-1) - (((-1) - j2) | ((-1) - 3))) << 3))) & 255)) != 0;
    }
