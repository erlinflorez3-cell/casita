...
public final class zziy extends zzbel implements zzbft {
    ...
    static /* synthetic */ void zzd(zziy zziyVar, zzhm zzhmVar) {
        zzhmVar.getClass();
        zziyVar.zzh = zzhmVar;
        zziyVar.zzd = (-1) - (((-1) - zziyVar.zzd) & ((-1) - 8));
    }

    static /* synthetic */ void zze(zziy zziyVar, zzhm zzhmVar) {
        zzhmVar.getClass();
        zziyVar.zzi = zzhmVar;
        zziyVar.zzd = (-1) - (((-1) - zziyVar.zzd) & ((-1) - 16));
    }

    static /* synthetic */ void zzf(zziy zziyVar, int i2) {
        zziyVar.zzd |= 128;
        zziyVar.zzl = i2;
    }

    static /* synthetic */ void zzg(zziy zziyVar, float f2) {
        zziyVar.zzd = (-1) - (((-1) - zziyVar.zzd) & ((-1) - 256));
        zziyVar.zzm = f2;
    }
    ...
    static /* synthetic */ void zzi(zziy zziyVar, zzbhv zzbhvVar) {
        ...
        zziyVar.zzd = (-1) - (((-1) - zziyVar.zzd) & ((-1) - 1024));
    }

    static /* synthetic */ void zzj(zziy zziyVar, String str) {
        zziyVar.zzd = (-1) - (((-1) - zziyVar.zzd) & ((-1) - 1));
        zziyVar.zze = "";
    }
