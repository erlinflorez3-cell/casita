...
final class zznt implements ObjectEncoderContext {
    ...
    private final zznt zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z2) throws IOException {
    ...
    private final zznt zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z2) throws IOException {
    ...
    final ObjectEncoderContext zzc(FieldDescriptor fieldDescriptor, Object obj, boolean z2) throws IOException {
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                byte[] bArr = (byte[]) obj;
                if (!z2 || bArr.length != 0) {
                    int iZzh2 = zzh(fieldDescriptor) << 3;
                    zzn((iZzh2 + 2) - (iZzh2 & 2));
                    zzn(bArr.length);
                    this.zze.write(bArr);
                    return this;
    ...
    final zznt zzd(FieldDescriptor fieldDescriptor, int i2, boolean z2) throws IOException {
        if (!z2 || i2 != 0) {
    ...
    final zznt zze(FieldDescriptor fieldDescriptor, long j2, boolean z2) throws IOException {
        if (!z2 || j2 != 0) {
            zznr zznrVarZzj = zzj(fieldDescriptor);
            int iOrdinal = zznrVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
