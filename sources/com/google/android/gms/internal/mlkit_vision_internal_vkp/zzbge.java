...
interface zzbge {
    ...
    @Deprecated
    void zzE(List list, zzbgm zzbgmVar, zzbdv zzbdvVar) throws IOException;

    void zzF(List list) throws IOException;

    void zzG(List list) throws IOException;

    void zzH(Map map, zzbfk zzbfkVar, zzbdv zzbdvVar) throws IOException;

    void zzI(List list, zzbgm zzbgmVar, zzbdv zzbdvVar) throws IOException;
    ...
    boolean zzR() throws IOException;
    ...
    zzbdd zzp() throws IOException;

    @Deprecated
    Object zzr(Class cls, zzbdv zzbdvVar) throws IOException;

    Object zzs(Class cls, zzbdv zzbdvVar) throws IOException;

    String zzt() throws IOException;

    String zzu() throws IOException;

    void zzv(Object obj, zzbgm zzbgmVar, zzbdv zzbdvVar) throws IOException;

    void zzw(Object obj, zzbgm zzbgmVar, zzbdv zzbdvVar) throws IOException;
