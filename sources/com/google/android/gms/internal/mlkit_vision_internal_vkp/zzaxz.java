...
public final class zzaxz {
    ...
    public zzaxz(Context context, final SharedPrefManager sharedPrefManager, zzaxs zzaxsVar, String str) throws Throwable {
        new HashMap();
        new HashMap();
        Object[] objArr = new Object[0];
        Method method = Class.forName(Qg.kd("[g\\ie^X!U`^cS[`\u0019-XV[K]X", (short) (C1633zX.Xd() ^ (-22478)), (short) (C1633zX.Xd() ^ (-4024)))).getMethod(hg.Vd("HES.>?F;@=%7B9", (short) (ZN.Xd() ^ 6115), (short) (ZN.Xd() ^ 688)), new Class[0]);
        try {
