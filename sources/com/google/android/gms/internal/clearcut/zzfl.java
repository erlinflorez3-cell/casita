...
public class zzfl extends Enum<zzfl> {
    ...
    static {
        ...
        final int i4 = 8;
        zzfl zzflVar9 = new zzfl(str, i4, zzfqVar, i2) { // from class: com.google.android.gms.internal.clearcut.zzfm
        };
        zzqk = zzflVar9;
        final zzfq zzfqVar2 = zzfq.MESSAGE;
        final String str2 = "GROUP";
        final int i5 = 9;
        zzfl zzflVar10 = new zzfl(str2, i5, zzfqVar2, i3) { // from class: com.google.android.gms.internal.clearcut.zzfn
        };
        zzql = zzflVar10;
        final zzfq zzfqVar3 = zzfq.MESSAGE;
        final String str3 = "MESSAGE";
        final int i6 = 10;
        zzfl zzflVar11 = new zzfl(str3, i6, zzfqVar3, i2) { // from class: com.google.android.gms.internal.clearcut.zzfo
        };
        zzqm = zzflVar11;
        final zzfq zzfqVar4 = zzfq.BYTE_STRING;
        final String str4 = "BYTES";
        final int i7 = 11;
        zzfl zzflVar12 = new zzfl(str4, i7, zzfqVar4, i2) { // from class: com.google.android.gms.internal.clearcut.zzfp
        };
        zzqn = zzflVar12;
    ...
    private zzfl(String str, int i2, zzfq zzfqVar, int i3) {
        super(str, i2);
        this.zzqu = zzfqVar;
        this.zzqv = i3;
    }

    /* synthetic */ zzfl(String str, int i2, zzfq zzfqVar, int i3, zzfk zzfkVar) {
        this(str, i2, zzfqVar, i3);
    }
