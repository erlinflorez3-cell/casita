...
public final class zzha extends zzfu<zzha> implements Cloneable {
        ...
        try {
            ...
            if (zzhbVarArr != null && zzhbVarArr.length > 0) {
                ...
                while (true) {
                    ...
                    if (zzhbVar != null) {
                        zzhaVar.zzbjm[i2] = (zzhb) zzhbVar.clone();
                    }
                    i2++;
                }
            }
    ...
    public final int hashCode() {
        ...
        long j3 = this.zzbjg;
        int i3 = (i2 + ((int) (j3 ^ (j3 >>> 32)))) * 961;
        String str = this.tag;
        int iHashCode2 = 0;
        int iHashCode3 = (((i3 + (str == null ? 0 : str.hashCode())) * 31) + this.zzbji) * 31;
        String str2 = this.zzbjj;
        ...
        long j4 = this.zzbju;
        int i4 = ((iHashCode8 + iHashCode9) * 31) + ((int) (j4 ^ (j4 >>> 32)));
        zzgz zzgzVar = this.zzbjv;
        int iHashCode10 = ((((i4 * 31) + (zzgzVar == null ? 0 : zzgzVar.hashCode())) * 31) + Arrays.hashCode(this.zzbjw)) * 31;
        String str6 = this.zzbjx;
    ...
    public final void zza(zzfs zzfsVar) throws IOException {
        ...
        if (zzhbVarArr != null && zzhbVarArr.length > 0) {
            ...
            while (true) {
                zzhb[] zzhbVarArr2 = this.zzbjm;
                if (i3 >= zzhbVarArr2.length) {
                    break;
                }
                zzhb zzhbVar = zzhbVarArr2[i3];
                if (zzhbVar != null) {
    ...
    protected final int zzen() {
        ...
        long j3 = this.zzbju;
        if (j3 != 180000) {
            iZzen += zzfs.zzr(15) + zzfs.zzo(zzfs.zzj(j3));
        }
        zzgz zzgzVar = this.zzbjv;
        if (zzgzVar != null) {
