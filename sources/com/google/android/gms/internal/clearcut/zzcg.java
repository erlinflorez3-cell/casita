...
public abstract class zzcg<MessageType extends zzcg<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzas<MessageType, BuilderType> {
    ...
    static final class zze implements zzca<zze> {
        ...
        zze(zzck<?> zzckVar, int i2, zzfl zzflVar, boolean z2, boolean z3) {
            this.zzjx = zzflVar;
        }
    ...
    public static <ContainingType extends zzdo, Type> zzf<ContainingType, Type> zza(ContainingType containingtype, Type type, zzdo zzdoVar, zzck<?> zzckVar, int i2, zzfl zzflVar, Class cls) {
        return new zzf<>(containingtype, type, zzdoVar, new zze(null, 66321687, zzflVar, false, false), cls);
    }

    private static <T extends zzcg<T, ?>> T zza(T t2, byte[] bArr) throws zzco {
        T t3 = (T) t2.zza(zzg.zzkg, null, null);
        try {
            zzea.zzcm().zzp(t3).zza(t3, bArr, 0, bArr.length, new zzay());
            zzea.zzcm().zzp(t3).zzc(t3);
            if (t3.zzex == 0) {
                return t3;
            }
            ...
            throw new zzco(e2.getMessage()).zzg(t3);
        } catch (IndexOutOfBoundsException unused) {
            throw zzco.zzbl().zzg(t3);
        }
    }
    ...
    protected static <T extends zzcg<?, ?>> void zza(Class<T> cls, T t2) {
        zzjr.put(cls, t2);
    }

    protected static final <T extends zzcg<T, ?>> boolean zza(T t2, boolean z2) {
        ...
        return zzea.zzcm().zzp(t2).zzo(t2);
    }
    ...
    protected static <T extends zzcg<T, ?>> T zzb(T t2, byte[] bArr) throws zzco {
        zzap.zza zzaVar = (T) zza(t2, bArr);
        if (zzaVar != null) {
            boolean zBooleanValue = Boolean.TRUE.booleanValue();
