...
class zzei<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    /* synthetic */ zzei(int i2, zzej zzejVar) {
        this(i2);
    }
    ...
    */
    private final int zza(K r5) {
        /*
            ...
            com.google.android.gms.internal.clearcut.zzep r0 = (com.google.android.gms.internal.clearcut.zzep) r0
    ...
    static <FieldDescriptorType extends zzca<FieldDescriptorType>> zzei<FieldDescriptorType, Object> zzaj(int i2) {
        return new zzej(i2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final V zzal(int i2) {
        zzdu();
        V v2 = (V) this.zzom.remove(i2).getValue();
    ...
    public boolean equals(Object obj) {
        ...
        if (iZzdr != zzeiVar.zzdr()) {
            ...
            for (int i2 = 0; i2 < iZzdr; i2++) {
                if (!zzak(i2).equals(zzeiVar.zzak(i2))) {
                    return false;
                }
            }
            if (iZzdr == size) {
    ...
    public int hashCode() {
        ...
        int iHashCode = 0;
        for (int i2 = 0; i2 < iZzdr; i2++) {
            iHashCode += this.zzom.get(i2).hashCode();
        }
    ...
    public final V put(K k2, V v2) {
        ...
        int iZza = zza(k2);
        if (iZza >= 0) {
            return (V) this.zzom.get(iZza).setValue(v2);
        }
        zzdu();
        ...
        int i2 = -(iZza + 1);
        if (i2 >= this.zzol) {
            return zzdv().put(k2, v2);
        }
        int size = this.zzom.size();
        int i3 = this.zzol;
        if (size == i3) {
            zzep zzepVarRemove = this.zzom.remove(i3 - 1);
            zzdv().put((Comparable) zzepVarRemove.getKey(), zzepVarRemove.getValue());
        }
        this.zzom.add(i2, new zzep(this, k2, v2));
        return null;
    }

    public final Map.Entry<K, V> zzak(int i2) {
        return this.zzom.get(i2);
    }
