...
final class zzed {
    ...
    */
    ...
    final Field zzdb() {
        int i2 = this.zzob << 1;
        Object obj = this.zzmj[i2];
        if (obj instanceof Field) {
            return (Field) obj;
        }
        Field fieldZza = zza(this.zzni, (String) obj);
        this.zzmj[i2] = fieldZza;
        return fieldZza;
    }

    final Field zzdc() {
        int i2 = (this.zzob << 1) + 1;
        Object obj = this.zzmj[i2];
        if (obj instanceof Field) {
            return (Field) obj;
        }
    ...
    final Field zzdf() {
        int i2 = (this.zznk << 1) + (this.zzoc / 32);
        Object obj = this.zzmj[i2];
        if (obj instanceof Field) {
            return (Field) obj;
        }
    ...
    final boolean zzdh() {
        return (-1) - (((-1) - this.zznz) | ((-1) - 256)) != 0;
    }

    final boolean zzdi() {
        return (-1) - (((-1) - this.zznz) | ((-1) - 512)) != 0;
    }
