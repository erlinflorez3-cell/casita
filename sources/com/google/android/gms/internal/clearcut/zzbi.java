...
class zzbi extends zzbh {
    ...
    protected final int zza(int i2, int i3, int i4) {
        return zzci.zza(i2, this.zzfp, zzac(), i4);
    }

    @Override // com.google.android.gms.internal.clearcut.zzbb
    public final zzbb zza(int i2, int i3) {
        int iZzb = zzb(0, i3, size());
    ...
    final boolean zza(zzbb zzbbVar, int i2, int i3) {
        if (i3 > zzbbVar.size()) {
            throw new IllegalArgumentException(new StringBuilder(40).append("Length too large: ").append(i3).append(size()).toString());
        }
        if (i3 > zzbbVar.size()) {
            throw new IllegalArgumentException(new StringBuilder(59).append("Ran off end of other: 0, ").append(i3).append(", ").append(zzbbVar.size()).toString());
        }
