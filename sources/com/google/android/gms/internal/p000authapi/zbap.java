...
public final class zbap extends GoogleApi implements SignInClient {
    ...
    @Override // com.google.android.gms.auth.api.identity.SignInClient
    public final Task<Void> signOut() throws Throwable {
        Context applicationContext = getApplicationContext();
        String strUd = C1561oA.ud("-85t-43*.&m ,!.*#\u001de\u001e#(a&\u001b\u0018\u001e\u0018\u001c", (short) (FB.Xd() ^ 31416));
        Class<?> cls = Class.forName(C1561oA.yd("frgtpic,`kin^fk$8cafVhc", (short) (C1580rY.Xd() ^ (-30242))));
        Class<?>[] clsArr = {Class.forName(C1561oA.Yd("@8N:\bG=KE\r3UTLRL", (short) (C1633zX.Xd() ^ (-9690)))), Integer.TYPE};
        Object[] objArr = {strUd, 0};
        short sXd = (short) (C1580rY.Xd() ^ (-30085));
        short sXd2 = (short) (C1580rY.Xd() ^ (-31642));
        int[] iArr = new int["^]mMc]occPsgiiwkukn}".length()];
        QB qb = new QB("^]mMc]occPsgiiwkukn}");
        int i2 = 0;
        while (qb.YK()) {
            int iKK = qb.KK();
            Xu xuXd = Xu.Xd(iKK);
        ...
        try {
            ...
            ((SharedPreferences) method.invoke(applicationContext, objArr)).edit().clear().apply();
