...
final class zzdd extends zzcq {
    ...
    private static final zzch zzd(zzdg zzdgVar, int i2) throws IOException {
        int i3 = i2 - 1;
        if (i3 == 5) {
        ...
        if (i3 != 8) {
            throw new IllegalStateException("Unexpected token: ".concat(zzdh.zza(i2)));
        }
        zzdgVar.zzj();
        return zzcj.zza;
    }

    private static final zzch zze(zzdg zzdgVar, int i2) throws IOException {
        int i3 = i2 - 1;
        if (i3 == 0) {
            zzdgVar.zzf();
            return new zzcg();
