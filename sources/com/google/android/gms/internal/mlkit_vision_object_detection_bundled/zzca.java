...
final class zzca implements ObjectEncoderContext {
    ...
    private final zzca zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z2) throws IOException {
    ...
    private final zzca zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z2) throws IOException {
    ...
    final zzca zzd(FieldDescriptor fieldDescriptor, int i2, boolean z2) throws IOException {
        if (!z2 || i2 != 0) {
    ...
    final zzca zze(FieldDescriptor fieldDescriptor, long j2, boolean z2) throws IOException {
        if (!z2 || j2 != 0) {
            zzby zzbyVarZzj = zzj(fieldDescriptor);
            int iOrdinal = zzbyVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
