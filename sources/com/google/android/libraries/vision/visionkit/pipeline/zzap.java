...
public final class zzap extends zzbel implements zzbft {
    ...
    static /* synthetic */ void zzd(zzap zzapVar, zziy zziyVar) {
        ...
        zzapVar.zzh = zziyVar;
        int i2 = zzapVar.zzd;
        zzapVar.zzd = (i2 + 2) - (i2 & 2);
    }

    static /* synthetic */ void zze(zzap zzapVar, boolean z2) {
        zzapVar.zzd = (-1) - (((-1) - zzapVar.zzd) & ((-1) - 4));
        zzapVar.zzi = true;
    }
    ...
    static /* synthetic */ void zzh(zzap zzapVar, boolean z2) {
        zzapVar.zzd |= 64;
        zzapVar.zzm = z2;
    }

    static /* synthetic */ void zzi(zzap zzapVar, int i2) {
        zzapVar.zzd |= 128;
        zzapVar.zzn = i2;
    }

    static /* synthetic */ void zzj(zzap zzapVar, float f2) {
        int i2 = zzapVar.zzd;
        zzapVar.zzd = (i2 + 512) - (i2 & 512);
        zzapVar.zzp = 0.6f;
    }

    static /* synthetic */ void zzk(zzap zzapVar, int i2) {
        int i3 = zzapVar.zzd;
        zzapVar.zzd = (i3 + 1024) - (i3 & 1024);
        zzapVar.zzq = 0;
    }
