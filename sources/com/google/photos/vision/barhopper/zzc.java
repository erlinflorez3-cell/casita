...
public final class zzc extends zzeh implements zzfn {
    ...
    static /* synthetic */ void zzp(zzc zzcVar, int i2, zzaf zzafVar) {
        zzafVar.getClass();
        zzeo zzeoVar = zzcVar.zzt;
        if (!zzeoVar.zzc()) {
            zzcVar.zzt = zzeh.zzQ(zzeoVar);
        }
        zzcVar.zzt.set(i2, zzafVar);
    }
    ...
    public final boolean zzt() {
        return (-1) - (((-1) - this.zzd) | ((-1) - 64)) != 0;
    }

    public final boolean zzu() {
        int i2 = this.zzd;
        return (i2 + 2048) - (i2 | 2048) != 0;
    }
