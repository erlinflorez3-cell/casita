...
public final class zzl extends MLTask {
    ...
    private final void zzf(final zzrb zzrbVar, long j2, final InputImage inputImage, List list) {
    ...
    final /* synthetic */ zzwe zzc(long j2, zzrb zzrbVar, zzcp zzcpVar, zzcp zzcpVar2, InputImage inputImage) {
        zzrp zzrpVar = new zzrp();
        zzqo zzqoVar = new zzqo();
        zzqoVar.zzc(Long.valueOf(j2));
        zzqoVar.zzd(zzrbVar);
    ...
    final /* synthetic */ zzwe zzd(zzft zzftVar, int i2, zzqd zzqdVar) {
        zzrd zzrdVar = new zzrd();
        zzrdVar.zze(this.zzh ? zzra.TYPE_THICK : zzra.TYPE_THIN);
        zzfq zzfqVar = new zzfq();
        zzfqVar.zza(Integer.valueOf(i2));
        zzfqVar.zzc(zzftVar);
        zzfqVar.zzb(zzqdVar);
    ...
    public final synchronized List run(InputImage inputImage) throws MlKitException {
        ...
        try {
            ...
            zzf(e2.getErrorCode() == 14 ? zzrb.MODEL_NOT_DOWNLOADED : zzrb.UNKNOWN_ERROR, jElapsedRealtime, inputImage, null);
            throw e2;
        }
        return listZza;
    }
