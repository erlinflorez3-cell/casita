...
final class zzo implements zzm {
    ...
    public final List zza(InputImage inputImage) throws Throwable {
        if (this.zzh == null) {
            zzc();
        }
    ...
    final zzyl zze(DynamiteModule.VersionPolicy versionPolicy, String str, String str2) throws RemoteException, DynamiteModule.LoadingException {
        ...
        boolean zZzd = barcodeScannerOptions.zzd();
        boolean z2 = true;
        if (!zZzd && this.zzf.zzb() == null) {
            z2 = false;
        }
        return zzyoVarZza.zzd(iObjectWrapperWrap, new zzyd(iZza, z2));
    }
}
