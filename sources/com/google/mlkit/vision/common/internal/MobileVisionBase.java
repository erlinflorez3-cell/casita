...
public class MobileVisionBase<DetectionResultT> implements Closeable, LifecycleObserver {
    ...
    public Task<DetectionResultT> process(Bitmap bitmap, int i2) {
        return processBase(InputImage.fromBitmap(bitmap, i2));
    }

    public Task<DetectionResultT> process(Image image, int i2) {
        return processBase(InputImage.fromMediaImage(image, i2));
    }

    public Task<DetectionResultT> process(Image image, int i2, Matrix matrix) {
        return processBase(InputImage.fromMediaImage(image, i2, matrix));
    }

    public Task<DetectionResultT> process(ByteBuffer byteBuffer, int i2, int i3, int i4, int i5) {
