...
public class PipelineManager {
    ...
    PipelineManager(Context context, zzc zzcVar, boolean z2, zzaxz zzaxzVar, zzawp zzawpVar) {
        this.zza = context;
        this.zzb = zzcVar;
        this.zzc = z2;
        this.zzg = zzaxzVar;
    ...
    private final zzhp zzb(String str) throws Throwable {
        Context context = this.zza;
        Object[] objArr = new Object[0];
        Method method = Class.forName(Wg.Zd("#U\nV\u000eE~\u000b\u0007P\u0012V}H\r\u0005D3o4_1j", (short) (Od.Xd() ^ (-4962)), (short) (Od.Xd() ^ (-7196)))).getMethod(C1561oA.Xd("\u000f\u000e\u001ek\u001f \u0013##", (short) (Od.Xd() ^ (-6294))), new Class[0]);
        try {
            method.setAccessible(true);
            AssetFileDescriptor assetFileDescriptorOpenFd = ((AssetManager) method.invoke(context, objArr)).openFd(str);
    ...
    private final String[] zzd(LocalModel localModel, boolean z2) throws Throwable {
        String string;
        ...
        if (localModel.isManifestFile()) {
            ModelUtils.AutoMLManifest manifestFile = ModelUtils.parseManifestFile(string2, z2, this.zza);
    ...
    public VkpResults process(InputImage inputImage, VisionImageMetadataParcel visionImageMetadataParcel) throws Throwable {
        ...
        if (this.zzc) {
            ...
            long j2 = this.zzl;
            if (j2 <= 0 || jElapsedRealtime - j2 <= 300) {
        ...
        try {
            if (inputImage.getFormat() == -1) {
                ...
                if (bitmapCopy.getConfig() != Bitmap.Config.ARGB_8888) {
                    String str = "Input bitmap is not ARGB_8888 config. Converting it to ARGB_8888 from " + String.valueOf(bitmapCopy.getConfig());
            ...
            for (int i2 = 0; i2 < zzjqVarZzf.zza(); i2++) {
                zzjn zzjnVarZzc = zzjqVarZzf.zzc(i2);
                ...
                for (int i3 = 0; i3 < zzjnVarZzc.zza(); i3++) {
                    zzkwVar2.zzb(VkpImageLabel.zza(zzjnVarZzc.zze(i3)));
                }
            ...
            return VkpResults.zza(VkpStatus.zza(e2));
        }
    }
    ...
    public VkpStatus start() throws Throwable {
        ...
        zziy zziyVarZzc;
        zzbhx zzbhxVarZzc;
        String strVd = Wg.vd("z\b\u0003Dz\u0004\u0001y\f\u0006K\u000f\u0001\u000f|\u007f\u0018\u001d\u000f\u0016\u0012", (short) (OY.Xd() ^ 20401));
        if (this.zzj) {
            return VkpStatus.zzb();
        }
        zzd zzdVar = this.zzi;
        String strKd = Qg.kd("\u0006 ')!\u001fY-'V\u001f#\u001d'\u001b\u0012\u001c\u0018(\u0012K\u000f\u000f\u001d\r\n\u001a\u0014\u0016PA", (short) (OY.Xd() ^ 10557), (short) (OY.Xd() ^ 27387));
        if (zzdVar == null) {
            try {
                zzc zzcVar = this.zzb;
                boolean z2 = zzcVar instanceof VkpImageLabelerOptions;
                hg.Vd("~\u0017\u001d\u0011\u0017\u0013\u0017\rs\u0007\u0013\u0005\n\u0007\u0013", (short) (Od.Xd() ^ (-23118)), (short) (Od.Xd() ^ (-27440)));
                if (z2) {
                    ...
                    if (!vkpObjectDetectorOptions.zzg()) {
                        ...
                        short sXd = (short) (C1607wl.Xd() ^ 731);
                        int[] iArr = new int["JHFCM7F:I37771D:A+.6*;:/+-(4o,  \"( ,\u0018/ *\u001d\u0013)\u0013\u001d\u0019\u0013\u000f!\u0015\u001a\u0018V\u001c\r\u0012\u000e\u0018\b".length()];
                        QB qb = new QB("JHFCM7F:I37771D:A+.6*;:/+-(4o,  \"( ,\u0018/ *\u001d\u0013)\u0013\u001d\u0019\u0013\u000f!\u0015\u001a\u0018V\u001c\r\u0012\u000e\u0018\b");
                        int i2 = 0;
                        while (qb.YK()) {
                            int iKK = qb.KK();
                            Xu xuXd = Xu.Xd(iKK);
                        ...
                        zziyVarZzc = zzfy.zzd(zzb(new String(iArr, 0, i2)), zzbhv.zze());
                    ...
                    int i3 = true != vkpObjectDetectorOptions.zzf() ? 3 : 2;
                    zzhp zzhpVarZzb = zzb(C1561oA.yd("MMMLXDUKL8FJ?>JHJ6D\u0002@D9842D0>,E8tiayeqokYmcjj+re\\ZfX", (short) (C1607wl.Xd() ^ 12354)));
                    if (vkpObjectDetectorOptions.zzf()) {
                        zzbhxVarZzc = this.zzh.zzc(vkpObjectDetectorOptions.zzd(), vkpObjectDetectorOptions.zze(), strVd, 2);
                        C1561oA.Yd("_\u007f\u0010\u007f\u0006\b\u000e\bA\u0004\u0007\b\u000b\u0013\r\u001b\u000b\u001f\u0015\u001c\u001cN\u0011\u001d\u001e\"+!\u001f*,", (short) (C1607wl.Xd() ^ 9126));
                        this.zzh.zzb(vkpObjectDetectorOptions.zzd(), vkpObjectDetectorOptions.zze(), strVd, 2);
                    } else {
                        zzbhxVarZzc = null;
                    }
                    if (vkpObjectDetectorOptions.zzi()) {
                        zzdr zzdrVarZzb = zzfy.zzb(this.zza, vkpObjectDetectorOptions.zzh(), zzhpVarZzb, zziyVarZzc, PeriodicWorkRequest.MIN_PERIODIC_FLEX_MILLIS, zzbhxVarZzc);
                        zzdrVarZzb.zzj(i3);
                        ...
                        zzdr zzdrVarZza = zzfy.zza(this.zza, vkpObjectDetectorOptions.zzh(), zzhpVarZzb, zziyVarZzc, zzbhv.zze());
                        zzdrVarZza.zzj(i3);
                        if (zzbhxVarZzc != null) {
                            zzdrVarZza.zzc(zzbhxVarZzc);
                        }
                ...
                zzfVarZza.zza(true);
                Context context = this.zza;
                short sXd2 = (short) (C1580rY.Xd() ^ (-15517));
                short sXd3 = (short) (C1580rY.Xd() ^ (-6923));
                ...
                Object[] objArr = new Object[0];
                Method method = cls.getMethod(Jg.Wd(".(+hnmZT(QF", (short) (C1580rY.Xd() ^ (-29160)), (short) (C1580rY.Xd() ^ (-7425))), new Class[0]);
                try {
                    method.setAccessible(true);
                    File file = new File((File) method.invoke(context, objArr), ZO.xd("E\u0002/ _PJmMP7\nu\n>e\u0011-\u0002@V{s\u0012.\u0006D9?", (short) (Od.Xd() ^ (-21467)), (short) (Od.Xd() ^ (-23507))));
                    if (!file.exists() && !file.mkdir()) {
                        List list = this.zzd;
                        zzblh zzblhVarZzf = zzbli.zzf();
                        zzblhVarZzf.zza(3);
                        list.add((zzbli) zzblhVarZzf.zzv());
                        C1626yg.Ud("P\u0013U\u0012\tc\f{E\t*Z<DuX\u0010F\fV]\u001f`\"c_r%<MQ \u001c\f\u0011na%_6D", (short) (FB.Xd() ^ 1431), (short) (FB.Xd() ^ 9274));
                    }
                ...
                zza();
                return VkpStatus.zza(new MlKitException(strKd, 5, e3));
            }
        }
        try {
            try {
                ...
                MlKitException mlKitException = new MlKitException(strKd + ((String) e4.getRootCauseMessage().zzb("")), 3);
                zzlc zzlcVar = new zzlc();
                zzlcVar.zzb(new AutoValue_VkpStatus_VkpError(1, e4.getStatusCode().ordinal()));
                Iterator<zzag> it = e4.getComponentStatuses().iterator();
                while (it.hasNext()) {
                    for (zzam zzamVar : it.next().zzc()) {
                        zzlcVar.zzb(new AutoValue_VkpStatus_VkpError(true != Ig.wd("\u001fA5\u0012\fPA:$LGg\u0017\u001eB0V\u0001IU3hmq\u0018]}GR\u0005}GFyb)", (short) (C1607wl.Xd() ^ 17443)).equals(zzamVar.zzd()) ? 0 : 3, zzamVar.zza()));
                    }
                }
