...
final class AutoValue_VkpResults extends VkpResults {
    ...
    AutoValue_VkpResults(VkpStatus vkpStatus, List list, List list2, boolean z2, Boolean bool) {
        if (vkpStatus == null) {
    ...
    public final int hashCode() {
        ...
        return (((iHashCode * 1000003) ^ (true != this.zzd ? 1237 : 1231)) * 1000003) ^ (bool == null ? 0 : bool.hashCode());
    }
