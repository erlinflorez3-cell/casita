...
public class CloseGuard implements Closeable {
    ...
    CloseGuard(Object obj, final int i2, Cleaner cleaner, final Runnable runnable, final zzsh zzshVar) {
    ...
    final /* synthetic */ void zza(int i2, zzsh zzshVar, Runnable runnable) {
        if (!this.zza.get()) {
