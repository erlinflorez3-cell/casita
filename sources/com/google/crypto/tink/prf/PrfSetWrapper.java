...
public class PrfSetWrapper implements PrimitiveWrapper<Prf, PrfSet> {
    ...
    private static class WrappedPrfSet extends PrfSet {
        ...
        private WrappedPrfSet(PrimitiveSet<Prf> primitives) throws GeneralSecurityException {
            ...
            MonitoringClient.Logger loggerCreateLogger = primitives.hasAnnotations() ? MutableMonitoringRegistry.globalInstance().getMonitoringClient().createLogger(MonitoringUtil.getMonitoringKeysetInfo(primitives), "prf", "compute") : MonitoringUtil.DO_NOTHING_LOGGER;
        ...
        /* synthetic */ WrappedPrfSet(PrimitiveSet primitiveSet, AnonymousClass1 anonymousClass1) throws GeneralSecurityException {
            this(primitiveSet);
        }
