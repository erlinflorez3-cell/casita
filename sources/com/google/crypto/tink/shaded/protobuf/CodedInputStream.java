...
public abstract class CodedInputStream {
    ...
    private static final class ArrayDecoder extends CodedInputStream {
        ...
        public int readRawLittleEndian32() throws IOException {
            ...
            return (((-1) - (((-1) - bArr[i2 + 3]) | ((-1) - 255))) << 24) | ((i3 + i4) - (i3 & i4));
        }
        ...
        public long readRawLittleEndian64() throws IOException {
            ...
            long j4 = (j2 + j3) - (j2 & j3);
            long j5 = (((long) bArr[i2 + 2]) & 255) << 16;
            long j6 = (j4 + j5) - (j4 & j5);
            long j7 = ((-1) - (((-1) - ((long) bArr[i2 + 3])) | ((-1) - 255))) << 24;
            long j8 = (j6 + j7) - (j6 & j7);
            long j9 = ((-1) - (((-1) - ((long) bArr[i2 + 4])) | ((-1) - 255))) << 32;
            return (-1) - (((-1) - ((((long) bArr[i2 + 7]) & 255) << 56)) & ((-1) - ((-1) - (((-1) - ((-1) - (((-1) - ((j8 + j9) - (j8 & j9))) & ((-1) - ((((long) bArr[i2 + 5]) & 255) << 40))))) & ((-1) - ((((long) bArr[i2 + 6]) & 255) << 48))))));
        }
        ...
        */
        ...
        long readRawVarint64SlowPath() throws IOException {
            ...
            for (int i2 = 0; i2 < 64; i2 += 7) {
                ...
                j2 |= ((long) ((rawByte + 127) - (127 | rawByte))) << i2;
    ...
    private static final class IterableDirectByteBufferDecoder extends CodedInputStream {
        ...
        public int readRawLittleEndian32() throws IOException {
            if (currentRemaining() < 4) {
                return ((-1) - (((-1) - ((-1) - (((-1) - readRawByte()) | ((-1) - 255)))) & ((-1) - ((readRawByte() & 255) << 8)))) | ((readRawByte() & 255) << 16) | (((-1) - (((-1) - readRawByte()) | ((-1) - 255))) << 24);
            }
            long j2 = this.currentByteBufferPos;
            this.currentByteBufferPos = 4 + j2;
            int i2 = UnsafeUtil.getByte(j2) & 255;
            int i3 = ((-1) - (((-1) - UnsafeUtil.getByte(1 + j2)) | ((-1) - 255))) << 8;
            int i4 = (i2 + i3) - (i2 & i3);
            byte b2 = UnsafeUtil.getByte(2 + j2);
            int i5 = ((b2 + 255) - (b2 | 255)) << 16;
            return ((UnsafeUtil.getByte(j2 + 3) & 255) << 24) | ((i4 + i5) - (i4 & i5));
        }
        ...
        public long readRawLittleEndian64() throws IOException {
            ...
            if (currentRemaining() >= 8) {
                ...
                long j4 = (((long) UnsafeUtil.getByte(1 + j2)) & 255) << 8;
                long j5 = (j3 + j4) - (j3 & j4);
                long j6 = (((long) UnsafeUtil.getByte(2 + j2)) & 255) << 16;
                long j7 = (j5 + j6) - (j5 & j6);
                long j8 = (((long) UnsafeUtil.getByte(3 + j2)) & 255) << 24;
                long j9 = (-1) - (((-1) - ((j7 + j8) - (j7 & j8))) & ((-1) - ((((long) UnsafeUtil.getByte(4 + j2)) & 255) << 32)));
                long j10 = UnsafeUtil.getByte(5 + j2);
                long j11 = (-1) - (((-1) - j9) & ((-1) - (((j10 + 255) - (j10 | 255)) << 40)));
                long j12 = UnsafeUtil.getByte(6 + j2);
                rawByte = (-1) - (((-1) - j11) & ((-1) - (((j12 + 255) - (j12 | 255)) << 48)));
                rawByte2 = UnsafeUtil.getByte(j2 + 7);
            } else {
                long rawByte3 = (-1) - (((-1) - ((long) readRawByte())) | ((-1) - 255));
                long rawByte4 = (((long) readRawByte()) & 255) << 8;
                long rawByte5 = (-1) - (((-1) - ((-1) - (((-1) - ((rawByte3 + rawByte4) - (rawByte3 & rawByte4))) & ((-1) - ((((long) readRawByte()) & 255) << 16))))) & ((-1) - ((((long) readRawByte()) & 255) << 24)));
                long rawByte6 = readRawByte();
                long j13 = ((rawByte6 + 255) - (rawByte6 | 255)) << 32;
                long j14 = (rawByte5 + j13) - (rawByte5 & j13);
                long rawByte7 = (((long) readRawByte()) & 255) << 40;
                rawByte = (-1) - (((-1) - ((j14 + rawByte7) - (j14 & rawByte7))) & ((-1) - ((((long) readRawByte()) & 255) << 48)));
                rawByte2 = readRawByte();
            }
            long j15 = rawByte2;
            return (-1) - (((-1) - (((j15 + 255) - (j15 | 255)) << 56)) & ((-1) - rawByte));
        }
  ...
  0x0099: PHI (r3v10 long) = (r3v9 long), (r3v12 long) binds: [B:71:0x0073, B:75:0x0085] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        */
        public int readRawVarint32() throws java.io.IOException {
            ...
            Le:
                r3 = 1
                long r11 = r1 + r3
                byte r7 = com.google.crypto.tink.shaded.protobuf.UnsafeUtil.getByte(r1)
                if (r7 < 0) goto L1e
    ...
    private static final class StreamDecoder extends CodedInputStream {
        ...
        public long readRawLittleEndian64() throws IOException {
            ...
            this.pos = i2 + 8;
            long j2 = bArr[i2];
            long j3 = (-1) - (((-1) - ((-1) - (((-1) - (((-1) - (((-1) - ((j2 + 255) - (j2 | 255))) & ((-1) - (((-1) - (((-1) - ((long) bArr[i2 + 1])) | ((-1) - 255))) << 8)))) | (((-1) - (((-1) - ((long) bArr[i2 + 2])) | ((-1) - 255))) << 16))) & ((-1) - (((-1) - (((-1) - ((long) bArr[i2 + 3])) | ((-1) - 255))) << 24))))) & ((-1) - (((-1) - (((-1) - ((long) bArr[i2 + 4])) | ((-1) - 255))) << 32)));
            long j4 = bArr[i2 + 5];
            long j5 = ((j4 + 255) - (j4 | 255)) << 40;
            return (((-1) - (((-1) - ((long) bArr[i2 + 7])) | ((-1) - 255))) << 56) | ((-1) - (((-1) - ((j3 + j5) - (j3 & j5))) & ((-1) - ((((long) bArr[i2 + 6]) & 255) << 48))));
        }
  ...
  0x0072: PHI (r1v6 int) = (r1v5 int), (r1v7 int) binds: [B:71:0x0057, B:75:0x0063] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    private static final class UnsafeDirectNioDecoder extends CodedInputStream {
        ...
        public int readRawLittleEndian32() throws IOException {
            ...
            this.pos = 4 + j2;
            int i2 = ((-1) - (((-1) - UnsafeUtil.getByte(j2)) | ((-1) - 255))) | (((-1) - (((-1) - UnsafeUtil.getByte(1 + j2)) | ((-1) - 255))) << 8);
            int i3 = (UnsafeUtil.getByte(2 + j2) & 255) << 16;
            int i4 = (i2 + i3) - (i2 & i3);
            byte b2 = UnsafeUtil.getByte(j2 + 3);
            return (-1) - (((-1) - (((b2 + 255) - (b2 | 255)) << 24)) & ((-1) - i4));
        }
        ...
        public long readRawLittleEndian64() throws IOException {
            ...
            long j5 = j3 | (((j4 + 255) - (j4 | 255)) << 8) | (((-1) - (((-1) - ((long) UnsafeUtil.getByte(2 + j2))) | ((-1) - 255))) << 16) | ((((long) UnsafeUtil.getByte(3 + j2)) & 255) << 24);
            long j6 = UnsafeUtil.getByte(4 + j2);
            long j7 = j5 | (((j6 + 255) - (j6 | 255)) << 32);
            long j8 = (((long) UnsafeUtil.getByte(5 + j2)) & 255) << 40;
            long j9 = (-1) - (((-1) - ((j7 + j8) - (j7 & j8))) & ((-1) - ((((long) UnsafeUtil.getByte(6 + j2)) & 255) << 48)));
            long j10 = UnsafeUtil.getByte(j2 + 7);
            return (-1) - (((-1) - (((j10 + 255) - (j10 | 255)) << 56)) & ((-1) - j9));
        }

        /* JADX WARN: Code restructure failed: missing block: B:76:0x0090, code lost:
        
            if (com.google.crypto.tink.shaded.protobuf.UnsafeUtil.getByte(r6) < 0) goto L44;
         */
        @Override // com.google.crypto.tink.shaded.protobuf.CodedInputStream
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        public int readRawVarint32() throws java.io.IOException {
            ...
            L24:
                r3 = 2
                long r3 = r3 + r1
                byte r0 = com.google.crypto.tink.shaded.protobuf.UnsafeUtil.getByte(r5)
                int r5 = r0 << 7
                r5 = r5 ^ r7
                if (r5 >= 0) goto L35
    ...
    public static int readRawVarint32(final int firstByte, final InputStream input) throws IOException {
        if ((firstByte + 128) - (128 | firstByte) == 0) {
            return firstByte;
        }
        int i2 = firstByte & 127;
        int i3 = 7;
        while (i3 < 32) {
            int i4 = input.read();
            if (i4 == -1) {
