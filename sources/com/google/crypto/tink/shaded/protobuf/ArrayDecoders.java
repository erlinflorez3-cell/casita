...
final class ArrayDecoders {
            ...
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[extension.getLiteType().ordinal()]) {
                ...
                case 17:
                    ...
                    if (extension.isRepeated()) {
                        int iDecodeGroupField = decodeGroupField(schemaSchemaFor, data, iDecodeString, limit, i3, registers);
                    ...
                    return mergeGroupField(field, schemaSchemaFor, data, iDecodeString, limit, i3, registers);
                case 18:
    ...
    static int decodeFixed32(byte[] data, int position) {
        int i2 = (-1) - (((-1) - (data[position] & 255)) & ((-1) - ((data[position + 1] & 255) << 8)));
        byte b2 = data[position + 2];
        int i3 = ((b2 + 255) - (b2 | 255)) << 16;
        int i4 = (i2 + i3) - (i2 & i3);
        byte b3 = data[position + 3];
        return (((b3 + 255) - (b3 | 255)) << 24) | i4;
    }
    ...
    static long decodeFixed64(byte[] data, int position) {
        long j2 = ((long) data[position]) & 255;
        long j3 = data[position + 1];
        long j4 = j2 | (((j3 + 255) - (j3 | 255)) << 8);
        long j5 = data[position + 2];
        long j6 = (-1) - (((-1) - (j4 | (((j5 + 255) - (j5 | 255)) << 16))) & ((-1) - (((-1) - (((-1) - ((long) data[position + 3])) | ((-1) - 255))) << 24)));
        long j7 = data[position + 4];
        return ((((long) data[position + 7]) & 255) << 56) | ((-1) - (((-1) - (j6 | (((j7 + 255) - (j7 | 255)) << 32))) & ((-1) - ((((long) data[position + 5]) & 255) << 40)))) | (((-1) - (((-1) - ((long) data[position + 6])) | ((-1) - 255))) << 48);
    }
    ...
    static int decodeUnknownField(int tag, byte[] data, int position, int limit, UnknownFieldSetLite unknownFields, Registers registers) throws InvalidProtocolBufferException {
        ...
        while (iDecodeVarint32 < limit) {
            ...
            iDecodeVarint32 = decodeUnknownField(i5, data, iDecodeVarint32, limit, unknownFieldSetLiteNewInstance, registers);
        }
        if (iDecodeVarint32 > limit || i5 != i4) {
    ...
    static int decodeVarint32(int firstByte, byte[] data, int position, Registers registers) {
        ...
        byte b3 = data[i3];
        if (b3 >= 0) {
            registers.int1 = (-1) - (((-1) - i5) & ((-1) - (b3 << Ascii.SO)));
            return i6;
        }
        int i7 = ((-1) - (((-1) - b3) | ((-1) - 127))) << 14;
        int i8 = (i5 + i7) - (i5 & i7);
        int i9 = position + 3;
        byte b4 = data[i6];
        if (b4 >= 0) {
            int i10 = b4 << Ascii.NAK;
            registers.int1 = (i8 + i10) - (i8 & i10);
            return i9;
        }
        int i11 = i8 | ((b4 & 127) << 21);
        int i12 = position + 4;
        byte b5 = data[i9];
        if (b5 >= 0) {
            registers.int1 = (-1) - (((-1) - i11) & ((-1) - (b5 << Ascii.FS)));
            return i12;
        }
        int i13 = (-1) - (((-1) - i11) & ((-1) - ((b5 & 127) << 28)));
        while (true) {
            int i14 = i12 + 1;
            if (data[i12] >= 0) {
                registers.int1 = i13;
    ...
    static int decodeVarint64(long firstByte, byte[] data, int position, Registers registers) {
        long j2 = firstByte & 127;
        int i2 = position + 1;
        byte b2 = data[position];
        long j3 = ((long) ((b2 + 127) - (127 | b2))) << 7;
        long j4 = (j2 + j3) - (j2 & j3);
        int i3 = 7;
        while (b2 < 0) {
            b2 = data[i2];
            i3 += 7;
            j4 = (-1) - (((-1) - j4) & ((-1) - (((long) ((b2 + 127) - (127 | b2))) << i3)));
            i2++;
        }
        registers.long1 = j4;
        return i2;
    ...
    static int skipField(int tag, byte[] data, int position, int limit, Registers registers) throws InvalidProtocolBufferException {
        ...
        while (position < limit) {
            ...
            position = skipField(i3, data, position, limit, registers);
        }
