...
public final class Internal {
    ...
    public static class MapAdapter<K, V, RealValue> extends AbstractMap<K, V> {
        ...
        class AnonymousClass1<T> implements Converter<Integer, T> {
            ...
            AnonymousClass1(final EnumLite val$unrecognizedValue) {
        ...
        public static <T extends EnumLite> Converter<Integer, T> newEnumConverter(final EnumLiteMap<T> enumMap, final T unrecognizedValue) {
            return new Converter<Integer, T>() { // from class: com.google.crypto.tink.shaded.protobuf.Internal.MapAdapter.1
                final /* synthetic */ EnumLite val$unrecognizedValue;

                AnonymousClass1(final EnumLite unrecognizedValue2) {
