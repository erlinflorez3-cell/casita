...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    private static abstract class AbstractBufferedEncoder extends CodedOutputStream {
        ...
        final void bufferFixed32NoTag(int value) {
            ...
            this.position = i4;
            int i5 = value >> 8;
            bArr[i3] = (byte) ((i5 + 255) - (i5 | 255));
            int i6 = i2 + 3;
            this.position = i6;
            int i7 = value >> 16;
            bArr[i4] = (byte) ((i7 + 255) - (i7 | 255));
            this.position = i2 + 4;
        ...
        final void bufferFixed64NoTag(long value) {
            ...
            int i3 = i2 + 1;
            this.position = i3;
            bArr[i2] = (byte) ((value + 255) - (value | 255));
            int i4 = i2 + 2;
            this.position = i4;
            ...
            int i7 = i2 + 5;
            this.position = i7;
            bArr[i6] = (byte) ((-1) - (((-1) - ((int) (value >> 32))) | ((-1) - 255)));
            int i8 = i2 + 6;
            this.position = i8;
            bArr[i7] = (byte) ((-1) - (((-1) - ((int) (value >> 40))) | ((-1) - 255)));
            int i9 = i2 + 7;
            this.position = i9;
            int i10 = (int) (value >> 48);
            bArr[i8] = (byte) ((i10 + 255) - (i10 | 255));
            this.position = i2 + 8;
            bArr[i9] = (byte) ((-1) - (((-1) - ((int) (value >> 56))) | ((-1) - 255)));
        ...
        final void bufferUInt32NoTag(int value) {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                while (((-128) & value) != 0) {
                    ...
                    int i2 = this.position;
                    this.position = i2 + 1;
                    bArr[i2] = (byte) ((-1) - (((-1) - ((-1) - (((-1) - value) | ((-1) - 127)))) & ((-1) - 128)));
                    this.totalBytesWritten++;
                    value >>>= 7;
                }
            ...
            while (((-128) & value) != 0) {
                ...
                this.position = i4 + 1;
                UnsafeUtil.putByte(bArr3, i4, (byte) ((-1) - (((-1) - (value & 127)) & ((-1) - 128))));
                value >>>= 7;
            }
        ...
        final void bufferUInt64NoTag(long value) {
            ...
            while ((value - 128) - (value | (-128)) != 0) {
                ...
                this.position = i5 + 1;
                int i6 = (int) value;
                UnsafeUtil.putByte(bArr3, i5, (byte) ((-1) - (((-1) - ((i6 + 127) - (i6 | 127))) & ((-1) - 128))));
                value >>>= 7;
            }
            byte[] bArr4 = this.buffer;
    ...
    private static class ArrayEncoder extends CodedOutputStream {
        ...
        ArrayEncoder(byte[] buffer, int offset, int length) {
            ...
            if ((offset | length | (buffer.length - i2)) < 0) {
        ...
        public final void writeFixed64NoTag(long value) throws IOException {
            try {
                ...
                int i3 = i2 + 1;
                this.position = i3;
                bArr[i2] = (byte) ((-1) - (((-1) - ((int) value)) | ((-1) - 255)));
                int i4 = i2 + 2;
                this.position = i4;
                int i5 = (int) (value >> 8);
                bArr[i3] = (byte) ((i5 + 255) - (i5 | 255));
                ...
                int i9 = i2 + 5;
                this.position = i9;
                int i10 = (int) (value >> 32);
                bArr[i7] = (byte) ((i10 + 255) - (i10 | 255));
                int i11 = i2 + 6;
                this.position = i11;
                int i12 = (int) (value >> 40);
                bArr[i9] = (byte) ((i12 + 255) - (i12 | 255));
                int i13 = i2 + 7;
                this.position = i13;
                bArr[i11] = (byte) ((-1) - (((-1) - ((int) (value >> 48))) | ((-1) - 255)));
                this.position = i2 + 8;
                bArr[i13] = (byte) (((int) (value >> 56)) & 255);
            } catch (IndexOutOfBoundsException e2) {
                throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), 1), e2);
            }
        }
        ...
        public final void writeUInt32NoTag(int value) throws IOException {
            while ((-1) - (((-1) - value) | ((-1) - (-128))) != 0) {
                try {
                    ...
                    int i2 = this.position;
                    this.position = i2 + 1;
                    bArr[i2] = (byte) (((-1) - (((-1) - value) | ((-1) - 127))) | 128);
                    value >>>= 7;
                } catch (IndexOutOfBoundsException e2) {
                    throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), 1), e2);
                }
        ...
        public final void writeUInt64NoTag(long value) throws IOException {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS && spaceLeft() >= 10) {
                while ((-1) - (((-1) - value) | ((-1) - (-128))) != 0) {
                    ...
                    int i2 = this.position;
                    this.position = i2 + 1;
                    UnsafeUtil.putByte(bArr, i2, (byte) ((-1) - (((-1) - ((-1) - (((-1) - ((int) value)) | ((-1) - 127)))) & ((-1) - 128))));
                    value >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i3 = this.position;
    ...
    private static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            while (((-128) & value) != 0) {
                try {
                    this.buffer.put((byte) ((-1) - (((-1) - ((-1) - (((-1) - ((int) value)) | ((-1) - 127)))) & ((-1) - 128))));
                    value >>>= 7;
                } catch (BufferOverflowException e2) {
                    throw new OutOfSpaceException(e2);
                }
        ...
        public void writeUInt32NoTag(int value) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while (((-128) & value) != 0) {
                    ...
                    this.position = j2 + 1;
                    int i2 = (value + 127) - (127 | value);
                    UnsafeUtil.putByte(j2, (byte) ((i2 + 128) - (i2 & 128)));
                    value >>>= 7;
                }
            ...
            while (true) {
                ...
                if ((value - 128) - ((-128) | value) == 0) {
                    ...
                    this.position = j4 + 1;
                    UnsafeUtil.putByte(j4, (byte) ((-1) - (((-1) - (value & 127)) & ((-1) - 128))));
                    value >>>= 7;
                }
            }
        }
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((value - 128) - (value | (-128)) != 0) {
                    long j2 = this.position;
                    this.position = j2 + 1;
                    UnsafeUtil.putByte(j2, (byte) ((-1) - (((-1) - (((int) value) & 127)) & ((-1) - 128))));
                    value >>>= 7;
                }
                long j3 = this.position;
                this.position = 1 + j3;
    ...
    public static int computeUInt32SizeNoTag(final int value) {
        ...
        return (value + (-268435456)) - (value | (-268435456)) == 0 ? 4 : 5;
    }
