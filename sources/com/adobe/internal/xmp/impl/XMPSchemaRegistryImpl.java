...
public final class XMPSchemaRegistryImpl implements XMPSchemaRegistry, XMPConst {
    ...
    private Pattern f2582p = Pattern.compile("[/*?\\[\\]]");
    ...
    private void registerStandardAliases() throws XMPException {
        ...
        registerAlias("http://ns.adobe.com/photoshop/1.0/", ExifInterface.TAG_COPYRIGHT, "http://purl.org/dc/elements/1.1/", "rights", arrayAltText);
        registerAlias("http://ns.adobe.com/photoshop/1.0/", "Keywords", "http://purl.org/dc/elements/1.1/", "subject", null);
        registerAlias("http://ns.adobe.com/photoshop/1.0/", "Marked", XMPConst.NS_XMP_RIGHTS, "Marked", null);
        registerAlias("http://ns.adobe.com/photoshop/1.0/", "Title", "http://purl.org/dc/elements/1.1/", "title", arrayAltText);
        registerAlias("http://ns.adobe.com/photoshop/1.0/", "WebStatement", XMPConst.NS_XMP_RIGHTS, "WebStatement", null);
        ...
        registerAlias("http://ns.adobe.com/exif/1.0/", ExifInterface.TAG_DATETIME_DIGITIZED, "http://ns.adobe.com/xap/1.0/", "CreateDate", null);
    ...
    synchronized void registerAlias(String str, String str2, final String str3, final String str4, AliasOptions aliasOptions) throws XMPException {
        ...
        if (this.f2582p.matcher(str2).find() || this.f2582p.matcher(str4).find()) {
    ...
    public synchronized String registerNamespace(String str, String str2) throws XMPException {
        ...
        if (str4 != null) {
            ...
            while (this.prefixToNamespaceMap.containsKey(str5)) {
                str5 = str2.substring(0, str2.length() - 1) + Global.UNDERSCORE + i2 + "_:";
                i2++;
            }
            str2 = str5;
        }
