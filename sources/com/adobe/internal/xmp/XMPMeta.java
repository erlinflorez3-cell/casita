...
public interface XMPMeta extends Cloneable {
    ...
    XMPProperty getArrayItem(String str, String str2, int i2) throws XMPException;
    ...
    void insertArrayItem(String str, String str2, int i2, String str3) throws XMPException;

    void insertArrayItem(String str, String str2, int i2, String str3, PropertyOptions propertyOptions) throws XMPException;
    ...
    void setArrayItem(String str, String str2, int i2, String str3) throws XMPException;

    void setArrayItem(String str, String str2, int i2, String str3, PropertyOptions propertyOptions) throws XMPException;
    ...
    void setPropertyBoolean(String str, String str2, boolean z2) throws XMPException;

    void setPropertyBoolean(String str, String str2, boolean z2, PropertyOptions propertyOptions) throws XMPException;
    ...
    void setPropertyInteger(String str, String str2, int i2) throws XMPException;

    void setPropertyInteger(String str, String str2, int i2, PropertyOptions propertyOptions) throws XMPException;

    void setPropertyLong(String str, String str2, long j2) throws XMPException;

    void setPropertyLong(String str, String str2, long j2, PropertyOptions propertyOptions) throws XMPException;
