...
public abstract class RenderableView extends VirtualView implements ReactHitSlopView {
    ...
    static RenderableView contextElement = null;
    ...
    /* JADX INFO: renamed from: com.horcrux.svg.RenderableView$1 */
    ...
    private void setupPaint(Paint paint, float f2, ReadableArray readableArray) {
        ...
        if (i2 == 0) {
            ...
            int iRound = Math.round((iIntValue >>> 24) * f2) << 24;
            int i3 = (iIntValue + ViewCompat.MEASURED_SIZE_MASK) - (iIntValue | ViewCompat.MEASURED_SIZE_MASK);
            paint.setColor((iRound + i3) - (iRound & i3));
            return;
        }
        if (i2 == 1) {
            Brush definedBrush = getSvgView().getDefinedBrush(readableArray.getString(1));
            if (definedBrush != null) {
                definedBrush.setupPaint(paint, this.mBox, this.mScale, f2);
                return;
            }
            return;
        }
        if (i2 == 2) {
            paint.setColor((-1) - (((-1) - (Math.round((r1 >>> 24) * f2) << 24)) & ((-1) - ((-1) - (((-1) - getCurrentColor()) | ((-1) - ViewCompat.MEASURED_SIZE_MASK))))));
            return;
        }
        if (i2 != 3) {
    ...
    void renderMarkers(Canvas canvas, Paint paint, float f2) {
        ...
        while (true) {
            ...
            int i2 = AnonymousClass1.$SwitchMap$com$horcrux$svg$RNSVGMarkerType[next.type.ordinal()];
            if (i2 == 1) {
            ...
            if (markerView4 != null) {
                markerView4.renderMarker(canvas, paint, f2, next, fRelativeOnOther);
    ...
    boolean setupFillPaint(Paint paint, float f2) {
    ...
    boolean setupStrokePaint(Paint paint, float f2) {
