...
class ImageView extends RenderableView {
    ...
    /* JADX INFO: renamed from: com.horcrux.svg.ImageView$1 */
    ...
    private void tryRenderFromBitmapCache(ImagePipeline imagePipeline, ImageRequest imageRequest, Canvas canvas, Paint paint, float f2) {
    ...
    void draw(Canvas canvas, Paint paint, float f2) {
        ...
        if (imagePipeline.isInBitmapMemoryCache(imageRequestFromUri)) {
            tryRenderFromBitmapCache(imagePipeline, imageRequestFromUri, canvas, paint, f2 * this.mOpacity);
        } else {
