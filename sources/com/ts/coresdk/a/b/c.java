...
@InterfaceC1492Gx
@Metadata(bv = {}, d1 = {"ЯH\u001d<K!&˛\bDZc|\u0004G\u00068\u000bDB\u0007\"2\u0013\u007f\u0007tjA0JeP.hS2\u000fq{<$q$yCAV\"}8\tWNmgvJh\u0014K\u000f\f\u0017\u0001jBI]xc\u0016\u0015˰Xģ]2uqCʠn\u0013f\u000b04280ڎ/$bG\u000f7\u0016SO\u001a H@\u001f:b\u0017[ 2\u0018\u0016@0\u0001Tձ\u0016QɇLncV=@KvPV?_^\u0004\u0014!ТX)\u0013~o'sSE@-+c\u0005\u0017R\u0012Ϊ1I8Rݾl)-6W\u007f Qf\u000f,\u0015YV=g\u00014t\u000bab\u001c'aՒ\u0012X\u0017\"߭{|\u0002\u001cJ\u0014V\u00195ZF3*h\u0018\u000eiο!d\u0007eؿbD\u0006\roI_2\u000eHC9Iz\u0018uޅ\u001dP=\u0011\u0013#f0\u000f\u00069[\u0003\"')ôXyWH_V\u0006U\\#q=\u001c\u001c7w͆.\u00066`\u000eIL#<\u0016=7\n9Y!BȹJזkz\rbnTwT\u0019X0t.=:\u000b\u001cZzߟ3n\u0007T/\u0090\u0013ܖ X\u000f\u007f\u000e\u0017.a"}, d2 = {"\u001ab^:\";L\u001d\u0017\t\b^:{\u000fxaI%E>V", RemoteSettings.FORWARD_SLASH_STRING, "\u001a`]1e6BRb|\u0005g;|\u0012>/]2\u0005O\u0001*&\u001d", "1@", "\u001a`]1e6BRb|\u0005g;|\u0012>/]2\u0005O\u0001*&\u001d", "\u001aqTAe6?W(KD<(\u0004\u0010\u0005", "1A", "\u001aqTAe6?W(KD<(\u0004\u0010\u0005", AdkSettings.PLATFORM_TYPE_MOBILE, "", "1`]0X3", "u(E", "\u001ab^:\";L\u001d\u0017\t\b^:{\u000fxTm\u0006wG\bl", "1k^;X", "u(;0b4\bb'Hxh9|\u0017.kI\u0017i\u001e|\u001e\u001e\u001d", "\u001ab^:\";L\u001d\u0017\t\b^:{\u000fxTm\u0006wG\b\u0014\u0013Euc", ">/", "3m`BX<>", "uKR<`uMab|\u0005k,\u000b\b5/n\u0016Y<\b\u001e\u0014Cm\u0014\u0012:\u0016", "\u001ab^:\";L\u001d\u0017\t\b^:{\u000fxTm\u0011{O\u0013!$M\\\u000eJ\u0002/>g}u", "3wT0h;>", "u(;0b4\bb'Hxh9|\u0017.kI\u0017i)\u0001&)Q|\u0014)v3@c\u0007.7C", "", "7r2.a*>Z\u0019}", "u(I", "7r4EX*Nb\u0019}", "\u001anZ5g;I!bkzj<|\u0017>;", "@d`BX:M", "u(;<^/Mb$LDK,\t\u0019/s\u000f}", ">0", "\nh]6g\u0005", "uKP;W9HW\u0018Hxh5\f\t8tI\u0006\u0006I\u0010\u0017*VEtIv4Bc~$F:_\fIJBAw\u000f", "\""}, k = 1, mv = {1, 7, 1}, pn = "", xi = 48, xs = "")
public final class c<T> implements TSCall<T> {

    /* JADX INFO: renamed from: a */
    public static final a f18247a = new a(null);
    private static final TSNetworkResponse.TSExternalNetworkError cC = new TSNetworkResponse.TSExternalNetworkError("This url is forbidden by the setting");
    private final Context cA;
    private final Call<T> cB;

    @InterfaceC1492Gx
    @Metadata(bv = {}, d1 = {"Я\u0012\u001d<K!&i\u0016DLcz\u0007I\u0006>é4ȗ\u007f8ܥBw5k+@6DͿL0XV8\u0013<\u000eB&s$ BqUpԆ$\u07beSRoitJh\f"}, d2 = {"\u001ab^:\";L\u001d\u0017\t\b^:{\u000fxaI%E>?\u0013l", "\u001ab^:\";L\u001d\u0017\t\b^:{\u000fxTm\u0011{O\u0013!$M\\\u000eJ\u0002/>g}^&[uA\\CHt0%}hpK\u0011p2.\u00044QY$", "1B", "\u001ab^:\";L\u001d\u0017\t\b^:{\u000fxTm\u0011{O\u0013!$M\\\u000eJ\u0002/>g}^&[uA\\CHt0%}hpK\u0011p2.\u00044QY$", RemoteSettings.FORWARD_SLASH_STRING, "\nh]6g\u0005", "u(E", ""}, k = 1, mv = {1, 7, 1}, pn = "", xi = 48, xs = "")
    ...
    public c(Context context, Call<T> call) {
    ...
    public boolean isExecuted() {
        return this.cB.isExecuted();
    }

    @Override // com.ts.coresdk.TSCall
    public Request request() {
        Request request = this.cB.request();
