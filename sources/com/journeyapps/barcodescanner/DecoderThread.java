...
public class DecoderThread {
    ...
    public void decode(SourceData sourceData) throws Throwable {
        ...
        if (resultDecode != null) {
            ...
            String str = TAG;
            String str2 = "Found barcode in " + (jCurrentTimeMillis2 - jCurrentTimeMillis) + " ms";
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void requestNextPreview() throws Throwable {
