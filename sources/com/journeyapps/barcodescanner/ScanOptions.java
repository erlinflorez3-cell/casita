...
public class ScanOptions {
    ...
    public ScanOptions setBarcodeImageEnabled(boolean z2) {
        addExtra(Intents.Scan.BARCODE_IMAGE_ENABLED, Boolean.valueOf(z2));
        return this;
    }

    public ScanOptions setBeepEnabled(boolean z2) {
        addExtra(Intents.Scan.BEEP_ENABLED, Boolean.valueOf(z2));
        return this;
    }

    public ScanOptions setCameraId(int i2) {
        if (i2 >= 0) {
    ...
    public ScanOptions setOrientationLocked(boolean z2) {
    ...
    public ScanOptions setTimeout(long j2) {
        addExtra("TIMEOUT", Long.valueOf(j2));
        return this;
    }

    public ScanOptions setTorchEnabled(boolean z2) {
