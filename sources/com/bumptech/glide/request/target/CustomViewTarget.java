...
public abstract class CustomViewTarget<T extends View, Z> implements Target<Z> {
    ...
    static final class SizeDeterminer {
        ...
        private static int getMaxDisplayLength(Context context) throws Throwable {
            if (maxDisplayLength == null) {
                Object[] objArr = {C1561oA.Kd("i\\bYen", (short) (FB.Xd() ^ 27612))};
                Method method = Class.forName(Wg.Zd("\u0018&Y)\"\u001dU\u001b\u0002KIM{D\b\u0003C-./ar*", (short) (Od.Xd() ^ (-23374)), (short) (Od.Xd() ^ (-16180)))).getMethod(Wg.vd("\u0017\u0014\"\u007f%\u001e\u001e\u000e\u0015y\u000b\u0017\u001a\f\u0005\u0006", (short) (C1607wl.Xd() ^ 29786)), Class.forName(C1561oA.Xd("zr\ttB\u0002w\u0006\u007fGm\u0010\u000f\u0007\r\u0007", (short) (OY.Xd() ^ 13168))));
                try {
    ...
    @Deprecated
    public final CustomViewTarget<T, Z> useTagId(int i2) {
        return this;
    }
