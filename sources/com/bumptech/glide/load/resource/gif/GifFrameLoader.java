...
class GifFrameLoader {
    ...
    GifFrameLoader(BitmapPool bitmapPool, RequestManager requestManager, GifDecoder gifDecoder, Handler handler, RequestBuilder<Bitmap> requestBuilder, Transformation<Bitmap> transformation, Bitmap bitmap) throws Throwable {
        this.callbacks = new ArrayList();
        this.requestManager = requestManager;
        if (handler == null) {
            Object[] objArr = new Object[0];
            Method declaredMethod = Class.forName(C1593ug.zd("#1(750,v9>y\u0019=>@6D", (short) (C1633zX.Xd() ^ (-30156)), (short) (C1633zX.Xd() ^ (-16338)))).getDeclaredMethod(C1561oA.od("KHV.AHL)KJJ>J", (short) (C1633zX.Xd() ^ (-13163))), new Class[0]);
            try {
                declaredMethod.setAccessible(true);
                handler = new Handler((Looper) declaredMethod.invoke(null, objArr), new FrameLoaderCallback());
