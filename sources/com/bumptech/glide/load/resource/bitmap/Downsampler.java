...
public final class Downsampler {
    ...
    /* JADX INFO: renamed from: com.bumptech.glide.load.resource.bitmap.Downsampler$1 */
    ...
    private static void calculateScaling(ImageHeaderParser.ImageType imageType, ImageReader imageReader, DecodeCallbacks decodeCallbacks, BitmapPool bitmapPool, DownsampleStrategy downsampleStrategy, int i2, int i3, int i4, int i5, int i6, BitmapFactory.Options options) throws IOException {
        ...
        float f2 = i7;
        float f3 = i8;
        int iRound = i7 / round(scaleFactor * f2);
        int iRound2 = i8 / round(scaleFactor * f3);
        ...
        double scaleFactor2 = downsampleStrategy.getScaleFactor(iFloor, iFloor2, i5, i6);
        ...
        if (Log.isLoggable(TAG, 2)) {
            String str2 = "Calculate scaling, source: [" + i3 + "x" + i4 + "], degreesToRotate: " + i2 + ", target: [" + i5 + "x" + i6 + "], power of two scaled: [" + iFloor + "x" + iFloor2 + "], exact scale factor: " + scaleFactor + ", power of 2 sample size: " + iMax + ", adjusted scale factor: " + scaleFactor2 + ", target density: " + options.inTargetDensity + ", density: " + options.inDensity;
        }
    }
    ...
    private Bitmap decodeFromWrappedStreams(ImageReader imageReader, BitmapFactory.Options options, DownsampleStrategy downsampleStrategy, DecodeFormat decodeFormat, PreferredColorSpace preferredColorSpace, boolean z2, int i2, int i3, boolean z3, DecodeCallbacks decodeCallbacks) throws IOException {
        ...
        int iRound = i2 == Integer.MIN_VALUE ? isRotationRequired(exifOrientationDegrees) ? i5 : i4 : i2;
        int iRound2 = i3 == Integer.MIN_VALUE ? isRotationRequired(exifOrientationDegrees) ? i4 : i5 : i3;
        ImageHeaderParser.ImageType imageType = imageReader.getImageType();
        calculateScaling(imageType, imageReader, decodeCallbacks, this.bitmapPool, downsampleStrategy, exifOrientationDegrees, i4, i5, iRound, iRound2, options);
        calculateConfig(imageReader, decodeFormat, z4, zIsExifOrientationRequired, options, iRound, iRound2);
        ...
        if (shouldUsePool(imageType)) {
            if (i4 < 0 || i5 < 0 || !z3) {
                ...
                if (Log.isLoggable(TAG, 2)) {
                    String str2 = "Calculated target [" + iRound + "x" + iRound2 + "] for source [" + i4 + "x" + i5 + "], sampleSize: " + i7 + ", targetDensity: " + options.inTargetDensity + ", density: " + options.inDensity + ", density multiplier: " + f2;
                }
            }
        ...
        if (Log.isLoggable(TAG, 2)) {
            logDecode(i4, i5, str, options, bitmapDecodeStream, i2, i3, logTime);
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:55:?, code lost:
        ...
        throw r1;
     */
    /* JADX WARN: Type inference failed for: r1v4, types: [android.graphics.Bitmap, java.lang.Throwable] */
    /*
    ...
    */
    private static android.graphics.Bitmap decodeStream(com.bumptech.glide.load.resource.bitmap.ImageReader r5, android.graphics.BitmapFactory.Options r6, com.bumptech.glide.load.resource.bitmap.Downsampler.DecodeCallbacks r7, com.bumptech.glide.load.engine.bitmap_recycle.BitmapPool r8) throws java.io.IOException {
        ...
        Lc:
            ...
            r0.lock()
            android.graphics.Bitmap r1 = r5.decodeBitmap(r6)     // Catch: java.lang.IllegalArgumentException -> L25 java.lang.Throwable -> L4d
            java.util.concurrent.locks.Lock r0 = com.bumptech.glide.load.resource.bitmap.TransformationUtils.getBitmapDrawableLock()
            r0.unlock()
            return r1
        L25:
            r0 = move-exception
            java.io.IOException r1 = newIoExceptionForInBitmapAssertion(r0, r3, r2, r1, r6)     // Catch: java.lang.Throwable -> L4d
            r0 = 3
            boolean r0 = android.util.Log.isLoggable(r4, r0)     // Catch: java.lang.Throwable -> L4d
            if (r0 == 0) goto L33
            java.lang.String r0 = "Failed to decode with inBitmap, trying again without Bitmap re-use"
        L33:
            android.graphics.Bitmap r0 = r6.inBitmap     // Catch: java.lang.Throwable -> L4d
            if (r0 == 0) goto L4c
            android.graphics.Bitmap r0 = r6.inBitmap     // Catch: java.io.IOException -> L4b java.lang.Throwable -> L4d
            r8.put(r0)     // Catch: java.io.IOException -> L4b java.lang.Throwable -> L4d
            r0 = 0
            r6.inBitmap = r0     // Catch: java.io.IOException -> L4b java.lang.Throwable -> L4d
            android.graphics.Bitmap r1 = decodeStream(r5, r6, r7, r8)     // Catch: java.io.IOException -> L4b java.lang.Throwable -> L4d
            java.util.concurrent.locks.Lock r0 = com.bumptech.glide.load.resource.bitmap.TransformationUtils.getBitmapDrawableLock()
            r0.unlock()
            return r1
        L4b:
