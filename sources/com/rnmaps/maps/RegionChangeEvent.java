...
public class RegionChangeEvent extends Event<RegionChangeEvent> {
    ...
    public RegionChangeEvent(int i2, LatLngBounds latLngBounds, boolean z2, boolean z3) {
        super(i2);
    ...
    public void dispatch(RCTEventEmitter rCTEventEmitter) {
        ...
        writableNativeMap2.putDouble(IBrazeLocation.LATITUDE, center.latitude);
        writableNativeMap2.putDouble(IBrazeLocation.LONGITUDE, center.longitude);
