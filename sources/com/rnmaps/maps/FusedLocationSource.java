...
public class FusedLocationSource implements LocationSource {
    ...
    public void activate(final LocationSource.OnLocationChangedListener onLocationChangedListener) {
        try {
            this.fusedLocationClientProviderClient.getLastLocation().addOnSuccessListener(new OnSuccessListener<Location>() { // from class: com.rnmaps.maps.FusedLocationSource.1
