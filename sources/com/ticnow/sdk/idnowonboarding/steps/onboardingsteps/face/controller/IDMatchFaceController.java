...
public class IDMatchFaceController {
    Activity activity;
    Context context;
    ...
    public static class Builder {
        ...
        public IDMatchFaceController Build() {
            return new IDMatchFaceController(this);
        }
    ...
    public IDMatchFaceController(Builder builder) {
    ...
    public void Start() throws Exception {
        Intent intent = new Intent(this.context, (Class<?>) IdMatchFaceActivity.class);
