package com.ticnow.sdk.idnowonboarding.steps.onboardingsteps.face.controller;
...
public class IDMatchEnrollFaceController {
    Activity activity;
    Context context;
    ...
    public static class Builder {
        ...
        public IDMatchEnrollFaceController Build() {
            return new IDMatchEnrollFaceController(this);
        }
    ...
    public IDMatchEnrollFaceController(Builder builder) {
    ...
    public void Start() throws Exception {
        Intent intent = new Intent(this.context, (Class<?>) IdMatchEnrollFaceActivity.class);
