package com.ticnow.sdk.idnowonboarding.steps.onboardingsteps.validateotp.controllers;

import android.app.Activity;
import android.content.Context;
import android.content.Intent;
import com.ticnow.sdk.idnowonboarding.model.config.IDNowOnboardingConfiguration;
import com.ticnow.sdk.idnowonboarding.steps.onboardingsteps.validateotp.activity.ValidateOtpActivity;
...
public class IDValidateOtpController {
    Activity activity;
    Context context;
    ...
    public static class Builder {
        ...
        public IDValidateOtpController Build() {
            return new IDValidateOtpController(this);
        }
    ...
    public IDValidateOtpController(Builder builder) {
