package com.ticnow.sdk.idnowonboarding.steps.onboardingsteps.dni.controller;
...
public class IDDNIController {
    ...
    public static class Builder {
        ...
        public IDDNIController Build() {
            return new IDDNIController(this);
        }
    ...
    public IDDNIController(Builder builder) {
    ...
    public void Start() throws Exception {
        Intent intent = new Intent(this.context, (Class<?>) ValidateDniActivity.class);
