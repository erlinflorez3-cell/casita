...
public class ScriptC_avg_brighten extends ScriptC {
    ...
    public ScriptC_avg_brighten(RenderScript renderScript) {
        ...
        this.mExportVar_median_filter_strength = 1.0f;
    ...
    public void forEach_avg_brighten_f(Allocation allocation, Allocation allocation2, Script.LaunchOptions launchOptions) {
    ...
    public void forEach_dro_brighten(Allocation allocation, Allocation allocation2, Script.LaunchOptions launchOptions) {
    ...
    public Script.InvokeID getInvokeID_setBlackLevel() {
        return createInvokeID(0);
    }

    public Script.InvokeID getInvokeID_setBrightenParameters() {
    ...
    public void invoke_setBlackLevel(float f2) {
        FieldPacker fieldPacker = new FieldPacker(4);
        fieldPacker.addF32(f2);
        invoke(0, fieldPacker);
    }

    public void invoke_setBrightenParameters(float f2, float f3, float f4, float f5, float f6) {
    ...
    public synchronized void set_median_filter_strength(float f2) {
        setVar(1, f2);
        this.mExportVar_median_filter_strength = f2;
    }
}
