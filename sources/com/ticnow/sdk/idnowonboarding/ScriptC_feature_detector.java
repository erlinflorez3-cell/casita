...
public class ScriptC_feature_detector extends ScriptC {
    ...
    public void forEach_compute_derivatives(Allocation allocation, Script.LaunchOptions launchOptions) {
    ...
    public void forEach_corner_detector(Allocation allocation, Allocation allocation2, Script.LaunchOptions launchOptions) {
        if (!allocation.getType().getElement().isCompatible(this.__U8)) {
            throw new RSRuntimeException("Type mismatch with U8!");
        }
    ...
    public void forEach_create_greyscale(Allocation allocation, Allocation allocation2, Script.LaunchOptions launchOptions) {
    ...
    public void forEach_local_maximum(Allocation allocation, Allocation allocation2, Script.LaunchOptions launchOptions) {
    ...
    public synchronized void set_corner_threshold(float f2) {
        setVar(0, f2);
        this.mExportVar_corner_threshold = f2;
    }
}
