...
public class ScriptC_process_hdr extends ScriptC {
    ...
    public void forEach_hdr_n(Allocation allocation, Allocation allocation2, Script.LaunchOptions launchOptions) {
        if (!allocation.getType().getElement().isCompatible(this.__U8_4)) {
            throw new RSRuntimeException("Type mismatch with U8_4!");
        }
        if (!allocation2.getType().getElement().isCompatible(this.__U8_4)) {
    ...
    public synchronized void set_W(float f2) {
        setVar(45, f2);
        this.mExportVar_W = f2;
    }
    ...
    public synchronized void set_linear_scale(float f2) {
        setVar(46, f2);
        this.mExportVar_linear_scale = f2;
    }

    public synchronized void set_n_bitmaps_g(int i2) {
        setVar(47, i2);
        this.mExportVar_n_bitmaps_g = i2;
    }

    public synchronized void set_offset_x0(int i2) {
        setVar(7, i2);
        this.mExportVar_offset_x0 = i2;
    }
    ...
    public synchronized void set_offset_y0(int i2) {
        setVar(8, i2);
        this.mExportVar_offset_y0 = i2;
    }
    ...
    public synchronized void set_parameter_A0(float f2) {
        setVar(21, f2);
        this.mExportVar_parameter_A0 = f2;
    }

    public synchronized void set_parameter_A1(float f2) {
        setVar(23, f2);
        this.mExportVar_parameter_A1 = f2;
    }

    public synchronized void set_parameter_A2(float f2) {
        setVar(25, f2);
        this.mExportVar_parameter_A2 = f2;
    }

    public synchronized void set_parameter_A3(float f2) {
        setVar(27, f2);
        this.mExportVar_parameter_A3 = f2;
    }

    public synchronized void set_parameter_A4(float f2) {
        setVar(29, f2);
        this.mExportVar_parameter_A4 = f2;
    }

    public synchronized void set_parameter_A5(float f2) {
        setVar(31, f2);
        this.mExportVar_parameter_A5 = f2;
    }

    public synchronized void set_parameter_A6(float f2) {
        setVar(33, f2);
        this.mExportVar_parameter_A6 = f2;
    }

    public synchronized void set_parameter_B0(float f2) {
        setVar(22, f2);
        this.mExportVar_parameter_B0 = f2;
    }

    public synchronized void set_parameter_B1(float f2) {
        setVar(24, f2);
        this.mExportVar_parameter_B1 = f2;
    }

    public synchronized void set_parameter_B2(float f2) {
        setVar(26, f2);
        this.mExportVar_parameter_B2 = f2;
    }

    public synchronized void set_parameter_B3(float f2) {
        setVar(28, f2);
        this.mExportVar_parameter_B3 = f2;
    }

    public synchronized void set_parameter_B4(float f2) {
        setVar(30, f2);
        this.mExportVar_parameter_B4 = f2;
    }

    public synchronized void set_parameter_B5(float f2) {
        setVar(32, f2);
        this.mExportVar_parameter_B5 = f2;
    }

    public synchronized void set_parameter_B6(float f2) {
        setVar(34, f2);
        this.mExportVar_parameter_B6 = f2;
    }

    public synchronized void set_tonemap_algorithm(int i2) {
        setVar(41, i2);
        this.mExportVar_tonemap_algorithm = i2;
    }

    public synchronized void set_tonemap_scale(float f2) {
        setVar(43, f2);
        this.mExportVar_tonemap_scale = f2;
    }
}
