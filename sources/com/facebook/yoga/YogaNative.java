...
public class YogaNative {
    ...
    static native int jni_YGConfigGetErrataJNI(long j2);

    static native long jni_YGConfigNewJNI();

    static native void jni_YGConfigSetErrataJNI(long j2, int i2);
    ...
    static native void jni_YGNodeFinalizeJNI(long j2);
    ...
    static native void jni_YGNodeRemoveAllChildrenJNI(long j2);

    static native void jni_YGNodeRemoveChildJNI(long j2, long j3);

    static native void jni_YGNodeResetJNI(long j2);

    static native void jni_YGNodeSetAlwaysFormsContainingBlockJNI(long j2, boolean z2);
    ...
    static native float jni_YGNodeStyleGetGapJNI(long j2, int i2);
    ...
    static native void jni_YGNodeStyleSetGapJNI(long j2, int i2, float f2);

    static native void jni_YGNodeStyleSetGapPercentJNI(long j2, int i2, float f2);
    ...
    static native void jni_YGNodeStyleSetPositionAutoJNI(long j2, int i2);
