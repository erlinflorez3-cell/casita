...
public abstract class YogaNode implements YogaProps {
    ...
    public abstract void setAlwaysFormsContainingBlock(boolean z2);
    ...
    public abstract void setGap(YogaGutter yogaGutter, float f2);

    public abstract void setGapPercent(YogaGutter yogaGutter, float f2);
