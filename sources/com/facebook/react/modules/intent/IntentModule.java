...
public class IntentModule extends NativeIntentAndroidSpec {
    ...
    private void sendOSIntent(Intent intent, Boolean bool) throws Exception {
    ...
    @Override // com.facebook.fbreact.specs.NativeIntentAndroidSpec
    public void openSettings(Promise promise) throws Exception {
        try {
    ...
    @Override // com.facebook.fbreact.specs.NativeIntentAndroidSpec
    public void sendIntent(String str, ReadableArray readableArray, Promise promise) throws Exception {
        if (str == null || str.isEmpty()) {
        ...
        if (readableArray != null) {
            for (int i2 = 0; i2 < readableArray.size(); i2++) {
                ...
                int i3 = AnonymousClass2.$SwitchMap$com$facebook$react$bridge$ReadableType[map.getType("value").ordinal()];
                if (i3 == 1) {
