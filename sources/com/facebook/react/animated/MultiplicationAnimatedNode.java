...
public final class MultiplicationAnimatedNode extends ValueAnimatedNode {
    ...
    public void update() {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            AnimatedNode nodeById = this.nativeAnimatedNodesManager.getNodeById(this.inputNodes[i2]);
