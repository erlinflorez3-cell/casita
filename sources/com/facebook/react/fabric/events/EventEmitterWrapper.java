...
public class EventEmitterWrapper {
    ...
    private native void dispatchEvent(String str, NativeMap nativeMap, int i2);
    ...
    public synchronized void dispatch(String str, WritableMap writableMap, int i2) {
        if (isValid()) {
            dispatchEvent(str, (NativeMap) writableMap, i2);
        }
    }
