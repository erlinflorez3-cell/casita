...
public interface RNSVGTextPathManagerInterface<T extends View> {
    void setAlignmentBaseline(T t2, String str);

    void setBaselineShift(T t2, Dynamic dynamic);
    ...
    void setDx(T t2, Dynamic dynamic);

    void setDy(T t2, Dynamic dynamic);
    ...
    void setHref(T t2, String str);

    void setInlineSize(T t2, Dynamic dynamic);

    void setLengthAdjust(T t2, String str);
    ...
    void setMethod(T t2, String str);

    void setMidLine(T t2, String str);
    ...
    void setRotate(T t2, Dynamic dynamic);

    void setSide(T t2, String str);

    void setSpacing(T t2, String str);

    void setStartOffset(T t2, Dynamic dynamic);
    ...
    void setTextLength(T t2, Dynamic dynamic);

    void setVectorEffect(T t2, int i2);

    void setVerticalAlign(T t2, Dynamic dynamic);
