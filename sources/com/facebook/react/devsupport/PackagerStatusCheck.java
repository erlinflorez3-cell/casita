...
public class PackagerStatusCheck {
    ...
    public void run(String str, final PackagerStatusCallback packagerStatusCallback) {
        OkCallback.enqueue(this.mClient.newCall(new Request.Builder().url(createPackagerStatusURL(str)).build()), new Callback() { // from class: com.facebook.react.devsupport.PackagerStatusCheck.1
