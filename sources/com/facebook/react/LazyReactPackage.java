...
public abstract class LazyReactPackage implements ReactPackage {
    ...
    /* JADX INFO: renamed from: com.facebook.react.LazyReactPackage$1 */
    class AnonymousClass1 implements Iterator<ModuleHolder> {
        int position = 0;
        final /* synthetic */ List val$nativeModules;
        final /* synthetic */ Map val$reactModuleInfoMap;
    ...
    public /* synthetic */ Iterator lambda$getNativeModuleIterator$0(List list, Map map) {
        return new Iterator<ModuleHolder>() { // from class: com.facebook.react.LazyReactPackage.1
            int position = 0;
            final /* synthetic */ List val$nativeModules;
            final /* synthetic */ Map val$reactModuleInfoMap;

            AnonymousClass1(List list2, Map map2) {
                list = list2;
                map = map2;
            }
            ...
            public ModuleHolder next() {
                ...
                int i2 = this.position;
                this.position = i2 + 1;
                ModuleSpec moduleSpec = (ModuleSpec) list2.get(i2);
                String name = moduleSpec.getName();
                ReactModuleInfo reactModuleInfo = (ReactModuleInfo) map.get(name);
                if (reactModuleInfo != null) {
                    return new ModuleHolder(reactModuleInfo, moduleSpec.getProvider());
