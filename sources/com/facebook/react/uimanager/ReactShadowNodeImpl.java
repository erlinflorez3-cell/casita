...
public class ReactShadowNodeImpl implements ReactShadowNode<ReactShadowNodeImpl> {
    ...
    */
    ...
    @Override // com.facebook.react.uimanager.ReactShadowNode
    public void dispatchUpdates(float f2, float f3, UIViewOperationQueue uIViewOperationQueue, NativeViewHierarchyOptimizer nativeViewHierarchyOptimizer) {
        ...
        if (hasNewLayout()) {
            ...
            int iRound3 = Math.round(f4 + getLayoutWidth());
            int iRound4 = Math.round(f5 + getLayoutHeight());
            int iRound5 = Math.round(layoutX);
            int iRound6 = Math.round(layoutY);
            int i2 = iRound3 - iRound;
            int i3 = iRound4 - iRound2;
            boolean z2 = (iRound5 == this.mScreenX && iRound6 == this.mScreenY && i2 == this.mScreenWidth && i3 == this.mScreenHeight) ? false : true;
    ...
    @Override // com.facebook.react.uimanager.ReactShadowNode
    public boolean dispatchUpdatesWillChangeLayout(float f2, float f3) {
        if (!hasNewLayout()) {
            return false;
        }
        float layoutX = getLayoutX();
        ...
        float f5 = f3 + layoutY;
        int iRound2 = Math.round(f5);
        return (Math.round(layoutX) == this.mScreenX && Math.round(layoutY) == this.mScreenY && Math.round(f4 + getLayoutWidth()) - iRound == this.mScreenWidth && Math.round(f5 + getLayoutHeight()) - iRound2 == this.mScreenHeight) ? false : true;
    }
    ...
    public ReactShadowNodeImpl removeChildAt(int i2) {
        ...
        ReactShadowNodeImpl reactShadowNodeImplRemove = arrayList.remove(i2);
    ...
    public final ReactShadowNodeImpl removeNativeChildAt(int i2) {
        Assertions.assertNotNull(this.mNativeChildren);
        ReactShadowNodeImpl reactShadowNodeImplRemove = this.mNativeChildren.remove(i2);
    ...
    public void setColumnGap(float f2) {
        this.mYogaNode.setGap(YogaGutter.COLUMN, f2);
    }

    @Override // com.facebook.react.uimanager.ReactShadowNode
    public void setColumnGapPercent(float f2) {
        this.mYogaNode.setGapPercent(YogaGutter.COLUMN, f2);
    }
    ...
    public void setGap(float f2) {
        this.mYogaNode.setGap(YogaGutter.ALL, f2);
    }
    ...
    public void setRowGap(float f2) {
        this.mYogaNode.setGap(YogaGutter.ROW, f2);
    }

    @Override // com.facebook.react.uimanager.ReactShadowNode
    public void setRowGapPercent(float f2) {
        this.mYogaNode.setGapPercent(YogaGutter.ROW, f2);
    }
    ...
    public String toString() {
        return "[" + this.mViewClassName + Global.BLANK + getReactTag() + "]";
    }
