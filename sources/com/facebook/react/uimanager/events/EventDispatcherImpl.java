...
public class EventDispatcherImpl implements EventDispatcher, LifecycleEventListener {
    ...
    private long getEventCookie(int i2, String str, short s2) {
        ...
        if (sh != null) {
            ...
            sShortValue = this.mNextEventTypeId;
            this.mNextEventTypeId = (short) (sShortValue + 1);
            this.mEventNameToEventId.put(str, Short.valueOf(sShortValue));
        }
        return getEventCookie(i2, sShortValue, s2);
    }
