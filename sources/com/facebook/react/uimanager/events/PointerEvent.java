...
public class PointerEvent extends Event<PointerEvent> {
    ...
    public static class PointerEventState {
        ...
        public PointerEventState(int i2, int i3, int i4, int i5, Map<Integer, float[]> map, Map<Integer, List<TouchTargetHelper.ViewTarget>> map2, Map<Integer, float[]> map3, Map<Integer, float[]> map4, Set<Integer> set) {
            this.mPrimaryPointerId = i2;
        ...
        public boolean supportsHover(int i2) {
            return this.mHoveringPointerIds.contains(Integer.valueOf(i2));
        }
    }
    ...
    private void addModifierKeyData(WritableMap writableMap, int i2) {
        writableMap.putBoolean("ctrlKey", (4096 & i2) != 0);
        writableMap.putBoolean("shiftKey", (-1) - (((-1) - i2) | ((-1) - 1)) != 0);
        writableMap.putBoolean("altKey", (i2 + 2) - (2 | i2) != 0);
    ...
    private WritableMap createW3CPointerEvent(int i2) {
        WritableMap writableMapCreateMap = Arguments.createMap();
        int pointerId = this.mMotionEvent.getPointerId(i2);
        writableMapCreateMap.putDouble("pointerId", pointerId);
        String w3CPointerType = PointerEventHelper.getW3CPointerType(this.mMotionEvent.getToolType(i2));
        ...
        writableMapCreateMap.putInt(ProductAction.ACTION_DETAIL, 0);
        ...
        if (w3CPointerType.equals(PointerEventHelper.POINTER_TYPE_MOUSE) || isClickEvent()) {
            ...
            double dIPFromPixel5 = PixelUtil.toDIPFromPixel(this.mMotionEvent.getTouchMajor(i2));
    ...
    private List<WritableMap> createW3CPointerEvents() {
        ...
        for (int i2 = 0; i2 < this.mMotionEvent.getPointerCount(); i2++) {
            arrayList.add(createW3CPointerEvent(i2));
        }
        return arrayList;
    }

    private void init(String str, int i2, PointerEventState pointerEventState, MotionEvent motionEvent, short s2) {
    ...
    public static PointerEvent obtain(String str, int i2, PointerEventState pointerEventState, MotionEvent motionEvent) {
        ...
        pointerEventAcquire.init(str, i2, pointerEventState, (MotionEvent) Assertions.assertNotNull(motionEvent), (short) 0);
    ...
    public static PointerEvent obtain(String str, int i2, PointerEventState pointerEventState, MotionEvent motionEvent, short s2) {
        ...
        pointerEventAcquire.init(str, i2, pointerEventState, (MotionEvent) Assertions.assertNotNull(motionEvent), s2);
        return pointerEventAcquire;
    }
    ...
    public void dispatchModern(RCTModernEventEmitter rCTModernEventEmitter) {
        ...
        for (WritableMap writableMapCopy : this.mPointersEventData) {
            ...
            String str = this.mEventName;
            short s2 = this.mCoalescingKey;
            rCTModernEventEmitter.receiveEvent(surfaceId, viewTag, str, s2 != -1, s2, writableMapCopy, PointerEventHelper.getEventCategory(str));
        }
    }
