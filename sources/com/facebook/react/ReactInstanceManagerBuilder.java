...
public class ReactInstanceManagerBuilder {
    ...
    public ReactInstanceManager build() {
        ...
        JavaScriptExecutorFactory defaultJSExecutorFactory = this.mJavaScriptExecutorFactory;
        if (defaultJSExecutorFactory == null) {
            defaultJSExecutorFactory = getDefaultJSExecutorFactory(packageName, friendlyDeviceName, application.getApplicationContext());
        }
    ...
    public ReactInstanceManagerBuilder setKeepActivity(boolean z2) {
        this.mKeepActivity = z2;
        return this;
    }
