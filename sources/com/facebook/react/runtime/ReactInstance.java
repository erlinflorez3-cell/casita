...
final class ReactInstance {
    ...
    /* JADX INFO: renamed from: com.facebook.react.runtime.ReactInstance$1 */
    class AnonymousClass1 implements JSBundleLoaderDelegate {
        AnonymousClass1() {
        }
    ...
    private class ReactJsExceptionHandlerImpl implements ReactJsExceptionHandler {
        ...
        public void reportJsException(ReactJsExceptionHandler.ParsedError parsedError) {
            try {
                ...
                this.mQueueThreadExceptionHandler.handleException(e2);
            }
        }
    }
    ...
    ReactInstance(BridgelessReactContext bridgelessReactContext, ReactHostDelegate reactHostDelegate, ComponentFactory componentFactory, DevSupportManager devSupportManager, QueueThreadExceptionHandler queueThreadExceptionHandler, boolean z2, @Nullable ReactHostInspectorTarget reactHostInspectorTarget) throws Throwable {
        this.mBridgelessReactContext = bridgelessReactContext;
    ...
    private native HybridData initHybrid(JSRuntimeFactory jSRuntimeFactory, MessageQueueThread messageQueueThread, MessageQueueThread messageQueueThread2, JavaTimerManager javaTimerManager, JSTimerExecutor jSTimerExecutor, ReactJsExceptionHandler reactJsExceptionHandler, @Nullable BindingsInstaller bindingsInstaller, boolean z2, @Nullable ReactHostInspectorTarget reactHostInspectorTarget);
