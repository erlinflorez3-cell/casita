...
public final class JSPackagerClient implements ReconnectingWebSocket.MessageCallback {
    ...
    private class ResponderImpl implements Responder {
        ...
        public void error(Object obj) {
            try {
                ...
                FLog.e(JSPackagerClient.TAG, "Responding with error failed", e2);
            }
        }
        ...
        public void respond(Object obj) {
            try {
                ...
                FLog.e(JSPackagerClient.TAG, "Responding failed", e2);
            }
        }
    }
    ...
    public void onMessage(String str) {
        try {
            ...
            Object objOpt2 = jSONObject.opt(Message.JsonKeys.PARAMS);
            if (iOptInt != 2) {
            ...
            FLog.e(TAG, "Handling the message failed", e2);
        }
    }
