...
class MaintainVisibleScrollPositionHelper<ScrollViewT extends ViewGroup & ReactScrollViewHelper.HasSmoothScroll> implements UIManagerListener {
    ...
    /* JADX INFO: renamed from: com.facebook.react.views.scroll.MaintainVisibleScrollPositionHelper$1 */
    ...
    public void computeTargetView() {
        ...
        for (int i2 = this.mConfig.minIndexForVisible; i2 < contentView.getChildCount(); i2++) {
            ...
            if (y2 + height > scrollX || i2 == contentView.getChildCount() - 1) {
    ...
    private void updateScrollPositionInternal() {
        ...
        if (this.mHorizontal) {
            int i2 = rect.left - this.mPrevFirstVisibleFrame.left;
            if (i2 != 0) {
                int scrollX = this.mScrollView.getScrollX();
                ScrollViewT scrollviewt = this.mScrollView;
                scrollviewt.scrollToPreservingMomentum(i2 + scrollX, scrollviewt.getScrollY());
                this.mPrevFirstVisibleFrame = rect;
        ...
        int i3 = rect.top - this.mPrevFirstVisibleFrame.top;
        if (i3 != 0) {
            int scrollY = this.mScrollView.getScrollY();
            ScrollViewT scrollviewt3 = this.mScrollView;
            scrollviewt3.scrollToPreservingMomentum(scrollviewt3.getScrollX(), i3 + scrollY);
            this.mPrevFirstVisibleFrame = rect;
