...
public class BridgeReactContext extends ReactApplicationContext {
    ...
    public <T extends JavaScriptModule> T getJSModule(Class<T> cls) {
        if (this.mCatalystInstance != null) {
            return (this.mInteropModuleRegistry == null || !this.mInteropModuleRegistry.shouldReturnInteropModule(cls)) ? (T) this.mCatalystInstance.getJSModule(cls) : (T) this.mInteropModuleRegistry.getInteropModule(cls);
        }
        if (this.mDestroyed) {
    ...
    public void handleException(Exception exc) {
        ...
        boolean z4 = getJSExceptionHandler() != null;
        if (z3 && z4) {
            getJSExceptionHandler().handleException(exc);
        } else {
            FLog.e(ReactConstants.TAG, "Unable to handle Exception - catalystInstanceVariableExists: " + z2 + " - isCatalystInstanceAlive: " + z3 + " - hasExceptionHandler: " + z4, exc);
