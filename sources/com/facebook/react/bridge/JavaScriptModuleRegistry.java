...
public final class JavaScriptModuleRegistry {
    ...
    public synchronized <T extends JavaScriptModule> T getJavaScriptModule(CatalystInstance catalystInstance, Class<T> cls) {
        T t2 = (T) this.mModuleInstances.get(cls);
        if (t2 != null) {
            return t2;
        }
        T t3 = (T) Proxy.newProxyInstance(cls.getClassLoader(), new Class[]{cls}, new JavaScriptModuleInvocationHandler(catalystInstance, cls));
        this.mModuleInstances.put((Class<? extends JavaScriptModule>) cls, t3);
        return t3;
    }
}
