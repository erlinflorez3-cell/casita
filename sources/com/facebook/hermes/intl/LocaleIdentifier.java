...
public class LocaleIdentifier {
    ...
    static boolean handleExtensions(CharSequence charSequence, LocaleIdTokenizer localeIdTokenizer, LocaleIdTokenizer.LocaleIdSubtag localeIdSubtag, boolean z2, ParsedLocaleIdentifier parsedLocaleIdentifier) throws LocaleIdTokenizer.LocaleIdSubtagIterationFailed, JSRangeErrorException {
    ...
    static void parseLanguageId(CharSequence charSequence, LocaleIdTokenizer localeIdTokenizer, LocaleIdTokenizer.LocaleIdSubtag localeIdSubtag, boolean z2, ParsedLocaleIdentifier parsedLocaleIdentifier) throws LocaleIdTokenizer.LocaleIdSubtagIterationFailed, JSRangeErrorException {
        ...
        try {
            ...
            if (localeIdTokenizer.hasMoreSubtags()) {
                ...
                if (handleExtensions(charSequence, localeIdTokenizer, localeIdSubtagNextSubtag, z2, parsedLocaleIdentifier)) {
                    return;
                }
                ...
                while (!handleExtensions(charSequence, localeIdTokenizer, localeIdSubtagNextSubtag, z2, parsedLocaleIdentifier)) {
    ...
    static void parseOtherExtensions(CharSequence charSequence, LocaleIdTokenizer localeIdTokenizer, ParsedLocaleIdentifier parsedLocaleIdentifier, char c2) throws LocaleIdTokenizer.LocaleIdSubtagIterationFailed, JSRangeErrorException {
        if (!localeIdTokenizer.hasMoreSubtags()) {
            throw new JSRangeErrorException("Extension sequence expected.");
        }
        LocaleIdTokenizer.LocaleIdSubtag localeIdSubtagNextSubtag = localeIdTokenizer.nextSubtag();
    ...
    public static String replaceRegionSubtagIfNeeded(StringBuffer stringBuffer) {
        ...
        if (stringBuffer.length() == 2) {
            ...
            return iBinarySearch >= 0 ? LanguageTagsGenerated.regionAliasReplacements2[iBinarySearch] : stringBuffer.toString();
        }
        int iBinarySearch2 = Arrays.binarySearch(LanguageTagsGenerated.regionAliasKeys3, stringBuffer.toString());
        return iBinarySearch2 >= 0 ? LanguageTagsGenerated.regionAliasReplacements3[iBinarySearch2] : stringBuffer.toString();
    }
}
