...
public class CountingLruBitmapMemoryCacheFactory implements BitmapMemoryCacheFactory {
    ...
    public CountingMemoryCache<CacheKey, CloseableImage> create(Supplier<MemoryCacheParams> supplier, MemoryTrimmableRegistry memoryTrimmableRegistry, MemoryCache.CacheTrimStrategy cacheTrimStrategy, boolean z2, boolean z3, @Nullable CountingMemoryCache.EntryStateObserver<CacheKey> entryStateObserver) {
        ...
        }, cacheTrimStrategy, supplier, entryStateObserver, z2, z3);
