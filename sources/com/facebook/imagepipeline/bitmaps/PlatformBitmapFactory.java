...
public abstract class PlatformBitmapFactory {
    ...
    private CloseableReference<Bitmap> createBitmap(int i2, int i3, Bitmap.Config config, boolean z2, @Nullable Object obj) {
    ...
    private CloseableReference<Bitmap> createBitmap(@Nullable DisplayMetrics displayMetrics, int i2, int i3, Bitmap.Config config, boolean z2, @Nullable Object obj) {
        checkWidthHeight(i2, i3);
        CloseableReference<Bitmap> closeableReferenceCreateBitmapInternal = createBitmapInternal(i2, i3, config);
    ...
    public CloseableReference<Bitmap> createBitmap(Bitmap bitmap, int i2, int i3, int i4, int i5, @Nullable Matrix matrix, boolean z2) {
        return createBitmap(bitmap, i2, i3, i4, i5, matrix, z2, (Object) null);
    }

    public CloseableReference<Bitmap> createBitmap(Bitmap bitmap, int i2, int i3, int i4, int i5, @Nullable Matrix matrix, boolean z2, @Nullable Object obj) {
        ...
        if (matrix == null || matrix.isIdentity()) {
            closeableReferenceCreateBitmap = createBitmap(i4, i5, suitableBitmapConfig, bitmap.hasAlpha(), obj);
    ...
    public CloseableReference<Bitmap> createBitmap(DisplayMetrics displayMetrics, int[] iArr, int i2, int i3, int i4, int i5, Bitmap.Config config, @Nullable Object obj) {
        CloseableReference<Bitmap> closeableReferenceCreateBitmap = createBitmap(displayMetrics, i4, i5, config, obj);
        closeableReferenceCreateBitmap.get().setPixels(iArr, i2, i3, 0, 0, i4, i5);
        return closeableReferenceCreateBitmap;
    }
    ...
    public CloseableReference<Bitmap> createBitmap(int[] iArr, int i2, int i3, Bitmap.Config config, @Nullable Object obj) {
        CloseableReference<Bitmap> closeableReferenceCreateBitmapInternal = createBitmapInternal(i2, i3, config);
        closeableReferenceCreateBitmapInternal.get().setPixels(iArr, 0, i2, 0, 0, i2, i3);
        return closeableReferenceCreateBitmapInternal;
    }
    ...
    public CloseableReference<Bitmap> createScaledBitmap(Bitmap bitmap, int i2, int i3, boolean z2) {
        return createScaledBitmap(bitmap, i2, i3, z2, null);
    }

    public CloseableReference<Bitmap> createScaledBitmap(Bitmap bitmap, int i2, int i3, boolean z2, @Nullable Object obj) {
        checkWidthHeight(i2, i3);
