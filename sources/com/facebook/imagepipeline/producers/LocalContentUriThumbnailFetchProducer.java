...
public class LocalContentUriThumbnailFetchProducer extends LocalFetchProducer implements ThumbnailProducer<EncodedImage> {
    ...
    private EncodedImage getThumbnail(ResizeOptions resizeOptions, long j2) throws IOException {
        ...
        if (thumbnailKind == 0 || (cursorQueryMiniThumbnail = MediaStore.Images.Thumbnails.queryMiniThumbnail(this.mContentResolver, j2, thumbnailKind, THUMBNAIL_PROJECTION)) == null) {
            return null;
        }
        try {
