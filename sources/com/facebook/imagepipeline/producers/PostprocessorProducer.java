...
public class PostprocessorProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    private class PostprocessorConsumer extends DelegatingConsumer<CloseableReference<CloseableImage>, CloseableReference<CloseableImage>> {
        ...
        public void doPostprocessing(CloseableReference<CloseableImage> closeableReference, int i2) {
            ...
            try {
                try {
                    ...
                    maybeNotifyOnNewResult(closeableReferencePostprocessInternal, i2);
        ...
        private void maybeNotifyOnNewResult(@Nullable CloseableReference<CloseableImage> closeableReference, int i2) {
    ...
    public void produceResults(Consumer<CloseableReference<CloseableImage>> consumer, ProducerContext producerContext) {
        ...
        ProducerListener2 producerListener = producerContext2.getProducerListener();
        Postprocessor postprocessor = producerContext2.getImageRequest().getPostprocessor();
        Preconditions.checkNotNull(postprocessor);
        PostprocessorConsumer postprocessorConsumer = new PostprocessorConsumer(consumer, producerListener, postprocessor, producerContext2);
        ...
        this.mInputProducer.produceResults(singleUsePostprocessorConsumer, producerContext2);
    }
}
