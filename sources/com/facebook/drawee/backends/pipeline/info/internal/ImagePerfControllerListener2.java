...
public class ImagePerfControllerListener2 extends BaseControllerListener2<ImageInfo> implements ImagePerfNotifierHolder, OnDrawControllerListener<ImageInfo>, Closeable, VisibilityCallback {
    ...
    @Nullable
    private static LogHandler sHandler = null;
    ...
    static class LogHandler extends Handler implements ImagePerfNotifierHolder {
        ...
        public void handleMessage(Message message) {
            ...
            int i2 = message.what;
            if (i2 == 1) {
                ImageLoadStatus imageLoadStatusFromInt = ImageLoadStatus.Companion.fromInt(message.arg1);
            ...
            VisibilityState visibilityStateFromInt = VisibilityState.Companion.fromInt(message.arg1);
    ...
    public ImagePerfControllerListener2(MonotonicClock monotonicClock, ImagePerfState imagePerfState, ImagePerfNotifier imagePerfNotifier, Supplier<Boolean> supplier, boolean z2) {
        ...
        this.mReportVisibleOnSubmitAndRelease = z2;
    }
