...
public class ProgressBarDrawable extends Drawable implements CloneableDrawable {
    ...
    private void drawHorizontalBar(Canvas canvas, int i2, int i3) {
        ...
        int iWidth = ((bounds.width() - (this.mPadding * 2)) * i2) / 10000;
        this.mRect.set(bounds.left + this.mPadding, (bounds.bottom - this.mPadding) - this.mBarWidth, r1 + iWidth, r5 + r0);
        drawBar(canvas, i3);
    }

    private void drawVerticalBar(Canvas canvas, int i2, int i3) {
        Rect bounds = getBounds();
        int iHeight = ((bounds.height() - (this.mPadding * 2)) * i2) / 10000;
        this.mRect.set(bounds.left + this.mPadding, bounds.top + this.mPadding, r1 + this.mBarWidth, r5 + iHeight);
        drawBar(canvas, i3);
    }
