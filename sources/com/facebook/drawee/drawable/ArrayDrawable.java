...
public class ArrayDrawable extends Drawable implements Drawable.Callback, TransformCallback, TransformAwareDrawable {
    ...
    /* JADX INFO: renamed from: com.facebook.drawee.drawable.ArrayDrawable$1 */
    class AnonymousClass1 implements DrawableParent {
    ...
    public Drawable getDrawable(int i2) {
        ...
        Preconditions.checkArgument(Boolean.valueOf(i2 < this.mLayers.length));
        return this.mLayers[i2];
    }

    public DrawableParent getDrawableParentForIndex(int i2) {
        Preconditions.checkArgument(Boolean.valueOf(i2 >= 0));
        Preconditions.checkArgument(Boolean.valueOf(i2 < this.mDrawableParents.length));
    ...
    public boolean isStateful() {
        if (!this.mIsStatefulCalculated) {
            ...
            while (true) {
                ...
                int i3 = (drawable == null || !drawable.isStateful()) ? 0 : 1;
                boolean z3 = true;
                if (((z2 ? 1 : 0) + i3) - ((z2 ? 1 : 0) & i3) != 1) {
                    z3 = false;
                }
                this.mIsStateful = z3;
                i2++;
