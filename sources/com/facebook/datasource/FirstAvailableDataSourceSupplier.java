...
public class FirstAvailableDataSourceSupplier<T> implements Supplier<DataSource<T>> {
    ...
    private class FirstAvailableDataSource extends AbstractDataSource<T> {
        ...
        private void maybeSetDataSourceWithResult(DataSource<T> dataSource, boolean z2) {
        ...
        */
        public synchronized boolean hasResult() {
            /*
                r1 = this;
                monitor-enter(r1)
                com.facebook.datasource.DataSource r0 = r1.getDataSourceWithResult()     // Catch: java.lang.Throwable -> L13
                if (r0 == 0) goto Lc
                boolean r0 = r0.hasResult()     // Catch: java.lang.Throwable -> L13
                goto Le
            Lc:
                r0 = 0
                goto L11
