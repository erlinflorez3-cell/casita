...
public class IncreasingQualityDataSourceSupplier<T> implements Supplier<DataSource<T>> {
    ...
    private class IncreasingQualityDataSource extends AbstractDataSource<T> {
        ...
        private void maybeSetIndexOfDataSourceWithResult(int i2, DataSource<T> dataSource, boolean z2) {
            synchronized (this) {
                int i3 = this.mIndexOfDataSourceWithResult;
                if (dataSource != getDataSource(i2) || i2 == this.mIndexOfDataSourceWithResult) {
                    return;
                }
                if (getDataSourceWithResult() == null || (z2 && i2 < this.mIndexOfDataSourceWithResult)) {
        ...
        */
        public synchronized boolean hasResult() {
            /*
                r1 = this;
                monitor-enter(r1)
                com.facebook.datasource.IncreasingQualityDataSourceSupplier r0 = com.facebook.datasource.IncreasingQualityDataSourceSupplier.this     // Catch: java.lang.Throwable -> L1e
                boolean r0 = com.facebook.datasource.IncreasingQualityDataSourceSupplier.m7170$$Nest$fgetmDataSourceLazy(r0)     // Catch: java.lang.Throwable -> L1e
                if (r0 == 0) goto Lc
                r1.ensureDataSourceInitialized()     // Catch: java.lang.Throwable -> L1e
            Lc:
                com.facebook.datasource.DataSource r0 = r1.getDataSourceWithResult()     // Catch: java.lang.Throwable -> L1e
                if (r0 == 0) goto L17
                boolean r0 = r0.hasResult()     // Catch: java.lang.Throwable -> L1e
                goto L19
            L17:
                r0 = 0
                goto L1c
