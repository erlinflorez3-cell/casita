...
public class ContextChain implements Parcelable {
    ...
    public ContextChain(String str, String str2, @Nullable Map<String, String> map, @Nullable ContextChain contextChain) {
        this.mTag = str;
        this.mName = str2;
        this.mSerializedNodeString = str + Global.COLON + str2;
    ...
    public static void setUseConcurrentHashMap(boolean z2) {
        sUseConcurrentHashMap = z2;
    }
    ...
    public void putObjectExtra(String str, Object obj) {
        boolean z2 = sUseConcurrentHashMap;
