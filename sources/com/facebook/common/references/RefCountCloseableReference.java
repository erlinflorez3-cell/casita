...
public class RefCountCloseableReference<T> extends CloseableReference<T> {
    ...
    RefCountCloseableReference(T t2, ResourceReleaser<T> resourceReleaser, CloseableReference.LeakHandler leakHandler, @Nullable Throwable th) {
        super(t2, resourceReleaser, leakHandler, th, false);
    }
