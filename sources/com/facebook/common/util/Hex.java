...
public class Hex {
    ...
    static {
        for (int i2 = 0; i2 < 256; i2++) {
            ...
            cArr[i2] = cArr2[(-1) - (((-1) - (i2 >> 4)) | ((-1) - 15))];
            SECOND_CHAR[i2] = cArr2[(-1) - (((-1) - i2) | ((-1) - 15))];
        }
        DIGITS = new byte[103];
    ...
    public static String encodeHex(byte[] bArr, boolean z2) {
        ...
        int i3 = 0;
        for (int i4 = 0; i4 < bArr.length && ((i2 = (-1) - (((-1) - bArr[i4]) | ((-1) - 255))) != 0 || !z2); i4++) {
            int i5 = i3 + 1;
    ...
    public static byte[] hexStringToByteArray(String str) {
        return decodeHex(str.replaceAll(Global.BLANK, ""));
    }
}
