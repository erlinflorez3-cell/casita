...
@InterfaceC1492Gx
@Metadata(bv = {}, d1 = {"Я\u0014\u001d̉=!,i\bDZc|İI\u0006F\u000b6Ȑ\u00176:ߚ\u0010\u0007\u0015ia0rex6`TB\u0013{{:%\n&ڷG>"}, d2 = {"2hb=T;<Vx\u0010zg;", "", "\u001ab^:\"-:Q\u0019{\u0005h2F\u0016/a}7E=\u000e\u001b\u0016IoW)v!3h[*@|\u0016A\\\u0019", "3uT;g", "\u001ab^:\"-:Q\u0019{\u0005h2F\u0016/a}7EP\u0005\u001f\u0013Pk\u0010<\u0004n5j})F{_\u000e^CDz\n", "@dP0gsGO(\u0003\f^s~\t=t\u00105{\b\u0004\u0013 Fv\u000eIp25`}\u001cEm"}, k = 2, mv = {1, 9, 0}, pn = "", xi = 48, xs = "")
public final class ReactContextExtensionsKt {
    public static final void dispatchEvent(ReactContext reactContext, Event<?> event) {
        ...
        try {
            ...
            throw new Exception("Couldn't get an instance of UIManagerModule. Gesture Handler is unable to send an event.", e2);
        }
    }
}
