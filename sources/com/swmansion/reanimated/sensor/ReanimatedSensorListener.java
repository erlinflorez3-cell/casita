...
public class ReanimatedSensorListener implements SensorEventListener {
    ...
    ReanimatedSensorListener(SensorSetter sensorSetter, double d2, Display display) {
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (type == 2 || type == 4) {
            this.setter.sensorSetter(new float[]{sensorEvent.values[0], sensorEvent.values[1], sensorEvent.values[2]}, i2);
            return;
        }
        switch (type) {
            case 9:
            ...
            case 11:
                ...
                this.setter.sensorSetter(new float[]{f2, f3, f4, f5, -fArr2[0], -fArr2[1], fArr2[2]}, i2);
                return;
            default:
