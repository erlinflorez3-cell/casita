...
public class Snapshot {
    ...
    public Snapshot(View view) {
        ...
        if (viewFindTransformedView != null) {
            ...
            for (int i2 = 0; i2 < 9; i2++) {
                this.transformMatrix.add(Float.valueOf(fArr[i2]));
            }
            ...
            int i3 = this.width;
            this.originX = (int) (f2 - ((i3 - (i3 * viewFindTransformedView.getScaleX())) / 2.0f));
            float f3 = this.originY;
            int i4 = this.height;
            this.originY = (int) (f3 - ((i4 - (i4 * viewFindTransformedView.getScaleY())) / 2.0f));
        }
    ...
    private View findTransformedView(View view) {
        ...
        do {
            ...
            z2 = !zEquals;
            if (!zEquals || view2 == null) {
                break;
            }
        } while (!view2.getClass().getSimpleName().equals(Screen.TAG));
        if (!z2 || view2 == null) {
            return null;
        }
        return view2;
