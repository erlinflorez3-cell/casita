...
public class PngChunkType {
    ...
    public PngChunkType(String str, boolean z2) throws PngProcessingException {
        this._multipleAllowed = z2;
        try {
    ...
    private static boolean isUpperCase(byte b2) {
        return (-1) - (((-1) - b2) | ((-1) - 32)) == 0;
    }

    private static boolean isValidByte(byte b2) {
