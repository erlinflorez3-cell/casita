...
public class BmpReader {
    ...
    /* JADX WARN: Not initialized variable reg: 7, insn: 0x023f: INVOKE (r7 I:com.drew.metadata.bmp.BmpHeaderDirectory), (r0 I:java.lang.String) VIRTUAL call: com.drew.metadata.bmp.BmpHeaderDirectory.addError(java.lang.String):void A[MD:(java.lang.String):void (m)], block:B:56:0x023d */
    /* JADX WARN: Not initialized variable reg: 7, insn: 0x0245: INVOKE (r7 I:com.drew.metadata.bmp.BmpHeaderDirectory), (r0 I:java.lang.String) VIRTUAL call: com.drew.metadata.bmp.BmpHeaderDirectory.addError(java.lang.String):void A[MD:(java.lang.String):void (m)], block:B:57:0x0243 */
    protected void readBitmapHeader(SequentialReader sequentialReader, BmpHeaderDirectory bmpHeaderDirectory, Metadata metadata) {
        BmpHeaderDirectory bmpHeaderDirectoryAddError;
        BmpHeaderDirectory bmpHeaderDirectoryAddError2;
        try {
            ...
            if (int32 != 16 && int32 != 64) {
                ...
                if (sequentialReader.getPosition() > j2) {
                    bmpHeaderDirectory.addError("Invalid profile data offset 0x" + Long.toHexString(j2));
                    return;
                }
            ...
            bmpHeaderDirectoryAddError2.addError("Internal error");
        } catch (IOException unused2) {
            bmpHeaderDirectoryAddError.addError("Unable to read BMP header");
        }
    }

    protected void readFileHeader(SequentialReader sequentialReader, Metadata metadata, boolean z2) {
        try {
            ...
            metadata.addDirectory(new ErrorDirectory("Couldn't determine bitmap type: " + e2.getMessage()));
        }
    }
}
