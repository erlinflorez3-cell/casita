...
public class BmpHeaderDirectory extends Directory {
    ...
    public enum ColorSpaceType {
        ...
        @Override // java.lang.Enum
        public String toString() {
            int i2 = AnonymousClass1.$SwitchMap$com$drew$metadata$bmp$BmpHeaderDirectory$ColorSpaceType[ordinal()];
            if (i2 == 1) {
    ...
    public enum RenderingHalftoningAlgorithm {
        ...
        @Override // java.lang.Enum
        public String toString() {
            int i2 = AnonymousClass1.$SwitchMap$com$drew$metadata$bmp$BmpHeaderDirectory$RenderingHalftoningAlgorithm[ordinal()];
            if (i2 == 1) {
    ...
    public enum RenderingIntent {
        ...
        @Override // java.lang.Enum
        public String toString() {
            int i2 = AnonymousClass1.$SwitchMap$com$drew$metadata$bmp$BmpHeaderDirectory$RenderingIntent[ordinal()];
            if (i2 == 1) {
