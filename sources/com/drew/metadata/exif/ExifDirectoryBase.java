...
public abstract class ExifDirectoryBase extends Directory {
    ...
    protected static void addExifTagNames(HashMap<Integer, String> map) {
        ...
        map.put(259, ExifInterface.TAG_COMPRESSION);
        ...
        map.put(Integer.valueOf(TAG_PAGE_NUMBER), "Page Number");
        map.put(301, "Transfer Function");
        map.put(305, ExifInterface.TAG_SOFTWARE);
        map.put(306, "Date/Time");
        map.put(315, ExifInterface.TAG_ARTIST);
        map.put(317, "Predictor");
        map.put(316, "Host Computer");
        map.put(318, "White Point");
        ...
        map.put(Integer.valueOf(TAG_EXTRA_SAMPLES), "Extra Samples");
        map.put(Integer.valueOf(TAG_SAMPLE_FORMAT), "Sample Format");
        ...
        map.put(Integer.valueOf(TAG_COPYRIGHT), ExifInterface.TAG_COPYRIGHT);
        ...
        map.put(Integer.valueOf(TAG_PHOTOSHOP_SETTINGS), "Photoshop Settings");
        ...
        map.put(Integer.valueOf(TAG_TIME_ZONE_OFFSET_TIFF_EP), "Time Zone Offset");
        map.put(Integer.valueOf(TAG_SELF_TIMER_MODE_TIFF_EP), "Self Timer Mode");
        ...
        map.put(Integer.valueOf(TAG_ISO_SPEED), "ISO Speed");
        map.put(Integer.valueOf(TAG_ISO_SPEED_LATITUDE_YYY), "ISO Speed Latitude yyy");
        map.put(Integer.valueOf(TAG_ISO_SPEED_LATITUDE_ZZZ), "ISO Speed Latitude zzz");
        ...
        map.put(Integer.valueOf(TAG_TIME_ZONE_ORIGINAL), "Time Zone Original");
        map.put(Integer.valueOf(TAG_TIME_ZONE_DIGITIZED), "Time Zone Digitized");
        ...
        map.put(Integer.valueOf(TAG_FLASH), ExifInterface.TAG_FLASH);
        ...
        map.put(Integer.valueOf(TAG_TEMPERATURE), "Temperature");
        map.put(Integer.valueOf(TAG_HUMIDITY), "Humidity");
        map.put(Integer.valueOf(TAG_PRESSURE), "Pressure");
        map.put(Integer.valueOf(TAG_WATER_DEPTH), "Water Depth");
        map.put(Integer.valueOf(TAG_ACCELERATION), "Acceleration");
        map.put(Integer.valueOf(TAG_CAMERA_ELEVATION_ANGLE), "Camera Elevation Angle");
        ...
        map.put(40962, "Exif Image Width");
        map.put(40963, "Exif Image Height");
        map.put(40964, "Related Sound File");
        ...
        map.put(Integer.valueOf(TAG_SATURATION), ExifInterface.TAG_SATURATION);
        ...
        map.put(Integer.valueOf(TAG_GAMMA), ExifInterface.TAG_GAMMA);
        map.put(Integer.valueOf(TAG_PRINT_IMAGE_MATCHING_INFO), "Print Image Matching (PIM) Info");
