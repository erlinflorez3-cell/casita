...
public class CanonMakernoteDescriptor extends TagDescriptor<CanonMakernoteDirectory> {
    ...
    static {
        ...
        map.put(124, "Canon MP-E 65mm f/2.8 1-5x Macro Photo");
        map.put(125, "Canon TS-E 24mm f/3.5L");
        map.put(126, "Canon TS-E 45mm f/2.8");
        ...
        map.put(217, "Tamron AF 18-270mm f/3.5-6.3 Di II VC PZD");
    ...
    private double decodeCanonEv(int i2) {
        int i3;
        if (i2 < 0) {
            i2 = -i2;
            i3 = -1;
    ...
    public String getAfPointUsedDescription() {
        ...
        return (iIntValue + 7) - (iIntValue | 7) == 0 ? "Right" : (integer.intValue() & 7) == 1 ? "Centre" : (-1) - (((-1) - integer.intValue()) | ((-1) - 7)) == 2 ? "Left" : "Unknown (" + integer + ")";
    }
    ...
    public String getContrastDescription() {
        ...
        int iIntValue = integer.intValue();
        return iIntValue != 0 ? iIntValue != 1 ? iIntValue != 65535 ? "Unknown (" + integer + ")" : "Low" : "High" : ReactProgressBarViewManager.DEFAULT_STYLE;
    }
    ...
    public String getDisplayApertureDescription() {
        ...
        return integer.intValue() == 65535 ? integer.toString() : getFStopDescription(integer.intValue() / 10.0f);
    }
    ...
    public String getFlashBiasDescription() {
        ...
        return (z2 ? Global.HYPHEN : "") + Float.toString(integer.intValue() / 32.0f) + " EV";
    }
    ...
    public String getFlashDetailsDescription() {
        ...
        int iIntValue = integer.intValue() >> 13;
        if ((iIntValue + 1) - (iIntValue | 1) != 0) {
            return "Internal flash";
        }
        int iIntValue2 = integer.intValue() >> 11;
        return (iIntValue2 + 1) - (iIntValue2 | 1) != 0 ? "FP sync used" : (-1) - (((-1) - (integer.intValue() >> 4)) | ((-1) - 1)) != 0 ? "FP sync enabled" : "Unknown (" + integer + ")";
    }
    ...
    public String getIsoDescription() {
        ...
        if ((integer.intValue() & 16384) != 0) {
            return "" + ((-1) - (((-1) - integer.intValue()) | ((-1) - (-16385))));
        }
        int iIntValue = integer.intValue();
        if (iIntValue == 0) {
    ...
    public String getLongFocalLengthDescription() {
        ...
        return Integer.toString(integer.intValue()) + Global.BLANK + getFocalUnitsPerMillimetreDescription();
    }

    public String getMacroModeDescription() {
        return getIndexedDescription(CanonMakernoteDirectory.CameraSettings.TAG_MACRO_MODE, 1, "Macro", ReactProgressBarViewManager.DEFAULT_STYLE);
    }
    ...
    public String getMaxApertureDescription() {
        ...
        return integer.intValue() > 512 ? String.format("Unknown (%d)", integer) : getFStopDescription(Math.exp((decodeCanonEv(integer.intValue()) * Math.log(2.0d)) / 2.0d));
    }
    ...
    public String getQualityDescription() {
        ...
        int iIntValue = integer.intValue();
        return iIntValue != -1 ? iIntValue != 7 ? iIntValue != 130 ? iIntValue != 1131 ? iIntValue != 1 ? iIntValue != 2 ? iIntValue != 3 ? iIntValue != 4 ? iIntValue != 5 ? "Unknown (" + integer + ")" : "Superfine" : "RAW" : "Fine" : ReactProgressBarViewManager.DEFAULT_STYLE : "Economy" : "Movie (2)" : "Normal Movie" : "CRAW" : "n/a";
    }
    ...
    public String getSerialNumberDescription() {
        ...
        Integer numValueOf = Integer.valueOf((-1) - (((-1) - (integer.intValue() >> 8)) | ((-1) - 255)));
        int iIntValue = integer.intValue();
        return String.format("%04X%05d", numValueOf, Integer.valueOf((iIntValue + 255) - (iIntValue | 255)));
    }
    ...
    public String getTagAfPointsInFocus() {
        ...
        for (int i2 = 0; i2 < 16; i2++) {
            int iIntValue = integer.intValue();
            int i3 = 1 << i2;
            if ((iIntValue + i3) - (iIntValue | i3) != 0) {
                if (sb.length() != 0) {
