...
public class PanasonicMakernoteDirectory extends Directory {
    ...
    static {
        ...
        map.put(103, "Location");
        map.put(105, "Country");
        map.put(107, "State");
        map.put(109, "City");
        map.put(111, "Landmark");
        map.put(Integer.valueOf(TAG_INTELLIGENT_RESOLUTION), "Intelligent Resolution");
        map.put(Integer.valueOf(TAG_BURST_SPEED), "Burst Speed");
        map.put(121, "Intelligent D-Range");
        map.put(124, "Clear Retouch");
        map.put(128, "City 2");
    ...
    public Face[] getDetectedFaces() {
        ...
        try {
            ...
            for (int i2 = 0; i2 < uInt16; i2++) {
                int i3 = i2 * 8;
                faceArr[i2] = new Face(byteArrayReader.getUInt16(i3 + 2), byteArrayReader.getUInt16(i3 + 4), byteArrayReader.getUInt16(i3 + 6), byteArrayReader.getUInt16(i3 + 8), null, null);
            }
            return faceArr;
    ...
    public Face[] getRecognizedFaces() {
        ...
        try {
            ...
            for (int i2 = 0; i2 < uInt16; i2++) {
                int i3 = i2 * 44;
                faceArr[i2] = new Face(byteArrayReader.getUInt16(i3 + 24), byteArrayReader.getUInt16(i3 + 26), byteArrayReader.getUInt16(i3 + 28), byteArrayReader.getUInt16(i3 + 30), byteArrayReader.getString(i3 + 4, 20, HTTP.ASCII).trim(), Age.fromPanasonicString(byteArrayReader.getString(i3 + 32, 20, HTTP.ASCII).trim()));
            }
            return faceArr;
        } catch (IOException unused) {
            return null;
