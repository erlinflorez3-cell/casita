...
public class SamsungType2MakernoteDescriptor extends TagDescriptor<SamsungType2MakernoteDirectory> {
    ...
    public String getColorSpaceDescription() {
        return getIndexedDescription(SamsungType2MakernoteDirectory.TagColorSpace, "sRGB", "Adobe RGB");
    }
    ...
    public String getRawDataByteOrderDescription() {
        return getIndexedDescription(64, "Little-endian (Intel)", "Big-endian (Motorola)");
    }
    ...
    public String getSmartRangeDescription() {
        return getIndexedDescription(SamsungType2MakernoteDirectory.TagSmartRange, "Off", "On");
    }

    public String getWhiteBalanceSetupDescription() {
        return getIndexedDescription(65, "Auto", "Manual");
    }
}
