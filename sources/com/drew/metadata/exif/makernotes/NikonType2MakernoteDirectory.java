...
public class NikonType2MakernoteDirectory extends Directory {
    ...
    static {
        ...
        _decTable2 = new int[]{167, 188, 201, 173, 145, 223, 133, 229, Mp4VideoDirectory.TAG_OPCOLOR, 120, Mp4VideoDirectory.TAG_COLOR_TABLE, 23, 70, 124, 41, 76, 77, 3, 233, 37, 104, 17, 134, 179, 189, 247, 111, 97, 34, 162, 38, 52, 42, 190, 30, 70, 20, 104, 157, 68, 24, 194, 64, 244, 126, 95, 27, 173, 11, 148, 182, 103, 180, 11, JfifUtil.MARKER_APP1, 234, 149, 156, 102, 220, 231, 93, 108, 5, JfifUtil.MARKER_SOS, Mp4VideoDirectory.TAG_COLOR_TABLE, 223, 122, 239, 246, 219, 31, 130, 76, 192, 104, 71, 161, 189, 238, 57, 80, 86, 74, 221, 223, 165, 248, 198, JfifUtil.MARKER_SOS, 202, 144, 202, 1, 66, 157, 139, 12, 115, 67, 117, 5, 148, 222, 36, 179, 128, 52, 229, 44, 220, 155, 63, 202, 51, 69, 208, 219, 95, 245, 82, 195, 33, JfifUtil.MARKER_SOS, 226, 34, 114, 107, 62, 208, 91, 168, 135, 140, 6, 93, 15, 221, 9, 25, 147, 208, 185, 252, 139, 15, 132, 96, 51, 28, 155, 69, 241, 240, 163, 148, 58, 18, PanasonicMakernoteDirectory.TAG_BURST_SPEED, 51, 77, 68, 120, 40, 60, 158, 253, 101, 87, 22, 148, 107, 251, 89, 208, 200, 34, 54, 219, Mp4VideoDirectory.TAG_COMPRESSION_TYPE, 99, 152, 67, 161, 4, 135, 134, 247, 166, 38, 187, Mp4VideoDirectory.TAG_FRAME_RATE, 89, 77, 191, 106, 46, 170, 43, 239, 230, 120, 182, 78, CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY, 47, 220, 124, 190, 87, 25, 50, 126, 42, 208, 184, 186, 41, 0, 60, 82, 125, 168, 73, 59, 45, 235, 37, 73, 250, 163, 170, 57, 167, 197, 167, 80, 17, 54, 251, 198, 103, 74, 245, 165, 18, 101, 126, 176, 223, 175, 78, 179, 97, 127, 47};
    }
    ...
    public int[] getDecryptedIntArray(int i2) {
        int i3;
        ...
        while (true) {
            ...
            iIntValue ^= (integer2.intValue() >> (i4 * 8)) & 255;
            i4++;
        }
        int i5 = _decTable1[(-1) - (((-1) - integer.intValue()) | ((-1) - 255))];
        int i6 = _decTable2[iIntValue];
        int i7 = 96;
        for (i3 = 4; i3 < intArray.length; i3++) {
            int i8 = i6 + (i5 * i7);
            i6 = (i8 + 255) - (i8 | 255);
            int i9 = i7 + 1;
            i7 = (i9 + 255) - (i9 | 255);
            intArray[i3] = intArray[i3] ^ i6;
        }
        return intArray;
    }
