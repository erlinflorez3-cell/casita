...
public class GpsDescriptor extends TagDescriptor<GpsDirectory> {
    ...
    private String getGeoLocationDimension(int i2, int i3, String str) {
        Double dDegreesMinutesSecondsToDecimal;
        Rational[] rationalArray = ((GpsDirectory) this._directory).getRationalArray(i2);
        String string = ((GpsDirectory) this._directory).getString(i3);
    ...
    public String getDescription(int i2) {
        switch (i2) {
            ...
            case 16:
            case 23:
                return getGpsDirectionReferenceDescription(i2);
            case 15:
            case 17:
            case 24:
                return getGpsDirectionDescription(i2);
            case 20:
    ...
    public String getGpsDestLatitudeDescription() {
        return getGeoLocationDimension(20, 19, ExifInterface.LATITUDE_SOUTH);
    }

    public String getGpsDestLongitudeDescription() {
        return getGeoLocationDimension(22, 21, ExifInterface.LONGITUDE_WEST);
    }
    ...
    public String getGpsDirectionDescription(int i2) {
        Rational rational = ((GpsDirectory) this._directory).getRational(i2);
        String string = rational != null ? new DecimalFormat("0.##").format(rational.doubleValue()) : ((GpsDirectory) this._directory).getString(i2);
    ...
    public String getGpsDirectionReferenceDescription(int i2) {
