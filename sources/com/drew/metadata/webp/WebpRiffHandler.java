...
public class WebpRiffHandler implements RiffHandler {
    ...
    public void processChunk(String str, byte[] bArr) {
        ...
        if (str.equals(WebpDirectory.CHUNK_EXIF)) {
            new ExifReader().extract(ExifReader.startsWithJpegExifPreamble(bArr) ? new ByteArrayReader(bArr, ExifReader.JPEG_SEGMENT_PREAMBLE.length()) : new ByteArrayReader(bArr), this._metadata);
            return;
        }
        ...
        if (str.equals(WebpDirectory.CHUNK_VP8L) && bArr.length > 4) {
            ...
            try {
                ...
                int uInt83 = (-1) - (((-1) - ((byteArrayReader2.getUInt8(4) & 15) << 10)) & ((-1) - (byteArrayReader2.getUInt8(3) << 2)));
                int i2 = ((-1) - (((-1) - uInt82) | ((-1) - 192))) >> 6;
                webpDirectory.setInt(2, (uInt8 | ((63 & uInt82) << 8)) + 1);
                webpDirectory.setInt(1, ((uInt83 + i2) - (uInt83 & i2)) + 1);
                this._metadata.addDirectory(webpDirectory);
                return;
        ...
        try {
            ...
            webpDirectory.addError(e4.getMessage());
        }
    }
