...
public class Mp4Dictionary {
    ...
    static {
        ...
        _dictionary.put(201, _vendorIds);
        ...
        _videoCompressionTypes.put(Constants.SENSITIVITY_BASE, "Base");
    ...
    public static String lookup(int i2, String str) {
        return (_dictionary.containsKey(Integer.valueOf(i2)) && _dictionary.get(Integer.valueOf(i2)).containsKey(str)) ? _dictionary.get(Integer.valueOf(i2)).get(str) : "Unknown";
    }

    public static void setLookup(int i2, String str, Mp4Directory mp4Directory) {
        mp4Directory.setString(i2, lookup(i2, str));
    }
}
