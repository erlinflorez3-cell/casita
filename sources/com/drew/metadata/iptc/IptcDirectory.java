...
public class IptcDirectory extends Directory {
    ...
    static {
        ...
        map.put(261, HttpHeaders.DESTINATION);
        ...
        map.put(602, "City");
        map.put(604, "Sub-location");
        map.put(607, "Province/State");
        map.put(612, "Country/Primary Location Code");
    ...
    private Date getDate(int i2, int i3) {
