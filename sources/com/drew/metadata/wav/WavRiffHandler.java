            ...
            if (!str.equals(WavDirectory.CHUNK_FORMAT)) {
                ...
                try {
                    if (this._directory.containsTag(4)) {
                        ...
                        int i2 = (int) length;
                        Integer numValueOf = Integer.valueOf(i2 / ((int) Math.pow(60.0d, 2.0d)));
                        Integer numValueOf2 = Integer.valueOf((i2 / ((int) Math.pow(60.0d, 1.0d))) - (numValueOf.intValue() * 60));
                        this._directory.setString(16, String.format("%1$02d:%2$02d:%3$02d", numValueOf, numValueOf2, Integer.valueOf((int) Math.round((length / Math.pow(60.0d, 0.0d)) - ((double) (numValueOf2.intValue() * 60))))));
                        return;
                    }
                    return;
