...
public class QuickTimeMetadataDirectory extends QuickTimeDirectory {
    ...
    static {
        ...
        map2.put("apID", 1037);
        map2.put("atID", 1038);
        map2.put("auth", Integer.valueOf(PhotoshopDirectory.TAG_ICC_PROFILE_BYTES));
        map2.put("catg", 1040);
        ...
        map2.put("egid", 1048);
        map2.put("geID", Integer.valueOf(PhotoshopDirectory.TAG_GLOBAL_ALTITUDE));
        map2.put("gnre", Integer.valueOf(PhotoshopDirectory.TAG_SLICES));
        map2.put("grup", Integer.valueOf(PhotoshopDirectory.TAG_WORKFLOW_URL));
        map2.put("gshh", Integer.valueOf(PhotoshopDirectory.TAG_JUMP_TO_XPEP));
        map2.put("gspm", Integer.valueOf(PhotoshopDirectory.TAG_ALPHA_IDENTIFIERS));
        ...
        map.put(Integer.valueOf(PhotoshopDirectory.TAG_GLOBAL_ALTITUDE), "Genre ID");
        map.put(Integer.valueOf(PhotoshopDirectory.TAG_SLICES), "Genre");
        map.put(Integer.valueOf(PhotoshopDirectory.TAG_WORKFLOW_URL), "Grouping");
        map.put(Integer.valueOf(PhotoshopDirectory.TAG_JUMP_TO_XPEP), "Google Host Header");
        map.put(Integer.valueOf(PhotoshopDirectory.TAG_ALPHA_IDENTIFIERS), "Google Ping Message");
        map.put(Integer.valueOf(PhotoshopDirectory.TAG_URL_LIST), "Google Ping URL");
        map.put(1055, "Google Source Data");
