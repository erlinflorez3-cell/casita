...
public class ViewStyle extends BundledStyle {
    ...
    public static abstract class BaseBuilder<T extends ViewStyle, B extends BaseBuilder<T, B>> extends BundledStyle.Builder<T> {
        ...
        public B setBackgroundColor(int i2) {
            this.mBundle.putInt(ViewStyle.KEY_BACKGROUND_COLOR, i2);
            return (B) getThis();
        }

        public B setPadding(int i2, int i3, int i4, int i5) {
            this.mBundle.putIntArray("padding", new int[]{i2, i3, i4, i5});
            return (B) getThis();
        }

        public B setLayoutMargin(int i2, int i3, int i4, int i5) {
            this.mBundle.putIntArray(ViewStyle.KEY_LAYOUT_MARGIN, new int[]{i2, i3, i4, i5});
            return (B) getThis();
        }
    }
