...
@InterfaceC1492Gx
@Metadata(bv = {}, d1 = {"Я\u0010\u001d̉=!4i\bDZc|\u0004G\tP&<Ȑ\u0017(<\u0014\b\u0007\u0015jg/ǲiT6ɟc,\u0015l\n6<]*tQ?ڎ\u001e\u0003"}, d2 = {"\u001anR._\u0013BT\u0019|\u000f\\3|rAn\u007f5", "\u001a`]1e6BR,Hxh4\b\u0013=eI5\fI\u0010\u001b\u001fG9xI\u000169Xy\u001d>ms8UNEy8-\u0019rj \u0011a(UL", "\u001a`]1e6BR,H\u0002b-|\u0007Cc\u0007(E'\u0005\u0018\u0017E\u0004\fCv\u000fGb}-\r", "5dc\u0019b*:Z\u007f\u0003{^*\u0011\u00076ei:\u0005@\u000eU\u0013Px\u0018Kr49c\u0007.", "u(E", "5dc\u0019b*:Z\u007f\u0003{^*\u0011\u00076ei:\u0005@\u000e", "u(;.a+K]\u001d}\u000e(*\u0007\u0011:o\u000e(EM\u0011 &Kw\u000e\u0006a2?j\u0002\u001f3j\u001d.+MCv>,\u0019weC\u0010J6Lr.\u001d", ":hU2V@<Z\u0019F\bn5\f\r7eG&\u0006H\f!%Gi\u001b<}%1g}"}, k = 2, mv = {1, 8, 0}, pn = "", xi = 48, xs = "")
public final class LocalLifecycleOwnerKt {
    ...
    static {
        ...
        try {
            ...
            int length = annotationArrKX.length;
            int i2 = 0;
            while (true) {
                if (i2 < length) {
                    if (annotationArrKX[i2] instanceof Deprecated) {
                        break;
                    } else {
                        i2++;
                    }
            ...
            objM8980constructorimpl = Result.m8980constructorimpl(providableCompositionLocal);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            objM8980constructorimpl = Result.m8980constructorimpl(ResultKt.createFailure(th));
        }
        ProvidableCompositionLocal<LifecycleOwner> providableCompositionLocalStaticCompositionLocalOf = (ProvidableCompositionLocal) (Result.m8986isFailureimpl(objM8980constructorimpl) ? null : objM8980constructorimpl);
