...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    public void display() {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            if (variable != null) {
                System.out.print(variable + " = " + getVariableValue(i3) + Global.BLANK);
            }
        }
        System.out.println(" }");
    }
    ...
    public String toString() {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            SolverVariable variable = getVariable(i3);
            if (variable != null) {
                String str4 = str3 + variable + " = " + getVariableValue(i3) + Global.BLANK;
    ...
    private void displayHash() {
        for (int i2 = 0; i2 < this.HASH_SIZE; i2++) {
            if (this.keys[i2] != -1) {
                ...
                boolean z2 = false;
                while (!z2) {
                    str = str + Global.BLANK + this.variables[i3];
