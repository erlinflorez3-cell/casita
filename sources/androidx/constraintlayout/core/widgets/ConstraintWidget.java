...
public class ConstraintWidget {
    ...
    public boolean hasResolvedTargets(int i2, int i3) {
        return i2 == 0 ? this.mLeft.mTarget != null && this.mLeft.mTarget.hasFinalValue() && this.mRight.mTarget != null && this.mRight.mTarget.hasFinalValue() && (this.mRight.mTarget.getFinalValue() - this.mRight.getMargin()) - (this.mLeft.mTarget.getFinalValue() + this.mLeft.getMargin()) >= i3 : this.mTop.mTarget != null && this.mTop.mTarget.hasFinalValue() && this.mBottom.mTarget != null && this.mBottom.mTarget.hasFinalValue() && (this.mBottom.mTarget.getFinalValue() - this.mBottom.getMargin()) - (this.mTop.mTarget.getFinalValue() + this.mTop.getMargin()) >= i3;
        return false;
    }
    ...
    private void serializeSize(StringBuilder sb, String str, int i2, int i3, int i4, int i5, int i6, int i7, float f2, float f3) {
        sb.append(str);
        sb.append(" :  {\n");
        serializeAttribute(sb, RRWebVideoEvent.JsonKeys.SIZE, i2, Integer.MIN_VALUE);
        serializeAttribute(sb, MetricSummary.JsonKeys.MIN, i3, 0);
        serializeAttribute(sb, MetricSummary.JsonKeys.MAX, i4, Integer.MAX_VALUE);
    ...
    public String toString() {
        return (this.mType != null ? "type: " + this.mType + Global.BLANK : "") + (this.mDebugName != null ? "id: " + this.mDebugName + Global.BLANK : "") + "(" + this.mX + ", " + this.mY + ") - (" + this.mWidth + " x " + this.mHeight + ")";
    }
    ...
    /* JADX WARN: Path cross not found for [B:35:0x0079, B:19:0x0039], limit reached: 47 */
    /* JADX WARN: Path cross not found for [B:38:0x0088, B:28:0x005b], limit reached: 47 */
    ...
    */
    public void setDimensionRatio(java.lang.String r9) {
        ...
        Lc:
            ...
            int r0 = r7 + (-1)
            if (r6 >= r0) goto L2e
            java.lang.String r1 = r9.substring(r2, r6)
        ...
        L5b:
            ...
            float r1 = java.lang.Float.parseFloat(r1)     // Catch: java.lang.NumberFormatException -> L88
            ...
            if (r3 != r5) goto L73
            float r1 = r1 / r2
            float r1 = java.lang.Math.abs(r1)     // Catch: java.lang.NumberFormatException -> L88
            goto L89
        L73:
            float r2 = r2 / r1
            float r1 = java.lang.Math.abs(r2)     // Catch: java.lang.NumberFormatException -> L88
            goto L89
        L79:
        ...
        L89:
            int r0 = (r1 > r4 ? 1 : (r1 == r4 ? 0 : -1))
            if (r0 <= 0) goto L91
            r8.mDimensionRatio = r1
            r8.mDimensionRatioSide = r3
        L91:
            return
        */
    ...
    public ConstraintWidget getPreviousChainMember(int i2) {
        ...
        if (i2 != 1 || this.mTop.mTarget == null) {
            return null;
        }
    ...
    public ConstraintWidget getNextChainMember(int i2) {
        ...
        if (i2 != 1 || this.mBottom.mTarget == null) {
            return null;
        }
    ...
    /* JADX WARN: Type inference failed for: r1v26, types: [androidx.constraintlayout.core.widgets.ConstraintWidget] */
    /* JADX WARN: Type inference failed for: r1v32, types: [androidx.constraintlayout.core.widgets.ConstraintWidget] */
    ...
    /* JADX WARN: Type inference failed for: r71v0, types: [androidx.constraintlayout.core.widgets.ConstraintWidget] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void addToSolver(androidx.constraintlayout.core.LinearSystem r72, boolean r73) {
        /*
    ...
    /* JADX WARN: Removed duplicated region for block: B:269:0x0392 A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:353:0x0495  */
    ...
    */
    ...
    public void updateFromRuns(boolean z2, boolean z3) {
        ...
        boolean z4 = (-1) - (((-1) - (z3 ? 1 : 0)) | ((-1) - (this.verticalRun.isResolved() ? 1 : 0))) == 1;
