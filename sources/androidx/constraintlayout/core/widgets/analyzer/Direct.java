...
public class Direct {
    ...
    private static void horizontalSolvingPass(int i2, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, boolean z2) {
        ...
        if (anchor.getDependents() != null && anchor.hasFinalValue()) {
            for (ConstraintAnchor constraintAnchor : anchor.getDependents()) {
                ...
                if ((constraintAnchor != constraintWidget2.mLeft || constraintWidget2.mRight.mTarget == null || !constraintWidget2.mRight.mTarget.hasFinalValue()) && (constraintAnchor != constraintWidget2.mRight || constraintWidget2.mLeft.mTarget == null || !constraintWidget2.mLeft.mTarget.hasFinalValue())) {
                    z3 = false;
                }
        ...
        if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
            for (ConstraintAnchor constraintAnchor2 : anchor2.getDependents()) {
                ...
                if ((constraintAnchor2 != constraintWidget3.mLeft || constraintWidget3.mRight.mTarget == null || !constraintWidget3.mRight.mTarget.hasFinalValue()) && (constraintAnchor2 != constraintWidget3.mRight || constraintWidget3.mLeft.mTarget == null || !constraintWidget3.mLeft.mTarget.hasFinalValue())) {
                    z4 = false;
                }
    ...
    private static void verticalSolvingPass(int i2, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer) {
        ...
        if (anchor.getDependents() != null && anchor.hasFinalValue()) {
            ...
            while (it.hasNext()) {
                ...
                boolean z2 = (next == constraintWidget2.mTop && constraintWidget2.mBottom.mTarget != null && constraintWidget2.mBottom.mTarget.hasFinalValue()) || (next == constraintWidget2.mBottom && constraintWidget2.mTop.mTarget != null && constraintWidget2.mTop.mTarget.hasFinalValue());
        ...
        if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
            ...
            while (it2.hasNext()) {
                ...
                boolean z3 = (next2 == constraintWidget3.mTop && constraintWidget3.mBottom.mTarget != null && constraintWidget3.mBottom.mTarget.hasFinalValue()) || (next2 == constraintWidget3.mBottom && constraintWidget3.mTop.mTarget != null && constraintWidget3.mTop.mTarget.hasFinalValue());
    ...
    */
    public static boolean solveChain(androidx.constraintlayout.core.widgets.ConstraintWidgetContainer r19, androidx.constraintlayout.core.LinearSystem r20, int r21, int r22, androidx.constraintlayout.core.widgets.ChainHead r23, boolean r24, boolean r25, boolean r26) {
        /*
