...
public class VerticalWidgetRun extends WidgetRun {
    ...
    public void update(Dependency dependency) {
        ...
        if (this.dimension.readyToSolve && !this.dimension.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            int i4 = this.widget.mMatchConstraintDefaultHeight;
            if (i4 != 2) {
                if (i4 == 3 && this.widget.horizontalRun.dimension.resolved) {
        ...
        if (this.start.readyToSolve && this.end.readyToSolve) {
            ...
            if (!this.dimension.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && this.matchConstraintsType == 1 && this.start.targets.size() > 0 && this.end.targets.size() > 0) {
                ...
                int i7 = (this.end.targets.get(0).value + this.end.margin) - (dependencyNode3.value + this.start.margin);
                if (i7 < this.dimension.wrapValue) {
            ...
            if (this.dimension.resolved && this.start.targets.size() > 0 && this.end.targets.size() > 0) {
                ...
                this.start.resolve((int) (i8 + 0.5f + (((i9 - i8) - this.dimension.value) * verticalBiasPercent)));
    ...
    void apply() {
        ...
        if (!this.dimension.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            if (i2 != 2) {
                if (i2 == 3 && !this.widget.isInVerticalChain() && this.widget.mMatchConstraintDefaultWidth != 3) {
