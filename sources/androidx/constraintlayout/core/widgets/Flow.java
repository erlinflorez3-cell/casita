...
public class Flow extends VirtualLayout {
    ...
    public void measure(int i2, int i3, int i4, int i5) {
        ...
        if (i12 != 0) {
            ...
            z2 = true;
            if (i12 == 1) {
                measureChainWrap(constraintWidgetArr, i10, this.mOrientation, i6, iArr);
            } else if (i12 == 2) {
                measureAligned(constraintWidgetArr, i10, this.mOrientation, i6, iArr);
            } else if (i12 == 3) {
                measureChainWrap_new(constraintWidgetArr, i10, this.mOrientation, i6, iArr);
            }
        } else {
            z2 = true;
            measureNoWrap(constraintWidgetArr, i10, this.mOrientation, i6, iArr);
        }
    ...
    private void measureChainWrap(ConstraintWidget[] constraintWidgetArr, int i2, int i3, int i4, int[] iArr) {
        ...
        int i8 = i3;
        WidgetsList widgetsList = new WidgetsList(i8, this.mLeft, this.mTop, this.mRight, this.mBottom, i4);
        ...
        if (i8 == 0) {
            ...
            for (int i10 = 0; i10 < i2; i10++) {
                ...
                if (!z2 && i10 > 0 && (i7 = this.mMaxElementsWrap) > 0 && i10 % i7 == 0) {
                    z2 = true;
                }
                if (z2) {
                    widgetsList = new WidgetsList(i8, this.mLeft, this.mTop, this.mRight, this.mBottom, i4);
            ...
            for (int i12 = 0; i12 < i2; i12++) {
                ...
                boolean z3 = (i11 == i4 || (this.mVerticalGap + i11) + widgetHeight > i4) && widgetsList.biggest != null;
        ...
        int i14 = 0;
        while (i14 < size) {
            WidgetsList widgetsList3 = this.mChainList.get(i14);
            if (i8 == 0) {
                if (i14 < size - 1) {
                    constraintAnchor5 = this.mChainList.get(i14 + 1).biggest.mTop;
                    paddingBottom = 0;
                } else {
                    constraintAnchor5 = this.mBottom;
                    paddingBottom = getPaddingBottom();
                }
                ConstraintAnchor constraintAnchor6 = widgetsList3.biggest.mBottom;
                ConstraintAnchor constraintAnchor7 = constraintAnchor2;
                constraintAnchor = constraintAnchor4;
                widgetsList3.setup(i8, constraintAnchor7, constraintAnchor3, constraintAnchor, constraintAnchor5, paddingLeft, paddingTop, paddingRight2, paddingBottom, i4);
                width = Math.max(width, widgetsList3.getWidth());
                iMax += widgetsList3.getHeight();
                if (i14 > 0) {
                ...
                ConstraintAnchor constraintAnchor8 = widgetsList3.biggest.mRight;
                i8 = i8;
                paddingTop = paddingTop;
                paddingRight2 = paddingRight;
                paddingBottom = paddingBottom;
                widgetsList3.setup(i8, constraintAnchor2, constraintAnchor3, constraintAnchor, constraintAnchor5, paddingLeft, paddingTop, paddingRight2, paddingBottom, i4);
                width += widgetsList3.getWidth();
                iMax = Math.max(iMax, widgetsList3.getHeight());
                if (i14 > 0) {
    ...
    private void measureChainWrap_new(ConstraintWidget[] constraintWidgetArr, int i2, int i3, int i4, int[] iArr) {
        ...
        if (i8 == 0) {
            ...
            while (i11 < i2) {
                ...
                if (!z2 && i11 > 0 && (i7 = this.mMaxElementsWrap) > 0 && i9 > i7) {
                    z2 = true;
                }
                if (z2) {
                    widgetsList = new WidgetsList(i8, this.mLeft, this.mTop, this.mRight, this.mBottom, i4);
            ...
            for (int i13 = 0; i13 < i2; i13++) {
                ...
                if (!z3 && i13 > 0 && (i6 = this.mMaxElementsWrap) > 0 && i6 < 0) {
                    z3 = true;
                }
                if (z3) {
                    widgetsList = new WidgetsList(i8, this.mLeft, this.mTop, this.mRight, this.mBottom, i4);
        ...
        while (i15 < size) {
            ...
            if (i8 == 0) {
                if (i15 < size - 1) {
                    constraintAnchor5 = this.mChainList.get(i15 + 1).biggest.mTop;
                    paddingBottom = 0;
                } else {
                    constraintAnchor5 = this.mBottom;
                    paddingBottom = getPaddingBottom();
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:93:0x00f1 -> B:37:0x0053). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:94:0x00f3 -> B:37:0x0053). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:96:0x00f9 -> B:37:0x0053). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:97:0x00fb -> B:37:0x0053). Please report as a decompilation issue!!! */
    /*
