...
public class MotionLabel extends View implements FloatLayout {
    ...
    public MotionLabel(Context context) throws Throwable {
        super(context);
    ...
    public MotionLabel(Context context, AttributeSet attrs) throws Throwable {
        super(context, attrs);
        this.mPaint = new TextPaint();
        this.mPath = new Path();
        this.mTextFillColor = 65535;
    ...
    public MotionLabel(Context context, AttributeSet attrs, int defStyleAttr) throws Throwable {
    ...
    private void init(Context context, AttributeSet attrs) throws Throwable {
        ...
        if (attrs != null) {
            ...
            Class<?> cls = Class.forName(C1561oA.Qd("?K@MIB<\u00059DBG7?D|\u0011<:?/A<", (short) (OY.Xd() ^ 1833)));
            Class<?>[] clsArr = new Class[2];
            short sXd = (short) (FB.Xd() ^ 6741);
            short sXd2 = (short) (FB.Xd() ^ 3599);
            int[] iArr2 = new int["4B9HFA=\bPPFJ\r!UVUMG[[M<O_".length()];
            QB qb = new QB("4B9HFA=\bPPFJ\r!UVUMG[[M<O_");
            int i2 = 0;
            while (qb.YK()) {
                int iKK = qb.KK();
                Xu xuXd = Xu.Xd(iKK);
            ...
            Method method = cls.getMethod(C1561oA.od("{m~jquYy}ogeAsroe]om]j", (short) (OY.Xd() ^ 21672)), clsArr);
            try {
                ...
                for (int i3 = 0; i3 < indexCount; i3++) {
                    ...
                    if (index == R.styleable.MotionLabel_android_text) {
                        ...
                        this.mBaseTextSize = typedArray.getDimensionPixelSize(index, (int) this.mBaseTextSize);
                    } else if (index == R.styleable.MotionLabel_android_textSize) {
                        this.mTextSize = typedArray.getDimensionPixelSize(index, (int) this.mTextSize);
                    } else if (index == R.styleable.MotionLabel_android_textStyle) {
                        this.mStyleIndex = typedArray.getInt(index, this.mStyleIndex);
                    } else if (index == R.styleable.MotionLabel_android_typeface) {
                        this.mTypefaceIndex = typedArray.getInt(index, this.mTypefaceIndex);
                    } else if (index == R.styleable.MotionLabel_android_textColor) {
                        this.mTextFillColor = typedArray.getColor(index, this.mTextFillColor);
                    } else if (index == R.styleable.MotionLabel_borderRound) {
                        this.mRound = typedArray.getDimension(index, this.mRound);
                        setRound(this.mRound);
                    } else if (index == R.styleable.MotionLabel_borderRoundPercent) {
                        this.mRoundPercent = typedArray.getFloat(index, this.mRoundPercent);
                        setRoundPercent(this.mRoundPercent);
                    } else if (index == R.styleable.MotionLabel_android_gravity) {
                        setGravity(typedArray.getInt(index, -1));
                    } else if (index == R.styleable.MotionLabel_android_autoSizeTextType) {
                        this.mAutoSizeTextType = typedArray.getInt(index, 0);
                    } else if (index == R.styleable.MotionLabel_textOutlineColor) {
                        this.mTextOutlineColor = typedArray.getInt(index, this.mTextOutlineColor);
                        this.mUseOutline = true;
                    } else if (index == R.styleable.MotionLabel_textOutlineThickness) {
                        this.mTextOutlineThickness = typedArray.getDimension(index, this.mTextOutlineThickness);
                        this.mUseOutline = true;
                    } else if (index == R.styleable.MotionLabel_textBackground) {
                        this.mTextBackground = typedArray.getDrawable(index);
                        this.mUseOutline = true;
                    } else if (index == R.styleable.MotionLabel_textBackgroundPanX) {
                        this.mBackgroundPanX = typedArray.getFloat(index, this.mBackgroundPanX);
                    } else if (index == R.styleable.MotionLabel_textBackgroundPanY) {
                        this.mBackgroundPanY = typedArray.getFloat(index, this.mBackgroundPanY);
                    } else if (index == R.styleable.MotionLabel_textPanX) {
                        this.mTextPanX = typedArray.getFloat(index, this.mTextPanX);
                    } else if (index == R.styleable.MotionLabel_textPanY) {
                        this.mTextPanY = typedArray.getFloat(index, this.mTextPanY);
                    } else if (index == R.styleable.MotionLabel_textBackgroundRotate) {
                        this.mRotate = typedArray.getFloat(index, this.mRotate);
                    } else if (index == R.styleable.MotionLabel_textBackgroundZoom) {
                        this.mZoom = typedArray.getFloat(index, this.mZoom);
                    } else if (index == R.styleable.MotionLabel_textureHeight) {
                        this.mTextureHeight = typedArray.getDimension(index, this.mTextureHeight);
                    } else if (index == R.styleable.MotionLabel_textureWidth) {
                        this.mTextureWidth = typedArray.getDimension(index, this.mTextureWidth);
                    } else if (index == R.styleable.MotionLabel_textureEffect) {
                        this.mTextureEffect = typedArray.getInt(index, this.mTextureEffect);
                    }
                }
                typedArray.recycle();
    ...
    private void adjustTexture(float l2, float t2, float r2, float b2) {
        if (this.mTextShaderMatrix == null) {
            return;
        }
        this.mFloatWidth = r2 - l2;
        this.mFloatHeight = b2 - t2;
        updateShaderMatrix();
    }

    public void setGravity(int gravity) {
        if ((-1) - (((-1) - gravity) | ((-1) - GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK)) == 0) {
            gravity |= GravityCompat.START;
        }
        if ((gravity + PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION) - (112 | gravity) == 0) {
            gravity = (gravity + 48) - (gravity & 48);
        }
        if (gravity != this.mGravity) {
            invalidate();
        }
        this.mGravity = gravity;
        int i2 = (-1) - (((-1) - gravity) | ((-1) - PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION));
        if (i2 == 48) {
            this.mTextPanY = -1.0f;
        } else if (i2 == 80) {
            this.mTextPanY = 1.0f;
        ...
        int i3 = (-1) - (((-1) - gravity) | ((-1) - GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK));
        if (i3 != 3) {
            if (i3 != 5) {
                if (i3 != 8388611) {
                    if (i3 != 8388613) {
    ...
    private void setUpTheme(Context context, AttributeSet attrs) throws Throwable {
        TypedValue typedValue = new TypedValue();
        Object[] objArr = new Object[0];
        Method method = Class.forName(C1561oA.Kd("\r\u001b\u0012!\u001f\u001a\u0016`\u0017$$+\u001d'.h~,,3%96", (short) (C1633zX.Xd() ^ (-573)))).getMethod(Wg.Zd("Z{\n\u000b\u001e:A\\", (short) (C1580rY.Xd() ^ (-29782)), (short) (C1580rY.Xd() ^ (-32519))), new Class[0]);
        try {
            method.setAccessible(true);
            ((Resources.Theme) method.invoke(context, objArr)).resolveAttribute(androidx.appcompat.R.attr.colorPrimary, typedValue, true);
            TextPaint textPaint = this.mPaint;
    ...
    void buildShape(float scale) {
        if (this.mUseOutline || scale != 1.0f) {
            ...
            if (scale != 1.0f) {
                String str2 = TAG;
                String str3 = Debug.getLoc() + " scale " + scale;
    ...
    public void layout(int l2, int t2, int r2, int b2) {
        ...
        if (this.mUseOutline || !zIsNaN) {
            adjustTexture(l2, t2, r2, b2);
            buildShape(f2);
        }
    }

    @Override // androidx.constraintlayout.motion.widget.FloatLayout
    public void layout(float l2, float t2, float r2, float b2) {
        int i2 = (int) (l2 + 0.5f);
    ...
    private void setTypefaceFromAttrs(String familyName, int typefaceIndex, int styleIndex) {
        ...
        if (styleIndex > 0) {
            ...
            int i2 = (-1) - (((-1) - (~(typefaceCreate2 != null ? typefaceCreate2.getStyle() : 0))) | ((-1) - styleIndex));
            this.mPaint.setFakeBoldText((i2 + 1) - (1 | i2) != 0);
            this.mPaint.setTextSkewX((-1) - (((-1) - i2) | ((-1) - 2)) != 0 ? -0.25f : 0.0f);
            return;
        }
    ...
    public void setTextSize(float size) {
        this.mTextSize = size;
        String str = TAG;
        String str2 = Debug.getLoc() + "  " + size + " / " + this.mBaseTextSize;
        TextPaint textPaint = this.mPaint;
