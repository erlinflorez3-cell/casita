...
public class KeyCycle extends Key {
    ...
    public void load(Context context, AttributeSet attrs) throws Throwable {
        int[] iArr = R.styleable.KeyCycle;
        short sXd = (short) (Od.Xd() ^ (-26319));
        short sXd2 = (short) (Od.Xd() ^ (-5317));
        int[] iArr2 = new int["cVd$[\u0004lL-L}QbIK\u0013q>~&G5l".length()];
        QB qb = new QB("cVd$[\u0004lL-L}QbIK\u0013q>~&G5l");
        int i2 = 0;
        while (qb.YK()) {
            int iKK = qb.KK();
            Xu xuXd = Xu.Xd(iKK);
        ...
        Class<?>[] clsArr = {Class.forName(Ig.wd("4pTQUyV\u000f\u000f4!L>M+Kon\u001e\u0007>y\u0014$?", (short) (C1633zX.Xd() ^ (-3530)))), int[].class};
        Object[] objArr = {attrs, iArr};
        short sXd3 = (short) (OY.Xd() ^ 11476);
        int[] iArr3 = new int["e BQ4e0D'ylQy+\u0007f+\u0016p\f<\u001e".length()];
        QB qb2 = new QB("e BQ4e0D'ylQy+\u0007f+\u0016p\f<\u001e");
        int i3 = 0;
        while (qb2.YK()) {
            int iKK2 = qb2.KK();
            Xu xuXd2 = Xu.Xd(iKK2);
    ...
    /* JADX WARN: Failed to restore switch over string. Please report as a decompilation issue */
    @Override // androidx.constraintlayout.motion.widget.Key
    public void addValues(HashMap<String, ViewSpline> splines) throws Throwable {
