...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public MotionLayout(Context context) throws Throwable {
        super(context);
    ...
    public MotionLayout(Context context, AttributeSet attrs) throws Throwable {
        super(context, attrs);
        this.mProgressInterpolator = null;
        this.mLastVelocity = 0.0f;
        this.mBeginState = -1;
    ...
    public MotionLayout(Context context, AttributeSet attrs, int defStyleAttr) throws Throwable {
    ...
    void setState(TransitionState newState) {
        ...
        int i2 = AnonymousClass5.$SwitchMap$androidx$constraintlayout$motion$widget$MotionLayout$TransitionState[transitionState.ordinal()];
        if (i2 == 1 || i2 == 2) {
        ...
        if (i2 != 3 || newState != TransitionState.FINISHED) {
            return;
        }
        fireTransitionCompleted();
    }
    ...
    public void setTransition(int transitionId) {
        ...
        if (this.mScene != null) {
            ...
            if (i2 == this.mBeginState) {
                ...
                f2 = i2 == this.mEndState ? 1.0f : Float.NaN;
            }
    ...
    */
    ...
    void animateTo(float position) {
        ...
        this.mTemporalInterpolator = false;
        this.mTransitionGoalPosition = position;
        this.mTransitionDuration = r4.getDuration() / 1000.0f;
    ...
    public void getViewVelocity(View view, float posOnViewX, float posOnViewY, float[] returnVelocity, int type) {
        ...
        if (this.mInterpolator != null) {
            float fSignum = Math.signum(this.mTransitionGoalPosition - interpolation);
    ...
    class Model {
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            String strConcat2;
            String strConcat3;
            StringBuilder sb = new StringBuilder(Global.BLANK);
            ...
            String str3 = str + sbAppend3.append(strConcat4).toString() + " ---  " + child;
        }

        private void debugLayout(String title, ConstraintWidgetContainer c2) {
            String str = title + Global.BLANK + Debug.getName((View) c2.getCompanionWidget());
            String str2 = str + "  ========= " + c2;
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                String str4 = Global.UNDERSCORE;
                StringBuilder sbAppend = new StringBuilder().append(((constraintAnchor != null ? ExifInterface.GPS_DIRECTION_TRUE : Global.UNDERSCORE) + (constraintWidget.mBottom.mTarget != null ? "B" : Global.UNDERSCORE)) + (constraintWidget.mLeft.mTarget != null ? "L" : Global.UNDERSCORE));
                if (constraintWidget.mRight.mTarget != null) {
                    str4 = "R";
                }
                String string = sbAppend.append(str4).toString();
                View view = (View) constraintWidget.getCompanionWidget();
                String name = Debug.getName(view);
                if (view instanceof TextView) {
                    name = name + "(" + ((Object) ((TextView) view).getText()) + ")";
                }
                String str5 = str3 + "  " + name + Global.BLANK + constraintWidget + Global.BLANK + string;
            }
            String str6 = str + " done. ";
        }
        ...
        public void measure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            int i2 = MotionLayout.this.mStartWrapWidth;
            int i3 = MotionLayout.this.mStartWrapHeight;
            if (MotionLayout.this.mWidthMeasureMode == Integer.MIN_VALUE || MotionLayout.this.mWidthMeasureMode == 0) {
                i2 = (int) (MotionLayout.this.mStartWrapWidth + (MotionLayout.this.mPostInterpolationPosition * (MotionLayout.this.mEndWrapWidth - MotionLayout.this.mStartWrapWidth)));
            }
            if (MotionLayout.this.mHeightMeasureMode == Integer.MIN_VALUE || MotionLayout.this.mHeightMeasureMode == 0) {
                i3 = (int) (MotionLayout.this.mStartWrapHeight + (MotionLayout.this.mPostInterpolationPosition * (MotionLayout.this.mEndWrapHeight - MotionLayout.this.mStartWrapHeight)));
            }
            ...
            MotionLayout.this.resolveMeasuredDimension(widthMeasureSpec, heightMeasureSpec, i2, i3, z3, z2);
        }
        ...
        private void computeStartEndSize(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (MotionLayout.this.mCurrentState == MotionLayout.this.getStartState()) {
                ...
                int i2 = (constraintSet == null || constraintSet.mRotate == 0) ? widthMeasureSpec : heightMeasureSpec;
                ConstraintSet constraintSet2 = this.mEnd;
                motionLayout.resolveSystem(constraintWidgetContainer, optimizationLevel, i2, (constraintSet2 == null || constraintSet2.mRotate == 0) ? heightMeasureSpec : widthMeasureSpec);
                ConstraintSet constraintSet3 = this.mStart;
                if (constraintSet3 != null) {
                    MotionLayout motionLayout2 = MotionLayout.this;
                    ConstraintWidgetContainer constraintWidgetContainer2 = this.mLayoutStart;
                    int i3 = constraintSet3.mRotate == 0 ? widthMeasureSpec : heightMeasureSpec;
                    if (this.mStart.mRotate == 0) {
                        widthMeasureSpec = heightMeasureSpec;
                    }
                    motionLayout2.resolveSystem(constraintWidgetContainer2, optimizationLevel, i3, widthMeasureSpec);
                    return;
                }
                return;
            }
            ...
            int i4 = (constraintSet5 == null || constraintSet5.mRotate == 0) ? widthMeasureSpec : heightMeasureSpec;
            ConstraintSet constraintSet6 = this.mEnd;
            if (constraintSet6 == null || constraintSet6.mRotate == 0) {
                widthMeasureSpec = heightMeasureSpec;
            }
            motionLayout3.resolveSystem(constraintWidgetContainer3, optimizationLevel, i4, widthMeasureSpec);
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        boolean z2 = false;
        boolean z3 = (this.mLastWidthMeasureSpec == widthMeasureSpec && this.mLastHeightMeasureSpec == heightMeasureSpec) ? false : true;
        ...
        if (this.mMeasureDuringTransition || z2) {
            ...
            if (i2 == Integer.MIN_VALUE || i2 == 0) {
                width = (int) (this.mStartWrapWidth + (this.mPostInterpolationPosition * (this.mEndWrapWidth - r3)));
                requestLayout();
            }
            int i3 = this.mHeightMeasureMode;
            if (i3 == Integer.MIN_VALUE || i3 == 0) {
                height = (int) (this.mStartWrapHeight + (this.mPostInterpolationPosition * (this.mEndWrapHeight - r3)));
                requestLayout();
            }
                ...
                if (transition.getTouchResponse() != null && (transition.getTouchResponse().getFlags() & 1) != 0) {
                    ...
                    if ((f3 <= 0.0f && progressDirection < 0.0f) || (f3 >= 1.0f && progressDirection > 0.0f)) {
                        ...
                        target.post(new Runnable(this) { // from class: androidx.constraintlayout.motion.widget.MotionLayout.3
                            ...
                            AnonymousClass3(MotionLayout this, View target2) {
                                val$target = target2;
                            }
    ...
    /* JADX INFO: renamed from: androidx.constraintlayout.motion.widget.MotionLayout$3 */
    ...
    private class DevModeDraw {
        ...
        public DevModeDraw() throws Throwable {
            ...
            Context context = MotionLayout.this.getContext();
            short sXd = (short) (C1499aX.Xd() ^ (-8066));
            short sXd2 = (short) (C1499aX.Xd() ^ (-11997));
            int[] iArr = new int["f/J@b\u001a8kD\u00122 2\u001d*I\u0002k0]4fD".length()];
            QB qb = new QB("f/J@b\u001a8kD\u00122 2\u001d*I\u0002k0]4fD");
            int i2 = 0;
            while (qb.YK()) {
                int iKK = qb.KK();
                Xu xuXd = Xu.Xd(iKK);
            ...
            Method method = Class.forName(new String(iArr, 0, i2)).getMethod(ZO.xd("f\u0003\u007f[Zd\"j_\u0005C\u0003", (short) (Od.Xd() ^ (-3077)), (short) (Od.Xd() ^ (-25629))), new Class[0]);
            try {
        ...
        public void draw(Canvas canvas, HashMap<View, MotionController> frameArrayList, int duration, int debugPath) throws Throwable {
            if (frameArrayList != null && frameArrayList.size() != 0) {
                canvas.save();
                if (!MotionLayout.this.isInEditMode() && (-1) - (((-1) - debugPath) | ((-1) - 1)) == 2) {
                    StringBuilder sb = new StringBuilder();
                    Context context = MotionLayout.this.getContext();
                    Object[] objArr = new Object[0];
                    Method method = Class.forName(C1626yg.Ud(",$\u0013\"YT\u001c9\t\u0014pYY[9!c\nP\\,\u001ed", (short) (Od.Xd() ^ (-23746)), (short) (Od.Xd() ^ (-6738)))).getMethod(Ig.wd("\u0012>\f\u0002t]5\fUR~f", (short) (C1499aX.Xd() ^ (-11910))), new Class[0]);
                    try {
                        method.setAccessible(true);
                        String string = sb.append(((Resources) method.invoke(context, objArr)).getResourceName(MotionLayout.this.mEndState)).append(EO.Od("\u001e", (short) (C1633zX.Xd() ^ (-31977)))).append(MotionLayout.this.getProgress()).toString();
        ...
        private void drawPathRelativeTicks(Canvas canvas, float x2, float y2) {
            float[] fArr = this.mPoints;
            float f2 = fArr[0];
            float f3 = fArr[1];
            ...
            float f6 = f4 - f2;
            float f7 = f5 - f3;
            float f8 = (((x2 - f2) * f6) + ((y2 - f3) * f7)) / (fHypot * fHypot);
            float f9 = f2 + (f6 * f8);
            float f10 = f3 + (f8 * f7);
            Path path = new Path();
            path.moveTo(x2, y2);
            path.lineTo(f9, f10);
            float fHypot2 = (float) Math.hypot(f9 - x2, f10 - y2);
            ...
            canvas.drawLine(x2, y2, f9, f10, this.mPaintGraph);
        }
        ...
        private void drawPathCartesianTicks(Canvas canvas, float x2, float y2) {
            float[] fArr = this.mPoints;
            float f2 = fArr[0];
            float f3 = fArr[1];
            float f4 = fArr[fArr.length - 2];
            ...
            float fMin2 = x2 - Math.min(f2, f4);
            float fMax2 = Math.max(f3, f5) - y2;
            String str = "" + (((int) (((double) ((fMin2 * 100.0f) / Math.abs(f4 - f2))) + 0.5d)) / 100.0f);
            getTextBounds(str, this.mTextPaint);
            canvas.drawText(str, ((fMin2 / 2.0f) - (this.mBounds.width() / 2)) + fMin, y2 - 20.0f, this.mTextPaint);
            canvas.drawLine(x2, y2, Math.min(f2, f4), y2, this.mPaintGraph);
            String str2 = "" + (((int) (((double) ((fMax2 * 100.0f) / Math.abs(f5 - f3))) + 0.5d)) / 100.0f);
            getTextBounds(str2, this.mTextPaint);
            canvas.drawText(str2, x2 + 5.0f, fMax - ((fMax2 / 2.0f) - (this.mBounds.height() / 2)), this.mTextPaint);
            canvas.drawLine(x2, y2, x2, Math.max(f3, f5), this.mPaintGraph);
        }

        private void drawPathScreenTicks(Canvas canvas, float x2, float y2, int viewWidth, int viewHeight) {
            String str = "" + (((int) (((double) (((x2 - (viewWidth / 2)) * 100.0f) / (MotionLayout.this.getWidth() - viewWidth))) + 0.5d)) / 100.0f);
            getTextBounds(str, this.mTextPaint);
            canvas.drawText(str, ((x2 / 2.0f) - (this.mBounds.width() / 2)) + 0.0f, y2 - 20.0f, this.mTextPaint);
            canvas.drawLine(x2, y2, Math.min(0.0f, 1.0f), y2, this.mPaintGraph);
            String str2 = "" + (((int) (((double) (((y2 - (viewHeight / 2)) * 100.0f) / (MotionLayout.this.getHeight() - viewHeight))) + 0.5d)) / 100.0f);
            getTextBounds(str2, this.mTextPaint);
            canvas.drawText(str2, x2 + 5.0f, 0.0f - ((y2 / 2.0f) - (this.mBounds.height() / 2)), this.mTextPaint);
    ...
    private void debugPos() {
        for (int i2 = 0; i2 < getChildCount(); i2++) {
            View childAt = getChildAt(i2);
            String str = Global.BLANK + Debug.getLocation() + Global.BLANK + Debug.getName(this) + Global.BLANK + Debug.getName(getContext(), this.mCurrentState) + Global.BLANK + Debug.getName(childAt) + childAt.getLeft() + Global.BLANK + childAt.getTop();
        }
    }
    ...
    protected void dispatchDraw(Canvas canvas) throws Throwable {
        ...
        int i2 = this.mDebugPath;
        if ((i2 + 1) - (i2 | 1) == 1 && !isInEditMode()) {
            this.mFrames++;
            long nanoTime = getNanoTime();
            ...
            String string = sbAppend.append(i3 == -1 ? "undefined" : Debug.getState(this, i3)).toString();
    ...
    /* JADX WARN: Removed duplicated region for block: B:300:0x01c5  */
    /* JADX WARN: Removed duplicated region for block: B:303:0x01d2  */
    /* JADX WARN: Removed duplicated region for block: B:310:0x01f3  */
    /* JADX WARN: Removed duplicated region for block: B:315:0x020e  */
    /* JADX WARN: Removed duplicated region for block: B:317:0x0212  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    private void init(AttributeSet attrs) throws Throwable {
        ...
        if (attrs != null) {
            Context context = getContext();
            Object[] objArr = {attrs, R.styleable.MotionLayout};
            Method method = Class.forName(ZO.xd("t1\u001f4zJ1\u0012\bil<\b$\u001e2Ax'p\u0002;?", (short) (C1633zX.Xd() ^ (-25521)), (short) (C1633zX.Xd() ^ (-30582)))).getMethod(Ig.wd("G\fm<Jz\u000eT\u0017khGQ|3\r+$|\u00064\f", (short) (FB.Xd() ^ 5228)), Class.forName(C1626yg.Ud("<'\u0015\u000be%yQB-83\u001a8)~\u0003BLh\u000e\u0005O_2", (short) (Od.Xd() ^ (-10853)), (short) (Od.Xd() ^ (-16959)))), int[].class);
            try {
                method.setAccessible(true);
                ...
                for (int i2 = 0; i2 < indexCount; i2++) {
                    ...
                    if (index == R.styleable.MotionLayout_layoutDescription) {
                        this.mScene = new MotionScene(getContext(), this, typedArray.getResourceId(index, -1));
                    } else if (index == R.styleable.MotionLayout_currentState) {
                        this.mCurrentState = typedArray.getResourceId(index, -1);
                    } else if (index == R.styleable.MotionLayout_motionProgress) {
                        this.mTransitionGoalPosition = typedArray.getFloat(index, 0.0f);
                        this.mInTransition = true;
                    } else if (index == R.styleable.MotionLayout_applyMotionScene) {
                        z2 = typedArray.getBoolean(index, z2);
                    } else if (index == R.styleable.MotionLayout_showPaths) {
                        if (this.mDebugPath == 0) {
                            this.mDebugPath = typedArray.getBoolean(index, false) ? 2 : 0;
                        }
                    } else if (index == R.styleable.MotionLayout_motionDebug) {
                        this.mDebugPath = typedArray.getInt(index, 0);
                    }
                }
                typedArray.recycle();
                if (this.mScene == null) {
                    EO.Od("\f`G!v:@eP\u0007#\f", (short) (OY.Xd() ^ 13963));
                    C1561oA.Qd("eN^YSWO'TT$drq:k_vkpn=]jYg]cfZ_]\u000eaMR", (short) (OY.Xd() ^ 3119));
                }
                if (!z2) {
                    this.mScene = null;
                }
    ...
    private boolean handlesTouchEvent(float x2, float y2, View view, MotionEvent event) {
        boolean z2;
        if (view instanceof ViewGroup) {
            ViewGroup viewGroup = (ViewGroup) view;
            for (int childCount = viewGroup.getChildCount() - 1; childCount >= 0; childCount--) {
                if (handlesTouchEvent((r5.getLeft() + x2) - view.getScrollX(), (r5.getTop() + y2) - view.getScrollY(), viewGroup.getChildAt(childCount), event)) {
                    z2 = true;
                    break;
                }
            }
        ...
        if (!z2) {
            this.mBoundsCheck.set(x2, y2, (view.getRight() + x2) - view.getLeft(), (view.getBottom() + y2) - view.getTop());
            if ((event.getAction() != 0 || this.mBoundsCheck.contains(event.getX(), event.getY())) && callTransformedTouchEvent(view, event, -x2, -y2)) {
                return true;
            }
        }
        return z2;
    ...
    /* JADX INFO: renamed from: androidx.constraintlayout.motion.widget.MotionLayout$4 */
    ...
    void getAnchorDpDt(int mTouchAnchorId, float pos, float locationX, float locationY, float[] mAnchorDpDt) throws Throwable {
        String resourceName;
        ...
        if (viewById == null) {
            ...
            Object[] objArr = new Object[0];
            Method method = Class.forName(C1593ug.zd("\u0011\u001f\u0016%#\u001e\u001ad\u001b((/!+2l\u0003007)=:", (short) (FB.Xd() ^ 7217), (short) (FB.Xd() ^ 25503))).getMethod(C1561oA.od(")&4\u0011#0+0,\u001c\u001d*", (short) (C1580rY.Xd() ^ (-28601))), new Class[0]);
            try {
                method.setAccessible(true);
                resourceName = ((Resources) method.invoke(context, objArr)).getResourceName(mTouchAnchorId);
            } catch (InvocationTargetException e2) {
                throw e2.getCause();
            }
        }
        String str = C1561oA.Kd("iTfc_e_9}\u000b\u0012\n\u0003?\u000f\u0011\u0017C\u000b\u000f\u0015\fH \u0014\u0011$M\u0018\u0014P", (short) (ZN.Xd() ^ 21699)) + resourceName;
        Wg.Zd("\u0004u_\u0010n\"c9%o:\u0011", (short) (C1633zX.Xd() ^ (-6649)), (short) (C1633zX.Xd() ^ (-16084)));
    }
