...
abstract class KeyPositionBase extends Key {
    ...
    public abstract boolean intersects(int layoutWidth, int layoutHeight, RectF start, RectF end, float x2, float y2);

    abstract void positionAttributes(View view, RectF start, RectF end, float x2, float y2, String[] attribute, float[] value);
