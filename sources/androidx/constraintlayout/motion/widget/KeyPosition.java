...
public class KeyPosition extends KeyPositionBase {
    ...
    public void load(Context context, AttributeSet attrs) throws Throwable {
        Object[] objArr = {attrs, R.styleable.KeyPosition};
        Method method = Class.forName(C1561oA.od("]i^kg`Z#Wb`eU]b\u001b/ZX]M_Z", (short) (OY.Xd() ^ 8647))).getMethod(Wg.Zd("@\u0019\u0010FCd\faP8]O0=r|\u0016rPtq\"", (short) (C1499aX.Xd() ^ (-3403)), (short) (C1499aX.Xd() ^ (-21982))), Class.forName(C1561oA.Kd("UcZigb^)qqgk.Bvwvnh||n]p\u0001", (short) (Od.Xd() ^ (-653)))), int[].class);
        try {
    ...
    void positionPathAttributes(RectF start, RectF end, float x2, float y2, String[] attribute, float[] value) {
    ...
    void positionScreenAttributes(View view, RectF start, RectF end, float x2, float y2, String[] attribute, float[] value) {
        start.centerX();
        start.centerY();
        end.centerX();
        end.centerY();
    ...
    void positionCartAttributes(RectF start, RectF end, float x2, float y2, String[] attribute, float[] value) {
        float fCenterX = start.centerX();
        float fCenterY = start.centerY();
        float fCenterX2 = end.centerX() - fCenterX;
        float fCenterY2 = end.centerY() - fCenterY;
