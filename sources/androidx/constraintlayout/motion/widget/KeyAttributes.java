...
public class KeyAttributes extends Key {
    ...
    public void load(Context context, AttributeSet attrs) throws Throwable {
        Object[] objArr = {attrs, R.styleable.KeyAttribute};
        Method method = Class.forName(Xg.qd("\u0002\u0010\u0007\u0016\u0014\u000f\u000bU\f\u0019\u0019 \u0012\u001c#]s!!(\u001a.+", (short) (Od.Xd() ^ (-27894)), (short) (Od.Xd() ^ (-2850)))).getMethod(ZO.xd("\u001f9\\UD\u0016`\u0014VzWN\u0006LJ\u001f\u0003\rx&%w", (short) (C1607wl.Xd() ^ 15111), (short) (C1607wl.Xd() ^ 3047)), Class.forName(Jg.Wd("O\u0003lU\u0017g^J\u000e!\\{0_\u0019m'\u0001u_#.P\t\u0014", (short) (OY.Xd() ^ 1467), (short) (OY.Xd() ^ 32288))), int[].class);
        try {
