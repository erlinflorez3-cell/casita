...
class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    void different(MotionConstrainedPoint motionConstrainedPoint, boolean[] zArr, String[] strArr) {
        zArr[0] = (zArr[0] ? 1 : 0) | (diff(this.position, motionConstrainedPoint.position) ? 1 : 0);
        zArr[1] = (-1) - (((-1) - (zArr[1] ? 1 : 0)) & ((-1) - (diff(this.f129x, motionConstrainedPoint.f129x) ? 1 : 0))) == 1;
        zArr[2] = (-1) - (((-1) - (zArr[2] ? 1 : 0)) & ((-1) - (diff(this.f130y, motionConstrainedPoint.f130y) ? 1 : 0))) == 1;
        boolean z2 = zArr[3];
        boolean zDiff = diff(this.width, motionConstrainedPoint.width);
        zArr[3] = ((z2 ? 1 : 0) + (zDiff ? 1 : 0)) - ((z2 ? 1 : 0) & (zDiff ? 1 : 0)) == 1;
        zArr[4] = (-1) - (((-1) - (diff(this.height, motionConstrainedPoint.height) ? 1 : 0)) & ((-1) - (zArr[4] ? 1 : 0))) == 1;
    }

    void fillStandard(double[] data, int[] toUse) {
        int i2 = 0;
        float[] fArr = {this.position, this.f129x, this.f130y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        for (int i3 : toUse) {
            if (i3 < 18) {
                data[i2] = fArr[r1];
                i2++;
    ...
    public int compareTo(MotionConstrainedPoint o2) {
                    ...
                    if (str.startsWith("CUSTOM")) {
                        ...
                        if (this.attributes.containsKey(str2)) {
                            ...
                            if (viewSpline instanceof ViewSpline.CustomSet) {
                                ...
                                String str3 = str + " ViewSpline not a CustomSet frame = " + mFramePosition + ", value" + constraintAttribute.getValueToInterpolate() + viewSpline;
                            }
                        }
                    } else {
