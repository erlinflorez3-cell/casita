...
class OutputConfigurationCompatApi28Impl extends OutputConfigurationCompatApi26Impl {
    ...
    OutputConfigurationCompatApi28Impl(int i2, Surface surface) {
        this(new OutputConfigurationParamsApi28(new OutputConfiguration(i2, surface)));
    }
    ...
    public void setDynamicRangeProfile(long j2) {
        ((OutputConfigurationParamsApi28) this.mObject).mDynamicRangeProfile = j2;
    }
