...
class DynamicRangesCompatApi33Impl implements DynamicRangesCompat.DynamicRangeProfilesCompatImpl {
    ...
    private static DynamicRange profileToDynamicRange(long j2) {
        return (DynamicRange) Preconditions.checkNotNull(DynamicRangeConversions.profileToDynamicRange(j2), "Dynamic range profile cannot be converted to a DynamicRange object: " + j2);
    }
