...
class OutputConfigurationCompatApi24Impl extends OutputConfigurationCompatBaseImpl {
    ...
    OutputConfigurationCompatApi24Impl(int i2, Surface surface) {
    ...
    public void setDynamicRangeProfile(long j2) {
        ((OutputConfigurationParamsApi24) this.mObject).mDynamicRangeProfile = j2;
    }
    ...
    private static final class OutputConfigurationParamsApi24 {
        ...
        public int hashCode() {
            ...
            int iHashCode2 = (str == null ? 0 : str.hashCode()) ^ i3;
