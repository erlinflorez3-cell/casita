...
public final class SessionConfigurationCompat {
    ...
    private static final class SessionConfigurationCompatBaseImpl implements SessionConfigurationCompatImpl {
        ...
        SessionConfigurationCompatBaseImpl(int i2, List<OutputConfigurationCompat> list, Executor executor, CameraCaptureSession.StateCallback stateCallback) {
    ...
    private static final class SessionConfigurationCompatApi28Impl implements SessionConfigurationCompatImpl {
        ...
        SessionConfigurationCompatApi28Impl(int i2, List<OutputConfigurationCompat> list, Executor executor, CameraCaptureSession.StateCallback stateCallback) {
