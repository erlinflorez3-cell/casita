...
final class Camera2CameraImpl implements CameraInternal {
    ...
    Camera2CameraImpl(Context context, CameraManagerCompat cameraManagerCompat, String str, Camera2CameraInfoImpl camera2CameraInfoImpl, CameraCoordinator cameraCoordinator, CameraStateRegistry cameraStateRegistry, Executor executor, Handler handler, DisplayInfoManager displayInfoManager, long j2) throws CameraUnavailableException {
        ...
        this.mStateCallback = new StateCallback(executorNewSequentialExecutor, scheduledExecutorServiceNewHandlerExecutor, j2);
    ...
    /* JADX INFO: renamed from: androidx.camera.camera2.internal.Camera2CameraImpl$1 */
    ...
    public void configAndCloseIfNeeded() {
        ...
        if (!this.mCameraAvailability.isCameraAvailable()) {
            ...
            listenableFutureOpenCameraConfigAndClose.addListener(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda15
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m50x65edacec();
                }
            }, this.mExecutor);
        }
    }

    /* JADX INFO: renamed from: lambda$configAndCloseIfNeeded$0$androidx-camera-camera2-internal-Camera2CameraImpl */
    /* synthetic */ void m50x65edacec() {
        this.mIsConfiguringForClose = false;
        this.mIsConfigAndCloseRequired = false;
    ...
    private ListenableFuture<Void> openCameraConfigAndClose() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda14
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m60xfb055f0e(completer);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$openCameraConfigAndClose$1$androidx-camera-camera2-internal-Camera2CameraImpl */
    /* synthetic */ Object m60xfb055f0e(CallbackToFutureAdapter.Completer completer) throws Exception {
        try {
            ...
            debugLog("Unable to open camera for configAndClose: " + e2.getMessage(), e2);
            completer.setException(e2);
            return "configAndCloseTask";
        }
    }

    /* JADX INFO: renamed from: androidx.camera.camera2.internal.Camera2CameraImpl$2 */
    class AnonymousClass2 extends CameraDevice.StateCallback {
        ...
        public void onError(CameraDevice cameraDevice, int i2) {
            Camera2CameraImpl.this.debugLog("openCameraConfigAndClose camera error " + i2);
            this.val$completer.set(null);
        }
    ...
    static /* synthetic */ ListenableFuture lambda$configAndClose$3(CaptureSession captureSession, DeferrableSurface deferrableSurface, Void r3) throws Exception {
    ...
    public ListenableFuture<Void> release() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda1
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m62x22c7252f(completer);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$release$5$androidx-camera-camera2-internal-Camera2CameraImpl */
    /* synthetic */ Object m62x22c7252f(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m61xf4ee8ad0(completer);
            }
        });
        return "Release[request=" + this.mReleaseRequestCount.getAndIncrement() + "]";
    }

    /* JADX INFO: renamed from: lambda$release$4$androidx-camera-camera2-internal-Camera2CameraImpl */
    /* synthetic */ void m61xf4ee8ad0(CallbackToFutureAdapter.Completer completer) {
        ...
        if (this.mUserReleaseFuture == null) {
            if (this.mState != InternalState.RELEASED) {
                this.mUserReleaseFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda5
                    @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                        return this.f$0.m52x9e399b31(completer);
                    }
                });
            } else {
    ...
    /* JADX INFO: renamed from: lambda$getOrCreateUserReleaseFuture$6$androidx-camera-camera2-internal-Camera2CameraImpl */
    /* synthetic */ Object m52x9e399b31(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    ListenableFuture<Void> releaseSession(CaptureSessionInterface captureSessionInterface, boolean z2) {
        ...
        Futures.addCallback(listenableFutureRelease, new FutureCallback<Void>() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl.3
            ...
            AnonymousClass3(CaptureSessionInterface captureSessionInterface2) {
                captureSessionInterface = captureSessionInterface2;
            }
    ...
    public void onUseCaseActive(UseCase useCase) {
        ...
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda21
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m57x4ba3b9b6(useCaseId, sessionConfig, currentConfig, attachedStreamSpec, captureTypes);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$onUseCaseActive$7$androidx-camera-camera2-internal-Camera2CameraImpl */
    /* synthetic */ void m57x4ba3b9b6(String str, SessionConfig sessionConfig, UseCaseConfig useCaseConfig, StreamSpec streamSpec, List list) {
    ...
    public void onUseCaseInactive(UseCase useCase) {
        ...
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda20
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m58xe952d690(useCaseId);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$onUseCaseInactive$8$androidx-camera-camera2-internal-Camera2CameraImpl */
    /* synthetic */ void m58xe952d690(String str) {
    ...
    public void onUseCaseUpdated(UseCase useCase) {
        ...
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda19
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m59x44486635(useCaseId, sessionConfig, currentConfig, attachedStreamSpec, captureTypes);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$onUseCaseUpdated$9$androidx-camera-camera2-internal-Camera2CameraImpl */
    /* synthetic */ void m59x44486635(String str, SessionConfig sessionConfig, UseCaseConfig useCaseConfig, StreamSpec streamSpec, List list) {
    ...
    private void resetUseCase(final String str, final SessionConfig sessionConfig, final UseCaseConfig<?> useCaseConfig, final StreamSpec streamSpec, final List<UseCaseConfigFactory.CaptureType> list) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m63xb3c15a2c(str, sessionConfig, useCaseConfig, streamSpec, list);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$resetUseCase$10$androidx-camera-camera2-internal-Camera2CameraImpl */
    /* synthetic */ void m63xb3c15a2c(String str, SessionConfig sessionConfig, UseCaseConfig useCaseConfig, StreamSpec streamSpec, List list) {
    ...
    boolean isUseCaseAttached(UseCase useCase) {
        try {
            ...
            return ((Boolean) CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda4
                @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return this.f$0.m56xf78c78d9(useCaseId, completer);
                }
            }).get()).booleanValue();
    ...
    /* JADX INFO: renamed from: lambda$isUseCaseAttached$12$androidx-camera-camera2-internal-Camera2CameraImpl */
    /* synthetic */ Object m56xf78c78d9(final String str, final CallbackToFutureAdapter.Completer completer) throws Exception {
        try {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m55xc9b3de7a(completer, str);
                }
            });
    ...
    /* JADX INFO: renamed from: lambda$isUseCaseAttached$11$androidx-camera-camera2-internal-Camera2CameraImpl */
    /* synthetic */ void m55xc9b3de7a(CallbackToFutureAdapter.Completer completer, String str) {
    ...
    boolean isMeteringRepeatingAttached() {
        try {
            return ((Boolean) CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda18
                @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return this.f$0.m54x3a89a76e(completer);
                }
            }).get()).booleanValue();
        } catch (InterruptedException | ExecutionException e2) {
    ...
    /* JADX INFO: renamed from: lambda$isMeteringRepeatingAttached$14$androidx-camera-camera2-internal-Camera2CameraImpl */
    /* synthetic */ Object m54x3a89a76e(final CallbackToFutureAdapter.Completer completer) throws Exception {
        try {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda13
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m53xcb10d0f(completer);
                }
            });
    ...
    /* JADX INFO: renamed from: lambda$isMeteringRepeatingAttached$13$androidx-camera-camera2-internal-Camera2CameraImpl */
    /* synthetic */ void m53xcb10d0f(CallbackToFutureAdapter.Completer completer) {
    ...
    public void attachUseCases(Collection<UseCase> collection) {
        ...
        try {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda17
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m49x1cf87860(arrayList2);
                }
            });
    ...
    /* JADX INFO: renamed from: lambda$attachUseCases$15$androidx-camera-camera2-internal-Camera2CameraImpl */
    /* synthetic */ void m49x1cf87860(List list) {
        try {
    ...
    public void detachUseCases(Collection<UseCase> collection) {
        ...
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m51x3fc4c78d(arrayList2);
            }
        });
    }

    /* JADX INFO: renamed from: tryDetachUseCases */
    public void m51x3fc4c78d(Collection<UseCaseInfo> collection) {
        ArrayList arrayList = new ArrayList();
        boolean z2 = false;
        for (UseCaseInfo useCaseInfo : collection) {
            if (this.mUseCaseAttachState.isUseCaseAttached(useCaseInfo.getUseCaseId())) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v3, types: [androidx.camera.camera2.internal.Camera2CameraControlImpl] */
    ...
    private void updateZslDisabledByUseCaseConfigStatus() {
        ...
        ?? r2 = 0;
        while (it.hasNext()) {
            boolean zIsZslDisabled = it.next().isZslDisabled(false);
            int i2 = (r2 + (zIsZslDisabled ? 1 : 0)) - (r2 & (zIsZslDisabled ? 1 : 0));
            r2 = 1;
            if (i2 != 1) {
                r2 = 0;
            }
        }
        this.mCameraControlInternal.setZslDisabledByUserCaseConfig(r2);
    }
    ...
    /* JADX INFO: renamed from: lambda$addOrRemoveMeteringRepeatingUseCase$17$androidx-camera-camera2-internal-Camera2CameraImpl */
    /* synthetic */ void m48x8e086554() {
    ...
    void tryForceOpenCameraDevice(boolean z2) {
    ...
    void tryOpenCameraDevice(boolean z2) {
    ...
    public void setActiveResumingMode(final boolean z2) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m64x83557197(z2);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$setActiveResumingMode$18$androidx-camera-camera2-internal-Camera2CameraImpl */
    /* synthetic */ void m64x83557197(boolean z2) {
    ...
    class ErrorTimeoutReopenScheduler {
        ...
        /* synthetic */ ErrorTimeoutReopenScheduler(Camera2CameraImpl camera2CameraImpl, AnonymousClass1 anonymousClass1) {
            this();
        }
    ...
    void openCaptureSession() {
        ...
        Futures.addCallback(captureSessionInterface.open(attachedBuilder.build(), (CameraDevice) Preconditions.checkNotNull(this.mCameraDevice), this.mCaptureSessionOpenerBuilder.build()), new FutureCallback<Void>() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl.4
            ...
            AnonymousClass4(CaptureSessionInterface captureSessionInterface2) {
                captureSessionInterface = captureSessionInterface2;
            }
    ...
    /* JADX INFO: renamed from: androidx.camera.camera2.internal.Camera2CameraImpl$4 */
    ...
    void resetCaptureSession(boolean z2) {
    ...
    void setState(InternalState internalState, CameraState.StateError stateError, boolean z2) {
    ...
    static abstract class UseCaseInfo {
        ...
        static UseCaseInfo from(UseCase useCase, boolean z2) {
    ...
    final class StateCallback extends CameraDevice.StateCallback {
        ...
        StateCallback(Executor executor, ScheduledExecutorService scheduledExecutorService, long j2) {
            this.mExecutor = executor;
            this.mScheduler = scheduledExecutorService;
            this.mCameraReopenMonitor = new CameraReopenMonitor(j2);
        }
        ...
        public void onError(CameraDevice cameraDevice, int i2) {
            Camera2CameraImpl.this.mCameraDevice = cameraDevice;
            Camera2CameraImpl.this.mCameraDeviceError = i2;
        ...
        class CameraReopenMonitor {
            ...
            CameraReopenMonitor(long j2) {
                this.mCameraOpenRetryMaxTimeoutInMs = j2;
            }
            ...
            int getReopenLimitMs() {
                ...
                return j3 > 0 ? Math.min((int) j3, ACTIVE_REOPEN_LIMIT_MS) : ACTIVE_REOPEN_LIMIT_MS;
            }
