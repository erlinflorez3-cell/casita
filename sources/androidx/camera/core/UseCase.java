...
public abstract class UseCase {
    ...
    public static int snapToSurfaceRotation(int i2) {
    ...
    protected boolean setTargetRotationInternal(int i2) {
    ...
    protected int getRelativeRotation(CameraInternal cameraInternal, boolean z2) {
