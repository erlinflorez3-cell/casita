...
public class StreamSharing extends UseCase {
    ...
    interface Control {
        ListenableFuture<Void> jpegSnapshot(int i2, int i3);
    }
    ...
    public StreamSharing(CameraInternal cameraInternal, CameraInternal cameraInternal2, LayoutSettings layoutSettings, LayoutSettings layoutSettings2, Set<UseCase> set, UseCaseConfigFactory useCaseConfigFactory) {
        ...
        this.mVirtualCameraAdapter = new VirtualCameraAdapter(cameraInternal, cameraInternal2, set, useCaseConfigFactory, new Control() { // from class: androidx.camera.core.streamsharing.StreamSharing$$ExternalSyntheticLambda3
            ...
            public final ListenableFuture jpegSnapshot(int i2, int i3) {
                return this.f$0.m250lambda$new$0$androidxcameracorestreamsharingStreamSharing(i2, i3);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$0$androidx-camera-core-streamsharing-StreamSharing */
    /* synthetic */ ListenableFuture m250lambda$new$0$androidxcameracorestreamsharingStreamSharing(int i2, int i3) {
        SurfaceProcessorNode surfaceProcessorNode = this.mSharingNode;
        if (surfaceProcessorNode != null) {
            return surfaceProcessorNode.getSurfaceProcessor().snapshot(i2, i3);
        }
    ...
    private List<SessionConfig> createPipelineAndUpdateChildrenSpecs(String str, String str2, UseCaseConfig<?> useCaseConfig, StreamSpec streamSpec, StreamSpec streamSpec2) {
        ...
        if (streamSpec2 == null) {
            ...
            return c$$ExternalSyntheticBackport0.m(new Object[]{this.mSessionConfigBuilder.build()});
        }
        ...
        return c$$ExternalSyntheticBackport0.m(new Object[]{this.mSessionConfigBuilder.build(), this.mSecondarySessionConfigBuilder.build()});
    }
    ...
    private void addCameraErrorListener(SessionConfig.Builder builder, final String str, final String str2, final UseCaseConfig<?> useCaseConfig, final StreamSpec streamSpec, final StreamSpec streamSpec2) {
        ...
        SessionConfig.CloseableErrorListener closeableErrorListener2 = new SessionConfig.CloseableErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.streamsharing.StreamSharing$$ExternalSyntheticLambda2
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                this.f$0.m249x83a3b685(str, str2, useCaseConfig, streamSpec, streamSpec2, sessionConfig, sessionError);
            }
        });
    ...
    /* JADX INFO: renamed from: lambda$addCameraErrorListener$1$androidx-camera-core-streamsharing-StreamSharing */
    /* synthetic */ void m249x83a3b685(String str, String str2, UseCaseConfig useCaseConfig, StreamSpec streamSpec, StreamSpec streamSpec2, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        if (getCamera() == null) {
            return;
        }
        clearPipeline();
