...
public abstract class CameraEffect {
    ...
    protected CameraEffect(int i2, Executor executor, ImageProcessor imageProcessor, Consumer<Throwable> consumer) {
    ...
    protected CameraEffect(int i2, int i3, Executor executor, SurfaceProcessor surfaceProcessor, Consumer<Throwable> consumer) {
        this(i2, 0, i3, executor, surfaceProcessor, consumer);
    }

    protected CameraEffect(int i2, int i3, int i4, Executor executor, SurfaceProcessor surfaceProcessor, Consumer<Throwable> consumer) {
        TargetUtils.checkSupportedTargets(SURFACE_PROCESSOR_TARGETS, i2);
        this.mTargets = i2;
        this.mOutputOption = i3;
    ...
    protected CameraEffect(int i2, Executor executor, SurfaceProcessor surfaceProcessor, Consumer<Throwable> consumer) {
