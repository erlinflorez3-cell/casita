...
public final class CameraOrientationUtil {
    ...
    public static int getRelativeImageRotation(int i2, int i3, boolean z2) {
        int i4;
        if (z2) {
            i4 = ((i3 - i2) + SessionSplitConfiguration.DEFAULT_MAX_SESSION_DURATION_MINS) % SessionSplitConfiguration.DEFAULT_MAX_SESSION_DURATION_MINS;
        } else {
            i4 = (i3 + i2) % SessionSplitConfiguration.DEFAULT_MAX_SESSION_DURATION_MINS;
        }
