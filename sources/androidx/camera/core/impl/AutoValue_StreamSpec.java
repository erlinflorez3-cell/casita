...
final class AutoValue_StreamSpec extends StreamSpec {
    ...
    /* synthetic */ AutoValue_StreamSpec(Size size, DynamicRange dynamicRange, Range range, Config config, boolean z2, AnonymousClass1 anonymousClass1) {
        this(size, dynamicRange, range, config, z2);
    }

    private AutoValue_StreamSpec(Size size, DynamicRange dynamicRange, Range<Integer> range, Config config, boolean z2) {
    ...
    static final class Builder extends StreamSpec.Builder {
        ...
        /* synthetic */ Builder(StreamSpec streamSpec, AnonymousClass1 anonymousClass1) {
            this(streamSpec);
        }
