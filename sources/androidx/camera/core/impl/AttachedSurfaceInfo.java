...
public abstract class AttachedSurfaceInfo {
    ...
    public static AttachedSurfaceInfo create(SurfaceConfig surfaceConfig, int i2, Size size, DynamicRange dynamicRange, List<UseCaseConfigFactory.CaptureType> list, Config config, Range<Integer> range) {
        return new AutoValue_AttachedSurfaceInfo(surfaceConfig, i2, size, dynamicRange, list, config, range);
    }
