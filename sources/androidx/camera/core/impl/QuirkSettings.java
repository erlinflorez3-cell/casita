...
public class QuirkSettings {
    ...
    private QuirkSettings(boolean z2, Set<Class<? extends Quirk>> set, Set<Class<? extends Quirk>> set2) {
        this.mEnabledWhenDeviceHasQuirk = z2;
    ...
    public boolean shouldEnableQuirk(Class<? extends Quirk> cls, boolean z2) {
        ...
        return this.mEnabledWhenDeviceHasQuirk && z2;
    }
    ...
    public static class Builder {
        ...
        public Builder setEnabledWhenDeviceHasQuirk(boolean z2) {
            this.mEnabledWhenDeviceHasQuirk = z2;
            return this;
        }
