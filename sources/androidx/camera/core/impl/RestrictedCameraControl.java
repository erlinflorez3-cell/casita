...
public class RestrictedCameraControl extends ForwardingCameraControl {
    ...
    public ListenableFuture<Void> enableTorch(boolean z2) {
        ...
        return this.mCameraControl.enableTorch(z2);
    }
    ...
    public ListenableFuture<Void> setZoomRatio(float f2) {
        ...
        return this.mCameraControl.setZoomRatio(f2);
    }
    ...
    public ListenableFuture<Void> setLinearZoom(float f2) {
        ...
        return this.mCameraControl.setLinearZoom(f2);
    }
    ...
    public ListenableFuture<Integer> setExposureCompensationIndex(int i2) {
        ...
        return this.mCameraControl.setExposureCompensationIndex(i2);
    }
}
