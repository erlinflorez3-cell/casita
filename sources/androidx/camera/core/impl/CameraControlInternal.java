...
public interface CameraControlInternal extends CameraControl {
    ...
    ListenableFuture<List<Void>> submitStillCaptureRequests(List<CaptureConfig> list, int i2, int i3);

    /* JADX INFO: renamed from: androidx.camera.core.impl.CameraControlInternal$1 */
    class AnonymousClass1 implements CameraCapturePipeline {
        AnonymousClass1() {
        }
    ...
    default ListenableFuture<CameraCapturePipeline> getCameraCapturePipelineAsync(int i2, int i3) {
    ...
    class AnonymousClass2 implements CameraControlInternal {
        @Override // androidx.camera.core.impl.CameraControlInternal
        public void addInteropConfig(Config config) {
        }
