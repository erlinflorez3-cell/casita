...
public interface ImageOutputConfig extends ReadableConfig {
    ...
    default int getTargetRotation(int i2) {
        return ((Integer) retrieveOption(OPTION_TARGET_ROTATION, Integer.valueOf(i2))).intValue();
    }

    default int getAppTargetRotation(int i2) {
        return ((Integer) retrieveOption(OPTION_APP_TARGET_ROTATION, Integer.valueOf(i2))).intValue();
    }
    ...
    default int getMirrorMode(int i2) {
        return ((Integer) retrieveOption(OPTION_MIRROR_MODE, Integer.valueOf(i2))).intValue();
    }
