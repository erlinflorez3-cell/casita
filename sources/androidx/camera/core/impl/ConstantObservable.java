...
public final class ConstantObservable<T> implements Observable<T> {
    ...
    public static <U> Observable<U> withValue(U u2) {
        ...
        return new ConstantObservable(u2);
    }

    private ConstantObservable(T t2) {
