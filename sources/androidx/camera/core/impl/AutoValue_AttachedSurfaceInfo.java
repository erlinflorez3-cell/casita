...
final class AutoValue_AttachedSurfaceInfo extends AttachedSurfaceInfo {
    ...
    AutoValue_AttachedSurfaceInfo(SurfaceConfig surfaceConfig, int i2, Size size, DynamicRange dynamicRange, List<UseCaseConfigFactory.CaptureType> list, Config config, Range<Integer> range) {
