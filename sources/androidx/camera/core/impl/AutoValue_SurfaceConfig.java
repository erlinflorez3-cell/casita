...
final class AutoValue_SurfaceConfig extends SurfaceConfig {
    ...
    AutoValue_SurfaceConfig(SurfaceConfig.ConfigType configType, SurfaceConfig.ConfigSize configSize, long j2) {
        if (configType == null) {
