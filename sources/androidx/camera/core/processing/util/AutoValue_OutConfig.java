...
final class AutoValue_OutConfig extends OutConfig {
    ...
    AutoValue_OutConfig(UUID uuid, int i2, int i3, Rect rect, Size size, int i4, boolean z2, boolean z3) {
        if (uuid == null) {
        ...
        this.getSize = size;
        this.getRotationDegrees = i4;
        this.isMirroring = z2;
        this.shouldRespectInputCropRect = z3;
    }
