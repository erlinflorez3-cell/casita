...
public class SurfaceEdge {
    ...
    public SurfaceEdge(int i2, int i3, StreamSpec streamSpec, Matrix matrix, boolean z2, Rect rect, int i4, int i5, boolean z3) {
        ...
        this.mMirroring = z3;
        this.mSettableSurface = new SettableSurface(streamSpec.getResolution(), i3);
    }
    ...
    public SurfaceRequest createSurfaceRequest(CameraInternal cameraInternal, boolean z2) {
        Threads.checkMainThread();
        checkNotClosed();
        SurfaceRequest surfaceRequest = new SurfaceRequest(this.mStreamSpec.getResolution(), cameraInternal, z2, this.mStreamSpec.getDynamicRange(), this.mStreamSpec.getExpectedFrameRateRange(), new Runnable() { // from class: androidx.camera.core.processing.SurfaceEdge$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m229xa8c6a4fe();
            }
        });
        try {
    ...
    /* JADX INFO: renamed from: lambda$createSurfaceRequest$1$androidx-camera-core-processing-SurfaceEdge */
    /* synthetic */ void m229xa8c6a4fe() {
        CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.processing.SurfaceEdge$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m228xe25e27d();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$createSurfaceRequest$0$androidx-camera-core-processing-SurfaceEdge */
    /* synthetic */ void m228xe25e27d() {
        if (this.mIsClosed) {
            return;
        }
        invalidate();
    ...
    public ListenableFuture<SurfaceOutput> createSurfaceOutputFuture(final int i2, final SurfaceOutput.CameraInputInfo cameraInputInfo, final SurfaceOutput.CameraInputInfo cameraInputInfo2) {
        Threads.checkMainThread();
        checkNotClosed();
        checkAndSetHasConsumer();
        ...
        return Futures.transformAsync(settableSurface.getSurface(), new AsyncFunction() { // from class: androidx.camera.core.processing.SurfaceEdge$$ExternalSyntheticLambda0
            ...
            public final ListenableFuture apply(Object obj) {
                return this.f$0.m227xcd1514fc(settableSurface, i2, cameraInputInfo, cameraInputInfo2, (Surface) obj);
            }
        }, CameraXExecutors.mainThreadExecutor());
    }

    /* JADX INFO: renamed from: lambda$createSurfaceOutputFuture$2$androidx-camera-core-processing-SurfaceEdge */
    /* synthetic */ ListenableFuture m227xcd1514fc(final SettableSurface settableSurface, int i2, SurfaceOutput.CameraInputInfo cameraInputInfo, SurfaceOutput.CameraInputInfo cameraInputInfo2, Surface surface) throws Exception {
    ...
    public void updateTransformation(final int i2, final int i3) {
        Threads.runOnMain(new Runnable() { // from class: androidx.camera.core.processing.SurfaceEdge$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m230xb9042df4(i2, i3);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$updateTransformation$3$androidx-camera-core-processing-SurfaceEdge */
    /* synthetic */ void m230xb9042df4(int i2, int i3) {
        boolean z2;
        boolean z3 = true;
    ...
    static class SettableSurface extends DeferrableSurface {
        ...
        /* JADX INFO: renamed from: lambda$new$0$androidx-camera-core-processing-SurfaceEdge$SettableSurface */
        /* synthetic */ Object m232xcee66962(CallbackToFutureAdapter.Completer completer) throws Exception {
        ...
        SettableSurface(Size size, int i2) {
            ...
            this.mSurfaceFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.processing.SurfaceEdge$SettableSurface$$ExternalSyntheticLambda2
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return this.f$0.m232xcee66962(completer);
                }
            });
        }
        ...
        public void close() {
            ...
            Threads.runOnMain(new Runnable() { // from class: androidx.camera.core.processing.SurfaceEdge$SettableSurface$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m231x2121a77b();
                }
            });
        }

        /* JADX INFO: renamed from: lambda$close$1$androidx-camera-core-processing-SurfaceEdge$SettableSurface */
        /* synthetic */ void m231x2121a77b() {
