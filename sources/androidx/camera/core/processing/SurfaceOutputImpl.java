...
final class SurfaceOutputImpl implements SurfaceOutput {
    ...
    SurfaceOutputImpl(Surface surface, int i2, int i3, Size size, SurfaceOutput.CameraInputInfo cameraInputInfo, SurfaceOutput.CameraInputInfo cameraInputInfo2, Matrix matrix) {
        ...
        this.mCloseFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.processing.SurfaceOutputImpl$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m233lambda$new$0$androidxcameracoreprocessingSurfaceOutputImpl(completer);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$0$androidx-camera-core-processing-SurfaceOutputImpl, reason: not valid java name */
    /* synthetic */ Object m233lambda$new$0$androidxcameracoreprocessingSurfaceOutputImpl(CallbackToFutureAdapter.Completer completer) throws Exception {
            ...
            try {
                executor.execute(new Runnable() { // from class: androidx.camera.core.processing.SurfaceOutputImpl$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        this.f$0.m234x4fbd8e2d(atomicReference);
                    }
                });
    ...
    /* synthetic */ void m234x4fbd8e2d(AtomicReference atomicReference) {
    ...
    private static void calculateAdditionalTransform(float[] fArr, float[] fArr2, SurfaceOutput.CameraInputInfo cameraInputInfo) {
        ...
        float fWidth = rectF.width() / r8.getWidth();
        float fHeight = rectF.height() / r8.getHeight();
