...
class SupportedOutputSizesSorterLegacy {
    ...
    private static Size flipSizeByRotation(Size size, int i2, int i3, int i4) {
        return (size == null || !isRotationNeeded(i2, i3, i4)) ? size : new Size(size.getHeight(), size.getWidth());
    }

    private static boolean isRotationNeeded(int i2, int i3, int i4) {
        int relativeImageRotation = CameraOrientationUtil.getRelativeImageRotation(CameraOrientationUtil.surfaceRotationToDegrees(i2), i4, 1 == i3);
