...
public class ViewPorts {
    ...
    public static Map<UseCase, Rect> calculateViewPortRects(Rect rect, boolean z2, Rational rational, int i2, int i3, int i4, Map<UseCase, StreamSpec> map) {
    ...
    public static RectF getScaledRect(RectF rectF, Rational rational, int i2, boolean z2, int i3, int i4) {
        if (i2 == 3) {
            return rectF;
        }
        Matrix matrix = new Matrix();
    ...
    private static RectF correctStartOrEnd(boolean z2, int i2, RectF rectF, RectF rectF2) {
        boolean z3 = i2 == 0 && !z2;
        boolean z4 = i2 == 90 && z2;
        if (z3 || z4) {
            return rectF2;
