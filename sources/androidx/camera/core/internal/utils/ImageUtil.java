...
public final class ImageUtil {
    ...
    public static Bitmap createBitmapFromPlane(ImageProxy.PlaneProxy[] planeProxyArr, int i2, int i3) {
    ...
    public static byte[] jpegImageToJpegByteArray(ImageProxy imageProxy, Rect rect, int i2) throws CodecFailedException {
        if (!isJpegFormats(imageProxy.getFormat())) {
            throw new IllegalArgumentException("Incorrect image format of the input image proxy: " + imageProxy.getFormat());
        }
    ...
    public static byte[] yuvImageToJpegByteArray(ImageProxy imageProxy, Rect rect, int i2, int i3) throws CodecFailedException {
        ...
        ExifOutputStream exifOutputStream = new ExifOutputStream(byteArrayOutputStream, ExifData.create(imageProxy, i3));
        if (rect == null) {
    ...
    private static byte[] cropJpegByteArray(byte[] bArr, Rect rect, int i2) throws CodecFailedException {
        try {
    ...
    public static Rect computeCropRectFromDispatchInfo(Rect rect, int i2, Size size, int i3) {
        Matrix matrix = new Matrix();
