    ...
    static ForwardingImageProxy downsample(ImageProxy imageProxy, int i2, int i3, DownsamplingMethod downsamplingMethod) {
        ...
        if (imageProxy.getWidth() != i2 || imageProxy.getHeight() != i3) {
            ...
            for (int i7 = 3; i6 < i7; i7 = 3) {
                ...
                byte[] bArr = new byte[iArr3[i6] * iArr4[i6]];
        ...
        synchronized (byteBuffer) {
            ...
            while (i10 < i7) {
                ...
                while (i8 < i6) {
                    ...
                    byte b2 = bArr2[i14 + i3];
                    int i16 = (b2 + 255) - (b2 | 255);
                    byte b3 = bArr3[i14];
                    int i17 = (((i15 + i16) + ((b3 + 255) - (b3 | 255))) + ((-1) - (((-1) - bArr3[i14 + i3]) | ((-1) - 255)))) / 4;
                    bArr[i13 + i8] = (byte) ((i17 + 255) - (i17 | 255));
                    i8++;
                }
                i10++;
                i8 = 0;
