...
public final class RgbaImageProxy implements ImageProxy {
    ...
    private static ImageProxy.PlaneProxy createPlaneProxy(final ByteBuffer byteBuffer, final int i2, final int i3) {
    ...
    private static ImageInfo createImageInfo(final long j2, final int i2, final Matrix matrix) {
