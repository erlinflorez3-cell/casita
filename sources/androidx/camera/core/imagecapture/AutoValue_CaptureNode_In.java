...
final class AutoValue_CaptureNode_In extends CaptureNode.In {
    ...
    AutoValue_CaptureNode_In(Size size, int i2, int i3, boolean z2, ImageReaderProxyProvider imageReaderProxyProvider, Size size2, int i4, Edge<ProcessingRequest> edge, Edge<TakePictureManager.CaptureError> edge2) {
        if (size == null) {
