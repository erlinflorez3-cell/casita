...
final class SurfaceViewImplementation extends PreviewViewImplementation {
    ...
    @Override // androidx.camera.view.PreviewViewImplementation
    void onSurfaceRequested(final SurfaceRequest surfaceRequest, final PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) throws Throwable {
        ...
        this.mSurfaceView.post(new Runnable() { // from class: androidx.camera.view.SurfaceViewImplementation$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m341x6305943b(surfaceRequest, onSurfaceNotInUseListener);
            }
        });
    }
    ...
    /* synthetic */ void m341x6305943b(SurfaceRequest surfaceRequest, PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
    ...
    static /* synthetic */ void lambda$getPreviewBitmap$1(Semaphore semaphore, int i2) {
        if (i2 == 0) {
