...
class KeyValueMapCameraCaptureResult implements CameraCaptureResult {
    ...
    KeyValueMapCameraCaptureResult(long j2, TagBundle tagBundle, Map<CaptureResult.Key, Object> map) {
        this.mKeyValues = map;
    ...
    public void populateExifData(ExifData.Builder builder) {
        ...
        Long l2 = (Long) this.mKeyValues.get(CaptureResult.SENSOR_EXPOSURE_TIME);
        if (l2 != null) {
            builder.setExposureTimeNanos(l2.longValue());
        }
        Float f2 = (Float) this.mKeyValues.get(CaptureResult.LENS_APERTURE);
        if (f2 != null) {
        ...
        if (numValueOf != null) {
            if (((Integer) this.mKeyValues.get(CaptureResult.CONTROL_POST_RAW_SENSITIVITY_BOOST)) != null) {
                numValueOf = Integer.valueOf(numValueOf.intValue() * ((int) (r0.intValue() / 100.0f)));
            }
