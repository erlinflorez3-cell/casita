...
abstract class SessionProcessorBase implements SessionProcessor, CameraExtensionsInfo, CameraExtensionsControl {
    ...
    protected void setImageProcessor(final int i2, final ImageProcessor imageProcessor) {
    ...
    static /* synthetic */ void lambda$setImageProcessor$1(ImageProcessor imageProcessor, int i2, String str, ImageReader imageReader) {
        try {
