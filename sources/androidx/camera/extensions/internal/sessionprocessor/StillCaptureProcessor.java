...
class StillCaptureProcessor {
    ...
    interface OnCaptureResultCallback {
        void onCaptureCompleted(long j2, List<Pair<CaptureResult.Key, Object>> list);
    ...
    StillCaptureProcessor(CaptureProcessorImpl captureProcessorImpl, Surface surface, Size size, OutputSurface outputSurface, boolean z2) {
    ...
    void startCapture(final boolean z2, final List<Integer> list, final OnCaptureResultCallback onCaptureResultCallback) {
        ...
        this.mCaptureResultImageMatcher.setImageReferenceListener(new CaptureResultImageMatcher.ImageReferenceListener() { // from class: androidx.camera.extensions.internal.sessionprocessor.StillCaptureProcessor$$ExternalSyntheticLambda1
            ...
            public final void onImageReferenceIncoming(ImageReference imageReference, TotalCaptureResult totalCaptureResult, int i2) {
                this.f$0.m258xbae267d5(list, onCaptureResultCallback, z2, imageReference, totalCaptureResult, i2);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$startCapture$0$androidx-camera-extensions-internal-sessionprocessor-StillCaptureProcessor, reason: not valid java name */
    /* synthetic */ void m258xbae267d5(List list, OnCaptureResultCallback onCaptureResultCallback, boolean z2, ImageReference imageReference, TotalCaptureResult totalCaptureResult, int i2) {
        synchronized (this.mLock) {
            if (this.mIsClosed) {
    ...
    void process(Map<Integer, Pair<ImageReference, TotalCaptureResult>> map, final OnCaptureResultCallback onCaptureResultCallback, final boolean z2) {
        ...
        CameraXExecutors.ioExecutor().execute(new Runnable() { // from class: androidx.camera.extensions.internal.sessionprocessor.StillCaptureProcessor$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m257xd81cd883(z2, map2, onCaptureResultCallback);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$process$1$androidx-camera-extensions-internal-sessionprocessor-StillCaptureProcessor, reason: not valid java name */
    /* synthetic */ void m257xd81cd883(boolean z2, HashMap map, final OnCaptureResultCallback onCaptureResultCallback) {
        synchronized (this.mLock) {
            try {
                try {
                } catch (Exception e2) {
                    Logger.e(TAG, "mCaptureProcessorImpl.process exception ", e2);
                ...
                if (ExtensionVersion.isMinimumCompatibleVersion(Version.VERSION_1_4) && ClientVersion.isMinimumCompatibleVersion(Version.VERSION_1_4) && z2 && this.mIsPostviewConfigured) {
                    this.mCaptureProcessorImpl.processWithPostview(map, new ProcessResultImpl() { // from class: androidx.camera.extensions.internal.sessionprocessor.StillCaptureProcessor.1
                        public void onCaptureCompleted(long j2, List<Pair<CaptureResult.Key, Object>> list) {
                            onCaptureResultCallback.onCaptureCompleted(j2, list);
                        }
    ...
    void notifyCaptureResult(TotalCaptureResult totalCaptureResult, int i2) {
        Long l2;
        this.mCaptureResultImageMatcher.captureResultIncoming(totalCaptureResult, i2);
        if (this.mTimeStampForOutputImage == -1 && (l2 = (Long) totalCaptureResult.get(CaptureResult.SENSOR_TIMESTAMP)) != null) {
