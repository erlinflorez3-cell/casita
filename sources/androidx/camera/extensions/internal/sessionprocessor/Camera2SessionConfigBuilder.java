...
class Camera2SessionConfigBuilder {
    ...
    Camera2SessionConfigBuilder setSessionTemplateId(int i2) {
        this.mSessionTemplateId = i2;
        return this;
    }

    Camera2SessionConfigBuilder setSessionType(int i2) {
    ...
    private static class SessionConfigImpl implements Camera2SessionConfig {
        ...
        SessionConfigImpl(int i2, int i3, Map<CaptureRequest.Key<?>, Object> map, List<Camera2OutputConfig> list) {
            this.mSessionTemplateId = i2;
