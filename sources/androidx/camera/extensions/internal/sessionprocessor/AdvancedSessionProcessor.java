...
public class AdvancedSessionProcessor extends SessionProcessorBase {
    ...
    public int startCapture(boolean z2, TagBundle tagBundle, SessionProcessor.CaptureCallback captureCallback) {
        ...
        if (ClientVersion.isMinimumCompatibleVersion(Version.VERSION_1_4) && ExtensionVersion.isMinimumCompatibleVersion(Version.VERSION_1_4) && this.mIsPostviewConfigured && z2 && this.mVendorExtender.isPostviewAvailable()) {
    ...
    private static class ImageProcessorAdapter implements ImageProcessor {
        ...
        public void onNextImageAvailable(int i2, long j2, ImageReference imageReference, String str) {
            this.mImpl.onNextImageAvailable(i2, j2, new ImageReferenceImplAdapter(imageReference), str);
        }
    }
    ...
    private static class CallbackAdapter implements RequestProcessor.Callback {
        ...
        @Override // androidx.camera.core.impl.RequestProcessor.Callback
        public void onCaptureBufferLost(RequestProcessor.Request request, long j2, int i2) {
            this.mCallback.onCaptureBufferLost(getImplRequest(request), j2, i2);
        }
    ...
    private static class SessionProcessorImplCaptureCallbackAdapter implements SessionProcessorImpl.CaptureCallback {
        ...
        SessionProcessorImplCaptureCallbackAdapter(SessionProcessor.CaptureCallback captureCallback, TagBundle tagBundle, boolean z2) {
            this(captureCallback, tagBundle, null, z2);
        }

        SessionProcessorImplCaptureCallbackAdapter(SessionProcessor.CaptureCallback captureCallback, TagBundle tagBundle, ExtensionMetadataMonitor extensionMetadataMonitor, boolean z2) {
        ...
        public void onCaptureStarted(int i2, long j2) {
            ...
            this.mCaptureCallback.onCaptureStarted(i2, j2);
        }
        ...
        public void onCaptureSequenceCompleted(int i2) {
            ...
            this.mCaptureCallback.onCaptureCompleted(this.mOnCaptureStartedTimestamp, i2, new KeyValueMapCameraCaptureResult(this.mOnCaptureStartedTimestamp, this.mTagBundle, Collections.emptyMap()));
        ...
        public void onCaptureCompleted(long j2, int i2, Map<CaptureResult.Key, Object> map) {
            ...
            if (this.mWillReceiveOnCaptureCompleted) {
                this.mCaptureCallback.onCaptureCompleted(j2, i2, new KeyValueMapCameraCaptureResult(j2, this.mTagBundle, map));
                this.mCaptureCallback.onCaptureSequenceCompleted(i2);
            }
        }
