...
public class AdvancedVendorExtender implements VendorExtender {
    ...
    private List<CaptureRequest.Key> getSupportedParameterKeys() {
        ...
        try {
            listEmptyList = Collections.unmodifiableList(this.mAdvancedExtenderImpl.getAvailableCaptureRequestKeys());
            return listEmptyList;
        } catch (Exception e2) {
            Logger.e(TAG, "AdvancedExtenderImpl.getAvailableCaptureRequestKeys throws exceptions", e2);
            return listEmptyList;
        }
    }
    ...
    public List<CaptureResult.Key> getSupportedCaptureResultKeys() {
        ...
        try {
            listEmptyList = Collections.unmodifiableList(this.mAdvancedExtenderImpl.getAvailableCaptureResultKeys());
            return listEmptyList;
        } catch (Exception e2) {
            Logger.e(TAG, "AdvancedExtenderImpl.getAvailableCaptureResultKeys throws exceptions", e2);
            return listEmptyList;
        }
    }
