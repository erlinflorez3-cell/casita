...
public final class ExtensionsManager {
    ...
    private static ListenableFuture<Void> sDeinitializeFuture = null;
    private static ExtensionsManager sExtensionsManager = null;
    private static ListenableFuture<ExtensionsManager> sInitializeFuture = null;
    ...
    static /* synthetic */ Object lambda$getInstanceAsync$0(ClientVersion clientVersion, Context context, final CameraProvider cameraProvider, final CallbackToFutureAdapter.Completer completer) throws Exception {
        try {
            ...
            Logger.e(TAG, "Failed to initialize extensions. Something wents wrong when initializing the vendor library. " + e5);
            ...
            try {
                ...
                if (extensionsAvailability == ExtensionsAvailability.LIBRARY_AVAILABLE) {
                    ...
                    sDeinitializeFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.extensions.ExtensionsManager$$ExternalSyntheticLambda0
                        @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                        public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                            return this.f$0.m253lambda$shutdown$1$androidxcameraextensionsExtensionsManager(completer);
                        }
                    });
                } else {
                ...
                ListenableFuture<Void> listenableFutureImmediateFailedFuture = Futures.immediateFailedFuture(e2);
    ...
    /* JADX INFO: renamed from: lambda$shutdown$1$androidx-camera-extensions-ExtensionsManager, reason: not valid java name */
    /* synthetic */ Object m253lambda$shutdown$1$androidxcameraextensionsExtensionsManager(final CallbackToFutureAdapter.Completer completer) throws Exception {
        try {
