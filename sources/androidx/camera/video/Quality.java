...
public class Quality {
    ...
    static {
        ConstantQuality constantQualityOf = ConstantQuality.of(4, "SD", Collections.unmodifiableList(Arrays.asList(new Size(720, 480), new Size(OlympusMakernoteDirectory.TAG_PREVIEW_IMAGE, 480))));
        ...
        ConstantQuality constantQualityOf3 = ConstantQuality.of(6, "FHD", Collections.singletonList(new Size(1920, PhotoshopDirectory.TAG_COUNT_INFORMATION)));
    ...
    public static abstract class ConstantQuality extends Quality {
        ...
        static ConstantQuality of(int i2, String str, List<Size> list) {
