...
public final class RecorderVideoCapabilities implements VideoCapabilities {
    ...
    RecorderVideoCapabilities(int i2, CameraInfoInternal cameraInfoInternal, Function<VideoEncoderConfig, VideoEncoderInfo> function) {
