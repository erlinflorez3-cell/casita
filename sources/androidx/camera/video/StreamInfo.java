...
public abstract class StreamInfo {
    ...
    static StreamInfo of(int i2, StreamState streamState) {
        return new AutoValue_StreamInfo(i2, streamState, null);
    }

    static StreamInfo of(int i2, StreamState streamState, SurfaceRequest.TransformationInfo transformationInfo) {
