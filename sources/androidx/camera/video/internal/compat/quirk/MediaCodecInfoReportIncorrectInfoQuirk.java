...
public class MediaCodecInfoReportIncorrectInfoQuirk implements Quirk {
    ...
    public boolean isUnSupportMediaCodecInfo(MediaFormat mediaFormat) {
        ...
        if (isFHDProblematicDevice()) {
            return mediaFormatResolver.isAvc() && mediaFormatResolver.isSize(1920, PhotoshopDirectory.TAG_COUNT_INFORMATION);
        }
        return false;
    }
    ...
    public static Set<Size> getExtraSupportedSizes() {
        if (isFHDProblematicDevice()) {
            return Collections.singleton(new Size(1920, PhotoshopDirectory.TAG_COUNT_INFORMATION));
        }
    ...
    private static class MediaFormatResolver {
        ...
        boolean isSize(int i2, int i3) {
            return this.mMediaFormat.getInteger("width") == i2 && this.mMediaFormat.getInteger("height") == i3;
        }
