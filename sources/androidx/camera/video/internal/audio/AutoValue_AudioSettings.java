...
final class AutoValue_AudioSettings extends AudioSettings {
    ...
    /* synthetic */ AutoValue_AudioSettings(int i2, int i3, int i4, int i5, AnonymousClass1 anonymousClass1) {
        this(i2, i3, i4, i5);
    }
    ...
    static final class Builder extends AudioSettings.Builder {
        ...
        /* synthetic */ Builder(AudioSettings audioSettings, AnonymousClass1 anonymousClass1) {
            this(audioSettings);
        }
