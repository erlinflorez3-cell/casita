...
public abstract class AudioSettings {
    public static final List<Integer> COMMON_SAMPLE_RATES = Collections.unmodifiableList(Arrays.asList(48000, 44100, 22050, 11025, Integer.valueOf(PhotoshopDirectory.TAG_LIGHTROOM_WORKFLOW), 4800));
    ...
    public static abstract class Builder {
        ...
        public abstract Builder setSampleRate(int i2);
