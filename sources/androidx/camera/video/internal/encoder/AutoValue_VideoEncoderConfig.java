...
final class AutoValue_VideoEncoderConfig extends VideoEncoderConfig {
    ...
    /* synthetic */ AutoValue_VideoEncoderConfig(String str, int i2, Timebase timebase, Size size, int i3, VideoEncoderDataSpace videoEncoderDataSpace, int i4, int i5, int i6, AnonymousClass1 anonymousClass1) {
        this(str, i2, timebase, size, i3, videoEncoderDataSpace, i4, i5, i6);
    }
