...
public final class DebugUtils {
    ...
    private static void dumpVideoCapabilities(StringBuilder sb, MediaCodecInfo.VideoCapabilities videoCapabilities, MediaFormat mediaFormat) {
        ...
        try {
            ...
            Preconditions.checkArgument(integer3 > 0);
            i2 = integer3;
        ...
        logToString(sb, "[VideoCaps] areSizeAndRateSupported for " + integer + "x" + integer2 + ", " + i2 + " = " + videoCapabilities.areSizeAndRateSupported(integer, integer2, i2));
    }
