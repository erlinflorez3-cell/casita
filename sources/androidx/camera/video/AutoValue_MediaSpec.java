...
final class AutoValue_MediaSpec extends MediaSpec {
    ...
    /* synthetic */ AutoValue_MediaSpec(VideoSpec videoSpec, AudioSpec audioSpec, int i2, AnonymousClass1 anonymousClass1) {
        this(videoSpec, audioSpec, i2);
    }
    ...
    static final class Builder extends MediaSpec.Builder {
        ...
        /* synthetic */ Builder(MediaSpec mediaSpec, AnonymousClass1 anonymousClass1) {
            this(mediaSpec);
        }
