...
public final class VideoCapture<T extends VideoOutput> extends UseCase {
    ...
    public static <T extends VideoOutput> VideoCapture<T> withOutput(T t2) {
        return new Builder((VideoOutput) Preconditions.checkNotNull(t2)).build();
    }
        ...
        this.mStreamInfoObserver = new Observable.Observer<StreamInfo>() { // from class: androidx.camera.video.VideoCapture.1
            ...
            public void onNewData(StreamInfo streamInfo) {
                ...
                if ((streamInfo2.getId() != -1 && streamInfo.getId() == -1) || (streamInfo2.getId() == -1 && streamInfo.getId() != -1)) {
                    ...
                    videoCapture2.updateSessionConfig(c$$ExternalSyntheticBackport0.m(new Object[]{videoCapture2.mSessionConfigBuilder.build()}));
                ...
                if (streamInfo2.getStreamState() != streamInfo.getStreamState()) {
                    ...
                    videoCapture4.updateSessionConfig(c$$ExternalSyntheticBackport0.m(new Object[]{videoCapture4.mSessionConfigBuilder.build()}));
    ...
    private SessionConfig.Builder createPipeline(final VideoCaptureConfig<T> videoCaptureConfig, StreamSpec streamSpec) {
        ...
        if (this.mNode != null) {
            ...
            surfaceEdge2.addOnInvalidatedListener(new Runnable() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m274lambda$createPipeline$1$androidxcameravideoVideoCapture(surfaceEdge2, cameraInternal, videoCaptureConfig, timebaseResolveTimebase);
                }
            });
            ...
            deferrableSurface.getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m275lambda$createPipeline$2$androidxcameravideoVideoCapture(deferrableSurface);
                }
        ...
        SessionConfig.CloseableErrorListener closeableErrorListener2 = new SessionConfig.CloseableErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda5
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                this.f$0.m276lambda$createPipeline$3$androidxcameravideoVideoCapture(sessionConfig, sessionError);
            }
        });
    ...
    /* JADX INFO: renamed from: lambda$createPipeline$2$androidx-camera-video-VideoCapture */
    /* synthetic */ void m275lambda$createPipeline$2$androidxcameravideoVideoCapture(DeferrableSurface deferrableSurface) {
        if (deferrableSurface == this.mDeferrableSurface) {
            clearPipeline();
        }
    }

    /* JADX INFO: renamed from: lambda$createPipeline$3$androidx-camera-video-VideoCapture */
    /* synthetic */ void m276lambda$createPipeline$3$androidxcameravideoVideoCapture(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        resetPipeline();
    }

    /* JADX INFO: renamed from: onAppEdgeInvalidated */
    public void m274lambda$createPipeline$1$androidxcameravideoVideoCapture(SurfaceEdge surfaceEdge, CameraInternal cameraInternal, VideoCaptureConfig<T> videoCaptureConfig, Timebase timebase) {
    ...
    /* JADX INFO: renamed from: androidx.camera.video.VideoCapture$1 */
    ...
    private static void addBySupportedSize(Set<Size> set, int i2, int i3, Size size, VideoEncoderInfo videoEncoderInfo) {
        if (i2 <= size.getWidth() && i3 <= size.getHeight()) {
            try {
                set.add(new Size(i2, ((Integer) videoEncoderInfo.getSupportedHeightsFor(i2).clamp(Integer.valueOf(i3))).intValue()));
            } catch (IllegalArgumentException e2) {
                Logger.w(TAG, "No supportedHeights for width: " + i2, e2);
            }
            try {
                set.add(new Size(((Integer) videoEncoderInfo.getSupportedWidthsFor(i3).clamp(Integer.valueOf(i2))).intValue(), i3));
            } catch (IllegalArgumentException e3) {
                Logger.w(TAG, "No supportedWidths for height: " + i3, e3);
            }
        }
    }

    boolean isStreamIdChanged(int i2, int i3) {
        return (StreamInfo.NON_SURFACE_STREAM_ID.contains(Integer.valueOf(i2)) || StreamInfo.NON_SURFACE_STREAM_ID.contains(Integer.valueOf(i3)) || i2 == i3) ? false : true;
    }
    ...
    private static int alignDown(int i2, int i3, Range<Integer> range) {
        return align(true, i2, i3, range);
    }

    private static int alignUp(int i2, int i3, Range<Integer> range) {
        return align(false, i2, i3, range);
    }

    private static int align(boolean z2, int i2, int i3, Range<Integer> range) {
        int i4 = i2 % i3;
        if (i4 != 0) {
    ...
    private void setupSurfaceUpdateNotifier(final SessionConfig.Builder builder, boolean z2) {
        ListenableFuture<Void> listenableFuture = this.mSurfaceUpdateFuture;
        if (listenableFuture != null && listenableFuture.cancel(false)) {
            Logger.d(TAG, "A newer surface update is requested. Previous surface update cancelled.");
        }
        ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda1
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m277xc7537f7(builder, completer);
            }
        });
        ...
        Futures.addCallback(future, new FutureCallback<Void>() { // from class: androidx.camera.video.VideoCapture.3
            ...
            public void onSuccess(Void r3) {
                if (listenableFuture != VideoCapture.this.mSurfaceUpdateFuture || VideoCapture.this.mSourceState == VideoOutput.SourceState.INACTIVE) {
                    return;
                }
    ...
    /* JADX INFO: renamed from: lambda$setupSurfaceUpdateNotifier$6$androidx-camera-video-VideoCapture */
    /* synthetic */ Object m277xc7537f7(final SessionConfig.Builder builder, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    class AnonymousClass2 extends CameraCaptureCallback {
        ...
        public void onCaptureCompleted(int i2, CameraCaptureResult cameraCaptureResult) {
            ...
            scheduledExecutorServiceMainThreadExecutor.execute(new Runnable() { // from class: androidx.camera.video.VideoCapture$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m278lambda$onCaptureCompleted$0$androidxcameravideoVideoCapture$2(builder);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onCaptureCompleted$0$androidx-camera-video-VideoCapture$2 */
        /* synthetic */ void m278lambda$onCaptureCompleted$0$androidxcameravideoVideoCapture$2(SessionConfig.Builder builder) {
    ...
    /* JADX INFO: renamed from: androidx.camera.video.VideoCapture$3 */
    ...
    private static <T> T fetchObservableValue(Observable<T> observable, T t2) {
    ...
    public static final class Builder<T extends VideoOutput> implements UseCaseConfig.Builder<VideoCapture<T>, VideoCaptureConfig<T>, Builder<T>>, ImageOutputConfig.Builder<Builder<T>>, ImageInputConfig.Builder<Builder<T>>, ThreadConfig.Builder<Builder<T>> {
        ...
        private static <T extends VideoOutput> MutableOptionsBundle createInitialBundle(T t2) {
            MutableOptionsBundle mutableOptionsBundleCreate = MutableOptionsBundle.create();
            mutableOptionsBundleCreate.insertOption(VideoCaptureConfig.OPTION_VIDEO_OUTPUT, t2);
