...
public class FlatBufferBuilder {
    ...
    static ByteBuffer growByteBuffer(ByteBuffer byteBuffer, ByteBufferFactory byteBufferFactory) {
        ...
        if (((-1073741824) + iCapacity) - ((-1073741824) | iCapacity) == 0) {
    ...
    public void prep(int i2, int i3) {
        ...
        int i4 = (~((this.bb.capacity() - this.space) + i3)) + 1;
        int i5 = i2 - 1;
        int i6 = (i4 + i5) - (i4 | i5);
        while (this.space < i6 + i2 + i3) {
    ...
    protected void finish(int i2, boolean z2) {
    ...
    protected void finish(int i2, String str, boolean z2) {
