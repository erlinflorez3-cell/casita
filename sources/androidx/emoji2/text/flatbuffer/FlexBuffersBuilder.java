...
public class FlexBuffersBuilder {
    ...
    private Value createVector(int i2, int i3, int i4, boolean z2, boolean z3, Value value) {
        ...
        int i8 = 4;
        for (int i9 = i7; i9 < this.stack.size(); i9++) {
            iMax = Math.max(iMax, this.stack.get(i9).elemWidth(this.bb.writePosition(), i9 + i5));
            if (z2 && i9 == i7) {
                i8 = this.stack.get(i9).type;
        ...
        int iWritePosition = this.bb.writePosition();
        for (int i10 = i7; i10 < this.stack.size(); i10++) {
            writeAny(this.stack.get(i10), iAlign);
        }
        if (!z2) {
            while (i7 < this.stack.size()) {
                this.bb.put(this.stack.get(i7).storedPackedType(iMax));
                i7++;
            }
        }
        if (value != null) {
            ...
            typedVector = FlexBuffers.toTypedVector(i8, i6);
        } else {
            typedVector = 10;
        }
        return new Value(i2, typedVector, iMax, iWritePosition);
    }
