...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    static RoundRectHelper sRoundRectHelper = null;
    ...
    void setAddPaddingForCorners(boolean z2) {
    ...
    private void buildShadowCorners() {
        ...
        paint2.setShader(new LinearGradient(0.0f, f9, 0.0f, f10, new int[]{i3, i3, this.mShadowEndColor}, new float[]{0.0f, 0.5f, 1.0f}, Shader.TileMode.CLAMP));
