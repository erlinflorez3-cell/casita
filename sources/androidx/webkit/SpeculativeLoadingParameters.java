...
public final class SpeculativeLoadingParameters {
    ...
    private SpeculativeLoadingParameters(Map<String, String> map, NoVarySearchHeader noVarySearchHeader, boolean z2) {
    ...
    public static final class Builder {
        ...
        public Builder setJavaScriptEnabled(boolean z2) {
            this.mIsJavaScriptEnabled = z2;
            return this;
        }
    }
