...
public abstract class LongList {
    ...
    public final long elementAt(int i2) {
        if (i2 < 0 || i2 >= this._size) {
            throw new IndexOutOfBoundsException("Index " + i2 + " must be in 0.." + (this._size - 1));
        }
        return this.content[i2];
    ...
    public final long elementAtOrElse(int i2, Function1<? super Integer, Long> defaultValue) {
    ...
    public static /* synthetic */ String joinToString$default(LongList longList, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i2, CharSequence charSequence4, int i3, Object obj) {
        ...
        return longList.joinToString(charSequence, charSequence2, charSequence3, i2, charSequence4);
    }
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int i2, CharSequence truncated, Function1<? super Long, ? extends CharSequence> transform) {
        Intrinsics.checkNotNullParameter(separator, "separator");
        Intrinsics.checkNotNullParameter(prefix, "prefix");
        Intrinsics.checkNotNullParameter(postfix, "postfix");
        Intrinsics.checkNotNullParameter(truncated, "truncated");
    ...
    public final <R> R fold(R r2, Function2<? super R, ? super Long, ? extends R> operation) {
        Intrinsics.checkNotNullParameter(operation, "operation");
        long[] jArr = this.content;
        int i2 = this._size;
        for (int i3 = 0; i3 < i2; i3++) {
            r2 = operation.invoke(r2, Long.valueOf(jArr[i3]));
        }
        return r2;
    }

    public final <R> R foldIndexed(R r2, Function3<? super Integer, ? super R, ? super Long, ? extends R> operation) {
        Intrinsics.checkNotNullParameter(operation, "operation");
        long[] jArr = this.content;
        int i2 = this._size;
        for (int i3 = 0; i3 < i2; i3++) {
            R r3 = r2;
            r2 = operation.invoke(Integer.valueOf(i3), r3, Long.valueOf(jArr[i3]));
        }
        return r2;
    }

    public final <R> R foldRight(R r2, Function2<? super Long, ? super R, ? extends R> operation) {
        Intrinsics.checkNotNullParameter(operation, "operation");
        long[] jArr = this.content;
        for (int i2 = this._size - 1; -1 < i2; i2--) {
            r2 = operation.invoke(Long.valueOf(jArr[i2]), r2);
        }
        return r2;
    }

    public final <R> R foldRightIndexed(R r2, Function3<? super Integer, ? super Long, ? super R, ? extends R> operation) {
        Intrinsics.checkNotNullParameter(operation, "operation");
        long[] jArr = this.content;
        for (int i2 = this._size - 1; -1 < i2; i2--) {
            r2 = operation.invoke(Integer.valueOf(i2), Long.valueOf(jArr[i2]), r2);
        }
        return r2;
    }
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int i2, Function1<? super Long, ? extends CharSequence> transform) {
        Intrinsics.checkNotNullParameter(separator, "separator");
        Intrinsics.checkNotNullParameter(prefix, "prefix");
        Intrinsics.checkNotNullParameter(postfix, "postfix");
        Intrinsics.checkNotNullParameter(transform, "transform");
