...
class FindAddress {
    ...
    private static boolean checkHouseNumber(String str) {
        ...
        if (i5 == 2) {
            return lowerCase.equals(i4 % 100 != 12 ? Constants.BRAZE_PUSH_NOTIFICATION_DURATION_KEY : "th");
        }
        if (i5 != 3) {
    ...
    */
    private static int attemptMatch(java.lang.String r15, java.util.regex.MatchResult r16) {
        /*
