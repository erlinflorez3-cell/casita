...
public final class LinkifyCompat {
    ...
    private static String makeUrl(String str, String[] strArr, Matcher matcher, Linkify.TransformFilter transformFilter) {
        ...
        if (transformFilter != null) {
            strTransformUrl = transformFilter.transformUrl(matcher, strTransformUrl);
        }
        ...
        while (true) {
            ...
            String str2 = strArr[i2];
            if (strTransformUrl.regionMatches(true, 0, str2, 0, str2.length())) {
                z2 = true;
                if (!strTransformUrl.regionMatches(false, 0, str2, 0, str2.length())) {
                    strTransformUrl = str2 + strTransformUrl.substring(str2.length());
                }
            } else {
                i2++;
            }
        }
        return (z2 || strArr.length <= 0) ? strTransformUrl : strArr[0] + strTransformUrl;
    }
