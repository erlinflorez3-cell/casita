...
public class WindowInsetsCompat {
    ...
    private static class Impl20 extends Impl {
        ...
        static boolean systemBarVisibilityEquals(int i2, int i3) {
            return (i2 + 6) - (i2 | 6) == (-1) - (((-1) - i3) | ((-1) - 6));
        }
        ...
        boolean isVisible(int i2) {
            for (int i3 = 1; i3 <= 512; i3 <<= 1) {
                if ((-1) - (((-1) - i2) | ((-1) - i3)) != 0 && !isTypeVisible(i3)) {
                    return false;
                }
            }
            return true;
        ...
        static int toPlatformType(int i2) {
            ...
            for (int i4 = 1; i4 <= 512; i4 <<= 1) {
                if ((i2 + i4) - (i2 | i4) != 0) {
                    ...
                    i3 = (i3 + iStatusBars) - (i3 & iStatusBars);
                }
            }
            return i3;
        }
    ...
    static class Api21ReflectionHolder {
        ...
        private static boolean sReflectionSucceeded = false;
