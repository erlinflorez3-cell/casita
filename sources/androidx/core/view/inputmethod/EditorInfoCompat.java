...
public final class EditorInfoCompat {
    ...
    private static void trimLongSurroundingText(EditorInfo editorInfo, CharSequence charSequence, int i2, int i3) {
        ...
        setSurroundingText(editorInfo, charSequenceSubSequence, iMin2, i5 + iMin2);
    }
    ...
    public static CharSequence getInitialSelectedText(EditorInfo editorInfo, int i2) {
        ...
        return (i2 + 1) - (i2 | 1) != 0 ? charSequence.subSequence(i3, i4) : TextUtils.substring(charSequence, i3, i4);
    }
    ...
    private static class Api35Impl {
        ...
        static void setStylusHandwritingEnabled(EditorInfo editorInfo, boolean z2) {
