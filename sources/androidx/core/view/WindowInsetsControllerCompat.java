...
public final class WindowInsetsControllerCompat {
    ...
    private static class Impl20 extends Impl {
        ...
        protected void setSystemUiFlag(int i2) {
            ...
            decorView.setSystemUiVisibility((i2 + systemUiVisibility) - (i2 & systemUiVisibility));
        }
        ...
        protected void unsetSystemUiFlag(int i2) {
            ...
            int systemUiVisibility = decorView.getSystemUiVisibility();
            int i3 = ~i2;
            decorView.setSystemUiVisibility((i3 + systemUiVisibility) - (i3 | systemUiVisibility));
        }
    ...
    static class Impl30 extends Impl {
        ...
        void show(int i2) {
            ...
            this.mInsetsController.show((i2 - 9) - (i2 | (-9)));
        }
        ...
        public boolean isAppearanceLightStatusBars() {
            ...
            return (-1) - (((-1) - this.mInsetsController.getSystemBarsAppearance()) | ((-1) - 8)) != 0;
        }
        ...
        void addOnControllableInsetsChangedListener(final OnControllableInsetsChangedListener onControllableInsetsChangedListener) {
            ...
            WindowInsetsController.OnControllableInsetsChangedListener onControllableInsetsChangedListener2 = new WindowInsetsController.OnControllableInsetsChangedListener() { // from class: androidx.core.view.WindowInsetsControllerCompat$Impl30$$ExternalSyntheticLambda0
                ...
                public final void onControllableInsetsChanged(WindowInsetsController windowInsetsController, int i2) {
                    this.f$0.m6929xe96d8c51(onControllableInsetsChangedListener, windowInsetsController, i2);
                }
            };
        ...
        /* synthetic */ void m6929xe96d8c51(OnControllableInsetsChangedListener onControllableInsetsChangedListener, WindowInsetsController windowInsetsController, int i2) {
        ...
        protected void unsetSystemUiFlag(int i2) {
            View decorView = this.mWindow.getDecorView();
            decorView.setSystemUiVisibility((-1) - (((-1) - (~i2)) | ((-1) - decorView.getSystemUiVisibility())));
        }
    ...
    private static class Impl35 extends Impl31 {
        ...
        @Override // androidx.core.view.WindowInsetsControllerCompat.Impl30, androidx.core.view.WindowInsetsControllerCompat.Impl
        public boolean isAppearanceLightNavigationBars() {
            int systemBarsAppearance = this.mInsetsController.getSystemBarsAppearance();
            return (systemBarsAppearance + 16) - (systemBarsAppearance | 16) != 0;
        }
    }
}
