...
public class NestedScrollingChildHelper {
    ...
    private boolean dispatchNestedScrollInternal(int i2, int i3, int i4, int i5, int[] iArr, int i6, int[] iArr2) {
        ...
        int i7;
        int i8;
        int[] tempNestedScrollConsumed = iArr2;
        ...
        if (tempNestedScrollConsumed == null) {
            tempNestedScrollConsumed = getTempNestedScrollConsumed();
            tempNestedScrollConsumed[0] = 0;
            tempNestedScrollConsumed[1] = 0;
        }
        ViewParentCompat.onNestedScroll(nestedScrollingParentForType, this.mView, i2, i3, i4, i5, i6, tempNestedScrollConsumed);
        if (iArr != null) {
            this.mView.getLocationInWindow(iArr);
            iArr[0] = iArr[0] - i7;
            iArr[1] = iArr[1] - i8;
    ...
    public boolean dispatchNestedPreScroll(int i2, int i3, int[] iArr, int[] iArr2, int i4) {
        ...
        int i5;
        int i6;
        int[] tempNestedScrollConsumed = iArr;
        ...
        tempNestedScrollConsumed[0] = 0;
        tempNestedScrollConsumed[1] = 0;
        ViewParentCompat.onNestedPreScroll(nestedScrollingParentForType, this.mView, i2, i3, tempNestedScrollConsumed, i4);
        if (iArr2 != null) {
            this.mView.getLocationInWindow(iArr2);
            iArr2[0] = iArr2[0] - i5;
            iArr2[1] = iArr2[1] - i6;
