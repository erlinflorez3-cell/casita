...
public final class ComplexColorCompat {
    ...
    static ComplexColorCompat from(int i2) {
    ...
    private static ComplexColorCompat createFromXml(Resources resources, int i2, Resources.Theme theme) throws XmlPullParserException, IOException {
        int next;
