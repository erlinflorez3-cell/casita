...
public class IntentSanitizer {
    ...
    public Intent sanitize(Intent intent, Consumer<String> consumer) {
        ...
        int i3 = (i2 + flags) - (i2 & flags);
        int i4 = this.mAllowedFlags;
        if (i3 == i4) {
            intent2.setFlags(intent.getFlags());
        } else {
            int flags2 = intent.getFlags();
            intent2.setFlags((flags2 + i4) - (flags2 | i4));
            ...
            consumer.accept(sb.append(Integer.toHexString((flags3 + i5) - (flags3 | i5))).toString());
        }
    ...
    public static final class Builder {
        ...
        public Builder allowHistoryStackFlags() {
            this.mAllowedFlags = (-1) - (((-1) - this.mAllowedFlags) & ((-1) - HISTORY_STACK_FLAGS));
            return this;
        }
    ...
    */
    static void sanitizeClipData(android.content.Intent r8, android.content.Intent r9, androidx.core.util.Predicate<android.content.ClipData> r10, boolean r11, androidx.core.util.Predicate<android.net.Uri> r12, androidx.core.util.Consumer<java.lang.String> r13) {
        /*
    ...
    private static class Api31Impl {
        ...
        static void checkOtherMembers(int i2, ClipData.Item item, Consumer<String> consumer) {
