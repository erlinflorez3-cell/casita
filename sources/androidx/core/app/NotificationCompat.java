...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder setLights(int i2, int i3, int i4) {
            ...
            int i7 = (i6 - 2) - (i6 | (-2));
            notification.flags = (i5 + i7) - (i5 & i7);
            return this;
        }
        ...
        private void setFlag(int i2, boolean z2) {
            if (z2) {
                Notification notification = this.mNotification;
                int i3 = notification.flags;
                notification.flags = (i2 + i3) - (i2 & i3);
            } else {
    ...
    public static abstract class Style {
        ...
        */
        public android.widget.RemoteViews applyStandardTemplate(boolean r21, int r22, boolean r23) throws java.lang.Throwable {
            /*
        ...
        private Bitmap createIconWithBackground(int i2, int i3, int i4, int i5) throws Throwable {
            ...
            Method method = Class.forName(Jg.Wd("9O\u0012\u001b\\b\u001b+h,;\n0E\u0019N(]\u001dkS-9", (short) (OY.Xd() ^ 17493), (short) (OY.Xd() ^ 385))).getMethod(ZO.xd(" P\t\u0019c\u001aytKo\u0013e", (short) (C1499aX.Xd() ^ (-3277)), (short) (C1499aX.Xd() ^ (-25705))), new Class[0]);
            try {
                method.setAccessible(true);
                Drawable drawableMutate = ((Resources) method.invoke(context, objArr)).getDrawable(i2).mutate();
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) throws Throwable {
        ...
        private int calculateTopPadding() throws Throwable {
            Context context = this.mBuilder.mContext;
            Object[] objArr = new Object[0];
            Method method = Class.forName(C1561oA.Yd("SaXge`\\']jjqcmt/Erryk\u007f|", (short) (FB.Xd() ^ 13354))).getMethod(Xg.qd("87G&:IFMK=@O", (short) (C1580rY.Xd() ^ (-14506)), (short) (C1580rY.Xd() ^ (-4651))), new Class[0]);
            try {
                method.setAccessible(true);
    ...
    public static class MessagingStyle extends Style {
        ...
        public boolean isGroupConversation() throws Throwable {
            Object obj;
            if (this.mBuilder != null) {
                Context context = this.mBuilder.mContext;
                short sXd = (short) (C1499aX.Xd() ^ (-16003));
                int[] iArr = new int["'3,9920x1<>C7?H\u0001x$&+\u001f10".length()];
                QB qb = new QB("'3,9920x1<>C7?H\u0001x$&+\u001f10");
                int i2 = 0;
                while (qb.YK()) {
                    int iKK = qb.KK();
                    Xu xuXd = Xu.Xd(iKK);
                ...
                Object[] objArr = new Object[0];
                Method method = Class.forName(new String(iArr, 0, i2)).getMethod(C1561oA.Yd("JIY'WXUSNMaW^^:`Yc", (short) (OY.Xd() ^ 82)), new Class[0]);
                try {
                    method.setAccessible(true);
                    ApplicationInfo applicationInfo = (ApplicationInfo) method.invoke(context, objArr);
                    String strQd = Xg.qd("JXO^\\WS\u001eTaahZdk&ig)=mnkidcwmttPvoy", (short) (C1499aX.Xd() ^ (-29770)), (short) (C1499aX.Xd() ^ (-30795)));
                    String strWd = Jg.Wd("\u000bD\u0004A2y'#z\u001c\u001cs%\u0012j\u0012", (short) (OY.Xd() ^ 16919), (short) (OY.Xd() ^ 11282));
                    try {
        ...
        private Message findLatestIncomingMessage() {
            ...
            return this.mMessages.get(r1.size() - 1);
        }
        ...
        public static final class Message {
            ...
            static class Api24Impl {
                ...
                static Notification.MessagingStyle.Message createMessage(CharSequence charSequence, long j2, CharSequence charSequence2) {
            ...
            static class Api28Impl {
                ...
                static Notification.MessagingStyle.Message createMessage(CharSequence charSequence, long j2, android.app.Person person) {
        ...
        static class Api28Impl {
            ...
            static Notification.MessagingStyle setGroupConversation(Notification.MessagingStyle messagingStyle, boolean z2) {
    ...
    public static class CallStyle extends Style {
        ...
        public CallStyle setAnswerButtonColorHint(int i2) {
            this.mAnswerButtonColor = Integer.valueOf(i2);
            return this;
        }

        public CallStyle setDeclineButtonColorHint(int i2) {
        ...
        @Override // androidx.core.app.NotificationCompat.Style
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) throws Throwable {
        ...
        private String getDefaultText() throws Throwable {
            int i2 = this.mCallType;
            if (i2 != 1) {
                if (i2 == 2) {
                    Context context = this.mBuilder.mContext;
                    Object[] objArr = new Object[0];
                    Method method = Class.forName(Wg.vd("'3,91*(p1<>C/7@xx$&+\u0017)(", (short) (OY.Xd() ^ 12034))).getMethod(Qg.kd("\u001d\u001a(\u0005\u0017$\u001f$ \u0010\u0011\u001e", (short) (C1580rY.Xd() ^ (-15589)), (short) (C1580rY.Xd() ^ (-8843))), new Class[0]);
                    try {
                        method.setAccessible(true);
                        return ((Resources) method.invoke(context, objArr)).getString(R.string.call_notification_ongoing_text);
                    } catch (InvocationTargetException e2) {
                        throw e2.getCause();
                    }
                }
                ...
                Method method2 = Class.forName(Wg.Zd("?^*}S\u0013csz\u001d`<vV\"1\u0017H\u001dm4\r]", (short) (C1499aX.Xd() ^ (-17872)), (short) (C1499aX.Xd() ^ (-4784)))).getMethod(C1561oA.Xd("feuThwt{ykn}", (short) (C1580rY.Xd() ^ (-10654))), new Class[0]);
                try {
                    method2.setAccessible(true);
                    return ((Resources) method2.invoke(context2, objArr2)).getString(R.string.call_notification_screening_text);
                } catch (InvocationTargetException e3) {
                    throw e3.getCause();
                }
            }
            Context context3 = this.mBuilder.mContext;
            short sXd = (short) (C1633zX.Xd() ^ (-5542));
            short sXd2 = (short) (C1633zX.Xd() ^ (-29058));
            int[] iArr = new int["\u000b\u0017\f\u0019\u0015\u000e\bP\u0005\u0010\u000e\u0013\u0003\u000b\u0010H\\\b\u0006\u000bz\r\b".length()];
            QB qb = new QB("\u000b\u0017\f\u0019\u0015\u000e\bP\u0005\u0010\u000e\u0013\u0003\u000b\u0010H\\\b\u0006\u000bz\r\b");
            int i3 = 0;
            while (qb.YK()) {
                int iKK = qb.KK();
                Xu xuXd = Xu.Xd(iKK);
            ...
            Method method3 = Class.forName(new String(iArr, 0, i3)).getMethod(C1561oA.ud("XUc@R_Z_[KLY", (short) (C1580rY.Xd() ^ (-1911))), new Class[0]);
            try {
                method3.setAccessible(true);
                return ((Resources) method3.invoke(context3, objArr3)).getString(R.string.call_notification_incoming_text);
        ...
        private Action makeNegativeAction() {
            ...
            if (this.mDeclineIntent == null) {
                return makeAction(i3, R.string.call_notification_hang_up_action, this.mDeclineButtonColor, R.color.call_notification_decline_color, this.mHangUpIntent);
            }
            return makeAction(i3, R.string.call_notification_decline_action, this.mDeclineButtonColor, R.color.call_notification_decline_color, this.mDeclineIntent);
        }

        private Action makeAnswerAction() {
            int i2;
            int i3 = R.drawable.ic_call_answer_video_low;
            int i4 = R.drawable.ic_call_answer_low;
            ...
            return makeAction(i5, i2, this.mAnswerButtonColor, R.color.call_notification_answer_color, this.mAnswerIntent);
        }

        private Action makeAction(int i2, int i3, Integer num, int i4, PendingIntent pendingIntent) throws Throwable {
            if (num == null) {
            ...
            Context context = this.mBuilder.mContext;
            Object[] objArr = new Object[0];
            Method method = Class.forName(C1561oA.yd("\u000e\u001a\u000f\u001c \u0019\u0013[\b\u0013\u0011\u0016\u000e\u0016\u001bS\u007f+).&83", (short) (ZN.Xd() ^ 16731))).getMethod(C1561oA.Yd("\u0012\u0011!\u007f\u0014# '%\u0017\u001a)", (short) (ZN.Xd() ^ 31731)), new Class[0]);
            try {
                method.setAccessible(true);
                spannableStringBuilder.append((CharSequence) ((Resources) method.invoke(context, objArr)).getString(i3));
                ...
                actionBuild.getExtras().putBoolean(Xg.qd("yt\npsv\t~\u0006\u0006w\n\r\u0005\f\u0010\b\u0014\u001a", (short) (C1633zX.Xd() ^ (-32231)), (short) (C1633zX.Xd() ^ (-12411))), true);
                return actionBuild;
            } catch (InvocationTargetException e2) {
                throw e2.getCause();
            }
        ...
        static class Api20Impl {
            ...
            static Notification.Action.Builder createActionBuilder(int i2, CharSequence charSequence, PendingIntent pendingIntent) {
        ...
        static class Api31Impl {
            ...
            static Notification.CallStyle setIsVideo(Notification.CallStyle callStyle, boolean z2) {
            ...
            static Notification.CallStyle setAnswerButtonColorHint(Notification.CallStyle callStyle, int i2) {
                return callStyle.setAnswerButtonColorHint(i2);
            }

            static Notification.CallStyle setDeclineButtonColorHint(Notification.CallStyle callStyle, int i2) {
                return callStyle.setDeclineButtonColorHint(i2);
            }

            static Notification.Action.Builder setAuthenticationRequired(Notification.Action.Builder builder, boolean z2) {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        public static List<CharSequence> getTextsFromContentView(Context context, Notification notification) throws Throwable {
            RemoteViews remoteViews;
            Object obj;
            Bundle bundle = notification.extras;
            short sXd = (short) (C1607wl.Xd() ^ 24335);
            short sXd2 = (short) (C1607wl.Xd() ^ 4178);
            int[] iArr = new int["\u0002D?_I\b/9Z}qJ\b`\n6".length()];
            QB qb = new QB("\u0002D?_I\b/9Z}qJ\b`\n6");
            int i2 = 0;
            while (qb.YK()) {
                int iKK = qb.KK();
                Xu xuXd = Xu.Xd(iKK);
            ...
            if (!Notification.DecoratedCustomViewStyle.class.getName().equals(bundle.getString(new String(iArr, 0, i2)))) {
            ...
            try {
                Class<?> cls = Class.forName(Ig.wd("\u0015Np1s\u001891\u001f\u000e\u0005v\u0018\u001dMg#S\th\u0012kW", (short) (Od.Xd() ^ (-24760))));
                Class<?>[] clsArr = new Class[2];
                short sXd3 = (short) (Od.Xd() ^ (-32385));
                int[] iArr2 = new int["A\u000fs9\u001f\u0002%T\u00049b_H7\u001e3".length()];
                QB qb2 = new QB("A\u000fs9\u001f\u0002%T\u00049b_H7\u001e3");
                int i3 = 0;
                while (qb2.YK()) {
                    int iKK2 = qb2.KK();
                    Xu xuXd2 = Xu.Xd(iKK2);
                ...
                Object[] objArr = {str, 0};
                Method method = cls.getMethod(C1561oA.Qd(")7)$6&\u0010 !(\u001d\"\u001f{'%*\u001a,'", (short) (Od.Xd() ^ (-24700))), clsArr);
                try {
                    method.setAccessible(true);
                    Context context2 = (Context) method.invoke(context, objArr);
                    Object[] objArr2 = new Object[0];
                    Method method2 = Class.forName(C1593ug.zd("TbYhfa](^kkrdnu0Fsszl\u0001}", (short) (Od.Xd() ^ (-22848)), (short) (Od.Xd() ^ (-10229)))).getMethod(C1561oA.od("OLZ5EFMBGD+>J<A>J", (short) (C1607wl.Xd() ^ 7351)), new Class[0]);
                    try {
                        method2.setAccessible(true);
                        PackageManager packageManager = (PackageManager) method2.invoke(context, objArr2);
                        Class<?> cls2 = Class.forName(C1561oA.Kd("IWN][VR\u001dS``gYcj%hf(K]`i`gfOdrfmlz", (short) (C1499aX.Xd() ^ (-26695))));
                        Class<?>[] clsArr2 = new Class[2];
                        clsArr2[0] = Class.forName(Wg.Zd("r<\u0017R|\bJ1~\u0013\u000e\u0001L\u0014r4", (short) (C1633zX.Xd() ^ (-30986)), (short) (C1633zX.Xd() ^ (-10510))));
                        clsArr2[1] = Integer.TYPE;
                        Object[] objArr3 = {str, 0};
                        Method method3 = cls2.getMethod(C1561oA.Xd(" \u001f/|-.+)$#7-44\u00106/9", (short) (Od.Xd() ^ (-24034))), clsArr2);
                        try {
                            method3.setAccessible(true);
                            ApplicationInfo applicationInfo = (ApplicationInfo) method3.invoke(packageManager, objArr3);
                            short sXd4 = (short) (C1499aX.Xd() ^ (-6038));
                            int[] iArr3 = new int["x\u0005}\u000b\u000b\u0004\u0002Jr}\u007f\u0005x\u0001\nBws7I{zyub_uirpNr]e".length()];
                            QB qb3 = new QB("x\u0005}\u000b\u000b\u0004\u0002Jr}\u007f\u0005x\u0001\nBws7I{zyub_uirpNr]e");
                            int i4 = 0;
                            while (qb3.YK()) {
                                int iKK3 = qb3.KK();
                                Xu xuXd3 = Xu.Xd(iKK3);
                            ...
                            String strKd = Qg.kd("\u0018\u000b\u0007\u000e\u0005", (short) (OY.Xd() ^ 15000), (short) (OY.Xd() ^ 4780));
                            try {
                                Class<?> cls3 = Class.forName(str2);
                                Field field = 1 != 0 ? cls3.getField(strKd) : cls3.getDeclaredField(strKd);
                                field.setAccessible(true);
                                obj = field.get(applicationInfo);
                            } catch (Throwable th) {
                                obj = null;
                            ...
                            Class<?> cls4 = Class.forName(hg.Vd("6B7D@93{0;9>.6;s\b316&83", (short) (C1499aX.Xd() ^ (-2390)), (short) (C1499aX.Xd() ^ (-13683))));
                            Class<?>[] clsArr3 = {Integer.TYPE};
                            Object[] objArr4 = {Integer.valueOf(iIntValue)};
                            Method method4 = cls4.getMethod(C1561oA.ud("?0>\u001d0,3*", (short) (Od.Xd() ^ (-2630))), clsArr3);
                            try {
                                method4.setAccessible(true);
                                method4.invoke(context2, objArr4);
                                View viewApply = remoteViews.apply(context2, null);
        ...
        private RemoteViews generateActionButton(Action action) throws Throwable {
            int i2;
            boolean z2 = action.actionIntent == null;
            Context context = this.mBuilder.mContext;
            Object[] objArr = new Object[0];
            Method method = Class.forName(Jg.Wd("\u0017M\\\u0013ir_x?{\u0014CL^\\(L*ApyVK", (short) (ZN.Xd() ^ 12130), (short) (ZN.Xd() ^ 30154))).getMethod(ZO.xd("URcL\u0004)/z8\u0015\u0016O\u0017X", (short) (ZN.Xd() ^ HttpStatus.SC_REQUEST_URI_TOO_LONG), (short) (ZN.Xd() ^ 23313)), new Class[0]);
            try {
                method.setAccessible(true);
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m6904clone() {
            ...
            private void setFlag(int i2, boolean z2) {
                if (z2) {
                    int i3 = this.mFlags;
                    this.mFlags = (i2 + i3) - (i2 & i3);
                } else {
                    this.mFlags = (-1) - (((-1) - (~i2)) | ((-1) - this.mFlags));
                }
            }
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* JADX INFO: renamed from: clone */
        public WearableExtender m6905clone() {
            WearableExtender wearableExtender = new WearableExtender();
        ...
        static class Api20Impl {
            ...
            static Notification.Action.Builder createBuilder(int i2, CharSequence charSequence, PendingIntent pendingIntent) {
                return new Notification.Action.Builder(i2, charSequence, pendingIntent);
            }
    ...
    public static final class CarExtender implements Extender {
        ...
        static class Api20Impl {
            ...
            static RemoteInput.Builder setAllowFreeFormInput(RemoteInput.Builder builder, boolean z2) {
    ...
    public static final class BubbleMetadata {
        ...
        /* synthetic */ BubbleMetadata(PendingIntent pendingIntent, PendingIntent pendingIntent2, IconCompat iconCompat, int i2, int i3, int i4, String str, AnonymousClass1 anonymousClass1) {
    ...
    @InterfaceC1492Gx
    @ReplaceWith(expression = "\u00129+\u001c\u0004i`JLF9$\u001e9H3\u001dpo", imports = {})
    @Deprecated
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i2 = 0; i2 < remoteInputs.length; i2++) {
                ...
                remoteInputArr[i2] = new RemoteInput(Api20Impl.getResultKey(remoteInput), Api20Impl.getLabel(remoteInput), Api20Impl.getChoices(remoteInput), Api20Impl.getAllowFreeFormInput(remoteInput), Build.VERSION.SDK_INT >= 29 ? Api29Impl.getEditChoicesBeforeSending(remoteInput) : 0, Api20Impl.getExtras(remoteInput), null);
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            zIsContextual = Api29Impl.isContextual(action);
        } else {
            zIsContextual = false;
        }
    ...
    public static boolean getLocalOnly(Notification notification) {
        return (-1) - (((-1) - notification.flags) | ((-1) - 256)) != 0;
    }
    ...
    public static boolean getAutoCancel(Notification notification) {
        return (-1) - (((-1) - notification.flags) | ((-1) - 16)) != 0;
    }
    ...
    public static boolean isGroupSummary(Notification notification) {
        return (-1) - (((-1) - notification.flags) | ((-1) - 512)) != 0;
    }
    ...
    public static Bitmap reduceLargeIconSize(Context context, Bitmap bitmap) throws Throwable {
        if (bitmap != null && Build.VERSION.SDK_INT < 27) {
            Object[] objArr = new Object[0];
            Method method = Class.forName(ZO.xd("\u0019oq \u0014>%`Y`!>y\f\tTnaABw\n,", (short) (OY.Xd() ^ 20843), (short) (OY.Xd() ^ 26056))).getMethod(C1626yg.Ud("Z\u000e\u0011_./@\u001aa\u000f\u001d#", (short) (C1580rY.Xd() ^ (-22112)), (short) (C1580rY.Xd() ^ (-14021))), new Class[0]);
            try {
                method.setAccessible(true);
                Resources resources = (Resources) method.invoke(context, objArr);
