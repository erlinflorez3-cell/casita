...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    NotificationCompatBuilder(NotificationCompat.Builder builder) {
        ...
        Notification.Builder lights = builderCreateBuilder.setWhen(notification.when).setSmallIcon(notification.icon, notification.iconLevel).setContent(notification.contentView).setTicker(notification.tickerText, builder.mTickerView).setVibrate(notification.vibrate).setLights(notification.ledARGB, notification.ledOnMS, notification.ledOffMS);
        int i2 = notification.flags;
        lights.setOngoing((i2 + 2) - (i2 | 2) != 0).setOnlyAlertOnce((notification.flags & 8) != 0).setAutoCancel((notification.flags & 16) != 0).setDefaults(notification.defaults).setContentTitle(builder.mContentTitle).setContentText(builder.mContentText).setContentInfo(builder.mContentInfo).setContentIntent(builder.mContentIntent).setDeleteIntent(notification.deleteIntent).setFullScreenIntent(builder.mFullScreenIntent, (-1) - (((-1) - notification.flags) | ((-1) - 128)) != 0).setNumber(builder.mNumber).setProgress(builder.mProgressMax, builder.mProgress, builder.mProgressIndeterminate);
        ...
        if (builder.mInvisibleActions.size() > 0) {
            ...
            for (int i3 = 0; i3 < builder.mInvisibleActions.size(); i3++) {
                bundle3.putBundle(Integer.toString(i3), NotificationCompatJellybean.getBundleForAction(builder.mInvisibleActions.get(i3)));
            }
    ...
    static class Api20Impl {
        ...
        static Notification.Builder setGroupSummary(Notification.Builder builder, boolean z2) {
            return builder.setGroupSummary(z2);
        }

        static Notification.Builder setLocalOnly(Notification.Builder builder, boolean z2) {
    ...
    static class Api21Impl {
        ...
        static Notification.Builder setColor(Notification.Builder builder, int i2) {
            return builder.setColor(i2);
        }

        static Notification.Builder setVisibility(Notification.Builder builder, int i2) {
    ...
    static class Api26Impl {
        ...
        static Notification.Builder setGroupAlertBehavior(Notification.Builder builder, int i2) {
            return builder.setGroupAlertBehavior(i2);
        }

        static Notification.Builder setColorized(Notification.Builder builder, boolean z2) {
            return builder.setColorized(z2);
        }

        static Notification.Builder setBadgeIconType(Notification.Builder builder, int i2) {
        ...
        static Notification.Builder setTimeoutAfter(Notification.Builder builder, long j2) {
    ...
    static class Api28Impl {
        ...
        static Notification.Action.Builder setSemanticAction(Notification.Action.Builder builder, int i2) {
    ...
    static class Api29Impl {
        ...
        static Notification.Action.Builder setContextual(Notification.Action.Builder builder, boolean z2) {
        ...
        static Notification.Builder setAllowSystemGeneratedContextualActions(Notification.Builder builder, boolean z2) {
    ...
    static class Api31Impl {
        ...
        static Notification.Builder setForegroundServiceBehavior(Notification.Builder builder, int i2) {
