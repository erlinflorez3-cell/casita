...
public class NotificationChannelCompat {
    ...
    static class Api26Impl {
        ...
        static NotificationChannel createNotificationChannel(String str, CharSequence charSequence, int i2) {
        ...
        static void setShowBadge(NotificationChannel notificationChannel, boolean z2) {
        ...
        static void enableLights(NotificationChannel notificationChannel, boolean z2) {
        ...
        static void setLightColor(NotificationChannel notificationChannel, int i2) {
        ...
        static void enableVibration(NotificationChannel notificationChannel, boolean z2) {
