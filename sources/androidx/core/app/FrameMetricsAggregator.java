    ...
    private static class FrameMetricsApi24Impl extends FrameMetricsBaseImpl {
        ...
        Window.OnFrameMetricsAvailableListener mListener = new Window.OnFrameMetricsAvailableListener() { // from class: androidx.core.app.FrameMetricsAggregator.FrameMetricsApi24Impl.1
            ...
            public void onFrameMetricsAvailable(Window window, FrameMetrics frameMetrics, int i2) {
                int i3 = FrameMetricsApi24Impl.this.mTrackingFlags;
                if ((i3 + 1) - (i3 | 1) != 0) {
                ...
                if ((-1) - (((-1) - FrameMetricsApi24Impl.this.mTrackingFlags) | ((-1) - 2)) != 0) {
                ...
                int i4 = FrameMetricsApi24Impl.this.mTrackingFlags;
                if ((i4 + 4) - (i4 | 4) != 0) {
                ...
                int i5 = FrameMetricsApi24Impl.this.mTrackingFlags;
                if ((i5 + 8) - (i5 | 8) != 0) {
                ...
                if ((-1) - (((-1) - FrameMetricsApi24Impl.this.mTrackingFlags) | ((-1) - 16)) != 0) {
                ...
                int i6 = FrameMetricsApi24Impl.this.mTrackingFlags;
                if ((i6 + 64) - (i6 | 64) != 0) {
                ...
                int i7 = FrameMetricsApi24Impl.this.mTrackingFlags;
                if ((i7 + 32) - (i7 | 32) != 0) {
                ...
                int i8 = FrameMetricsApi24Impl.this.mTrackingFlags;
                if ((i8 + 128) - (i8 | 128) != 0) {
                ...
                if ((-1) - (((-1) - FrameMetricsApi24Impl.this.mTrackingFlags) | ((-1) - 256)) != 0) {
        ...
        void addDurationItem(SparseIntArray sparseIntArray, long j2) {
            if (sparseIntArray != null) {
                int i2 = (int) ((500000 + j2) / AnimationKt.MillisToNanos);
                if (j2 >= 0) {
