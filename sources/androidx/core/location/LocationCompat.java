...
public final class LocationCompat {
    ...
    private static Field sFieldsMaskField = null;
    private static Integer sHasBearingAccuracyMask = null;
    private static Integer sHasSpeedAccuracyMask = null;
    private static Integer sHasVerticalAccuracyMask = null;
    private static Method sSetIsFromMockProviderMethod = null;

    private LocationCompat() {
    }

    @InterfaceC1492Gx
    @ReplaceWith(expression = "\u00109\u001a\u0014\u0012ilW\u0006D/*5@1/\u001et`9H)\u001feGO3\b\u0018\tww\u0019m", imports = {})
    @Deprecated
    ...
    private static class Api26Impl {
        ...
        static void removeSpeedAccuracy(Location location) {
            try {
                byte b2 = LocationCompat.getFieldsMaskField().getByte(location);
                int i2 = ~LocationCompat.getHasSpeedAccuracyMask();
                LocationCompat.getFieldsMaskField().setByte(location, (byte) ((b2 + i2) - (b2 | i2)));
            } catch (IllegalAccessException e2) {
                IllegalAccessError illegalAccessError = new IllegalAccessError();
                illegalAccessError.initCause(e2);
                throw illegalAccessError;
