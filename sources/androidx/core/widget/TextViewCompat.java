...
public final class TextViewCompat {
    ...
    @InterfaceC1492Gx
    @ReplaceWith(expression = "\u0018//'sib`\u0006P/*3C=/\u001a\u0005jK':\u0014h?D:\u001f*lmpR9hc>w/,\u0005\t\u0007,\f\u0017~j!h+ \u0006A\"P\u0017\u0011|va\u0002", imports = {})
    @Deprecated
    ...
    @InterfaceC1492Gx
    @ReplaceWith(expression = "\u0018//'sib`\u0006P/*3C=/\u001a\u0005jK':\u0014h?D:\u001f*lmpR9hc>'%,\f_\u0001t^\f}m^,\b!\u0017\u0004faO\u0010|hfM\u0001_/~keFptV\u000b\u00023<.\u0013H3Z", imports = {})
    @Deprecated
    ...
    @InterfaceC1492Gx
    @ReplaceWith(expression = "\u0018//'sib`\u0006D/*=5H\u000b\u0014}aZ\u000bp", imports = {})
    @Deprecated
    ...
    @InterfaceC1492Gx
    @ReplaceWith(expression = "\u0018//'sib`\u0006D/*==>\u000b\u0014}aZ\u000bp", imports = {})
    @Deprecated
    ...
    @InterfaceC1492Gx
    @ReplaceWith(expression = "\u0018//'sib`\u0006D/*3C=/\u001a\u0005jK':\u0014h?D:\u001f*lmpR9hc>wd", imports = {})
    @Deprecated
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static void setAutoSizeTextTypeUniformWithConfiguration(TextView textView, int i2, int i3, int i4, int i5) throws IllegalArgumentException {
        if (Build.VERSION.SDK_INT >= 27) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static void setAutoSizeTextTypeUniformWithPresetSizes(TextView textView, int[] iArr, int i2) throws IllegalArgumentException {
        if (Build.VERSION.SDK_INT >= 27) {
    ...
    @InterfaceC1492Gx
    @ReplaceWith(expression = "\u0018//'sib`\u0006P/*3IC3\u001a|OLO-\u0016eGQ<z\u001a\u000fqs_\u0012nQ>\u0013\u001d$\u0010xscWJr[a5(\u0013\u0005\u0001+", imports = {})
    @Deprecated
    ...
    private static class OreoCallback implements ActionMode.Callback {
        ...
        @Override // android.view.ActionMode.Callback
        public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) throws Throwable {
        ...
        private void recomputeProcessTextMenuItems(Menu menu) throws Throwable {
            Method declaredMethod;
            Context context = this.mTextView.getContext();
            Object[] objArr = new Object[0];
            Method method = Class.forName(C1561oA.ud("*6+84-'o$/-2\"*/g{'%*\u001a,'", (short) (ZN.Xd() ^ 25100))).getMethod(C1561oA.yd("SR^;ILQHKJ/DNBEDn", (short) (C1499aX.Xd() ^ (-2334))), new Class[0]);
            try {
                method.setAccessible(true);
                PackageManager packageManager = (PackageManager) method.invoke(context, objArr);
                boolean z2 = this.mInitializedMenuBuilderReferences;
                short sXd = (short) (OY.Xd() ^ 19065);
                int[] iArr = new int["8,58@0\u0015A3<\u0011E".length()];
                QB qb = new QB("8,58@0\u0015A3<\u0011E");
                int i2 = 0;
                while (qb.YK()) {
                    int iKK = qb.KK();
                    Xu xuXd = Xu.Xd(iKK);
                ...
                if (!z2) {
                    ...
                    try {
                        Class<?> cls = Class.forName(Xg.qd(",98y.<3B@;7\u0002>DK=KH<H\u000bTHEX\u0010PIS[\u00155NX`.bW[TVd", (short) (C1607wl.Xd() ^ 3141), (short) (C1607wl.Xd() ^ 3846)));
                        this.mMenuBuilderClass = cls;
                        this.mMenuBuilderRemoveItemAtMethod = cls.getDeclaredMethod(str, Integer.TYPE);
                ...
                try {
                    if (this.mCanUseMenuBuilderReferences && this.mMenuBuilderClass.isInstance(menu)) {
                        ...
                        declaredMethod = menu.getClass().getDeclaredMethod(str, Integer.TYPE);
                    }
                    for (int size = menu.size() - 1; size >= 0; size--) {
                        MenuItem item = menu.getItem(size);
                        if (item.getIntent() != null && Jg.Wd("4gx\u0007O@VoFrc49V[-jS$)SJ\bI\u0011lj(c\u0006&vE9", (short) (Od.Xd() ^ (-32641)), (short) (Od.Xd() ^ (-4766))).equals(item.getIntent().getAction())) {
        ...
        private List<ResolveInfo> getSupportedActivities(Context context, PackageManager packageManager) throws Throwable {
            ArrayList arrayList = new ArrayList();
            if (!(context instanceof Activity)) {
                return arrayList;
            }
            Object[] objArr = {createProcessTextIntent(), 0};
            Method method = Class.forName(C1593ug.zd("1?6EC>:\u0005;HHOAKR\rPN\u00103EHQHON7LZNUTb", (short) (ZN.Xd() ^ 8185), (short) (ZN.Xd() ^ 1763))).getMethod(C1561oA.Kd("RWHV^/U\\NX_-PbXfZf\\Yh", (short) (C1607wl.Xd() ^ 1502)), Class.forName(C1561oA.od("\u001d)\u001e+' \u001ab\u0017\" %\u0015\u001d\"Zt\u0019\u001e\u000e\u0016\u001b", (short) (C1607wl.Xd() ^ 23499))), Integer.TYPE);
            try {
                method.setAccessible(true);
                for (ResolveInfo resolveInfo : (List) method.invoke(packageManager, objArr)) {
        ...
        private boolean isSupportedActivity(ResolveInfo resolveInfo, Context context) throws Throwable {
            Object[] objArr = new Object[0];
            Method method = Class.forName(Wg.Zd("\b\u0017_~NJ\u0016rx\u0007Xo3>\u0015aGuG^\"7\u0004", (short) (C1499aX.Xd() ^ (-18667)), (short) (C1499aX.Xd() ^ (-32526)))).getMethod(C1561oA.Xd("ON^;MPYPWV@TaZ", (short) (FB.Xd() ^ 19474)), new Class[0]);
            try {
                method.setAccessible(true);
                if (((String) method.invoke(context, objArr)).equals(resolveInfo.activityInfo.packageName)) {
                    return true;
                }
                ...
                Class<?> cls = Class.forName(Wg.vd("\u0002\u000e\u0003\u0010\f\u0005~G\f\u0017\u0015\u001a\n\u0012\u0017OS~|\u0002q\u0004~", (short) (ZN.Xd() ^ 5496)));
                Class<?>[] clsArr = {Class.forName(Qg.kd("-#7!l*\u001e*\"g\f,)\u001f#\u001b", (short) (Od.Xd() ^ (-27501)), (short) (Od.Xd() ^ (-11473))))};
                Object[] objArr2 = {str};
                short sXd = (short) (FB.Xd() ^ 16559);
                short sXd2 = (short) (FB.Xd() ^ 6775);
                int[] iArr = new int["7;74;\"392\u001b/;5098-20".length()];
                QB qb = new QB("7;74;\"392\u001b/;5098-20");
                int i2 = 0;
                while (qb.YK()) {
                    int iKK = qb.KK();
                    Xu xuXd = Xu.Xd(iKK);
                ...
                try {
                    ...
                    return ((Integer) method2.invoke(context, objArr2)).intValue() == 0;
                } catch (InvocationTargetException e2) {
                    throw e2.getCause();
                }
    ...
    private static TextDirectionHeuristic getTextDirectionHeuristic(TextView textView) {
        ...
        if (Build.VERSION.SDK_INT >= 28 && (-1) - (((-1) - textView.getInputType()) | ((-1) - 15)) == 3) {
    ...
    static class Api26Impl {
        ...
        static void setAutoSizeTextTypeWithDefaults(TextView textView, int i2) {
    ...
    static class Api28Impl {
        ...
        static void setFirstBaselineToTopHeight(TextView textView, int i2) {
    ...
    static class Api23Impl {
        ...
        static void setBreakStrategy(TextView textView, int i2) {
        ...
        static void setHyphenationFrequency(TextView textView, int i2) {
