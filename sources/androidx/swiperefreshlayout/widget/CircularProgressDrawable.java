...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private int evaluateColorChange(float f2, int i2, int i3) {
        int i4 = (-1) - (((-1) - (i2 >> 24)) | ((-1) - 255));
        int i5 = (-1) - (((-1) - (i2 >> 16)) | ((-1) - 255));
        int i6 = i2 >> 8;
        int i7 = (i6 + 255) - (i6 | 255);
        int i8 = i3 >> 24;
        int i9 = (i4 + ((int) ((((i8 + 255) - (i8 | 255)) - i4) * f2))) << 24;
        int i10 = (i5 + ((int) ((((-1) - (((-1) - (i3 >> 16)) | ((-1) - 255))) - i5) * f2))) << 16;
        int i11 = (i9 + i10) - (i9 & i10);
        int i12 = (i7 + ((int) ((((-1) - (((-1) - (i3 >> 8)) | ((-1) - 255))) - i7) * f2))) << 8;
        return (-1) - (((-1) - ((i11 + i12) - (i11 & i12))) & ((-1) - ((i2 & 255) + ((int) (f2 * (((i3 + 255) - (i3 | 255)) - r11))))));
    }
    ...
    public CircularProgressDrawable(Context context) throws Throwable {
        Context context2 = (Context) Preconditions.checkNotNull(context);
        short sXd = (short) (FB.Xd() ^ 23965);
        ...
        Method method = Class.forName(new String(iArr, 0, i2)).getMethod(Wg.vd("hgwVbqnuk]`o", (short) (C1499aX.Xd() ^ (-27377))), new Class[0]);
        try {
            method.setAccessible(true);
            this.mResources = (Resources) method.invoke(context2, objArr);
            Ring ring = new Ring();
            this.mRing = ring;
    ...
    void applyTransformation(float f2, Ring ring, boolean z2) {
        ...
        if (f2 != 1.0f || z2) {
            ...
            if (f2 < 0.5f) {
                ...
                startingStartTrim = (MATERIAL_INTERPOLATOR.getInterpolation(f2 / 0.5f) * 0.79f) + 0.01f + interpolation;
            } else {
