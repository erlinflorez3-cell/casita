...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3, NestedScrollingParent2, NestedScrollingChild3, NestedScrollingChild2, NestedScrollingParent, NestedScrollingChild {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) throws Throwable {
        ...
        Class<?> cls = Class.forName(Qg.kd("MYN[WPJ\u0013GRPUEMR\u000b\u001fJHM=OJ", (short) (FB.Xd() ^ 6364), (short) (FB.Xd() ^ 2864)));
        Class<?>[] clsArr = new Class[2];
        short sXd = (short) (Od.Xd() ^ (-10711));
        short sXd2 = (short) (Od.Xd() ^ (-1915));
        int[] iArr2 = new int["4@5B>71y@>24t\u0007985+#53#\u0010!/".length()];
        QB qb = new QB("4@5B>71y@>24t\u0007985+#53#\u0010!/");
        int i4 = 0;
        while (qb.YK()) {
            int iKK = qb.KK();
            Xu xuXd = Xu.Xd(iKK);
        ...
        Method method = cls.getMethod(C1561oA.ud("m_p\\cgKkoaYW3edaWOa_O\\", (short) (C1607wl.Xd() ^ 18838)), clsArr);
        try {
    ...
    private Animation startAlphaAnimation(final int i2, final int i3) {
        Animation animation = new Animation() { // from class: androidx.swiperefreshlayout.widget.SwipeRefreshLayout.4
            @Override // android.view.animation.Animation
            public void applyTransformation(float f2, Transformation transformation) {
                SwipeRefreshLayout.this.mProgress.setAlpha((int) (i2 + ((i3 - r2) * f2)));
            }
        };
    ...
    */
    public boolean onInterceptTouchEvent(android.view.MotionEvent r5) {
        /*
            ...
            boolean r0 = r4.mReturningToStart
            r2 = 0
            if (r0 == 0) goto L10
            if (r3 != 0) goto L10
        ...
        L3f:
            ...
            if (r0 != r1) goto L48
            java.lang.String r0 = androidx.swiperefreshlayout.widget.SwipeRefreshLayout.LOG_TAG
        ...
        L5c:
            ...
            androidx.swiperefreshlayout.widget.CircleImageView r0 = r4.mCircleView
            int r0 = r0.getTop()
            int r1 = r1 - r0
    ...
    public void onNestedScroll(View view, int i2, int i3, int i4, int i5, int i6, int[] iArr) {
        ...
        float fAbs = this.mTotalUnconsumed + Math.abs(r9);
    ...
    void moveToStart(float f2) {
        setTargetOffsetTopAndBottom((this.mFrom + ((int) ((this.mOriginalOffsetTop - r1) * f2))) - this.mCircleView.getTop());
    }
