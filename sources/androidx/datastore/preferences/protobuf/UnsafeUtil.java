...
final class UnsafeUtil {
    ...
    static int mismatch(byte[] bArr, int i2, byte[] bArr2, int i3, int i4) {
        ...
        int i5 = 0;
        if (HAS_UNSAFE_ARRAY_OPERATIONS) {
            for (int i6 = (-1) - (((-1) - (BYTE_ARRAY_ALIGNMENT + i2)) | ((-1) - 7)); i5 < i4 && (-1) - (((-1) - i6) | ((-1) - 7)) != 0; i6++) {
    ...
    public static byte getByteBigEndian(Object obj, long j2) {
        return (byte) ((-1) - (((-1) - (getInt(obj, (-4) & j2) >>> ((int) (((~j2) & 3) << 3)))) | ((-1) - 255)));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static byte getByteLittleEndian(Object obj, long j2) {
        return (byte) ((-1) - (((-1) - (getInt(obj, (-1) - (((-1) - (-4)) | ((-1) - j2))) >>> ((int) ((j2 & 3) << 3)))) | ((-1) - 255)));
    }
    ...
    public static void putByteBigEndian(Object obj, long j2, byte b2) {
        ...
        int i3 = ((~((int) j2)) & 3) << 3;
        putInt(obj, j3, (-1) - (((-1) - (((255 + b2) - (255 | b2)) << i3)) & ((-1) - ((-1) - (((-1) - i2) | ((-1) - (~(255 << i3))))))));
    }
    ...
    public static void putByteLittleEndian(Object obj, long j2, byte b2) {
        ...
        int i2 = (int) j2;
        int i3 = ((i2 + 3) - (i2 | 3)) << 3;
        int i4 = (-1) - (((-1) - getInt(obj, j3)) | ((-1) - (~(255 << i3))));
        int i5 = ((-1) - (((-1) - 255) | ((-1) - b2))) << i3;
        putInt(obj, j3, (i5 + i4) - (i5 & i4));
    }
