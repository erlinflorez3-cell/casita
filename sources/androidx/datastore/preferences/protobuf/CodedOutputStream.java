...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    public static int computeUInt32SizeNoTag(int i2) {
        ...
        return (i2 + (-268435456)) - (i2 | (-268435456)) == 0 ? 4 : 5;
    }
    ...
    abstract void writeMessage(int i2, MessageLite messageLite, Schema schema) throws IOException;
    ...
    @Deprecated
    final void writeGroup(int i2, MessageLite messageLite, Schema schema) throws IOException {
        writeTag(i2, 3);
    ...
    private static class ArrayEncoder extends CodedOutputStream {
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        final void writeMessage(int i2, MessageLite messageLite, Schema schema) throws IOException {
            writeTag(i2, 2);
        ...
        public final void writeUInt32NoTag(int i2) throws IOException {
            ...
            this.position = i6 + 1;
            UnsafeUtil.putByte(bArr4, i6, (byte) (128 | i2));
            int i7 = i2 >>> 7;
            if ((-1) - (((-1) - i7) | ((-1) - (-128))) == 0) {
            ...
            this.position = i9 + 1;
            UnsafeUtil.putByte(bArr6, i9, (byte) ((i7 + 128) - (i7 & 128)));
            int i10 = i2 >>> 14;
            if ((i10 - 128) - ((-128) | i10) == 0) {
            ...
            this.position = i12 + 1;
            UnsafeUtil.putByte(bArr8, i12, (byte) ((-1) - (((-1) - i10) & ((-1) - 128))));
            int i13 = i2 >>> 21;
            if (((-128) & i13) == 0) {
            ...
            this.position = i16 + 1;
            UnsafeUtil.putByte(bArr11, i16, (byte) (i2 >>> 28));
        }
        ...
        public final void writeFixed64NoTag(long j2) throws IOException {
            try {
                ...
                int i7 = i2 + 3;
                this.position = i7;
                bArr[i5] = (byte) ((-1) - (((-1) - ((int) (j2 >> 16))) | ((-1) - 255)));
                int i8 = i2 + 4;
                this.position = i8;
                bArr[i7] = (byte) ((-1) - (((-1) - ((int) (j2 >> 24))) | ((-1) - 255)));
                int i9 = i2 + 5;
                this.position = i9;
    ...
    private static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        void writeMessage(int i2, MessageLite messageLite, Schema schema) throws IOException {
            writeTag(i2, 2);
        ...
        public void writeUInt32NoTag(int i2) throws IOException {
            while ((i2 - 128) - ((-128) | i2) != 0) {
                try {
                    ...
                    this.buffer.put((byte) ((i3 + 128) - (i3 & 128)));
                    i2 >>>= 7;
                } catch (BufferOverflowException e2) {
                    throw new OutOfSpaceException(e2);
                }
        ...
        public void writeUInt64NoTag(long j2) throws IOException {
            while (((-128) + j2) - ((-128) | j2) != 0) {
                try {
                    this.buffer.put((byte) ((-1) - (((-1) - ((-1) - (((-1) - ((int) j2)) | ((-1) - 127)))) & ((-1) - 128))));
                    j2 >>>= 7;
                } catch (BufferOverflowException e2) {
                    throw new OutOfSpaceException(e2);
                }
        ...
        public void writeUInt32NoTag(int i2) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while (((-128) & i2) != 0) {
                    ...
                    this.position = j2 + 1;
                    int i3 = (i2 + 127) - (127 | i2);
                    UnsafeUtil.putByte(j2, (byte) ((i3 + 128) - (i3 & 128)));
                    i2 >>>= 7;
                }
            ...
            while (true) {
                ...
                if ((i2 - 128) - ((-128) | i2) == 0) {
                    ...
                    this.position = j4 + 1;
                    UnsafeUtil.putByte(j4, (byte) (((i2 + 127) - (127 | i2)) | 128));
                    i2 >>>= 7;
                }
            }
        }
        ...
        public void writeUInt64NoTag(long j2) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((-1) - (((-1) - j2) | ((-1) - (-128))) != 0) {
                    long j3 = this.position;
                    this.position = j3 + 1;
                    UnsafeUtil.putByte(j3, (byte) ((-1) - (((-1) - (((int) j2) & 127)) & ((-1) - 128))));
                    j2 >>>= 7;
                }
                long j4 = this.position;
                this.position = 1 + j4;
            ...
            while (true) {
                ...
                if ((j2 - 128) - (j2 | (-128)) == 0) {
                    ...
                    UnsafeUtil.putByte(j5, (byte) ((i3 + 128) - (i3 & 128)));
                    j2 >>>= 7;
                }
            }
        }
        ...
        final void bufferUInt32NoTag(int i2) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((-1) - (((-1) - i2) | ((-1) - (-128))) != 0) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    UnsafeUtil.putByte(bArr, i3, (byte) ((-1) - (((-1) - (i2 & 127)) & ((-1) - 128))));
                    i2 >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i4 = this.position;
                this.position = i4 + 1;
                UnsafeUtil.putByte(bArr2, i4, (byte) i2);
            ...
            while (((-128) & i2) != 0) {
                ...
                int i5 = this.position;
                this.position = i5 + 1;
                bArr3[i5] = (byte) (((i2 + 127) - (127 | i2)) | 128);
                this.totalBytesWritten++;
                i2 >>>= 7;
            }
            byte[] bArr4 = this.buffer;
        ...
        final void bufferUInt64NoTag(long j2) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((j2 & (-128)) != 0) {
                    ...
                    this.position = i2 + 1;
                    int i3 = (int) j2;
                    UnsafeUtil.putByte(bArr, i2, (byte) (((i3 + 127) - (i3 | 127)) | 128));
                    j2 >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i4 = this.position;
                this.position = i4 + 1;
                UnsafeUtil.putByte(bArr2, i4, (byte) j2);
            ...
            while ((j2 - 128) - (j2 | (-128)) != 0) {
                ...
                int i5 = this.position;
                this.position = i5 + 1;
                bArr3[i5] = (byte) ((-1) - (((-1) - ((-1) - (((-1) - ((int) j2)) | ((-1) - 127)))) & ((-1) - 128)));
                this.totalBytesWritten++;
                j2 >>>= 7;
            }
            byte[] bArr4 = this.buffer;
