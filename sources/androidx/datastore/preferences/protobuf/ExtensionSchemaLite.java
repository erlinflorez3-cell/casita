...
final class ExtensionSchemaLite extends ExtensionSchema<GeneratedMessageLite.ExtensionDescriptor> {
    ...
    <UT, UB> UB parseExtension(Reader reader, Object obj, ExtensionRegistryLite extensionRegistryLite, FieldSet<GeneratedMessageLite.ExtensionDescriptor> fieldSet, UB ub, UnknownFieldSchema<UT, UB> unknownFieldSchema) throws IOException {
        ...
        if (generatedExtension.descriptor.isRepeated() && generatedExtension.descriptor.isPacked()) {
            ...
            if (generatedExtension.getLiteType() == WireFormat.FieldType.ENUM) {
                ...
                message = Integer.valueOf(int32);
            } else {
                switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[generatedExtension.getLiteType().ordinal()]) {
                    case 1:
                        message = Double.valueOf(reader.readDouble());
                        break;
                    case 2:
                        message = Float.valueOf(reader.readFloat());
                        break;
                    case 3:
                        message = Long.valueOf(reader.readInt64());
                        break;
                    case 4:
                        message = Long.valueOf(reader.readUInt64());
                        break;
                    case 5:
                        message = Integer.valueOf(reader.readInt32());
                        break;
                    case 6:
                        message = Long.valueOf(reader.readFixed64());
                        break;
                    case 7:
                        message = Integer.valueOf(reader.readFixed32());
                        break;
                    case 8:
                        message = Boolean.valueOf(reader.readBool());
                        break;
                    case 9:
                        message = Integer.valueOf(reader.readUInt32());
                        break;
                    case 10:
                        message = Integer.valueOf(reader.readSFixed32());
                        break;
                    case 11:
                        message = Long.valueOf(reader.readSFixed64());
                        break;
                    case 12:
                        message = Integer.valueOf(reader.readSInt32());
                        break;
                    case 13:
                        message = Long.valueOf(reader.readSInt64());
                        break;
                    case 14:
                    ...
                    case 16:
                        ...
                        break;
                    case 17:
                        message = reader.readGroup(generatedExtension.getMessageDefaultInstance().getClass(), extensionRegistryLite);
                        break;
                    case 18:
                        message = reader.readMessage(generatedExtension.getMessageDefaultInstance().getClass(), extensionRegistryLite);
                        break;
                    default:
                        message = null;
                        break;
            ...
            if (generatedExtension.isRepeated()) {
                fieldSet.addRepeatedField(generatedExtension.descriptor, message);
            } else {
                ...
                if ((i2 == 17 || i2 == 18) && (field = fieldSet.getField(generatedExtension.descriptor)) != null) {
                    message = Internal.mergeMessage(field, message);
                }
                fieldSet.setField(generatedExtension.descriptor, message);
            }
        }
        return ub;
    }
    ...
    @Override // androidx.datastore.preferences.protobuf.ExtensionSchema
    Object findExtensionByNumber(ExtensionRegistryLite extensionRegistryLite, MessageLite messageLite, int i2) {
