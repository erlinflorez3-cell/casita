...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    protected abstract void copyToInternal(byte[] bArr, int i2, int i3, int i4);
    ...
    protected abstract int partialHash(int i2, int i3, int i4);

    protected abstract int partialIsValidUtf8(int i2, int i3, int i4);
    ...
    static {
        ...
        UNSIGNED_LEXICOGRAPHICAL_COMPARATOR = new Comparator<ByteString>() { // from class: androidx.datastore.preferences.protobuf.ByteString.2
            ...
            /* JADX WARN: Type inference failed for: r2v0, types: [androidx.datastore.preferences.protobuf.ByteString$ByteIterator] */
            /* JADX WARN: Type inference failed for: r3v0, types: [androidx.datastore.preferences.protobuf.ByteString$ByteIterator] */
    ...
    static abstract class LeafByteString extends ByteString {
        abstract boolean equalsRange(ByteString byteString, int i2, int i3);
    ...
    private static class LiteralByteString extends LeafByteString {
        ...
        public final ByteString substring(int i2, int i3) {
            int iCheckRange = checkRange(i2, i3, size());
            if (iCheckRange == 0) {
                return ByteString.EMPTY;
            }
            return new BoundedByteString(this.bytes, getOffsetIntoBytes() + i2, iCheckRange);
        }
        ...
        final boolean equalsRange(ByteString byteString, int i2, int i3) {
