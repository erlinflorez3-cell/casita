...
@InterfaceC1492Gx
@Metadata(bv = {}, d1 = {"Я\u0010\u001d̉=!,i\bDJc|\u0004W\u0006>éFB-!L\u0014}јtjY2JdV.\u0003]8\u0010\u0004\u0002D&k$8CiW`ԍ`"}, d2 = {"\n`]<a@F])\rS", "", "\"", "/oX", "\u001a`]1e6BR,HyZ;x\u0017>o\r(E>\u000b$\u0017\u0011S\u0017@\u0006)1`\u000257zq9Q\u0019"}, k = 3, mv = {1, 5, 1}, pn = "", xi = 48, xs = "")
@DebugMetadata(c = "drixvqm\u00039pn\u0003p\u0004\u0006\u0002\u0006yCy\u0007\u000b~H_}\u0012\u007fl\n\t\u0015\u0005\u0019\u000f\u0016\u0016q\u0018\u0014 \u0016\u000f\u001b\u0019+\u0017%Ww%$(\u001a($++a&%5\u000b1-9/(42D0>p~", f = "\u0011-?+\u00161.8&8,1/\t-'1%\u001c&\"2\u001c(b\u001f'", i = {}, l = {33}, m = "8>GA>9(KJH>H?", n = {}, s = {})
final class DataMigrationInitializer$Companion$getInitializer$1<T> extends SuspendLambda implements Function2<InitializerApi<T>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            ...
            this.label = 1;
            if (DataMigrationInitializer.Companion.runMigrations(this.$migrations, initializerApi, this) == coroutine_suspended) {
