...
class ProfileTranscoder {
    ...
    private static int computeMethodFlags(DexProfileData dexProfileData) {
        ...
        int iIntValue = 0;
        while (it.hasNext()) {
            iIntValue = (-1) - (((-1) - iIntValue) & ((-1) - it.next().getValue().intValue()));
        }
        return iIntValue;
    }
    ...
    private static void setMethodBitmapBit(byte[] bArr, int i2, int i3, DexProfileData dexProfileData) {
        int iMethodFlagBitmapIndex = methodFlagBitmapIndex(i2, i3, dexProfileData.numMethodIds);
        int i4 = iMethodFlagBitmapIndex / 8;
        bArr[i4] = (byte) ((-1) - (((-1) - (1 << (iMethodFlagBitmapIndex % 8))) & ((-1) - bArr[i4])));
    }
    ...
    private static void writeMethodsWithInlineCaches(OutputStream outputStream, DexProfileData dexProfileData) throws IOException {
        ...
        for (Map.Entry<Integer, Integer> entry : dexProfileData.methods.entrySet()) {
            ...
            if ((-1) - (((-1) - entry.getValue().intValue()) | ((-1) - 1)) != 0) {
    ...
    private static void writeMethodBitmap(OutputStream outputStream, DexProfileData dexProfileData) throws IOException {
        ...
        for (Map.Entry<Integer, Integer> entry : dexProfileData.methods.entrySet()) {
            ...
            if ((iIntValue2 + 4) - (iIntValue2 | 4) != 0) {
    ...
    private static DexProfileData[] readMetadataV002Body(InputStream inputStream, byte[] bArr, int i2, DexProfileData[] dexProfileDataArr) throws IOException {
    ...
    private static DexProfileData[] readMetadataForNBody(InputStream inputStream, int i2, DexProfileData[] dexProfileDataArr) throws IOException {
        if (inputStream.available() == 0) {
            return new DexProfileData[0];
        }
        if (i2 != dexProfileDataArr.length) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            dexProfileData.classSetSize = iArr[i4];
    ...
    private static String enforceSeparator(String str, String str2) {
        if ("!".equals(str2)) {
            return str.replace(Global.COLON, "!");
        }
        return Global.COLON.equals(str2) ? str.replace("!", Global.COLON) : str;
    }
    ...
    private static DexProfileData[] readUncompressedBody(InputStream inputStream, String str, int i2) throws IOException {
        if (inputStream.available() == 0) {
            return new DexProfileData[0];
        }
    ...
    private static void readMethodBitmap(InputStream inputStream, DexProfileData dexProfileData) throws IOException {
        ...
        for (int i2 = 0; i2 < dexProfileData.numMethodIds; i2++) {
            int flagsFromBitmap = readFlagsFromBitmap(bitSetValueOf, i2, dexProfileData.numMethodIds);
            if (flagsFromBitmap != 0) {
                Integer num = dexProfileData.methods.get(Integer.valueOf(i2));
                if (num == null) {
                    num = 0;
                }
                TreeMap<Integer, Integer> treeMap = dexProfileData.methods;
                Integer numValueOf = Integer.valueOf(i2);
                int iIntValue = num.intValue();
                treeMap.put(numValueOf, Integer.valueOf((flagsFromBitmap + iIntValue) - (flagsFromBitmap & iIntValue)));
            }
        }
    }
    ...
    private static int readFlagsFromBitmap(BitSet bitSet, int i2, int i3) {
        ...
        return bitSet.get(methodFlagBitmapIndex(4, i2, i3)) ? (i4 + 4) - (i4 & 4) : i4;
    }
