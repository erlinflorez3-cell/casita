...
class ViewBoundsCheck {
    ...
    static class BoundFlags {
        ...
        boolean boundsMatch() {
            ...
            if ((i2 + 7) - (7 | i2) != 0) {
                int iCompare = compare(this.mChildStart, this.mRvStart);
                if ((i2 + iCompare) - (i2 | iCompare) == 0) {
                    return false;
                }
            }
            int i3 = this.mBoundFlags;
            if ((112 & i3) != 0 && (i3 & (compare(this.mChildStart, this.mRvEnd) << 4)) == 0) {
                return false;
            }
            int i4 = this.mBoundFlags;
            if ((1792 & i4) != 0 && (i4 & (compare(this.mChildEnd, this.mRvStart) << 8)) == 0) {
                return false;
            }
            int i5 = this.mBoundFlags;
            if ((i5 + 28672) - (28672 | i5) != 0) {
                return (-1) - (((-1) - i5) | ((-1) - (compare(this.mChildEnd, this.mRvEnd) << 12))) != 0;
            }
            return true;
        }
    }
