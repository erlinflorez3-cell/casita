...
final class AdapterHelper implements OpReorderer.Callback {
    ...
    private void dispatchAndUpdateViewHolders(UpdateOp updateOp) {
        ...
        for (int i6 = 1; i6 < updateOp.itemCount; i6++) {
            int iUpdatePositionWithPostponed2 = updatePositionWithPostponed(updateOp.positionStart + (i2 * i6), updateOp.cmd);
            int i7 = updateOp.cmd;
            if (i7 == 2 ? iUpdatePositionWithPostponed2 != iUpdatePositionWithPostponed : !(i7 == 4 && iUpdatePositionWithPostponed2 == iUpdatePositionWithPostponed + 1)) {
                UpdateOp updateOpObtainUpdateOp = obtainUpdateOp(updateOp.cmd, iUpdatePositionWithPostponed, i5, updateOp.payload);
    ...
    boolean hasAnyUpdateTypes(int i2) {
        return (-1) - (((-1) - i2) | ((-1) - this.mExistingUpdateTypes)) != 0;
    }
    ...
    boolean onItemRangeChanged(int i2, int i3, Object obj) {
        ...
        this.mExistingUpdateTypes = (-1) - (((-1) - this.mExistingUpdateTypes) & ((-1) - 4));
    ...
    boolean onItemRangeInserted(int i2, int i3) {
        ...
        this.mExistingUpdateTypes = (-1) - (((-1) - this.mExistingUpdateTypes) & ((-1) - 1));
        return this.mPendingUpdates.size() == 1;
    }
    ...
    boolean onItemRangeRemoved(int i2, int i3) {
        ...
        this.mExistingUpdateTypes = (-1) - (((-1) - this.mExistingUpdateTypes) & ((-1) - 2));
        return this.mPendingUpdates.size() == 1;
    }
    ...
    boolean onItemRangeMoved(int i2, int i3, int i4) {
        ...
        int i5 = this.mExistingUpdateTypes;
        this.mExistingUpdateTypes = (i5 + 8) - (i5 & 8);
        return this.mPendingUpdates.size() == 1;
    }
