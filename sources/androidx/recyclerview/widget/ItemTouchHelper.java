...
public class ItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
    ...
    */
    void select(androidx.recyclerview.widget.RecyclerView.ViewHolder r28, int r29) {
        /*
    ...
    */
    ...
    private List<RecyclerView.ViewHolder> findSwapTargets(RecyclerView.ViewHolder viewHolder) {
        ...
        int width = viewHolder.itemView.getWidth() + iRound + i2;
        int height = viewHolder.itemView.getHeight() + iRound2 + i2;
    ...
    void endRecoverAnimation(RecyclerView.ViewHolder viewHolder, boolean z2) {
        for (int size = this.mRecoverAnimations.size() - 1; size >= 0; size--) {
            ...
            if (recoverAnimation.mViewHolder == viewHolder) {
                recoverAnimation.mOverridden = (-1) - (((-1) - (recoverAnimation.mOverridden ? 1 : 0)) & ((-1) - (z2 ? 1 : 0))) == 1;
    ...
    void checkSelectForSwipe(int i2, MotionEvent motionEvent, int i3) {
        ...
        if (this.mSelected != null || i2 != 2 || this.mActionState == 2 || !this.mCallback.isItemViewSwipeEnabled() || this.mRecyclerView.getScrollState() == 1 || (viewHolderFindSwipedView = findSwipedView(motionEvent)) == null) {
            return;
        }
        int absoluteMovementFlags = this.mCallback.getAbsoluteMovementFlags(this.mRecyclerView, viewHolderFindSwipedView);
        int i4 = ((absoluteMovementFlags + 65280) - (absoluteMovementFlags | 65280)) >> 8;
        if (i4 == 0) {
            return;
        }
        ...
        if (fAbs >= i5 || fAbs2 >= i5) {
            if (fAbs > fAbs2) {
                if (f2 < 0.0f && (-1) - (((-1) - i4) | ((-1) - 4)) == 0) {
                    return;
                }
                if (f2 > 0.0f && (-1) - (((-1) - i4) | ((-1) - 8)) == 0) {
                    return;
                }
            } else {
                if (f3 < 0.0f && (1 & i4) == 0) {
    ...
    private int swipeIfNecessary(RecyclerView.ViewHolder viewHolder) {
        ...
        if (Math.abs(this.mDx) > Math.abs(this.mDy)) {
            ...
            if (iCheckHorizontalSwipe > 0) {
                return (i2 + iCheckHorizontalSwipe) - (i2 | iCheckHorizontalSwipe) == 0 ? Callback.convertToRelativeDirection(iCheckHorizontalSwipe, ViewCompat.getLayoutDirection(this.mRecyclerView)) : iCheckHorizontalSwipe;
            }
    ...
    private int checkHorizontalSwipe(RecyclerView.ViewHolder viewHolder, int i2) {
        ...
        if (velocityTracker != null && this.mActivePointerId > -1) {
            ...
            if ((-1) - (((-1) - i4) | ((-1) - i2)) != 0 && i3 == i4 && fAbs >= this.mCallback.getSwipeEscapeVelocity(this.mSwipeEscapeVelocity) && fAbs > Math.abs(yVelocity)) {
                return i4;
            }
        }
        float width = this.mRecyclerView.getWidth() * this.mCallback.getSwipeThreshold(viewHolder);
        if ((-1) - (((-1) - i2) | ((-1) - i3)) == 0 || Math.abs(this.mDx) <= width) {
            return 0;
        }
        return i3;
    }
    ...
    private int checkVerticalSwipe(RecyclerView.ViewHolder viewHolder, int i2) {
        ...
        if (velocityTracker != null && this.mActivePointerId > -1) {
            ...
            if ((i4 + i2) - (i4 | i2) != 0 && i4 == i3 && fAbs >= this.mCallback.getSwipeEscapeVelocity(this.mSwipeEscapeVelocity) && fAbs > Math.abs(xVelocity)) {
                return i4;
            }
        }
        float height = this.mRecyclerView.getHeight() * this.mCallback.getSwipeThreshold(viewHolder);
        if ((-1) - (((-1) - i2) | ((-1) - i3)) == 0 || Math.abs(this.mDy) <= height) {
            return 0;
        }
        return i3;
    }
    ...
    public static abstract class Callback {
        ...
        public static int convertToRelativeDirection(int i2, int i3) {
            int i4;
            int i5 = (i2 + ABS_HORIZONTAL_DIR_FLAGS) - (i2 | ABS_HORIZONTAL_DIR_FLAGS);
            if (i5 == 0) {
                return i2;
            }
            int i6 = i2 & (~i5);
            if (i3 == 0) {
                ...
                int i8 = (-789517) & i7;
                i6 = (i6 + i8) - (i6 & i8);
                i4 = ((i7 + ABS_HORIZONTAL_DIR_FLAGS) - (i7 | ABS_HORIZONTAL_DIR_FLAGS)) << 2;
            }
            return (-1) - (((-1) - i6) & ((-1) - i4));
        }
        ...
        public int convertToAbsoluteDirection(int i2, int i3) {
            ...
            if (i3 == 0) {
                ...
                int i8 = i5 >> 1;
                i7 = (-1) - (((-1) - i7) & ((-1) - (((-3158065) + i8) - ((-3158065) | i8))));
                i4 = ((i8 + RELATIVE_DIR_FLAGS) - (i8 | RELATIVE_DIR_FLAGS)) >> 2;
            }
            return (-1) - (((-1) - i7) & ((-1) - i4));
        }
        ...
        public static int makeMovementFlags(int i2, int i3) {
            int iMakeFlag = makeFlag(1, i3) | makeFlag(0, (-1) - (((-1) - i3) & ((-1) - i2)));
            int iMakeFlag2 = makeFlag(2, i2);
            return (iMakeFlag2 + iMakeFlag) - (iMakeFlag2 & iMakeFlag);
        }
        ...
        boolean hasDragFlag(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
            int absoluteMovementFlags = getAbsoluteMovementFlags(recyclerView, viewHolder);
            return (absoluteMovementFlags + ItemTouchHelper.ACTION_MODE_DRAG_MASK) - (absoluteMovementFlags | ItemTouchHelper.ACTION_MODE_DRAG_MASK) != 0;
        }
        ...
        void onDrawOver(Canvas canvas, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, List<RecoverAnimation> list, int i2, float f2, float f3) {
            ...
            while (true) {
                ...
                RecoverAnimation recoverAnimation = list.get(i3);
                int iSave = canvas.save();
                onChildDrawOver(canvas, recyclerView2, recoverAnimation.mViewHolder, recoverAnimation.mX, recoverAnimation.mY, recoverAnimation.mActionState, false);
                canvas.restoreToCount(iSave);
                i3++;
            }
            if (viewHolder != null) {
                ...
                onChildDrawOver(canvas, recyclerView2, viewHolder, f2, f3, i2, true);
                canvas.restoreToCount(iSave2);
            }
    ...
    private class ItemTouchHelperGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public void onLongPress(MotionEvent motionEvent) {
            ...
            if (this.mShouldReactToLongPress && (viewFindChildView = ItemTouchHelper.this.findChildView(motionEvent)) != null && (childViewHolder = ItemTouchHelper.this.mRecyclerView.getChildViewHolder(viewFindChildView)) != null && ItemTouchHelper.this.mCallback.hasDragFlag(ItemTouchHelper.this.mRecyclerView, childViewHolder) && motionEvent.getPointerId(0) == ItemTouchHelper.this.mActivePointerId) {
                ...
                ItemTouchHelper.this.mInitialTouchX = x2;
                ItemTouchHelper.this.mInitialTouchY = y2;
                ItemTouchHelper itemTouchHelper = ItemTouchHelper.this;
