...
class ConcatAdapterController implements NestedAdapterWrapper.Callback {
    ...
    boolean addAdapter(int i2, RecyclerView.Adapter<RecyclerView.ViewHolder> adapter) {
    ...
    @Override // androidx.recyclerview.widget.NestedAdapterWrapper.Callback
    public void onItemRangeChanged(NestedAdapterWrapper nestedAdapterWrapper, int i2, int i3) {
        this.mConcatAdapter.notifyItemRangeChanged(i2 + countItemsBefore(nestedAdapterWrapper), i3);
    }

    @Override // androidx.recyclerview.widget.NestedAdapterWrapper.Callback
    public void onItemRangeChanged(NestedAdapterWrapper nestedAdapterWrapper, int i2, int i3, Object obj) {
        this.mConcatAdapter.notifyItemRangeChanged(i2 + countItemsBefore(nestedAdapterWrapper), i3, obj);
    }

    @Override // androidx.recyclerview.widget.NestedAdapterWrapper.Callback
    public void onItemRangeInserted(NestedAdapterWrapper nestedAdapterWrapper, int i2, int i3) {
        this.mConcatAdapter.notifyItemRangeInserted(i2 + countItemsBefore(nestedAdapterWrapper), i3);
    }

    @Override // androidx.recyclerview.widget.NestedAdapterWrapper.Callback
    public void onItemRangeRemoved(NestedAdapterWrapper nestedAdapterWrapper, int i2, int i3) {
        this.mConcatAdapter.notifyItemRangeRemoved(i2 + countItemsBefore(nestedAdapterWrapper), i3);
    }

    @Override // androidx.recyclerview.widget.NestedAdapterWrapper.Callback
    public void onItemRangeMoved(NestedAdapterWrapper nestedAdapterWrapper, int i2, int i3) {
        int iCountItemsBefore = countItemsBefore(nestedAdapterWrapper);
