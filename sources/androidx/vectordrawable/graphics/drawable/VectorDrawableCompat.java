...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public void setAutoMirrored(boolean z2) {
        if (this.mDelegateDrawable != null) {
            DrawableCompat.setAutoMirrored(this.mDelegateDrawable, z2);
        } else {
    ...
    static int applyAlpha(int i2, float f2) {
        return ((i2 + ViewCompat.MEASURED_SIZE_MASK) - (i2 | ViewCompat.MEASURED_SIZE_MASK)) | (((int) (Color.alpha(i2) * f2)) << 24);
    }
        ...
        while (eventType != 1 && (xmlPullParser.getDepth() >= depth || eventType != 3)) {
            if (eventType == 2) {
                ...
                if ("path".equals(name)) {
                    ...
                    int i2 = vectorDrawableCompatState.mChangingConfigurations;
                    int i3 = vFullPath.mChangingConfigurations;
                    vectorDrawableCompatState.mChangingConfigurations = (i3 + i2) - (i3 & i2);
                    z2 = false;
                    ...
                    int i4 = vectorDrawableCompatState.mChangingConfigurations;
                    int i5 = vClipPath.mChangingConfigurations;
                    vectorDrawableCompatState.mChangingConfigurations = (i5 + i4) - (i5 & i4);
                    ...
                    int i6 = vectorDrawableCompatState.mChangingConfigurations;
                    int i7 = vGroup2.mChangingConfigurations;
                    vectorDrawableCompatState.mChangingConfigurations = (i7 + i6) - (i7 & i6);
                }
    ...
    void setAllowCaching(boolean z2) {
    ...
    public int getChangingConfigurations() {
        ...
        return (-1) - (((-1) - super.getChangingConfigurations()) & ((-1) - this.mVectorState.getChangingConfigurations()));
    }
    ...
    public void scheduleSelf(Runnable runnable, long j2) {
        if (this.mDelegateDrawable != null) {
            this.mDelegateDrawable.scheduleSelf(runnable, j2);
        } else {
    ...
    public boolean setVisible(boolean z2, boolean z3) {
        if (this.mDelegateDrawable != null) {
            return this.mDelegateDrawable.setVisible(z2, z3);
        }
    ...
    private static class VectorDrawableCompatState extends Drawable.ConstantState {
        ...
        public boolean onStateChanged(int[] iArr) {
            ...
            boolean z2 = this.mCacheDirty;
            this.mCacheDirty = ((z2 ? 1 : 0) + (zOnStateChanged ? 1 : 0)) - ((z2 ? 1 : 0) & (zOnStateChanged ? 1 : 0)) == 1;
    ...
    private static class VGroup extends VObject {
        ...
        public boolean onStateChanged(int[] iArr) {
            ...
            while (i2 < this.mChildren.size()) {
                boolean zOnStateChanged = this.mChildren.get(i2).onStateChanged(iArr);
                int i3 = (r2 + (zOnStateChanged ? 1 : 0)) - (r2 & (zOnStateChanged ? 1 : 0));
                boolean z2 = true;
                if (i3 != 1) {
                    z2 = false;
                }
    ...
    private static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i2 = 0; i2 < pathDataNodeArr.length; i2++) {
                str = str + pathDataNodeArr[i2].mType + Global.COLON;
    ...
    private static class VFullPath extends VPath {
        ...
        @Override // androidx.vectordrawable.graphics.drawable.VectorDrawableCompat.VObject
        public boolean onStateChanged(int[] iArr) {
            boolean zOnStateChanged = this.mFillColor.onStateChanged(iArr);
            boolean zOnStateChanged2 = this.mStrokeColor.onStateChanged(iArr);
            return ((zOnStateChanged2 ? 1 : 0) + (zOnStateChanged ? 1 : 0)) - ((zOnStateChanged2 ? 1 : 0) & (zOnStateChanged ? 1 : 0)) == 1;
        }
