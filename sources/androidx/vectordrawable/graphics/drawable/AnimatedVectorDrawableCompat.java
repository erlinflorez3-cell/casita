...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    public static AnimatedVectorDrawableCompat create(Context context, int i2) throws Throwable {
        AnimatedVectorDrawableCompat animatedVectorDrawableCompat = new AnimatedVectorDrawableCompat(context);
        Object[] objArr = new Object[0];
        Method method = Class.forName(Xg.qd("DRIXVQM\u0018N[[bT^e 6ccj\\pm", (short) (Od.Xd() ^ (-15445)), (short) (Od.Xd() ^ (-12851)))).getMethod(Jg.Wd("B[!Z\u001eGyg)Qm3", (short) (C1499aX.Xd() ^ (-17416)), (short) (C1499aX.Xd() ^ (-14219))), new Class[0]);
        try {
            method.setAccessible(true);
            Resources resources = (Resources) method.invoke(context, objArr);
            short sXd = (short) (FB.Xd() ^ 5325);
            short sXd2 = (short) (FB.Xd() ^ 15322);
            int[] iArr = new int["YHp,p\u0017<\u0007_>tl\u001c'\u0002v\u001a\u000b|<G^\u0002".length()];
            QB qb = new QB("YHp,p\u0017<\u0007_>tl\u001c'\u0002v\u001a\u000b|<G^\u0002");
            int i3 = 0;
            while (qb.YK()) {
                int iKK = qb.KK();
                Xu xuXd = Xu.Xd(iKK);
            ...
            Method method2 = Class.forName(new String(iArr, 0, i3)).getMethod(C1626yg.Ud("*\u001dV\u0001MF3M", (short) (C1607wl.Xd() ^ 3838), (short) (C1607wl.Xd() ^ 10026)), new Class[0]);
            try {
                method2.setAccessible(true);
                animatedVectorDrawableCompat.mDelegateDrawable = ResourcesCompat.getDrawable(resources, i2, (Resources.Theme) method2.invoke(context, objArr2));
    ...
    public int getChangingConfigurations() {
        ...
        int i2 = this.mAnimatedVectorState.mChangingConfigurations;
        return (changingConfigurations + i2) - (changingConfigurations & i2);
    }
