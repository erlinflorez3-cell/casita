...
public class PathInterpolatorCompat implements Interpolator {
    ...
    public PathInterpolatorCompat(Context context, AttributeSet attributeSet, XmlPullParser xmlPullParser) throws Throwable {
        Object[] objArr = new Object[0];
        Method method = Class.forName(Ig.wd("\u001eQ9(lAP:8\u0011\u000ey\u007f\u0013\u0015s<j\u0011\u001fY\u0014.", (short) (C1499aX.Xd() ^ (-9384)))).getMethod(EO.Od("\u0002(+j\u0007r\r\u001ct35#", (short) (ZN.Xd() ^ 18161)), new Class[0]);
        try {
            method.setAccessible(true);
            Resources resources = (Resources) method.invoke(context, objArr);
            Object[] objArr2 = new Object[0];
            Method method2 = Class.forName(C1561oA.Qd("DPERNGA\n>IGL<DI\u0002\u0016A?D4FA", (short) (Od.Xd() ^ (-19289)))).getMethod(C1593ug.zd("\u0004\u0003\u0013s\t\u0007\u0010\t", (short) (C1499aX.Xd() ^ (-11200)), (short) (C1499aX.Xd() ^ (-19312))), new Class[0]);
            try {
                method2.setAccessible(true);
                this(resources, (Resources.Theme) method2.invoke(context, objArr2), attributeSet, xmlPullParser);
    ...
    private void initPath(Path path) {
        ...
        int i7 = iMin - 1;
        throw new IllegalArgumentException("The Path must start at (0,0) and end at (1,1) start: " + this.mX[0] + "," + this.mY[0] + " end:" + this.mX[i7] + "," + this.mY[i7]);
    }
