...
public final class RoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo1284createOutlineLjSzlW0(long j2, float f2, float f3, float f4, float f5, LayoutDirection layoutDirection) {
        ...
        Rect rectM4027toRectuvyYCjk = SizeKt.m4027toRectuvyYCjk(j2);
        long jCornerRadius$default = CornerRadiusKt.CornerRadius$default(layoutDirection == LayoutDirection.Ltr ? f2 : f6, 0.0f, 2, null);
        if (layoutDirection != LayoutDirection.Ltr) {
            f6 = f2;
        }
        long jCornerRadius$default2 = CornerRadiusKt.CornerRadius$default(f6, 0.0f, 2, null);
        long jCornerRadius$default3 = CornerRadiusKt.CornerRadius$default(layoutDirection == LayoutDirection.Ltr ? f4 : f7, 0.0f, 2, null);
        if (layoutDirection != LayoutDirection.Ltr) {
            f7 = f4;
        }
        return new Outline.Rounded(RoundRectKt.m3989RoundRectZAM2FJo(rectM4027toRectuvyYCjk, jCornerRadius$default, jCornerRadius$default2, jCornerRadius$default3, CornerRadiusKt.CornerRadius$default(f7, 0.0f, 2, null)));
    }
