...
public final class AbsoluteCutCornerShape extends CornerBasedShape {
    ...
    public Outline mo1284createOutlineLjSzlW0(long j2, float f2, float f3, float f4, float f5, LayoutDirection layoutDirection) {
        ...
        Path.moveTo(0.0f, f2);
        Path.lineTo(f2, 0.0f);
        Path.lineTo(Size.m4006getWidthimpl(j2) - f3, 0.0f);
        Path.lineTo(Size.m4006getWidthimpl(j2), f3);
        Path.lineTo(Size.m4006getWidthimpl(j2), Size.m4003getHeightimpl(j2) - f4);
        Path.lineTo(Size.m4006getWidthimpl(j2) - f4, Size.m4003getHeightimpl(j2));
        Path.lineTo(f5, Size.m4003getHeightimpl(j2));
        Path.lineTo(0.0f, Size.m4003getHeightimpl(j2) - f5);
        Path.close();
