...
@InterfaceC1492Gx
@Metadata(bv = {}, d1 = {"Я\f\u001d̉=!,r\bDJc\r\u000fOيH\u000b\\AE!݈\u0016w\u0015fʺ=1"}, d2 = {"-hb l:MS!b\u0004=(\n\u000f\u001eh\u007f0{", "", "uKP;W9HW\u0018\u0012D\\6\u0005\u00149s\u007fq\tP\n&\u001bOoW\u001a\u0001-@c\f DCyqB", "4nd;W(MW#\btk,\u0004\t+s\u007f"}, k = 2, mv = {1, 8, 0}, pn = "", xi = 48, xs = "")
public final class DarkTheme_androidKt {
    public static final boolean _isSystemInDarkTheme(Composer composer, int i2) {
        ...
        int i3 = ((Configuration) objConsume).uiMode;
        boolean z2 = (i3 + 48) - (i3 | 48) == 32;
        if (ComposerKt.isTraceInProgress()) {
