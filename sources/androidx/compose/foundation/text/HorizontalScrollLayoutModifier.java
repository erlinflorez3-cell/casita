...
final class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public final HorizontalScrollLayoutModifier copy(TextFieldScrollerPosition textFieldScrollerPosition, int i2, TransformedText transformedText, Function0<TextLayoutResultProxy> function0) {
        return new HorizontalScrollLayoutModifier(textFieldScrollerPosition, i2, transformedText, function0);
    }
    ...
    public MeasureResult mo401measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j2) {
        long jM6582copyZbe2FdA$default;
        if (measurable.maxIntrinsicWidth(Constraints.m6590getMaxHeightimpl(j2)) < Constraints.m6591getMaxWidthimpl(j2)) {
            jM6582copyZbe2FdA$default = j2;
        } else {
            jM6582copyZbe2FdA$default = Constraints.m6582copyZbe2FdA$default(j2, 0, Integer.MAX_VALUE, 0, 0, 13, null);
        }
        final Placeable placeableMo5514measureBRTryo0 = measurable.mo5514measureBRTryo0(jM6582copyZbe2FdA$default);
        final int iMin = Math.min(placeableMo5514measureBRTryo0.getWidth(), Constraints.m6591getMaxWidthimpl(j2));
        return MeasureScope.layout$default(measureScope, iMin, placeableMo5514measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                this.getScrollerPosition().update(Orientation.Horizontal, TextFieldScrollKt.getCursorRectInScroller(measureScope2, cursorOffset, transformedText, textLayoutResultProxyInvoke != null ? textLayoutResultProxyInvoke.getValue() : null, measureScope.getLayoutDirection() == LayoutDirection.Rtl, placeableMo5514measureBRTryo0.getWidth()), iMin, placeableMo5514measureBRTryo0.getWidth());
                Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo5514measureBRTryo0, Math.round(-this.getScrollerPosition().getOffset()), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
}
