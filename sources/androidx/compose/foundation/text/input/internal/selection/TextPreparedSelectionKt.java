...
@InterfaceC1492Gx
@Metadata(bv = {}, d1 = {"Я\u001e\u001d̉=!,o\bӵLc\u0003\u0010I\u00066\u000b6B\r+4ߚ\u007f\u0007|jAӄ\\\fV\u008cjSX\u000e\u001c\u007fB$s$ DkY(\u007f:\t}M\u0018k|Mr\u000bq\u00136\u001a\u0007oDI\u0004~$\u0011ƪ6I"}, d2 = {"1`[0h3:b\u0019Zyc(z\t8t]8\tN\u000b$\u0002Q}\u0012Kz/>", "", "BqP;f-H`!~yM,\u0010\u0018", "", "1ta@b9", "4naDT9=", "", "AsPAX", "\u001a`]1e6BR,Hxh4\b\u0013=eI)\u0006P\n\u0016\u0013Vs\u0018E@45l\ri;v!>\\\r?tC\u001e\"q]@PR9J\u007f5HV[4\\Qa='!;\u0012N2\frh=3n\u001a", "4nd;W(MW#\btk,\u0004\t+s\u007f"}, k = 2, mv = {1, 8, 0}, pn = "", xi = 48, xs = "")
public final class TextPreparedSelectionKt {
    ...
    public static final int calculateAdjacentCursorPosition(String str, int i2, boolean z2, TransformedTextFieldState transformedTextFieldState) {
        IndexTransformationType indexTransformationType;
        int iFindFollowingBreak = z2 ? StringHelpers_androidKt.findFollowingBreak(str, i2) : StringHelpers_androidKt.findPrecedingBreak(str, i2);
        if (iFindFollowingBreak == -1) {
            return i2;
        }
        long jM1566mapFromTransformedjx7JFs = transformedTextFieldState.m1566mapFromTransformedjx7JFs(iFindFollowingBreak);
        ...
        if (i3 == 3) {
            return z2 ? TextRange.m6118getEndimpl(jM1569mapToTransformedGEjPoXI) : TextRange.m6123getStartimpl(jM1569mapToTransformedGEjPoXI);
        }
        if (i3 != 4) {
            throw new NoWhenBranchMatchedException();
        }
        if (z2) {
            if (iFindFollowingBreak == TextRange.m6123getStartimpl(jM1569mapToTransformedGEjPoXI)) {
        ...
        if (iFindFollowingBreak == TextRange.m6118getEndimpl(jM1569mapToTransformedGEjPoXI)) {
            transformedTextFieldState.setSelectionWedgeAffinity(new SelectionWedgeAffinity(WedgeAffinity.End));
            return iFindFollowingBreak;
        }
        transformedTextFieldState.setSelectionWedgeAffinity(new SelectionWedgeAffinity(WedgeAffinity.Start));
