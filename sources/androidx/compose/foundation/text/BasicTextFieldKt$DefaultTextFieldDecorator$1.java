...
@InterfaceC1492Gx
@Metadata(bv = {}, d1 = {"Я\u0012\u001d̉=!,i\bӵLc\u000b\u0004I\u0006F\u000b<Ȑ\u0017\"Z\u0011(\u0016tjQ;TgX.\u0001RX\u0010ө\u007f4*]jz"}, d2 = {"\n`]<a@F])\rS", "", "7s", "\u001aj^A_0G\u001dy\u000f\u0004\\;\u0001\u001380U", "\u001a`]1e6BR,Hxh4\b\u0013=eI5\fI\u0010\u001b\u001fG9kF~0?gy\u001d>mk"}, k = 3, mv = {1, 8, 0}, pn = "", xi = 48, xs = "")
    ...
    public final void Decoration(final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i2) {
        ...
        if ((i3 + 19) - (19 | i3) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1669748801, i3, -1, "androidx.compose.foundation.text.DefaultTextFieldDecorator.<no name provided>.Decoration (BasicTextField.kt:487)");
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.BasicTextFieldKt$DefaultTextFieldDecorator$1$Decoration$1
                ...
                public final void invoke(Composer composer2, int i5) {
                    BasicTextFieldKt$DefaultTextFieldDecorator$1 basicTextFieldKt$DefaultTextFieldDecorator$1 = this.$tmp0_rcvr;
                    Function2<Composer, Integer, Unit> function22 = function2;
                    int i6 = i2;
                    basicTextFieldKt$DefaultTextFieldDecorator$1.Decoration(function22, composer2, RecomposeScopeImplKt.updateChangedFlags((i6 + 1) - (i6 & 1)));
                }
            });
        }
    }
