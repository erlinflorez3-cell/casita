...
@DebugMetadata(c = "drixvqm\u00039o|{\u007f\u007f\u0005wAz\u0005\f\u0006|z\u000f\u0005\f\fL\u0007\u0006\u0015\u0017\u0019\u0017\u000b\u001aU{\r\u001d\u001b\u0019\u001a\u0010\u0012\u001d\u0017}(X)\u001c%\u001a(/% 1\u0012#31/0\u0007?jy", f = " /=954((1)p-5", i = {}, l = {967}, m = "8>GA>9(KJH>H?", n = {}, s = {})
final class ScrollableKt$semanticsScrollBy$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    ScrollableKt$semanticsScrollBy$2(ScrollingLogic scrollingLogic, long j2, Ref.FloatRef floatRef, Continuation<? super ScrollableKt$semanticsScrollBy$2> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            ...
            float fM835toFloatk4lQ0M = this.$this_semanticsScrollBy.m835toFloatk4lQ0M(this.$offset);
            final Ref.FloatRef floatRef = this.$previousValue;
            final ScrollingLogic scrollingLogic = this.$this_semanticsScrollBy;
            this.label = 1;
            if (SuspendAnimationKt.animate$default(0.0f, fM835toFloatk4lQ0M, 0.0f, null, new Function2<Float, Float, Unit>() { // from class: androidx.compose.foundation.gestures.ScrollableKt$semanticsScrollBy$2.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(float f2, float f3) {
                    ...
                    floatRef.element += scrollingLogic2.reverseIfNeeded(scrollingLogic2.m835toFloatk4lQ0M(nestedScrollScope.mo791scrollByOzD1aCk(scrollingLogic2.m836toOffsettuRUvjQ(scrollingLogic2.reverseIfNeeded(f4)), NestedScrollSource.Companion.m5280getUserInputWNlRxjI())));
                }
