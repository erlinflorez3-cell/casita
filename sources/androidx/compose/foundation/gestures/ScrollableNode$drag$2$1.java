...
@DebugMetadata(c = "drixvqm\u00039o|{\u007f\u007f\u0005wAz\u0005\f\u0006|z\u000f\u0005\f\fL\u0007\u0006\u0015\u0017\u0019\u0017\u000b\u001aU{\r\u001d\u001b\u0019\u001a\u0010\u0012\u001d\u0017\u0001#\u0019\u001bZ\u001c+\u001b\"_nao", f = " /=954((1)p-5", i = {}, l = {344}, m = "8>GA>9(KJH>H?", n = {}, s = {})
        ...
        if (i2 == 0) {
            ...
            Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.ScrollableNode$drag$2$1.1
                ...
                public final void invoke2(DragEvent.DragDelta dragDelta) {
                    nestedScrollScope.mo792scrollByWithOverscrollOzD1aCk(scrollingLogic.m834singleAxisOffsetMKHz9U(dragDelta.m742getDeltaF1C5BW0()), NestedScrollSource.Companion.m5280getUserInputWNlRxjI());
                }
            };
            this.label = 1;
