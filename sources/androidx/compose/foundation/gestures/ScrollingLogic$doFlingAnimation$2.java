...
@DebugMetadata(c = "drixvqm\u00039o|{\u007f\u007f\u0005wAz\u0005\f\u0006|z\u000f\u0005\f\fL\u0007\u0006\u0015\u0017\u0019\u0017\u000b\u001aU{\r\u001d\u001b\u0019\u001a\u0018\u001e\u0018}\"\u001b\u001e\u0019Z\u001c(\u007f'%+%\u007f.*/$8.55kz", f = " /=954((1)p-5", i = {}, l = {782}, m = "8>GA>9(KJH>H?", n = {}, s = {})
final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    ScrollingLogic$doFlingAnimation$2(ScrollingLogic scrollingLogic, Ref.LongRef longRef, long j2, Continuation<? super ScrollingLogic$doFlingAnimation$2> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            ...
            ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$reverseScope$1
                ...
                public float scrollBy(float f2) {
                    ...
                    return scrollingLogic4.reverseIfNeeded(scrollingLogic4.m835toFloatk4lQ0M(nestedScrollScope.mo792scrollByWithOverscrollOzD1aCk(scrollingLogic4.m833reverseIfNeededMKHz9U(scrollingLogic4.m836toOffsettuRUvjQ(f2)), NestedScrollSource.Companion.m5279getSideEffectWNlRxjI())));
                }
            };
            ...
            j2 = longRef.element;
            float fReverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m828toFloatTH1AsA0(j3));
        ...
        longRef.element = scrollingLogic.m829updateQWom1Mo(j2, scrollingLogic2.reverseIfNeeded(((Number) obj).floatValue()));
