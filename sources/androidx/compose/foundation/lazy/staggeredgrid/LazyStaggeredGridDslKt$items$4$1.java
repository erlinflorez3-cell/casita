...
@InterfaceC1492Gx
@Metadata(bv = {}, d1 = {"Я\u0012\u001d̉=!4i\bDJc|\u0004O\f8é<Ȑ\u0017\"Z\u0011\u0018\tlʑG0tiV/jSX\u00112\u0004Č([*t"}, d2 = {"\n`]<a@F])\rS", "\u001a`]1e6BR,Hxh4\b\u0013=eI)\u0006P\n\u0016\u0013Vs\u0018E@,1n\u0012iE|\u00120OCHk3 \"l`\u0003tr(Px'TLM\u000eiVq!#\u0012b{Y'\u0016Z", "\"", "7mS2k", "", "7me<^,"}, k = 3, mv = {1, 8, 0}, pn = "", xi = 176, xs = "")
final class LazyStaggeredGridDslKt$items$4$1 extends Lambda implements Function1<Integer, StaggeredGridItemSpan> {
    ...
    public final StaggeredGridItemSpan invoke(int i2) {
        return this.$span.invoke((T) this.$items.get(i2));
    }
