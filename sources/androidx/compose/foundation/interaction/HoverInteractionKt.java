...
public final class HoverInteractionKt {
    public static final State<Boolean> collectIsHoveredAsState(InteractionSource interactionSource, Composer composer, int i2) {
        ...
        if (z2 || hoverInteractionKt$collectIsHoveredAsState$1$1RememberedValue == Composer.Companion.getEmpty()) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        EffectsKt.LaunchedEffect(interactionSource, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) hoverInteractionKt$collectIsHoveredAsState$1$1RememberedValue, composer, i3);
        if (ComposerKt.isTraceInProgress()) {
