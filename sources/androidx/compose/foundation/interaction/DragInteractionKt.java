...
public final class DragInteractionKt {
    public static final State<Boolean> collectIsDraggedAsState(InteractionSource interactionSource, Composer composer, int i2) {
        ...
        if (z2 || dragInteractionKt$collectIsDraggedAsState$1$1RememberedValue == Composer.Companion.getEmpty()) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        EffectsKt.LaunchedEffect(interactionSource, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) dragInteractionKt$collectIsDraggedAsState$1$1RememberedValue, composer, i3);
        if (ComposerKt.isTraceInProgress()) {
