...
public final class FocusInteractionKt {
    public static final State<Boolean> collectIsFocusedAsState(InteractionSource interactionSource, Composer composer, int i2) {
        ...
        int i3 = i2 & 14;
        boolean z2 = ((i3 ^ 6) > 4 && composer.changed(interactionSource)) || (-1) - (((-1) - i2) | ((-1) - 6)) == 4;
        ...
        if (z2 || focusInteractionKt$collectIsFocusedAsState$1$1RememberedValue == Composer.Companion.getEmpty()) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        EffectsKt.LaunchedEffect(interactionSource, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) focusInteractionKt$collectIsFocusedAsState$1$1RememberedValue, composer, i3);
        if (ComposerKt.isTraceInProgress()) {
