...
final class IntrinsicHeightNode extends IntrinsicSizeModifier {
    ...
    public long mo972calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j2) {
        ...
        if (this.height == IntrinsicSize.Min) {
            iMaxIntrinsicHeight = measurable.minIntrinsicHeight(Constraints.m6591getMaxWidthimpl(j2));
        } else {
            iMaxIntrinsicHeight = measurable.maxIntrinsicHeight(Constraints.m6591getMaxWidthimpl(j2));
        }
        if (iMaxIntrinsicHeight < 0) {
            iMaxIntrinsicHeight = 0;
        }
        return Constraints.Companion.m6602fixedHeightOenEA2s(iMaxIntrinsicHeight);
    }
