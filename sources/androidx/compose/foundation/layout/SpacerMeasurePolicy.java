...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo375measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j2) {
        return MeasureScope.layout$default(measureScope, Constraints.m6589getHasFixedWidthimpl(j2) ? Constraints.m6591getMaxWidthimpl(j2) : 0, Constraints.m6588getHasFixedHeightimpl(j2) ? Constraints.m6590getMaxHeightimpl(j2) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
