...
public final class PlatformRipple extends Ripple {
    ...
    public RippleIndicationInstance mo1752rememberUpdatedRippleInstance942rkJo(InteractionSource interactionSource, boolean z2, float f2, State<Color> state, State<RippleAlpha> state2, Composer composer, int i2) {
        ...
        int i3 = (((((-1) - (((-1) - i2) | ((-1) - 14))) ^ 6) <= 4 || !composer.changed(interactionSource)) && (6 & i2) != 4) ? 0 : 1;
        int i4 = ((((458752 & i2) ^ ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) > 131072 && composer.changed(this)) || (i2 + ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) - (i2 | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) == 131072) ? 1 : 0;
        int i5 = (i3 + i4) - (i3 & i4);
        boolean zChanged = composer.changed(viewGroupFindNearestViewGroup);
        int i6 = (i5 + (zChanged ? 1 : 0)) - (i5 & (zChanged ? 1 : 0));
        Object objRememberedValue = composer.rememberedValue();
        if (i6 != 0 || objRememberedValue == Composer.Companion.getEmpty()) {
            objRememberedValue = new AndroidRippleIndicationInstance(z2, f2, state, state2, viewGroupFindNearestViewGroup, null);
