...
@DebugMetadata(c = "drixvqm\u00039o|{\u007f\u007f\u0005wAu\u0004\u007f\u0005y\u000e\u0004\u000b\u000bKq\t\u001b\u0007c\u0012\u000e\u0013\b\u001c\u0012\u0019\u0019x\u001c\u0012\u0018\u0016\u001a\u0017%\u0002$\u001a\u001c[\u001a($)\u001e2$\u00140e'%9'jxlz", f = "\u000e:47*<053\u00112&*&(#/i&.", i = {}, l = {228}, m = "8>GA>9(KJH>H?", n = {}, s = {})
final class SizeAnimationModifierNode$animateTo$data$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    SizeAnimationModifierNode$animateTo$data$1$1(SizeAnimationModifierNode.AnimData animData, long j2, SizeAnimationModifierNode sizeAnimationModifierNode, Continuation<? super SizeAnimationModifierNode$animateTo$data$1$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            ...
            this.label = 1;
            obj = Animatable.animateTo$default(this.$this_apply.getAnim(), IntSize.m6800boximpl(this.$targetSize), this.this$0.getAnimationSpec(), null, null, this, 12, null);
        ...
        if (animationResult.getEndReason() == AnimationEndReason.Finished && (listener = this.this$0.getListener()) != 0) {
            listener.invoke(IntSize.m6800boximpl(this.$this_apply.m458getStartSizeYbymL2g()), animationResult.getEndState().getValue());
        }
