...
@InterfaceC1492Gx
@Metadata(bv = {}, d1 = {"Я\u000e\u001d̉=!4i\bDZc|İY\u0010>éFB-!T\u0012&\u0007-j˷4E"}, d2 = {"Bn16g4:^", "\u001a`]1e6BRb\u0001\bZ7\u007f\r-sI\u0005\u007fO\t\u0013\"\u001d", "\u001a`]1e6BRb\u0007z]0xR\u0013m{*{\u0016", "Ch\u001c4e(IV\u001d|\tX9|\u0010/a\u000e("}, k = 2, mv = {1, 8, 0}, pn = "", xi = 48, xs = "")
public final class LayerSnapshot_androidKt {
    ...
    public static final Bitmap toBitmap(Image image) {
        ...
        for (int i2 = 0; i2 < width; i2++) {
            ...
            int i5 = (-1) - (((-1) - (i3 >> 8)) | ((-1) - 255));
            int i6 = (i3 >> 16) & 255;
            int i7 = i3 >> 24;
            iArr[i2] = ColorKt.m4232toArgb8_81llA(ColorKt.Color(i4, i5, i6, (i7 + 255) - (i7 | 255)));
        }
