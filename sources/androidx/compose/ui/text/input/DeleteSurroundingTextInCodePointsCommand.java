...
public final class DeleteSurroundingTextInCodePointsCommand implements EditCommand {
    ...
    public void applyTo(EditingBuffer editingBuffer) {
        ...
        while (true) {
            if (i4 < i2) {
                int i5 = selectionStart$ui_text_release + 1;
                if (editingBuffer.getSelectionStart$ui_text_release() > i5) {
                    selectionStart$ui_text_release = EditCommandKt.isSurrogatePair(editingBuffer.get$ui_text_release((editingBuffer.getSelectionStart$ui_text_release() - i5) + (-1)), editingBuffer.get$ui_text_release(editingBuffer.getSelectionStart$ui_text_release() - i5)) ? selectionStart$ui_text_release + 2 : i5;
                    i4++;
                } else {
        ...
        while (true) {
            ...
            if (editingBuffer.getSelectionEnd$ui_text_release() + i7 < editingBuffer.getLength$ui_text_release()) {
                length$ui_text_release = EditCommandKt.isSurrogatePair(editingBuffer.get$ui_text_release((editingBuffer.getSelectionEnd$ui_text_release() + i7) + (-1)), editingBuffer.get$ui_text_release(editingBuffer.getSelectionEnd$ui_text_release() + i7)) ? length$ui_text_release + 2 : i7;
                i3++;
            } else {
