...
@InterfaceC1492Gx
@Metadata(bv = {}, d1 = {"Я\u0012\u001d̉=!,p\bӵLc\u0003\nI\u00066\u000eFY\rӬD\u0012&\u0006\u0017nG0\\ev/\u0003W8\u0011\u0004{b%\"Җw[Jc\u001d\u0016\"7P~kurbZ9BUئ\u001c\u0011y:Nmx\f\u0013?6PsW3{n\u0004ʡfӃ:\u000b"}, d2 = {">`R8<5Ma", "", "D`[}", "", "D`[~", "Cm_.V2\"\\(J", "D`[BX", "Cm_.V2\"\\(K", "Ch\u001cAX?MM&~\u0002^(\u000b\t"}, k = 2, mv = {1, 8, 0}, pn = "", xi = 48, xs = "")
public final class InlineClassUtils_androidKt {
    public static final long packInts(int i2, int i3) {
        long j2 = i3;
        return ((j2 + 4294967295L) - (j2 | 4294967295L)) | (((long) i2) << 32);
    }
