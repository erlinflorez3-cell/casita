...
@InterfaceC1492Gx
@Metadata(bv = {}, d1 = {"Я\u0016\u001d̉=!,o\bDZc|\u0004G\u00068\u000b<K\u0007ӬD.\u0006ј~jg/lev.\u0003Y0\u000ey|L$\n#\"GIW2}P\f\u0016Ȟ˝kr"}, d2 = {"5dc\u0019\\5>4#\fd_-\u000b\t>", "", "\u001a`]1e6BRb\u000ezq;Fo+y\n8\u000b\u0016", "=eU@X;", "CobAe,:[", "", "Ch\u001cAX?MM&~\u0002^(\u000b\t"}, k = 2, mv = {1, 8, 0}, pn = "", xi = 48, xs = "")
public final class LayoutCompat_androidKt {
    public static final int getLineForOffset(Layout layout, int i2, boolean z2) {
        if (i2 <= 0) {
            return 0;
        }
