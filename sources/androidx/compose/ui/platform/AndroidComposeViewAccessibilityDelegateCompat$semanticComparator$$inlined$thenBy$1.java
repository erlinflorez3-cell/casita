...
public final class AndroidComposeViewAccessibilityDelegateCompat$semanticComparator$$inlined$thenBy$1<T> implements Comparator {
    ...
    public final int compare(T t2, T t3) {
        ...
        return iCompare != 0 ? iCompare : this.$comparator.compare(((SemanticsNode) t2).getLayoutNode$ui_release(), ((SemanticsNode) t3).getLayoutNode$ui_release());
    }
}
