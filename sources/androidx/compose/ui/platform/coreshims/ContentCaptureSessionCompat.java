...
public class ContentCaptureSessionCompat {
    ...
    public AutofillId newAutofillId(long j2) {
        if (Build.VERSION.SDK_INT >= 29) {
            return Api29Impl.newAutofillId((ContentCaptureSession) this.mWrappedObj, ((AutofillIdCompat) Objects.requireNonNull(ViewCompatShims.getAutofillId(this.mView))).toAutofillId(), j2);
        }
        return null;
    }
    ...
    public void notifyViewsAppeared(List<ViewStructure> list) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            for (int i2 = 0; i2 < list.size(); i2++) {
                Api29Impl.notifyViewAppeared((ContentCaptureSession) this.mWrappedObj, list.get(i2));
            }
