...
public class ViewStructureCompat {
    ...
    private static class Api23Impl {
        ...
        static void setId(ViewStructure viewStructure, int i2, String str, String str2, String str3) {
            viewStructure.setId(i2, str, str2, str3);
        }

        static void setDimens(ViewStructure viewStructure, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        static void setTextStyle(ViewStructure viewStructure, float f2, int i2, int i3, int i4) {
