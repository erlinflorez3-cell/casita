...
@DebugMetadata(c = "drixvqm\u00039o|{\u007f\u007f\u0005wA\u0002v\u000b|\u000b\u0003{\bOKa\u0001\u0013\u0006g\u0010\n\u001c\b\u001c\u0012\u0019\u0019O\u000e\u001c\u0018\u001d\u0012&\u0018x!\u001b-\u0019-#**`obp", f = "\u0010-=.v3;", i = {}, l = {731, 741}, m = "8>GA>9(KJH>H?", n = {}, s = {})
final class CardElevation$animateElevation$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    CardElevation$animateElevation$2$1(Animatable<Dp, AnimationVector1D> animatable, float f2, boolean z2, CardElevation cardElevation, Interaction interaction, Continuation<? super CardElevation$animateElevation$2$1> continuation) {
            ...
            if (!Dp.m6643equalsimpl0(this.$animatable.getTargetValue().m6652unboximpl(), this.$target)) {
                if (!this.$enabled) {
                    ...
                    if (Dp.m6643equalsimpl0(fM6652unboximpl, this.this$0.pressedElevation)) {
                        start = new PressInteraction.Press(Offset.Companion.m3953getZeroF1C5BW0(), null);
                    ...
                    } else if (Dp.m6643equalsimpl0(fM6652unboximpl, this.this$0.draggedElevation)) {
                        start = new DragInteraction.Start();
                    }
                    this.label = 2;
                    if (ElevationKt.m2919animateElevationrAjV9yQ(this.$animatable, this.$target, start, this.$interaction, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
            }
