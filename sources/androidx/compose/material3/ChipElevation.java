...
public final class ChipElevation {
    ...
    private final State<Dp> animateElevation(boolean z2, InteractionSource interactionSource, Composer composer, int i2) {
        ...
        int i3 = 1;
        byte b2 = ((((-1) - (((-1) - i2) | ((-1) - PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION))) ^ 48) > 32 && composer.changed(interactionSource)) || (-1) - (((-1) - i2) | ((-1) - 48)) == 32;
        ...
        if (((((-1) - (((-1) - i2) | ((-1) - 14))) ^ 6) <= 4 || !composer.changed(z2)) && (i2 & 6) != 4) {
            i3 = 0;
        }
        boolean z3 = (-1) - (((-1) - ((i4 + i3) - (i4 & i3))) & ((-1) - (composer.changedInstance(interaction) ? 1 : 0))) == 1;
        Object objRememberedValue5 = composer.rememberedValue();
        if (z3 || objRememberedValue5 == Composer.Companion.getEmpty()) {
            animatable = animatable;
            objRememberedValue5 = (Function2) new ChipElevation$animateElevation$2$1(animatable, f2, z2, interaction, mutableState, null);
    ...
    public boolean equals(Object obj) {
        ...
        return Dp.m6643equalsimpl0(this.elevation, chipElevation.elevation) && Dp.m6643equalsimpl0(this.pressedElevation, chipElevation.pressedElevation) && Dp.m6643equalsimpl0(this.focusedElevation, chipElevation.focusedElevation) && Dp.m6643equalsimpl0(this.hoveredElevation, chipElevation.hoveredElevation) && Dp.m6643equalsimpl0(this.disabledElevation, chipElevation.disabledElevation);
    }
