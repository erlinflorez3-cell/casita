...
public final class ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo1094onPreScrollOzD1aCk(long j2, int i2) {
        if (!this.this$0.getCanScroll().invoke().booleanValue() || Offset.m3938getYimpl(j2) > 0.0f) {
    ...
    public long mo820onPostScrollDzOQY0M(long j2, long j3, int i2) {
        ...
        if (Offset.m3938getYimpl(j3) < 0.0f || Offset.m3938getYimpl(j2) < 0.0f) {
            float heightOffset = this.this$0.getState().getHeightOffset();
            this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m3938getYimpl(j2));
        ...
        if (Offset.m3938getYimpl(j3) > 0.0f) {
            float heightOffset2 = this.this$0.getState().getHeightOffset();
            this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m3938getYimpl(j3));
    ...
    */
    public java.lang.Object mo819onPostFlingRZ2iAVY(long r16, long r18, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r20) {
        /*
            ...
            r3 = r20
            r12 = r18
            boolean r0 = r3 instanceof androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1
            if (r0 == 0) goto L8a
            r14 = r3
            androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1 r14 = (androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1) r14
            int r0 = r14.label
        ...
        L56:
            ...
            androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 r1 = (androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1) r1
            kotlin.ResultKt.throwOnFailure(r4)
        L5f:
            androidx.compose.ui.unit.Velocity r4 = (androidx.compose.ui.unit.Velocity) r4
            long r2 = r4.m6884unboximpl()
            androidx.compose.material3.ExitUntilCollapsedScrollBehavior r0 = r1.this$0
        ...
        L89:
            goto L32
        L8a:
            androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1 r14 = new androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1
            r14.<init>(r15, r3)
            goto L1d
        L90:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1.mo819onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
