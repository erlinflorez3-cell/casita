...
@DebugMetadata(c = "drixvqm\u00039o|{\u007f\u007f\u0005wA\u0002v\u000b|\u000b\u0003{\bOK_\u0010\u0011c\u0004\u0016o\u001aJ{ \u0019|\u001b$!\u0003\u001f!r#$v\u0017)[\u001a*+}\u001e0\u00032\")\u00103)/-1.<n}p~", f = "\u000e<;\f*:t19", i = {}, l = {2031}, m = "8>GA>9(KJH>H?", n = {}, s = {})
final class AppBarKt$TwoRowsTopAppBar$appBarDragModifier$2$1 extends SuspendLambda implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            ...
            float f2 = this.F$0;
            this.label = 1;
            if (AppBarKt.settleAppBar(this.$scrollBehavior.getState(), f2, this.$scrollBehavior.getFlingAnimationSpec(), this.$scrollBehavior.getSnapAnimationSpec(), this) == coroutine_suspended) {
