...
@DebugMetadata(c = "drixvqm\u00039o|{\u007f\u007f\u0005wA\u0002v\u000b|\u000b\u0003{\bOK_\u0010\u0011c\u0004\u0016o\u001aJi\u0018\u001e\u001f\u001b\u001an\u001f r\u0013%W\u0016&'y\u001a,~.\u001e%\f/%+)-*8jylz", f = "\u000e<;\f*:t19", i = {}, l = {877}, m = "8>GA>9(KJH>H?", n = {}, s = {})
final class AppBarKt$BottomAppBar$appBarDragModifier$2$1 extends SuspendLambda implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            ...
            float f2 = this.F$0;
            this.label = 1;
            if (AppBarKt.settleAppBarBottom(this.$scrollBehavior.getState(), f2, this.$scrollBehavior.getFlingAnimationSpec(), this.$scrollBehavior.getSnapAnimationSpec(), this) == coroutine_suspended) {
