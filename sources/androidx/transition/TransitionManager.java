...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        if (!sPendingTransitions.contains(sceneRoot)) {
            ...
            Transition transitionMo6979clone = transition.mo6979clone();
            if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
                transitionMo6979clone.setCanRemoveViews(true);
            }
            sceneChangeSetup(sceneRoot, transitionMo6979clone);
            scene.enter();
            sceneChangeRunTransition(sceneRoot, transitionMo6979clone);
        }
    }
    ...
    public static TransitionSeekController createSeekController(Scene scene, Transition transition) {
        ...
        if (sceneRoot.isLaidOut() && Build.VERSION.SDK_INT >= 34) {
            ...
            transitionSet.addTransition(transitionMo6979clone);
            if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo6979clone = transition.mo6979clone();
        sceneChangeSetup(viewGroup, transitionMo6979clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo6979clone);
    }
