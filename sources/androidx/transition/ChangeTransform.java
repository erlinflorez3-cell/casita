...
public class ChangeTransform extends Transition {
    ...
    public ChangeTransform(Context context, AttributeSet attributeSet) throws Throwable {
        super(context, attributeSet);
        this.mUseOverlay = true;
        this.mReparent = true;
        this.mTempMatrix = new Matrix();
        int[] iArr = Styleable.CHANGE_TRANSFORM;
        Class<?> cls = Class.forName(Jg.Wd("\u0010YM^YDA\nEJ_`WYY\n%\u0012\u0010(\u0018-*", (short) (ZN.Xd() ^ 31699), (short) (ZN.Xd() ^ 3630)));
        Class<?>[] clsArr = {Class.forName(ZO.xd(".x\u0001\u001a\u0014LIu\u0019t9xx\u0016IW t-4\u0007\"\u007fP\u0004", (short) (Od.Xd() ^ (-18394)), (short) (Od.Xd() ^ (-10716)))), int[].class};
        Object[] objArr = {attributeSet, iArr};
        short sXd = (short) (C1499aX.Xd() ^ (-32381));
        short sXd2 = (short) (C1499aX.Xd() ^ (-9112));
        int[] iArr2 = new int["+?|k\u0019e)B\u0005\n\u0017b$:sLg9PV\b6".length()];
        QB qb = new QB("+?|k\u0019e)B\u0005\n\u0017b$:sLg9PV\b6");
        int i2 = 0;
        while (qb.YK()) {
            int iKK = qb.KK();
        ...
        try {
            ...
            this.mUseOverlay = TypedArrayUtils.getNamedBoolean(typedArray, xmlPullParser, Ig.wd("Sx2JKi\u0017D`RW5MriXyxH", (short) (C1499aX.Xd() ^ (-26319))), 1, true);
            short sXd3 = (short) (C1499aX.Xd() ^ (-29654));
            int[] iArr3 = new int["\u00136/\b\u0018@e#".length()];
            QB qb2 = new QB("\u00136/\b\u0018@e#");
            int i3 = 0;
            while (qb2.YK()) {
                int iKK2 = qb2.KK();
                Xu xuXd2 = Xu.Xd(iKK2);
                iArr3[i3] = xuXd2.fK((C1561oA.Xd[i3 % C1561oA.Xd.length] ^ ((sXd3 + sXd3) + i3)) + xuXd2.CK(iKK2));
                i3++;
            }
            this.mReparent = TypedArrayUtils.getNamedBoolean(typedArray, xmlPullParser, new String(iArr3, 0, i3), 0, true);
            typedArray.recycle();
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues transitionValues, TransitionValues transitionValues2, boolean z2) {
        ...
        Listener listener = new Listener(view, transforms, pathAnimatorMatrix, matrix2, z2, this.mUseOverlay);
