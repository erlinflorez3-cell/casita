...
class VelocityTracker1D {
    ...
    public void addDataPoint(long j2, float f2) {
    ...
    float calculateVelocity() {
        ...
        long j2 = this.mTimeSamples[i2];
        int i3 = 0;
        long j3 = j2;
        while (true) {
            long j4 = this.mTimeSamples[i2];
