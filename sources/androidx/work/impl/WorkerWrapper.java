...
public class WorkerWrapper implements Runnable {
        ...
        try {
            ...
            this.mWorkerResultFuture.addListener(new Runnable() { // from class: androidx.work.impl.WorkerWrapper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m6986lambda$runWorker$0$androidxworkimplWorkerWrapper(future);
                }
                ...
                public void run() {
                    try {
                        try {
                            ...
                            Logger.get().info(WorkerWrapper.TAG, str + " was cancelled", e3);
    ...
    /* synthetic */ void m6986lambda$runWorker$0$androidxworkimplWorkerWrapper(ListenableFuture listenableFuture) {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Configuration configuration, TaskExecutor workTaskExecutor, ForegroundProcessor foregroundProcessor, WorkDatabase database, WorkSpec workSpec, List<String> tags) throws Throwable {
            Object[] objArr = new Object[0];
            Method method = Class.forName(C1626yg.Ud("\u0014;\tcL\u001d|9d\bqF7Nhd|^Yi\u007f20", (short) (Od.Xd() ^ (-18700)), (short) (Od.Xd() ^ (-32323)))).getMethod(Ig.wd("mDaE,_7\u0014_l\u0002\u0019pu:\u0010VV\u001f*g", (short) (C1633zX.Xd() ^ (-14846))), new Class[0]);
            try {
                method.setAccessible(true);
                this.mAppContext = (Context) method.invoke(context, objArr);
