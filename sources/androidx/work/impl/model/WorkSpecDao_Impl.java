...
public final class WorkSpecDao_Impl implements WorkSpecDao {
    ...
    public WorkSpec getWorkSpec(final String id) throws Throwable {
        ...
        try {
            ...
            int columnIndexOrThrow2 = CursorUtil.getColumnIndexOrThrow(cursorQuery, SentryThread.JsonKeys.STATE);
            ...
            try {
                ...
                if (cursorQuery.moveToFirst()) {
                    ...
                    long j7 = cursorQuery.getLong(columnIndexOrThrow14);
                    long j8 = cursorQuery.getLong(columnIndexOrThrow15);
                    boolean z2 = cursorQuery.getInt(columnIndexOrThrow16) != 0;
                    int i5 = cursorQuery.getInt(columnIndexOrThrow17);
                    WorkTypeConverters workTypeConverters3 = WorkTypeConverters.INSTANCE;
                    OutOfQuotaPolicy outOfQuotaPolicyIntToOutOfQuotaPolicy = WorkTypeConverters.intToOutOfQuotaPolicy(i5);
                    int i6 = cursorQuery.getInt(columnIndexOrThrow18);
                    ...
                    boolean z3 = cursorQuery.getInt(columnIndexOrThrow21) != 0;
                    boolean z4 = cursorQuery.getInt(columnIndexOrThrow22) != 0;
                    boolean z5 = cursorQuery.getInt(columnIndexOrThrow23) != 0;
                    boolean z6 = cursorQuery.getInt(columnIndexOrThrow24) != 0;
                    long j9 = cursorQuery.getLong(columnIndexOrThrow25);
                    long j10 = cursorQuery.getLong(columnIndexOrThrow26);
                    byte[] blob = cursorQuery.isNull(columnIndexOrThrow27) ? null : cursorQuery.getBlob(columnIndexOrThrow27);
                    WorkTypeConverters workTypeConverters5 = WorkTypeConverters.INSTANCE;
                    workSpec = new WorkSpec(string, stateIntToState, string2, string3, dataFromByteArray, dataFromByteArray2, j2, j3, j4, new Constraints(networkTypeIntToNetworkType, z3, z4, z5, z6, j9, j10, WorkTypeConverters.byteArrayToSetOfTriggers(blob)), i3, backoffPolicyIntToBackoffPolicy, j5, j6, j7, j8, z2, outOfQuotaPolicyIntToOutOfQuotaPolicy, i6, i7);
                } else {
                    workSpec = null;
                }
                cursorQuery.close();
        ...
        try {
            ...
            try {
                ...
                if (cursorQuery.moveToFirst()) {
                    ...
                    ArrayList<Data> arrayList2 = arrayMap2.get(cursorQuery.getString(0));
                    if (arrayList2 == null) {
                        arrayList2 = new ArrayList<>();
                    }
                    workInfoPojo = new WorkSpec.WorkInfoPojo(string3, stateIntToState, dataFromByteArray, i3, i4, arrayList, arrayList2);
                }
                this.__db.setTransactionSuccessful();
                return workInfoPojo;
            } finally {
        ...
        try {
            ...
            try {
                ...
                while (cursorQuery.moveToNext()) {
                    ...
                    arrayList.add(new WorkSpec.WorkInfoPojo(string3, stateIntToState, dataFromByteArray, i4, i5, arrayList2, arrayList3));
                }
                this.__db.setTransactionSuccessful();
                return arrayList;
            } finally {
                ...
                try {
                    ...
                    try {
                        ...
                        while (cursorQuery.moveToNext()) {
                            ...
                            ArrayList arrayList3 = (ArrayList) arrayMap2.get(cursorQuery.getString(0));
                            if (arrayList3 == null) {
                                arrayList3 = new ArrayList();
                            }
                            arrayList.add(new WorkSpec.WorkInfoPojo(string3, stateIntToState, dataFromByteArray, i4, i5, arrayList2, arrayList3));
        ...
        try {
            ...
            try {
                ...
                while (cursorQuery.moveToNext()) {
                    ...
                    arrayList.add(new WorkSpec.WorkInfoPojo(string3, stateIntToState, dataFromByteArray, i3, i4, arrayList2, arrayList3));
                }
                this.__db.setTransactionSuccessful();
                return arrayList;
            } finally {
    ...
    public List<WorkSpec> getEligibleWorkForScheduling(final int schedulerLimit) throws Throwable {
        ...
        try {
            ...
            columnIndexOrThrow2 = CursorUtil.getColumnIndexOrThrow(cursorQuery, SentryThread.JsonKeys.STATE);
        ...
        try {
            ...
            while (cursorQuery.moveToNext()) {
                ...
                if (cursorQuery.isNull(columnIndexOrThrow27)) {
                    blob = null;
                } else {
                    columnIndexOrThrow27 = columnIndexOrThrow27;
                    blob = cursorQuery.getBlob(columnIndexOrThrow27);
                }
                WorkTypeConverters workTypeConverters5 = WorkTypeConverters.INSTANCE;
        ...
        try {
            ...
            try {
                ...
                while (cursorQuery.moveToNext()) {
                    ...
                    long j8 = cursorQuery.getLong(columnIndexOrThrow15);
                    boolean z2 = true;
                    boolean z3 = cursorQuery.getInt(columnIndexOrThrow16) != 0;
                    int i5 = cursorQuery.getInt(columnIndexOrThrow17);
                    WorkTypeConverters workTypeConverters3 = WorkTypeConverters.INSTANCE;
                    OutOfQuotaPolicy outOfQuotaPolicyIntToOutOfQuotaPolicy = WorkTypeConverters.intToOutOfQuotaPolicy(i5);
                    int i6 = cursorQuery.getInt(columnIndexOrThrow18);
                    ...
                    WorkTypeConverters workTypeConverters4 = WorkTypeConverters.INSTANCE;
                    NetworkType networkTypeIntToNetworkType = WorkTypeConverters.intToNetworkType(i8);
                    boolean z4 = cursorQuery.getInt(columnIndexOrThrow21) != 0;
                    boolean z5 = cursorQuery.getInt(columnIndexOrThrow22) != 0;
                    boolean z6 = cursorQuery.getInt(columnIndexOrThrow23) != 0;
                    ...
                    WorkTypeConverters workTypeConverters5 = WorkTypeConverters.INSTANCE;
                    arrayList.add(new WorkSpec(string, stateIntToState, string2, string3, dataFromByteArray, dataFromByteArray2, j2, j3, j4, new Constraints(networkTypeIntToNetworkType, z4, z5, z6, z2, j9, j10, WorkTypeConverters.byteArrayToSetOfTriggers(blob)), i3, backoffPolicyIntToBackoffPolicy, j5, j6, j7, j8, z3, outOfQuotaPolicyIntToOutOfQuotaPolicy, i6, i7));
                }
                cursorQuery.close();
                roomSQLiteQueryAcquire.release();
                return arrayList;
