    ...
    public SystemIdInfo getSystemIdInfo(String str, int i2) {
        ...
        try {
            ...
            if (cursorQuery.moveToFirst()) {
                systemIdInfo = new SystemIdInfo(cursorQuery.isNull(columnIndexOrThrow) ? null : cursorQuery.getString(columnIndexOrThrow), cursorQuery.getInt(columnIndexOrThrow2), cursorQuery.getInt(columnIndexOrThrow3));
            }
            return systemIdInfo;
        } finally {
            cursorQuery.close();
