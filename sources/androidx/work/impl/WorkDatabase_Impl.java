        ...
        return configuration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(configuration.context).name(configuration.name).callback(new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(16) { // from class: androidx.work.impl.WorkDatabase_Impl.1
            ...
            public void dropAllTables(SupportSQLiteDatabase _db) {
                ...
                if (WorkDatabase_Impl.this.mCallbacks != null) {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        ((RoomDatabase.Callback) WorkDatabase_Impl.this.mCallbacks.get(i2)).onDestructiveMigration(_db);
                    }
                }
            }
            ...
            public void onCreate(SupportSQLiteDatabase _db) {
                if (WorkDatabase_Impl.this.mCallbacks != null) {
                    int size = WorkDatabase_Impl.this.mCallbacks.size();
                    for (int i2 = 0; i2 < size; i2++) {
                        ((RoomDatabase.Callback) WorkDatabase_Impl.this.mCallbacks.get(i2)).onCreate(_db);
                    }
                }
            }
            ...
            public void onOpen(SupportSQLiteDatabase _db) {
                ...
                if (WorkDatabase_Impl.this.mCallbacks != null) {
                    int size = WorkDatabase_Impl.this.mCallbacks.size();
                    for (int i2 = 0; i2 < size; i2++) {
                        ((RoomDatabase.Callback) WorkDatabase_Impl.this.mCallbacks.get(i2)).onOpen(_db);
                    }
                }
            }
            ...
            public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
                ...
                map2.put(SentryThread.JsonKeys.STATE, new TableInfo.Column(SentryThread.JsonKeys.STATE, "INTEGER", true, 0, null, 1));
                ...
                map2.put("period_count", new TableInfo.Column("period_count", "INTEGER", true, 0, AdkSettings.PLATFORM_TYPE_MOBILE, 1));
                map2.put("generation", new TableInfo.Column("generation", "INTEGER", true, 0, AdkSettings.PLATFORM_TYPE_MOBILE, 1));
                ...
                map4.put("generation", new TableInfo.Column("generation", "INTEGER", true, 2, AdkSettings.PLATFORM_TYPE_MOBILE, 1));
