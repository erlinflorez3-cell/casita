...
public class CommandHandler implements ExecutionListener {
    ...
    private void handleStopWork(Intent intent, SystemAlarmDispatcher dispatcher) {
        ...
        if (extras.containsKey(KEY_WORKSPEC_GENERATION)) {
            ...
            StartStopToken startStopTokenRemove = this.mStartStopTokens.remove(new WorkGenerationalId(string, i2));
        ...
        for (StartStopToken startStopToken : listRemove) {
            ...
            dispatcher.m6982lambda$runOnExecuted$1$androidxworkimplProcessor(startStopToken.getId(), false);
        }
    }
    ...
    private void handleExecutionCompleted(Intent intent, int startId) {
        ...
        m6982lambda$runOnExecuted$1$androidxworkimplProcessor(workGenerationalId, z2);
    }
