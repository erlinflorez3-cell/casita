...
public class SystemAlarmDispatcher implements ExecutionListener {
    ...
    SystemAlarmDispatcher(Context context, Processor processor, WorkManagerImpl workManager) throws Throwable {
        Object[] objArr = new Object[0];
        Method method = Class.forName(EO.Od("*\u0007N8e\r\u001812MJr36$ze\u007fFx%\u007f\u000e", (short) (ZN.Xd() ^ 14781))).getMethod(C1561oA.Qd("\\Yg3a`[WPM_SXV*USXHZU", (short) (Od.Xd() ^ (-7446))), new Class[0]);
        try {
            method.setAccessible(true);
            Context context2 = (Context) method.invoke(context, objArr);
            this.mContext = context2;
            this.mStartStopTokens = new StartStopTokens();
            this.mCommandHandler = new CommandHandler(context2, this.mStartStopTokens);
    ...
    public void m6982lambda$runOnExecuted$1$androidxworkimplProcessor(WorkGenerationalId id, boolean needsReschedule) {
    ...
    public boolean add(final Intent intent, final int startId) throws Throwable {
    ...
    void dequeueAndCheckForCompletion() throws Throwable {
        Logger logger = Logger.get();
        String str = TAG;
    ...
    private boolean hasIntentWithAction(String action) throws Throwable {
        assertMainThread();
        synchronized (this.mIntents) {
    ...
    private void assertMainThread() throws Throwable {
        Class<?> cls = Class.forName(C1593ug.zd("\\japnie0rw3Rvwyo}", (short) (ZN.Xd() ^ 30362), (short) (ZN.Xd() ^ 7108)));
        Class<?>[] clsArr = new Class[0];
        Object[] objArr = new Object[0];
        short sXd = (short) (OY.Xd() ^ 12546);
        int[] iArr = new int["*'5\r '+\b*))\u001d)".length()];
        QB qb = new QB("*'5\r '+\b*))\u001d)");
        int i2 = 0;
        while (qb.YK()) {
            int iKK = qb.KK();
        ...
        try {
            ...
            if (((Looper) declaredMethod.invoke(null, objArr)).getThread() != Thread.currentThread()) {
                throw new IllegalStateException(C1561oA.Kd("o\b\t\t\u0019F\u001c\u0018I\r\u0011L\u0017\u001d& \u001d\u0018\u0018T%%W-\" [*\u001f(.`6+6*'+u", (short) (C1580rY.Xd() ^ (-14232))));
            }
        } catch (InvocationTargetException e2) {
            throw e2.getCause();
        }
