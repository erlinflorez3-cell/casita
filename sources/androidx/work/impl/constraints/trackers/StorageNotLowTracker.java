...
public final class StorageNotLowTracker extends BroadcastReceiverConstraintTracker<Boolean> {
    ...
    public Boolean getInitialState() throws Throwable {
        ...
        Object[] objArr = {null, getIntentFilter()};
        Method method = Class.forName(EO.Od("bF@k2\u0002Nqj\b~)ivZ;&BzG{<L", (short) (ZN.Xd() ^ 27007))).getMethod(C1561oA.od("#\u0015\u0016\u0017  \u0010\u001cz\r\n\u000b\u000e\u001a\b\u0014", (short) (ZN.Xd() ^ 18178)), Class.forName(C1561oA.Qd("-9.;70*r'205%-2j}-)\u001a\u001c\u001a\u0017((\u0005\u0017\u0014\u0015\u0018$\u0012\u001e", (short) (C1633zX.Xd() ^ (-30604)))), Class.forName(C1593ug.zd("0>5DB=9\u0004:GGN@JQ\f(NUGQX+OS\\N\\", (short) (C1499aX.Xd() ^ (-11527)), (short) (C1499aX.Xd() ^ (-12392)))));
        try {
            ...
            if (intent != null && intent.getAction() != null) {
                ...
                if (action == null) {
                    ...
                    if (iHashCode == -1181163412) {
                        action.equals(Wg.Zd("6\u0013!\u007ft\u000eP\u0019l@>P!$uys%`d|\f\u0019:\u0014\u0005\u0016gz~VO[*(5'\u0013\u001e\u0005", (short) (OY.Xd() ^ 15530), (short) (OY.Xd() ^ FirebaseError.ERROR_REQUIRES_RECENT_LOGIN)));
                    } else if (iHashCode != -730838620 || !action.equals(C1561oA.Kd("3A8GE@<\u0007CIPBLS\u000eBEWMTT\u0015,.@4/2MBD@D4;:UFC", (short) (FB.Xd() ^ 10346)))) {
                    }
                    z2 = false;
                }
            }
