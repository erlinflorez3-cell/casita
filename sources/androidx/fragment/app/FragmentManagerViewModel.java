...
final class FragmentManagerViewModel extends ViewModel {
    ...
    void setIsStateSaved(boolean z2) {
    ...
    void clearNonConfigState(Fragment fragment, boolean z2) {
        if (FragmentManager.isLoggingEnabled(3)) {
    ...
    void clearNonConfigState(String str, boolean z2) {
        if (FragmentManager.isLoggingEnabled(3)) {
    ...
    private void clearNonConfigStateInternal(String str, boolean z2) {
