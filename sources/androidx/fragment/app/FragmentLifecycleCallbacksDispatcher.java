...
class FragmentLifecycleCallbacksDispatcher {
    ...
    void dispatchOnFragmentPreAttached(Fragment fragment, boolean z2) {
    ...
    void dispatchOnFragmentAttached(Fragment fragment, boolean z2) {
        Context context = this.mFragmentManager.getHost().getContext();
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentPreCreated(Fragment fragment, Bundle bundle, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentCreated(Fragment fragment, Bundle bundle, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentActivityCreated(Fragment fragment, Bundle bundle, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentViewCreated(Fragment fragment, View view, Bundle bundle, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentStarted(Fragment fragment, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentResumed(Fragment fragment, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentPaused(Fragment fragment, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentStopped(Fragment fragment, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentSaveInstanceState(Fragment fragment, Bundle bundle, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentViewDestroyed(Fragment fragment, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentDestroyed(Fragment fragment, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentDetached(Fragment fragment, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
