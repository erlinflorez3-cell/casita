...
class FragmentStateManager {
            ...
            while (true) {
                ...
                if (iComputeExpectedState != this.mFragment.mState) {
                    ...
                    if (!z2 && this.mFragment.mState == -1 && this.mFragment.mRemoving && !this.mFragment.isInBackStack() && !this.mFragment.mBeingSaved) {
                        if (FragmentManager.isLoggingEnabled(3)) {
                            String str3 = "Cleaning up state of never attached fragment: " + this.mFragment;
                        }
                        this.mFragmentStore.getNonConfig().clearNonConfigState(this.mFragment, true);
                        this.mFragmentStore.makeInactive(this);
                        if (FragmentManager.isLoggingEnabled(3)) {
                            String str4 = "initState called for fragment: " + this.mFragment;
                        }
    ...
    void createView() {
        ...
        if (this.mFragment.mView != null) {
            if (FragmentManager.isLoggingEnabled(3)) {
                String str2 = "moveto VIEW_CREATED: " + this.mFragment;
            }
            this.mFragment.mView.setSaveFromParentEnabled(false);
            this.mFragment.mView.setTag(R.id.fragment_container_view_tag, this.mFragment);
            if (viewGroup != null) {
            ...
            if (this.mFragment.mContainer != null && visibility == 0) {
                ...
                if (viewFindFocus != null) {
                    ...
                    if (FragmentManager.isLoggingEnabled(2)) {
                        String str3 = "requestFocus: Saved focused view " + viewFindFocus + " for Fragment " + this.mFragment;
                    }
                }
    ...
    void resume() {
        ...
        if (focusedView != null && isFragmentViewChild(focusedView)) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                String str2 = "requestFocus: Restoring focused view " + focusedView + Global.BLANK + (zRequestFocus ? "succeeded" : "failed") + " on Fragment " + this.mFragment + " resulting in focused view " + this.mFragment.mView.findFocus();
            }
        }
    ...
    Bundle saveState() {
        ...
        if (this.mFragment.mState > -1) {
            ...
            Bundle bundleM6949lambda$attachController$4$androidxfragmentappFragmentManager = this.mFragment.mChildFragmentManager.m6949lambda$attachController$4$androidxfragmentappFragmentManager();
            if (!bundleM6949lambda$attachController$4$androidxfragmentappFragmentManager.isEmpty()) {
                bundle.putBundle(CHILD_FRAGMENT_MANAGER_KEY, bundleM6949lambda$attachController$4$androidxfragmentappFragmentManager);
            }
            if (this.mFragment.mView != null) {
                saveViewState();
            }
