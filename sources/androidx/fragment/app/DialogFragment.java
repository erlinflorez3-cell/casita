...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    public void dismissNow() throws Throwable {
        dismissInternal(false, false, true);
    }

    public void dismissAllowingStateLoss() throws Throwable {
        dismissInternal(true, false, false);
    }

    private void dismissInternal(boolean z2, boolean z3, boolean z4) throws Throwable {
        if (this.mDismissed) {
            return;
        }
        ...
        if (dialog != null) {
            ...
            if (!z3) {
                if (Looper.myLooper() == this.mHandler.getLooper()) {
                    ...
                    Object[] objArr = {this.mDismissRunnable};
                    Method method = Class.forName(Qg.kd("\r\u0019\u000e\u001b\u0017\u0010\nR\u0013\u0016Oh\u0001\r\u0002\t\u0001\r", (short) (ZN.Xd() ^ 12757), (short) (ZN.Xd() ^ 23023))).getMethod(C1561oA.ud("\u000f\r\u0010\u0010", (short) (ZN.Xd() ^ 19849)), Class.forName(hg.Vd("E;O9\u0005B6B:\u007f#E=<..7/", (short) (Od.Xd() ^ (-10494)), (short) (Od.Xd() ^ (-10857)))));
                    try {
