...
public final class ViewPager2 extends ViewGroup {
    ...
    public ViewPager2(Context context) throws Throwable {
        super(context);
    ...
    public ViewPager2(Context context, AttributeSet attributeSet) throws Throwable {
    ...
    public ViewPager2(Context context, AttributeSet attributeSet, int i2) throws Throwable {
    ...
    public ViewPager2(Context context, AttributeSet attributeSet, int i2, int i3) throws Throwable {
    ...
    private void initialize(Context context, AttributeSet attributeSet) throws Throwable {
        ...
        OnPageChangeCallback onPageChangeCallback = new OnPageChangeCallback() { // from class: androidx.viewpager2.widget.ViewPager2.2
            ...
            public void onPageSelected(int i2) {
                if (ViewPager2.this.mCurrentItem != i2) {
                    ViewPager2.this.mCurrentItem = i2;
    ...
    private void setOrientation(Context context, AttributeSet attributeSet) throws Throwable {
        Object[] objArr = {attributeSet, R.styleable.ViewPager2};
        Method method = Class.forName(C1561oA.Xd("8F=LJEA\fBOOVHRY\u0014*WW^Pda", (short) (OY.Xd() ^ 9192))).getMethod(Qg.kd("aSdPW[?_cUMK'YXUKCUSCP", (short) (C1499aX.Xd() ^ (-7040)), (short) (C1499aX.Xd() ^ (-19220))), Class.forName(Wg.vd("Q]R_c\\V\u001f][OQ\u001a,^]RH@RXH5FL", (short) (OY.Xd() ^ 15692))), int[].class);
        try {
            method.setAccessible(true);
            TypedArray typedArray = (TypedArray) method.invoke(context, objArr);
            ViewCompat.saveAttributeDataForStyleable(this, context, R.styleable.ViewPager2, attributeSet, typedArray, 0, 0);
            try {
    ...
    class PageAwareAccessibilityProvider extends AccessibilityProvider {
        ...
        @Override // androidx.viewpager2.widget.ViewPager2.AccessibilityProvider
        public void onRestorePendingState() throws Throwable {
            updatePageAccessibilityActions();
        }

        @Override // androidx.viewpager2.widget.ViewPager2.AccessibilityProvider
        public void onAttachAdapter(RecyclerView.Adapter<?> adapter) throws Throwable {
            updatePageAccessibilityActions();
            if (adapter != null) {
        ...
        @Override // androidx.viewpager2.widget.ViewPager2.AccessibilityProvider
        public void onSetOrientation() throws Throwable {
            updatePageAccessibilityActions();
        }

        @Override // androidx.viewpager2.widget.ViewPager2.AccessibilityProvider
        public void onSetNewCurrentItem() throws Throwable {
            updatePageAccessibilityActions();
        }

        @Override // androidx.viewpager2.widget.ViewPager2.AccessibilityProvider
        public void onSetUserInputEnabled() throws Throwable {
            updatePageAccessibilityActions();
        }

        @Override // androidx.viewpager2.widget.ViewPager2.AccessibilityProvider
        public void onSetLayoutDirection() throws Throwable {
            updatePageAccessibilityActions();
        }
        ...
        void updatePageAccessibilityActions() throws Throwable {
            int itemCount;
