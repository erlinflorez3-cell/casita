...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attributeSet) throws Throwable {
        ...
        Method method = Class.forName(C1561oA.ud("\u0010\u001c\u0011\u001e\u001a\u0013\rU\n\u0015\u0013\u0018\b\u0010\u0015Ma\r\u000b\u0010\u007f\u0012\r", (short) (OY.Xd() ^ 31617))).getMethod(C1561oA.yd("(%7\u0014*76;;+0=", (short) (OY.Xd() ^ 5993)), new Class[0]);
        try {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int i3 = this.mTabAlpha << 24;
        int i4 = (-1) - (((-1) - this.mIndicatorColor) | ((-1) - ViewCompat.MEASURED_SIZE_MASK));
        paint.setColor((i3 + i4) - (i3 & i4));
        float f2 = height;
        canvas.drawRect(left, i2, right, f2, this.mTabPaint);
        if (this.mDrawFullUnderline) {
            this.mTabPaint.setColor((-1) - (((-1) - ((-1) - (((-1) - this.mIndicatorColor) | ((-1) - ViewCompat.MEASURED_SIZE_MASK)))) & ((-1) - ViewCompat.MEASURED_STATE_MASK)));
