...
class TwilightCalculator {
    ...
    private static TwilightCalculator sInstance = null;
    public int state;
    public long sunrise;
    public long sunset;
    ...
    public void calculateTwilight(long j2, double d2, double d3) {
        ...
        double dSin = (Math.sin(d4) * 0.03341960161924362d) + d4 + (Math.sin(2.0f * r8) * 3.4906598739326E-4d) + (Math.sin(r8 * 3.0f) * 5.236000106378924E-6d) + 1.796593063d + 3.141592653589793d;
        double dRound = ((double) (Math.round(((double) (r6 - J0)) - r2) + J0)) + ((-d3) / 360.0d) + (Math.sin(d4) * 0.0053d) + (Math.sin(2.0d * dSin) * (-0.0069d));
