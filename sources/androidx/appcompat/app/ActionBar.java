...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) throws Throwable {
            ...
            this.gravity = 0;
            Object[] objArr = {attributeSet, R.styleable.ActionBarLayout};
            Method method = Class.forName(Jg.Wd("\u001f\u001fvgF%}\u001eA2\u0013{NL0PSdE.phB", (short) (Od.Xd() ^ (-20717)), (short) (Od.Xd() ^ (-5324)))).getMethod(C1626yg.Ud("\u000e\u000fwTnQU+\fU\u000fRe\u001at{D\u0013\u0006EYe", (short) (FB.Xd() ^ 30604), (short) (FB.Xd() ^ 7264)), Class.forName(ZO.xd("<\u001cl=C<]\u000fzy\u0001!7\r\u0007b\b1}a6{\u000e\u000eN", (short) (C1580rY.Xd() ^ (-11205)), (short) (C1580rY.Xd() ^ (-4358)))), int[].class);
            try {
