...
public class DrawableContainerCompat extends Drawable implements Drawable.Callback {
    ...
    public int getChangingConfigurations() {
        return (-1) - (((-1) - super.getChangingConfigurations()) & ((-1) - this.mDrawableContainerState.getChangingConfigurations()));
    }
    ...
    public boolean getPadding(Rect rect) {
        ...
        if (constantPadding != null) {
            ...
            padding = (constantPadding.right | ((-1) - (((-1) - (constantPadding.left | constantPadding.top)) & ((-1) - constantPadding.bottom)))) != 0;
        } else {
            Drawable drawable = this.mCurrDrawable;
            if (drawable != null) {
    ...
    */
    void animate(boolean r14) {
        /*
            ...
            android.graphics.drawable.Drawable r8 = r13.mCurrDrawable
            r10 = 255(0xff, double:1.26E-321)
            r5 = 0
            r9 = 0
            if (r8 == 0) goto L72
            long r0 = r13.mEnterAnimationEnd
            ...
            int r0 = r13.mAlpha
            r8.setAlpha(r0)
            r13.mEnterAnimationEnd = r5
        L21:
            r12 = r9
        L22:
            android.graphics.drawable.Drawable r8 = r13.mLastDrawable
            if (r8 == 0) goto L59
            long r0 = r13.mExitAnimationEnd
            int r2 = (r0 > r5 ? 1 : (r0 == r5 ? 0 : -1))
            if (r2 == 0) goto L38
            int r2 = (r0 > r3 ? 1 : (r0 == r3 ? 0 : -1))
            if (r2 > 0) goto L46
            ...
            r13.mExitAnimationEnd = r5
        L38:
            r7 = r12
        L39:
            if (r14 == 0) goto L45
            if (r7 == 0) goto L45
            java.lang.Runnable r2 = r13.mAnimationRunnable
            r0 = 16
            long r3 = r3 + r0
            r13.scheduleSelf(r2, r3)
        L45:
            return
        L46:
            long r0 = r0 - r3
            long r0 = r0 * r10
            int r2 = (int) r0
            androidx.appcompat.graphics.drawable.DrawableContainerCompat$DrawableContainerState r0 = r13.mDrawableContainerState
            int r0 = r0.mExitFadeDuration
            int r2 = r2 / r0
            android.graphics.drawable.Drawable r1 = r13.mLastDrawable
            int r0 = r13.mAlpha
            int r2 = r2 * r0
            int r0 = r2 / 255
            r1.setAlpha(r0)
    ...
    static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        public int getChangingConfigurations() {
            ...
            int i3 = this.mChildrenChangingConfigurations;
            return (i2 + i3) - (i2 & i3);
        }
        ...
        final boolean setLayoutDirection(int i2, int i3) {
            ...
            for (int i5 = 0; i5 < i4; i5++) {
                if (drawableArr[i5] != null) {
                    boolean layoutDirection = DrawableCompat.setLayoutDirection(drawableArr[i5], i2);
                    if (i5 == i3) {
                        z2 = layoutDirection;
                    }
                }
