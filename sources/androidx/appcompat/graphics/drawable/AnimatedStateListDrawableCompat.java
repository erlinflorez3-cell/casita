...
public class AnimatedStateListDrawableCompat extends StateListDrawableCompat implements TintAwareDrawable {
    ...
    public static AnimatedStateListDrawableCompat create(Context context, int i2, Resources.Theme theme) throws Throwable {
        int next;
        C1561oA.Kd("\u0014\u0006\u0018\u001a\r\u001bI\u0010\u001e\u001f\u001d!", (short) (FB.Xd() ^ 29611));
        try {
            Object[] objArr = new Object[0];
            Method method = Class.forName(Wg.Zd("\u001aP9M,Lu!|[\u0001H\b7\u001f^f8UNE:|", (short) (C1580rY.Xd() ^ (-28367)), (short) (C1580rY.Xd() ^ (-8500)))).getMethod(C1561oA.Xd("hgwVjyv}{mp\u007f", (short) (ZN.Xd() ^ 26912)), new Class[0]);
            try {
                ...
                if (next != 2) {
                    throw new XmlPullParserException(Wg.vd("<^\u0010dfTfi\u0006[IP\nQ[blc", (short) (C1633zX.Xd() ^ (-6308))));
                }
    ...
    protected boolean onStateChange(int[] iArr) {
        ...
        ?? r1 = (iIndexOfKeyframe == getCurrentIndex() || !(selectTransition(iIndexOfKeyframe) || selectDrawable(iIndexOfKeyframe))) ? 0 : 1;
        Drawable current = getCurrent();
        return current != null ? (-1) - (((-1) - r1) & ((-1) - (current.setState(iArr) ? 1 : 0))) : r1;
    }
    ...
    static class AnimatedStateListState extends StateListDrawableCompat.StateListState {
        ...
        private static long generateTransitionKey(int i2, int i3) {
            return (-1) - (((-1) - ((long) i3)) & ((-1) - (((long) i2) << 32)));
        }
        ...
        void mutate() {
            this.mTransitions = this.mTransitions.m370clone();
            this.mStateIds = this.mStateIds.m371clone();
        }

        int addTransition(int i2, int i3, Drawable drawable, boolean z2) {
            ...
            if (z2) {
                this.mTransitions.append(generateTransitionKey(i3, i2), Long.valueOf(((-1) - (((-1) - REVERSED_BIT) & ((-1) - j3))) | j2));
            }
            return iAddChild;
        }

        int addStateSet(int[] iArr, Drawable drawable, int i2) {
        ...
        boolean isTransitionReversed(int i2, int i3) {
            long jLongValue = this.mTransitions.get(generateTransitionKey(i2, i3), -1L).longValue();
            return (jLongValue + REVERSED_BIT) - (jLongValue | REVERSED_BIT) != 0;
        }

        boolean transitionHasReversibleFlag(int i2, int i3) {
            long jLongValue = this.mTransitions.get(generateTransitionKey(i2, i3), -1L).longValue();
            return (jLongValue + REVERSIBLE_FLAG_BIT) - (jLongValue | REVERSIBLE_FLAG_BIT) != 0;
        }
    ...
    private static class FrameInterpolator implements TimeInterpolator {
        ...
        int updateFrames(AnimationDrawable animationDrawable, boolean z2) {
            int numberOfFrames = animationDrawable.getNumberOfFrames();
