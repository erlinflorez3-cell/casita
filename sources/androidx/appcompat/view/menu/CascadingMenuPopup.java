...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private final MenuItemHoverListener mMenuItemHoverListener = new MenuItemHoverListener() { // from class: androidx.appcompat.view.menu.CascadingMenuPopup.3
        ...
        @Override // androidx.appcompat.widget.MenuItemHoverListener
        public void onItemHoverEnter(MenuBuilder menuBuilder, MenuItem menuItem) throws Throwable {
            ...
            int i3 = i2 + 1;
            AnonymousClass1 anonymousClass1 = new Runnable() { // from class: androidx.appcompat.view.menu.CascadingMenuPopup.3.1
            ...
            long jUptimeMillis = SystemClock.uptimeMillis() + 200;
            Handler handler = CascadingMenuPopup.this.mSubMenuHoverHandler;
            Class<?> cls = Class.forName(EO.Od("\u001aV@(w?HC0\"\\V\u001f($\f:S", (short) (C1607wl.Xd() ^ 15583)));
            Class<?>[] clsArr = new Class[3];
            clsArr[0] = Class.forName(C1561oA.Qd("[QeO\u001bXLXP\u00169[SRDDME", (short) (C1607wl.Xd() ^ 13677)));
            short sXd = (short) (C1580rY.Xd() ^ (-13729));
            short sXd2 = (short) (C1580rY.Xd() ^ (-31919));
            int[] iArr = new int["og}i7vlzt<^r{wv\t".length()];
            QB qb = new QB("og}i7vlzt<^r{wv\t");
            int i4 = 0;
            while (qb.YK()) {
                int iKK = qb.KK();
                Xu xuXd = Xu.Xd(iKK);
            ...
            clsArr[1] = Class.forName(new String(iArr, 0, i4));
            clsArr[2] = Long.TYPE;
            Object[] objArr = {anonymousClass1, menuBuilder2, Long.valueOf(jUptimeMillis)};
            Method method = cls.getMethod(C1561oA.od("8699\u00057\u0016*-$", (short) (ZN.Xd() ^ 7976)), clsArr);
            try {
    ...
    class AnonymousClass3 implements MenuItemHoverListener {
        ...
        @Override // androidx.appcompat.widget.MenuItemHoverListener
        public void onItemHoverEnter(MenuBuilder menuBuilder2, MenuItem menuItem2) throws Throwable {
            CascadingMenuPopup.this.mSubMenuHoverHandler.removeCallbacksAndMessages(null);
            int size = CascadingMenuPopup.this.mShowingMenus.size();
            int i2 = 0;
            while (true) {
            ...
            clsArr[1] = Class.forName(new String(iArr, 0, i4));
            clsArr[2] = Long.TYPE;
            Object[] objArr = {anonymousClass1, menuBuilder22, Long.valueOf(jUptimeMillis)};
            Method method = cls.getMethod(C1561oA.od("8699\u00057\u0016*-$", (short) (ZN.Xd() ^ 7976)), clsArr);
            try {
                method.setAccessible(true);
                method.invoke(handler, objArr);
    ...
    public CascadingMenuPopup(Context context, View view, int i2, int i3, boolean z2) throws Throwable {
        this.mContext = context;
        this.mAnchorView = view;
        this.mPopupStyleAttr = i2;
        this.mPopupStyleRes = i3;
        this.mOverflowOnly = z2;
        Class<?> cls = Class.forName(C1561oA.ud("\u0003\u000f\u0004\u0011\r\u0006\u007fH|\b\u0006\u000bz\u0003\b@T\u007f}\u0003r\u0005\u007f", (short) (C1499aX.Xd() ^ (-15159))));
        Class<?>[] clsArr = new Class[0];
        Object[] objArr = new Object[0];
        short sXd = (short) (OY.Xd() ^ 5839);
        int[] iArr = new int["KHV3ERMR^NO\\".length()];
        QB qb = new QB("KHV3ERMR^NO\\");
        int i4 = 0;
        while (qb.YK()) {
            int iKK = qb.KK();
            Xu xuXd = Xu.Xd(iKK);
