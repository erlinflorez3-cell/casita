...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i2) throws Throwable {
    ...
    public void setSwitchTextAppearance(Context context, int i2) throws Throwable {
    ...
    public void setSwitchTypeface(Typeface typeface, int i2) {
        ...
        if (i2 > 0) {
            ...
            this.mTextPaint.setFakeBoldText((i3 + 1) - (1 | i3) != 0);
            this.mTextPaint.setTextSkewX((-1) - (((-1) - i3) | ((-1) - 2)) != 0 ? -0.25f : 0.0f);
            return;
        }
    ...
    public void setTextOn(CharSequence charSequence) throws Throwable {
    ...
    public void setTextOff(CharSequence charSequence) throws Throwable {
    ...
    private Layout makeLayout(CharSequence charSequence) {
        return new StaticLayout(charSequence, this.mTextPaint, charSequence != null ? (int) Math.ceil(Layout.getDesiredWidth(charSequence, r4)) : 0, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
    }
    ...
    private boolean hitThumb(float f2, float f3) {
        ...
        return f2 > ((float) i5) && f2 < ((float) (i6 + i7)) && f3 > ((float) i4) && f3 < ((float) (this.mSwitchBottom + i7));
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r8) throws java.lang.Throwable {
        /*
            r7 = this;
        ...
        L83:
            ...
            float r4 = r4 / r0
        L96:
            boolean r0 = androidx.appcompat.widget.ViewUtils.isLayoutRtl(r7)
            if (r0 == 0) goto L9d
            float r4 = -r4
        L9d:
    ...
    private void stopDrag(MotionEvent motionEvent) throws Throwable {
        this.mTouchMode = 0;
    ...
    protected void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        int i7 = (gravity + PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION) - (gravity | PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION);
        if (i7 == 16) {
    ...
    public void draw(Canvas canvas) {
        ...
        if (drawable2 != null) {
            ...
            if (opticalBounds != null) {
                ...
                if (opticalBounds.bottom > rect.bottom) {
                    i3 = i7 - (opticalBounds.bottom - rect.bottom);
                }
        ...
        if (drawable3 != null) {
            ...
            int i9 = thumbOffset + this.mThumbWidth + rect.right;
    ...
    protected void drawableStateChanged() {
        ...
        if (drawable2 != null && drawable2.isStateful()) {
            int i2 = (-1) - (((-1) - (state ? 1 : 0)) & ((-1) - (drawable2.setState(drawableState) ? 1 : 0)));
            state = true;
            if (i2 != 1) {
                state = false;
            }
    ...
    private void setOnStateDescriptionOnRAndAbove() throws Throwable {
        if (Build.VERSION.SDK_INT >= 30) {
    ...
    private void setOffStateDescriptionOnRAndAbove() throws Throwable {
        if (Build.VERSION.SDK_INT >= 30) {
