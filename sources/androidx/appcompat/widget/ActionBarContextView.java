...
public class ActionBarContextView extends AbsActionBarView {
    ...
    protected void onMeasure(int i2, int i3) {
        ...
        if (view2 != null) {
            ...
            this.mCustomView.measure(View.MeasureSpec.makeMeasureSpec(paddingLeft, i4), View.MeasureSpec.makeMeasureSpec(iMin, i5));
        }
    ...
    protected void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        if (view != null && view.getVisibility() != 8) {
            ...
            int next = next(paddingRight, i6, zIsLayoutRtl);
            paddingRight = next(next + positionChild(this.mClose, next, paddingTop, paddingTop2, zIsLayoutRtl), i7, zIsLayoutRtl);
        }
        LinearLayout linearLayout = this.mTitleLayout;
        if (linearLayout != null && this.mCustomView == null && linearLayout.getVisibility() != 8) {
            paddingRight += positionChild(this.mTitleLayout, paddingRight, paddingTop, paddingTop2, zIsLayoutRtl);
        }
        View view2 = this.mCustomView;
        if (view2 != null) {
            positionChild(view2, paddingRight, paddingTop, paddingTop2, zIsLayoutRtl);
        }
