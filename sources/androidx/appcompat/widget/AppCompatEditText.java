...
public class AppCompatEditText extends EditText implements TintableBackgroundView, OnReceiveContentViewBehavior, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    protected void onDetachedFromWindow() throws Throwable {
        ...
        Object[] objArr = {C1626yg.Ud("#ni\u0019\u0018Xq!\f\u000b;Q", (short) (Od.Xd() ^ (-27840)), (short) (Od.Xd() ^ (-10926)))};
        Method method = Class.forName(Ig.wd("@\u007fgNRoN\u007fj\u0016\u0013?]hzY\u0016H~M\u0004Bh", (short) (ZN.Xd() ^ 12107))).getMethod(C1561oA.Qd("85C!F??/6\u001b,8;-&'", (short) (FB.Xd() ^ 21878)), Class.forName(EO.Od("\u000bPuzI4\u000f\u0007]\u0004#*shiD", (short) (C1499aX.Xd() ^ (-15920)))));
        try {
