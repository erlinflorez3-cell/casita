...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    private static Method sSetTouchModalMethod = null;
    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        public MenuDropDownListView(Context context, boolean z2) throws Throwable {
            super(context, z2);
            short sXd = (short) (C1580rY.Xd() ^ (-1682));
            int[] iArr = new int["xTN\u0002 o<g`}t\u001f_lpQ<P\t5i*:".length()];
            QB qb = new QB("xTN\u0002 o<g`}t\u001f_lpQ<P\t5i*:");
            int i2 = 0;
            while (qb.YK()) {
                int iKK = qb.KK();
                Xu xuXd = Xu.Xd(iKK);
            ...
            Method method = Class.forName(new String(iArr, 0, i2)).getMethod(C1561oA.Qd(":7E\"4A<A=-.;", (short) (C1580rY.Xd() ^ (-510))), new Class[0]);
            try {
                method.setAccessible(true);
                if (1 == ((Resources) method.invoke(context, objArr)).getConfiguration().getLayoutDirection()) {
                    this.mAdvanceKey = 21;
                    this.mRetreatKey = 22;
                } else {
                    this.mAdvanceKey = 22;
    ...
    static class Api29Impl {
        ...
        static void setTouchModal(PopupWindow popupWindow, boolean z2) {
