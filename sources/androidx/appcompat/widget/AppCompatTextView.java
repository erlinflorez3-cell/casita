...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView, EmojiCompatConfigurationView {
    ...
    protected void onDetachedFromWindow() throws Throwable {
        ...
        Context context = getContext();
        short sXd = (short) (C1607wl.Xd() ^ 19589);
        int[] iArr = new int["+\tL.t4Zj<\u0001}\\".length()];
        QB qb = new QB("+\tL.t4Zj<\u0001}\\");
        int i2 = 0;
        while (qb.YK()) {
            int iKK = qb.KK();
        ...
        Method method = Class.forName(C1561oA.Qd("\u0002\u000e\u0003\u0010\f\u0005~G{\u0007\u0005\ny\u0002\u0007?S~|\u0002q\u0004~", (short) (C1633zX.Xd() ^ (-8976)))).getMethod(C1561oA.od("PM[9^WWGN3DPSE>?", (short) (C1633zX.Xd() ^ (-8842))), Class.forName(C1593ug.zd("d\\r^,kaoi1Wyxpvp", (short) (OY.Xd() ^ 25751), (short) (OY.Xd() ^ 12088))));
        try {
            method.setAccessible(true);
            ((InputMethodManager) method.invoke(context, objArr)).isActive(this);
