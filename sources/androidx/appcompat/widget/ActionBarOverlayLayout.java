...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) throws Throwable {
    ...
    private void init(Context context) throws Throwable {
        ...
        short sXd = (short) (C1499aX.Xd() ^ (-10278));
        ...
        Method method = Class.forName(new String(iArr, 0, i2)).getMethod(Xg.qd("po\u007f`us|u", (short) (C1580rY.Xd() ^ (-479)), (short) (C1580rY.Xd() ^ (-13698))), new Class[0]);
        try {
            method.setAccessible(true);
            TypedArray typedArrayObtainStyledAttributes = ((Resources.Theme) method.invoke(context2, objArr)).obtainStyledAttributes(ATTRS);
    ...
    public void onWindowSystemUiVisibilityChanged(int i2) {
        ...
        if ((i3 + 256) - (i3 | 256) == 0 || this.mActionBarVisibilityCallback == null) {
            return;
        }
        ViewCompat.requestApplyInsets(this);
    }
    ...
    public boolean onStartNestedScroll(View view, View view2, int i2) {
        if ((i2 + 2) - (i2 | 2) == 0 || this.mActionBarTop.getVisibility() != 0) {
            return false;
        }
