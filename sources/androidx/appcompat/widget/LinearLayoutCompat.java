...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public int getBaseline() {
        ...
        if (this.mOrientation == 1 && (i2 = (-1) - (((-1) - this.mGravity) | ((-1) - PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION))) != 48) {
            if (i2 == 16) {
    ...
    protected boolean hasDividerBeforeChildAt(int i2) {
        if (i2 == 0) {
            return (-1) - (((-1) - this.mShowDividers) | ((-1) - 1)) != 0;
        }
        if (i2 == getChildCount()) {
            int i3 = this.mShowDividers;
            return (i3 + 4) - (i3 | 4) != 0;
        }
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    void measureHorizontal(int r41, int r42) {
        /*
    ...
    */
    ...
    void layoutHorizontal(int i2, int i3, int i4, int i5) {
        ...
        int i10 = (GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK + i9) - (8388615 | i9);
        int i11 = i9 & PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION;
        ...
        while (childrenSkipCount < virtualChildCount) {
            int i12 = i6 + (i7 * childrenSkipCount);
            ...
            if (virtualChildAt == null) {
                ...
                childrenSkipCount += getChildrenSkipCount(virtualChildAt, i12);
    ...
    public void setGravity(int i2) {
        if (this.mGravity != i2) {
            if ((-1) - (((-1) - GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK) | ((-1) - i2)) == 0) {
    ...
    public void setHorizontalGravity(int i2) {
        int i3 = (-1) - (((-1) - i2) | ((-1) - GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK));
        int i4 = this.mGravity;
        if ((GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK + i4) - (8388615 | i4) != i3) {
            int i5 = (-8388616) & i4;
            this.mGravity = (i3 + i5) - (i3 & i5);
            requestLayout();
        }
    }
    ...
    public void setVerticalGravity(int i2) {
        ...
        int i4 = this.mGravity;
        if ((-1) - (((-1) - i4) | ((-1) - PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION)) != i3) {
            this.mGravity = (-1) - (((-1) - i3) & ((-1) - ((-1) - (((-1) - i4) | ((-1) - (-113))))));
            requestLayout();
        }
    }
