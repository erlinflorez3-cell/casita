...
public abstract class AbstractResolvableFuture<V> implements ListenableFuture<V> {
    ...
    public final V get(long j2, TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        boolean z2 = true;
        int i2 = obj != null ? 1 : 0;
        int i3 = !(obj instanceof SetFuture) ? 1 : 0;
        if ((i2 + i3) - (i2 | i3) != 0) {
                ...
                do {
                    ...
                    if (ATOMIC_HELPER.casWaiters(this, waiter, waiter2)) {
                        do {
                            ...
                            int i5 = !(obj2 instanceof SetFuture) ? 1 : 0;
                            if ((i4 + i5) - (i4 | i5) != 0) {
        ...
        while (nanos > 0) {
            ...
            if ((-1) - (((-1) - (obj3 != null ? 1 : 0)) | ((-1) - (!(obj3 instanceof SetFuture) ? 1 : 0))) != 0) {
            ...
            do {
                ...
                if (ATOMIC_HELPER.casWaiters(this, waiter, waiter2)) {
                    do {
                        ...
                        obj = this.value;
                        i2 = obj != null ? 1 : 0;
                        i3 = !(obj instanceof SetFuture) ? 1 : 0;
                    } while ((i2 + i3) - (i2 | i3) == 0);
                    return getDoneValue(obj);
                }
                waiter = this.waiters;
        ...
        while (true) {
            if (ATOMIC_HELPER.casValue(abstractResolvableFuture, obj, cancellation)) {
                ...
                if (listenableFuture instanceof AbstractResolvableFuture) {
                    ...
                    int i3 = obj == null ? 1 : 0;
                    boolean z5 = obj instanceof SetFuture;
                    if ((i3 + (z5 ? 1 : 0)) - (i3 & (z5 ? 1 : 0)) == 0) {
                        return true;
                    }
                    z4 = true;
                } else {
    ...
    static Object getFutureValue(ListenableFuture<?> listenableFuture) {
        ...
        int i2 = !GENERATE_CANCELLATION_CAUSES ? 1 : 0;
        if ((i2 + (zIsCancelled ? 1 : 0)) - (i2 | (zIsCancelled ? 1 : 0)) == 1) {
    ...
    final void maybePropagateCancellationTo(Future<?> future) {
        if ((-1) - (((-1) - (future != null ? 1 : 0)) | ((-1) - (isCancelled() ? 1 : 0))) != 0) {
