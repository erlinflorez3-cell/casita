...
@DebugMetadata(c = "drixvqm\u00039~|}|>T\u0002\u0006\u0004\u000b\u000b\u0001\u0007~\u000em\f\r\fCc\u0011\u0010\u0014\u0006\u0014\u0010\u0017\u0017M\u0010$\u0012\u0011$$\u0016UfW\u001f%\u0019[i", f = "\u0010;=9><04*7\u001510-l)1", i = {}, l = {}, m = "8>GA>9(KJH>H?", n = {}, s = {})
final class CoroutinesRoom$Companion$execute$4$job$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            continuation.resumeWith(Result.m8980constructorimpl(objCall));
        } catch (Throwable th) {
            Continuation continuation2 = this.$continuation;
            Result.Companion companion2 = Result.Companion;
            continuation2.resumeWith(Result.m8980constructorimpl(ResultKt.createFailure(th)));
        }
